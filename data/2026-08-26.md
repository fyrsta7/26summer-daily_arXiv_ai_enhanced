...
### [11] [Repo2Skill-Evo: Repository Skills Go Stale in Silence](https://arxiv.org/abs/2608.21964)
...
Selection reason: 研究仓库技能随版本更新失效的问题并提出维护基准，直接面向仓库级编码 agent 的技能维护与评测。
...
### [12] [Disagree to Explore, Agree to Commit: Routing-Guided Test-Time Scaling for Software Agents](https://arxiv.org/abs/2608.22191)
...
Selection reason: 利用 MoE 路由信息引导软件 agent 探索与选择，在 SWE-bench Verified 上验证，直接提升编码 agent 效果。
...
### [13] [HIRA: A Human-in-the-Loop Retrieval-Augmented Cascade for Document Classification in Regulated Industries](https://arxiv.org/abs/2608.21792)
...
### [14] [Concepts for Securing Agentic AI Coding and the Terok Environment](https://arxiv.org/abs/2608.22930)
...
Selection reason: 针对 Agentic AI 编码的安全风险与隔离环境设计，对构建安全可靠的编码 agent 有参考价值。
...
### [15] [Hints, Critics, and Teachers: Prior Injection for Sparse-Reward RL in Vision-Language Math Reasoning](https://arxiv.org/abs/2608.21811)
*Qiqian Fu*
...
### [16] [PatchWrite: One Line, Not One Section -- Compile-Gated, Validity-Preserving Editing for AI-Drafted Manuscripts](https://arxiv.org/abs/2608.23001)
*Weiwei Yang*
...
Selection reason: 编译门控与证据锁定的编辑提交机制可迁移到代码 agent 的局部修改与验证流程。
...
### [17] [AutoSaddler: Automatic Harness Optimization with Durable Updates from Agent Execution Traces](https://arxiv.org/abs/2608.23041)
...
Selection reason: 自动优化 agent harness，通过失败轨迹诊断和结构化补丁更新在 SWE-Bench 等任务上显著提升性能，直接相关。
...
### [18] [Beyond Success and Failure: Length-Aware Contrastive Learning for GUI Agents](https://arxiv.org/abs/2608.21830)
...
### [19] [Prime Agent: A Self-Improving RLM Harness](https://arxiv.org/abs/2608.23552)
...
Selection reason: 面向长程 coding-agent 工作流的开源 harness，提供持久 REPL、技能记忆和子 agent 协调，工程化迁移价值明确。
...
### [20] [GameXpert-Bench: How Far Are Coding Agents from Expert Game Development?](https://arxiv.org/abs/2608.21833)
...
### [21] [LLM4LLM: Bridging Kernel Benchmarks and Real Deployment via Closed-Loop Agentic Optimization](https://arxiv.org/abs/2608.21836)
...
### [22] [MemGuard: Persisting Verifier Signals for LLM-Agent Memory Governance](https://arxiv.org/abs/2608.21867)
...
### [23] [HiMA-MDD: A Hierarchical Multi-Agent Harness for Interpretable Multimodal Depression Detection in Clinical Interviews](https://arxiv.org/abs/2608.21868)
...
### [24] [From Solver Feedback to Faithful Plans: Multi-Role Reinforcement Learning for Symbolic Planning](https://arxiv.org/abs/2608.21897)
...
### [26] [GuardianBench: A Same-Scene Instruction-Contrastive Benchmark for Latent Contextual Risk in Embodied AI](https://arxiv.org/abs/2608.21928)
...
### [27] [TessIndex: Capability Verified Identity System for the Agent Economy](https://arxiv.org/abs/2608.21942)
...
### [28] [Closed-loop AI achieves certifiable engineering design](https://arxiv.org/abs/2608.21976)
...
### [29] [DynaContext: Self-Improving Dynamic Contextualization of Optimized Prompts for Heterogeneous Parameter Extraction](https://arxiv.org/abs/2608.22014)
...
### [31] [MEMORY Wins All: Indirect Bias Injection Attacks via Social Media Feeds](https://arxiv.org/abs/2608.22061)
...
### [32] [Search Broadly, Seek Evidence on Both Sides, Decide Narrowly: Evidence-Admissible GraphRAG for Longitudinal Clinical Event Verification](https://arxiv.org/abs/2608.22062)
...
### [33] [From SQL Generation to Tool Selection: A Domain-Oriented Pattern for MCP Servers](https://arxiv.org/abs/2608.22063)
*Bartolomeo Bogliolo*
...
### [34] [Dissecting Neuro-Symbolic Quality Assurance for Synthetic Oncology Data Generation](https://arxiv.org/abs/2608.22085)
...
### [36] [MegaMem: A Retrieval Solution for Ultra-Large Context Windows](https://arxiv.org/abs/2608.22137)
...
### [37] [MEMONDEMAND: A Memory Management System for Large-Scale Enterprise Data](https://arxiv.org/abs/2608.22141)
*Xinyuan Song,Bowen Zhu,Hasibul Haque,Liang Zhao*
...
### [38] [AUDITA: certified auditing and causal attribution of adverse outcomes in autonomous multi-agent systems](https://arxiv.org/abs/2608.22160)
*Zhixu Du,Yiran Chen*
...
### [39] [MCP-Universe RL: A Framework for Training MCP Tool-Use Agents via Reinforcement Learning](https://arxiv.org/abs/2608.22167)
...
### [40] [Role-Specialized Mixture-of-Agents with Open-Weight LLMs for Clinical Prediction](https://arxiv.org/abs/2608.22176)
...
### [41] [Read Less, Solve More: Token-Efficient Sparse Reading for AI Agents](https://arxiv.org/abs/2608.22237)
...
### [42] [HERO: Human-profile Enhanced Retrieval Optimization Framework for Long-term Agent Memory](https://arxiv.org/abs/2608.22310)
...
### [43] [Where Cognition Lives: Dissecting Emergent from Computed Function in a Minimal Complete Cognitive Architecture](https://arxiv.org/abs/2608.22347)
...
### [44] [Where World Models Break: Natural-Input Failure Discovery](https://arxiv.org/abs/2608.22421)
...
### [45] [Small Reasoning Models are Instruction Followers in Function Calling](https://arxiv.org/abs/2608.22472)
...
### [46] [ClawProBench: Trace-Aware Evaluation of AI Agents with Runtime Coverage and Frozen Workplace-Style Holdouts](https://arxiv.org/abs/2608.22510)
*YuanHang Xiao*
...
### [47] [HANSARD: A Reference Architecture for Forensic Readiness, Runtime Witnessing, and Graded Attribution in Autonomous Multi-Agent AI Systems](https://arxiv.org/abs/2608.22512)
...
### [48] [CONTRAMEM: Learning Self-Evolving Procedural Memory from Contrasting Multi-Model Trajectories](https://arxiv.org/abs/2608.22533)
...
### [49] [STAGE: Stateful Translation to Agentic Graph Execution with Policy-Scoped Context and Deterministic Control](https://arxiv.org/abs/2608.22538)
...
### [50] [ExecRubrics: Executable Tool-Augmented Rubrics for Verifiable and Efficient Long-Form Evaluation](https://arxiv.org/abs/2608.22559)
...
### [51] [CausalCache: Conditional High-Fidelity Restoration for Long-Horizon GUI Agents](https://arxiv.org/abs/2608.22577)
...
### [52] [Coalition-Aware Skill Reliability for Self-Evolving Agents](https://arxiv.org/abs/2608.22610)
...
### [53] [A-CPES: A Reference Framework for Agentic AI in Cyber-Physical Energy Systems](https://arxiv.org/abs/2608.22672)
...
### [54] [Robustness Analysis of Agentic AI to Inconsistent and Incomplete Tool Responses](https://arxiv.org/abs/2608.22676)
...
### [55] [CacheRouter: A Dual-Path Tool Routing Architecture with Cache-Preserving Main-Model Isolation for Long-Tail Tool Discovery](https://arxiv.org/abs/2608.22708)
...
### [56] [The Compaction Cliff in Long-Running AI Agent Memory](https://arxiv.org/abs/2608.22752)
...
### [57] [Compositional Chain-of-Relations for Faithful Knowledge Graph Question Answering with Large Language Models](https://arxiv.org/abs/2608.22762)
...
### [58] [The Retriever Should Remember: Experience-Amortized Reranking for Long-Term Agent Memory](https://arxiv.org/abs/2608.22767)
...
### [59] [Beyond the Harness: End-to-End Optimization of Context Artifacts for Enterprise Text-to-SQL](https://arxiv.org/abs/2608.22830)
...
### [60] [GSAR: Goal-State-Anchor Rewards for Mobile GUI Agents with Self-Evolving Data Synthesis](https://arxiv.org/abs/2608.22847)
...
### [61] [Your AI, On a Dial: Controlling Investment Bias in LLMs with a Single Neuron](https://arxiv.org/abs/2608.22852)
...
### [62] [CDEG: Learning Decision-Critical Evidence for Long-Horizon Diagnostic Agents](https://arxiv.org/abs/2608.22899)
...
### [63] [What Process Evaluation of Coding Agents Actually Measures: Action, Task, and Step Are Three Different Levels](https://arxiv.org/abs/2608.22960)
...
### [64] [Buried in Textual Debt: Context Pruning with Visual Evidence Preservation for MLLM Agents](https://arxiv.org/abs/2608.22963)
...
### [65] [ParallelWorld: Test-Time Scaling for Embodied Reasoning](https://arxiv.org/abs/2608.22971)
...
### [66] [Toward Effective and Reliable LLM Agents via Dynamic Ontology](https://arxiv.org/abs/2608.22974)
...
### [67] [Budget-Constrained Embodied Perception: Four Resource Walls and a Pre-Registered Evaluation of Access-Structured Perception on Open Models at less than 31B](https://arxiv.org/abs/2608.22975)
...
### [68] [PsychJail: Exploring Psychological Jailbreaks via Multi-Turn Persuasion of LLM Policies](https://arxiv.org/abs/2608.23028)
...
### [69] [Artificial Empathy: Towards a Framework for Unsupervised Agency Detection and Policy Reconstruction](https://arxiv.org/abs/2608.23030)
...
### [70] [MobilePA-Bench: Benchmarking Mobile Planner Agents on Complex Real-World Tasks](https://arxiv.org/abs/2608.23035)
...
### [71] [From Inertia to Objectivity: Improving Deep Research Agents with Noise Isolation](https://arxiv.org/abs/2608.23045)
...
### [72] [LLM-based Agents for Forecasting and Prediction: Methods, Training, Evaluation, and Applications](https://arxiv.org/abs/2608.23058)
...
### [73] [AgentWeave: Routing Before Reasoning for Efficient Function Calling in Tool-Rich Language Models](https://arxiv.org/abs/2608.23078)
...
### [74] [POOL: Propagated Uncertainty Over Lookalikes](https://arxiv.org/abs/2608.23086)
...
### [75] [Cognitive Profiling of LRMs' Reasoning Traces Using Bloom's Taxonomy](https://arxiv.org/abs/2608.23205)
...
### [76] [Is Next-Chunk Reasoning RL Really Better than SFT? Revisiting Training Strategies under no-CoT Data](https://arxiv.org/abs/2608.23256)
...
### [77] [Hidden in the Request: Explaining Unethical LLM Compliance through Token Relevance](https://arxiv.org/abs/2608.23264)
...
### [78] [Apodex 1.1: Scaling Agentic Intelligence for Complex Work](https://arxiv.org/abs/2608.23283)
...
### [79] [Agent-G$^2$: Gaussian Guidance for Agentic Reinforcement Learning](https://arxiv.org/abs/2608.23318)
...
### [80] [Walking on the DARKSIDE](https://arxiv.org/abs/2608.23370)
...
### [81] [MediSkill-Evo: Process-Constrained Self-Evolution for Evidence-Grounded Clinical Interaction](https://arxiv.org/abs/2608.23397)
...
### [82] [SkillAlchemy: Open-World Agent Skill Creation](https://arxiv.org/abs/2608.23417)
...
### [83] [StrategyBench: Evaluating Explicit Strategy Induction in Large Language Models](https://arxiv.org/abs/2608.23475)
...
### [84] [SRPO: Self-Reflective Policy Optimization for Long-Horizon Reasoning](https://arxiv.org/abs/2608.23493)
...
### [85] [EarthVerse: Benchmarking Scientific Agents Across Dynamic Earth Systems and Natural Hazards](https://arxiv.org/abs/2608.23525)
...
### [86] [Execution-Anchored Hallucination Calibration Reranking for Verilog Code Generation](https://arxiv.org/abs/2608.22938)
...
Selection reason: 提出执行锚定的幻觉校准重排框架 EAHC，结合执行与推理信号提升 Verilog 代码生成选择，对代码生成验证有直接价值。
...
### [87] [ARGUS: MCP-Grounded Root Cause Analysis for Kubernetes Incidents](https://arxiv.org/abs/2608.23084)
...
Selection reason: 提出 MCP 驱动的 Kubernetes 事故根因分析助手 ARGUS，在真实故障注入中验证，对运维 agent 和工具反馈机制有迁移价值。
...
### [88] [From Metrics to Improvement: A Lifecycle-Aware LLM Feedback Framework for Research Software Quality](https://arxiv.org/abs/2608.23118)
...
Selection reason: 提出生命周期感知的 LLM 反馈框架，基于质量指标迭代优化研究软件，对代码质量改进和 agent 反馈循环有参考价值。
...
### [89] [An AI-Assisted Migration Framework for Transforming Legacy Scientific Applications into Reusable Cloud-Based Workflows](https://arxiv.org/abs/2608.23146)
...
Selection reason: AI 辅助迁移遗留科学应用为云工作流，虽涉及 LLM 代码生成，但属垂直应用，迁移价值有限。
...
### [90] [TianoForge: An Automated Bug Triage Approach for the TianoCore UEFI Firmware Development Community](https://arxiv.org/abs/2608.23259)
...
Selection reason: 提出基于 LLM 的 bug 分类方法 TianoForge，减少分类时间，对软件工程代理的自动化维护有参考价值。
...
### [91] [From Natural Language Policies to Executable Obligations: A Verification Harness for Dependable In-Car LLM Agents](https://arxiv.org/abs/2608.23282)
...
Selection reason: 提出将自然语言策略编译为可执行规则的验证 harness，用于车内 LLM 代理的可依赖验证，其验证与修订循环可迁移到代码代理。
...
### [92] [DPIAgent: Divide, Protocol, Isolate for Agentic Reproduction Test Generation](https://arxiv.org/abs/2608.23341)
...
Selection reason: 提出 Divide, Protocol, Isolate 结构的代理框架用于复现测试生成，在 SWT-Bench 上超越基线，对代码代理的测试生成直接相关。
...
### [93] [Formalizing and Automating Fine-Grained Move Refactorings Across Methods](https://arxiv.org/abs/2608.23377)
...
Selection reason: 形式化并自动化跨方法的 Move 重构，提供静态检查前提，可作为代码代理重构工具的基础。
...
### [94] [An Interactive Agent for Requirement-Driven Candidate Sourcing](https://arxiv.org/abs/2608.23501)
...
Selection reason: 交互式需求采集、双阶段提交协议和终止守卫等通用 agent 工作流机制可迁移到编码 agent 的需求澄清与验证流程。
...
### [95] [Architecture as Capability Equalizer for Coding Agents](https://arxiv.org/abs/2608.21747)
*Arquimedes Canedo*
...
Selection reason: 系统比较不同架构说明格式对编码 agent 生成质量的影响，揭示能力均衡器效应，对 coding agent 设计有直接指导。
...
### [96] [Evaluating Inference-Time Defenses Against Package Hallucination in LLM-Generated Code](https://arxiv.org/abs/2608.22652)
...
Selection reason: 系统评估 LLM 代码生成中包幻觉的推理时防御，并提出评测基准与指标，对代码 agent 安全性直接相关。
