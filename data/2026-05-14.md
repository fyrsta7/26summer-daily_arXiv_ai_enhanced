...
- [SWE-Chain: Benchmarking Coding Agents on Chained Release-Level Package Upgrades](http://arxiv.org/abs/2605.14415v1) — 相关度 0.95：面向链式版本升级的coding agent基准，直接评估agent在真实维护任务中的表现。
- [FuzzAgent: Multi-Agent System for Evolutionary Library Fuzzing](http://arxiv.org/abs/2605.14431v1) — 相关度 0.90：多agent进化式库模糊测试系统，结合运行时反馈，对自动化测试agent有直接启发。
- [Hydra: Efficient, Correct Code Generation via Checkpoint-and-Rollback Support](http://arxiv.org/abs/2605.15238v1) — 相关度 0.90：面向代码生成的checkpoint-rollback恢复机制，直接提升代码agent的编译修复效率。
- [Viverra: Text-to-Code with Guarantees](http://arxiv.org/abs/2605.14972v1) — 相关度 0.90：文本生成代码附带可验证断言与形式验证，直接提升生成代码的正确性保障能力。
- [Documentation-Guided Agentic Codebase Migration from C to Rust](http://arxiv.org/abs/2605.14634v3) — 相关度 0.85：文档引导的agentic C-to-Rust代码库迁移，展示agent在大型迁移任务中的规划与验证能力。
- [Runtime-Structured Task Decomposition for Agentic Coding Systems](http://arxiv.org/abs/2605.15425v1) — 相关度 0.85：提出运行时结构化任务分解架构，降低编码智能体的重试成本并提升可调试性，直接服务于agentic coding系统。
- [Veritas: A Semantically Grounded Agentic Framework for Memory Corruption Vulnerability Detection in Binaries](http://arxiv.org/abs/2605.15097v2) — 相关度 0.85：提出基于语义落地的智能体漏洞检测框架，结合静态分析与多智能体验证，对代码分析智能体有直接迁移价值。
- [Correctness-Aware Repository Filtering Under Maximum Effective Context Window Constraints](http://arxiv.org/abs/2605.14362v1) — 相关度 0.80：上下文窗口过滤方法提升LLM开发工具准确性，对coding agent上下文管理具有实用价值。
- [From I/O to Code with Discovery Agent](http://arxiv.org/abs/2605.15334v1) — 相关度 0.80：将LLM作为变异算子进行IO到代码的程序合成，利用执行信号指导演化搜索，可用于代码生成智能体。
- [Not All RAGs Are Created Equal: A Component-Wise Empirical Study for Software Engineering Tasks](http://arxiv.org/abs/2605.14503v1) — 相关度 0.80：组件级实证研究RAG系统在SE任务中的配置选择，为代码agent检索优化提供数据驱动指导。
- [Towards In-Depth Root Cause Localization for Microservices with Multi-Agent Recursion-of-Thought](http://arxiv.org/abs/2605.14866v1) — 相关度 0.80：多agent递归思维微服务根因定位，并行推理结构对调试型agent效率提升有借鉴意义。
- [When Retrieval Hurts Code Completion: A Diagnostic Study of Stale Repository Context](http://arxiv.org/abs/2605.14478v1) — 相关度 0.80：诊断RAG中过期仓库上下文对代码补全的负面影响，对代码检索和agent上下文构建有重要价值。
- [Making OpenAPI Documentation Agent-Ready: Detecting Documentation and REST Smells with a Multi-Agent LLM System](http://arxiv.org/abs/2605.14312v1) — 相关度 0.75：多agent系统检测OpenAPI文档气味，使API对agent更友好，直接关联工具反馈与agent工程化。
- [Remember Your Trace: Memory-Guided Long-Horizon Agentic Framework for Consistent and Hierarchical Repository-Level Code Documentation](http://arxiv.org/abs/2605.14563v2) — 相关度 0.75：记忆引导的长程agent框架生成仓库级代码文档，记忆机制可迁移到其他coding agent任务。
- [Assistance to Autonomy: A Systematic Literature Review of Agentic AI across the Software Development Life Cycle](http://arxiv.org/abs/2605.15245v2) — 相关度 0.70：系统综述agentic AI在SDLC中的采用与架构模式，提供agentic开发全景与验证机制洞察。
- [Exploiting LLM Agent Supply Chains via Payload-less Skills](http://arxiv.org/abs/2605.14460v1) — 相关度 0.70：研究LLM agent技能供应链安全，对coding agent的安全性评估与防御有迁移意义。
- [Probing Privacy Leaks in LLM-based Code Generation via Test Generation](http://arxiv.org/abs/2605.15248v1) — 相关度 0.70：通过测试生成探测LLM代码生成中的隐私泄露，为代码agent安全性测试提供方法。
- [Web Agents Should Adopt the Plan-Then-Execute Paradigm](http://arxiv.org/abs/2605.14290v1) — 相关度 0.65：提出plan-then-execute范式以增强agent安全性与可控性，对coding agent架构设计有参考价值。
- [Agentic AI in Industry: Adoption Level and Deployment Barriers](http://arxiv.org/abs/2605.14675v1) — 相关度 0.60：工业agent采用与部署障碍的定性研究，揭示验证机制等关键问题，对工程化agent有参考价值。
- [Failure-Guided Fuzzing for Hybrid Quantum-Classical Programs](http://arxiv.org/abs/2605.14219v1) — 相关度 0.60：基于失败引导的模糊测试方法可迁移到代码agent的测试与故障发现场景。
- [Given, When, Then, Again: Mining Subscenario Refactoring Candidates in Behaviour-Driven Test Suites with ML Classifiers and LLM-Judge Baselines](http://arxiv.org/abs/2605.14568v3) — 相关度 0.60：使用ML和LLM挖掘BDD测试中的重构候选，对测试分析与重构推荐有参考价值。
- [In-IDE Toolkit for Developers of AI-Based Features](http://arxiv.org/abs/2605.14612v1) — 相关度 0.60：IDE内建AI功能追踪与评测工具，为agent可观测性和评测工作流提供设计参考。
