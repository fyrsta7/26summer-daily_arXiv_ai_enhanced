...
### [1] [Practical Quantum CIM Empowerment via All-Domestic-Core Agentic Large Model](http://arxiv.org/abs/2605.23934v1)
*Wang Rui,Lu Diannan*
...
### [2] [Self-Correction as Feedback Control: Error Dynamics, Stability Thresholds, and Prompt Interventions in LLMs](http://arxiv.org/abs/2604.22273v2)
...
### [3] [AgentSearchBench: A Benchmark for AI Agent Search in the Wild](http://arxiv.org/abs/2604.22436v1)
...
### [4] [From Skills to Talent: Organising Heterogeneous Agents as a Real-World Company](http://arxiv.org/abs/2604.22446v1)
...
### [5] [Superminds Test: Actively Evaluating Collective Intelligence of Agent Society via Probing Agents](http://arxiv.org/abs/2604.22452v1)
...
### [6] [Operationalizing Reconstructive Authority: Runtime Construction, Dependency Resolution, and Execution Gating in Autonomous Agent Systems](http://arxiv.org/abs/2605.23935v1)
...
Selection reason: 提出运行时权威重构与执行门控模型，为自主代码agent提供了动态依赖解析和安全性保障机制。
...
### [7] [QuantClaw: Precision Where It Matters for OpenClaw](http://arxiv.org/abs/2604.22577v1)
...
### [9] [Agentic World Modeling: Foundations, Capabilities, Laws, and Beyond](http://arxiv.org/abs/2604.22748v3)
...
### [10] [PExA: Parallel Exploration Agent for Complex Text-to-SQL](http://arxiv.org/abs/2604.22934v1)
...
### [11] [Towards Causally Interpretable Wi-Fi CSI-Based Human Activity Recognition with Discrete Latent Compression and LTL Rule Extraction](http://arxiv.org/abs/2604.22979v1)
...
### [12] [FormalScience: Scalable Human-in-the-Loop Autoformalisation of Science with Agentic Code Generation in Lean](http://arxiv.org/abs/2604.23002v1)
...
### [13] [A Decoupled Human-in-the-Loop System for Controlled Autonomy in Agentic Workflows](http://arxiv.org/abs/2604.23049v1)
...
### [14] [Don't Make the LLM Read the Graph: Make the Graph Think](http://arxiv.org/abs/2604.23057v2)
...
### [15] [Analytica: Soft Propositional Reasoning for Robust and Scalable LLM-Driven Analysis](http://arxiv.org/abs/2604.23072v1)
...
### [16] [Evaluating LLM-Based Goal Extraction in Requirements Engineering: Prompting Strategies and Their Limitations](http://arxiv.org/abs/2604.22207v1)
...
Selection reason: 评估LLM在需求工程中的目标提取与反馈循环机制，其生成-批评工作流可迁移到软件agent的任务规划。
...
### [17] [RAG-Reflect: Agentic Retrieval-Augmented Generation with Reflections for Comment-Driven Code Maintenance on Stack Overflow](http://arxiv.org/abs/2604.22217v1)
...
Selection reason: 面向代码维护的agentic RAG框架，集成检索、推理与自反思，可迁移到代码注释驱动的自动编辑。
...
### [18] [R2Code: A Self-Reflective LLM Framework for Requirements-to-Code Traceability](http://arxiv.org/abs/2604.22432v1)
...
Selection reason: 需求到代码追踪的LLM框架，包含自反思验证与动态上下文检索，可增强代码agent的需求理解和链路一致性。
...
### [19] [Test Design and Review Argumentation in AI-Assisted Test Generation](http://arxiv.org/abs/2604.22473v1)
...
Selection reason: 提出AI辅助测试生成中的论证结构化模板，可提高测试agent生成物件的可解释性与审查质量。
...
### [20] [From Natural Language to Verified Code: Toward AI Assisted Problem-to-Code Generation with Dafny-Based Formal Verification](http://arxiv.org/abs/2604.22601v1)
...
Selection reason: 面向自然语言到Dafny验证代码生成的prompt策略与自修复流程，直接相关代码生成与形式化验证agent。
...
### [21] [RealBench: A Repo-Level Code Generation Benchmark Aligned with Real-World Software Development Practices](http://arxiv.org/abs/2604.22659v2)
...
Selection reason: 提出仓库级代码生成基准RealBench，贴近真实开发实践，直接用于评估coding agent代码生成能力。
...
### [22] [Inferring Equivalence Classes from Legacy Undocumented Embedded Binaries for ISO 26262-Compliant Testing](http://arxiv.org/abs/2604.22673v1)
...
Selection reason: 二进制级等价类推断结合符号执行，为无文档固件自动生成测试分区，方法可迁移到agent测试设计。
...
### [23] [Navigating Large-Scale Document Collections: MuDABench for Multi-Document Analytical QA](http://arxiv.org/abs/2604.22239v1)
...
### [24] [SLIDERS: Systematic Reviews via Automated Evidence Synthesis and Reconciliation](http://arxiv.org/abs/2604.22294v2)
...
### [25] [Learning Evidence Highlighting for Frozen LLMs](http://arxiv.org/abs/2604.22565v2)
...
### [26] [How Do AI Agents Spend Your Money? Analyzing and Predicting Token Consumption in Agentic Coding Tasks](http://arxiv.org/abs/2604.22750v2)
...
Selection reason: 系统分析agentic coding任务的token消耗模式与可预测性，直接关乎coding agent成本优化。
...
### [27] [DeepImagine: Learning Biomedical Reasoning via Successive Counterfactual Imagining](http://arxiv.org/abs/2604.23054v1)
...
### [28] [BLAST: Benchmarking LLMs with ASP-based Structured Testing](http://arxiv.org/abs/2604.22306v1)
...
### [29] [An Undecidability Proof for the Plan Existence Problem](http://arxiv.org/abs/2604.22736v1)
*Antonis Achilleos*
...
### [30] [AutoINV: Automated Invariant Generation Framework for Formal Verification on High-Level Synthesis Designs](http://arxiv.org/abs/2604.22285v1)
...
Selection reason: 自动生成辅助断言加速HLS设计形式验证，其不变量生成与迭代选择机制可迁移到程序验证agent。
...
### [31] [Train in Vain: Functionality-Preserving Poisoning to Prevent Unauthorized Use of Code Datasets](http://arxiv.org/abs/2604.22291v1)
...
Selection reason: 面向代码数据集的功能保持投毒方法，涉及编译性和静态分析规避，对代码agent数据安全有参考价值。
...
### [32] [RouteGuard: Internal-Signal Detection of Skill Poisoning in LLM Agents](http://arxiv.org/abs/2604.22888v1)
...
### [33] [Reconstructive Authority Model: Runtime Execution Validity Under Partial Observability](http://arxiv.org/abs/2604.22898v1)
*Marcelo Fernandez - TraslaIA*

Main category: cs.CR

Comments: Agent Governance Series, Paper P5. Standalone resubmission following consolidation of P3+P4 into a single paper (P3/4, submit/7510907). Prior submission: submit/7501806. Companion papers on arXiv: P0 (2604.17511), P1 (2603.18829), P2 (2604.17517). Zenodo: 10.5281/zenodo.19669430
...
### [34] [Beyond Single-Agent Alignment: Preventing Context-Fragmented Violations in Multi-Agent Systems](http://arxiv.org/abs/2604.22879v1)
*Jie Wu,Ming Gong*
...
### [35] [From Demographics to Survey Anchors: Evaluating LLM Agents for Modeling Retirement Attitudes](http://arxiv.org/abs/2605.16303v1)
...
### [36] [Peer Identity Bias in Multi-Agent LLM Evaluation: An Empirical Study Using the TRUST Democratic Discourse Analysis Pipeline](http://arxiv.org/abs/2604.22971v1)
*Juergen Dietrich*
...
### [37] [An LLM-Driven Closed-Loop Autonomous Learning Framework for Robots Facing Uncovered Tasks in Open Environments](http://arxiv.org/abs/2604.22199v1)
*Hong Su*
...
### [38] [Vision-Language-Action in Robotics: A Survey of Datasets, Benchmarks, and Data Engines](http://arxiv.org/abs/2604.23001v1)
...
### [39] [Reliable Self-Harm Risk Screening via Adaptive Multi-Agent LLM Systems](http://arxiv.org/abs/2604.22154v1)
...
### [40] [Quantifying and Mitigating Self-Preference Bias of LLM Judges](http://arxiv.org/abs/2604.22891v4)
...
### [41] [FeatEHR-LLM: Leveraging Large Language Models for Feature Engineering in Electronic Health Records](http://arxiv.org/abs/2604.22534v1)
...
### [42] [SOLAR-RL: Semi-Online Long-horizon Assignment Reinforcement Learning](http://arxiv.org/abs/2604.22558v1)
