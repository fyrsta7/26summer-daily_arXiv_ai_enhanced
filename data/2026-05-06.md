...
### [1] [Deployment-Relevant Alignment Cannot Be Inferred from Model-Level Evaluation Alone](http://arxiv.org/abs/2605.04454v1)
...
Selection reason: 评估层级与固定脚手架协议可迁移到代码agent评测。
...
### [2] [SensingAgents: A Multi-Agent Collaborative Framework for Robust IMU Activity Recognition](http://arxiv.org/abs/2605.04608v1)
...
### [3] [AuditRepairBench: A Paired-Execution Trace Corpus for Evaluator-Channel Ranking Instability in Agent Repair](http://arxiv.org/abs/2605.04624v1)
...
Selection reason: 评估通道稳定性benchmark，直接指导agent修复评测设计。
...
### [4] [Reward-Decomposed Reinforcement Learning for Immersive Video Role-Playing](http://arxiv.org/abs/2605.04733v2)
...
### [5] [AgentTrust: Runtime Safety Evaluation and Interception for AI Agent Tool Use](http://arxiv.org/abs/2605.04785v1)
*Chenglin Yang*
...
### [6] [DecodingTrust-Agent Platform (DTap): A Controllable and Interactive Red-Teaming Platform for AI Agents](http://arxiv.org/abs/2605.04808v1)
...
### [7] [Strat-Reasoner: Reinforcing Strategic Reasoning of LLMs in Multi-Agent Games](http://arxiv.org/abs/2605.04906v2)
...
### [8] [On-line Learning in Tree MDPs by Treating Policies as Bandit Arms](http://arxiv.org/abs/2605.04979v1)
...
### [9] [Uno-Orchestra: Parsimonious Agent Routing via Selective Delegation](http://arxiv.org/abs/2605.05007v1)
...
### [10] [Executable World Models for ARC-AGI-3 in the Era of Coding Agents](http://arxiv.org/abs/2605.05138v2)
*Sergey Rodionov*
...
### [11] [LongSeeker: Elastic Context Orchestration for Long-Horizon Search Agents](http://arxiv.org/abs/2605.05191v1)
...
### [12] [Partial Evidence Bench: Benchmarking Authorization-Limited Evidence in Agentic Systems](http://arxiv.org/abs/2605.05379v1)
*Krti Tallam*
...
### [13] [BALAR : A Bayesian Agentic Loop for Active Reasoning](http://arxiv.org/abs/2605.05386v1)
...
### [14] [When Helpfulness Becomes Sycophancy: Sycophancy is a Boundary Failure Between Social Alignment and Epistemic Integrity in Large Language Models](http://arxiv.org/abs/2605.05403v1)
...
### [15] [PRISM: Perception Reasoning Interleaved for Sequential Decision Making](http://arxiv.org/abs/2605.05407v2)
...
### [16] [Agentic Retrieval-Augmented Generation for Financial Document Question Answering](http://arxiv.org/abs/2605.05409v2)
...
### [17] [From History to State: Constant-Context Skill Learning for LLM Agents](http://arxiv.org/abs/2605.05413v1)
...
### [18] [The Refusal--Compliance Tradeoff: A Large-Scale Safety Behavior Audit of Large Language Models](http://arxiv.org/abs/2605.05427v2)
...
### [19] [Authorization Propagation in Multi-Agent AI Systems: Identity Governance as Infrastructure](http://arxiv.org/abs/2605.05440v1)
*Krti Tallam*
...
### [20] [Agentic Discovery of Exchange-Correlation Density Functionals](http://arxiv.org/abs/2605.05460v1)
...
### [21] [Intentionality is a Design Decision: Measuring Functional Intentionality for Accountable AI Systems](http://arxiv.org/abs/2605.05475v1)
...
### [22] [LANTERN: LLM-Augmented Neurosymbolic Transfer with Experience-Gated Reasoning Networks](http://arxiv.org/abs/2605.05478v1)
...
### [23] [PARNESS: A Paper Harness for End-to-End Automated Scientific Research with Dynamic Workflows, Full-Text Indexing, and Cross-Run Knowledge Accumulation](http://arxiv.org/abs/2605.05258v1)
...
Selection reason: 动态工作流与知识索引可迁移到代码agent长程执行。
...
### [24] [Accountable Agents in Software Engineering: An Analysis of Terms of Service and a Research Roadmap](http://arxiv.org/abs/2605.04532v1)
*Christoph Treude*
...
Selection reason: agent责任与治理研究路线图，对工程化agent有参考价值。
...
### [25] [Beyond Retrieval: A Multitask Benchmark and Model for Code Search](http://arxiv.org/abs/2605.04615v2)
...
Selection reason: 多任务代码检索重排序benchmark，提升agent上下文质量。
...
### [26] [CodeEvolve: LLM-Driven Evolutionary Optimization with Runtime-Enriched Target Selection for Multi-Language Code Enhancement](http://arxiv.org/abs/2605.04677v1)
...
Selection reason: LLM驱动进化优化程序性能，runtime-guided选择+MCTS，直接命中SemOpt核心
...
### [27] [Bridging Generation and Training: A Systematic Review of Quality Issues in LLMs for Code](http://arxiv.org/abs/2605.05267v1)
...
Selection reason: 系统综述LLM代码生成质量与训练数据质量关联，对代码agent评测与数据治理有参考价值
...
### [28] [How Does Chunking Affect Retrieval-Augmented Code Completion? A Controlled Empirical Study](http://arxiv.org/abs/2605.04763v1)
...
Selection reason: 对RAG代码补全中chunking策略的系统实证，直接影响agent检索设计
...
### [29] [A meta-analysis of the effect of generative AI on productivity and learning in programming](http://arxiv.org/abs/2605.04779v1)
...
Selection reason: GenAI编程生产力与学习的元分析，提供背景证据，无直接方法迁移
...
### [30] [Patterns of Developer Adoption of LLM-Generated Code Refactoring Suggestions](http://arxiv.org/abs/2605.04835v1)
...
Selection reason: 开发者采纳LLM重构建议的模式分析，对agent反馈设计有参考价值
...
### [31] [Agentic Repository Mining: A Multi-Task Evaluation](http://arxiv.org/abs/2605.04845v1)
*Johannes Härtel*
...
Selection reason: 多任务评估LLM agent挖掘仓库，比较agent自主探索与传统上下文，直接相关coding agent
...
### [32] [SynConfRoute: Syntax-Aware Routing for Efficient Code Completion with Small CodeLLMs](http://arxiv.org/abs/2605.04894v1)
...
Selection reason: 面向代码补全的语法感知路由，结合置信度与语法验证提升pass@1并降成本，可迁移到agent推理
...
### [33] [Architectural Constraints Alignment in AI-assisted, Platform-based Service Development](http://arxiv.org/abs/2605.04973v1)
...
Selection reason: 检索增强脚手架与agent澄清循环对齐架构约束，可迁移至生产级代码生成agent
...
### [34] [Mise en Place for Agentic Coding: Deliberate Preparation as Context Engineering Methodology](http://arxiv.org/abs/2605.05400v1)
*Andrew Zigler*
...
Selection reason: 提出面向coding agent的上下午准备方法论（MEP），直接提升agent任务分解与执行。
...
### [35] [Modular Reinforcement Learning For Cooperative Swarms](http://arxiv.org/abs/2605.04939v1)
...
### [36] [Creative Robot Tool Use by Counterfactual Reasoning](http://arxiv.org/abs/2605.05411v1)
...
### [37] [UVMarvel: an Automated LLM-aided UVM Machine for Subsystem-level RTL Verification](http://arxiv.org/abs/2605.04704v2)
...
Selection reason: LLM自动构建UVM测试平台，代码生成+验证流程可迁移至硬件相关的code agent
...
### [38] [Design Conductor 2.0: An agent builds a TurboQuant inference accelerator in 80 hours](http://arxiv.org/abs/2605.05170v1)
...
### [39] [GEM: Graph-Enhanced Mixture-of-Experts with ReAct Agents for Dialogue State Tracking](http://arxiv.org/abs/2605.04449v1)
*Ziqi Zhu,Adithya Suresh,Tomal Deb,Iman Abbasnejad*

Main category: cs.CL

Comments: 9 pages, 1 figure. Submitted to AAAI 2026. Also available at Amazon Science: https://www.amazon.science/publications/gem-graph-enhanced-mixture-of-experts-with-react-agents-for-dialogue-state-tracking
...
### [40] [CAR: Query-Guided Confidence-Aware Reranking for Retrieval-Augmented Generation](http://arxiv.org/abs/2605.04495v1)
...
### [41] [RaguTeam at SemEval-2026 Task 8: Meno and Friends in a Judge-Orchestrated LLM Ensemble for Faithful Multi-Turn Response Generation](http://arxiv.org/abs/2605.04523v1)
...
### [42] [RLearner-LLM: Balancing Logical Grounding and Fluency in Large Language Models via Hybrid Direct Preference Optimization](http://arxiv.org/abs/2605.04539v4)
...
### [43] [Ask Before You Diagnose: Safe-Psych, a Sequential Evaluation Benchmark for LLMs in Psychiatry](http://arxiv.org/abs/2607.13036v1)
...
### [44] [Storage Is Not Memory: A Retrieval-Centered Architecture for Agent Recall](http://arxiv.org/abs/2605.04897v1)
...
### [45] [Misaligned by Reward: Socially Undesirable Preferences in LLMs](http://arxiv.org/abs/2605.05003v1)
...
### [46] [The Impossibility Triangle of Long-Context Modeling](http://arxiv.org/abs/2605.05066v1)
*Yan Zhou*
...
### [47] [Text Corpora as Concept Fields: Black-Box Hallucination and Novelty Measurement](http://arxiv.org/abs/2605.05103v2)
...
### [48] [ReaComp: Compiling LLM Reasoning into Symbolic Solvers for Efficient Program Synthesis](http://arxiv.org/abs/2605.05485v1)
...
### [49] [Maximizing Rollout Informativeness under a Fixed Budget: A Submodular View of Tree Search for Tool-Use Agentic Reinforcement Learning](http://arxiv.org/abs/2605.05262v1)
*Yuelin Hu,Zhenbo Yu,Zhengxue Cheng,Wei Liu,Li Song*
...
### [50] [Pen-Strategist: A Reasoning Framework for Penetration Testing Strategy Formation and Analysis](http://arxiv.org/abs/2605.04499v1)
...
### [51] [AFL-ICP: Enhancing Industrial Control Protocol Reliability via Specification-Guided Fuzzing](http://arxiv.org/abs/2605.04760v1)
...
Selection reason: LLM辅助规范驱动的协议模糊测试，自动化漏洞检测方法可迁移到代码agent测试
...
### [52] [SoK: Robustness in Large Language Models against Jailbreak Attacks](http://arxiv.org/abs/2605.05058v1)
...
### [53] [Securing the Agent: Vendor-Neutral, Multitenant Enterprise Retrieval and Tool Use](http://arxiv.org/abs/2605.05287v1)
...
Selection reason: 提出多租户agent检索与工具使用的安全隔离架构，可迁移至代码agent的工具权限与上下文隔离。
...
### [54] [How Far Are VLMs from Privacy Awareness in the Physical World? An Empirical Study](http://arxiv.org/abs/2605.05340v2)
...
### [55] [Agentic AI and the Industrialization of Cyber Offense: Forecast, Consequences, and Defensive Priorities for Enterprises and the Mittelstand](http://arxiv.org/abs/2605.06713v1)
*Christopher Koch*
...
### [56] [SADE: Symptom-Aware Diagnostic Escalation for LLM-Based Network Troubleshooting](http://arxiv.org/abs/2605.04530v1)
...
### [57] [Role-Based Agentic AI for Intent-Driven Network and Service Orchestration](http://arxiv.org/abs/2606.20580v1)
...
### [58] [Career-Aware Resume Tailoring via Multi-Source Retrieval-Augmented Generation with Provenance Tracking: A Case Study](http://arxiv.org/abs/2605.05257v1)
*Kumar Abhinav*
...
### [59] [NoisyCoconut: Counterfactual Consensus via Latent Space Reasoning](http://arxiv.org/abs/2605.08221v1)
...
### [60] [Skill Neologisms: Towards Skill-based Continual Learning](http://arxiv.org/abs/2605.04970v2)
...
### [61] [Continual Knowledge Updating in LLM Systems: Learning Through Multi-Timescale Memory Dynamics](http://arxiv.org/abs/2605.05097v3)
...
### [62] [Adaptive Policy Selection and Fine-Tuning under Interaction Budgets for Offline-to-Online Reinforcement Learning](http://arxiv.org/abs/2605.05123v1)
...
### [63] [SWE-WebDevBench: Evaluating Coding Agent Application Platforms as Virtual Software Agencies](http://arxiv.org/abs/2605.04637v1)
...
Selection reason: 编码agent平台评测框架，扩展agent能力评估维度。
...
### [64] [Evolving Idea Graphs with Learnable Edits-and-Commits for Multi-Agent Scientific Ideation](http://arxiv.org/abs/2605.04922v1)
...
### [65] [SODE: Analyzing Social Dynamics in LLM Agents](http://arxiv.org/abs/2605.23949v1)
