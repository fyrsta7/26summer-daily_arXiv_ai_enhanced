...
- [CodeEvolve: LLM-Driven Evolutionary Optimization with Runtime-Enriched Target Selection for Multi-Language Code Enhancement](http://arxiv.org/abs/2605.04677v1) — 相关度 0.95：LLM驱动进化优化程序性能，runtime-guided选择+MCTS，直接命中SemOpt核心
- [AuditRepairBench: A Paired-Execution Trace Corpus for Evaluator-Channel Ranking Instability in Agent Repair](http://arxiv.org/abs/2605.04624v1) — 相关度 0.92：评估通道稳定性benchmark，直接指导agent修复评测设计。
- [SWE-WebDevBench: Evaluating Coding Agent Application Platforms as Virtual Software Agencies](http://arxiv.org/abs/2605.04637v1) — 相关度 0.90：编码agent平台评测框架，扩展agent能力评估维度。
- [Beyond Retrieval: A Multitask Benchmark and Model for Code Search](http://arxiv.org/abs/2605.04615v2) — 相关度 0.88：多任务代码检索重排序benchmark，提升agent上下文质量。
- [Agentic Repository Mining: A Multi-Task Evaluation](http://arxiv.org/abs/2605.04845v1) — 相关度 0.85：多任务评估LLM agent挖掘仓库，比较agent自主探索与传统上下文，直接相关coding agent
- [How Does Chunking Affect Retrieval-Augmented Code Completion? A Controlled Empirical Study](http://arxiv.org/abs/2605.04763v1) — 相关度 0.85：对RAG代码补全中chunking策略的系统实证，直接影响agent检索设计
- [SynConfRoute: Syntax-Aware Routing for Efficient Code Completion with Small CodeLLMs](http://arxiv.org/abs/2605.04894v1) — 相关度 0.85：面向代码补全的语法感知路由，结合置信度与语法验证提升pass@1并降成本，可迁移到agent推理
- [Mise en Place for Agentic Coding: Deliberate Preparation as Context Engineering Methodology](http://arxiv.org/abs/2605.05400v1) — 相关度 0.82：提出面向coding agent的上下午准备方法论（MEP），直接提升agent任务分解与执行。
- [PARNESS: A Paper Harness for End-to-End Automated Scientific Research with Dynamic Workflows, Full-Text Indexing, and Cross-Run Knowledge Accumulation](http://arxiv.org/abs/2605.05258v1) — 相关度 0.80：动态工作流与知识索引可迁移到代码agent长程执行。
- [Securing the Agent: Vendor-Neutral, Multitenant Enterprise Retrieval and Tool Use](http://arxiv.org/abs/2605.05287v1) — 相关度 0.78：提出多租户agent检索与工具使用的安全隔离架构，可迁移至代码agent的工具权限与上下文隔离。
- [Bridging Generation and Training: A Systematic Review of Quality Issues in LLMs for Code](http://arxiv.org/abs/2605.05267v1) — 相关度 0.75：系统综述LLM代码生成质量与训练数据质量关联，对代码agent评测与数据治理有参考价值
- [UVMarvel: an Automated LLM-aided UVM Machine for Subsystem-level RTL Verification](http://arxiv.org/abs/2605.04704v2) — 相关度 0.75：LLM自动构建UVM测试平台，代码生成+验证流程可迁移至硬件相关的code agent
- [AFL-ICP: Enhancing Industrial Control Protocol Reliability via Specification-Guided Fuzzing](http://arxiv.org/abs/2605.04760v1) — 相关度 0.70：LLM辅助规范驱动的协议模糊测试，自动化漏洞检测方法可迁移到代码agent测试
- [Architectural Constraints Alignment in AI-assisted, Platform-based Service Development](http://arxiv.org/abs/2605.04973v1) — 相关度 0.70：检索增强脚手架与agent澄清循环对齐架构约束，可迁移至生产级代码生成agent
- [Deployment-Relevant Alignment Cannot Be Inferred from Model-Level Evaluation Alone](http://arxiv.org/abs/2605.04454v1) — 相关度 0.70：评估层级与固定脚手架协议可迁移到代码agent评测。
- [A meta-analysis of the effect of generative AI on productivity and learning in programming](http://arxiv.org/abs/2605.04779v1) — 相关度 0.55：GenAI编程生产力与学习的元分析，提供背景证据，无直接方法迁移
- [Accountable Agents in Software Engineering: An Analysis of Terms of Service and a Research Roadmap](http://arxiv.org/abs/2605.04532v1) — 相关度 0.55：agent责任与治理研究路线图，对工程化agent有参考价值。
- [Patterns of Developer Adoption of LLM-Generated Code Refactoring Suggestions](http://arxiv.org/abs/2605.04835v1) — 相关度 0.50：开发者采纳LLM重构建议的模式分析，对agent反馈设计有参考价值
