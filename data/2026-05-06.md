...
### [8] [Spatial Priming Outperforms Semantic Prompting: A Grid-Based Approach to Improving LLM Accuracy on Chart Data Extraction](http://arxiv.org/abs/2605.08220v1)
...
### [9] [On-line Learning in Tree MDPs by Treating Policies as Bandit Arms](http://arxiv.org/abs/2605.04979v1)
...
### [10] [Uno-Orchestra: Parsimonious Agent Routing via Selective Delegation](http://arxiv.org/abs/2605.05007v1)
...
### [11] [Executable World Models for ARC-AGI-3 in the Era of Coding Agents](http://arxiv.org/abs/2605.05138v2)
*Sergey Rodionov*
...
### [12] [LongSeeker: Elastic Context Orchestration for Long-Horizon Search Agents](http://arxiv.org/abs/2605.05191v1)
...
### [13] [Partial Evidence Bench: Benchmarking Authorization-Limited Evidence in Agentic Systems](http://arxiv.org/abs/2605.05379v1)
*Krti Tallam*
...
### [14] [BALAR : A Bayesian Agentic Loop for Active Reasoning](http://arxiv.org/abs/2605.05386v1)
...
### [15] [When Helpfulness Becomes Sycophancy: Sycophancy is a Boundary Failure Between Social Alignment and Epistemic Integrity in Large Language Models](http://arxiv.org/abs/2605.05403v1)
...
### [16] [PRISM: Perception Reasoning Interleaved for Sequential Decision Making](http://arxiv.org/abs/2605.05407v2)
...
### [17] [Agentic Retrieval-Augmented Generation for Financial Document Question Answering](http://arxiv.org/abs/2605.05409v2)
...
### [18] [From History to State: Constant-Context Skill Learning for LLM Agents](http://arxiv.org/abs/2605.05413v1)
...
### [19] [The Refusal--Compliance Tradeoff: A Large-Scale Safety Behavior Audit of Large Language Models](http://arxiv.org/abs/2605.05427v2)
...
### [20] [Authorization Propagation in Multi-Agent AI Systems: Identity Governance as Infrastructure](http://arxiv.org/abs/2605.05440v1)
*Krti Tallam*
...
### [21] [Agentic Discovery of Exchange-Correlation Density Functionals](http://arxiv.org/abs/2605.05460v1)
...
### [22] [Intentionality is a Design Decision: Measuring Functional Intentionality for Accountable AI Systems](http://arxiv.org/abs/2605.05475v1)
...
### [23] [LANTERN: LLM-Augmented Neurosymbolic Transfer with Experience-Gated Reasoning Networks](http://arxiv.org/abs/2605.05478v1)
...
### [24] [SADE: Symptom-Aware Diagnostic Escalation for LLM-Based Network Troubleshooting](http://arxiv.org/abs/2605.04530v1)
...
### [25] [Role-Based Agentic AI for Intent-Driven Network and Service Orchestration](http://arxiv.org/abs/2606.20580v1)
...
### [26] [SWE-WebDevBench: Evaluating Coding Agent Application Platforms as Virtual Software Agencies](http://arxiv.org/abs/2605.04637v1)
...
### [27] [Evolving Idea Graphs with Learnable Edits-and-Commits for Multi-Agent Scientific Ideation](http://arxiv.org/abs/2605.04922v1)
...
### [28] [SODE: Analyzing Social Dynamics in LLM Agents](http://arxiv.org/abs/2605.23949v1)
...
### [29] [UVMarvel: an Automated LLM-aided UVM Machine for Subsystem-level RTL Verification](http://arxiv.org/abs/2605.04704v2)
...
### [30] [Design Conductor 2.0: An agent builds a TurboQuant inference accelerator in 80 hours](http://arxiv.org/abs/2605.05170v1)
...
### [31] [Ensuring Reliability in Programming Knowledge Tracing: A Re-evaluation of Attention-augmented Models and Experimental Protocols](http://arxiv.org/abs/2605.04727v1)
...
### [32] [NoisyCoconut: Counterfactual Consensus via Latent Space Reasoning](http://arxiv.org/abs/2605.08221v1)
...
### [33] [Skill Neologisms: Towards Skill-based Continual Learning](http://arxiv.org/abs/2605.04970v2)
...
### [34] [Continual Knowledge Updating in LLM Systems: Learning Through Multi-Timescale Memory Dynamics](http://arxiv.org/abs/2605.05097v3)
...
### [35] [Adaptive Policy Selection and Fine-Tuning under Interaction Budgets for Offline-to-Online Reinforcement Learning](http://arxiv.org/abs/2605.05123v1)
...
### [36] [Modular Reinforcement Learning For Cooperative Swarms](http://arxiv.org/abs/2605.04939v1)
...
### [37] [Creative Robot Tool Use by Counterfactual Reasoning](http://arxiv.org/abs/2605.05411v1)
...
### [38] [Toward a Risk Assessment Framework for Institutional DeFi: A Nine-Dimension Approach](http://arxiv.org/abs/2605.05145v1)
...
### [45] [UzWordnet and Generative AI for Learning Uzbek by Game Playing](http://arxiv.org/abs/2607.14104v1)
...
### [46] [Misaligned by Reward: Socially Undesirable Preferences in LLMs](http://arxiv.org/abs/2605.05003v1)
...
### [47] [The Impossibility Triangle of Long-Context Modeling](http://arxiv.org/abs/2605.05066v1)
*Yan Zhou*
...
### [48] [Text Corpora as Concept Fields: Black-Box Hallucination and Novelty Measurement](http://arxiv.org/abs/2605.05103v2)
...
### [49] [ReaComp: Compiling LLM Reasoning into Symbolic Solvers for Efficient Program Synthesis](http://arxiv.org/abs/2605.05485v1)
...
### [50] [AISSA: Implementation and Deployment of an AI-based Student Slides Analysis tool for Academic Presentations](http://arxiv.org/abs/2605.04729v1)
...
### [51] [AICoFe: Implementation and Deployment of an AI-Based Collaborative Feedback System for Higher Education](http://arxiv.org/abs/2605.04740v1)
...
### [52] [Trustworthiness in Digital Twin Systems: Systematic Review and Research Horizons](http://arxiv.org/abs/2605.08208v1)
...
### [53] [AI SciBrief as a Gateway to Research: A Framework for Onboarding Students into New Research Areas](http://arxiv.org/abs/2606.12413v1)
...
### [54] [Career-Aware Resume Tailoring via Multi-Source Retrieval-Augmented Generation with Provenance Tracking: A Case Study](http://arxiv.org/abs/2605.05257v1)
*Kumar Abhinav*
...
### [55] [Pen-Strategist: A Reasoning Framework for Penetration Testing Strategy Formation and Analysis](http://arxiv.org/abs/2605.04499v1)
...
### [56] [AFL-ICP: Enhancing Industrial Control Protocol Reliability via Specification-Guided Fuzzing](http://arxiv.org/abs/2605.04760v1)
...
### [57] [SoK: Robustness in Large Language Models against Jailbreak Attacks](http://arxiv.org/abs/2605.05058v1)
...
### [58] [Securing the Agent: Vendor-Neutral, Multitenant Enterprise Retrieval and Tool Use](http://arxiv.org/abs/2605.05287v1)
...
### [59] [How Far Are VLMs from Privacy Awareness in the Physical World? An Empirical Study](http://arxiv.org/abs/2605.05340v2)
...
### [60] [Evolution of Log-Based Detection Rules in Public Repositories](http://arxiv.org/abs/2605.05383v3)
...
### [61] [Agentic AI and the Industrialization of Cyber Offense: Forecast, Consequences, and Defensive Priorities for Enterprises and the Mittelstand](http://arxiv.org/abs/2605.06713v1)
*Christopher Koch*
...
### [62] [Maximizing Rollout Informativeness under a Fixed Budget: A Submodular View of Tree Search for Tool-Use Agentic Reinforcement Learning](http://arxiv.org/abs/2605.05262v1)
*Yuelin Hu,Zhenbo Yu,Zhengxue Cheng,Wei Liu,Li Song*
