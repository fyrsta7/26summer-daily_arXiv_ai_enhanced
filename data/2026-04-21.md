...
### [1] [AutomationBench](http://arxiv.org/abs/2604.18934v1)
...
### [2] [SAVOIR: Learning Social Savoir-Faire via Shapley-based Reward Attribution](http://arxiv.org/abs/2604.18982v1)
...
### [3] [On Accelerating Grounded Code Development for Research](http://arxiv.org/abs/2604.19022v1)
*Santosh Ganji*
...
### [4] [OLLM: Options-based Large Language Models](http://arxiv.org/abs/2604.19087v1)
...
### [5] [How Much Thinking is Enough? Quantifying and Understanding Redundancy in LLM Reasoning](http://arxiv.org/abs/2605.23926v1)
...
### [6] [Forage V2: Knowledge Evolution and Transfer in Autonomous Agent Organizations](http://arxiv.org/abs/2604.19837v1)
*Huaqing Xie*
...
### [7] [ClawNet: Human-Symbiotic Agent Network for Cross-User Autonomous Cooperation](http://arxiv.org/abs/2604.19211v1)
...
### [8] [Explicit Trait Inference for Multi-Agent Coordination](http://arxiv.org/abs/2604.19278v2)
...
### [9] [Large Language Models Exhibit Normative Conformity](http://arxiv.org/abs/2604.19301v1)
...
### [10] [Do Agents Dream of Root Shells? Partial-Credit Evaluation of LLM Agents in Capture the Flag Challenges](http://arxiv.org/abs/2604.19354v2)
...
Selection reason: CTF环境中LLM代理评测基准，提出部分信用评分方法，可迁移到其他代理评测
...
### [11] [Four-Axis Decision Alignment for Long-Horizon Enterprise AI Agents](http://arxiv.org/abs/2604.19457v1)
...
### [12] [Do LLMs Game Formalization? Evaluating Faithfulness in Logical Reasoning](http://arxiv.org/abs/2604.19459v1)
...
### [13] [CoDA: Towards Effective Cross-domain Knowledge Transfer via CoT-guided Domain Adaptation](http://arxiv.org/abs/2604.19488v1)
...
### [14] [From Experience to Skill: Multi-Agent Generative Engine Optimization via Reusable Strategy Learning](http://arxiv.org/abs/2604.19516v1)
...
### [15] [Context: Proactive Goal-Directed Intelligence via Composable Sandboxed Programs, Declarative Wiring, and Structured Interaction](http://arxiv.org/abs/2605.23928v1)
*Gregory Magarshak*
...
Selection reason: 主动目标导向代理架构，含可组合沙箱程序、声明式接线和形式化代价定理，可迁移到代码代理设计
...
### [16] [Revac: A Social Deduction Reasoning Agent](http://arxiv.org/abs/2604.19523v1)
...
### [17] [Integrating Anomaly Detection into Agentic AI for Proactive Risk Management in Human Activity](http://arxiv.org/abs/2604.19538v1)
...
### [18] [AblateCell: A Reproduce-then-Ablate Agent for Virtual Cell Repositories](http://arxiv.org/abs/2604.19606v2)
...
### [19] [Time Series Augmented Generation for Financial Applications](http://arxiv.org/abs/2604.19633v1)
...
### [20] [SafetyALFRED: Evaluating Safety-Conscious Planning of Multimodal Large Language Models](http://arxiv.org/abs/2604.19638v1)
...
### [21] [A-MAR: Agent-based Multimodal Art Retrieval for Fine-Grained Artwork Understanding](http://arxiv.org/abs/2604.19689v1)
...
### [22] [CogniConsole: Externalizing Inference-Time Control as a Formal Abstraction for Reliable LLM Interactions](http://arxiv.org/abs/2607.08774v1)
...
### [23] [Overcoming the Impedance Mismatch: A Theoretical Roadmap for Fusing Foundation Models and Knowledge Graphs](http://arxiv.org/abs/2606.15656v1)
...
### [24] [Learning When Not to Decide: A Framework for Overcoming Factual Presumptuousness in AI Adjudication](http://arxiv.org/abs/2604.19895v1)
...
### [25] [CreativeGame:Toward Mechanic-Aware Creative Game Generation](http://arxiv.org/abs/2604.19926v1)
...
### [26] [What Makes a Good AI Review? Concern-Level Diagnostics for AI Peer Review](http://arxiv.org/abs/2604.19998v1)
*Ming Jin*
...
### [27] [Toward Reliable Design of LLM-Enabled Agentic Workflows: Optimizing Latency-Reliability-Cost Tradeoffs](http://arxiv.org/abs/2605.23929v1)
...
Selection reason: 直接研究LLM agent工作流的延迟-可靠性-成本权衡与优化分配策略，强相关。
...
### [28] [Automated LTL Specification Generation from Industrial Aerospace Requirements](http://arxiv.org/abs/2604.21715v1)
...
Selection reason: LLM结合数据字典与模板生成LTL规格，可迁移到代码代理的规格生成与验证流程
...
### [29] [Proactive Detection of GUI Defects in Multi-Window Scenarios via Multimodal Reasoning](http://arxiv.org/abs/2604.19081v1)
...
Selection reason: 多模态LLM主动检测多窗口GUI缺陷，含测试基准，可迁移到UI测试代理
...
### [30] [MUCOCO: Automated Consistency Testing of Code LLMs](http://arxiv.org/abs/2604.19086v1)
...
Selection reason: 基于语义保持突变的代码LLM一致性自动测试方法，可直接用于代码模型评测
...
### [31] [Cascaded Code Editing: Large-Small Model Collaboration for Effective and Efficient Code Editing](http://arxiv.org/abs/2604.19201v1)
...
Selection reason: 大-小模型级联的代码编辑框架，兼顾效果与效率，可迁移到代码编辑代理
...
### [32] [iCoRe: An Iterative Correlation-Aware Retriever for Bug Reproduction Test Generation](http://arxiv.org/abs/2604.19224v2)
...
Selection reason: 迭代相关感知检索器用于bug复现测试生成，含反馈循环，直接提升测试代理
...
### [33] [DebugRepair: Enhancing LLM-Based Automated Program Repair via Self-Directed Debugging](http://arxiv.org/abs/2604.19305v1)
...
Selection reason: 自我导向调试增强LLM程序修复，利用中间运行时状态，直接提升APR
...
### [34] [Improving LLM-Driven Test Generation by Learning from Mocking Information](http://arxiv.org/abs/2604.19315v1)
...
Selection reason: 利用现有mock信息指导LLM测试生成，迭代生成修复，提升测试覆盖率
...
### [35] [Systematic Detection of Energy Regression and Corresponding Code Patterns in Java Projects](http://arxiv.org/abs/2604.19373v1)
...
Selection reason: 自动检测Java项目能量回归及代码反模式，与性能优化直接相关
...
### [36] [CASCADE: Detecting Inconsistencies between Code and Documentation with Automatic Test Generation](http://arxiv.org/abs/2604.19400v1)
...
Selection reason: 自动生成测试检测代码与文档不一致，双重验证降低误报，可迁移到一致性检查代理
...
### [37] [Crash-free Deductive Verifiers](http://arxiv.org/abs/2604.19448v1)
...
Selection reason: 使用模糊测试提升演绎验证器的健壮性，对验证工具测试有参考价值
...
### [38] [On Reasoning-Centric LLM-based Automated Theorem Proving](http://arxiv.org/abs/2604.19558v1)
...
Selection reason: 推理中心的定理证明代理，含反思验证与计划检索，可迁移到代码代理
...
### [39] [PlayCoder: Making LLM-Generated GUI Code Playable](http://arxiv.org/abs/2604.19742v1)
...
Selection reason: 提出GUI代码生成基准、LLM测试agent和闭环修复框架，直接相关coding agent。
...
### [40] [ViBR: Automated Bug Replay from Video-based Reports using Vision-Language Models](http://arxiv.org/abs/2604.19905v1)
...
Selection reason: 利用VLM自动复现GUI视频报告中的bug，可迁移至调试/测试agent。
...
### [41] [Insights into Security-Related AI-Generated Pull Requests](http://arxiv.org/abs/2604.19965v1)
...
Selection reason: 对AI生成PR的安全实证分析，为agent可靠性与安全改进提供参考。
...
### [42] [FIKA: Expanding Dependency Reachability with Executability Guarantees](http://arxiv.org/abs/2604.20015v1)
...
Selection reason: 通过代码执行保证依赖可达性，提升静态分析/漏洞验证，可用于agent验证。
...
### [43] [Environmental Understanding Vision-Language Model for Embodied Agent](http://arxiv.org/abs/2604.19839v1)
...
### [44] [If you're waiting for a sign... that might not be it! Mitigating Trust Boundary Confusion from Visual Injections on Vision-Language Agentic Systems](http://arxiv.org/abs/2604.19844v1)
...
### [45] [EgoSelf: From Memory to Personalized Egocentric Assistant](http://arxiv.org/abs/2604.19564v2)
...
### [46] [Behavioral Transfer in AI Agents: Evidence and Privacy Implications](http://arxiv.org/abs/2604.19925v1)
...
### [47] [How Do Answer Tokens Read Reasoning Traces? Self-Reading Patterns in Thinking LLMs for Quantitative Reasoning](http://arxiv.org/abs/2604.19149v1)
...
### [48] [The Structural Attention Tax: How Retrieval Format Hijacks In-Context Learning Independent of Content](http://arxiv.org/abs/2606.11198v1)
*Yuqi Zhang,Di Zhang*
...
### [49] [Talking to a Know-It-All GPT or a Second-Guesser Claude? How Repair reveals unreliable Multi-Turn Behavior in LLMs](http://arxiv.org/abs/2604.19245v2)
...
### [50] [Rethinking Scale: Deployment Trade-offs of Small Language Models under Agent Paradigms](http://arxiv.org/abs/2604.19299v1)
...
### [51] [Durable Evaluation Framework: Adversarial Arbitration for Sycophancy Reduction in Large Language Models](http://arxiv.org/abs/2606.07532v2)
*Sam Ryan*
...
### [52] [Taming Actor-Observer Asymmetry in Agents via Dialectical Alignment](http://arxiv.org/abs/2604.19548v1)
...
### [53] [Chat2Workflow: A Benchmark for Generating Executable Visual Workflows with Natural Language](http://arxiv.org/abs/2604.19667v2)
...
### [54] [In-Situ Behavioral Evaluation for LLM Fairness, Not Standardized-Test Scores](http://arxiv.org/abs/2605.12530v1)
...
### [55] [NightFeats @ MMU-RAGent NeurIPS 2025: A Context-Optimized Multi-Agent RAG System for the Text-to-Text Track](http://arxiv.org/abs/2606.11199v1)
...
### [56] [TriEx: A Game-based Tri-View Framework for Explaining Internal Reasoning in Multi-Agent LLMs](http://arxiv.org/abs/2604.20043v1)
...
### [57] [Query-Aware Flow Diffusion for Graph-Based RAG with Retrieval Guarantees](http://arxiv.org/abs/2605.18775v1)
...
### [58] [Mask-to-Correct$^+$: Leveraging Retriever Diversity for Masking-guided Faithful Fact Correction](http://arxiv.org/abs/2605.18776v1)
...
### [59] [Structure Guided Retrieval-Augmented Generation for Factual Queries](http://arxiv.org/abs/2604.22843v1)
...
### [60] [AgenticRecTune: Multi-Agent with Self-Evolving Skillhub for Recommendation System Optimization](http://arxiv.org/abs/2604.26969v2)
...
### [61] [M$^{2}$GRPO: Mamba-based Multi-Agent Group Relative Policy Optimization for Biomimetic Underwater Robots Pursuit](http://arxiv.org/abs/2604.19404v1)
...
### [62] [Multi-Cycle Spatio-Temporal Adaptation in Human-Robot Teaming](http://arxiv.org/abs/2604.19670v1)
...
### [63] [Mesh Memory Protocol: Semantic Infrastructure for Multi-Agent LLM Systems](http://arxiv.org/abs/2604.19540v1)
*Hongwei Xu*
...
### [64] [Security Is Relative: Training-Free Vulnerability Detection via Multi-Agent Behavioral Contract Synthesis](http://arxiv.org/abs/2604.19012v1)
...
Selection reason: 多代理行为契约合成进行漏洞检测，训练免费，与代码安全分析直接相关
...
### [65] [Refute-or-Promote: An Adversarial Stage-Gated Multi-Agent Review Methodology for High-Precision LLM-Assisted Defect Discovery](http://arxiv.org/abs/2604.19049v1)
*Abhinav Agarwal*
...
Selection reason: 对抗式多代理评审方法，显著提升LLM缺陷发现精度，并可迁移到SWE-bench
...
### [66] [Evaluating LLM-Generated Obfuscated XSS Payloads for Machine Learning-Based Detection](http://arxiv.org/abs/2604.19526v1)
...
Selection reason: LLM生成混淆XSS payload并基于运行时行为评估，对安全测试数据生成有参考价值
...
### [67] [Cyber Defense Benchmark: Agentic Threat Hunting Evaluation for LLMs in SecOps](http://arxiv.org/abs/2604.19533v3)
...
### [68] [An AI Agent Execution Environment to Safeguard User Data](http://arxiv.org/abs/2604.19657v1)
...
### [69] [BONSAI: A Mixed-Initiative Workspace for Human-AI Co-Development of Visual Analytics Applications](http://arxiv.org/abs/2604.19247v1)
...
Selection reason: 混合主动多代理VA开发工作区，模块化架构与过程可部分迁移到代码协同开发
...
### [70] [Streamliners for Answer Set Programming](http://arxiv.org/abs/2604.19251v1)
...
### [71] [Decompose, Structure, and Repair: A Neuro-Symbolic Framework for Autoformalization via Operator Trees](http://arxiv.org/abs/2604.19000v2)
...
### [72] [Evaluation-driven Scaling for Scientific Discovery](http://arxiv.org/abs/2604.19341v1)
...
### [73] [EVPO: Explained Variance Policy Optimization for Adaptive Critic Utilization in LLM Post-Training](http://arxiv.org/abs/2604.19485v1)
...
### [74] [FASTER: Value-Guided Sampling for Fast RL](http://arxiv.org/abs/2604.19730v1)
...
### [75] [DR-Venus: Towards Frontier Edge-Scale Deep Research Agents with Only 10K Open Data](http://arxiv.org/abs/2604.19859v1)
...
### [76] [Reinforcing privacy reasoning in LLMs via normative simulacra from fiction](http://arxiv.org/abs/2604.20904v1)
...
### [77] [MoBayes: A Modular Bayesian Framework for Separating Reasoning from Language in Conversational Clinical Decision Support](http://arxiv.org/abs/2604.20022v3)
...
### [78] [Agentic Literacy Debt: A Structural Problem the AI Literacy Field Has Not Yet Named](http://arxiv.org/abs/2605.27396v1)
*Rohith Nama*
...
### [79] [ChipCraftBrain: Validation-First RTL Generation via Multi-Agent Orchestration](http://arxiv.org/abs/2604.19856v1)
*Cagri Eryilmaz*
