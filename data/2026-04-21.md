...
- [DebugRepair: Enhancing LLM-Based Automated Program Repair via Self-Directed Debugging](http://arxiv.org/abs/2604.19305v1) — 相关度 0.90：自我导向调试增强LLM程序修复，利用中间运行时状态，直接提升APR
- [PlayCoder: Making LLM-Generated GUI Code Playable](http://arxiv.org/abs/2604.19742v1) — 相关度 0.90：提出GUI代码生成基准、LLM测试agent和闭环修复框架，直接相关coding agent。
- [Refute-or-Promote: An Adversarial Stage-Gated Multi-Agent Review Methodology for High-Precision LLM-Assisted Defect Discovery](http://arxiv.org/abs/2604.19049v1) — 相关度 0.90：对抗式多代理评审方法，显著提升LLM缺陷发现精度，并可迁移到SWE-bench
- [Security Is Relative: Training-Free Vulnerability Detection via Multi-Agent Behavioral Contract Synthesis](http://arxiv.org/abs/2604.19012v1) — 相关度 0.90：多代理行为契约合成进行漏洞检测，训练免费，与代码安全分析直接相关
- [Toward Reliable Design of LLM-Enabled Agentic Workflows: Optimizing Latency-Reliability-Cost Tradeoffs](http://arxiv.org/abs/2605.23929v1) — 相关度 0.90：直接研究LLM agent工作流的延迟-可靠性-成本权衡与优化分配策略，强相关。
- [CASCADE: Detecting Inconsistencies between Code and Documentation with Automatic Test Generation](http://arxiv.org/abs/2604.19400v1) — 相关度 0.80：自动生成测试检测代码与文档不一致，双重验证降低误报，可迁移到一致性检查代理
- [Cascaded Code Editing: Large-Small Model Collaboration for Effective and Efficient Code Editing](http://arxiv.org/abs/2604.19201v1) — 相关度 0.80：大-小模型级联的代码编辑框架，兼顾效果与效率，可迁移到代码编辑代理
- [Improving LLM-Driven Test Generation by Learning from Mocking Information](http://arxiv.org/abs/2604.19315v1) — 相关度 0.80：利用现有mock信息指导LLM测试生成，迭代生成修复，提升测试覆盖率
- [MUCOCO: Automated Consistency Testing of Code LLMs](http://arxiv.org/abs/2604.19086v1) — 相关度 0.80：基于语义保持突变的代码LLM一致性自动测试方法，可直接用于代码模型评测
- [On Reasoning-Centric LLM-based Automated Theorem Proving](http://arxiv.org/abs/2604.19558v1) — 相关度 0.80：推理中心的定理证明代理，含反思验证与计划检索，可迁移到代码代理
- [iCoRe: An Iterative Correlation-Aware Retriever for Bug Reproduction Test Generation](http://arxiv.org/abs/2604.19224v2) — 相关度 0.80：迭代相关感知检索器用于bug复现测试生成，含反馈循环，直接提升测试代理
- [ViBR: Automated Bug Replay from Video-based Reports using Vision-Language Models](http://arxiv.org/abs/2604.19905v1) — 相关度 0.75：利用VLM自动复现GUI视频报告中的bug，可迁移至调试/测试agent。
- [Automated LTL Specification Generation from Industrial Aerospace Requirements](http://arxiv.org/abs/2604.21715v1) — 相关度 0.70：LLM结合数据字典与模板生成LTL规格，可迁移到代码代理的规格生成与验证流程
- [Context: Proactive Goal-Directed Intelligence via Composable Sandboxed Programs, Declarative Wiring, and Structured Interaction](http://arxiv.org/abs/2605.23928v1) — 相关度 0.70：主动目标导向代理架构，含可组合沙箱程序、声明式接线和形式化代价定理，可迁移到代码代理设计
- [Do Agents Dream of Root Shells? Partial-Credit Evaluation of LLM Agents in Capture the Flag Challenges](http://arxiv.org/abs/2604.19354v2) — 相关度 0.70：CTF环境中LLM代理评测基准，提出部分信用评分方法，可迁移到其他代理评测
- [FIKA: Expanding Dependency Reachability with Executability Guarantees](http://arxiv.org/abs/2604.20015v1) — 相关度 0.70：通过代码执行保证依赖可达性，提升静态分析/漏洞验证，可用于agent验证。
- [Proactive Detection of GUI Defects in Multi-Window Scenarios via Multimodal Reasoning](http://arxiv.org/abs/2604.19081v1) — 相关度 0.70：多模态LLM主动检测多窗口GUI缺陷，含测试基准，可迁移到UI测试代理
- [Systematic Detection of Energy Regression and Corresponding Code Patterns in Java Projects](http://arxiv.org/abs/2604.19373v1) — 相关度 0.70：自动检测Java项目能量回归及代码反模式，与性能优化直接相关
- [BONSAI: A Mixed-Initiative Workspace for Human-AI Co-Development of Visual Analytics Applications](http://arxiv.org/abs/2604.19247v1) — 相关度 0.60：混合主动多代理VA开发工作区，模块化架构与过程可部分迁移到代码协同开发
- [Evaluating LLM-Generated Obfuscated XSS Payloads for Machine Learning-Based Detection](http://arxiv.org/abs/2604.19526v1) — 相关度 0.60：LLM生成混淆XSS payload并基于运行时行为评估，对安全测试数据生成有参考价值
- [Insights into Security-Related AI-Generated Pull Requests](http://arxiv.org/abs/2604.19965v1) — 相关度 0.60：对AI生成PR的安全实证分析，为agent可靠性与安全改进提供参考。
- [Crash-free Deductive Verifiers](http://arxiv.org/abs/2604.19448v1) — 相关度 0.50：使用模糊测试提升演绎验证器的健壮性，对验证工具测试有参考价值
