...
### [1] [MoCA-Agent: A Market-of-Claims Code Agent for Financial and Numerical Reasoning](http://arxiv.org/abs/2606.11537v2)
...
### [2] [SkillJuror: Measuring How Agent Skill Organization Changes Runtime Behavior](http://arxiv.org/abs/2606.11543v1)
...
Selection reason: 提出 SkillJuror 评估 agent Skill 组织形式对运行行为的影响，对 coding agent 的 Skill 设计与评测有直接价值。
...
### [3] [DrugBench: Evaluating AI Control Protocols for Medication Harm Mitigation](http://arxiv.org/abs/2606.20663v1)
...
### [4] [HERO: Hindsight-Enhanced Reflection from Environment Observations for Agentic Self-Distillation](http://arxiv.org/abs/2606.11559v1)
...
### [5] [Architecture-Aware Reinforcement Learning Makes Sliding-Window Attention Competitive in Math Reasoning](http://arxiv.org/abs/2606.11634v1)
...
### [6] [Orchestra-o1: Omnimodal Agent Orchestration](http://arxiv.org/abs/2606.13707v1)
...
### [7] [TreeSeeker: Tree-Structured Trial, Error, and Return in Deep Search](http://arxiv.org/abs/2606.11662v1)
...
### [8] [Organize then Retrieve: Hierarchical Memory Navigation for Efficient Agents](http://arxiv.org/abs/2606.11680v1)
...
### [9] [Mind the Perspective: Let's Reason Recursively for Theory of Mind](http://arxiv.org/abs/2606.11724v1)
...
### [10] [SVoT: State-aware Visualization-of-Thought for Spatial Reasoning via Reinforcement Learning](http://arxiv.org/abs/2606.11770v1)
...
### [11] [StatefulDiscovery: Evidence-Calibrated Claim Formation in Open-Ended Scientific Discovery](http://arxiv.org/abs/2606.11851v1)
...
### [12] [AutoMine Solution for AV2 2026 Scenario Mining Challenge](http://arxiv.org/abs/2606.11874v1)
...
### [13] [Embodied-BenchClaw: An Autonomous Multi-Agent System for Embodied Spatial Intelligence Benchmark Construction](http://arxiv.org/abs/2606.11909v1)
...
### [14] [MODF-SIR: A Multi-agent Omni-modal Distilled Framework for Social Intelligence Reasoning](http://arxiv.org/abs/2606.12018v1)
...
### [15] [Human-Enhanced Loop Modeling (HELM): Agent-Based Finite Element Modeling of Concrete Bridge Barriers](http://arxiv.org/abs/2606.12025v3)
...
### [16] [A Lightweight Multi-Agent Framework for Automated Concrete Barrier Design](http://arxiv.org/abs/2606.12040v2)
...
### [17] [IntElicit: Eliciting and Assessing Contextualized Creativity via Dialogue Policy Optimization](http://arxiv.org/abs/2606.12086v1)
...
### [18] [Towards Responsibly Non-Compliant Machines](http://arxiv.org/abs/2606.12147v1)
...
### [19] [Hybrid Open-Ended Tri-Evolution Makes Better Deep Researcher](http://arxiv.org/abs/2606.13710v2)
...
### [20] [The Impossibility of Eliciting Latent Knowledge](http://arxiv.org/abs/2606.12268v1)
...
### [21] [A Five-Plane Reference Architecture for Runtime Governance of Production AI Agents](http://arxiv.org/abs/2606.12320v1)
*Krti Tallam*
...
Selection reason: 提出面向生产 AI agent 的运行时治理参考架构与中断原语，可迁移到代码 agent 的安全可靠执行。
...
### [22] [PROJECTMEM: A Local-First, Event-Sourced Memory and Judgment Layer for AI Coding Agents](http://arxiv.org/abs/2606.12329v1)
...
### [23] [Arbor: Tree Search as a Cognition Layer for Autonomous Agents](http://arxiv.org/abs/2606.12563v1)
...
### [24] [Strategic Decision Support for AI Agents](http://arxiv.org/abs/2606.12587v1)
...
### [25] [Pythagoras-Prover: Advancing Efficient Formal Proving via Augmented Lean Formalisation](http://arxiv.org/abs/2606.12594v1)
...
### [26] [PersonaDrive: Human-Style Retrieval-Augmented VLA Agents for Closed-Loop Driving Simulation](http://arxiv.org/abs/2606.12616v1)
...
### [27] [TrajGenAgent: A Hierarchical LLM Agent for Human Mobility Trajectory Generation](http://arxiv.org/abs/2606.12657v1)
...
### [28] [Evoflux: Inference-Time Evolution of Executable Tool Workflows for Compact Agents](http://arxiv.org/abs/2606.12674v1)
...
### [29] [WorkBench Revisited: Workplace Agents Two Years On](http://arxiv.org/abs/2606.13715v2)
...
### [30] [Benchmarking AI Agents for Addressing Scientific Challenges Across Scales](http://arxiv.org/abs/2606.12736v1)
...
### [31] [Prefill Awareness in Large Language Models](http://arxiv.org/abs/2606.12747v1)
...
### [32] [Acoda: Adversarial Code Obfuscation for Defending against LLM-based Analysis](http://arxiv.org/abs/2606.11755v1)
...
Selection reason: 利用遗传算法生成对抗性代码混淆以防御 LLM 代码分析，可用于增强代码 agent 的鲁棒性与隐私保护。
...
### [33] [Understanding and Detecting Scalability Faults in Large-Scale Distributed Systems](http://arxiv.org/abs/2606.11815v3)
...
Selection reason: 系统研究并检测大规模分布式系统中的可扩展性故障，其动静态结合分析方法对性能诊断有参考价值。
...
### [34] [Enhancing LLM-Based Code Translation with Verified Multi-Semantic Representations](http://arxiv.org/abs/2606.11863v1)
...
Selection reason: 通过多语义表示增强与自校准提升 LLM 代码翻译成功率，对 coding agent 的代码翻译和正确性保障有明确价值。
...
### [35] [Agents All the Way Down; A Methodology for Building Custom AI Agents from Substrate to Production](http://arxiv.org/abs/2606.11869v1)
...
Selection reason: 提出从底层到生产环境构建定制 AI agent 的实践方法论，含 agent-tests-agent 等模式，可迁移到 coding agent 工程化。
...
### [36] [Characterizing Software Aging in GPU-Based LLM Serving Systems](http://arxiv.org/abs/2606.11916v1)
...
Selection reason: 对 GPU LLM serving 系统的软件老化进行实证刻画，其统计方法可迁移到 coding agent 基础设施的性能与可靠性分析。
...
### [37] [Exploration Structure in LLM Agents for Multi-File Change Localization](http://arxiv.org/abs/2606.11976v1)
...
Selection reason: 比较线性与并行域范围探索在 LLM 多文件定位中的表现，直接改进 coding agent 的仓库探索策略。
...
### [38] [Rule Taxonomy and Evolution in AI IDEs: A Mining and Survey Study](http://arxiv.org/abs/2606.12231v1)
...
Selection reason: 系统研究 AI IDE 中 Rule 文件的分类、演化与合规影响，对 coding agent 的指令设计有直接指导价值。
...
### [39] [HybridCodeAuthorship: A Benchmark Dataset for Line-Level Code Authorship Detection](http://arxiv.org/abs/2606.12620v1)
...
Selection reason: 构建人机混合代码行级归属检测基准，可用于评估 AI 辅助代码的生产环境质量。
...
### [40] [CMIP-Forge: An Agentic System that Retrieves, Computes, and Self-Reviews Climate Science](http://arxiv.org/abs/2606.17076v1)
...
### [41] [SAIGuard: Communication-State Simulation for Proactive Defense of LLM Multi-Agent Systems](http://arxiv.org/abs/2606.12474v1)
...
### [42] [CCKS: Consensus-based Communication and Knowledge Sharing](http://arxiv.org/abs/2606.12281v1)
...
### [43] [A Mathematical Theory of Value: a synthesis on goal-directed agency under resource constraints](http://arxiv.org/abs/2606.12502v2)
*Cheng Qian*
...
### [44] [Breaking the Solver Bottleneck: Training Task Generators at the Learnable Frontier](http://arxiv.org/abs/2606.18284v1)
...
### [45] [When Context Returns: Toward Robust Internalization in On-Policy Distillation](http://arxiv.org/abs/2606.11627v1)
...
### [47] [ReCal: Reward Calibration for RL-based LLM Routing](http://arxiv.org/abs/2606.12479v1)
...
### [48] [Representing Time Series as Structured Programs for LLM Reasoning](http://arxiv.org/abs/2606.12481v1)
...
### [49] [Speculative Rollback Correction for Quality-Diverse Web Agent Imitation](http://arxiv.org/abs/2606.12485v1)
...
### [51] [APPO: Agentic Procedural Policy Optimization](http://arxiv.org/abs/2606.12384v1)
...
### [52] [The Signs Were Always There: Training-Free Concept Detection and Steering in Raw Transformer Dimensions](http://arxiv.org/abs/2606.12629v3)
...
### [53] [Keep Policy Gradient in Charge: Sibling-Guided Credit Distillation for Long-Horizon Tool-Use Agents](http://arxiv.org/abs/2606.12634v3)
...
### [54] [LLMs+Graphs: Toward Graph-Native, Synergistic AI Systems](http://arxiv.org/abs/2606.11560v1)
...
### [55] [TAHOE: Text-to-SQL with Automated Hint Optimization from Experience](http://arxiv.org/abs/2606.12387v1)
...
### [56] [LUCID: Learning Embodiment-Agnostic Intent Models from Unstructured Human Videos for Scalable Dexterous Robot Skill Acquisition](http://arxiv.org/abs/2606.11628v1)
...
### [57] [Intelligent Automation for Embodied Benchmark Construction: Pipelines, Embodiments, Simulators, and Trends](http://arxiv.org/abs/2606.12207v1)
...
### [58] [DIRECT: When and Where Should You Allocate Test-Time Compute in Embodied Planners?](http://arxiv.org/abs/2606.12402v1)
...
### [59] [Foresight: Iterative Reasoning About Clues that Matter for Navigation](http://arxiv.org/abs/2606.12550v1)
...
### [60] [EWAM: An Enhanced World Action Model for Closed-Loop Online Adaptation in Embodied Intelligence](http://arxiv.org/abs/2606.12690v1)
*Xin Zhou,Cong Miao*
...
### [61] [Evaluation of Alternative-Based Information Systems for Deliberative Polling using an Agentic Simulator](http://arxiv.org/abs/2606.11692v1)
...
### [62] [Sovereign Assurance Boundary: Certificate-Bound Admission for Agentic Infrastructure](http://arxiv.org/abs/2606.11632v1)
*Jun He,Deying Yu*
...
### [63] [Runtime Skill Audit: Targeted Runtime Probing for Agent Skill Security](http://arxiv.org/abs/2606.11671v1)
*Tu Lan,Chaowei Xiao*
...
### [64] [Can Open-Source LLM Agents Replace Static Application Security Testing Tools? An Empirical Assessment](http://arxiv.org/abs/2606.11672v1)
...
### [65] [Grammar-Constrained Decoding Can Jailbreak LLMs into Generating Malicious Code](http://arxiv.org/abs/2606.11817v1)
...
Selection reason: 揭示语法约束解码可越狱 LLM 生成恶意代码并提出对齐防御，对代码生成 agent 的安全部署有直接影响。
...
### [66] [CAPED: Context-Aware Privacy Exposure Defense for Mobile GUI Agents](http://arxiv.org/abs/2606.12666v2)
...
### [67] [SMSR: Certified Defence Against Runtime Memory Poisoning in Persistent LLM Agent Systems](http://arxiv.org/abs/2606.12703v1)
*Tarun Sharma*
...
### [68] [PI-Hunter: Automated Red-Teaming for Exposing and Localizing Prompt Injections](http://arxiv.org/abs/2606.12737v1)
...
### [69] [JoyAI-VL-Interaction: Real-Time Vision-Language Interaction Intelligence](http://arxiv.org/abs/2606.14777v1)
...
### [70] [FactCheck: Feasibility-aware Long-term Action Anticipation with Multi-agent Collaboration](http://arxiv.org/abs/2606.14778v1)
...
### [71] [MedCTA: A Benchmark for Clinical Tool Agents](http://arxiv.org/abs/2606.11702v1)
...
### [72] [Ouroboros-Spatial: Closing the Data-Model Loop for Spatial Reasoning](http://arxiv.org/abs/2606.11719v1)
...
### [73] [Layer-Isolated Evaluation: Gating the Deterministic Scaffold of a Production LLM Agent with a No-LLM, Regression-Locked Test Harness](http://arxiv.org/abs/2606.11686v1)
...
### [74] [Goal-Autopilot: A Verifiable Anti-Fabrication Firewall for Unattended Long-Horizon Agents](http://arxiv.org/abs/2606.11688v1)
*Youwang Deng*
...
### [75] [WorldReasoner: Evaluating Whether Language Model Agents Forecast Events with Valid Reasoning](http://arxiv.org/abs/2606.11816v1)
...
### [76] [Toward Generalist Autonomous Research via Hypothesis-Tree Refinement](http://arxiv.org/abs/2606.11926v1)
...
### [77] [Agentic Environment Engineering for Large Language Models: A Survey of Environment Modeling, Synthesis, Evaluation, and Application](http://arxiv.org/abs/2606.12191v1)
