...
- [Enhancing LLM-Based Code Translation with Verified Multi-Semantic Representations](http://arxiv.org/abs/2606.11863v1) — 相关度 0.85：通过多语义表示增强与自校准提升 LLM 代码翻译成功率，对 coding agent 的代码翻译和正确性保障有明确价值。
- [Exploration Structure in LLM Agents for Multi-File Change Localization](http://arxiv.org/abs/2606.11976v1) — 相关度 0.85：比较线性与并行域范围探索在 LLM 多文件定位中的表现，直接改进 coding agent 的仓库探索策略。
- [Rule Taxonomy and Evolution in AI IDEs: A Mining and Survey Study](http://arxiv.org/abs/2606.12231v1) — 相关度 0.85：系统研究 AI IDE 中 Rule 文件的分类、演化与合规影响，对 coding agent 的指令设计有直接指导价值。
- [SkillJuror: Measuring How Agent Skill Organization Changes Runtime Behavior](http://arxiv.org/abs/2606.11543v1) — 相关度 0.85：提出 SkillJuror 评估 agent Skill 组织形式对运行行为的影响，对 coding agent 的 Skill 设计与评测有直接价值。
- [A Five-Plane Reference Architecture for Runtime Governance of Production AI Agents](http://arxiv.org/abs/2606.12320v1) — 相关度 0.75：提出面向生产 AI agent 的运行时治理参考架构与中断原语，可迁移到代码 agent 的安全可靠执行。
- [Agents All the Way Down; A Methodology for Building Custom AI Agents from Substrate to Production](http://arxiv.org/abs/2606.11869v1) — 相关度 0.75：提出从底层到生产环境构建定制 AI agent 的实践方法论，含 agent-tests-agent 等模式，可迁移到 coding agent 工程化。
- [Grammar-Constrained Decoding Can Jailbreak LLMs into Generating Malicious Code](http://arxiv.org/abs/2606.11817v1) — 相关度 0.70：揭示语法约束解码可越狱 LLM 生成恶意代码并提出对齐防御，对代码生成 agent 的安全部署有直接影响。
- [Acoda: Adversarial Code Obfuscation for Defending against LLM-based Analysis](http://arxiv.org/abs/2606.11755v1) — 相关度 0.65：利用遗传算法生成对抗性代码混淆以防御 LLM 代码分析，可用于增强代码 agent 的鲁棒性与隐私保护。
- [HybridCodeAuthorship: A Benchmark Dataset for Line-Level Code Authorship Detection](http://arxiv.org/abs/2606.12620v1) — 相关度 0.60：构建人机混合代码行级归属检测基准，可用于评估 AI 辅助代码的生产环境质量。
- [Understanding and Detecting Scalability Faults in Large-Scale Distributed Systems](http://arxiv.org/abs/2606.11815v3) — 相关度 0.60：系统研究并检测大规模分布式系统中的可扩展性故障，其动静态结合分析方法对性能诊断有参考价值。
- [Characterizing Software Aging in GPU-Based LLM Serving Systems](http://arxiv.org/abs/2606.11916v1) — 相关度 0.55：对 GPU LLM serving 系统的软件老化进行实证刻画，其统计方法可迁移到 coding agent 基础设施的性能与可靠性分析。
