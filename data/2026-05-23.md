...
- [Beyond Inference-Only Deployment: Comparing Weight-Based Consolidation Against Cascading Compaction](http://arxiv.org/abs/2605.24657v1) — 相关度 0.85：对比权重合并与上下文压缩的记忆持久化策略，对代码agent长期记忆与知识巩固有直接借鉴价值。
- [Synthesizing Inductive Invariants for Distributed Protocols via IC3 and Large Language Models](http://arxiv.org/abs/2605.24619v1) — 相关度 0.85：结合IC3与LLM合成分布式协议归纳不变量，神经符号验证方法直接适用于LLM辅助的程序验证与agent。
- [Code2UML: Agentic LLMs with context engineering for scalable software visualization](http://arxiv.org/abs/2605.24453v1) — 相关度 0.75：提出五智能体分层架构和确定性IR压缩实现代码可视化，具备多agent协作与上下文工程的可迁移方法。
- [Guarded Repair for Harm-Aware Post-hoc Replacement of LLM Mathematical Reasoning](http://arxiv.org/abs/2605.24613v1) — 相关度 0.70：提出带验证守卫的选择性修复框架，其harm-aware替换与确定性验证机制可迁移到代码agent的修复与正确性保障。
- [Breaking Changes in Software Ecosystems: A Systematic Literature Review](http://arxiv.org/abs/2605.24397v1) — 相关度 0.65：系统综述了跨生态的破坏性变更检测与传播，分类体系和43种检测方法对依赖感知的代码agent有可参考价值。
