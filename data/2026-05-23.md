...
### [1] [Adaptive Human-AI Coordination via Hierarchical Action Disentanglement](http://arxiv.org/abs/2605.24343v1)
...
### [2] [Partner-Aware Hierarchical Skill Discovery for Robust Human-AI Collaboration](http://arxiv.org/abs/2605.24352v1)
*Adnan Ahmad,Bahareh Nakisa,Mohammad Naim Rastgoo*
...
### [3] [Distilling Game Code World Model Generation into Lightweight Large Language Models](http://arxiv.org/abs/2605.24375v1)
...
### [4] [Understanding and Mitigating Premature Confidence for Better LLM Reasoning](http://arxiv.org/abs/2605.24396v1)
...
### [5] [The Model Is Not the Product: A Dual-Pillar Architecture for Local-First Psychological Coaching](http://arxiv.org/abs/2605.24411v1)
*Alexander Mihalcea*
...
### [6] [JT-SAFE-V2: Safety-by-Design Foundation Model with World-Context Data](http://arxiv.org/abs/2605.24414v1)
...
### [7] [Benchmarking the Limits of In-Context Reinforcement Learning for Ad-Hoc Teamwork](http://arxiv.org/abs/2605.24423v1)
...
### [8] [SAM: State-Adaptive Memory for Long-Horizon Reasoning Agent](http://arxiv.org/abs/2605.24468v1)
...
### [9] [AgentFugue: Agent Scaling for Long-Horizon Tasks through Collective Reasoning](http://arxiv.org/abs/2605.24486v1)
...
### [10] [Market Regime Council for Dynamic Credit Assignment in Multi-Agent LLM Decision Systems](http://arxiv.org/abs/2605.24490v1)
...
### [11] [DemoEvolve: Overcoming Sparse Feedback in Agentic Harness Evolution with Demonstrations](http://arxiv.org/abs/2605.24539v1)
...
### [12] [Learning to Reason Efficiently with A* Post-Training](http://arxiv.org/abs/2605.24597v1)
...
### [13] [Hera: Learning Long-Horizon Coordination for Device-Cloud Collaborative LLM Agents](http://arxiv.org/abs/2605.24598v1)
...
### [14] [Agent-as-Peer-Debriefer: A Multi-Agent Framework with Perspective-Based Refinement for Qualitative Analysis](http://arxiv.org/abs/2605.24600v1)
...
### [15] [Beyond Inference-Only Deployment: Comparing Weight-Based Consolidation Against Cascading Compaction](http://arxiv.org/abs/2605.24657v1)
...
Selection reason: 对比权重合并与上下文压缩的记忆持久化策略，对代码agent长期记忆与知识巩固有直接借鉴价值。
...
### [16] [Measuring Reasoning Quality in LLMs: A Multi-Dimensional Behavioral Framework](http://arxiv.org/abs/2605.24661v3)
...
### [17] [MDIA: A Multi-Agent Diagnostic Intelligence Pipeline on HealthBench Professional](http://arxiv.org/abs/2605.24699v1)
...
### [18] [Proper Scoring Rules for Agentic Uncertainty Quantification](http://arxiv.org/abs/2605.24756v1)
...
### [19] [PRIMA: Operational Patterns for Resilient Multi-Agent Research with Verifiable Identity and Convergent Feedback](http://arxiv.org/abs/2605.24775v1)
*Sasank Annapureddy*
...
### [20] [GRAIL: AI translation for scientists application workflow on satellite data](http://arxiv.org/abs/2605.24784v1)
...
### [21] [Breaking Changes in Software Ecosystems: A Systematic Literature Review](http://arxiv.org/abs/2605.24397v1)
...
Selection reason: 系统综述了跨生态的破坏性变更检测与传播，分类体系和43种检测方法对依赖感知的代码agent有可参考价值。
...
### [22] [Code2UML: Agentic LLMs with context engineering for scalable software visualization](http://arxiv.org/abs/2605.24453v1)
...
Selection reason: 提出五智能体分层架构和确定性IR压缩实现代码可视化，具备多agent协作与上下文工程的可迁移方法。
...
### [23] [Synthesizing Inductive Invariants for Distributed Protocols via IC3 and Large Language Models](http://arxiv.org/abs/2605.24619v1)
...
Selection reason: 结合IC3与LLM合成分布式协议归纳不变量，神经符号验证方法直接适用于LLM辅助的程序验证与agent。
...
### [24] [Generative OOD-regularized Model-based Policy Optimization](http://arxiv.org/abs/2605.24405v1)
...
### [25] [Bilevel Optimization of Synthetic Trajectories for Multi-Turn LLM Fine-Tuning](http://arxiv.org/abs/2605.24743v1)
...
### [26] [How Many Tools Should an LLM Agent See? A Chance-Corrected Answer](http://arxiv.org/abs/2605.24660v2)
...
### [27] [The Open Source Economic Index of AI Adoption and Capability](http://arxiv.org/abs/2606.26118v1)
...
### [28] [Guarded Repair for Harm-Aware Post-hoc Replacement of LLM Mathematical Reasoning](http://arxiv.org/abs/2605.24613v1)
*Haizhou Xia*
...
Selection reason: 提出带验证守卫的选择性修复框架，其harm-aware替换与确定性验证机制可迁移到代码agent的修复与正确性保障。
...
### [29] [The Path Matters: Learning a Token-Commitment Policy for Diffusion Language Models](http://arxiv.org/abs/2605.24697v1)
...
### [30] [TS-Skill: A Benchmark for Evaluating Analytical Skills in Time-Series Question Answering](http://arxiv.org/abs/2605.24703v1)
