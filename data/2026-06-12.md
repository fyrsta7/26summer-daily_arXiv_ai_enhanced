...
### [1] [Formalizing Numerical Analysis: An Agent Pipeline and Quality Audit Beyond Kernel Acceptance](http://arxiv.org/abs/2606.14000v1)
...
### [2] [A Quantum-Assisted Agentic Distributed Artificial Intelligence Framework for Deadline-Bounded Orchestration of Hybrid Renewable Microgrids](http://arxiv.org/abs/2606.20667v1)
...
### [3] [VeriGeo: Controllable Geometry Question Generation with Numerical and Analytical Verification](http://arxiv.org/abs/2606.14176v1)
...
### [4] [When Should Agent Trust Be Conditional? Characterizing and Attacking Skill-Conditional Reputation in Agent Swarms](http://arxiv.org/abs/2606.14200v1)
...
### [5] [Closing the Reflection Gap: A Free Calibration Bonus for Agentic RL](http://arxiv.org/abs/2606.14211v1)
*Yinglun Zhu*
...
### [6] [SkillAudit: Ground-Truth-Free Skill Evolution via Paired Trajectory Auditing](http://arxiv.org/abs/2606.14239v1)
...
### [7] [Faithful, Not Corrective: Message-Format Effects in Multi-Hop Agent Relays Are Tier-Dependent](http://arxiv.org/abs/2607.09678v1)
*Zayx Shawn*
...
### [8] [HarnessX: A Composable, Adaptive, and Evolvable Agent Harness Foundry](http://arxiv.org/abs/2606.14249v2)
...
### [9] [Communication Policy Evolution for Proactive LLM Agents](http://arxiv.org/abs/2606.14314v1)
...
### [10] [CSPO: Constraint-Sensitive Policy Optimization for Safe Reinforcement Learning](http://arxiv.org/abs/2606.14415v1)
...
### [11] [Causal Object-Centric Models for Planning with Monte Carlo Tree Search](http://arxiv.org/abs/2606.14418v1)
...
### [12] [GitOfThoughts: Version-Controlled Reasoning and Agent Memory You Can Replay, Diff, and Merge](http://arxiv.org/abs/2606.14470v2)
...
### [13] [When the Tool Decides: LLM Agents Defer Blindly to Graph Neural Network Tools, and Stronger Backbones Defer More](http://arxiv.org/abs/2606.14476v1)
...
### [14] [From Chatbot to Digital Colleague: The Paradigm Shift Toward Persistent Autonomous AI](http://arxiv.org/abs/2606.14502v1)
...
### [16] [StreamMemBench: Streaming Evaluation of Agent Memory for Future-Oriented Assistance](http://arxiv.org/abs/2606.14571v1)
...
### [17] [Abstracting Cross-Domain Action Sequences into Interpretable Workflows](http://arxiv.org/abs/2606.14654v1)
...
### [18] [Towards Direct Latent-Space Synthesis for Parallel Branches in LLM-Agent Workflows](http://arxiv.org/abs/2606.14672v1)
...
### [19] [Dr-DCI: Scaling Direct Corpus Interaction via Dynamic Workspace Expansion](http://arxiv.org/abs/2606.14885v1)
...
### [20] [Relational Structural Causal Models](http://arxiv.org/abs/2606.14892v1)
...
### [21] [Trust Between AI Agents: Measuring Formation, Breakage, and Recovery, with Implications for Governing Multi-Agent Systems](http://arxiv.org/abs/2606.14923v1)
*Yujiao Chen*
...
### [22] [PrologMCP: A Standardized Prolog Tool Interface for LLM Agents](http://arxiv.org/abs/2606.14935v2)
...
### [23] [LLM Agents Can See Code Repositories](http://arxiv.org/abs/2606.14061v3)
...
Selection reason: 系统研究多模态大模型利用仓库可视化结构辅助issue修复，可迁移到coding agent的上下文压缩与导航设计。
...
### [24] [FastContext: Training Efficient Repository Explorer for Coding Agents](http://arxiv.org/abs/2606.14066v4)
...
Selection reason: 提出专门的仓库探索子agent，显著降低token消耗并提升SWE-bench上的修复率，直接贡献于coding agent效率优化。
...
### [25] [Investigating Metamorphic Fuzz Oracle Enhancement via Large Language Models](http://arxiv.org/abs/2606.14164v1)
...
Selection reason: 将LLM用于自动化生成和集成蜕变测试预言，提升模糊测试覆盖率并触发大量崩溃，对程序分析具有明确迁移价值。
...
### [26] [Evaluating LLMs for Obfuscation Detection and Classification in Android Apps](http://arxiv.org/abs/2606.14233v1)
...
Selection reason: 评估LLM在Android混淆检测与分类上的语义推理能力，对静态代码分析和安全检测工具有参考价值。
...
### [27] [No Accidental Software Agent First Canonical Code for Human Code Entropy Reduction and 30 to 500 times Lower Frontier Model Requirements](http://arxiv.org/abs/2606.14357v1)
*Jepson Taylor*
...
Selection reason: 提出agent-first canonical code与行为等价规约降低前沿模型需求，对代码agent表示与验证有概念性启发。
...
### [28] [tap: A File-Based Protocol for Heterogeneous LLM Agent Collaboration](http://arxiv.org/abs/2606.14445v1)
*Minseo Kim*
...
Selection reason: 提出跨运行时文件型协作协议，支持异构LLM agent在同一代码库上协作开发与评审，具有多agent协作迁移价值。
...
### [29] [When Errors Become Narratives: A Longitudinal Taxonomy of Silent Failures in a Production LLM Agent Runtime](http://arxiv.org/abs/2606.14589v1)
*Wei Wu*
...
Selection reason: 纵向研究生产LLM agent runtime中的静默失败并给出机制化分类与防御框架，直接指导agent可靠性设计。
...
### [30] [Empowering Student Debugging in Parallel Programming with Execution Traces and Large Language Models](http://arxiv.org/abs/2606.14607v1)
...
Selection reason: 结合执行轨迹可视化与LLM辅助并发程序调试，其调试思路可迁移到代码agent的bug定位与修复。
...
### [31] [Beyond Correctness: Enhancing Architectural Reasoning in Code LLMs via Scalable Labeling with Agentic Judgment](http://arxiv.org/abs/2606.14948v2)
...
Selection reason: 提出agentic judging流水线大规模标注架构质量并微调开源模型，显著提升SWE-bench Verified解决率，直接相关。
...
### [32] [LessonBench-V1: A Benchmark Dataset for Evaluating AI Lesson Generation Agents](http://arxiv.org/abs/2607.13041v1)
...
### [33] [Selective Agentic Recovery for UAV Autonomy with a Persistent Mission Runtime](http://arxiv.org/abs/2606.14219v1)
...
### [34] [Elastic Queries Reinforcement Learning: Self-Aware Policy Execution for VLA Models](http://arxiv.org/abs/2606.14375v1)
...
### [35] [Hy-Embodied-0.5-VLA: From Vision-Language-Action Models to a Real-World Robot Learning Stack](http://arxiv.org/abs/2606.14409v1)
...
### [36] [CADET: Physics-Grounded Causal Auditing and Training-Free Deconfounding of End-to-End Driving Planners](http://arxiv.org/abs/2606.14438v2)
*Zikun Guo*
...
### [37] [TRACE: Trajectory-Routed Causal Memory for Delayed-Evidence Visuomotor Imitation](http://arxiv.org/abs/2606.14551v2)
...
### [38] [Sensitivity Shaping for Latent Modeling](http://arxiv.org/abs/2606.14585v1)
...
### [39] [Discovery under Hypothesis Redundancy: A Geometric Theory of Discovery Bottlenecks](http://arxiv.org/abs/2606.14386v1)
*Li Xia,Baoxun Wang*
...
### [40] [From Meta Idea to Advanced Mathematical Discovery -- Human-AI Co-Discovery of Sign-Embedding Quantum Algorithms](http://arxiv.org/abs/2606.24899v1)
...
### [41] [CARE: Controlling LLM-Generated Policies through Auditable Review of Evidence in Scientific Experimentation](http://arxiv.org/abs/2606.14581v3)
*Guanyu Liu,Weiyi Kong,Zeyu Wang,Boer Zhang,Baiqing Li,Peiyu Zhang,Tianyu Shi*

Main category: cs.LG

Comments: 23 pages, 4 figures. Code: https://github.com/SHITIANYU-hue/care
...
### [42] [Flood and Harvest: The Provable Necessity of Trivia for Generating Valuable Mathematics via the Lens of Language Generation in the Limit](http://arxiv.org/abs/2606.14688v1)
...
### [43] [SIMMER: Benchmarking Latent Failures in LLM Executable Planning with a World Model](http://arxiv.org/abs/2606.14574v1)
...
### [44] [Evaluating the Robustness of Proof Autoformalization in Lean 4](http://arxiv.org/abs/2606.14867v1)
...
### [45] [Co-Scraper: query-aware DOM Pruning and Reusable Scraper Synthesis for Lightweight Web Data Extraction](http://arxiv.org/abs/2606.14821v1)
...
### [46] [Learning Coordinated Preference for Multi-Objective Multi-Agent Reinforcement Learning](http://arxiv.org/abs/2606.14693v1)
...
### [47] [Resilient Consensus in Agentic AI](http://arxiv.org/abs/2606.15024v1)
...
### [48] [MeEvo: Metacognitive Evolution Combined with Natural Evolution for Automatic Heuristic Design](http://arxiv.org/abs/2606.14202v4)
...
### [49] [Design Methodology and Performance Trade-offs Management for Distributed and Compound AI Systems](http://arxiv.org/abs/2606.14350v1)
...
### [50] [PLAIground: SLO-Driven Runtime Model Selection for Compound AI Systems in the Edge-Cloud-Space Continuum](http://arxiv.org/abs/2606.14356v1)
...
### [51] [Hidden in Plain Sight: Benchmarking Agent Safety Against Decomposition Attacks with DECOMPBENCH](http://arxiv.org/abs/2606.13994v1)
...
### [52] [Same-Origin Policy for Agentic Browsers](http://arxiv.org/abs/2606.14027v3)
...
### [53] [Security in a Workflow: Exploring Role-Based Agentic Architectures for Vulnerability Handling](http://arxiv.org/abs/2606.14261v1)
...
Selection reason: 设计Planner/Analyzer/Fixer/Verifier角色化agent工作流处理漏洞，是软件安全agent化的直接实践。
...
### [54] [AgentCyberRange: Benchmarking Frontier AI Systems in Realistic Cyber Ranges](http://arxiv.org/abs/2606.14295v2)
...
### [55] [A Security Analysis of Long-Horizon Agentic AI Systems: Threats, Evaluation, and Framework Development](http://arxiv.org/abs/2606.14816v1)
...
### [56] [From Shield to Target: Denial-of-Service Attacks on LLM-Based Agent Guardrails](http://arxiv.org/abs/2606.14517v2)
...
### [57] [Is Your Agent Playing Dead? Deployed LLM Agents Exhibit Constraint-Evasive Fabrication and Thanatosis](http://arxiv.org/abs/2606.14831v1)
...
### [58] [When Good Verifiers Go Bad: Self-Improving VLMs Can Regress on New Tasks](http://arxiv.org/abs/2606.14629v1)
*Jianzhe Lin*
...
### [59] [ClinHallu: A Benchmark for Diagnosing Stage-Wise Hallucinations in Medical MLLM Reasoning](http://arxiv.org/abs/2606.14697v1)
