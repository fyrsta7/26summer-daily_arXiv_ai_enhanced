...
### [10] [Agent Behavior Mining: Generative AI Agent Governance in Business Processes](http://arxiv.org/abs/2606.20669v1)
...
### [11] [CSPO: Constraint-Sensitive Policy Optimization for Safe Reinforcement Learning](http://arxiv.org/abs/2606.14415v1)
...
### [12] [Causal Object-Centric Models for Planning with Monte Carlo Tree Search](http://arxiv.org/abs/2606.14418v1)
...
### [13] [GitOfThoughts: Version-Controlled Reasoning and Agent Memory You Can Replay, Diff, and Merge](http://arxiv.org/abs/2606.14470v2)
...
### [14] [When the Tool Decides: LLM Agents Defer Blindly to Graph Neural Network Tools, and Stronger Backbones Defer More](http://arxiv.org/abs/2606.14476v1)
...
### [15] [From Chatbot to Digital Colleague: The Paradigm Shift Toward Persistent Autonomous AI](http://arxiv.org/abs/2606.14502v1)
...
### [16] [Every Eval Ever: A Unifying Schema and Community Repository for AI Evaluation Results](http://arxiv.org/abs/2606.14516v1)
...
### [17] [StreamMemBench: Streaming Evaluation of Agent Memory for Future-Oriented Assistance](http://arxiv.org/abs/2606.14571v1)
...
### [18] [Abstracting Cross-Domain Action Sequences into Interpretable Workflows](http://arxiv.org/abs/2606.14654v1)
...
### [19] [Towards Direct Latent-Space Synthesis for Parallel Branches in LLM-Agent Workflows](http://arxiv.org/abs/2606.14672v1)
...
### [20] [Dr-DCI: Scaling Direct Corpus Interaction via Dynamic Workspace Expansion](http://arxiv.org/abs/2606.14885v1)
...
### [21] [Relational Structural Causal Models](http://arxiv.org/abs/2606.14892v1)
...
### [22] [Trust Between AI Agents: Measuring Formation, Breakage, and Recovery, with Implications for Governing Multi-Agent Systems](http://arxiv.org/abs/2606.14923v1)
*Yujiao Chen*
...
### [23] [PrologMCP: A Standardized Prolog Tool Interface for LLM Agents](http://arxiv.org/abs/2606.14935v2)
...
### [24] [Hidden in Plain Sight: Benchmarking Agent Safety Against Decomposition Attacks with DECOMPBENCH](http://arxiv.org/abs/2606.13994v1)
...
### [25] [Same-Origin Policy for Agentic Browsers](http://arxiv.org/abs/2606.14027v3)
...
### [26] [Security in a Workflow: Exploring Role-Based Agentic Architectures for Vulnerability Handling](http://arxiv.org/abs/2606.14261v1)
...
### [27] [AgentCyberRange: Benchmarking Frontier AI Systems in Realistic Cyber Ranges](http://arxiv.org/abs/2606.14295v2)
...
### [28] [A Security Analysis of Long-Horizon Agentic AI Systems: Threats, Evaluation, and Framework Development](http://arxiv.org/abs/2606.14816v1)
...
### [29] [From Shield to Target: Denial-of-Service Attacks on LLM-Based Agent Guardrails](http://arxiv.org/abs/2606.14517v2)
...
### [30] [Is Your Agent Playing Dead? Deployed LLM Agents Exhibit Constraint-Evasive Fabrication and Thanatosis](http://arxiv.org/abs/2606.14831v1)
...
### [31] [When Good Verifiers Go Bad: Self-Improving VLMs Can Regress on New Tasks](http://arxiv.org/abs/2606.14629v1)
*Jianzhe Lin*
...
### [32] [Design Methodology and Performance Trade-offs Management for Distributed and Compound AI Systems](http://arxiv.org/abs/2606.14350v1)
...
### [33] [PLAIground: SLO-Driven Runtime Model Selection for Compound AI Systems in the Edge-Cloud-Space Continuum](http://arxiv.org/abs/2606.14356v1)
...
### [34] [Discovery under Hypothesis Redundancy: A Geometric Theory of Discovery Bottlenecks](http://arxiv.org/abs/2606.14386v1)
*Li Xia,Baoxun Wang*
...
### [35] [From Meta Idea to Advanced Mathematical Discovery -- Human-AI Co-Discovery of Sign-Embedding Quantum Algorithms](http://arxiv.org/abs/2606.24899v1)
...
### [36] [CARE: Controlling LLM-Generated Policies through Auditable Review of Evidence in Scientific Experimentation](http://arxiv.org/abs/2606.14581v3)
...
### [37] [Flood and Harvest: The Provable Necessity of Trivia for Generating Valuable Mathematics via the Lens of Language Generation in the Limit](http://arxiv.org/abs/2606.14688v1)
...
### [38] [SIMMER: Benchmarking Latent Failures in LLM Executable Planning with a World Model](http://arxiv.org/abs/2606.14574v1)
...
### [39] [Evaluating the Robustness of Proof Autoformalization in Lean 4](http://arxiv.org/abs/2606.14867v1)
...
### [40] [MeEvo: Metacognitive Evolution Combined with Natural Evolution for Automatic Heuristic Design](http://arxiv.org/abs/2606.14202v4)
...
### [41] [ClinHallu: A Benchmark for Diagnosing Stage-Wise Hallucinations in Medical MLLM Reasoning](http://arxiv.org/abs/2606.14697v1)
...
### [42] [Selective Agentic Recovery for UAV Autonomy with a Persistent Mission Runtime](http://arxiv.org/abs/2606.14219v1)
...
### [43] [Elastic Queries Reinforcement Learning: Self-Aware Policy Execution for VLA Models](http://arxiv.org/abs/2606.14375v1)
...
### [44] [Hy-Embodied-0.5-VLA: From Vision-Language-Action Models to a Real-World Robot Learning Stack](http://arxiv.org/abs/2606.14409v1)
...
### [45] [CADET: Physics-Grounded Causal Auditing and Training-Free Deconfounding of End-to-End Driving Planners](http://arxiv.org/abs/2606.14438v2)
*Zikun Guo*
...
### [46] [TRACE: Trajectory-Routed Causal Memory for Delayed-Evidence Visuomotor Imitation](http://arxiv.org/abs/2606.14551v2)
...
### [47] [Sensitivity Shaping for Latent Modeling](http://arxiv.org/abs/2606.14585v1)
...
### [48] [Quasilinear Equivalence Checking for Detector Error Models](http://arxiv.org/abs/2606.14677v1)
*Mathys Rennela*
...
### [49] [Learning Coordinated Preference for Multi-Objective Multi-Agent Reinforcement Learning](http://arxiv.org/abs/2606.14693v1)
...
### [50] [Resilient Consensus in Agentic AI](http://arxiv.org/abs/2606.15024v1)
...
### [51] [Co-Scraper: query-aware DOM Pruning and Reusable Scraper Synthesis for Lightweight Web Data Extraction](http://arxiv.org/abs/2606.14821v1)
...
### [52] [LessonBench-V1: A Benchmark Dataset for Evaluating AI Lesson Generation Agents](http://arxiv.org/abs/2607.13041v1)
