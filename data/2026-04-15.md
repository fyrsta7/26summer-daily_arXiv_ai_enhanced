...
- [The A-R Behavioral Space: Execution-Level Profiling of Tool-Using Language Model Agents in Organizational Deployment](https://arxiv.org/abs/2604.12116) — 相关度 0.70：提出工具使用LLM Agent的执行层行为画像方法，用动作率和拒绝信号分析协作模式，可迁移到代码Agent。
