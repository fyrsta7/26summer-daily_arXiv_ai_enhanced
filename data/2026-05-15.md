...
### [1] [X-SYNTH: Beyond Retrieval -- Enterprise Context Synthesis from Observed Digital Human Attention](http://arxiv.org/abs/2605.15505v2)
...
### [2] [CAPS: Cascaded Adaptive Pairwise Selection for Efficient Parallel Reasoning](http://arxiv.org/abs/2605.15513v1)
...
### [3] [RTL-BenchMT: Dynamic Maintenance of RTL Generation Benchmark Through Agent-Assisted Analysis and Revision](http://arxiv.org/abs/2605.15537v1)
...
### [4] [DRS-GUI: Dynamic Region Search for Training-Free GUI Grounding](http://arxiv.org/abs/2605.15542v1)
...
### [5] [Position: Artificial Intelligence Needs Meta Intelligence -- the Case for Metacognitive AI](http://arxiv.org/abs/2605.15567v1)
...
### [6] [STAR: A Stage-attributed Triage and Repair framework for RCA Agents in Microservices](http://arxiv.org/abs/2605.15581v1)
...
### [7] [See Before You Code: Learning Visual Priors for Spatially Aware Educational Animation Generation](http://arxiv.org/abs/2605.15585v1)
...
### [8] [TopoEvo: A Topology-Aware Self-Evolving Multi-Agent Framework for Root Cause Analysis in Microservices](http://arxiv.org/abs/2605.15611v1)
*Junle Wang,Xingchuang Liao,Wenjun Wu*
...
### [9] [ColPackAgent: Agent-Skill-Guided Hard-Particle Monte Carlo Workflows for Colloidal Packing](http://arxiv.org/abs/2605.15625v1)
...
### [10] [PRISM: Prompt Reliability via Iterative Simulation and Monitoring for Enterprise Conversational AI](http://arxiv.org/abs/2605.15665v1)
...
### [11] [ALSO: Adversarial Online Strategy Optimization for Social Agents](http://arxiv.org/abs/2605.15768v2)
...
### [12] [SaaS-Bench: Can Computer-Use Agents Leverage Real-World SaaS to Solve Professional Workflows?](http://arxiv.org/abs/2605.15777v2)
...
### [13] [Agentic Discovery of Neural Architectures: AIRA-Compose and AIRA-Design](http://arxiv.org/abs/2605.15871v1)
...
### [14] [Imperfect World Models are Exploitable](http://arxiv.org/abs/2605.15960v2)
...
### [15] [PAGER: Bridging the Semantic-Execution Gap in Point-Precise Geometric GUI Control](http://arxiv.org/abs/2605.15963v1)
...
### [16] [Deterministic Event-Graph Substrates as World Models for Counterfactual Reasoning](http://arxiv.org/abs/2605.15967v1)
*Fabio Rovai*
...
### [17] [Learning Bilevel Policies over Symbolic World Models for Long-Horizon Planning](http://arxiv.org/abs/2605.15975v2)
...
### [18] [ScreenSearch: Uncertainty-Aware OS Exploration](http://arxiv.org/abs/2605.16024v1)
...
### [19] [Sign-Separated Asymmetric Finite-Time Error Analysis of Q-Learning](http://arxiv.org/abs/2605.16103v2)
*Donghwan Lee*
...
### [20] [ShopGym: An Integrated Framework for Realistic Simulation and Scalable Benchmarking of E-Commerce Web Agents](http://arxiv.org/abs/2605.16116v1)
...
### [21] [Property-Guided LLM Program Synthesis for Planning](http://arxiv.org/abs/2605.16142v2)
...
### [22] [Look Before You Leap: Autonomous Exploration for LLM Agents](http://arxiv.org/abs/2605.16143v1)
...
### [23] [Formal Methods Meet LLMs: Auditing, Monitoring, and Intervention for Compliance of Advanced AI Systems](http://arxiv.org/abs/2605.16198v1)
...
### [24] [Context, Reasoning, and Hierarchy: A Cost-Performance Study of Compound LLM Agent Design in an Adversarial POMDP](http://arxiv.org/abs/2605.16205v1)
...
### [25] [Confirming Correct, Missing the Rest: LLM Tutoring Agents Struggle Where Feedback Matters Most](http://arxiv.org/abs/2605.16207v1)
...
### [26] [FORGE: Self-Evolving Agent Memory With No Weight Updates via Population Broadcast](http://arxiv.org/abs/2605.16233v1)
*Igor Bogdanov,Chung-Horng Lung,Thomas Kunz,Jie Gao,Adrian Taylor,Marzia Zaman*
...
### [27] [Prospective multi-pathogen disease forecasting using autonomous LLM-guided tree search](http://arxiv.org/abs/2605.16238v1)
...
### [28] [From Prompts to Protocols: An AI Agent for Laboratory Automation](http://arxiv.org/abs/2605.16552v1)
...
### [29] [Skim: Speculative Execution for Fast and Efficient Web Agents](http://arxiv.org/abs/2605.16565v2)
...
### [30] [Counterparty Modeling is Not Strategy: The Limits of LLM Negotiators](http://arxiv.org/abs/2605.16575v1)
...
Selection reason: 将仓库环境配置知识蒸馏为可复用agent知识，多智能体验证与修复策略对coding agent有实际价值。
...
### [32] [RoadmapBench: Evaluating Long-Horizon Agentic Software Development Across Version Upgrades](http://arxiv.org/abs/2605.15846v2)
...
Selection reason: 提供长程多目标软件开发的基准RoadmapBench，直接评测编码agent的长期规划与执行能力。
...
### [33] [From Text to DSL: Evaluating Grammar-Based Model Generation Using Open LLMs](http://arxiv.org/abs/2605.15865v1)
...
Selection reason: 评估开源LLM从自然语言生成DSL模型的能力，涉及代码/模型生成，有一定参考意义。
...
### [34] [XSearch: Explainable Code Search via Concept-to-Code Alignment](http://arxiv.org/abs/2605.16046v2)
...
Selection reason: 提出可解释的代码搜索方法，通过概念对齐提高检索准确率与泛化性，可用于代码检索与agent上下文获取。
...
### [35] [Customizing an LLM for Enterprise Software Engineering](http://arxiv.org/abs/2605.16517v2)
...
Selection reason: 面向企业软件工程定制LLM的全流程方法，展示代码生成率提升与防遗忘训练策略，对agent基座模型优化有借鉴。
...
### [36] [LLM-based vs. Search-based Merge Conflict Resolution: An Empirical Study of Competing Paradigms](http://arxiv.org/abs/2605.16646v1)
...
Selection reason: 系统比较LLM与搜索方法解决合并冲突，揭示各自优劣，对代码修复agent设计有参考价值。
...
### [37] [Detecting Privilege Escalation in Polyglot Microservices via Agentic Program Analysis](http://arxiv.org/abs/2605.15569v1)
...
Selection reason: 结合LLM智能体与经典程序分析进行跨服务权限提升漏洞检测，技术路线可迁移到代码分析与安全智能体。
...
### [38] [Who Owns This Agent? Tracing AI Agents Back to Their Owners](http://arxiv.org/abs/2605.16035v1)
...
### [39] [SLEIGHT-Bench: A Benchmark of Evasion Attacks Against Agent Monitors](http://arxiv.org/abs/2605.16626v2)
...
### [40] [PrivScope: Task-scoped Disclosure Control for Hybrid Agentic Systems](http://arxiv.org/abs/2605.16630v2)
...
### [41] [paper.json: A Coordination Convention for LLM-Agent-Actionable Papers](http://arxiv.org/abs/2605.16194v1)
*Arquimedes Canedo*
...
### [42] [DiffVAS: Diffusion-Guided Visual Active Search in Partially Observable Environments](http://arxiv.org/abs/2605.15519v1)
...
### [43] [VideoSeeker: Incentivizing Instance-level Video Understanding via Native Agentic Tool Invocation](http://arxiv.org/abs/2605.16079v1)
...
### [44] [Visual Agentic Memory: Enabling Online Long Video Understanding via Online Indexing, Hierarchical Memory, and Agentic Retrieval](http://arxiv.org/abs/2605.16481v1)
...
### [45] [Optimization-as-a-Service via Multi-Agent Large Language Model for Radio Access Networks](http://arxiv.org/abs/2606.20590v1)
...
### [46] [RoPE Distinguishes Neither Positions Nor Tokens in Long Contexts, Provably](http://arxiv.org/abs/2605.15514v1)
...
### [47] [Process Rewards with Learned Reliability](http://arxiv.org/abs/2605.15529v1)
...
### [48] [H-Mem: A Novel Memory Mechanism for Evolving and Retrieving Agent Memory via a Hybrid Structure](http://arxiv.org/abs/2605.15701v1)
...
### [49] [RecMem: Recurrence-based Memory Consolidation for Efficient and Effective Long-Running LLM Agents](http://arxiv.org/abs/2605.16045v1)
...
### [50] [DebiasRAG: A Tuning-Free Path to Fair Generation in Large Language Models through Retrieval-Augmented Generation](http://arxiv.org/abs/2605.16113v1)
...
### [51] [Argus: Evidence Assembly for Scalable Deep Research Agents](http://arxiv.org/abs/2605.16217v3)
...
### [52] [The Scaling Laws of Skills in LLM Agent Systems](http://arxiv.org/abs/2605.16508v1)
...
### [53] [SKG-Eval: Stateful Evaluation of Multi-Turn Dialogue via Incremental Semantic Knowledge Graphs](http://arxiv.org/abs/2605.16650v1)
...
### [54] [CHI-Bench: Can AI Agents Automate End-to-End, Long-Horizon, Policy-Rich Healthcare Workflows?](http://arxiv.org/abs/2605.16679v2)
...
### [55] [Toward Natural and Companionable Virtual Agents via Cross-Temporal Emotional Modeling](http://arxiv.org/abs/2605.15812v1)
...
### [56] [SLIP & ETHICS: Graduated Intervention for AI Emotional Companions](http://arxiv.org/abs/2605.15915v1)
*Minseo Kim*
...
### [57] [Alignment Drift in Long-Term Human-LLM Interaction: A Mechanism-Oriented Framework](http://arxiv.org/abs/2605.16516v1)
*Xintong Yao*
...
### [58] [Toward Template-Free Explainability for Monte Carlo Tree Search](http://arxiv.org/abs/2605.16524v2)
...
### [59] [Access Timing as Scaffolding: A Reinforcement Learning Approach to GenAI in Education](http://arxiv.org/abs/2605.15850v2)
...
### [60] [LERA: LLM-Enhanced RAG for Ad Auction in Generative Chatbots](http://arxiv.org/abs/2605.16474v1)
...
### [61] [An Agentic Retrieval Framework for Autonomous Context-Aware Data Quality Assessment](http://arxiv.org/abs/2606.13692v1)
...
### [62] [GRASP: Graph Agentic Search over Propositions for Multi-hop Question Answering](http://arxiv.org/abs/2605.16598v1)
...
### [63] [Hybrid LLM-based Intelligent Framework for Robot Task Scheduling](http://arxiv.org/abs/2605.15486v1)
...
### [64] [Feedback World Model Enables Precise Guidance of Diffusion Policy](http://arxiv.org/abs/2605.15705v1)
...
### [65] [DeepArrhythmia: Segment-Contextualized ECG Arrhythmia Classification via Selective Evidence Acquisition](http://arxiv.org/abs/2605.16441v1)
...
### [66] [AstraFlow: Dataflow-Oriented Reinforcement Learning for Agentic LLMs](http://arxiv.org/abs/2605.15565v1)
...
### [67] [SAGE: Shaping Anchors for Guided Exploration in RLVR of LLMs](http://arxiv.org/abs/2605.18864v1)
...
### [68] [EVA-0: Test-Time Model Evolution with Only Two Forward Passes per Sample](http://arxiv.org/abs/2605.18867v1)
...
### [69] [Predicting Performance of Symbolic and Prompt Programs with Examples](http://arxiv.org/abs/2605.21515v1)
...
### [70] [Harnesses for Inference-Time Alignment over Execution Trajectories](http://arxiv.org/abs/2605.21516v1)
...
### [71] [MO-CAPO: Multi-Objective Cost-Aware Prompt Optimization](http://arxiv.org/abs/2605.18869v1)
...
### [72] [Ada-Diffuser: Latent-Aware Adaptive Diffusion for Decision-Making](http://arxiv.org/abs/2605.16054v1)
...
### [73] [Surrogate Neural Architecture Codesign Package (SNAC-Pack)](http://arxiv.org/abs/2605.16138v2)
...
### [74] [Distributional Energy-Based Models for Uncertainty-Aware Structured LLM Reasoning](http://arxiv.org/abs/2605.18871v1)
...
### [75] [EUPHORIA: Efficient Universal Planning via Hybrid Optimization for Robust Industrial Robotic Assembly](http://arxiv.org/abs/2605.18872v1)
...
### [76] [Learning How to Cube](http://arxiv.org/abs/2605.16632v1)
