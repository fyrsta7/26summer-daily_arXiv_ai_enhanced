...
- [RoadmapBench: Evaluating Long-Horizon Agentic Software Development Across Version Upgrades](http://arxiv.org/abs/2605.15846v2) — 相关度 0.90：提供长程多目标软件开发的基准RoadmapBench，直接评测编码agent的长期规划与执行能力。
- [BootstrapAgent: Distilling Repository Setup into Reusable Agent Knowledge](http://arxiv.org/abs/2605.15815v1) — 相关度 0.85：将仓库环境配置知识蒸馏为可复用agent知识，多智能体验证与修复策略对coding agent有实际价值。
- [Detecting Privilege Escalation in Polyglot Microservices via Agentic Program Analysis](http://arxiv.org/abs/2605.15569v1) — 相关度 0.80：结合LLM智能体与经典程序分析进行跨服务权限提升漏洞检测，技术路线可迁移到代码分析与安全智能体。
- [Customizing an LLM for Enterprise Software Engineering](http://arxiv.org/abs/2605.16517v2) — 相关度 0.75：面向企业软件工程定制LLM的全流程方法，展示代码生成率提升与防遗忘训练策略，对agent基座模型优化有借鉴。
- [LLM-based vs. Search-based Merge Conflict Resolution: An Empirical Study of Competing Paradigms](http://arxiv.org/abs/2605.16646v1) — 相关度 0.75：系统比较LLM与搜索方法解决合并冲突，揭示各自优劣，对代码修复agent设计有参考价值。
- [XSearch: Explainable Code Search via Concept-to-Code Alignment](http://arxiv.org/abs/2605.16046v2) — 相关度 0.70：提出可解释的代码搜索方法，通过概念对齐提高检索准确率与泛化性，可用于代码检索与agent上下文获取。
- [From Text to DSL: Evaluating Grammar-Based Model Generation Using Open LLMs](http://arxiv.org/abs/2605.15865v1) — 相关度 0.60：评估开源LLM从自然语言生成DSL模型的能力，涉及代码/模型生成，有一定参考意义。
