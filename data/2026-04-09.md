...
- [Qualixar OS: A Universal Operating System for AI Agent Orchestration](https://arxiv.org/abs/2604.06392) — 相关度 0.70：为多Agent编排提供完整运行时与路由/共识机制，可迁移到代码Agent工作流设计。
- [Illocutionary Explanation Planning for Source-Faithful Explanations in Retrieval-Augmented Language Models](https://arxiv.org/abs/2604.06211) — 相关度 0.60：面向编程教育RAG的illocutionary宏规划提升解释来源忠实度，可迁移到代码RAG的可信解释。
- [Illocutionary Explanation Planning for Source-Faithful Explanations in Retrieval-Augmented Language Models](https://arxiv.org/abs/2604.06211) — 相关度 0.60：面向编程教育RAG的illocutionary宏规划提升解释来源忠实度，可迁移到代码RAG的可信解释。
