...
### [1] [Sim2Schedule: A Simulator-Guided LLM Framework for Autonomous Open-Pit Mine Scheduling](http://arxiv.org/abs/2606.10286v1)
...
### [2] [What Spatial Memory Must Store: Occlusion as the Test for Language-Agent Memory](http://arxiv.org/abs/2606.10299v1)
...
### [3] [Self-Distillation Policy Optimization via Visual Feedback: Bridging Code and Visual Artifacts](http://arxiv.org/abs/2606.10334v1)
*Haoyu Dong*
...
### [4] [Reasoning or Memorization? Direction-Aware Diversity Exploration in LLM Reinforcement Learning](http://arxiv.org/abs/2606.10346v1)
...
### [5] [Beyond Static Evaluation: Co-Evolutionary Mechanisms for LLM-Driven Strategy Evolution in Adversarial Games](http://arxiv.org/abs/2606.10389v1)
...
### [6] [STAGE-Claw: Automated State-based Agent Benchmarking for Realistic Scenarios](http://arxiv.org/abs/2606.10394v1)
...
### [7] [Learning Splitting Heuristics for Parallel String Solvers](http://arxiv.org/abs/2606.20656v1)
...
Selection reason: 用数据驱动学习字符串求解器的分裂启发式，属于求解器性能优化，可迁移到程序分析与约束求解的自动调优。
...
### [8] [Trace2Policy: From Expert Behavior Traces to Self-Evolving Decision Agents](http://arxiv.org/abs/2606.10457v1)
...
### [9] [A complementary study on PlanGPT: Evaluation with defined Performance Metrics and comparison with a planner](http://arxiv.org/abs/2606.10489v1)
...
### [10] [A-Evolve-Training: Autonomous Post-Training of a 30B Model](http://arxiv.org/abs/2606.20657v2)
...
### [11] [HIPIF: Hierarchical Planning and Information Folding for Long-Horizon LLM Agent Learning](http://arxiv.org/abs/2606.10507v1)
...
### [12] [ActiveMem: Distributed Active Memory for Long-Horizon LLM Reasoning](http://arxiv.org/abs/2606.10532v1)
...
### [13] [Expected Free Energy-based Planning as Variational Inference](http://arxiv.org/abs/2606.20658v1)
...
### [14] [One Token per Multimodal Evidence: Latent Memory for Resource-Constrained QA](http://arxiv.org/abs/2606.10572v1)
...
### [15] [Learning What to Remember: Observability-Safe Memory Retention via Constrained Optimization for Long-Horizon Language Agents](http://arxiv.org/abs/2606.10616v6)
...
### [16] [Skill Coverage: A Test Adequacy Metric for Agent Skills](http://arxiv.org/abs/2606.20659v2)
...
Selection reason: 提出技能覆盖度指标，基于轨迹评估agent技能执行并给出失败信号，可直接用于代码agent技能测试与改进。
...
### [17] [Infini Memory: Maintainable Topic Documents for Long-Term LLM Agent Memory](http://arxiv.org/abs/2606.10677v1)
...
### [18] [When the Chain of Thought Knows Better: Failure Modes in Multi-Turn Reasoning Models](http://arxiv.org/abs/2606.10740v2)
...
### [19] [The Arbiter Agent: Continually Monitoring Multi-Agent Conversations to Detect Emergent Misalignment](http://arxiv.org/abs/2606.10747v1)
...
### [20] [AutoPDE: Reliable Agentic PDE Solving via Explicitly Represented Solver Strategies](http://arxiv.org/abs/2606.10752v1)
...
### [21] [Evaluating Research-Level Math Proofs via Strict Step-Level Verification](http://arxiv.org/abs/2606.10799v1)
*Yifeng Sun*
...
### [22] [Moonshine: An Autonomous Mathematical Research Agent Centered on Conjecture Generation](http://arxiv.org/abs/2606.10806v1)
...
### [23] [Role-Agent: Bootstrapping LLM Agents via Dual-Role Evolution](http://arxiv.org/abs/2606.10917v1)
...
### [24] [Frontier Coding Agents Use Metaprogramming to Adapt to Unfamiliar Programming Languages](http://arxiv.org/abs/2606.10933v1)
...
### [25] [Recalling Too Well: Sycophancy Evaluation and Mitigation in Memory-Augmented Models](http://arxiv.org/abs/2606.10949v1)
...
### [26] [Mind the Gap: Can Frontier LLMs Pass a Standardized Office Proficiency Exam?](http://arxiv.org/abs/2606.10956v1)
...
### [27] [Structure from Reasoning, Numbers from Search: On-Premise Open LLMs as Structural Priors for Coupled MIMO Controller Tuning](http://arxiv.org/abs/2606.11015v1)
*Jiaxuan Chen,Haonan Li,Yang Shu*

Main category: cs.AI

Comments: 10 pages, 7 figures, 6 tables. Submitted to IEEE Access
...
### [28] [Workflow-GYM: Towards Long-Horizon Evaluation of Computer-use Agentic tasks in Real-World Professional Fields](http://arxiv.org/abs/2606.11042v4)
...
### [29] [What Fits (Into Few Tokens) Doesn't Overfit: Compression and Generalization in ML Research Agents](http://arxiv.org/abs/2606.11045v1)
...
### [30] [CIAware-Bench: Benchmarking Control Intervention Awareness Across Frontier LLMs](http://arxiv.org/abs/2606.11063v1)
...
### [31] [A History-Aware Visually Grounded Critic for Computer Use Agents](http://arxiv.org/abs/2606.11078v1)
...
### [32] [Monte Carlo Pass Search: Using Trajectory Generation for 3D Counterfactual Pass Evaluation in Football](http://arxiv.org/abs/2606.11120v1)
...
### [33] [From Knowing to Acting: Benchmarking Self-Awareness Capability of LLM Agents](http://arxiv.org/abs/2606.20661v1)
...
### [34] [ABC-Bench: An Agentic Bio-Capabilities Benchmark for Biosecurity](http://arxiv.org/abs/2606.11150v1)
...
### [35] [Can AI Agents Synthesize Scientific Conclusions?](http://arxiv.org/abs/2606.11337v1)
...
### [36] [Knowing When to Ask: Self-Gated Clarification for Hierarchical Language Agents](http://arxiv.org/abs/2606.11349v2)
...
### [37] [Automated Mediator for Human Negotiation: Pre-Mediation via a Structured LLM Pipeline](http://arxiv.org/abs/2606.11379v1)
...
### [38] [INFRAMIND: Infrastructure-Aware Multi-Agent Orchestration](http://arxiv.org/abs/2606.11440v1)
...
### [39] [Forecasting Future Behavior as a Learning Task](http://arxiv.org/abs/2606.11445v1)
...
### [40] [Confidence Laundering in Agent Systems: Why Uncertainty Needs a Latent Carrier](http://arxiv.org/abs/2606.20662v1)
...
### [41] [Search Discipline for Long-Horizon Research Agents](http://arxiv.org/abs/2606.11522v1)
...
### [42] [Beyond Coverage and Kill Scores: Empirically Measuring Test Suite Behavioural Gaps](http://arxiv.org/abs/2606.10417v1)
...
Selection reason: 提出行为差距度量补充覆盖率和变异分数，可用于评估测试套件质量，对agent测试生成与验证有参考价值。
...
### [43] [MASTOR: A Multi-Agent Approach to Semantic Test Oracle Generation for RESTful APIs](http://arxiv.org/abs/2606.10465v1)
...
Selection reason: 多智能体生成RESTful API语义测试oracle，含挑战者评审机制，直接涉及agent测试生成与自我改进，相关性强。
...
### [44] [Exploring and Complementing End Users' Requirements in IoT enabled System](http://arxiv.org/abs/2606.10598v1)
...
Selection reason: 面向IoT规则完成的意图驱动多agent框架，虽领域垂直，但其结合LLM推理与可追溯性模型可部分迁移到需求分析agent。
...
### [45] [Watts and Debts of Agentic Frameworks: An Empirical Study (Registered Report)](http://arxiv.org/abs/2606.10702v1)
...
Selection reason: 注册报告研究agent框架技术债与能耗关联，为agent框架质量与可持续性评估提供实证视角，有参考价值。
...
### [46] [DeNovoSWE: Scaling Long-Horizon Environments for Generating Entire Repositories from Scratch](http://arxiv.org/abs/2606.10728v2)
...
Selection reason: 构建大规模全仓库生成数据集并验证训练效果，直接面向长程SWE agent能力提升，高度相关。
...
### [47] [Writing Better Software Explanations: A Guideline-Based Approach](http://arxiv.org/abs/2606.10880v1)
...
Selection reason: 基于指南的LLM辅助解释生成与迭代修订流程，可迁移到agent的受控生成与质量检查工作流设计。
...
### [48] [From Quality Properties to Practice: A Guideline and Workflow for Explainability Requirements](http://arxiv.org/abs/2606.10882v1)
...
Selection reason: 提出指南驱动的可解释性需求工作流，LLM辅助迭代生成与评估，对需求工程agent有一般性参考。
...
### [49] [Early Comparative Evaluation of Transformer Models for Multilingual Software Vulnerability Detection](http://arxiv.org/abs/2606.10925v1)
...
Selection reason: 多语言漏洞检测的Transformer模型比较与评估，提供数据点可参考，但方法贡献有限。
...
### [50] [GapFuzz: Cross-Plane Divergence Fuzzing for Distributed SDN Controllers](http://arxiv.org/abs/2606.11035v2)
...
Selection reason: 面向分布式 SDN 控制器的并发模糊测试方法，其交叉平面状态探测与定时搜索思路可用于分布式系统测试。
...
### [51] [Making Software Meaningful](http://arxiv.org/abs/2606.11051v1)
...
Selection reason: 提出用显式行为语义支撑 LLM 模块化代码生成与 agent 问责，对 coding agent 设计有概念性迁移价值。
...
### [52] [Operationalizing Property-Based Testing for Data-Intensive Scalable Computing Systems](http://arxiv.org/abs/2606.11132v1)
...
Selection reason: 为 Spark 等系统提供属性化测试引擎与可复用元属性，其语义测试方法可用于 agent 生成代码的正确性验证。
...
### [53] [A Constrained Natural-Language Interface for Variational Multi-Physics Finite Element Simulations in FEniCS](http://arxiv.org/abs/2606.10928v1)
...
### [54] [SkillResolve-Bench: Measuring and Resolving Same-Capability Ambiguity in Agent Skill Retrieval](http://arxiv.org/abs/2606.10388v1)
*Jiandong Ding*
...
### [55] [Effective Reinforcement Learning for Agentic Search by Recycling Zero-Variance Queries During Training](http://arxiv.org/abs/2606.10709v1)
...
### [56] [RECON: An LLM-Enhanced Backward Constraint Analysis Framework](http://arxiv.org/abs/2606.10264v1)
...
Selection reason: 将LLM语义理解与静态程序分析结合进行约束提取，比符号执行更快且可解释，适用于程序分析类agent能力增强。
...
### [57] [Assessing Automated Prompt Injection Attacks in Agentic Environments](http://arxiv.org/abs/2606.10525v1)
...
### [58] [Toward Secure LLM Agents: Threat Surfaces, Attacks, Defenses, and Evaluation](http://arxiv.org/abs/2606.10749v1)
...
### [59] [Securing Code Understanding: Detecting Natural Backdoor Vulnerability in Code Language Models](http://arxiv.org/abs/2606.10846v1)
...
Selection reason: 研究CodeLM自然后门漏洞并提出检测方法，对代码agent使用的模型安全性评估有参考价值，但非核心方向。
...
### [60] [Context-Based Adversarial Attacks on AI Code Generators: Vulnerability Analysis and Implications](http://arxiv.org/abs/2606.10945v1)
...
Selection reason: 针对 AI 代码生成器的上下文对抗攻击与防御，可直接迁移到 coding agent 的安全测试与加固。
...
### [61] [Understanding and mitigating the risks of OpenClaw for non-technical users: A practical guide with Skill](http://arxiv.org/abs/2606.11007v1)
...
Selection reason: 对 agent 框架的风险分类与自动化防护 Skill 可迁移到 coding agent 的安全配置与使用。
...
### [62] [MPC-Patch-Bench: Security-Aware LLM Code Patch for Multi-Party Computation](http://arxiv.org/abs/2606.11416v1)
...
### [63] [JailbreakOPT: Tool-Assisted Iterative Jailbreak Prompt Optimization](http://arxiv.org/abs/2606.11425v1)
...
### [64] [Flaws in the LLM Automation Narrative](http://arxiv.org/abs/2606.11166v1)
...
### [65] [Decoupling Thought from Speech: Knowledge-Grounded Counterfactual Reasoning for Resilient Multi-Agent Argumentation](http://arxiv.org/abs/2606.10475v1)
...
### [66] [Decentralized Multi-Agent Systems with Shared Context](http://arxiv.org/abs/2606.10662v1)
...
### [67] [The Confident Liar: Diagnosing Multi-Agent Debate with Log-Probabilities and LLM-as-Judge](http://arxiv.org/abs/2606.10296v1)
...
### [68] [Catching One in Five: LLM-as-Judge Blind Spots in Production Multi-Turn Transaction Agents](http://arxiv.org/abs/2606.10315v1)
...
### [69] [Harnessing the Collective Intelligence of AI Agents in the Wild for New Discoveries](http://arxiv.org/abs/2606.10402v1)
...
### [70] [LakeQA: An Exploratory QA Benchmark over a Million-Scale Data Lake](http://arxiv.org/abs/2606.10460v1)
...
### [71] [Janus: A Benchmark for Goal-Conditioned Information Distortion in LLMs](http://arxiv.org/abs/2606.10852v1)
...
### [72] [T1-Bench: Benchmarking Multi-Scenario Agents in Real-World Domains](http://arxiv.org/abs/2606.11070v1)
...
### [73] [AI Coding Agents in Social Science: Methodologically Diverse, Empirically Consistent, Interpretively Vulnerable](http://arxiv.org/abs/2606.11456v1)
...
### [74] [APEX: Automated Prompt Engineering eXpert with Dynamic Data Selection](http://arxiv.org/abs/2606.11459v1)
...
### [75] [When Role-playing, Do Models Believe What They Say?](http://arxiv.org/abs/2606.11502v3)
...
### [76] [ISE: An Execution-Grounded Recipe for Multi-Turn OS-Agent Trajectories](http://arxiv.org/abs/2606.11520v4)
...
### [77] [Drawing with Strangers: Population Scaling Drives Zero-Shot Mutual Intelligibility in Emergent Sketching](http://arxiv.org/abs/2606.10582v1)
*Jooyeon Kim*
...
### [78] [Causal Ensemble Agent: Hierarchical Causal Discovery with LLM-guided Expert Reweighting](http://arxiv.org/abs/2606.10607v1)
...
### [79] [Divide and Cooperate: Role-Decomposed Multi-Agent LLM Training with Cross-Agent Learning Signals](http://arxiv.org/abs/2606.10684v1)
...
### [80] [Test-Time Gradient Guidance of Flow Policies in Reinforcement Learning](http://arxiv.org/abs/2606.11087v1)
...
### [81] [TRACE: A Unified Rollout Budget Allocation Framework for Efficient Agentic Reinforcement Learning](http://arxiv.org/abs/2606.11119v1)
...
### [82] [EEVEE: Towards Test-time Prompt Learning in the Real World for Self-Improving Agents](http://arxiv.org/abs/2606.11182v1)
...
### [83] [FlowBank: Query-Adaptive Agentic Workflows Optimization through Precompute-and-Reuse](http://arxiv.org/abs/2606.11290v1)
...
### [84] [Signed Compression Progress on a Sealed Audit is Goodhart-Resistant](http://arxiv.org/abs/2606.11417v1)
...
### [85] [The Power of Test-Time Training for Approximate Sampling](http://arxiv.org/abs/2606.11437v1)
...
### [86] [Human-AI Teaming Through the Lens of Calibration](http://arxiv.org/abs/2606.10906v1)
...
### [87] [Towards Autonomous Accelerator Design: FPGA Accelerator Generation with SECDA](http://arxiv.org/abs/2606.11117v1)
...
### [88] [HierSVA: A Data Synthesis Pipeline, Dataset, and Benchmark for LLM-Driven Hierarchical Hardware Formal Verification](http://arxiv.org/abs/2606.13706v1)
...
### [89] [What Matters in Orchestrating Robot Policies: A Systematic Study of Hierarchical VLA Agents](http://arxiv.org/abs/2606.10267v1)
...
### [90] [Embodied-R1.5: Evolving Physical Intelligence via Embodied Foundation Models](http://arxiv.org/abs/2606.11324v2)
...
### [91] [LIBERO-Occ: Evaluating and Improving Vision-Language-Action Models under Scene-Induced Occlusion via Viewpoint Imagination](http://arxiv.org/abs/2606.10862v2)
...
### [92] [An Ocean Model Ported by a Large Language Model: Experience and Lessons from FESOM2 (Fortran to C to C++/Kokkos)](http://arxiv.org/abs/2606.11356v1)
...
Selection reason: LLM 智能体在专家指导下完成 Fortran 到 C++/Kokkos 的完整移植，兼顾正确性验证与 GPU 性能提升，是 coding agent 长程任务的典型范例。
