...
Journal reference: IEEE Access, vol. 14, pp. 102999-103012, 2026

DOI: [10.1109/ACCESS.2026.3709080](https://doi.org/10.1109/ACCESS.2026.3709080)

Author affiliations: Matej Halinkovič: Slovak University of Technology in Bratislava; Nina Masarykova: Slovak University of Technology in Bratislava; Alexey Vinel: Karlsruhe Institute of Technology; Marek Galinski: Slovak University of Technology in Bratislava
...
Journal reference: The 8th International Conference on Artifcial Intelligence in Information and Communication (ICAIIC 2026)
...
Comments: 18 pages, 11 figures, Published in Proceedings of the ACM on Computer Graphics and Interactive Techniques, Vol. 7, Issue. 1 (May 2024)

Journal reference: Proceedings of the ACM on Computer Graphics and Interactive Techniques 7.1 (2024)

DOI: [10.1145/3651300](https://doi.org/10.1145/3651300)

Author affiliations: Ajinkya Gavane: North Carolina State University; Benjamin Watson: North Carolina State University
...
Journal reference: IEEE International Geoscience and Remote Sensing Symposium (IGARSS) 2025, Aug 3-8 2025

DOI: [10.1109/IGARSS55030.2025.11243605](https://doi.org/10.1109/IGARSS55030.2025.11243605)

Author affiliations: Zixuan Xiao: Family Planning Association of Hong Kong / Education University of Hong Kong / University of Hong Kong; Chunguang Hu: Urban Planning & Design Institute of Shenzhen (China) / Peking University Shenzhen Hospital; Jun Ma: Family Planning Association of Hong Kong / Education University of Hong Kong / University of Hong Kong
...
Comments: Also published in Advances in Financial Technologies 2026
...
Journal reference: in IEEE Transactions on Communications, vol. 73, no. 12, pp. 13199-13213, Dec. 2025

DOI: [10.1109/TCOMM.2025.3624165](https://doi.org/10.1109/TCOMM.2025.3624165)

Author affiliations: Vidhi Rana: The University of Texas at Arlington; Rémi A. Chou: The University of Texas at Arlington; Taejoon Kim: Arizona State University
...
- [Stingy Context: 18:1 Hierarchical Code Compression for LLM Auto-Coding](https://arxiv.org/abs/2601.19929) — 相关度 0.92：层次化树状代码压缩实现 18:1 上下文缩减，直接提升 LLM 自动编码任务的上下文效率并缓解 lost-in-the-middle
- [Stingy Context: 18:1 Hierarchical Code Compression for LLM Auto-Coding](https://arxiv.org/abs/2601.19929) — 相关度 0.92：层次化树状代码压缩实现 18:1 上下文缩减，直接提升 LLM 自动编码任务的上下文效率并缓解 lost-in-the-middle
- [Beyond Accuracy: A Cognitive Load Framework for Mapping the Capability Boundaries of Tool-use Agents](https://arxiv.org/abs/2601.20412) — 相关度 0.85：引入认知负荷框架和参数可控的 ToolLoad-Bench，为工具型 agent 的能力边界测绘提供通用评测方法
- [Simulating Complex Multi-Turn Tool Calling Interactions in Stateless Execution Environments](https://arxiv.org/abs/2601.19914) — 相关度 0.72：提出无状态环境下多轮工具调用对话的合成数据生成方法，可直接迁移到 coding agent 的工具调用训练与评测
- [Simulating Complex Multi-Turn Tool Calling Interactions in Stateless Execution Environments](https://arxiv.org/abs/2601.19914) — 相关度 0.72：提出无状态环境下多轮工具调用对话的合成数据生成方法，可直接迁移到 coding agent 的工具调用训练与评测
