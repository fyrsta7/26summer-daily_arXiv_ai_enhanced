...
### [1] [Beyond Trajectory Imitation: Strategy-Guided Policy Optimization for LLM Reasoning](http://arxiv.org/abs/2606.24064v1)
...
### [2] [ReMMD: Realistic Multilingual Multi-Image Agentic Verification for Multimodal Misinformation Detection](http://arxiv.org/abs/2606.24112v1)
...
### [3] [VeryTrace: Verifying Reasoning Traces through Compilable Formalism and Structured Verification](http://arxiv.org/abs/2606.24124v1)
...
### [4] [OmniPath: A Multi-Modal Agentic Framework for Auditing Wheelchair Accessibility](http://arxiv.org/abs/2606.24129v1)
...
### [5] [T2D-Bench: Evidence-Gated Evaluation of LLM Outputs for Type 2 Diabetes Using a Multi-Layer Clinical-Lifestyle Knowledge Graph](http://arxiv.org/abs/2606.24145v1)
...
### [6] [An Introduction to Causal Reinforcement Learning](http://arxiv.org/abs/2606.24160v1)
...
### [7] [Navigating User Behavior toward Personalized Multimodal Generation](http://arxiv.org/abs/2606.24196v2)
...
### [8] [SP-Mind: An Autonomous Reasoning Agent for Spatial Proteomics Analysis](http://arxiv.org/abs/2606.24235v1)
...
### [9] [LemonHarness Technical Report](http://arxiv.org/abs/2606.24311v1)
...
### [10] [Project Auto-World: Towards Automated Benchmarking of Neural Relational Reasoners](http://arxiv.org/abs/2606.24965v1)
...
### [11] [When Helpfulness Overrides Causal Caution: Context-Dependent Suppression and Recovery in LLMs](http://arxiv.org/abs/2606.24370v1)
*Hiroshi Okumura*
...
### [12] [Age of LLM: A Strategic 1v1 Benchmark for Reasoning, Diplomacy and Reliability of Large Language Models under Fog of War](http://arxiv.org/abs/2606.24391v1)
*Arnaud Ricci*
...
### [13] [ATRIA: Adaptive Traceable ECG Reporting with Iterative Agents](http://arxiv.org/abs/2606.24392v2)
...
### [14] [Agentic AI for Bilevel Long-Term Optimization of Policy-Driven Physical Layer Systems](http://arxiv.org/abs/2606.24416v1)
...
### [15] [ReM-MoA: Reasoning Memory Sustains Mixture-of-Agents Scaling](http://arxiv.org/abs/2606.24437v1)
...
### [16] [Bayesian control for coding agents](http://arxiv.org/abs/2606.24453v1)
...
### [17] [The Latent Bridge: A Continuous Slow-Fast Channel for Real-Time Game Agents](http://arxiv.org/abs/2606.24470v1)
*Bojie Li,Noah Shi*
...
### [18] [Diagnosing and Mitigating Compounding Failures in Agentic Persuasion via Taxonomic Strategy Retrieval](http://arxiv.org/abs/2606.24976v3)
...
### [19] [Reinforcement Learning for Computer-Use Agents with Autonomous Evaluation](http://arxiv.org/abs/2606.24515v1)
...
### [20] [Governed Shared Memory for Multi-Agent LLM Systems](http://arxiv.org/abs/2606.24535v1)
...
### [21] [The Verifier is the Curriculum: Execution-Gated Self-Distillation for Cross-Family Game Generation](http://arxiv.org/abs/2607.09709v1)
...
Selection reason: 以严格启动作为不可欺骗的验证门控进行自蒸馏，验证了验证器精度决定生成模型学习收益，可迁移到代码生成 agent 训练。
...
### [22] [AdversaBench: Automated LLM Red-Teaming with Multi-Judge Confirmation and Cross-Model Transferability](http://arxiv.org/abs/2606.24589v1)
*Khanak Khandelwal*
...
### [23] [ASALT: Adaptive State Alignment for Lateral Transfer in Multi-agent Reinforcement Learning](http://arxiv.org/abs/2606.24601v1)
...
### [24] [ScaleToT: Generalizing Structured LLM Reasoning for Billion-Scale Low-Activity User Modeling](http://arxiv.org/abs/2606.24605v1)
...
### [25] [Themis: An explainable AI-enabled framework for Reinforcement Learning with Human Feedback](http://arxiv.org/abs/2606.24622v1)
...
### [26] [SAFARI: Scaling Long Horizon Agentic Fault Attribution via Active Investigation](http://arxiv.org/abs/2606.24626v1)
...
### [27] [LaGO: Latent Action Guidance for Online Reinforcement Learning](http://arxiv.org/abs/2606.24669v1)
...
### [28] [Grading the Grader: Lessons from Evaluating an Agentic Data Analysis System](http://arxiv.org/abs/2606.24839v1)
...
### [29] [World Models in Pieces: Structural Certification for General Agents](http://arxiv.org/abs/2606.24842v1)
...
### [30] [OpenThoughts-Agent: Data Recipes for Agentic Models](http://arxiv.org/abs/2606.24855v1)
...
### [31] [TRUSTMEM: Learning Trustworthy Memory Consolidation for LLM Agents with Long-Term Memory](http://arxiv.org/abs/2606.25161v1)
...
### [32] [Matilda: Engine-Agnostic Search with Human Policy Guidance](http://arxiv.org/abs/2606.25176v2)
*Jason Carlson*
...
### [33] [Transferability for General Reasoning: An Automated Curriculum for Multi-Domain RLVR](http://arxiv.org/abs/2606.25178v2)
...
### [34] [To Isolate or to Score? Model-Adaptive Assessment for Cost-Efficient Multi-Agent RAG](http://arxiv.org/abs/2606.25191v1)
...
### [35] [Heuresis: Search Strategies for Autonomous AI Research Agents Across Quality, Diversity and Novelty](http://arxiv.org/abs/2606.25198v2)
...
### [36] [Life After Benchmark Saturation: A Case Study of CORE-Bench](http://arxiv.org/abs/2606.26158v1)
...
### [37] [Agon: An Autonomous Large-Scale Omnidisciplinary Research System Built on Prompt Economy](http://arxiv.org/abs/2606.24177v1)
...
Selection reason: 提出基于 Prompt Economy 的自主研究编排系统与失败分类法，其循环验证与人工接管机制对 agent 工作流有参考价值。
...
### [38] [AutoSpec: Safety Rule Evolution for LLM Agents via Inductive Logic Programming](http://arxiv.org/abs/2606.24245v3)
...
Selection reason: 通过反例引导归纳逻辑编程自动演化 LLM agent 安全规则，显著降低误报并保持可解释性，适用于代码执行 agent 的安全约束。
...
### [39] [Detecting AI Coding Agents in Open Source: A Validated Multi-Method Census of 180 Million Repositories](http://arxiv.org/abs/2606.24429v1)
...
Selection reason: 提出多方法检测开源 AI 编码 agent 的框架并给出验证统计，为编码 agent 生态感知与评测提供基础数据。
...
### [40] [Agentic Generation of AST Transformation Rules for Fixing Breaking Updates](http://arxiv.org/abs/2606.24446v1)
...
Selection reason: 用 agent 生成可跨项目迁移的 AST 变换规则修复编译失败，直接属于代码修复 agent 的高价值方法。
...
### [41] [Bit-Precise Conformance Testing of Simulink Model Checkers](http://arxiv.org/abs/2606.24719v2)
*Daisuke Ishii,Takashi Tomita,Toshiaki Aoki,Hideaki Takai*

Main category: cs.SE

Comments: 13 pages, accepted as a short paper at QRS 2026

Selection reason: 对 Simulink 模型检查器做位精确一致性测试，其一致性测试方法对验证工具可靠性和测试生成有参考价值。
...
### [42] [MANGO: Automated Multi-Agent Test Oracle Generation for Vision-Language-Action Models](http://arxiv.org/abs/2606.24815v1)
...
Selection reason: 多 agent 自动生成细粒度测试预言用于机器人模型测试，其 oracle 生成与多角色精化机制可迁移到代码 agent 测试。
...
### [43] [LLM4MTLs: Automated Generation and Empirical Evaluation of Model Transformation Languages](http://arxiv.org/abs/2606.25193v1)
...
Selection reason: 系统评估 LLM 生成模型转换语言的提示策略与语法/语义质量，对代码生成 agent 的提示工程有参考价值。
...
### [44] [Test-Input Generation for Tensor Programs: What Actually Finds Kernel Bugs](http://arxiv.org/abs/2606.27396v1)
*Dipankar Sarkar*

Main category: cs.SE

Comments: 8 pages, 1 figure, LNCS format. Companion paper: arXiv:2606.20128 (P1). Additional companions (P2, P4) to follow on arXiv this week; IDs will be added in a v2 replace

Selection reason: 在 26 个 tensor kernel 上对比七种测试输入生成策略的 bug 召回与误报，为测试 agent 的策略选择提供实证依据。
...
### [45] [CAVEWOMAN: How Large Language Models Behave Under Linguistic Input and Output Compression](http://arxiv.org/abs/2606.24083v1)
...
### [46] [Metis: Bridging Text and Code Memory for Self-Evolving Agents](http://arxiv.org/abs/2606.24151v1)
...
### [47] [Pigeonholing: how bad prompts hurt models, causing collapse and mistakes](http://arxiv.org/abs/2606.24267v2)
...
### [48] [Privacy-Preserving RAG via Multi-Agent Semantic Rewriting: Achieving Confidentiality Without Compromising Contextual Fidelity](http://arxiv.org/abs/2606.24623v1)
...
### [49] [Task Decomposition for Efficient Annotation](http://arxiv.org/abs/2606.24734v1)
...
### [50] [DeepBD: A Grounded Agentic Workflow for Variant Prioritization and Diagnosis of Genetic Birth Defects](http://arxiv.org/abs/2606.24779v1)
...
### [51] [PixJail: Self-Evolving Paper-to-Pipeline Reproduction for Text-to-Image Jailbreak Evaluation](http://arxiv.org/abs/2606.24081v1)
...
### [52] [Red-Teaming the Agentic Red-Team](http://arxiv.org/abs/2606.24496v1)
...
### [53] [SoK: AI Secure Code Generation: Progress, Pitfalls, and Paths Forward](http://arxiv.org/abs/2606.25195v1)
...
### [54] [InSight: Self-Guided Skill Acquisition via Steerable VLAs](http://arxiv.org/abs/2606.24884v1)
...
### [55] [RAVEN: Long-Horizon Reasoning & Navigation with a Visuo-Spatio-Temporal Memory](http://arxiv.org/abs/2606.25206v1)
...
### [56] [Blockwise Policy-Drift Gating for On-Policy Distillation](http://arxiv.org/abs/2606.24084v1)
...
### [57] [FlowPipe: LLM-Enhanced Conditional Generative Flow Networks for Data Preparation Pipeline Construction](http://arxiv.org/abs/2606.24679v2)
...
### [58] [ExTra: Exploratory Trajectory Optimization for Language Model Reinforcement Learning](http://arxiv.org/abs/2606.24994v1)
...
### [59] [Geo-Strat-RL: Learning Geological Event Reasoning from Verifiable Tasks](http://arxiv.org/abs/2606.25000v1)
*Lukas Mosser*
...
### [60] [Do Thinking Tokens Help with Safety?](http://arxiv.org/abs/2606.25013v1)
...
### [61] [LLM-ACES: Closed-Loop Discovery of Dynamical Systems with LLM-Guided Adaptive Search](http://arxiv.org/abs/2606.25039v1)
...
### [62] [GCT-MARL: Graph-Based Contrastive Transfer for Sample-Efficient Cooperative Multi-Agent Reinforcement Learning](http://arxiv.org/abs/2606.25073v1)
...
### [63] [EvoClawBench: Can Agents Learn Reusable Skills from Their Own Runs?](http://arxiv.org/abs/2607.09711v1)
...
Selection reason: 提出衡量 agent 从自身运行学习可复用技能的 benchmark，覆盖编码任务并揭示技能 authoring 的选择性收益，直接适用于编码 agent。
...
### [64] [Reward-Conditioned Attention: How Reward Design Shapes What Autonomous Driving Agents See](http://arxiv.org/abs/2606.25127v1)
...
### [65] [ATMA: Length-Invariant Language Modeling via Polar Attention and Gated-Delta Compression Memory](http://arxiv.org/abs/2606.25156v2)
*Habibullah Akbar*
...
### [66] [ASAP: Agent-System Co-Design for Wall-Clock-Centered Auto HPO Research for ML Experiments](http://arxiv.org/abs/2606.25207v1)
...
### [67] [Schema-First Retrieval: Embedding Catalogs for Natural Language Analytics](http://arxiv.org/abs/2606.28387v1)
