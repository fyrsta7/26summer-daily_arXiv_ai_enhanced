...
### [1] [Agentic Retrieval and Reinforcement Learned Equation Chains: A Controlled Generation Framework for Complex and Novel Physics Word Problems](http://arxiv.org/abs/2606.15591v1)
*Tirthankar Mittra*
...
### [2] [Integrating Reasoning and Generalization in Text-to-SQL via Self-Enhanced Fine-Tuning](http://arxiv.org/abs/2606.15598v1)
...
### [3] [From Question Answering to Task Completion: A Survey on Agent System and Harness Design](http://arxiv.org/abs/2606.20683v1)
...
### [4] [Multi-agent Framework for Time-Sensitive Complementary Collaboration in Minecraft](http://arxiv.org/abs/2606.15684v1)
...
### [5] [AI-Driven Framework for Adaptive Water Network Management with Proof-of-Concept Implementation: Addressing Non-Revenue Water in Jordan](http://arxiv.org/abs/2606.15709v1)
...
### [6] [Mitigating Visual Hallucinations in Multimodal Systems through Retrieval-Augmented Reliability-Aware Inference](http://arxiv.org/abs/2606.15782v1)
...
### [7] [TrustedARI: Towards Trust-Native Agentic Routing Infrastructure for Agentic AI](http://arxiv.org/abs/2606.15822v1)
...
### [8] [AIChilles: Automatically Uncovering Hidden Weaknesses in AI-Evolved Systems](http://arxiv.org/abs/2606.15834v2)
...
### [9] [Heteroskedastic Signals in Budgeted LLM Verification: Structural Heterogeneity Limits Optimization Gains](http://arxiv.org/abs/2606.15841v1)
*Jinlong Yang*
...
### [10] [RetailBench: Benchmarking long horizon reasoning and coherent decision making of LLM agents in realistic retail environments](http://arxiv.org/abs/2606.15862v3)
...
### [11] [STRIDE: Strategic Trajectory Reasoning via Discriminative Estimation for Verifiable Reinforcement Learning](http://arxiv.org/abs/2606.15866v1)
...
### [12] [LLM-as-Code: Agentic Programming for Agent Harness](http://arxiv.org/abs/2606.15874v2)
...
Selection reason: 主张由程序控制流主导、LLM作为被调用组件，为agent harness设计提供颠覆性架构，明显可迁移。
...
### [13] [Agentic Framework for Deep Learning workload migration via In-Context Learning](http://arxiv.org/abs/2606.15994v1)
...
### [14] [Auditing Reward Hackability in Code RL Training Environments](http://arxiv.org/abs/2606.16062v1)
*Shreshth Rajan*
...
### [15] [Mind-Studio: Executable World Models with Lookahead Evaluation for Partially Observable Games](http://arxiv.org/abs/2606.16070v2)
...
### [16] [Software Delegation Contracts: Measuring Reviewability in AI Coding-Agent Work](http://arxiv.org/abs/2606.17099v1)
*Vincent Schmalbach*
...
Selection reason: 通过受控实验测量软件委托契约对coding agent可审查性的影响，为agent工作包评审机制提供实证。
...
### [17] [DynAMO:Dynamic Asset Management Orchestration via Topological Multi-Agent Scheduling](http://arxiv.org/abs/2606.19382v1)
...
Selection reason: Plan-then-Execute多agent调度，支持并行拓扑执行和结构化上下文剪枝，可迁移到代码agent工作流编排。
...
### [18] [Configuration Smells in AGENTS.md Files: Common Mistakes in Configuring Coding Agents](http://arxiv.org/abs/2606.15828v4)
...
Selection reason: 首次系统化定义AGENTS.md配置文件smells并给出检测启发式，直接指导coding agent配置修复。
...
### [19] [Graphical-Probabilistic Modeling of Generative Flows in LLM-Native Software Systems](http://arxiv.org/abs/2606.15943v1)
...
Selection reason: 用图概率模型对LLM原生软件的生成流建模，可为agent系统设计分析与评测提供形式化基础。
...
### [20] [Green SARC: Predictive Cost and Carbon Governance for Agentic AI Systems](http://arxiv.org/abs/2606.15954v1)
*Gaston Besanson*
...
Selection reason: 在agent循环中设置成本/碳预算门控并用保形校准预测，其控制机制可迁移到代码agent的资源治理。
...
### [21] [Open-SWE-Traces: Advancing Dual-Mode Multilingual Distillation for Software Engineering Agents](http://arxiv.org/abs/2606.16038v1)
...
Selection reason: 发布20万条多语言SWE agent轨迹数据集并验证蒸馏效果，直接服务代码agent训练与评测。
...
### [22] [LLM Judges Have Dark Current: A Psychometric Datasheet for LLM-as-a-Judge Evaluation](http://arxiv.org/abs/2606.15610v1)
...
### [23] [Vernier: Probing Representational Misalignment Behind Lexical Gaps in Causal Reasoning](http://arxiv.org/abs/2606.15733v1)
*Zhenyu Yu*
...
### [24] [Retrievable Gradients: Continual Post-Training Without Cumulative Weight Drift](http://arxiv.org/abs/2606.15734v1)
...
### [25] [A Self Consistency Based Reranking for Narrative Question Answering](http://arxiv.org/abs/2606.15741v1)
...
### [26] [DYNA : Dynamic Episodic Memory Networks for Augmenting Large Language Models with Temporal Knowledge Graphs in Continuous Learning](http://arxiv.org/abs/2606.15778v1)
...
### [27] [Free Energy Heuristics: Fast-And-Frugal Cognition as Active Inference Under Uncertain Precision](http://arxiv.org/abs/2606.15877v1)
*Alex Bogdan*
...
### [28] [Control-Plane Placement Shapes Forgetting: An Architectural Study of Agent Memory Across Thirteen System Configurations](http://arxiv.org/abs/2606.15903v2)
*Dongxu Yang*
...
### [29] [MAGE-RAG: Multigranular Adaptive Graph Evidence for Agentic Multimodal RAG in Long-Document QA](http://arxiv.org/abs/2606.15906v1)
...
### [30] [CAMI: Cost-Aware Agent-Guided Multi-Indexing for Semantic Retrieval](http://arxiv.org/abs/2606.28365v1)
...
### [31] [Retrieve, Don't Retrain: Extending Vision Language Action Models to New Tasks at Test Time](http://arxiv.org/abs/2606.15631v1)
...
### [32] [PO-PDDL: Learning Symbolic POMDPs from Visual Demonstrations for Robot Planning Under Uncertainty](http://arxiv.org/abs/2606.15654v1)
...
### [33] [DeepRoot: A KG-Coordinated Multi-Agent System for Therapeutic Reasoning over Historical Medical Texts](http://arxiv.org/abs/2606.15931v1)
...
### [34] [Localizing Credit at the Divergence: Path-Conditioned Self-Distillation for LLM Reasoning](http://arxiv.org/abs/2606.15576v1)
...
### [35] [Is Code Better Than Language for Algorithmic Reasoning](http://arxiv.org/abs/2606.15589v1)
...
### [36] [The Reservoir Attention Network: Cross-Pass State in Pretrained Transformers via Content-Addressable Reservoir Injection](http://arxiv.org/abs/2606.15678v2)
*Emma Leonhart*
...
### [37] [Models Take Notes at Prefill: KV Cache Can Be Editable and Composable](http://arxiv.org/abs/2606.17107v1)
*Bojie Li*
...
### [38] [On-Policy Distillation with Curriculum Turn-level Guidance for Multi-turn Agents](http://arxiv.org/abs/2606.15912v1)
...
### [39] [AuditWeave: A Tamper-Evident, Auditor-Navigable Evidence Layer for AI-Assisted and Data-Transformation Workflows](http://arxiv.org/abs/2607.09682v1)
*Vimal Nakrani*
...
Selection reason: 为AI与数据工作流提供防篡改、可审计的哈希链证据层，可增强代码agent的可追溯与审计能力。
...
### [40] [Orchestrated Reality: From Role-Play to Living, Playable Game Worlds -- LLM-Driven World Simulation as a Parameterized-Action POMDP](http://arxiv.org/abs/2606.16014v1)
...
### [41] [MAF: Multimodal Adaptive Few-shot Prompting for Sentiment Analysis with MLLMs](http://arxiv.org/abs/2606.15694v1)
*Hangling Xie*
...
### [42] [One Goal, Many Commands: Characterizing Denylist Fragility in AI Agents](http://arxiv.org/abs/2606.15549v2)
...
### [43] [FragFuse: Bypassing Access Control of Large Language Model Agents via Memory-Based Query Fragmentation and Fusion](http://arxiv.org/abs/2606.15609v1)
...
### [44] [Odds Law: The Decomposition Algebra On How Intelligence Organizes Itself to Solve Difficult Problems Reliably](http://arxiv.org/abs/2606.15712v1)
*Hidayet Aksu*
...
### [45] [Snyk VulnBench JS 1.0: Can LLMs Find the Same Bugs Twice?](http://arxiv.org/abs/2606.15762v1)
...
Selection reason: 构建漏洞扫描可重复性基准，说明agentic LLM与SAST互补，对代码安全agent评测有直接价值。
...
### [46] [SkillVetBench: LLM-as-Judge for Multi-Dimensional Security Risk Evaluation in Open-Source LLM Agent Skills](http://arxiv.org/abs/2606.15899v1)
