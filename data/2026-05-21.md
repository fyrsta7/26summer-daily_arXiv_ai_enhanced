...
### [39] [MAVEN: A Multi-stage Agentic Annotation Pipeline for Video Reasoning Tasks](http://arxiv.org/abs/2605.21917v2)
...
### [40] [The Neglected Baseline in Model Interpretation](http://arxiv.org/abs/2605.22417v4)
...
### [41] [Pre-VLA: Preemptive Runtime Verification for Reliable Vision-Language-Action and World-Model Rollouts](http://arxiv.org/abs/2605.22446v1)
...
### [42] [GazeBehavior Annotation Toolkit (GBAT): AI-powered toolkit for automatic annotation of egocentric eye-tracking and video data of child-caregiver interaction](http://arxiv.org/abs/2605.22962v1)
...
### [43] [From Reasoning Chains to Verifiable Subproblems: Curriculum Reinforcement Learning Enables Credit Assignment for LLM Reasoning](http://arxiv.org/abs/2605.22074v1)
...
### [44] [Short-Term-to-Long-Term Memory Transfer for Knowledge Graphs under Partial Observability](http://arxiv.org/abs/2605.22142v2)
...
### [45] [One-Way Policy Optimization for Self-Evolving LLMs](http://arxiv.org/abs/2605.22156v1)
...
### [46] [Can Transformers Learn to Verify During Backtracking Search?](http://arxiv.org/abs/2605.22221v1)
...
### [47] [What are the Right Symmetries for Formal Theorem Proving?](http://arxiv.org/abs/2605.22257v1)
...
### [48] [Tailoring Teaching to Aptitude: Direction-Adaptive Self-Distillation for LLM Reasoning](http://arxiv.org/abs/2605.22263v1)
...
### [49] [VeriScale: Adversarial Test-Suite Scaling for Verifiable Code Generation](http://arxiv.org/abs/2605.22368v1)
...
### [50] [Don't Forget the Critic: Value-Based Data Rehearsal for Multi-Cyclic Continual Reinforcement Learning](http://arxiv.org/abs/2605.22454v1)
...
### [51] [Understanding Multimodal Failure in Action-Chunking Behavioral Cloning](http://arxiv.org/abs/2605.22493v1)
...
### [52] [The Neural Compiler: Program-to-Network Translation for Hybrid Scientific Machine Learning](http://arxiv.org/abs/2605.22498v1)
*Lucas Sheneman*
...
### [53] [Post-Training is About States, Not Tokens: A State Distribution View of SFT, RL, and On-Policy Distillation](http://arxiv.org/abs/2605.22731v1)
*Dong Nie*
...
### [54] [Vector Policy Optimization: Training for Diversity Improves Test-Time Search](http://arxiv.org/abs/2605.22817v1)
...
### [55] [Test-Time Training Undermines Safety Guardrails](http://arxiv.org/abs/2605.22984v1)
...
### [56] [LLM-AutoSciLab: Closed-Loop Scientific Discovery via Active Experimentation with LLMs](http://arxiv.org/abs/2605.24043v1)
...
### [57] [Mixture of Complementary Agents for Robust LLM Ensemble](http://arxiv.org/abs/2605.24048v1)
...
### [58] [Decomposing and Measuring Evaluation Awareness](http://arxiv.org/abs/2605.23055v2)
...
### [59] [Self-Play Reinforcement Learning under Imperfect Information in Big 2](http://arxiv.org/abs/2605.28863v2)
*Aalok Patwa*
...
### [60] [ACC: Compiling Agent Trajectories for Long-Context Training](http://arxiv.org/abs/2605.21850v2)
...
### [61] [DeferMem: Query-Time Evidence Distillation via Reinforcement Learning for Long-Term Memory QA](http://arxiv.org/abs/2605.22411v1)
...
### [62] [From Correlation to Cause: A Five-Stage Methodology for Feature Analysis in Transformer Language Models](http://arxiv.org/abs/2605.22462v1)
*Caleb Munigety*
...
### [63] [SynAE: A Framework for Measuring the Quality of Synthetic Data for Tool-Calling Agent Evaluations](http://arxiv.org/abs/2605.22564v1)
...
### [64] [Agentic CLEAR: Automating Multi-Level Evaluation of LLM Agents](http://arxiv.org/abs/2605.22608v1)
...
### [65] [Graph Alignment Topology as an Inductive Bias for Grounding Detection](http://arxiv.org/abs/2605.22963v1)
...
### [66] [A Proactive Multi-Agent Dialogue Framework for Assessing Social Language Disorder Traits in Autism](http://arxiv.org/abs/2605.22993v1)
...
### [67] [Incentive-Aligned Vehicle-to-Vehicle Energy Trading via Nash-Integrated Multi-Agent Reinforcement Learning](http://arxiv.org/abs/2605.22363v1)
...
### [68] [Sibyl-AutoResearch: Autonomous Research Needs Self-Evolving Trial-and-Error Harnesses, Not Paper Generators](http://arxiv.org/abs/2605.22343v1)
...
### [69] [MadEvolve: Evolutionary Optimization of Trading Systems with Large Language Models](http://arxiv.org/abs/2605.23007v1)
...
### [71] [Benchmarking Autonomous Agents against Temporal, Spatial, and Semantic Evasions](http://arxiv.org/abs/2605.22321v1)
...
### [72] [Measuring Security Without Fooling Ourselves: Why Benchmarking Agents Is Hard](http://arxiv.org/abs/2605.22568v1)
...
### [73] [Innovations in Cardless Artificial Intelligence Banking: A Comprehensive Framework for Cyber Secure and Fraud Mitigation using Machine Learning Algorithms](http://arxiv.org/abs/2605.22604v1)
*Md Israfeel*
...
### [74] [EvoScene-VLA: Evolving Scene Beliefs Inside the Action Decoder for Chunked Robot Control](http://arxiv.org/abs/2605.21862v1)
...
### [75] [Steins;Gate Drive: Semantic Safety Arbitration over Structured Futures for Latency-Decoupled LLM Planning](http://arxiv.org/abs/2605.22456v1)
...
### [76] [Agentic-VLA: Efficient Online Adaptation for Vision-Language-Action Models](http://arxiv.org/abs/2605.22896v1)
...
### [77] [Robots That Know What to Ask: Recovering Misaligned Rewards through Targeted Explanations](http://arxiv.org/abs/2605.22986v1)
...
### [78] [RED: Adaptive Real-Time DAG Scheduling for Robotic Inference under Environmental Dynamics](http://arxiv.org/abs/2605.24044v1)
...
### [79] [DeltaBox: Scaling Stateful AI Agents with Millisecond-Level Sandbox Checkpoint/Rollback](http://arxiv.org/abs/2605.22781v2)
...
### [80] [Simulating Hate Speech Cascades with Multi-LLM Agents: Empirical Grounding, Modeling Fidelity, and Intervention Strategies](http://arxiv.org/abs/2606.18264v1)
*Fan Huang*
...
### [81] [Astragalus: Automatic Configuration Repair for Production Networks](http://arxiv.org/abs/2605.22092v2)
