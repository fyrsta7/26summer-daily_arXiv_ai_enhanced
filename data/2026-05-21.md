...
### [1] [ImProver 2: Iteratively Self-Improving LMs for Neurosymbolic Proof Optimization](http://arxiv.org/abs/2605.22885v1)
...
### [2] [Planning in the LLM Era: Building for Reliability and Efficiency](http://arxiv.org/abs/2605.21902v1)
...
### [3] [AI-Enabled Serious Games: Integrating Intelligence and Adaptivity in Training Systems](http://arxiv.org/abs/2605.21962v1)
...
### [4] [Echo: Learning from Experience Data via User-Driven Refinement](http://arxiv.org/abs/2605.21984v1)
...
### [5] [The Log is the Agent: Event-Sourced Reactive Graphs for Auditable, Forkable Agentic Systems](http://arxiv.org/abs/2605.21997v1)
*Yohei Nakajima*
...
### [6] [Active Evidence-Seeking and Diagnostic Reasoning in Large Language Models for Clinical Decision Support](http://arxiv.org/abs/2605.22047v1)
...
### [7] [ExComm: Exploration-Stage Communication for Error-Resilient Agentic Test-Time Scaling](http://arxiv.org/abs/2605.22102v1)
...
### [8] [ArborKV: Structure-Aware KV Cache Management for Scaling Tree-based LLM Reasoning](http://arxiv.org/abs/2605.22106v1)
...
### [9] [Efficient Agentic Reasoning Through Self-Regulated Simulative Planning](http://arxiv.org/abs/2605.22138v1)
...
### [10] [Ratchet: A Minimal Hygiene Recipe for Self-Evolving LLM Agents](http://arxiv.org/abs/2605.22148v1)
...
### [11] [IdleSpec: Exploiting Idle Time via Speculative Planning for LLM Agents](http://arxiv.org/abs/2605.22154v1)
...
### [12] [Adapting the Interface, Not the Model: Runtime Harness Adaptation for Deterministic LLM Agents](http://arxiv.org/abs/2605.22166v2)
...
### [13] [Skill Weaving: Efficient LLM Improvement via Modular Skillpacks](http://arxiv.org/abs/2605.22205v1)
...
### [14] [CLORE: Content-Level Optimization for Reasoning Efficiency](http://arxiv.org/abs/2605.22211v1)
...
### [15] [SGR-Bench: Benchmarking Search Agents on State-Gated Retrieval](http://arxiv.org/abs/2605.22219v1)
...
### [16] [Evaluating Large Language Models as Live Strategic Agents: Provider Performance, Hybrid Decomposition, and Operational Gaps in Timed Risk Play](http://arxiv.org/abs/2605.22238v1)
*H. C. Ekne*
...
### [17] [Unlocking Proactivity in Task-Oriented Dialogue](http://arxiv.org/abs/2605.22240v2)
...
### [18] [Cross-domain benchmarks reveal when coordinated AI agents improve scientific inference from partial evidence](http://arxiv.org/abs/2605.22300v1)
...
### [19] [Scaling Observation-aware Planning in Uncertain Domains](http://arxiv.org/abs/2605.22364v1)
...
### [20] [S2ED: From Story to Executable Descriptions for Consistency-Aware Story Illustration](http://arxiv.org/abs/2605.22448v1)
...
### [21] [KAPPS: A knowledge-based CPPS Architecture for the Circular Factory](http://arxiv.org/abs/2605.22457v1)
...
### [22] [Compiling Agentic Workflows into LLM Weights: Near-Frontier Quality at Two Orders of Magnitude Less Cost](http://arxiv.org/abs/2605.22502v1)
...
### [23] [Towards Direct Evaluation of Harness Optimizers via Priority Ranking](http://arxiv.org/abs/2605.22505v1)
...
### [24] [Search-E1: Self-Distillation Drives Self-Evolution in Search-Augmented Reasoning](http://arxiv.org/abs/2605.22511v2)
...
### [25] [TerminalWorld: Benchmarking Agents on Real-World Terminal Tasks](http://arxiv.org/abs/2605.22535v1)
...
### [26] [Think Thrice Before You Speak: Dual knowledge-enhanced Theory-of-Mind Reasoning for Persuasive Agents](http://arxiv.org/abs/2605.22602v1)
...
### [27] [Spreadsheet-RL: Advancing Large Language Model Agents on Realistic Spreadsheet Tasks via Reinforcement Learning](http://arxiv.org/abs/2605.22642v1)
...
### [28] [Claw AI Lab: An Autonomous Multi-Agent Research Team](http://arxiv.org/abs/2605.22662v1)
...
### [29] [MBABench: Evaluating LLM Agents on End-to-End Spreadsheet Tasks in Finance](http://arxiv.org/abs/2605.22664v4)
...
### [30] [Is Capability a Liability? More Capable Language Models Make Worse Forecasts When It Matters Most](http://arxiv.org/abs/2605.22672v2)
...
### [31] [AMEL: Accumulated Message Effects on LLM Judgments](http://arxiv.org/abs/2605.22714v3)
*Sid-Ali Temkit*
...
### [32] [HarnessAPI: A Skill-First Framework for Unified Streaming APIs and MCP Tools](http://arxiv.org/abs/2605.22733v1)
*Edwin Jose*
...
Selection reason: 统一HTTP与MCP工具封装，减少agent工具开发样板代码，有工程迁移价值。
...
### [33] [Towards a General Intelligence and Interface for Wearable Health Data](http://arxiv.org/abs/2605.22759v3)
...
### [34] [Advancing Mathematics Research with AI-Driven Formal Proof Search](http://arxiv.org/abs/2605.22763v2)
...
### [35] [LCGuard: Latent Communication Guard for Safe KV Sharing in Multi-Agent Systems](http://arxiv.org/abs/2605.22786v1)
...
### [36] [EVE-Agent: Evidence-Verifiable Self-Evolving Agents](http://arxiv.org/abs/2605.22905v1)
...
### [37] [MOSS: Self-Evolution through Source-Level Rewriting in Autonomous Agent Systems](http://arxiv.org/abs/2605.22794v2)
...
### [38] [PathCal: State-Aware Reflection-Marker Calibration for Efficient Reasoning](http://arxiv.org/abs/2605.23074v1)
...
### [39] [PITMuS: A Tool for Automated Bug Dataset Generation via Source-Level Mutant Reconstruction](http://arxiv.org/abs/2605.21930v1)
...
Selection reason: PITMuS通过变异重建生成源码级bug数据集，输出可执行的buggy/fix代码对，为修复agent训练与评测提供新数据源。
...
### [40] [Deterministic vs. Probabilistic Summarisation: An Empirical Trade-off Study in Design Pattern Centric Java Code](http://arxiv.org/abs/2605.21943v1)
...
Selection reason: 对比确定性vs概率性代码摘要生成，揭示语义深度与可复现性的权衡，对agent中代码文档生成技术选型有参考价值。
...
### [41] [From Patches to Trajectories: Privileged Process Supervision for Software-Engineering Agents](http://arxiv.org/abs/2605.21996v1)
...
Selection reason: 利用开发者参考补丁监督SWE agent轨迹构建，在SWE-bench Verified上Pass@1提升10.8点并降低约15%推理成本，直接核心相关。
...
### [42] [Finding Missing Input Validation in TEEs via LLM-Assisted Symbolic Execution](http://arxiv.org/abs/2605.22058v1)
...
Selection reason: LLM辅助符号执行框架SymTEE，自动将TEE代码切片转换为KLEE可用的mock环境，以低成本检测输入验证缺失，方法可迁移到其他验证任务。
...
### [43] [Automated Repair of TEE Partitioning Issues via DSL-Guided and LLM-Assisted Patching](http://arxiv.org/abs/2605.22087v1)
...
Selection reason: DSL引导+LLM辅助的TEE分区问题自动修复框架，生成测试客户端验证修复，修复成功率达87.6%，对自动修复agent有参考。
...
### [44] [SWE-Mutation: Can LLMs Generate Reliable Test Suites in Software Engineering?](http://arxiv.org/abs/2605.22175v1)
...
Selection reason: SWE-Mutation基准通过系统性变异评估LLM生成测试套件的判别力，并设计agentic变异框架，直接服务于SWE agent的测试与评估。
...
### [45] ["Refactoring Runaway": Understanding and Mitigating Tangled Refactorings in Coding Agents for Issue Resolution](http://arxiv.org/abs/2605.22526v1)
...
Selection reason: 实证分析并缓解coding agent的tangled refactoring，提升可编译性与问题解决率。
...
### [46] [Why Are Agentic Pull Requests Merged or Rejected? An Empirical Study](http://arxiv.org/abs/2605.22534v1)
...
Selection reason: 揭示agentic PR合并/拒绝结果不能直接反映agent能力，提出交互感知评估方法。
...
### [47] [Contractual Skills: A GovernSpec Design Framework for Enterprise AI Agents](http://arxiv.org/abs/2605.22634v2)
*Ting Liu*

Main category: cs.SE

Comments: 15 pages, 5 figures, 4 tables. v2 adds a public-skill A/B study, updates experimental results, and adds a public replication package link: https://github.com/SymbolicLight-AGI/contractual-skill

Selection reason: 为企业AI agent设计契约式技能框架，显式化任务边界与验收标准，提升可靠性与治理。
...
### [48] [LLM Code Smells: A Taxonomy and Detection Approach](http://arxiv.org/abs/2605.22976v1)
...
Selection reason: 提出LLM code smells分类与静态检测工具，帮助提升LLM集成代码质量。
...
### [49] [Finding Performance Issues in Database Systems by Exploiting Dormant Code Paths](http://arxiv.org/abs/2605.22992v1)
...
Selection reason: 通过分支翻转分析系统性发现数据库性能问题，方法可迁移到其他系统的性能调优。
...
### [50] [A measurement substrate for agentic Kubernetes operations: Methodology and a case study in retrieval-compounding falsification](http://arxiv.org/abs/2605.23058v1)
...
Selection reason: 为Kubernetes运维agent构建可证伪的测量框架，包含对照控制与预注册决策矩阵，方法论可迁移。
...
### [51] [Security of LLM-generated Code: A Comparative Analysis](http://arxiv.org/abs/2605.23091v1)
...
Selection reason: 系统比较多个LLM生成代码的安全性，为agent输出验证与测评提供实证依据。
...
### [52] [More Skills, Worse Agents? Skill Shadowing Degrades Performance When Expanding Skill Libraries](http://arxiv.org/abs/2605.24050v2)
...
Selection reason: 揭示技能库扩大导致agent性能下降的skill shadowing效应，提出分解与上界分析方法。
...
### [53] [Philosophical Dispositions as Behavioral Constraints for AI-Assisted Code Review: An Empirical Study](http://arxiv.org/abs/2605.23108v1)
*Kaushal Bansal*
...
Selection reason: 用哲学倾向约束AI代码审查行为，实证显示能产生独特且有效的审查发现，可用于评审agent设计。
...
### [54] [Blind Spots in the Guard: How Domain-Camouflaged Injection Attacks Evade Detection in Multi-Agent LLM Systems](http://arxiv.org/abs/2605.22001v1)
*Aaditya Pai*
...
### [55] [Benchmarking Autonomous Agents against Temporal, Spatial, and Semantic Evasions](http://arxiv.org/abs/2605.22321v1)
...
Selection reason: 提出时间/空间/语义三类规避攻击并构建A3S-Bench基准，系统评估自主agent的安全脆弱性，可迁移到coding agent的防御设计。
...
### [56] [Measuring Security Without Fooling Ourselves: Why Benchmarking Agents Is Hard](http://arxiv.org/abs/2605.22568v1)
...
### [57] [MAVEN: A Multi-stage Agentic Annotation Pipeline for Video Reasoning Tasks](http://arxiv.org/abs/2605.21917v2)
...
### [58] [Pre-VLA: Preemptive Runtime Verification for Reliable Vision-Language-Action and World-Model Rollouts](http://arxiv.org/abs/2605.22446v1)
...
### [59] [From Reasoning Chains to Verifiable Subproblems: Curriculum Reinforcement Learning Enables Credit Assignment for LLM Reasoning](http://arxiv.org/abs/2605.22074v1)
...
### [60] [Short-Term-to-Long-Term Memory Transfer for Knowledge Graphs under Partial Observability](http://arxiv.org/abs/2605.22142v2)
...
### [61] [One-Way Policy Optimization for Self-Evolving LLMs](http://arxiv.org/abs/2605.22156v1)
...
### [62] [Can Transformers Learn to Verify During Backtracking Search?](http://arxiv.org/abs/2605.22221v1)
...
### [63] [What are the Right Symmetries for Formal Theorem Proving?](http://arxiv.org/abs/2605.22257v1)
...
### [64] [Tailoring Teaching to Aptitude: Direction-Adaptive Self-Distillation for LLM Reasoning](http://arxiv.org/abs/2605.22263v1)
...
### [65] [VeriScale: Adversarial Test-Suite Scaling for Verifiable Code Generation](http://arxiv.org/abs/2605.22368v1)
...
Selection reason: 提出对抗式测试集扩展与精简框架，直接提升代码生成benchmark的判别力与可验证性。
...
### [66] [Don't Forget the Critic: Value-Based Data Rehearsal for Multi-Cyclic Continual Reinforcement Learning](http://arxiv.org/abs/2605.22454v1)
...
### [67] [Understanding Multimodal Failure in Action-Chunking Behavioral Cloning](http://arxiv.org/abs/2605.22493v1)
...
### [68] [The Neural Compiler: Program-to-Network Translation for Hybrid Scientific Machine Learning](http://arxiv.org/abs/2605.22498v1)
*Lucas Sheneman*
...
### [69] [Post-Training is About States, Not Tokens: A State Distribution View of SFT, RL, and On-Policy Distillation](http://arxiv.org/abs/2605.22731v1)
*Dong Nie*
...
### [70] [Vector Policy Optimization: Training for Diversity Improves Test-Time Search](http://arxiv.org/abs/2605.22817v1)
...
### [71] [Test-Time Training Undermines Safety Guardrails](http://arxiv.org/abs/2605.22984v1)
...
### [72] [LLM-AutoSciLab: Closed-Loop Scientific Discovery via Active Experimentation with LLMs](http://arxiv.org/abs/2605.24043v1)
...
### [73] [Mixture of Complementary Agents for Robust LLM Ensemble](http://arxiv.org/abs/2605.24048v1)
...
### [74] [Decomposing and Measuring Evaluation Awareness](http://arxiv.org/abs/2605.23055v2)
...
### [75] [Self-Play Reinforcement Learning under Imperfect Information in Big 2](http://arxiv.org/abs/2605.28863v2)
*Aalok Patwa*
...
### [76] [MadEvolve: Evolutionary Optimization of Trading Systems with Large Language Models](http://arxiv.org/abs/2605.23007v1)
...
### [77] [Astragalus: Automatic Configuration Repair for Production Networks](http://arxiv.org/abs/2605.22092v2)
...
Selection reason: 提出语法驱动的网络配置自动修复方法Astragalus，借鉴APR的localize-fix-validate流程，配置修复方法对工程化agent有迁移价值。
...
### [78] [Incentive-Aligned Vehicle-to-Vehicle Energy Trading via Nash-Integrated Multi-Agent Reinforcement Learning](http://arxiv.org/abs/2605.22363v1)
...
### [79] [Simulating Hate Speech Cascades with Multi-LLM Agents: Empirical Grounding, Modeling Fidelity, and Intervention Strategies](http://arxiv.org/abs/2606.18264v1)
*Fan Huang*
...
Selection reason: 为tool-calling agent合成数据质量提供多轴评估框架，可用于评测基准构建。
...
### [87] [Sibyl-AutoResearch: Autonomous Research Needs Self-Evolving Trial-and-Error Harnesses, Not Paper Generators](http://arxiv.org/abs/2605.22343v1)
...
Selection reason: 自进化AutoResearch框架通过试错harness和行为转换实现自我改进，其记忆、失败登记、系统修复等机制可迁移到长程coding agent。
...
### [88] [DeltaBox: Scaling Stateful AI Agents with Millisecond-Level Sandbox Checkpoint/Rollback](http://arxiv.org/abs/2605.22781v2)
...
### [89] [EvoScene-VLA: Evolving Scene Beliefs Inside the Action Decoder for Chunked Robot Control](http://arxiv.org/abs/2605.21862v1)
...
### [90] [Steins;Gate Drive: Semantic Safety Arbitration over Structured Futures for Latency-Decoupled LLM Planning](http://arxiv.org/abs/2605.22456v1)
...
### [91] [Agentic-VLA: Efficient Online Adaptation for Vision-Language-Action Models](http://arxiv.org/abs/2605.22896v1)
...
### [92] [Robots That Know What to Ask: Recovering Misaligned Rewards through Targeted Explanations](http://arxiv.org/abs/2605.22986v1)
