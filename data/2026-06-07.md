...
- [Beyond Pass Rate: A Multilingual, Execution-Grounded Evaluation of Open Code LLMs](http://arxiv.org/abs/2606.08840v1) — 相关度 0.90：大规模多语言执行导向的代码LLM评测，揭示性能与失败模式，对benchmark设计有直接参考。
- [Projecting the Emerging Mindset of SWE Agent by Launching a Wild Code Understanding Journey](http://arxiv.org/abs/2606.08500v1) — 相关度 0.90：提出对SWE agent轨迹进行观察投影的装置与方法，用于刻画agent行为，直接相关。
- [LLM vs. Human Unit Tests: Fault Detection on Real Python Bugs](http://arxiv.org/abs/2606.08588v1) — 相关度 0.85：对比LLM与人工单元测试对真实Python bug的故障检测，强调覆盖率的不足，助力agent测试生成评估。
- [Structuring agentic AI for HPC code modernization](http://arxiv.org/abs/2606.08710v1) — 相关度 0.85：面向HPC代码现代化的结构化agentic AI方法，直接涉及代码迁移与并行化，对coding agent有明确迁移价值。
- [Auditable Graph-Guided Root Cause Analysis for Kubernetes Incidents](http://arxiv.org/abs/2606.08590v1) — 相关度 0.80：图引导的Kubernetes RCA agent，具备可审计验证、确定性图操作与消融检查，对agent可靠性设计有参考。
- [When LLMs Invent Rust Crates: An Empirical Study of Hallucination Patterns and Mitigation](http://arxiv.org/abs/2606.08444v1) — 相关度 0.80：首次系统研究Rust crate幻觉模式并提出缓解prompt策略，直接关乎代码生成可靠性。
- [Governance Controls for AI-Generated Test Artifacts in Autonomous Software Testing](http://arxiv.org/abs/2606.08806v1) — 相关度 0.75：为AI生成测试工件引入治理验证与可解释性机制，提升自主测试可靠性，与测试生成agent相关。
- [Lost in the Flow with Code Talkers: Unveiling the Instruction-Tuning Tax of Large Language Models in Code Tasks](http://arxiv.org/abs/2606.08676v1) — 相关度 0.75：实证揭示指令微调在代码任务上的infilling与指令遵循权衡，对coding assistant模型设计有指导。
- [FusionVul: A Multimodal Feature Fusion Framework for Source Code Vulnerability Detection](http://arxiv.org/abs/2606.08553v1) — 相关度 0.70：多模态融合的漏洞检测框架，属于程序分析通用方法，可辅助agent理解代码安全。
- [PIPE-Cypher: Automatic Enterprise Benchmark Generation for Text-to-Cypher Systems](http://arxiv.org/abs/2606.08481v1) — 相关度 0.60：面向Text2Cypher的自动benchmark生成流水线，可迁移到代码agent的评测基准生成方法。
- [AI-Augmented Closed-Loop Quality Engineering: A Reference Architecture for Continuous Software Quality Intelligence](http://arxiv.org/abs/2606.08793v1) — 相关度 0.55：提出闭环质量工程架构与反馈学习，虽不直接针对agent，但其缺陷预测与测试优先级方法可借鉴。
