...
### [1] [Self-Evolving Scientific Agent Discovers Generalizable Physically-Reasoned Fluid Control](http://arxiv.org/abs/2606.08405v1)
...
### [2] [GIFT: LLM-Guided State-Reward Interface for Financial Reinforcement Learning](http://arxiv.org/abs/2606.08450v1)
...
### [3] [Scaffold Effects on GAIA: A Controlled Comparison](http://arxiv.org/abs/2606.08529v1)
*Jason Starace*
...
### [4] [VESTA: A Fully Automated Scenario Generation and Safety Evaluation Framework for LLM Agents](http://arxiv.org/abs/2606.08531v1)
...
### [5] [DN-Hypo-Pipeline: An AI-Driven Workflow for Generating Hypotheses using Large Language Models and Scientific Explanations](http://arxiv.org/abs/2606.08532v4)
...
### [6] [AgentTrust: A Self-Improving Trust Layer for AI-Agent Actions](http://arxiv.org/abs/2606.08539v1)
*Chenglin Yang*
...
### [7] [Quantitative Promise Theory: Intentionality and Inference in Autonomous Agents](http://arxiv.org/abs/2606.08552v1)
*Mark Burgess*
...
### [8] [Distilling LLM Reasoning into an Interpretable Policy Tree for Human-AI Collaboration](http://arxiv.org/abs/2606.08596v1)
...
### [9] [ConMem: Structured Memory-Guided Adaptation in Training-Free Multi-Agent Systems](http://arxiv.org/abs/2606.08702v1)
...
### [10] [Artificial Intelligence for Mathematical Reasoning: An Integrated Survey of Language Models, Neuro-symbolic Systems, and Verified Discovery](http://arxiv.org/abs/2606.08728v2)
...
### [11] [Structure-Conditioned Actor-Critic Branches for Quality-Diversity Reinforcement Learning](http://arxiv.org/abs/2606.08735v1)
...
### [12] [RAILS: Verification-Native Clearing For Agentic Commerce](http://arxiv.org/abs/2606.08790v1)
...
### [13] [Inference-Time Conformal Reasoning with Valid Factuality Control for Large Language Models](http://arxiv.org/abs/2606.08831v2)
...
### [14] [Beyond Pass Rate: A Multilingual, Execution-Grounded Evaluation of Open Code LLMs](http://arxiv.org/abs/2606.08840v1)
*Sayed Erfan Arefin*
...
Selection reason: 大规模多语言执行导向的代码LLM评测，揭示性能与失败模式，对benchmark设计有直接参考。
...
### [15] [Can the Environment Speak for Itself? $T^{2}$-GRPO: A Turn-Trajectory Group Relative Policy Optimization for Caregiver Agents](http://arxiv.org/abs/2606.08875v1)
...
### [16] [When LLMs Invent Rust Crates: An Empirical Study of Hallucination Patterns and Mitigation](http://arxiv.org/abs/2606.08444v1)
...
Selection reason: 首次系统研究Rust crate幻觉模式并提出缓解prompt策略，直接关乎代码生成可靠性。
...
### [17] [Projecting the Emerging Mindset of SWE Agent by Launching a Wild Code Understanding Journey](http://arxiv.org/abs/2606.08500v1)
...
Selection reason: 提出对SWE agent轨迹进行观察投影的装置与方法，用于刻画agent行为，直接相关。
...
### [18] [FusionVul: A Multimodal Feature Fusion Framework for Source Code Vulnerability Detection](http://arxiv.org/abs/2606.08553v1)
...
Selection reason: 多模态融合的漏洞检测框架，属于程序分析通用方法，可辅助agent理解代码安全。
...
### [19] [LLM vs. Human Unit Tests: Fault Detection on Real Python Bugs](http://arxiv.org/abs/2606.08588v1)
...
Selection reason: 对比LLM与人工单元测试对真实Python bug的故障检测，强调覆盖率的不足，助力agent测试生成评估。
...
### [20] [Auditable Graph-Guided Root Cause Analysis for Kubernetes Incidents](http://arxiv.org/abs/2606.08590v1)
...
Selection reason: 图引导的Kubernetes RCA agent，具备可审计验证、确定性图操作与消融检查，对agent可靠性设计有参考。
...
### [21] [Lost in the Flow with Code Talkers: Unveiling the Instruction-Tuning Tax of Large Language Models in Code Tasks](http://arxiv.org/abs/2606.08676v1)
...
Selection reason: 实证揭示指令微调在代码任务上的infilling与指令遵循权衡，对coding assistant模型设计有指导。
...
### [22] [Structuring agentic AI for HPC code modernization](http://arxiv.org/abs/2606.08710v1)
...
Selection reason: 面向HPC代码现代化的结构化agentic AI方法，直接涉及代码迁移与并行化，对coding agent有明确迁移价值。
...
### [23] [AI-Augmented Closed-Loop Quality Engineering: A Reference Architecture for Continuous Software Quality Intelligence](http://arxiv.org/abs/2606.08793v1)
*Dimple Bajaj*
...
Selection reason: 提出闭环质量工程架构与反馈学习，虽不直接针对agent，但其缺陷预测与测试优先级方法可借鉴。
...
### [24] [Governance Controls for AI-Generated Test Artifacts in Autonomous Software Testing](http://arxiv.org/abs/2606.08806v1)
...
Selection reason: 为AI生成测试工件引入治理验证与可解释性机制，提升自主测试可靠性，与测试生成agent相关。
...
### [25] [ActProbe: Action-Space Probe for Early Failure Detection of Generative Robot Policies](http://arxiv.org/abs/2606.08508v1)
...
### [26] [When Video Misreads: Closed-Loop Distillation of Reading Heuristics for Exploratory Manipulation Trace QA](http://arxiv.org/abs/2606.08542v1)
...
### [27] [HARBOR: A Harness Framework for Agentic Robot Reinforcement Learning](http://arxiv.org/abs/2606.08610v1)
...
### [28] [Benchmarking Vision-Language-Action Models on SO-101: Failure and Recovery Analysis](http://arxiv.org/abs/2606.08881v2)
*Yi Yu,Xinchuan Qiu*
...
### [29] [SceneConductor: 3D Scene Generation from a Single Image with Multi-Agent Orchestration](http://arxiv.org/abs/2606.08402v3)
...
### [30] [AI Code Sandboxes: A Comparative Security Study. Part 1 of 2 -- Engine-Level Properties (Attack Surface, Leakage, Stackability, CVE History, Patch Cadence, Fuzzing)](http://arxiv.org/abs/2606.08433v1)
...
### [31] [Data Agents Under Attack: Vulnerabilities in LLM-Driven Analytical Systems](http://arxiv.org/abs/2606.08661v1)
...
### [32] [GitInject: Real-World Prompt Injection Attacks in AI-Powered CI/CD Pipelines](http://arxiv.org/abs/2606.09935v1)
...
### [33] [Not Just After One: Sleep-Inspired Replay Prevents Catastrophic Forgetting After Sequential Tasks](http://arxiv.org/abs/2606.08447v1)
...
### [34] [PIPE-Cypher: Automatic Enterprise Benchmark Generation for Text-to-Cypher Systems](http://arxiv.org/abs/2606.08481v1)
...
Selection reason: 面向Text2Cypher的自动benchmark生成流水线，可迁移到代码agent的评测基准生成方法。
...
### [35] [Agentic Search for Counterfactual Recourse under Fixed LLM Budgets](http://arxiv.org/abs/2606.08696v1)
*Yasuo Tabei*
...
### [36] [When RL Fails after SFT: Rejuvenating Model Plasticity for Robust SFT-to-RL Handoff](http://arxiv.org/abs/2606.09932v1)
...
### [37] [Intrinsic Selection and Particle Resampling for Inference-Time Scaling Beyond Domain Verifiability](http://arxiv.org/abs/2606.08850v1)
...
### [38] [sGPO: Trading Inference FLOPs for Training Efficiency in RLVR](http://arxiv.org/abs/2606.08854v1)
...
### [39] [Segment-level Tree Search for Long Meeting Document Summarization](http://arxiv.org/abs/2606.08445v1)
...
### [40] [More Yap Less Meaning: Uncovering Self-Improvement Behavior in SLMs](http://arxiv.org/abs/2606.08471v1)
...
### [41] [A Note on the Strategic Confinement Problem](http://arxiv.org/abs/2606.09931v1)
