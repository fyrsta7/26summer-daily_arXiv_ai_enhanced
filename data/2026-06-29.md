...
### [1] [Diversity is the Strength of the AI Crowd](http://arxiv.org/abs/2606.29661v1)
...
### [2] [Toward Secure and Reliable PDDL Formalization of Large Language Models with Planner-in-the-Loop Feedback](http://arxiv.org/abs/2606.29700v1)
...
### [3] [GUICrafter: Weakly-Supervised GUI Agent Leveraging Massive Unannotated Screenshots](http://arxiv.org/abs/2606.29705v1)
...
### [4] [DeepTrans Studio: Turning Expert Interventions into Shared Team Knowledge in Agentic Translation Workflows](http://arxiv.org/abs/2606.29727v1)
...
### [5] [DEEPMED Search: An Open-Source Agentic Platform for Medical Deep Research with Introspective Verification](http://arxiv.org/abs/2606.29746v1)
...
### [6] [CLQT: A Closed-Loop, Cost-Aware, Strategy-Consistent Benchmark for Diagnostic Evaluation of LLM Portfolio-Management Agents](http://arxiv.org/abs/2606.29771v1)
*Bo Qu,Mingguang Chen*

Main category: cs.AI

Comments: 50 pages, 14 figures, 10 tables
...
### [7] [The CRISTAL Method: Neurosymbolic analysis from AI-synthesized world models](http://arxiv.org/abs/2606.29799v1)
...
### [8] [AI Training Manager: Bounded Closed-Loop Control of Adaptive Training Recipes](http://arxiv.org/abs/2606.29871v1)
...
### [9] [SafePyramid: A Hierarchical Benchmark for In-context Policy Guardrailing](http://arxiv.org/abs/2606.29887v1)
...
### [10] [HippoSpark: An On-Demand Experience System for LLM Reasoning](http://arxiv.org/abs/2606.29929v1)
...
### [11] [SAGA: Scene-Aware, Goal-Evolving Agents for Long-Horizon Strategy Game Planning](http://arxiv.org/abs/2606.29932v3)
*Tianyu Jin,Shuo Chen,Yida Wang,Liuyu Xiang,Yingzhuo Liu,Zhiyao Jiang,Yexin Li,Peipei Li,Zhaofeng He*

Main category: cs.AI

Comments: 18 pages, 4 figures. Code: https://github.com/KazeCloud/SAGA-Civrealm
...
### [12] [AlgoSkill: Learning to Design Algorithms by Scheduling Human-Like Skills](http://arxiv.org/abs/2606.29999v1)
...
### [13] [ACPO: Agent-Chained Policy Optimization for Multi-Agent Reinforcement Learning](http://arxiv.org/abs/2606.30072v1)
...
### [14] [Structural Certification for Reliable Physical Design with Language Models](http://arxiv.org/abs/2606.30107v1)
...
### [15] [Does Verbose Chain-of-Thought Really Help? In-Distribution Evidence that Content, Not Length, Matters](http://arxiv.org/abs/2606.30128v1)
...
### [16] [Relevance Is Not Permission: Warranted Attention for Value Contributions](http://arxiv.org/abs/2606.30139v2)
...
### [17] [MirrorCode: AI can rebuild entire programs from behavior alone](http://arxiv.org/abs/2606.30182v1)
...
### [18] [Dynamo: Dynamic Skill-Tool Evolution for Vision-Language Agents](http://arxiv.org/abs/2606.30185v1)
...
### [19] [From Detecting Agency to Doing Work: Self-Caused Credit Builds a Durable Behavioral Self in a Minimal Spiking Agent](http://arxiv.org/abs/2606.30191v1)
*Haoliang Han*
...
### [21] [Clarus: Coordinating Autonomous Research Agents toward Web-Scale Scientific Collaboration](http://arxiv.org/abs/2606.30246v1)
...
### [22] [Rehearsed Multi-Agent Live Product Demonstrations with Real-Time Voice Question Answering](http://arxiv.org/abs/2606.30294v1)
...
Selection reason: 多 agent 演示系统的排练循环与 UI/源码跨模态定位机制，可迁移到软件工程 agent 的稳定执行。
...
### [23] [ManimAgent: Self-Evolving Multimodal Agents for Visual Education](http://arxiv.org/abs/2606.30296v2)
...
### [24] [BayesEvolve: Explicit Belief States for Autonomous Scientific Discovery](http://arxiv.org/abs/2606.30335v1)
...
### [25] [Whose Side Is Your Agent On? Multi-Party Principal Loyalty in LLM Agents](http://arxiv.org/abs/2606.30383v1)
*Bojie Li,Noah Shi*
...
### [26] [The FIL Hypothesis: Inductive Biases Help with Kernel Engineering](http://arxiv.org/abs/2606.30442v1)
...
### [27] [Entity Binding Failures in Tool-Augmented Agents](http://arxiv.org/abs/2606.30531v1)
...
### [28] [Linguistic Firewall: Geometry as Defense in Multi-Agent Systems Routing](http://arxiv.org/abs/2606.30555v2)
...
### [29] [Self-Evolving World Models for LLM Agent Planning](http://arxiv.org/abs/2606.30639v1)
...
### [30] [What Drives Interactive Improvement from Feedback?](http://arxiv.org/abs/2606.30774v1)
...
### [31] [Contrastive Reflection for Iterative Prompt Optimization](http://arxiv.org/abs/2606.30840v1)
...
### [32] [BayesBench: Evaluating LLM Belief Trajectories Under Multi-Turn Evidence Accumulation](http://arxiv.org/abs/2606.30850v1)
...
### [33] [When Does Learning to Stop Help? A Cost-Aware Study of Early Exits in Reasoning Models](http://arxiv.org/abs/2606.30852v2)
...
### [34] [Beyond expert users: agents should help users construct preferences, not just elicit them](http://arxiv.org/abs/2606.30863v2)
...
### [35] [SPINE: Bridging the Cyber-Physical Gap with Agentic AI](http://arxiv.org/abs/2607.13049v1)
...
### [36] [Why Solve It Twice? Hierarchical Accumulation of Skills for Transfer-Efficient ML Engineering](http://arxiv.org/abs/2606.30911v2)
...
### [37] [RoPoLL: Robust Panel of LLM Judges](http://arxiv.org/abs/2606.30931v1)
...
### [38] [AgRefactor: Self-Evolving Agentic Workflow for HLS Compatibility and Performance](http://arxiv.org/abs/2606.30949v1)
...
### [39] [HyPOLE: Hyperproperty-Guided Multi-Agent Reinforcement Learning under Partial Observation](http://arxiv.org/abs/2606.30966v1)
...
### [40] [Behavioral Governance for Autonomous AI Agents: The AgentBound Framework](http://arxiv.org/abs/2606.30970v2)
...
### [41] [When Regulation Has Memory: Hysteresis and Control Burden in Artificial Agency](http://arxiv.org/abs/2606.30975v1)
*Veronique Ziegler*
...
### [42] [Bash-Commenter: Leveraging Syntax-Aware Preference Optimization to Reinforce Large Language Model for Bash Code Comment Generation](http://arxiv.org/abs/2606.29709v1)
...
Selection reason: 提出面向 Bash 的语法感知偏好优化用于代码注释生成，方法可迁移到代码模型的语义训练。
...
### [43] [MicroAgent: Context-Augmented Multi-Agent Framework for Automatic Microservice Decomposition](http://arxiv.org/abs/2606.29742v1)
...
Selection reason: 多智能体框架将微服务分解任务委派给专门 agent，展示 agent 规划与上下文增强的软件工程应用。
...
### [44] [SpreadsheetBench 2: Evaluating Agents on End-to-End Business Spreadsheet Workflows](http://arxiv.org/abs/2606.29955v1)
...
Selection reason: 端到端业务表格工作流级智能体 benchmark，覆盖多表跨表任务并提供失败分类，直接用于 agent 评测。
...
### [45] [SWE-Together: Evaluating Coding Agents in Interactive User Sessions](http://arxiv.org/abs/2606.29957v1)
...
Selection reason: 基于真实多轮人机会话的 coding agent benchmark，包含用户模拟器和纠错反馈评估，直接相关。
...
### [46] [MCP Server Architecture Patterns for LLM-Integrated Applications](http://arxiv.org/abs/2606.30317v1)
...
Selection reason: 总结 MCP server 架构模式与反模式，为 coding agent 工具集成和 tool selection 提供直接参考。
...
### [47] [How do Execution Features Improve Statistical Fault Localization? An Empirical Study](http://arxiv.org/abs/2606.30324v1)
*Marius Smytzek,Andreas Zeller*

Main category: cs.SE

Comments: 7 pages, 1 figure, 1 table, ICSME Registered Report

Selection reason: 实验验证执行特征可增强统计故障定位，可帮助调试和修复 agent 提升定位精度并降低检查成本。
...
### [48] [ATM: CID-Brokered Pre-Write Admission for Multi-Agent Code Co-Synthesis](http://arxiv.org/abs/2607.00041v1)
*Eagl Huang*
...
Selection reason: 为多 agent 代码协合提供并发写意图准入、原子化与验证链，直接针对代码 agent 的共享变更治理。
...
### [49] [The Illusion of Agentic Complexity in README.md Generation: Evaluating Single-Agent vs. Multi-Agent RAG Systems](http://arxiv.org/abs/2606.30524v2)
...
Selection reason: 系统比较单/多 agent RAG 生成文档，给出架构复杂度与 token 成本权衡，对 agent 设计有参考价值。
...
### [50] [PyMETA: A Benchmark Dataset for Hierarchical Student Code Error Classification with Python-Interpreter-Based Labels](http://arxiv.org/abs/2606.30610v1)
...
Selection reason: 提供分层 Python 代码错误分类数据集与多错误标注，可用于代码 agent 调试和错误诊断评测。
...
### [51] [Towards Knowledge Alignment in Code LLMs: Contrastive Unlearning for Evolving APIs](http://arxiv.org/abs/2606.30810v1)
...
Selection reason: 针对代码LLM因API演进产生废弃调用的问题，提出对比去学习同时抑制旧API并促进正确替代，可迁移到代码生成agent的知识更新与修复。
...
### [52] [A Taxonomy of Single-Turn Textual Prompt Patterns](http://arxiv.org/abs/2607.00043v1)
...
Selection reason: 系统梳理单轮文本提示模式的分类法，为代码agent的prompt设计与模式复用提供参考。
...
### [53] [Loc2Repair: A Framework for Evaluating the Impact of File-Level Issue Localization in Repo-Level LLM Repair](http://arxiv.org/abs/2606.30963v1)
...
Selection reason: 提出仓库级LLM修复的模块化评测框架，将文件级定位与修复解耦并量化其影响，为SWE agent的定位-修复链路评测提供实用工具。
...
### [54] [Towards Generalizable and Evidential Nuclear Magnetic Resonance-Based Molecular Structure Elucidation via Large Language Model Agent](http://arxiv.org/abs/2606.29776v1)
...
### [55] [EVAF: A Test-Retest Protocol for Selective Parametric Consolidation](http://arxiv.org/abs/2606.29916v1)
*Haoliang Han*
...
### [56] [DuoMem: Towards Capable On-Device Memory Agents via Dual-Space Distillation](http://arxiv.org/abs/2606.29961v1)
...
### [57] [Neural Subspace Reallocation: Continual Learning as Retrieval-Based Subspace Memory Management](http://arxiv.org/abs/2606.30067v1)
*Byeong Hoon Yoon*
...
### [58] [Query-Aware Spreading Activation for Multi-Hop Retrieval over Knowledge Graphs](http://arxiv.org/abs/2606.30133v1)
...
### [59] [Towards Continual Motion-Language Agents: LoRA Variants for Incremental Motion Understanding and Generation](http://arxiv.org/abs/2606.30266v1)
...
### [60] [From Search to Synthesis: Training LLMs as Zero-Shot Workflow Generators](http://arxiv.org/abs/2606.30704v1)
...
### [61] [DRIFT: Difficulty Routing Self-DIstillation with Rhythm-Gated Exploration and Success BuFfer Training](http://arxiv.org/abs/2606.30345v1)
...
### [62] [TraceLab: Characterizing Coding Agent Workloads for LLM Serving](http://arxiv.org/abs/2606.30560v2)
...
### [63] [Pessimism's Paradox: Conservative Offline Training Amplifies Reward Hacking During Online Adaptation in Reasoning Models](http://arxiv.org/abs/2606.30627v1)
...
### [64] [Behavior Cloning is Not All You Need: The Optimality of On-Policy Distillation for Noisy Expert Feedback](http://arxiv.org/abs/2606.30923v1)
...
### [65] [Mandol: An Agglomerative Agent Memory System for Long-Term Conversations](http://arxiv.org/abs/2606.29778v1)
...
### [66] [Experience Graphs: The Data Foundation for Self-Improving Agents](http://arxiv.org/abs/2606.29823v1)
...
### [67] [SEVA: Self-Evolving Verification Agent with Process Reward for Fact Attribution](http://arxiv.org/abs/2606.29713v1)
...
### [68] [Neural Procedural Memory: Empowering LLM Agents with Implicit Activation Steering](http://arxiv.org/abs/2606.29824v1)
...
### [69] [Field Order Should Not Matter: Permutation-Invariant Embedding Model Fine-Tuning for Structured Metadata Retrieval](http://arxiv.org/abs/2606.30473v1)
...
### [70] [A Single Rewrite Suffices: Empirical Lessons from Production Skill Description Optimization](http://arxiv.org/abs/2606.30775v1)
...
### [71] [Test-Time Verification for Text-to-SQL via Outcome Reward Models](http://arxiv.org/abs/2606.30851v1)
...
### [72] [TopoAgent: An Agentic Framework for Automated Topology Learning in Medical Imaging](http://arxiv.org/abs/2606.29763v1)
...
### [73] [Can LLMs Rank? A Tale of Triads and Triage](http://arxiv.org/abs/2606.30412v1)
...
### [74] [ARMOR: Adaptive Retriever Optimization for Low-Resource Telecom Question Answering](http://arxiv.org/abs/2606.29706v1)
...
### [75] [Diagnosing and Mitigating Context Rot in Long-horizon Search](http://arxiv.org/abs/2606.29718v1)
...
### [76] [Always-OnAgents:A Survey of Persistent Memory, State, and Governance in LLMAgents](http://arxiv.org/abs/2606.30306v1)
...
### [77] [Translating Natural Language to Strategic Temporal Specifications via LLMs](http://arxiv.org/abs/2606.30441v2)
...
### [78] [Words Speak Louder Than Code: Investigating Cognitive Heuristics in LLM-Based Code Vulnerability Detection](http://arxiv.org/abs/2606.30587v1)
...
### [79] [MESA: Prioritizing Vulnerable Communication Channels for Securing Multi-Agent Systems](http://arxiv.org/abs/2606.30602v1)
...
### [80] [Understanding and Evaluating Claw-like Agent Security Through a Computer-Systems Lens](http://arxiv.org/abs/2606.30755v1)
...
### [81] [Security--Fidelity Tradeoffs: The Hidden Cost of Prompt Injection Defense](http://arxiv.org/abs/2606.30783v1)
...
### [82] [LUMOS: A Semantic Operating-System Layer for Accessibility-Grounded AI Agents](http://arxiv.org/abs/2606.30697v1)
...
### [83] [Trust Your Instincts: Confidence-Driven Test-Time RL for Vision-Language-Action Models](http://arxiv.org/abs/2606.29892v1)
...
### [84] [Critical Interval MSE: Toward Reliable Offline Validation for Robot Manipulation Policies](http://arxiv.org/abs/2606.29898v1)
...
### [85] [Pondering the Way: Spatial-perceiving World Action Model for Embodied Navigation](http://arxiv.org/abs/2606.29908v1)
...
### [86] [Automating the Design of Embodied Agent Architectures](http://arxiv.org/abs/2606.30111v2)
...
### [87] [Motion Planning in Compressed Representation Spaces](http://arxiv.org/abs/2606.30940v1)
...
### [88] [Optimizing Expert-Designed Crystal Graph Networks for Band-Gap Prediction with an Autonomous LLM Research Loop](http://arxiv.org/abs/2606.29717v1)
...
### [89] [COHORT: Collaborative Orchestration for Hardening via Offensive Replay on Emulated Topologies](http://arxiv.org/abs/2606.30479v1)
...
### [90] [A Machine-Verified Proof of a Quantum-Optimization Conjecture](http://arxiv.org/abs/2606.29687v1)
...
### [91] [Collective cooperation without individual fidelity in LLM agents](http://arxiv.org/abs/2606.30454v1)
