...
### [1] [Yanasse: Finding New Proofs from Deep Vision's Analogies, Part 1](http://arxiv.org/abs/2604.17229v1)
*Alexandre Linhares*
...
### [2] [Safe and Policy-Compliant Multi-Agent Orchestration for Enterprise AI](http://arxiv.org/abs/2604.17240v1)
...
### [3] [The Continuity Layer: Why Intelligence Needs an Architecture for What It Carries Forward](http://arxiv.org/abs/2604.17273v1)
...
### [4] [HalluClear: Diagnosing, Evaluating and Mitigating Hallucinations in GUI Agents](http://arxiv.org/abs/2604.17284v1)
...
### [5] [Efficient Test-Time Scaling via Temporal Reasoning Aggregation](http://arxiv.org/abs/2604.17304v1)
...
### [6] [SkillFlow:Benchmarking Lifelong Skill Discovery and Evolution for Autonomous Agents](http://arxiv.org/abs/2604.17308v1)
...
### [7] [Knows: Agent-Native Structured Research Representations](http://arxiv.org/abs/2604.17309v1)
...
### [8] [AutoSearch: Adaptive Search Depth for Efficient Agentic RAG via Reinforcement Learning](http://arxiv.org/abs/2604.17337v1)
...
### [9] [Formal Foundations of Agentic Business Process Management](http://arxiv.org/abs/2604.17347v1)
...
### [10] [SOCIA-EVO: Automated Simulator Construction via Dual-Anchored Bi-Level Optimization](http://arxiv.org/abs/2604.17351v1)
...
### [11] [Hive: A Multi-Agent Infrastructure for Algorithm- and Task-Level Scaling](http://arxiv.org/abs/2604.17353v1)
...
### [12] [LLM-Guided Strategy Synthesis for Scalable Equality Saturation](http://arxiv.org/abs/2604.17364v1)
...
### [13] [Beyond Meta-Reasoning: Metacognitive Consolidation for Self-Improving LLM Reasoning](http://arxiv.org/abs/2604.17399v1)
...
### [14] [Phase-Scheduled Multi-Agent Systems for Token-Efficient Coordination](http://arxiv.org/abs/2604.17400v1)
*Mohit Dubey*
...
### [15] [STRIDE: Strategic Iterative Decision-Making for Retrieval-Augmented Multi-Hop Question Answering](http://arxiv.org/abs/2604.17405v1)
...
### [16] [EvoMaster: A Foundational Evolving Agent Framework for Agentic Science at Scale](http://arxiv.org/abs/2604.17406v4)
...
### [17] [Compiling Deterministic Structure into SLM Harnesses](http://arxiv.org/abs/2604.17450v3)
...
### [18] [TrafficClaw: A Generalizable LLM Agent in the Unified Physical Environment for Urban Traffic Control](http://arxiv.org/abs/2604.17456v2)
...
### [19] [EHRAG: Bridging Semantic Gaps in Lightweight GraphRAG via Hybrid Hypergraph Construction and Retrieval](http://arxiv.org/abs/2604.17458v2)
...
### [20] [Waking Up Blind: Cold-Start Optimization of Supervision-Free Agentic Trajectories for Grounded Visual Perception](http://arxiv.org/abs/2604.17475v1)
...
### [21] [Towards Shutdownable Agents: Generalizing Stochastic Choice in RL Agents and LLMs](http://arxiv.org/abs/2604.17502v4)
...
### [22] [SkillGraph: Self-Evolving Multi-Agent Collaboration with Multimodal Graph Topology](http://arxiv.org/abs/2604.17503v1)
...
### [23] [Recurrent Reasoning on Symbolic Puzzles with Sequence Models](http://arxiv.org/abs/2606.15686v1)
...
### [24] [From Admission to Invariants: Measuring Deviation in Delegated Agent Systems](http://arxiv.org/abs/2604.17517v2)
*Marcelo Fernandez*
...
### [25] [CoSearch: Joint Training of Reasoning and Document Ranking via Reinforcement Learning for Agentic Search](http://arxiv.org/abs/2604.17555v2)
...
### [26] [SafeAgent: A Runtime Protection Architecture for Agentic Systems](http://arxiv.org/abs/2604.17562v1)
...
### [27] [Beyond Static Snapshots: A Grounded Evaluation Framework for Language Models at the Agentic Frontier](http://arxiv.org/abs/2604.17573v2)
*Jazmia Henry*
...
### [28] [Characterizing Model-Native Skills](http://arxiv.org/abs/2604.17614v1)
...
### [29] [KnowledgeBerg: Evaluating Systematic Knowledge Coverage and Compositional Reasoning in Large Language Models](http://arxiv.org/abs/2604.17621v2)
...
### [30] [PV-SQL: Synergizing Database Probing and Rule-based Verification for Text-to-SQL Agents](http://arxiv.org/abs/2604.17653v1)
...
### [31] [Poly-EPO: Training Exploratory Reasoning Models](http://arxiv.org/abs/2604.17654v3)
...
### [32] [Layer-wise MoE Routing Locality under Shared-Prefix Code Generation: Token-Identity Decomposition and Compile-Equivalent Fork Redundancy](http://arxiv.org/abs/2604.17182v1)
...
Selection reason: 分析共享前缀代码生成中MoE路由的局部性，发现编译等价冗余，可提升多候选代码生成与搜索效率。
...
### [33] [SynthFix: Adaptive Neuro-Symbolic Code Vulnerability Repair](http://arxiv.org/abs/2604.17184v2)
...
Selection reason: 结合编译器反馈的神经符号漏洞修复，训练与推理中的符号证据设计直接适用于代码修复agent。
...
### [34] [React-ing to Grace Hopper 200: Five Open-Weights Coding Models, One React Native App, One GH200, One Weekend](http://arxiv.org/abs/2604.17187v1)
*Alex Potanin*
...
Selection reason: 在单一真实App生成任务上对比五个编码模型，揭示SWE-Bench排名不预示任务性能及部署实践发现。
...
### [35] [From Language to Action: Enhancing LLM Task Efficiency with Task-Aware MCP Server Recommendation](http://arxiv.org/abs/2604.17234v1)
...
Selection reason: 任务感知的MCP服务器推荐，为代码agent的工具检索与集成提供结构化方法和数据集。
...
### [36] [KnowPilot: Your Knowledge-Driven Copilot for Domain Tasks](http://arxiv.org/abs/2604.19820v1)
...
Selection reason: 领域知识增强的生成式agent框架，知识检索与经验记忆机制可迁移到代码agent的领域适应。
...
### [37] [A Pilot Study on Detecting Software Design Patterns with Large Language Models: An Empirical Evaluation](http://arxiv.org/abs/2604.17329v1)
...
Selection reason: 比较LLM与集成方法检测设计模式，其多模态代码提示策略可为代码理解与分析agent提供参考。
...
### [38] [Precise Debugging Benchmark: Is Your Model Debugging or Regenerating?](http://arxiv.org/abs/2604.17338v4)
...
Selection reason: 提出精确调试基准PDB与编辑级精度/缺陷级召回指标，直接评估agent是否真正调试而非重生成。
...
### [39] [Project Prometheus: Bridging the Intent Gap in Agentic Program Repair via Reverse-Engineered Executable Specifications](http://arxiv.org/abs/2604.17464v1)
...
Selection reason: 反向工程可执行规格桥接意图鸿沟，多agent RQA循环显著提升程序修复准确率，直接关联coding agent。
...
### [40] [Augmenting unit test suites from integration tests](http://arxiv.org/abs/2604.17508v2)
...
Selection reason: 从集成测试自动生成单元测试的方法，对测试生成和agent验证有迁移价值。
...
### [41] [Single-Language Evidence Is Insufficient for Automated Logging: A Multilingual Benchmark and Empirical Study with LLMs](http://arxiv.org/abs/2604.17529v1)
...
Selection reason: 多语言日志生成基准与LLM实证，直接服务软件工程评测与代码生成任务。
...
### [42] [AIRA: AI-Induced Risk Audit: A Structured Inspection Framework for AI-Generated Code](http://arxiv.org/abs/2604.17587v1)
*William M. Parris*
...
Selection reason: 提出AI生成代码的风险审计框架，有助于评估agent产出的安全性与失败模式。
...
### [43] [Causal-Temporal Event Graphs: A Formal Model for Recursive Agent Execution Traces](http://arxiv.org/abs/2604.17557v1)
*Simon Foldvik*
...
### [44] [Instinct vs. Reflection: Unifying Token and Verbalized Confidence in Multimodal Large Models](http://arxiv.org/abs/2604.17274v1)
...
### [45] [Dual-Anchoring: Addressing State Drift in Vision-Language Navigation](http://arxiv.org/abs/2604.17473v4)
...
### [46] [Provable Coordination for LLM Agents via Message Sequence Charts](http://arxiv.org/abs/2604.17612v3)
...
### [47] [Agentic Social Affordance Framework (ASAF): Agent Identity Design as a Collaboration Interface in Multi-Agent Systems](http://arxiv.org/abs/2606.09832v2)
*Meng-Han Lee*
...
### [48] [Human-AI Collaboration for Estimating Scientific Replicability](http://arxiv.org/abs/2605.27394v1)
...
### [49] [Terminal Wrench: A Dataset of 331 Reward-Hackable Environments and 3,632 Exploit Trajectories](http://arxiv.org/abs/2604.17596v1)
...
### [50] [Bidirectional Small-Granularity Search between Code and Text](http://arxiv.org/abs/2606.07519v1)
...
### [51] [DORA Explorer: Improving the Exploration Ability of LLMs Without Training](http://arxiv.org/abs/2604.17244v1)
...
### [52] [Seeing Isn't Believing: Mitigating Belief Inertia via Active Intervention in Embodied Agents](http://arxiv.org/abs/2604.17252v1)
...
### [53] [HorizonBench: Long-Horizon Personalization with Evolving Preferences](http://arxiv.org/abs/2604.17283v1)
...
### [54] [Probabilistic Programs of Thought](http://arxiv.org/abs/2604.17290v1)
...
### [55] [Cat-DPO: Category-Adaptive Safety Alignment](http://arxiv.org/abs/2604.17299v2)
...
### [56] [Clover: A Neural-Symbolic Agentic Harness with Stochastic Tree-of-Thoughts for Verified RTL Repair](http://arxiv.org/abs/2604.17288v1)
...
### [57] [RosettaSearch: Multi-Objective Inference-Time Search for Protein Sequence Design](http://arxiv.org/abs/2604.17175v2)
...
### [58] [Signal or Noise in Multi-Agent LLM-based Stock Recommendations?](http://arxiv.org/abs/2604.17327v1)
...
### [59] [Dynamics of Cognitive Heterogeneity: Investigating Behavioral Biases in Multi-Stage Supply Chains with LLM-Based Simulation](http://arxiv.org/abs/2604.17220v2)
