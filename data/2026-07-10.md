...
Selection reason: 提出共享选择性持久记忆架构解决agent多轮上下文问题，对代码agent的长期记忆与复用具有直接迁移价值
...
### [18] [Benchmarking Large Language Models on Repairing Qiskit Programs using Bugs4Q](http://arxiv.org/abs/2607.09007v1)
...
Selection reason: 在 Bugs4Q 上系统评估 LLM 修复量子程序，并揭示基准标签反转问题，直接相关于程序修复评测。
...
### [19] [Automating Just-In-Time Python Type Annotation Updating](http://arxiv.org/abs/2607.09054v1)
...
Selection reason: 使用LLM自动更新Python类型注解，属于代码编辑/修复的自动化方法，对coding agent有参考价值
...
### [20] [Inside the Skill Market: From Software Engineering Activities to Reusable Agent Skills](http://arxiv.org/abs/2607.09065v1)
...
Selection reason: 大规模实证研究SE技能的可复用agent技能生态，为agent技能设计与评测提供迁移依据
...
### [21] [Agentic Proof and Property-Based Testing via Property-Templates in Data-Intensive Computing](http://arxiv.org/abs/2607.09072v1)
...
Selection reason: 提出agentic证明与基于属性模板的property-based testing验证框架，直接提升代码agent正确性验证能力
...
### [22] [Multi-Agent LLM Collaboration for Unit Test Generation via Human-Testing-Inspired Workflows](http://arxiv.org/abs/2607.09101v1)
...
Selection reason: 针对单元测试生成的多agent协作框架，融合需求规划、生成、审查与知识图谱，直接对应测试agent研究
...
### [23] [ReProAgent: Tool-Augmented Multi-Stage Agentic Generation of Bug Reproduction Tests from Issue Reports](http://arxiv.org/abs/2607.09123v1)
...
Selection reason: 多阶段工具增强agent从issue生成复现测试，涉及定位、根因分析、测试规划与执行反馈，高度相关
...
### [24] [Exploring the Potential of Program Flowcharts on Code Generation Using Multimodal LLMs](http://arxiv.org/abs/2607.09146v1)
...
Selection reason: 探究流程图对多模态LLM代码生成的影响，为agent提供额外视觉结构输入提供实证参考
...
### [25] [Evaluating Semantic and Quality-Aware Retrieval for Source Code Repositories](http://arxiv.org/abs/2607.09161v1)
...
Selection reason: 评估面向代码仓库的语义与质量感知检索模式，对代码检索/agent上下文获取有迁移价值
...
### [26] [Git-Assistant: Planning-Based Support for Updating Git Repositories](http://arxiv.org/abs/2607.09224v2)
...
Selection reason: 结合LLM与传统规划的git仓库管理助手，展示了规划增强agent执行工具任务的价值
...
### [27] [How Far Are We from Detecting Flaky Tests? On the Limits of Code-Based Detection](http://arxiv.org/abs/2607.09345v1)
...
Selection reason: 系统分析基于代码的flaky test检测局限并构建反事实数据与CI日志数据集，对测试agent可靠评测有重要参考
...
### [28] [Diversifying to Verify: When Task-Equivalent Programs Differ in Verifiability](http://arxiv.org/abs/2607.09366v1)
...
Selection reason: 利用LLM生成不同实现并验证，表明程序结构多样性影响可验证性，为验证友好的agent生成策略提供依据
...
Selection reason: 结合anchor检索与LLM推理从二进制恢复源码，对代码检索与逆向分析agent有参考价值
...
### [30] [Failure as a Process: An Anatomy of CLI Coding Agent Trajectories](http://arxiv.org/abs/2607.09510v1)
...
Selection reason: 大规模实证分析CLI编码agent失败轨迹，将失败视为动态过程，为agent可靠性与干预时机提供关键洞见
...
### [31] [Balancing Usefulness and Naturalness: An LLM-based Curation Pipeline for Code Review Comments](http://arxiv.org/abs/2607.09524v1)
...
Selection reason: 提出LLM驱动的代码评审评论数据策展流水线，改善下游评审生成与代码细化任务，对评审agent有价值
...
### [32] [Writing Bug Reports for Software Repair Agents: What Information Matters Most?](http://arxiv.org/abs/2607.09553v1)
...
Selection reason: 系统研究bug报告中哪些信息类型对修复agent成功最重要，直接指导agent任务规格设计
...
### [33] [AfterVibe: What Remains When the Conversation Ends](http://arxiv.org/abs/2607.09900v1)
...
Selection reason: 从vibe coding轨迹恢复规格并通过盲生成验证，为agent代码产物与规范验证提供可迁移方法
...
### [34] [Do These Violent Delights Have Violent Ends? Measuring the Post-Merge Fate of Agentic Code](http://arxiv.org/abs/2607.09902v1)
...
Selection reason: 对 agentic 代码提交的纵向实证研究，揭示合并后的维护负担与安全问题，直接关系到 coding agent 的可靠性评估与改进方向。
...
### [35] [Using LLMs to Adjudicate Static-Analysis Alerts with Error Reduction Techniques](http://arxiv.org/abs/2607.09979v1)
...
Selection reason: 利用 LLM 判定静态分析告警，并提出一致性检查与推理评估等消减错误技术，对代码分析 agent 的验证与决策有直接迁移价值。
...
### [36] [Memory-Conditioned Tool Calling for Camera-First Visual Agents](http://arxiv.org/abs/2607.09822v1)
...
### [37] [Prompting-MammAlps: Fine-Grained Text-to-Video Retrieval for Camera-Trap Data](http://arxiv.org/abs/2607.09876v1)
...
### [38] [Untrusted Authors, Trusted Answers: A Calculus of Fidelity-Graded Translations](http://arxiv.org/abs/2607.14137v1)
*Christoph Kirsch*

Main category: cs.PL

Comments: 23 pages. Code, evidence, and the Lean mechanization: https://github.com/cksystemsgroup/hurdy-gurdy (tag arxiv.1)

Selection reason: 提出保真度分级的翻译演算并实现LLM生成的多语言验证平台，对基于LLM的验证与代码生成架构有启发
...
### [39] [Risk-Aware General-Utility Markov Decision Processes](http://arxiv.org/abs/2607.09298v1)
...
### [40] [All Explanations are Wrong, But Many Are Useful: Exploring the Rashomon Explanation Set with Large Language Models](http://arxiv.org/abs/2607.09502v1)
*Pan Li*
...
### [41] [A Knowledge-Based Multi-Agent Framework for Security Control Recommendation](http://arxiv.org/abs/2607.09954v1)
...
Selection reason: 构建技能逻辑关系遵循基准，揭示 skill 引导 agent 的高风险行为并提供轻量护栏，直接相关。
...
Selection reason: 提出三重重grounding的多agent恶意代码分析框架，对证据驱动的代码分析agent有借鉴意义
...
### [45] [Task-Specific Multimodal Question Answering Agents via Confidence Calibration and Incremental Reasoning for QANTA 2026](http://arxiv.org/abs/2607.09623v1)
...
### [46] [An LLM-powered Agentic Recommendation System for Connected TV Content Discovery](http://arxiv.org/abs/2607.09988v1)
