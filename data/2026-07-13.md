...
### [1] [SVR-R1: Bootstrapping Multi-modal Reasoning with Self-verification in Reinforcement Learning](http://arxiv.org/abs/2607.10966v1)
...
### [2] [QwenPaw-Data: Bridging Facts, Methodology, and Execution for Autonomous Enterprise Data Analytics](http://arxiv.org/abs/2607.11019v2)
...
### [3] [AdvNav: Behavior-Guided Black-Box Adversarial Attacks on Vision-Language Navigation](http://arxiv.org/abs/2607.11063v1)
...
### [4] [Are LLMs Ready for Scientific Discovery? A Capability-Oriented Benchmark for AI Scientists](http://arxiv.org/abs/2607.11079v1)
...
### [5] [NVAITC AI Scientist: A Governed End-to-End Research System -- A Hypertension GWAS Case Study](http://arxiv.org/abs/2607.11084v1)
...
### [6] [OS-Pruner: Pruning Chains-of-Thought of Reasoning Models via Optimal Stopping](http://arxiv.org/abs/2607.11089v1)
...
### [7] [Human AI Construction of Bayesian Networks for Operational Decision Support -- A Virtual Survey Approach](http://arxiv.org/abs/2607.14141v1)
...
### [8] [A Formal Hierarchical Architecture for Agentic Orchestration with Stack-Based Execution and Lazy Discovery](http://arxiv.org/abs/2607.11138v1)
...
### [9] [NextFund: A Unified Performance Tracking Platform for Agentic Portfolio Management](http://arxiv.org/abs/2607.11141v1)
...
### [10] [The Hidden Footprint: Making Storage a First-Class Metric for LLM Agent Evaluation](http://arxiv.org/abs/2607.11149v2)
...
### [11] [STAMP: Provenance-Guided Credit Assignment for Deep Search Agents](http://arxiv.org/abs/2607.11172v1)
...
### [12] [The Path to Self-Evolving Clinical Systems: Scaling Medical Agents from Assistance to Autonomy](http://arxiv.org/abs/2607.11175v1)
...
### [13] [SCALECUA: Scaling Computer Use Agents with Verifiable Task Synthesis and Efficient Online RL](http://arxiv.org/abs/2607.11185v1)
...
### [14] [What We Talk About When We Talk About LLM Planning: Evidence for Two Distinct Planning Abilities](http://arxiv.org/abs/2607.11197v1)
...
### [15] [Heterogeneous Agent Cohorts for Safe Open-Ended Exploration with Runtime Constraint Memory](http://arxiv.org/abs/2607.11226v1)
*Tengjiao Liu*
...
### [16] [Bringing Back Rule Induction to Fluid Intelligence Research? An Initial Validation of the ARC-AGI Benchmark in Humans](http://arxiv.org/abs/2607.11263v3)
...
### [18] [Efficient Test-Time Optimization for Multi-Agent Proof Autoformalization](http://arxiv.org/abs/2607.11307v1)
...
### [19] [Calibrated e-CUSUM Decoding for Quantized Reasoning Models: Why Token Log-Probability Is the Wrong Observable for Decoding Monitors](http://arxiv.org/abs/2607.11317v1)
...
### [20] [Verifier-Guided Twelve-Tone Composition: A Generate-Verify-Repair Harness for Symbolic Music Generation](http://arxiv.org/abs/2607.11334v2)
...
### [21] [AutoVSR: Automatic Visual-to-Symbolic Reasoning for Symbolic Expression Generation from Circuit Schematic](http://arxiv.org/abs/2607.11338v1)
...
### [22] [Compile, Then Page: Executable SOP Programs and a Capability-Gated Runtime for Procedural LLM Agents](http://arxiv.org/abs/2607.11346v2)
...
### [23] [OpsMem: Dual-Memory Reasoning with Cross-Memory Resonance for Failure Diagnosis](http://arxiv.org/abs/2607.11357v1)
...
Selection reason: 双记忆LLM agent故障诊断框架，通过跨记忆共振提升诊断准确率，可直接迁移到agent记忆与推理设计。
...
### [24] [StructAgent: Harness Long-horizon Digital Agents with Unified Causal Structure](http://arxiv.org/abs/2607.11388v1)
...
### [25] [Omni-Decision: A Progressive Evidence-State Agent System for Omni-Modal QA](http://arxiv.org/abs/2607.11433v1)
...
### [26] [MAGIC: Transition-Aware Generation of Navigable Multi-Scene Game Worlds with Large Language Models](http://arxiv.org/abs/2607.11594v1)
...
### [27] [Interaction Scaling: Grounding the Third Axis of Test-Time Compute](http://arxiv.org/abs/2607.11598v1)
*Bojie Li,Noah Shi*
...
### [28] [Think Through a Bottleneck: Hourglass Reasoning for Rigorous Induction](http://arxiv.org/abs/2607.11696v1)
*Huan Zhu*
...
### [29] [Designing Agent-Ready Websites for AI Web Agents: A Framework for Machine Readability, Actionability, and Decision Reliability](http://arxiv.org/abs/2607.12056v1)
...
### [30] [Graph Feedback Controls Consensus and Clique Formation in Open-Weight Language-Model Populations](http://arxiv.org/abs/2607.12077v1)
...
### [31] [Operationalising Multi-Dimensional Evaluation for Conversational Agents: A Scalable, Governed Pipeline with Selective Re-evaluation and Model Benchmarking](http://arxiv.org/abs/2607.12085v1)
...
### [32] [Good Benchmarks](http://arxiv.org/abs/2607.12217v1)
*Ivan Bercovich*
...
### [33] [BackendForge: Benchmarking Agentic End-to-End Code Generation with Backend Services](http://arxiv.org/abs/2607.11042v1)
...
Selection reason: 面向后端服务端到端代码生成的agentic benchmark，强调可执行部署与契约测试，对代码agent评测有直接价值。
...
### [34] [Retrieval-Oriented Code Representations in Agentic Bug Localization](http://arxiv.org/abs/2607.11046v1)
...
Selection reason: 系统比较代码表示对文件级bug定位的影响，并在Agentless管线中验证提升，可直接迁移到agent检索与定位设计。
...
### [35] [AgentCheck: A Reproduce-Intervene-Mitigate Workbench for LLM Agents over MCP](http://arxiv.org/abs/2607.11098v3)
...
Selection reason: 针对MCP工具型agent的可复现故障注入与缓解验证工作台，提供修复前验证机制，可迁移到agent可靠性评测。
...
### [36] [Know Before Fix: QA-Driven Repository Knowledge Acquisition for Software Issue Resolution](http://arxiv.org/abs/2607.11111v1)
...
Selection reason: 提出QA驱动的仓库知识获取框架，将知识获取与补丁生成解耦，显著提升SWE-bench修复性能，对代码agent有清晰迁移价值。
...
### [37] [Inference Economics of Enterprise Coding Agents: A Case Study of Cloud vs. On-Premise LLMs](http://arxiv.org/abs/2607.13080v1)
...
Selection reason: 云与本地LLM编码agent的成本-质量案例研究，揭示缓存成本与缺陷修复负担的权衡，对agent部署经济性有参考价值。
...
### [38] [FlowArk: Boosting Agentic Data-flow Analysis for Android Apps via Context-Aware Knowledge Reuse](http://arxiv.org/abs/2607.11308v1)
...
Selection reason: 利用上下文感知知识复用来降低批量agentic数据流分析的API成本，是明确的代码agent效率优化方法。
...
### [39] [Fail-Aware and Explainable Test Oracle Prediction](http://arxiv.org/abs/2607.11342v1)
...
Selection reason: 基于LLM的失败感知判别式测试预言预测，能补充fuzzing/测试生成，对agent测试有迁移价值。
...
### [40] [TerraRepair: A Tool-Grounded LLM Agent for Infrastructure-as-Code Repair](http://arxiv.org/abs/2607.11390v1)
...
Selection reason: 工具增强的IaC修复agent，通过检索schema和重扫验证提升修复率，是代码agent在基础设施领域的直接应用。
...
### [41] [Knowledge-Guided Synthetic Bug Feedback for LLM-Based Unit Test Generation](http://arxiv.org/abs/2607.11573v1)
...
Selection reason: 利用真实缺陷机制指导LLM生成单元测试的合成bug反馈，提升缺陷检测，对agent测试生成有参考价值。
...
### [42] [ThinkLog: Leveraging Reasoning for Log Statement Generation](http://arxiv.org/abs/2607.11615v1)
...
Selection reason: 利用推理链提升日志语句生成准确率并降低推理成本，其中的提示工程技巧可迁移到代码生成agent。
...
### [43] [Which Optimizer, At What Budget? A Tournament of Optimizers for Search-Based SE](http://arxiv.org/abs/2607.11705v1)
...
Selection reason: 系统比较20种优化器并给出预算相关的选择指南，直接支撑自动调优。
...
### [44] [Predicting Acceptance and Review Effort in Human and Agent Pull Requests](http://arxiv.org/abs/2607.12057v1)
...
Selection reason: 从提交时特征预测agent/人类PR接受度与评审工作量，可用于triage与评估。
...
### [45] [AutoTrace: From Patches to Triggers via Agentic Interprocedural Exploration](http://arxiv.org/abs/2607.12058v1)
...
Selection reason: agentic跨过程漏洞触发定位，融合LLM决策与可验证证据，对代码agent安全分析有直接价值。
...
### [46] [Beyond Test Presence: Assessing the Quality and Robustness of Agent-Generated Tests in Open-Source Projects](http://arxiv.org/abs/2607.12068v1)
...
Selection reason: 大规模评估agent生成测试的断言强度、边界覆盖与脆弱性，揭示stealth debt，对agent测试评估有直接借鉴。
...
### [47] [Fault Injection in OpenAPI Specifications for Evaluating Black-Box Testing Effectiveness](http://arxiv.org/abs/2607.12101v1)
...
Selection reason: 对OpenAPI规范注入故障评估黑盒测试工具，提供规范缺陷分类与评测方法，可借鉴于API测试agent验证。
...
### [48] [Self-Improving AI Coding Agents Through Accumulated Behavioral Rules: A Closed-Loop Framework](http://arxiv.org/abs/2607.13091v1)
...
Selection reason: 闭环规则积累使编码agent跨会话改进，0%复发率，对agent持久记忆与反思有直接价值。
...
### [49] [TestMiner: Software Testing Analysis for GitHub Repositories](http://arxiv.org/abs/2607.12223v1)
...
Selection reason: 提供GitHub项目测试实践的多维概览工具，可用于评估agent测试习惯，但迁移价值有限。
...
### [50] [Vinci2: Providing Proactive Assistance in Continuous Egocentric Videos](http://arxiv.org/abs/2607.11523v1)
...
### [51] [MM-ToolSandBox: A Unified Framework for Evaluating Visual Tool-Calling Agents](http://arxiv.org/abs/2607.11818v1)
...
### [52] [DeepBias: Adaptive In-depth Probing of Social Biases in LVLMs](http://arxiv.org/abs/2607.11228v1)
...
### [53] [Flout at Your Own Risk: LLMs Struggle with Pragmatic Cooperativity Under Epistemic Asymmetry](http://arxiv.org/abs/2607.11053v1)
...
### [54] [ProgramTab: Boosting Table Reasoning of LLMs via Programmatic Paradigm](http://arxiv.org/abs/2607.11207v1)
...
### [55] [Automated Textbook Auditing with Multi-Agent LLM Systems](http://arxiv.org/abs/2607.11276v1)
...
### [56] [Beyond Sally-Anne: Evaluating Theory of Mind in LLMs using Epistemic Schelling Points](http://arxiv.org/abs/2607.11363v1)
...
### [57] [Agentic Routing: The Harness-Native Data Flywheel](http://arxiv.org/abs/2607.11399v1)
...
### [58] [LightMem-Ego: Your AI Memory for Everyday Life](http://arxiv.org/abs/2607.11487v1)
...
### [59] [RAGU: A Multi-Step GraphRAG Engine with a Compact Domain-Adapted LLM](http://arxiv.org/abs/2607.11683v1)
...
### [60] [Metacognition in LLMs: Foundations, Progress, and Opportunities](http://arxiv.org/abs/2607.11881v1)
...
### [61] [RCWT: Measuring Task-Budget Displacement from Coordination Content in LLM Calls](http://arxiv.org/abs/2607.12216v1)
...
### [62] [AMT-X: Phase-Structured Multi-Turn Red-Teaming with Checklist-Gated Evaluation](http://arxiv.org/abs/2607.11151v1)
...
### [63] [SingGuard-NSFA: Extensible Guardrails for Agentic AI via Generative Reasoning and Real-Time Classification](http://arxiv.org/abs/2607.13081v1)
*SingGuard Team*
...
### [64] [Mako: A Self-Evolving Agentic Operating System (SE-AOS) for Autonomous Web Exploitation](http://arxiv.org/abs/2607.11288v1)
...
### [65] [Phantom Guardrails: When Self-Improving Agent Harnesses Fix Failures That Never Happened](http://arxiv.org/abs/2607.13083v1)
...
Selection reason: 研究自改进agent在harness优化中虚构故障的现象，并引入可复现的评测实验台，对agent可靠性机制有重要参考价值。
...
### [66] [Baselines Before Architecture: Evaluating Coding Agents for Autonomous Penetration Testing](http://arxiv.org/abs/2607.13085v1)
...
### [67] [Agent Hacks Agent: Autoresearch for Production-Agent Red-Teaming](http://arxiv.org/abs/2607.11698v1)
...
### [68] [Cross-Cutting Security Analysis of LLM-Generated Code via Metamorphic Testing and Association Rule Mining](http://arxiv.org/abs/2607.12089v1)
...
Selection reason: 用蜕变测试+关联规则挖掘LLM生成代码的跨切安全漏洞，并追溯提示级风险，可迁移到代码agent漏洞验证。
...
### [69] [Enhancing LLMs through human feedback: a journey towards self-improvement](http://arxiv.org/abs/2607.11267v1)
...
### [70] [FAIR GraphRAG: A Retrieval-Augmented Generation Approach for Semantic Data Analysis](http://arxiv.org/abs/2607.11464v1)
...
### [71] [Toward Trustworthy Autonomous Science: A Two-Year Community Roadmap](http://arxiv.org/abs/2607.12113v1)
...
### [72] [Complexity Theory of Randomised Testing](http://arxiv.org/abs/2607.11811v1)
...
Selection reason: 为随机/属性测试提供复杂度理论，有助于设计agent测试生成器。
...
### [73] [VIA: Visual Interface Agent for Robot Control](http://arxiv.org/abs/2607.11119v1)
...
### [74] [Towards Predictive, Aligned, and Scalable Robot Learning](http://arxiv.org/abs/2607.11270v1)
...
### [75] [A Glimpse into Long-term Physical Coexistence with Intelligent Robots](http://arxiv.org/abs/2607.11377v1)
...
### [76] [From World Action Models to Embodied Brains: A Roadmap for Open-World Physical Intelligence](http://arxiv.org/abs/2607.11689v1)
...
### [79] [PRISM Edit: One Vector for All Temporal Answers](http://arxiv.org/abs/2607.11327v2)
...
### [80] [BackgroundMellow: A Multi-Modal Cohesive Framework for Narrative-Driven Rich Cinematic Soundscape Generation](http://arxiv.org/abs/2607.11364v1)
...
### [81] [Agentic Skill Optimization over Lie Algebroids](http://arxiv.org/abs/2607.11493v1)
*Sridhar Mahadevan*
...
### [82] [Heuristic Learning for Active Flow Control Using Coding Agents](http://arxiv.org/abs/2607.11565v1)
...
### [83] [Active Offline-to-Online Reinforcement Learning](http://arxiv.org/abs/2607.11720v1)
...
### [84] [PFAdapter: Hierarchical LoRA Decomposition for Personalized Federated MLLMs](http://arxiv.org/abs/2607.12111v1)
...
### [85] [Continual Learning with Elastic Regularization and Synthetic Replay for Federated MLLM Fine-Tuning](http://arxiv.org/abs/2607.12112v1)
