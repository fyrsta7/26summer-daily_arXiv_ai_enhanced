...
### [1] [Baba in Wonderland: Online Self-Supervised Dynamics Discovery for Executable World Models](http://arxiv.org/abs/2605.16725v1)
...
### [2] [PopuLoRA: Co-Evolving LLM Populations for Reasoning Self-Play](http://arxiv.org/abs/2605.16727v1)
...
### [3] [State Contamination in Memory-Augmented LLM Agents](http://arxiv.org/abs/2605.16746v1)
...
### [4] [NeuroMAS: Multi-Agent Systems as Neural Networks with Joint Reinforcement Learning](http://arxiv.org/abs/2605.16757v1)
...
### [5] [Multi-Paradigm Agent Interaction in Practice:A Systematic Analysis of Generator-Evaluator, ReAct Loop,and Adversarial Evaluation in the buddyMe Framework](http://arxiv.org/abs/2605.16821v1)
...
### [6] [Artificial Adaptive Intelligence: The Missing Stage Between Narrow and General Intelligence](http://arxiv.org/abs/2605.16844v1)
*Boris Kriuk*
...
### [7] [Learning to Learn from Multimodal Experience](http://arxiv.org/abs/2605.16857v1)
...
### [8] [Reasoning Can Be Restored by Correcting a Few Decision Tokens](http://arxiv.org/abs/2605.16874v1)
...
### [9] [NGM: A Plug-and-Play Training-Free Memory Module for LLMs](http://arxiv.org/abs/2605.16893v1)
...
### [10] [TOBench: A Task-Oriented Omni-Modal Benchmark for Real-World Tool-Using Agents](http://arxiv.org/abs/2605.16909v1)
...
### [11] [Reliability and Effectiveness of Autonomous AI Agents in Supply Chain Management](http://arxiv.org/abs/2605.17036v3)
...
### [12] [PersonaArena: Dynamic Simulation for Evaluating and Enhancing Persona-Level Role-Playing in Large Language Models](http://arxiv.org/abs/2605.17044v1)
...
### [13] [RAGA: Reading-And-Graph-building-Agent for Autonomous Knowledge Graph Construction and Retrieval-Augmented Generation](http://arxiv.org/abs/2605.17072v1)
...
### [14] [Latent Heuristic Search: Continuous Optimization for Automated Algorithm Design](http://arxiv.org/abs/2605.17137v1)
...
### [15] [MADP: A Multi-Agent Pipeline for Sustainable Document Processing with Human-in-the-Loop](http://arxiv.org/abs/2605.17159v1)
...
### [16] [Responsible Agentic AI Requires Explicit Provenance](http://arxiv.org/abs/2605.17169v1)
...
### [17] [Task Abstention for Large Language Models in Code Generation](http://arxiv.org/abs/2605.17029v1)
...
Selection reason: 面向代码生成的 LLM 任务弃权机制，基于多假设检验与执行一致性提供可靠性保证，可迁移到 coding agent 的安全决策。
...
### [18] [Beyond Execution: Static-Analysis Rewards and Hint-Conditioned Diffusion RL for Code Generation](http://arxiv.org/abs/2605.17174v1)
...
Selection reason: 系统研究代码生成扩散模型 RL 的奖励设计与提示条件，验证静态检查奖励的有效性，对代码生成 agent 后训练有直接价值。
...
### [19] [AgentKernelArena: Generalization-Aware Benchmarking of GPU Kernel Optimization Agents](http://arxiv.org/abs/2605.16819v1)
...
### [20] [Skills on the Fly: Test-Time Adaptive Skill Synthesis for LLM Agents](http://arxiv.org/abs/2605.16986v1)
...
### [21] [PARALLAX: Separating Genuine Hallucination Detection from Benchmark Construction Artifacts](http://arxiv.org/abs/2605.17028v1)
...
### [22] [Agentic AI Translate: An Agentic Translator Prototype for Translation as Communication Design](http://arxiv.org/abs/2605.17041v1)
*Masaru Yamada*
...
### [23] [Can LLMs Think Like Consumers? Benchmarking Crowd-Level Reaction Reconstruction with ConsumerSimBench](http://arxiv.org/abs/2605.17079v1)
...
### [24] [SEMA-RAG: A Self-Evolving Multi-Agent Retrieval-Augmented Generation Framework for Medical Reasoning](http://arxiv.org/abs/2605.17101v2)
...
### [25] [The Point of No Return: Counterfactual Localization of Deceptive Commitment in Language-Model Reasoning](http://arxiv.org/abs/2605.17113v1)
...
### [26] [Genflow Ad Studio: A Compound AI Architecture for Brand-Aligned, Self-Correcting Video Generation](http://arxiv.org/abs/2605.16748v1)
...
### [27] [Stop Starving or Stuffing Me: Boosting Firmware Fuzzing Efficiency with On-demand Input Delivery](http://arxiv.org/abs/2605.16798v1)
...
Selection reason: 面向固件模糊测试的输入时序与数量优化，通过静态/动态分析识别输入处理路径，可迁移到 agent 测试与覆盖率提升。
...
### [28] [The Range Shrinks, the Threat Remains: Re-evaluating LLM Package Hallucinations on the 2026 Frontier-Model Cohort](http://arxiv.org/abs/2605.17062v2)
*Aleksandr Churilov*
...
Selection reason: 系统评估前沿模型包名幻觉，揭示模型无关的供应链攻击面，为代码 agent 依赖安全提供评测基准与风险数据。
...
### [29] [The Alpha Illusion: Reported Alpha from LLM Trading Agents Should Not Be Treated as Deployment Evidence](http://arxiv.org/abs/2605.16895v1)
...
### [30] [The IsalProgram Programming Language](http://arxiv.org/abs/2605.17008v1)
...
### [31] [Reconsidering "Reconsidering Custom Memory Allocation"](http://arxiv.org/abs/2605.17119v1)
...
Selection reason: 重新评估自定义内存分配对执行性能的影响，包含现代平台基准与碎片/局部性方法，是 SemOpt 直接相关研究。
...
### [32] [Some[Body] Must Receive That Pain for Agent Accountability](http://arxiv.org/abs/2605.16872v1)
...
### [33] [Thinking with Patterns: Breaking the Perceptual Bottleneck in Visual Planning via Pattern Induction](http://arxiv.org/abs/2605.16848v1)
...
### [34] [OmniVL-Guard Pro: A Tool-Augmented Agent for Omnibus Vision-Language Forensics](http://arxiv.org/abs/2605.16962v2)
...
### [35] [MemForest: An Efficient Agent Memory System with Hierarchical Temporal Indexing](http://arxiv.org/abs/2605.23986v1)
...
### [36] [TIER: Trajectory-Invariant Execution Rewards for Multi-Step Tool Composition](http://arxiv.org/abs/2605.16790v1)
...
### [37] [To Call or Not to Call: Diagnosing Intrinsic Over-Calling Bias in LLM Agents](http://arxiv.org/abs/2605.18882v1)
...
### [38] [Decoupling KL and Trajectories: A Unified Perspective for SFT, DAgger, Offline RL, and OPD in LLM Distillation](http://arxiv.org/abs/2605.16826v1)
...
### [39] [BoLT: A Benchmark to Democratize Black-box Optimization Research for Expensive LLM Tasks](http://arxiv.org/abs/2605.17000v1)
...
### [40] [Learning-Zone Energy: Online Data Selection for Efficient RL Post-Training](http://arxiv.org/abs/2605.17003v2)
...
### [41] [When Dynamics Shift, Robust Task Inference Wins: Offline Imitation Learning with Behavior Foundation Models Revisited](http://arxiv.org/abs/2605.17017v1)
...
### [42] [Privacy Policy Enforcement Guardrails for Data-Sensitive Retrieval-Augmented Generation](http://arxiv.org/abs/2605.17034v2)
...
### [43] [D$^2$Evo: Dual Difficulty-Aware Self-Evolution for Data-Efficient Reinforcement Learning](http://arxiv.org/abs/2605.17037v1)
...
### [44] [1GC-7RC: One Graphic Card -- Seven Research Challenges! How Good Are AI Agents at Doing Your Job?](http://arxiv.org/abs/2605.17046v2)
...
### [45] [S-Bus: Automatic Read-Set Reconstruction for Multi-Agent LLM State Coordination](http://arxiv.org/abs/2605.17076v2)
*Sajjad Khan*
...
### [46] [OpenJarvis: Personal AI, On Personal Devices](http://arxiv.org/abs/2605.17172v1)
...
### [47] [Contrastive Conceptor Activation Steering (COAST): Unlocking Vision-Language-Action Models through Hidden States](http://arxiv.org/abs/2605.17144v1)
