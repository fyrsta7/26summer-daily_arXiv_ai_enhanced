...
- [RealisticTritonBench: A Benchmark for Triton-Kernel Generation in Real-World AI Frameworks](https://arxiv.org/abs/2608.12004) — 相关度 0.95：提出面向真实AI框架PR的Triton核生成基准，以端到端性能评估LLM生成内核，直接属于性能关键代码生成方向。
- [GraphAlignCoder: Aligning Program and Proof Graphs for Code Generation](https://arxiv.org/abs/2608.11394) — 相关度 0.85：通过对齐程序图与证明图训练代码生成模型，提升隐藏语义约束满足度，在多个代码生成基准上显著提升。
- [Do Influence Tactics Matter? Investigating Prompt Framing Effects in LLM Code Generation](https://arxiv.org/abs/2608.11513) — 相关度 0.70：实证研究心理学影响策略对LLM代码生成的功能正确性、质量与安全性的影响，为Agent提示设计提供实证依据。
- [Instruction Alignment for Binary Code Representation Learning](https://arxiv.org/abs/2608.11766) — 相关度 0.60：利用指令对齐提升二进制代码表示学习，服务于逆向工程与代码检索，对Agent的代码理解与检索有参考价值。
