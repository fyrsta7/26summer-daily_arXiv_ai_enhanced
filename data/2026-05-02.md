...
### [1] [GR-Ben: A General Reasoning Benchmark for Evaluating Process Reward Models](http://arxiv.org/abs/2605.01203v2)
...
### [2] [Faithful Mobile GUI Agents with Guided Advantage Estimator](http://arxiv.org/abs/2605.01208v1)
...
### [3] [Agentic AI Systems Should Be Designed as Marginal Token Allocators](http://arxiv.org/abs/2605.01214v1)
*Siqi Zhu*
...
### [4] [EO-Gym: A Multimodal, Interactive Environment for Earth Observation Agents](http://arxiv.org/abs/2605.01250v1)
...
### [5] [Lifting Traces to Logic: Programmatic Skill Induction with Neuro-Symbolic Learning for Long-Horizon Agentic Tasks](http://arxiv.org/abs/2605.01293v1)
...
### [6] [State Representation and Termination for Recursive Reasoning Systems](http://arxiv.org/abs/2605.06690v1)
...
### [7] [Segment-Aligned Policy Optimization for Multi-Modal Reasoning](http://arxiv.org/abs/2605.01327v2)
...
### [8] [Truth or Tribe: How In-group Favoritism Prioritize Facts in Persona Agents](http://arxiv.org/abs/2605.01329v1)
...
### [9] [DiagramNet: An End-to-End Recognition Framework and Dataset for Non-Standard System-Level Diagrams](http://arxiv.org/abs/2605.01338v1)
...
### [10] [CoFlow: Coordinated Few-Step Flow for Offline Multi-Agent Decision Making](http://arxiv.org/abs/2605.01457v3)
...
### [11] [MAP-Law: Coverage-Driven Retrieval Control for Multi-Turn Legal Consultation](http://arxiv.org/abs/2605.01486v2)
...
### [12] [SciResearcher: Scaling Deep Research Agents for Frontier Scientific Reasoning](http://arxiv.org/abs/2605.01489v2)
...
### [13] [MILD: Mediator Agent System with Bidirectional Perception and Multi-Layered Alignment for Human-Vehicle Collaboration](http://arxiv.org/abs/2605.01507v2)
...
### [14] [Multi-Agent Reasoning Improves Compute Efficiency: Pareto-Optimal Test-Time Scaling](http://arxiv.org/abs/2605.01566v1)
...
### [15] [Evaluating Agentic AI in the Wild: Failure Modes, Drift Patterns, and a Production Evaluation Framework](http://arxiv.org/abs/2605.01604v1)
*Mukund Pandey*
...
### [16] [ClarifySTL: An Interactive LLM Agent Framework for STL Transformation through Requirements Clarification](http://arxiv.org/abs/2605.01209v1)
...
Selection reason: 通过交互式澄清将自然语言需求转为STL规约，其澄清-更新循环可迁移到agent的规格获取。
...
### [17] [FeedbackLLM: Metadata driven Multi-Agentic Language Agnostic Test Case Generator with Evolving prompt and Coverage Feedback](http://arxiv.org/abs/2605.01264v1)
...
Selection reason: 多agent测试用例生成，利用行/分支覆盖反馈迭代优化，与测试agent直接相关。
...
### [18] [LiveFMBench: Unveiling the Power and Limits of Agentic Workflows in Specification Generation](http://arxiv.org/abs/2605.01394v1)
...
Selection reason: 提出防泄漏的形式规约生成基准并揭示评估高估现象，对agent生成与验证评测有重要价值。
...
### [19] [Practical Limits of Autonomous Test Repair: A Multi-Agent Case Study with LLM-Driven Discovery and Self-Correction](http://arxiv.org/abs/2605.01471v1)
*Hyukjoo Lee*
...
Selection reason: 多agent自主测试修复的工业案例，量化修复收敛与失败模式，为agent自主性与验证边界提供实证。
...
### [20] [Neuro-Symbolic Agents for Hallucination-Free Requirements Reuse](http://arxiv.org/abs/2605.01562v2)
*Ahmed F. Ibrahim*
...
Selection reason: 神经符号多agent需求复用框架，用确定性符号验证器约束LLM生成，可迁移到代码生成的结构约束。
...
### [21] [Feedback-Normalized Developer Memory for Reinforcement-Learning Coding Agents: A Safety-Gated MCP Architecture](http://arxiv.org/abs/2605.01567v1)
*Mehmet Iscan*
...
Selection reason: 为RL coding agent设计安全门控的记忆架构并含OPE评估，直接增强长程执行的记忆与验证能力。
...
### [22] [Model-Based Proactive Cost Generation for Learning Safe Policies Offline with Limited Violation Data](http://arxiv.org/abs/2605.01356v1)
...
### [23] [AI Alignment via Incentives and Correction](http://arxiv.org/abs/2605.01643v3)
...
### [24] [Chain of Evidence: Pixel-Level Visual Attribution for Iterative Retrieval-Augmented Generation](http://arxiv.org/abs/2605.01284v2)
...
### [25] [The Perceptual Bandwidth Bottleneck in Vision-Language Models: Active Visual Reasoning via Sequential Experimental Design](http://arxiv.org/abs/2605.01345v3)
...
### [26] [BaRA: Budget-constrained and Reliable Web Data Collection Agent](http://arxiv.org/abs/2607.00007v2)
...
### [27] [MAD-OPD: Breaking the Ceiling in On-Policy Distillation via Multi-Agent Debate](http://arxiv.org/abs/2605.01347v1)
...
### [28] [Verbal-R3: Verbal Reranker as the Missing Bridge between Retrieval and Reasoning](http://arxiv.org/abs/2605.01399v1)
...
### [29] [FT-RAG: A Fine-grained Retrieval-Augmented Generation Framework for Complex Table Reasoning](http://arxiv.org/abs/2605.01495v1)
...
### [30] [Automated Interpretability and Feature Discovery in Language Models with Agents](http://arxiv.org/abs/2605.01555v1)
...
### [31] [Prosa: Rubric-Based Evaluation of LLMs on Real User Chats in Brazilian Portuguese](http://arxiv.org/abs/2605.01630v1)
...
### [33] [Intelligent Autonomous Orchestration for Distributed Cloud Resources using Complex-Stability Analysis](http://arxiv.org/abs/2605.08139v1)
...
### [34] [Less Interaction But More Explanation: A Communication Perspective on Agentic AI Interfaces](http://arxiv.org/abs/2605.01610v1)
...
### [35] [HepScript: A Dual-Use DSL for Human-AI Collaborative Data Analysis Workflows in High-Energy Physics](http://arxiv.org/abs/2605.01423v1)
