...
### [2] [Induction and Inquiry via Probabilistic Reasoning over Language and Code](https://arxiv.org/abs/2609.01815)
...
### [3] [The Memory Trust Gap: Capability-Dependent Failures in Persistent-Memory Agents](https://arxiv.org/abs/2609.01852)
...
### [6] [ToolGate: An Executable Acceptance Pipeline for Tool-Dependent Scientific Benchmark Construction](https://arxiv.org/abs/2609.02067)
...
Selection reason: ToolGate提出可执行验证、无工具筛选、工具agent求解的三阶段接受管线，可迁移到工具依赖的代码任务基准构建与agent评测。
...
### [7] [When Agents Implement Systems: A Case Study in Defects, Detection, and Evaluation Rigor](https://arxiv.org/abs/2609.01985)
...
### [8] [ClaimReceipt: Verifying Evidence Sufficiency and Coverage in Agent Evaluations](https://arxiv.org/abs/2609.01992)
...
### [9] [Monitoring Web Agents Without Internal Signals: Observable Trajectories and Key-Step Supervision](https://arxiv.org/abs/2609.02057)
...
### [11] [Beyond Outcome Gaps: Process-Aware Fairness Diagnosis for LLM-based Multi-Agent Decision Systems](https://arxiv.org/abs/2609.02092)
...
### [13] [READY or Not: Reliable Enterprise Agent Deployment](https://arxiv.org/abs/2609.02095)
...
### [14] [Beyond Context Windows: Persistent Discovery Context for Data-Centric Agents](https://arxiv.org/abs/2609.02129)
*Jalal Mahmud*
...
### [15] [Examining the Vulnerability of Multi-Agent Medical Systems to Human Interventions for Clinical Reasoning](https://arxiv.org/abs/2609.02191)
...
### [16] [SkillGLoW: Procedural-Family Skill Consolidation for Self-Improving Agents on Long-Horizon Task Streams](https://arxiv.org/abs/2609.02217)
...
### [17] [PGPO: Potential-Guided Policy Optimization for Multi-Turn Agentic Tasks](https://arxiv.org/abs/2609.02236)
...
### [18] [Propose to Learn, Learn to Propose: Evaluability-Aware Assistance under Bounded Rationality](https://arxiv.org/abs/2609.02242)
...
### [19] [LLM-as-a-Judge Is Not an Oracle: Why Self-Improving Agents Need Deterministic Guardrails](https://arxiv.org/abs/2609.02246)
*Vansh Wahi*
...
### [20] [APEx: Distillation of Agent Procedural Experience for Adaptive Deep Research Question Answering](https://arxiv.org/abs/2609.02253)
...
### [21] [Codebook Agent: Amortized Topology Design for LLM Multi-Agent Systems](https://arxiv.org/abs/2609.02264)
...
### [23] [Diagnosing with Insights: Structured Analysis of Agent Failures via Behavioral Abstractions](https://arxiv.org/abs/2609.02371)
...
### [24] [UTP-Bench: Uncertainty-aware Travel Planning Benchmark](https://arxiv.org/abs/2609.02421)
...
### [25] [CivBench: A Long-Horizon Benchmark for Tool-Mediated Agents in Civilization VI](https://arxiv.org/abs/2609.02459)
...
### [26] [Loom: Weaving Diagnostic Strands into Free-Text Consensus via Embedding-Space Reweighting](https://arxiv.org/abs/2609.02649)
...
### [27] [Repo-To-Skill: Distilling GitHub Repositories Into AI4AI Skills](https://arxiv.org/abs/2609.02749)
...
### [28] [Bilevel Coordinated Reflection: A Game-Theoretic Approach to Multi-Agent LLM Systems](https://arxiv.org/abs/2609.02750)
...
### [29] [SafeEvolve: Harness-Policy Co-Evolution from Agent Experience for Safety Alignment](https://arxiv.org/abs/2609.02786)
...
### [30] [Discriminative World Models for Web Agents](https://arxiv.org/abs/2609.02885)
...
### [31] [RosettaBitcoin: An Artifact-Backed Experience Report on Verification Infrastructure for Agent-Assisted Consensus Validators](https://arxiv.org/abs/2609.01702)
*Donavon Guyot*
...
Selection reason: 该经验报告展示Agent辅助共识验证器的可审计基础设施（显式失败记录、fixtures、端口自有证明），对验证代码agent系统的可靠性有迁移价值。
...
### [32] [Harness Engineering in LLM Tool Use via Agent-Native Reusable Tool Primitives](https://arxiv.org/abs/2609.01736)
...
Selection reason: 直接提出LLM工具使用的Tool Primitives/ToolFace/HEART框架，包含规划、路由、验证与反馈恢复，是coding agent核心机制。
...
### [33] [From Silicon to Boot Code: Extending Automated Program Repair to Firmware-Layer Security Workarounds](https://arxiv.org/abs/2609.01769)
...
Selection reason: 将自动化程序修复从RTL扩展到固件层，用localize-synthesize-validate及字典引导定位器，方法可迁移到代码漏洞修复agent。
...
### [34] [ExecRetrieval: Measuring the Functional-Correctness Gap in Code-Embedding Retrieval](https://arxiv.org/abs/2609.01865)
...
Selection reason: 提出代码检索功能正确性基准ExecRetrieval，包含执行验证的buggy干扰项，直接衡量coding agent检索组件的判别力。
...
### [35] [From Prompting to Engineering: A Research Agenda for Prompt Engineering in Software Engineering](https://arxiv.org/abs/2609.02248)
...
Selection reason: 给出SE中prompt工程化的研究议程，涉及提示工件标准化、评估与生命周期管理，可指导coding agent提示工作流设计。
...
### [36] [Automated Vulnerability Injection in Smart Contracts Using Large Language Models](https://arxiv.org/abs/2609.02624)
...
Selection reason: 用LLM自动向Solidity合约注入已验证漏洞，生成带ground truth的数据集，可用于评估代码安全检测agent。
...
### [37] [The Import Tax: A Longitudinal Measurement of Startup Cost in the Python Ecosystem](https://arxiv.org/abs/2609.02753)
...
Selection reason: 大规模测量Python导入启动成本并评估lazy import，属于性能profiling与冷启动优化，对优化agent运行环境有直接价值。
...
### [38] [ShikumiMiner: Mining Recurring Implementation Patterns in AI Codebases](https://arxiv.org/abs/2609.02789)
...
Selection reason: ShikumiMiner用AST+CFG特征挖掘AI代码库中的重复实现模式，其静态分析方法可迁移到代码理解agent。
