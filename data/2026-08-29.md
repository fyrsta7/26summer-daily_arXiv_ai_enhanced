...
### [4] [The Artificial Experimentalist: Discovery and Control of Self-Organizing Phenomena with Autotelic Reinforcement Learning](https://arxiv.org/abs/2608.26116)
...
### [5] [GROUND: Reducing Hallucinations in LLM-Based Enterprise Analytics Through Governed Semantic Definitions](https://arxiv.org/abs/2608.26157)
...
### [6] [Refusal Is Not Robustness: Auditing Confident Fabrication in Large Language Models on a Provably Uninformative Clinical Pain Speech Transcript](https://arxiv.org/abs/2608.26167)
...
### [8] [AI Revealed Preferences](https://arxiv.org/abs/2608.26178)
...
### [9] [Benchmarking AI Agents for Hardware Design Automation via MCP Tool Calling](https://arxiv.org/abs/2608.26199)
...
Selection reason: 构建MCP工具调用下的硬件设计自动化agent基准，系统评估系统提示、工具描述、上下文与多agent架构对可靠性的影响，对工具增强代码agent有明确参考价值。
...
### [10] [Invocation-Level Reliability of Tool-Using Agents](https://arxiv.org/abs/2608.26189)
...
### [11] [Same Model, Different Harness: Different Coding-Agent Results](https://arxiv.org/abs/2608.26218)
*Sydney Lewis*
...
Selection reason: 通过对照实验证明相同模型在不同harness下代码agent结果显著不同，强调评测需将模型与harness视为整体，对coding agent评测方法论有直接影响。
...
### [12] [Agent Mesh: Reliability Primitives for Non-Idempotent Agent Delegation - Identity Adequacy and Evidence Adequacy](https://arxiv.org/abs/2608.26225)
...
Selection reason: 基于生产平台147个故障的分析提出非幂等agent委托的可靠性原语，包含身份充分性与证据充分性，可迁移到代码agent的重试、恢复与电路断开机制设计。
...
### [13] [Five Primitives for Governing Autonomous AI Agents at Runtime](https://arxiv.org/abs/2608.26696)
...
Selection reason: 提出运行时治理自主agent的五个原语（发现、身份、治理、证明、供应链），其策略强制与账本审计思路可迁移到代码agent的运行时安全与合规设计。
...
### [14] [Agentic AI for operating scientific instruments for nanoscale characterization](https://arxiv.org/abs/2608.26198)
...
### [15] [A Contract-Centered Architecture for Scalable and Manageable Agentic Runtimes](https://arxiv.org/abs/2608.27086)
...
Selection reason: 提出以契约为中心的agentic运行时架构与能力-容量可分性假设，虽无实现，但责任对象划分和验证协议对可扩展代码agent平台的设计有参考价值。
...
Selection reason: 针对工具输出诱导动作与执行授权分离的安全机制，在AgentDojo上显著降低攻击成功率，对代码agent处理不可信工具输出有直接防护价值。
...
### [17] [LLM Agents for Time-Series: A Survey](https://arxiv.org/abs/2608.26226)
...
### [19] [SKILL.state: Scalable Long-Horizon Agent Skills](https://arxiv.org/abs/2608.26263)
...
### [20] [Approved Too Late: Verdict Staleness in LLM-Guarded Self-Adaptive Systems](https://arxiv.org/abs/2608.26306)
...
### [21] [FaithSieve: Fine-Grained Evaluation of Math Proofs with Faithful Formal Evidence](https://arxiv.org/abs/2608.26310)
...
### [22] [ProofEvolve: Neuro-Symbolic Evolution for Formal Automated Theorem Proving](https://arxiv.org/abs/2608.26334)
...
### [23] [Don't Overthink, Don't Underthink: Toward Adaptive Reasoning in Agentic AI](https://arxiv.org/abs/2608.26442)
...
### [24] [PILOT in the Loop: Live Self-Improvement for Long-Horizon Agents](https://arxiv.org/abs/2608.26530)
...
### [25] [DuMateBench: Evaluating Autonomous Agents in Complex Real-World Workflows](https://arxiv.org/abs/2608.26546)
...
### [26] [AgentJudgeBench: A Multi-Difficulty Benchmark for Evaluating LLM Judges on Agentic Tool-Calling](https://arxiv.org/abs/2608.26623)
...
### [27] [SIGMA: Structured Noise-Effect-Aware Grouped Multi-Agent Aggregation](https://arxiv.org/abs/2608.26683)
*Li Mingqian*
...
### [28] [Accelerating Scientific Research with Gemini in the Real-World](https://arxiv.org/abs/2608.26701)
...
### [29] [Knowing When Not to Reuse: Conditional Experience Transfer in Autonomous LLM Post-Training](https://arxiv.org/abs/2608.26730)
...
### [30] [Graph-Guided Selective Unlearning for Language Models: Controlling Support Routes Beyond Forget Seeds](https://arxiv.org/abs/2608.26743)
...
### [31] [AgentFold: Closed-Loop Agentic Search for Protein Folding Model Design](https://arxiv.org/abs/2608.26747)
...
### [32] [DEEPCHART: How Far are LLMs from Faithful Data-Science Chart Generation?](https://arxiv.org/abs/2608.26757)
...
### [33] [AI Control Scientist: LLM-driven Agentic System for Automated Control Design](https://arxiv.org/abs/2608.26780)
...
### [35] [SymbolLKG: Towards Verifiable Logical Reasoning via Logical Knowledge Graph and Symbolic Solvers](https://arxiv.org/abs/2608.26836)
...
### [36] [LiveSim: Simulating Environment-Shaped Users in Multi-Agent Live-Stream Ecosystems](https://arxiv.org/abs/2608.26849)
...
### [37] [BekchiAI: Measuring, Observing, and Controlling LLM Agents in One Click](https://arxiv.org/abs/2608.26867)
*Mesut Toruk*
...
### [39] [Learning-Augmented Online Allocation under Unreliable Advice: Robustness, Exposure Fairness, and Distribution Shift](https://arxiv.org/abs/2608.26889)
*Fredy Pokou*
...
### [40] [Counterfactual Bias Testing for Application Tracking System](https://arxiv.org/abs/2608.26899)
...
### [41] [From Atomic to Agentic: Towards Interpretable Evaluation of LLMs' Agentic Mathematical Capabilities](https://arxiv.org/abs/2608.26950)
...
### [42] [GraphMemix: Query-Aware Evidence Forests for Long-Term Multimodal Agent Memory](https://arxiv.org/abs/2608.26983)
...
### [43] [DSA: Evidence-Aware LLM-Agent Orchestration for Multi-Market Stock Research](https://arxiv.org/abs/2608.26990)
*Linsen Zhu,Yi Shi*
...
### [44] [ASIL: Replacing Screenshot-and-Click with Structured State and Semantic Actions](https://arxiv.org/abs/2608.26991)
*Rui Xie,Lu Chen*
...
### [45] [LAAF: A Layered Accountability Architecture Framework for LLM Applications](https://arxiv.org/abs/2608.27102)
...
### [46] [TransMeme: A Multi-Agent Framework for Cross-Cultural Meme Transcreation](https://arxiv.org/abs/2608.27127)
...
### [47] [GRAIN: Bridging Name and Narrative Shifts in Real-World Graph Reasoning through Invariance-Rewarded Agentic RL](https://arxiv.org/abs/2608.27142)
...
### [48] [Calibrated Enough to Know, Not Calibrated to Act: Fabricated Evidence Makes LLM Agents Commit to the Unknowable](https://arxiv.org/abs/2608.27167)
*Pranav Aggarwal*
...
### [49] [What Makes Good Agentic Data? An ACE Lens on Data Generation for LLM Agents](https://arxiv.org/abs/2608.27260)
...
### [50] [Naive Prompt Optimization: Rethinking the Need for Complex Prompt Search](https://arxiv.org/abs/2608.27266)
...
### [51] [LLMs Can Design Near-Optimal OR Algorithms](https://arxiv.org/abs/2608.27296)
*Jackie Baek*
...
### [52] [Verify Smarter, Evolve Further: Efficient Harness Evolution through Behavior-Aware Verification](https://arxiv.org/abs/2608.27311)
...
### [53] [Not All Eval-Awareness Is Equal: Capabilities Framing Predicts Compliance](https://arxiv.org/abs/2608.27340)
...
### [54] [WikiSkill: Compiling Agent Experience into Persistent Knowledge for Skill Evolution](https://arxiv.org/abs/2608.27454)
...
### [55] [Agentic AI Containment Architecture for Security Hardening](https://arxiv.org/abs/2608.26108)
*Mohamed ElBendary*
...
Selection reason: 多agent安全约束架构与验证模型，可迁移到coding agent的安全治理与权限控制。
...
### [56] [Four Ways to Forge a Bundle My Own Verifier Calls Clean: Refusal-Site Mutation Testing of an Evidence-Bundle Verifier](https://arxiv.org/abs/2608.26183)
*Erik Hill*
...
Selection reason: 提出 refusal-site 变异测试量化验证器的空验证通过缺陷，可迁移到 agent 行为验证与测试。
...
### [57] [Cost-Utility Alignment in LLM Agent Trajectories:Profiling,Attribution,Diagnosis,Adaptation,and Evaluation](https://arxiv.org/abs/2608.26195)
*Dan Liu,Jian Li*
...
Selection reason: 提出轨迹级成本-效用对齐框架（剖析/归因/诊断/适配/评测），可直接用于 coding agent 的资源感知设计。
...
### [58] [Harness Engineering for Predictable Agentic Systems: An Empirical Study of Deterministic Execution Constraints](https://arxiv.org/abs/2608.26197)
*Saransh Dhage*
...
Selection reason: 通过确定性执行约束（有限状态控制、结构化规划）提升 agent 可复现性与成功率，对 agent 可靠性工程有直接迁移价值。
...
### [59] [Fairness Invariants: A Relational Approach to Explaining and Mitigating Fairness Bugs](https://arxiv.org/abs/2608.26209)
...
Selection reason: 用关系不变式合成定位公平性缺陷，方法可迁移到 agent 行为的反事实测试与验证。
...
### [60] [When Review Alone No Longer Scales: Layered Supervision in AI-Assisted Software Engineering](https://arxiv.org/abs/2608.26316)
...
Selection reason: 揭示 AI 辅助开发中分层监督（预防式/可执行/人工）的演化，对 agent 工作流防护设计有参考价值。
...
### [61] [Investigating Software Aging in LLM-Generated Software Systems across Generation-and-Execution Environments](https://arxiv.org/abs/2608.26391)
...
Selection reason: 系统评估 LLM 生成软件在持续负载下的老化症状，为 LLM 代码部署可靠性与性能评测提供方法。
...
### [62] [Spec2Vision: Contract-Guided Delivery of AI-Generated Computer Vision Pipelines](https://arxiv.org/abs/2608.26400)
...
Selection reason: 提出契约引导的分阶段生成-筛选-测试-修复框架，确保生成管线满足任务契约，可迁移到代码 agent。
...
### [63] [STILL: Recovering Lowered STL Semantics for LLM-assisted C++ Decompilation](https://arxiv.org/abs/2608.26408)
...
Selection reason: 为反编译/代码理解提供 STL 语义提示接口，提升 LLM 修复代码的可执行性，对代码 agent 有迁移价值。
...
### [64] [DeepRepro: State-Aware Subplanning for Paper-to-Code Reproduction in Evolving Repositories](https://arxiv.org/abs/2608.26557)
...
Selection reason: 提出基于执行状态感知子规划的长程仓库构建框架，显著优于代码 agent 基线，直接相关。
...
### [65] [The Thousand-Graph Hypothesis: A Testable Hypothesis of Task-Conditioned Relation Materialization in Repository-Level Code Reasoning](https://arxiv.org/abs/2608.26602)
*Fei Ding*
...
Selection reason: 提出实体级外部接口与任务条件关系物化，用于仓库级代码推理，可迁移到代码 agent 检索与规划。
...
### [66] [FaultLens: Learning Compact Behavioral Test Suites for Generated Operational Programs](https://arxiv.org/abs/2608.26746)
...
Selection reason: 学习紧凑行为测试套件并保留证据链，以极小预算覆盖大部分可杀死故障，适用于生成代码的验证。
...
### [67] [Beyond Execution: Auditing Experimental Fidelity in LLM-Driven Scientific Research](https://arxiv.org/abs/2608.26753)
...
Selection reason: 提出参考锚定的实验保真度审计框架，检测 LLM 科研 agent 的方法幻觉与证据不足，可迁移到 agent 验证评测。
...
### [68] [An Empirical Evaluation of Using Large Language Models for Automated Model-Based Test Generation](https://arxiv.org/abs/2608.27094)
...
Selection reason: 系统评估多种 LLM 在模型驱动测试生成中的能力，为 LLM 测试 agent 的路径优化提供实证。
...
### [69] [Mutation Testing for Reproducibility Safeguards in Machine Learning Research Software: An Empirical Study](https://arxiv.org/abs/2608.27100)
*Ilya Shulepov*
...
Selection reason: 提出面向 ML 研究仓库的可复现性变异测试，可用于评估 agent/工作流对实验关键选择的保护能力。
...
### [70] [AgentDV: Closed-Loop Agentic AI for Hardware Design Verification](https://arxiv.org/abs/2608.27148)
...
Selection reason: 面向RTL验证的闭环agent框架，结合仿真、覆盖率反馈与迭代修复，其可运行性过滤和覆盖率引导迭代可直接迁移到代码agent的测试生成与验证流程。
...
Selection reason: 提出人格-执行分离的LLM agent架构模式，通过受控契约桥接实现可审计执行与自由演化，其审计锚点与验证机制可迁移到代码agent的可靠性和可审计设计中。
...
### [72] [From Static to Dynamic: Benchmarking Real-World Code Review with MCR-Bench](https://arxiv.org/abs/2608.27442)
...
Selection reason: 首个面向多轮代码评审的缺陷状态感知基准，含细粒度缺陷元数据和动态状态标注，对代码审查agent评测有直接价值。
...
### [73] [SWE-Prime: Fewer Trajectories, Better Performance](https://arxiv.org/abs/2608.27449)
...
Selection reason: 针对SWE-bench轨迹的多粒度数据选择方法，仅用10%数据超越全量SFT，显著提升代码agent训练效率，直接相关。
