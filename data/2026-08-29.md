...
Comments: Accepted in SEAA 2026

Selection reason: cs.SE 论文按全量策略收录。

TL;DR: 通过系统性映射研究，分析了2020-2026年间33篇关于AI软件质量的主要研究，识别出六类挑战，其中质量评估模型局限性最为突出，呼吁研究者、从业者与标准化组织合作制定综合评估方法。


<details>
  <summary>Details</summary>
Motivation: AI在软件系统中日益普及，但如何定义、评估和保证AI软件的质量仍不明确，缺乏系统的综述来梳理现有研究和挑战。

Method: 采用系统性映射研究方法，从五个电子数据源中检索2020年1月至2026年1月的相关研究，经过自动搜索、筛选和滚雪球抽样，最终纳入33项主要研究进行分析。

Result: 识别出六类反复出现的挑战类别，最突出的是现有质量评估模型的局限性，其次是非功能需求管理、质量感知开发和质量保证方面的问题。

Conclusion: 需要研究人员、工业从业者与标准化组织合作，共同制定全面的质量评估及其测量方法。

中文摘要：人工智能（AI）日益嵌入现代软件系统，引发了关于如何定义、评估和保障其质量的重要问题。本文提出了一项关于基于AI的软件质量的系统性映射研究（SMS）。该研究综合了2020年1月至2026年1月期间发表的主要研究，并从五个电子数据源中选取。经过自动搜索、筛选和滚雪球抽样后，共纳入33项主要研究。结果识别出六类反复出现的挑战类别，其中最突出的是现有质量评估模型的局限性，其次是非功能需求管理、质量感知开发和质量保证方面的问题。研究结果表明，需要研究人员和工业从业者与标准化组织合作，以可能设计出全面的质量评估及其测量方法。
...
Journal reference: IEEE Computer, vol. 59, no. 9, pp. 37-46, Sept. 2026

DOI: [10.1109/MC.2026.3697659](https://doi.org/10.1109/MC.2026.3697659)

Selection reason: cs.SE 论文按全量策略收录。

TL;DR: 本文基于JavaScript和Lua两种宿主语言的案例研究，提出构成Processing/p5的软件决策指导方面，并讨论其在其他工具中的不同实现方式，以促进创造性编码和算法艺术的新库开发。


<details>
  <summary>Details</summary>
Motivation: 不同编程语言生态各有特点，但Processing/p5在不同语言中保持一致性，需要明确其核心设计原则以支持跨语言实现和扩展。

Method: 对JavaScript和Lua两种宿主语言中的Processing/p5实现进行案例研究，提炼指导方面，并与其他探索性/创造性工具中的决策进行比较。

Result: 提出一系列软件决策指导方面，构成与宿主语言无关的Processing/p5本质，并展示这些方面在不同工具中的多样操作化方式。

Conclusion: 该框架为新Processing/p5库的创建提供了学习、研究和艺术实践的机会，促进创造性编码和算法艺术的发展。

中文摘要：跨不同编程语言的Processing/p5库在创造性编码中作为设计体验实施了一致的优先事项。虽然像Java和JavaScript这样的不同编程语言生态各自具有自身的可供性、社区规范和使用模式，但跨这些语言的Processing/p5草图具有相似性。基于在两种宿主语言JavaScript和Lua中构建Processing/p5实现的案例研究，我们提出了一系列构成Processing/p5的软件决策指导方面，无论宿主语言如何。我们在其他探索性和创造性工具中的决策背景下讨论这一框架，这些决策展示了每个指导方面如何以不同于案例研究的方式被操作化。所提出的列表突出了通过学习、研究和艺术实践创造用于创造性编码和算法艺术的新Processing/p5库的机会。

Original abstract: Processing/p5 libraries across different programming languages enact consistent priorities for creative coding as a designed experience. While different programming language ecosystems, like Java and JavaScript, are each associated with their own affordances, community norms, and patterns of use, Processing/p5 sketches across these languages share similarities. Based on case studies of building an implementation of Processing/p5 in two host languages, JavaScript and Lua, we propose a list of software decision-making guiding aspects that constitute Processing/p5, regardless of host language. We discuss this framework in the context of decisions in other exploratory and creative tools that demonstrate how each of the guiding aspects can be operationalized differently than in the case studies. The proposed list highlights opportunities for learning, research, and artistic practice through creation of new Processing/p5 libraries for creative coding and algorithmic art.
...
TL;DR: 本文为小型研究软件团队提供灾害规划与恢复的实用指南，强调利用机构支持并明确“完成”的标准。


<details>
  <summary>Details</summary>
Motivation: 由于研究计算系统在面对政府攻击、自然灾难等事件时表现出脆弱性，规划灾害应对至关重要。

Method: 以简短指南形式，提供面向非专业系统管理员的实用建议，并指出机构内部可提供帮助的资源。

Result: 给出了“完成”的定义，即一份具体可操作的规划目标清单，帮助团队知道需要实现什么。

Conclusion: 灾害规划应积极利用机构内的专业支持，而不是独自承担所有工作；明确最终目标有助于落实防灾措施。

中文摘要：2025年，美国政府对其自己的科学研究团队发起了一系列前所未有的攻击。一年后，GitHub的可用性首次跌破90%，而加拿大、法国、西班牙等地的野火迫使研究人员离开家园和实验室。这些事件和其他事件提醒我们，研究计算系统可能非常脆弱，而为灾害做规划是防止灾害的最有效方法之一。本文是针对小型研究软件团队的灾害规划与恢复的简短指南。这些提示假设你是在日常工作之外自己完成所有事情，并且你不是经验丰富的系统管理员。有些提示确实需要这类专业知识，但大多数研究机构都有研究计算小组、数据图书馆员以及环境健康与安全办公室，他们的全部工作就是帮助解决这些问题。本文告诉你“完成”是什么样子；他们通常可以提供这种帮助。

Original abstract: In 2025, the US government launched an unprecedented series of attacks on its own scientific research groups. A year later GitHub dropped below 90% availability for the first time, while wildfires in Canada, France, Spain, and elsewhere forced researchers from the homes and labs. These events and others have reminded us just how fragile research computing systems can be, and that planning for disasters is one of the most effective ways to prevent them.
...
### [28] [Standalone LLM and a Pre-specified Agentic Pipeline for Explaining ICU Mortality Predictions: a Feasibility Study on the eICU Demo Dataset](https://arxiv.org/abs/2608.26109)
...
### [29] [PICasso: An AI-Enabled Design Framework for Autonomous Optimization of Silicon Photonic Devices](https://arxiv.org/abs/2608.26113)
...
### [30] [CIFQA: A Deterministic Tool-Grounded Multi-Agent LLM Framework for Financial Query Answering](https://arxiv.org/abs/2608.26114)
...
### [32] [GROUND: Reducing Hallucinations in LLM-Based Enterprise Analytics Through Governed Semantic Definitions](https://arxiv.org/abs/2608.26157)
...
### [33] [Refusal Is Not Robustness: Auditing Confident Fabrication in Large Language Models on a Provably Uninformative Clinical Pain Speech Transcript](https://arxiv.org/abs/2608.26167)
...
### [34] [Knowledge Cards: Structured Knowledge for AI Systems](https://arxiv.org/abs/2608.26176)
*Liliana Ferreira*
...
### [35] [AI Revealed Preferences](https://arxiv.org/abs/2608.26178)
...
### [36] [Benchmarking AI Agents for Hardware Design Automation via MCP Tool Calling](https://arxiv.org/abs/2608.26199)
...
### [37] [Invocation-Level Reliability of Tool-Using Agents](https://arxiv.org/abs/2608.26189)
...
### [38] [Same Model, Different Harness: Different Coding-Agent Results](https://arxiv.org/abs/2608.26218)
*Sydney Lewis*
...
### [39] [Agent Mesh: Reliability Primitives for Non-Idempotent Agent Delegation - Identity Adequacy and Evidence Adequacy](https://arxiv.org/abs/2608.26225)
...
### [40] [6.5% of the Neuro-Symbolic Literature Can Be Reproduced from Its Published Artifacts, a Six-Stage Audit Framework and First Instantiation](https://arxiv.org/abs/2608.26236)
...
### [41] [Five Primitives for Governing Autonomous AI Agents at Runtime](https://arxiv.org/abs/2608.26696)
...
### [42] [Agentic AI for operating scientific instruments for nanoscale characterization](https://arxiv.org/abs/2608.26198)
...
### [45] [When Tool Outputs Become Commands: Separating Action Induction from Runtime Authorization in Tool-Augmented LLM Agents](https://arxiv.org/abs/2608.27146)
...
### [46] [LLM Agents for Time-Series: A Survey](https://arxiv.org/abs/2608.26226)
...
### [47] [The Reasoning Tax: Token Economics of LLM Reasoning Across Task Types and Deployment Contexts](https://arxiv.org/abs/2608.26235)
...
### [48] [SKILL.state: Scalable Long-Horizon Agent Skills](https://arxiv.org/abs/2608.26263)
...
### [49] [Approved Too Late: Verdict Staleness in LLM-Guarded Self-Adaptive Systems](https://arxiv.org/abs/2608.26306)
...
### [50] [FaithSieve: Fine-Grained Evaluation of Math Proofs with Faithful Formal Evidence](https://arxiv.org/abs/2608.26310)
...
### [51] [ProofEvolve: Neuro-Symbolic Evolution for Formal Automated Theorem Proving](https://arxiv.org/abs/2608.26334)
...
### [52] [Don't Overthink, Don't Underthink: Toward Adaptive Reasoning in Agentic AI](https://arxiv.org/abs/2608.26442)
...
### [53] [PILOT in the Loop: Live Self-Improvement for Long-Horizon Agents](https://arxiv.org/abs/2608.26530)
...
### [57] [Accelerating Scientific Research with Gemini in the Real-World](https://arxiv.org/abs/2608.26701)
...
### [74] [LAAF: A Layered Accountability Architecture Framework for LLM Applications](https://arxiv.org/abs/2608.27102)
...
### [75] [TransMeme: A Multi-Agent Framework for Cross-Cultural Meme Transcreation](https://arxiv.org/abs/2608.27127)
...
### [76] [GRAIN: Bridging Name and Narrative Shifts in Real-World Graph Reasoning through Invariance-Rewarded Agentic RL](https://arxiv.org/abs/2608.27142)
...
### [77] [Calibrated Enough to Know, Not Calibrated to Act: Fabricated Evidence Makes LLM Agents Commit to the Unknowable](https://arxiv.org/abs/2608.27167)
*Pranav Aggarwal*
...
### [78] [What Makes Good Agentic Data? An ACE Lens on Data Generation for LLM Agents](https://arxiv.org/abs/2608.27260)
...
### [79] [Naive Prompt Optimization: Rethinking the Need for Complex Prompt Search](https://arxiv.org/abs/2608.27266)
...
### [80] [LLMs Can Design Near-Optimal OR Algorithms](https://arxiv.org/abs/2608.27296)
*Jackie Baek*
...
### [81] [Verify Smarter, Evolve Further: Efficient Harness Evolution through Behavior-Aware Verification](https://arxiv.org/abs/2608.27311)
...
### [82] [Not All Eval-Awareness Is Equal: Capabilities Framing Predicts Compliance](https://arxiv.org/abs/2608.27340)
...
### [83] [WikiSkill: Compiling Agent Experience into Persistent Knowledge for Skill Evolution](https://arxiv.org/abs/2608.27454)
...
- [Same Model, Different Harness: Different Coding-Agent Results](https://arxiv.org/abs/2608.26218) — 相关度 0.96：通过对照实验证明相同模型在不同harness下代码agent结果显著不同，强调评测需将模型与harness视为整体，对coding agent评测方法论有直接影响。
- [SWE-Prime: Fewer Trajectories, Better Performance](https://arxiv.org/abs/2608.27449) — 相关度 0.95：针对SWE-bench轨迹的多粒度数据选择方法，仅用10%数据超越全量SFT，显著提升代码agent训练效率，直接相关。
- [From Static to Dynamic: Benchmarking Real-World Code Review with MCR-Bench](https://arxiv.org/abs/2608.27442) — 相关度 0.92：首个面向多轮代码评审的缺陷状态感知基准，含细粒度缺陷元数据和动态状态标注，对代码审查agent评测有直接价值。
- [DeepRepro: State-Aware Subplanning for Paper-to-Code Reproduction in Evolving Repositories](https://arxiv.org/abs/2608.26557) — 相关度 0.90：提出基于执行状态感知子规划的长程仓库构建框架，显著优于代码 agent 基线，直接相关。
- [AgentDV: Closed-Loop Agentic AI for Hardware Design Verification](https://arxiv.org/abs/2608.27148) — 相关度 0.85：面向RTL验证的闭环agent框架，结合仿真、覆盖率反馈与迭代修复，其可运行性过滤和覆盖率引导迭代可直接迁移到代码agent的测试生成与验证流程。
- [Beyond Execution: Auditing Experimental Fidelity in LLM-Driven Scientific Research](https://arxiv.org/abs/2608.26753) — 相关度 0.85：提出参考锚定的实验保真度审计框架，检测 LLM 科研 agent 的方法幻觉与证据不足，可迁移到 agent 验证评测。
- [Cost-Utility Alignment in LLM Agent Trajectories:Profiling,Attribution,Diagnosis,Adaptation,and Evaluation](https://arxiv.org/abs/2608.26195) — 相关度 0.85：提出轨迹级成本-效用对齐框架（剖析/归因/诊断/适配/评测），可直接用于 coding agent 的资源感知设计。
- [FaultLens: Learning Compact Behavioral Test Suites for Generated Operational Programs](https://arxiv.org/abs/2608.26746) — 相关度 0.85：学习紧凑行为测试套件并保留证据链，以极小预算覆盖大部分可杀死故障，适用于生成代码的验证。
- [Harness Engineering for Predictable Agentic Systems: An Empirical Study of Deterministic Execution Constraints](https://arxiv.org/abs/2608.26197) — 相关度 0.85：通过确定性执行约束（有限状态控制、结构化规划）提升 agent 可复现性与成功率，对 agent 可靠性工程有直接迁移价值。
- [Benchmarking AI Agents for Hardware Design Automation via MCP Tool Calling](https://arxiv.org/abs/2608.26199) — 相关度 0.80：构建MCP工具调用下的硬件设计自动化agent基准，系统评估系统提示、工具描述、上下文与多agent架构对可靠性的影响，对工具增强代码agent有明确参考价值。
- [Spec2Vision: Contract-Guided Delivery of AI-Generated Computer Vision Pipelines](https://arxiv.org/abs/2608.26400) — 相关度 0.80：提出契约引导的分阶段生成-筛选-测试-修复框架，确保生成管线满足任务契约，可迁移到代码 agent。
- [The Thousand-Graph Hypothesis: A Testable Hypothesis of Task-Conditioned Relation Materialization in Repository-Level Code Reasoning](https://arxiv.org/abs/2608.26602) — 相关度 0.80：提出实体级外部接口与任务条件关系物化，用于仓库级代码推理，可迁移到代码 agent 检索与规划。
- [When Tool Outputs Become Commands: Separating Action Induction from Runtime Authorization in Tool-Augmented LLM Agents](https://arxiv.org/abs/2608.27146) — 相关度 0.78：针对工具输出诱导动作与执行授权分离的安全机制，在AgentDojo上显著降低攻击成功率，对代码agent处理不可信工具输出有直接防护价值。
- [Agent Mesh: Reliability Primitives for Non-Idempotent Agent Delegation - Identity Adequacy and Evidence Adequacy](https://arxiv.org/abs/2608.26225) — 相关度 0.75：基于生产平台147个故障的分析提出非幂等agent委托的可靠性原语，包含身份充分性与证据充分性，可迁移到代码agent的重试、恢复与电路断开机制设计。
- [Agentic AI Containment Architecture for Security Hardening](https://arxiv.org/abs/2608.26108) — 相关度 0.75：多agent安全约束架构与验证模型，可迁移到coding agent的安全治理与权限控制。
- [STILL: Recovering Lowered STL Semantics for LLM-assisted C++ Decompilation](https://arxiv.org/abs/2608.26408) — 相关度 0.75：为反编译/代码理解提供 STL 语义提示接口，提升 LLM 修复代码的可执行性，对代码 agent 有迁移价值。
- [An Empirical Evaluation of Using Large Language Models for Automated Model-Based Test Generation](https://arxiv.org/abs/2608.27094) — 相关度 0.70：系统评估多种 LLM 在模型驱动测试生成中的能力，为 LLM 测试 agent 的路径优化提供实证。
- [Four Ways to Forge a Bundle My Own Verifier Calls Clean: Refusal-Site Mutation Testing of an Evidence-Bundle Verifier](https://arxiv.org/abs/2608.26183) — 相关度 0.70：提出 refusal-site 变异测试量化验证器的空验证通过缺陷，可迁移到 agent 行为验证与测试。
- [Investigating Software Aging in LLM-Generated Software Systems across Generation-and-Execution Environments](https://arxiv.org/abs/2608.26391) — 相关度 0.70：系统评估 LLM 生成软件在持续负载下的老化症状，为 LLM 代码部署可靠性与性能评测提供方法。
- [Mutation Testing for Reproducibility Safeguards in Machine Learning Research Software: An Empirical Study](https://arxiv.org/abs/2608.27100) — 相关度 0.70：提出面向 ML 研究仓库的可复现性变异测试，可用于评估 agent/工作流对实验关键选择的保护能力。
- [When Review Alone No Longer Scales: Layered Supervision in AI-Assisted Software Engineering](https://arxiv.org/abs/2608.26316) — 相关度 0.70：揭示 AI 辅助开发中分层监督（预防式/可执行/人工）的演化，对 agent 工作流防护设计有参考价值。
- [Fairness Invariants: A Relational Approach to Explaining and Mitigating Fairness Bugs](https://arxiv.org/abs/2608.26209) — 相关度 0.60：用关系不变式合成定位公平性缺陷，方法可迁移到 agent 行为的反事实测试与验证。
- [Five Primitives for Governing Autonomous AI Agents at Runtime](https://arxiv.org/abs/2608.26696) — 相关度 0.60：提出运行时治理自主agent的五个原语（发现、身份、治理、证明、供应链），其策略强制与账本审计思路可迁移到代码agent的运行时安全与合规设计。
- [Persona-Execution Separation: An Architecture Pattern for Evolving LLM Agents under Execution Audit](https://arxiv.org/abs/2608.27427) — 相关度 0.60：提出人格-执行分离的LLM agent架构模式，通过受控契约桥接实现可审计执行与自由演化，其审计锚点与验证机制可迁移到代码agent的可靠性和可审计设计中。
- [A Contract-Centered Architecture for Scalable and Manageable Agentic Runtimes](https://arxiv.org/abs/2608.27086) — 相关度 0.55：提出以契约为中心的agentic运行时架构与能力-容量可分性假设，虽无实现，但责任对象划分和验证协议对可扩展代码agent平台的设计有参考价值。
