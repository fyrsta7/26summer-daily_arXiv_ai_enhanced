...
### [32] [ESBMC: A Survey of Its Evolution, Integration, and Future Directions in Formal Software Verification](http://arxiv.org/abs/2605.26169v2)
...
Selection reason: 综述ESBMC形式验证工具与LLM及自主agent验证内核的集成，对验证型agent和神经符号验证有清晰参考价值。
...
### [33] [Names Are All You Need: Effective and Safe Regression Test Selection for Python](http://arxiv.org/abs/2605.25356v1)
...
Selection reason: 提出基于细粒度依赖图的Python回归测试选择方法，安全且高效，对测试优化和精准分析有方法迁移价值。
...
### [34] [Leveraging Language Models for Log Statement Generation in Multilingual Scenarios: How Far Are We?](http://arxiv.org/abs/2605.25374v1)
...
Selection reason: 评估多语言环境下LLM日志生成，提出多语言基准，对代码生成与软件维护agent有迁移价值。
...
### [35] [A Universal Cliff and a Design Fingerprint: Cross-Section Defect Detection Under LLM Orchestration](http://arxiv.org/abs/2605.26174v1)
*Hiroki Fukui*
...
Selection reason: 揭示多agent编排下的跨章节缺陷检测悬崖结构性问题，对代码agent多agent协作可靠性有重要启发。
...
### [36] [Temporal Modeling of Change History for Black-Box Test Suite Minimization](http://arxiv.org/abs/2605.25441v1)
...
Selection reason: 提出时序风险驱动的测试套件最小化方法，利用版本历史与调用图，可迁移到测试优化agent。
...
### [37] [RepoMirage: Probing Repository Context Reasoning in Code Agents with Perturbations](http://arxiv.org/abs/2605.26177v1)
...
Selection reason: 提出仓库上下文推理评测套件与扰动诊断，直接评估代码agent能力并给出结构感知改进方案。
...
### [38] [A Tertiary Review of Large Language Model-Based Code Generating Tasks: Trends, Challenges, and Future Directions](http://arxiv.org/abs/2605.25536v1)
...
Selection reason: 三级综述系统梳理LLM代码生成任务的趋势与挑战，为评测与研究方向提供参考。
...
### [39] [SetupX: Can LLM Agents Learn from Past Failures in Functionality-Correct Code Repository Setup?](http://arxiv.org/abs/2605.26186v2)
...
Selection reason: 提出基于经验学习的仓库配置agent框架，解决跨仓库迁移与多步试错，直接相关代码agent。
...
### [40] [Meta-Engineering Harnesses for AI-Native Software Production: A Contract-Driven Adversarial Verification Architecture with Early Deployment Report](http://arxiv.org/abs/2605.25665v1)
...
Selection reason: 提出AI原生软件生产的元工程化框架，含合同驱动验证与失败仲裁，可迁移到代码agent工作流。
...
### [41] [FuzzPilot: Plateau-Triggered Recipe Validation for Structured Text Fuzzing](http://arxiv.org/abs/2605.26539v1)
*Zhiyi Yao*
...
Selection reason: 提出AFL++的库平台触发验证控制器，将LLM用于fuzzing配方生成，方法可迁移到程序优化。
...
### [42] [How Agentic AI Coding Assistants Become the Attacker's Shell](http://arxiv.org/abs/2605.25871v1)
...
Selection reason: 系统分析agentic编码助手的提示注入攻击面与防御局限，对代码agent安全性评估有直接价值。
...
### [43] [CelerLog: Fast Log Parsing via Dynamic Routing](http://arxiv.org/abs/2605.26005v1)
...
Selection reason: 提出动态路由混合统计与LLM的日志解析方法，显著提速降本，可迁移到日志分析工具。
...
### [44] [Trustworthy Software Project Generation : a Case Study with an Interactive Theorem Prover](http://arxiv.org/abs/2605.26017v1)
...
Selection reason: 用交互式定理证明器实现全自动可信代码项目生成，结合反馈修复，对代码生成与验证agent有重要价值。
...
### [45] [Workflow Closure Is Not Scientific Closure in Auto-Research Systems](http://arxiv.org/abs/2605.26200v1)
...
Selection reason: 讨论自动研究系统的工作流闭包与科学闭包，其目标崩溃与验证机制分析可类比agent评测设计。
...
### [46] [Beyond Summaries: Structure-Aware Labeling of Code Changes with Large Language Models](http://arxiv.org/abs/2605.26100v1)
...
Selection reason: 提出结构感知的代码变更标签流水线，用于代码审查自动化，可迁移到agent的补丁理解。
...
### [47] [Acting on the Unseen: Communication-Free Collaborative Filtering for Decentralized Multi-Robot Task Allocation](http://arxiv.org/abs/2605.25584v1)
...
### [48] [When Search Becomes Memory: Turning Robot Design Trials into Transferable Skills](http://arxiv.org/abs/2605.25832v1)
...
### [49] [Credit-assigned Policy Gradient for Early Stage Retrieval in Two-stage Ranking](http://arxiv.org/abs/2605.26385v1)
...
### [50] [BC Protocol: Structured Dual-Expert Dialogue for Eliciting High-Quality Chain-of-Thought Post-Training Data](http://arxiv.org/abs/2605.25549v1)
*Bo Zou,Chao Xu*
...
### [51] [PennySynth: RAG-Driven Data Synthesis for Automated Quantum Code Generation](http://arxiv.org/abs/2605.25572v1)
...
### [52] [AutoSG: LLM-Driven Solver Generation Solely from Task Prompts for Expensive Optimization](http://arxiv.org/abs/2605.25658v1)
...
### [53] [Simulating Human Memory with Language Models](http://arxiv.org/abs/2605.25680v1)
...
### [54] [Adaptive Graph Refinement and Label Propagation with LLMs for Cost-Effective Entity Resolution](http://arxiv.org/abs/2605.25814v1)
...
### [55] [Clarify, Abstain or Answer? Strategising in Conversation with Belief-Augmented Generation](http://arxiv.org/abs/2605.25831v1)
...
### [56] [Can LLMs Time Travel? Enhancing Temporal Consistency in Legal Agentic Search through Reinforcement Learning](http://arxiv.org/abs/2605.25920v1)
...
### [57] [SafeCtrl-RL: Inference-Time Adaptive Behaviour Control for LLM Dialogue via RL-Driven Prompt Optimisation](http://arxiv.org/abs/2605.25984v1)
...
### [58] [AI-Assisted Systematization for Evaluating GenAI Systems](http://arxiv.org/abs/2605.26001v1)
...
### [59] [When Gradients Collide: Failure Modes of Multi-Objective Prompt Optimization for LLM Judges](http://arxiv.org/abs/2605.26046v2)
...
Selection reason: 分析多目标文本梯度优化的失败模式，对基于LLM的判断器优化有参考价值。
...
### [60] [Do Language Models Need Sleep? Offline Recurrence for Improved Online Inference](http://arxiv.org/abs/2605.26099v3)
...
### [61] [A Token/KV-Cache Communication Media Selection and Resource Allocation Strategy for Multi-Agent Collaboration](http://arxiv.org/abs/2605.25422v1)
...
### [62] [AutoDFT: A Closed-Loop Multi-Agent Framework for Autonomous DFT Calculations](http://arxiv.org/abs/2605.26179v2)
...
### [63] [Keep the Proof State Live: Snapshotting for Efficient Tactic Search in Lean 4](http://arxiv.org/abs/2605.25556v2)
...
### [64] [KYA: A Framework-Agnostic Trust Layer for Autonomous Systems with Verifiable Provenance and Hierarchical Policy Composition](http://arxiv.org/abs/2605.25376v2)
*Kolawole Quadri*
...
Selection reason: 为自治agent设计信任与治理层，其策略组合与验证机制可迁移到代码agent的可信性保障。
...
### [65] [Evo-Attacker: Memory-Augmented Reinforcement Learning for Long-Horizon Tool Attacks on LLM-MAS](http://arxiv.org/abs/2605.25389v1)
...
### [66] [CyberEvolver: Structured Self-Evolution for Cybersecurity Agents On the Fly](http://arxiv.org/abs/2605.26195v2)
...
### [67] [Bridging the 2D-3D Gap: A Hierarchical Semantic-Geometric Map for Vision Language Navigation](http://arxiv.org/abs/2606.00095v1)
...
### [68] [Diversity Over Frequency: Rethinking Tool Use in Visual Chain-of-Thought Agents](http://arxiv.org/abs/2606.00096v2)
...
### [69] [VisualNeedle: Benchmarking Active Visual Search in Information-Dense Scenes](http://arxiv.org/abs/2605.26380v1)
...
### [70] [CausalFlow: Causal Attribution and Counterfactual Repair for LLM Agent Failures](http://arxiv.org/abs/2605.25338v1)
...
### [71] [SeqRoute: Global Budget-Aware Sequential LLM Routing via Offline Reinforcement Learning](http://arxiv.org/abs/2605.25424v1)
...
### [72] [Extreme Region Policy Distillation](http://arxiv.org/abs/2605.25582v2)
...
### [73] [Step-TP: A Grounded, Step-Level Dataset with Chain-of-Thought Reasoning for LLM-Guided Tensor Program Optimization](http://arxiv.org/abs/2605.25954v1)
...
### [74] [Multi-Agent Coordination Adaptation via Structure-Guided Orchestration](http://arxiv.org/abs/2605.25746v1)
...
### [75] [AgentSociety: Incentivizing Agentic Social Intelligence](http://arxiv.org/abs/2605.26203v1)
...
### [76] [Decoupled Delay Compensation: Enhancing Pre-trained MARL Policies via Learned Dynamics Filtering](http://arxiv.org/abs/2605.26286v1)
