...
- [Optimas: An Intelligent Analytics-Informed Generative AI Framework for Performance Optimization](http://arxiv.org/abs/2604.23892v1) — 相关度 0.98：多agent性能优化框架，将诊断转化为代码变换，直接符合SemOpt核心。
- [AgentEval: DAG-Structured Step-Level Evaluation for Agentic Workflows with Error Propagation Tracking](http://arxiv.org/abs/2604.23581v1) — 相关度 0.96：DAG结构步骤级评估框架，追踪错误传播，对agent工作流评测有直接价值。
- [ClawMark: A Living-World Benchmark for Multi-Turn, Multi-Day, Multimodal Coworker Agents](http://arxiv.org/abs/2604.23781v2) — 相关度 0.95：多天多轮multimodal coworker agent基准，评估状态化环境下的agent适应性，有直接价值。
- [Uncovering Business Logic Bugs via Semantics-Driven Unit Test Generation](http://arxiv.org/abs/2604.23509v1) — 相关度 0.92：语义驱动的单元测试生成，利用LLM发现业务逻辑错误，直接相关于测试生成。
- [KISS Sorcar: A Stupidly-Simple General-Purpose and Software Engineering AI Assistant](http://arxiv.org/abs/2604.23822v2) — 相关度 0.90：开源的软件工程AI agent框架，设计了层级agent和长期任务处理机制。
- [Uncertainty Propagation in LLM-Based Systems](http://arxiv.org/abs/2604.23505v1) — 相关度 0.85：系统级不确定性传播框架，可迁移到代码agent的可靠性设计。
- [Automated Classification of Human Code Review Comments with Large Language Models](http://arxiv.org/abs/2604.23667v1) — 相关度 0.78：用LLM分类代码审查评论，对审查agent的反馈质量分析有参考价值。
- [Learning Selective LLM Autonomy from Copilot Feedback in Enterprise Customer Support Workflows](http://arxiv.org/abs/2604.23855v1) — 相关度 0.72：从copilot反馈学习选择性自动化，abstention机制可迁移到代码agent的可靠性设计。
- [Query2Diagram: Answering Developer Queries with UML Diagrams](http://arxiv.org/abs/2604.23816v2) — 相关度 0.70：查询驱动的UML图生成，用LLM理解代码，对代码文档和检索有参考价值。
