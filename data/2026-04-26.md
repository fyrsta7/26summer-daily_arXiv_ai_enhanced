...
### [1] [Agentic Adversarial Rewriting Exposes Architectural Vulnerabilities in Black-Box NLP Pipelines](http://arxiv.org/abs/2604.23483v1)
...
### [2] [MetaGAI: A Large-Scale and High-Quality Benchmark for Generative AI Model and Data Card Generation](http://arxiv.org/abs/2604.23539v1)
...
### [3] [When AI reviews science: Can we trust the referee?](http://arxiv.org/abs/2604.23593v1)
...
### [4] [Thinking Like a Clinician: A Cognitive AI Agent for Clinical Diagnosis via Panoramic Profiling and Adversarial Debate](http://arxiv.org/abs/2604.23605v1)
...
### [5] [Tandem: Riding Together with Large and Small Language Models for Efficient Reasoning](http://arxiv.org/abs/2604.23623v1)
...
### [6] [Structural Enforcement of Goal Integrity in AI Agents via Separation-of-Powers Architecture](http://arxiv.org/abs/2604.23646v1)
*Rong Xiang*
...
### [7] [Vibe Medicine: Redefining Biomedical Research Through Human-AI Co-Work](http://arxiv.org/abs/2604.23674v1)
...
### [8] [ClawTrace: Cost-Aware Tracing for LLM Agent Skill Distillation](http://arxiv.org/abs/2604.23853v2)
...
### [9] [ZenBrain: A Neuroscience-Inspired 7-Layer Memory Architecture for Autonomous AI Systems](http://arxiv.org/abs/2604.23878v2)
*Alexander Bering*
...
### [10] [MarketBench: Evaluating AI Agents as Market Participants](http://arxiv.org/abs/2604.23897v1)
...
### [11] [LLM-Augmented Traffic Signal Control with LSTM-Based Traffic State Prediction and Safety-Constrained Decision Support](http://arxiv.org/abs/2604.23902v1)
*Jiazhao Shi*
...
### [12] [Uncertainty Propagation in LLM-Based Systems](http://arxiv.org/abs/2604.23505v1)
...
Selection reason: 系统级不确定性传播框架，可迁移到代码agent的可靠性设计。
...
### [13] [Uncovering Business Logic Bugs via Semantics-Driven Unit Test Generation](http://arxiv.org/abs/2604.23509v1)
...
Selection reason: 语义驱动的单元测试生成，利用LLM发现业务逻辑错误，直接相关于测试生成。
...
### [14] [AgentEval: DAG-Structured Step-Level Evaluation for Agentic Workflows with Error Propagation Tracking](http://arxiv.org/abs/2604.23581v1)
...
Selection reason: DAG结构步骤级评估框架，追踪错误传播，对agent工作流评测有直接价值。
...
### [15] [Automated Classification of Human Code Review Comments with Large Language Models](http://arxiv.org/abs/2604.23667v1)
...
Selection reason: 用LLM分类代码审查评论，对审查agent的反馈质量分析有参考价值。
...
### [16] [Query2Diagram: Answering Developer Queries with UML Diagrams](http://arxiv.org/abs/2604.23816v2)
...
Selection reason: 查询驱动的UML图生成，用LLM理解代码，对代码文档和检索有参考价值。
...
### [17] [KISS Sorcar: A Stupidly-Simple General-Purpose and Software Engineering AI Assistant](http://arxiv.org/abs/2604.23822v2)
*Koushik Sen*
...
Selection reason: 开源的软件工程AI agent框架，设计了层级agent和长期任务处理机制。
...
### [18] [OptProver: Bridging Olympiad and Optimization through Continual Training in Formal Theorem Proving](http://arxiv.org/abs/2604.23712v2)
...
### [19] [SFT-then-RL Outperforms Mixed-Policy Methods for LLM Reasoning](http://arxiv.org/abs/2604.23747v1)
...
### [20] [The Override Gap: A Magnitude Account of Knowledge Conflict Failure in Hypernetwork-Based Instant LLM Adaptation](http://arxiv.org/abs/2604.23750v2)
...
### [21] [Optimas: An Intelligent Analytics-Informed Generative AI Framework for Performance Optimization](http://arxiv.org/abs/2604.23892v1)
...
Selection reason: 多agent性能优化框架，将诊断转化为代码变换，直接符合SemOpt核心。
...
### [22] [DLM: Unified Decision Language Models for Offline Multi-Agent Sequential Decision Making](http://arxiv.org/abs/2604.23557v1)
...
### [23] [MTRouter: Cost-Aware Multi-Turn LLM Routing with History-Model Joint Embeddings](http://arxiv.org/abs/2604.23530v1)
...
### [24] [Agri-CPJ: A Training-Free Explainable Framework for Agricultural Pest Diagnosis Using Caption-Prompt-Judge and LLM-as-a-Judge](http://arxiv.org/abs/2604.23701v1)
...
### [25] [How LLMs Fail and Generalize in RTL Coding for Hardware Design?](http://arxiv.org/abs/2606.19347v1)
...
### [26] [Learning Selective LLM Autonomy from Copilot Feedback in Enterprise Customer Support Workflows](http://arxiv.org/abs/2604.23855v1)
...
Selection reason: 从copilot反馈学习选择性自动化，abstention机制可迁移到代码agent的可靠性设计。
...
### [27] [Adversarial Flow Matching for Imperceptible Attacks on End-to-End Autonomous Driving](http://arxiv.org/abs/2605.00880v1)
...
### [28] [RaV-IDP: A Reconstruction-as-Validation Framework for Faithful Intelligent Document Processing](http://arxiv.org/abs/2604.23644v1)
*Pritesh Jha*
...
### [29] [ClawMark: A Living-World Benchmark for Multi-Turn, Multi-Day, Multimodal Coworker Agents](http://arxiv.org/abs/2604.23781v2)
...
Selection reason: 多天多轮multimodal coworker agent基准，评估状态化环境下的agent适应性，有直接价值。
...
### [30] [Infrastructure for the Agentic Web: Gap Analysis and Architecture from the Agentverse Platform](http://arxiv.org/abs/2606.20570v1)
...
### [31] [PhysCodeBench: Benchmarking Physics-Aware Symbolic Simulation of 3D Scenes via Self-Corrective Multi-Agent Refinement](http://arxiv.org/abs/2604.23580v1)
...
### [32] [The Interlocutor Effect: Why LLMs Leak More Personal Data to Agents Than Humans](http://arxiv.org/abs/2606.09844v1)
...
### [33] [Proof of Execution: Runtime Verification for Governed AI Agent Actions](http://arxiv.org/abs/2607.05397v1)
...
### [34] [Evaluation of Prompt Injection Defenses in Large Language Models](http://arxiv.org/abs/2604.23887v2)
...
### [35] [GLIER: Generative Legal Inference and Evidence Ranking for Legal Case Retrieval](http://arxiv.org/abs/2604.23779v1)
...
### [36] [S2G-RAG: Structured Sufficiency and Gap Judging for Iterative Retrieval-Augmented QA](http://arxiv.org/abs/2604.23783v1)
