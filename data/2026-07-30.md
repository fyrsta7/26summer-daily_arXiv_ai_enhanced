...
### [2] [Kernel Forge: An Agent Harness for LLM-based Generation and Optimization of CUDA Kernels](https://arxiv.org/abs/2607.24762)
...
### [4] [RSMeM: Knowledge-Enhanced Memory Evolution for Remote Sensing Agents with Systematic Evaluation](https://arxiv.org/abs/2607.24772)
...
### [6] [Explanation-Bound Tool Execution for AI Agents: Server-Verified Action Claims Without Trusting Model Rationales](https://arxiv.org/abs/2607.25364)
...
Selection reason: 提出工具执行声明校验中介层，将模型理由转化为服务端可验证的动作声明，可迁移到代码agent的工具调用安全与审计。
...
### [7] [CogEEGAgent: Toward Autonomous Cognitive EEG Analysis with Grounded Execution and Selection-Aware Verification](https://arxiv.org/abs/2607.25045)
...
### [8] [Addressable Recall Compaction for Long Context-Window Control in AI Agents](https://arxiv.org/abs/2607.25066)
...
### [9] [How Often Should a Recommender Call an LLM? Value-Weighted Routing, Monitoring, and Seasonal Robustness](https://arxiv.org/abs/2607.25068)
*Bhavtosh Rath*
...
### [10] [Towards an Agent Operating System - Lessons from Classical and Cloud OS](https://arxiv.org/abs/2607.25076)
...
### [11] [PLATO: Pointer Learner for Agent and Task Openness](https://arxiv.org/abs/2607.25082)
...
### [12] [Matryoshka Agent: Unfolding Sub-Agents for Long-Horizon Machine Learning Engineering](https://arxiv.org/abs/2607.25090)
...
### [13] [Towards Robust Reinforcement Learning for Small-Scale Language Model Agents](https://arxiv.org/abs/2607.25091)
...
### [15] [When Do Agent Loops Mistake Stagnation for Progress? Self-Evaluation Bias and Externally Grounded Verification in Long-Running Autonomous LLM Agent Loops](https://arxiv.org/abs/2607.25152)
...
### [16] [The User Asks, Platforms Compete: How Agentic Recommendation Markets Take Shape](https://arxiv.org/abs/2607.25253)
...
### [17] [ContractHIL-HLS: Contract-Aligned Multi-Agent Workflow with Hardware-in-the-Loop Feedback for HLS Design](https://arxiv.org/abs/2607.25283)
...
### [18] [Cardiologent: Multi-Agent Clinical Decision Support for Patient-Level Arrhythmia Assessment, Urgency, and Management](https://arxiv.org/abs/2607.25340)
...
### [19] [ODYSSE: Episode-wise Policy Optimization for Personalized Agentic Reasoning](https://arxiv.org/abs/2607.25369)
...
### [20] [Cyber-Capable AI Agents: Vulnerabilities, Evaluation Containment, and Defensive Response](https://arxiv.org/abs/2607.25379)
*Abu Bakar Siddik*
...
### [21] [HANDBOOK.md: A Benchmark for Long-Context Agentic Instruction Following](https://arxiv.org/abs/2607.25398)
...
### [22] [COVENANT: Natural-Language Workflow Compilation for Aligned Agent Execution](https://arxiv.org/abs/2607.25400)
...
### [23] [Context Assembly as the Controlled Variable: A Control-Theoretic View of Harness Policies for Frozen LLM Agents](https://arxiv.org/abs/2607.25408)
*Debjyoti Paul*
...
### [24] [A Control System, a Dataset, and a Recipe for Making Frozen LLM Agents Learn a Domain](https://arxiv.org/abs/2607.25415)
*Debjyoti Paul*
...
### [25] [Toward an Organizational Science of Multi-Agent LLM Systems: Decoupling Who, How, and Which Algorithm](https://arxiv.org/abs/2607.25446)
...
### [26] [Finding Optimal Cost-Bounded Plan Reductions: Refined Model](https://arxiv.org/abs/2607.25484)
...
### [27] [PatientAgentBench: A Benchmark Framework for Evaluating Patient-Facing Health AI Agents](https://arxiv.org/abs/2607.25485)
...
### [28] [CoTinyVLA: Chain-of-Thought Distillation for a Sub-Billion-Parameter Vision-Language-Action Model](https://arxiv.org/abs/2607.25487)
...
### [29] [Entangled by Design: Spurious Intra-Variable Signal Routing in Tabular In-Context Learners](https://arxiv.org/abs/2607.25532)
...
### [30] [Distilling Temporal Search and Reasoning: Evolving LLMs for Future Prediction via Harness-Assisted Efficient Data Synthesis](https://arxiv.org/abs/2607.25554)
...
### [31] [Agent Skills Matter: Inferring Proprietary Skills from Execution Trajectories](https://arxiv.org/abs/2607.25560)
...
### [32] [OrchBench: Evaluating Multi-Agent Orchestration Plans in Isolation via Deterministic Simulation](https://arxiv.org/abs/2607.25656)
...
### [33] [DecoEvo: Score-Decoupled Co-Evolution of Solver and Rubric-Generator Skills in Text Space](https://arxiv.org/abs/2607.25675)
...
### [34] [Speculate While You Reason: Teaching Agents to Predict Their Next Tool Call via Joint Agent-Speculator RL](https://arxiv.org/abs/2607.25816)
...
### [35] [HiSkill: Empowering LLM Agents with Hierarchical Skill Graphs](https://arxiv.org/abs/2607.25853)
...
### [36] [Runtime Uncertainty Monitoring for LLM-Based Multi-Agent Systems Using Bayesian Networks](https://arxiv.org/abs/2607.25877)
...
### [37] [Distributing Security Controls Through Harness Engineering](https://arxiv.org/abs/2607.25890)
*William Robert Gore*
...
### [38] [Messier: A High-Resolution Corpus for Cross-Benchmark Agent Evaluation](https://arxiv.org/abs/2607.25891)
...
### [39] [Interactive Reward Agent: GUI Task Evaluation via Environment-State Verification](https://arxiv.org/abs/2607.25904)
...
### [41] [Large Language Model for Operations Research Formulation Selection in Multi-Warehouse Inventory Allocation](https://arxiv.org/abs/2607.25956)
...
### [42] [Desktop-Delta Bench: Do Computer-Use Models Understand Desktop GUI Transitions?](https://arxiv.org/abs/2607.26041)
...
### [43] [Beyond "What to Retrieve": Uncertainty in Retrieval-Augmented Code Generation](https://arxiv.org/abs/2607.24884)
...
Selection reason: 对仓库级代码生成中的检索不确定性建模与过滤修复，可迁移到coding agent的RAG、验证与修复流程。
...
### [44] [Characterizing Structural Testability in JavaScript: An Empirical Study](https://arxiv.org/abs/2607.24965)
...
Selection reason: 大规模JavaScript结构可测试性实证，产出测试性度量框架，对自动化测试生成和测试感知重构有参考价值。
...
### [45] [Authoring Agent Skills: A Software-Engineering Approach](https://arxiv.org/abs/2607.25032)
*Giuseppe Destefanis*
...
Selection reason: 将Agent Skill视为软件工件并给出工程化编写与评估原则，直接适用于coding agent的技能开发与选择。
...
### [46] [Learning from 53.6K Real-World Developer Edits of AI-Generated Code](https://arxiv.org/abs/2607.25130)
...
Selection reason: 提供53.6K真实IDE内AI代码编辑轨迹的数据集，可用于训练和评估代码编辑/修复agent。
...
### [47] [Specification-Driven DevOps for Multi-Service Environments](https://arxiv.org/abs/2607.25141)
...
Selection reason: 用LLM生成多服务Docker配置并区分功能正确性与部署意图保真度，对部署型工程agent有借鉴意义。
...
### [48] [Specula: Scaling formal specifications for autonomous model checking of system code](https://arxiv.org/abs/2607.25333)
...
Selection reason: 自主生成TLA+形式化规范并进行模型检查的agent系统，大幅提升代码验证与深度bug发现能力。
...
### [49] [CodeNib: A Multi-View Data System for Serving Repository Context to Coding Agents](https://arxiv.org/abs/2607.25431)
...
Selection reason: 为coding agent提供多视图仓库上下文服务的系统，降低token开销并加速检索与导航。
...
### [50] [Input Relation Prompting for Metamorphic Testing on Query-Based Systems](https://arxiv.org/abs/2607.25603)
...
Selection reason: 通过输入关系提示自动生成蜕变关系以辅助蜕变测试，可迁移到自动化测试生成和oracle缓解。
...
### [51] [SkillGate: Cost Efficient Runtime Malicious Skill File Detection in Coding Agents](https://arxiv.org/abs/2607.25619)
...
Selection reason: 针对coding agent恶意skill文件的检测网关，低成本防护供应链攻击，直接增强agent安全性。
...
### [52] [An Empirical Study of Model Context Protocol Applications](https://arxiv.org/abs/2607.25635)
...
Selection reason: 大规模MCP应用实证，揭示工具集成与人工监督配置现状，对工程化agent设计和安全治理有参考。
...
### [53] [KQFuzz: Knowledge-Guided Fuzzing for Quantum Libraries via Large Language Models](https://arxiv.org/abs/2607.25647)
...
Selection reason: 知识引导的LLM模糊测试框架，结合代码库知识生成量子程序测试，显著提升覆盖率并发现实际bug。
...
### [54] [Delta Debugging for Cyber-Physical Systems with Flaky Test Executions](https://arxiv.org/abs/2607.25695)
...
Selection reason: 针对flaky仿真的delta debugging算法，可迁移到失败复现与最小化输入隔离，适用于agent验证场景。
...
Selection reason: 离线到在线RL的编译器调优框架，利用程序条件策略和GRPO提升自动性能优化效果，直接相关SemOpt。
...
### [56] [Rethinking Training Data for Generating Code Review Comments](https://arxiv.org/abs/2607.25851)
...
Selection reason: 分析代码评审评论生成中的错位训练数据并给出类型学和过滤建议，对自动化代码评审agent有直接帮助。
...
### [57] [How Do LLMs Read Bug Reports? An Empirical Study of Attention in LLMs for Automated Program Repair](https://arxiv.org/abs/2607.25873)
...
Selection reason: 首次实证分析LLM程序修复中的注意力分配，解释修复成败差异，可直接指导APR上下文与提示设计。
...
### [58] [RSIBench-Data: Benchmarking Data-Centric Research for Recursive Self-Improvement](https://arxiv.org/abs/2607.25886)
...
Selection reason: 构建数据驱动LLM agent递归自我改进的受控评测基准，覆盖软件工程等任务，可迁移到代码agent的反馈迭代与策略优化评估。
...
### [59] [RepoReasoner: Evaluating Repository-Level Code Reasoning Ability of Long-Context Language Models](https://arxiv.org/abs/2607.25996)
...
Selection reason: 新增仓库级代码推理基准，评估跨文件输出预测与调用链理解，直接支撑长上下文代码agent评测。
