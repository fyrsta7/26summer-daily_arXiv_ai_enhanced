...
### [3] [AI Tool Discovery at Scale: All You Need is DNS](https://arxiv.org/abs/2607.18242)
...
### [4] [SAAG: Structured Agent Assessment and Grounding](https://arxiv.org/abs/2607.18245)
...
### [5] [MILP-Evo: Closed-Loop Fully Automatic Design of MILP Solvers](https://arxiv.org/abs/2607.18252)
...
### [6] [Cross-Dialect Generalization Without Retraining: Benchmarks and Evaluation of Schema-Derived Constrained Decoding for MLIR](https://arxiv.org/abs/2607.18254)
*Plawan Kumar Rath*
...
### [7] [Semantic Cooperative Games for Contribution Attribution in LLM-Based Multi-Agent Systems](https://arxiv.org/abs/2607.18255)
...
### [9] [Graph-Based Agentic AI with LangGraph: Workflow Pathways for Long-Running Stateful Business Processes](https://arxiv.org/abs/2607.19297)
...
Selection reason: LangGraph图式工作流的状态、检查点、重试、中断等模式可迁移到代码agent的可靠性设计。
...
### [13] [Fence: Specialized SLM Guardrails for LLM Applications](https://arxiv.org/abs/2607.18268)
...
### [14] [Operational Hallucination and Safety Drift in AI Agents](https://arxiv.org/abs/2607.18366)
...
### [15] [Neuro-Symbolic Meta-Policies for Temporal Knowledge-Graph Memory under Partial Observability](https://arxiv.org/abs/2607.18368)
...
### [16] [MAGE: Human-Like Macro Placement via Agentic Multimodal Reasoning](https://arxiv.org/abs/2607.18536)
...
### [17] [Engineering Trustworthy Agentic AI for Critical Systems](https://arxiv.org/abs/2607.18548)
...
### [18] [SciHazard: A Benchmark for Measuring Scientific Safety Risks with Decomposed Harm Scoring](https://arxiv.org/abs/2607.18665)
...
### [20] [AgentDebugX: An Open-Source Toolkit for Failure Observability, Attribution, and Recovery in LLM Agents](https://arxiv.org/abs/2607.18754)
...
### [21] [SkillSight: Seeing Through Shared Descriptions for Accurate Skill Retrieval](https://arxiv.org/abs/2607.18785)
...
### [22] [AI Tour Meeting: Group Travel Planning by LLM Agents](https://arxiv.org/abs/2607.18806)
*Daisuke Kikuta*
...
### [23] [PhoenixRepair: Rethinking Repair Strategy Exploration in Software Agents](https://arxiv.org/abs/2607.18859)
...
### [24] [Measuring Reward-Seeking via Contrastive Belief Updates](https://arxiv.org/abs/2607.18966)
...
### [25] [Mi-Memory: A Lifecycle Memory Framework for Personal AI](https://arxiv.org/abs/2607.18975)
...
### [26] [Fishing Out Free Riders: Shapley-Based Reward Attribution for Parallel Reasoning via Reinforcement Learning](https://arxiv.org/abs/2607.18979)
...
### [27] [Athena-Brain Technical Report: An Efficient Robot Brain for General Intelligence and Embodied Interactio](https://arxiv.org/abs/2607.18985)
...
### [28] [Vector-Bench: Can Models Surgically Edit SVG Code?](https://arxiv.org/abs/2607.19056)
...
### [29] [Supra Cognitive Modes: A Routed Architecture for Agent Memory](https://arxiv.org/abs/2607.19096)
...
### [30] [Comparative Study of Multi-Agent Actor-Critic Algorithms in Parameterized Action Reinforcement Learning](https://arxiv.org/abs/2607.19117)
...
### [31] [ResearchArena: Evaluating Sabotage and Monitoring in Automated AI R&D](https://arxiv.org/abs/2607.19321)
...
### [32] [Agents in the Wild: Where Research Meets Deployment](https://arxiv.org/abs/2607.19336)
...
### [33] [CodeRescue: Budget-Calibrated Recovery Routing for Coding Agents](https://arxiv.org/abs/2607.19338)
...
### [34] [Beyond Text Editing: Algebraic Manipulation of Source Code](https://arxiv.org/abs/2607.18742)
*Kevin Pulo*
...
Selection reason: 提出源代码代数操作替代文本编辑，适用于agentic代码编辑，显著减少token。
...
### [35] [TrapHunter: Exposing Covert Pathways in Trap Token Contracts](https://arxiv.org/abs/2607.18753)
...
DOI: [10.1145/3832106](https://doi.org/10.1145/3832106)

Selection reason: 智能合约trap token检测，结合LLM与动态验证，属程序分析范畴。
...
### [36] [TraceDev: A Traceability-Driven Multi-agent Framework for Requirement-to-Code Development](https://arxiv.org/abs/2607.18886)
...
DOI: [10.1145/3832171](https://doi.org/10.1145/3832171)

Selection reason: 可追踪性驱动的多agent框架，从需求生成仓库级代码，直接相关。
...
### [37] [Skillware: A Software Ontology and Engineering Lifecycle for Persistent Behavioral Artifacts](https://arxiv.org/abs/2607.18970)
...
Selection reason: 为Agent Skills建立软件本体与生命周期，对agent工程化有参考。
...
### [38] [SciCodePile: A 128GB Corpus and Executable Benchmark for Challenging Scientific Code Generation](https://arxiv.org/abs/2607.19104)
...
Selection reason: 大规模科学代码语料与可执行基准，直接支持代码生成评估与训练。
...
### [39] [Binding Drift in Multi-Step Tool-Augmented Agents](https://arxiv.org/abs/2607.18316)
...
Selection reason: 直接研究多步工具agent的实体绑定漂移与重验证机制，对提升代码agent可靠性有明确价值。
...
### [40] [CODENS: Transforming Code Changes into Living, Accessible, and Queryable Documentation](https://arxiv.org/abs/2607.18356)
...
DOI: [10.1145/3820755.3832807](https://doi.org/10.1145/3820755.3832807)

Selection reason: 将PR转化为知识图谱并支持agent引导的仓库级问答，可增强代码agent的检索与上下文理解。
