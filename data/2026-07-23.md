...
- [Binding Drift in Multi-Step Tool-Augmented Agents](https://arxiv.org/abs/2607.18316) — 相关度 0.90：直接研究多步工具agent的实体绑定漂移与重验证机制，对提升代码agent可靠性有明确价值。
- [Beyond Text Editing: Algebraic Manipulation of Source Code](https://arxiv.org/abs/2607.18742) — 相关度 0.88：提出源代码代数操作替代文本编辑，适用于agentic代码编辑，显著减少token。
- [SciCodePile: A 128GB Corpus and Executable Benchmark for Challenging Scientific Code Generation](https://arxiv.org/abs/2607.19104) — 相关度 0.85：大规模科学代码语料与可执行基准，直接支持代码生成评估与训练。
- [TraceDev: A Traceability-Driven Multi-agent Framework for Requirement-to-Code Development](https://arxiv.org/abs/2607.18886) — 相关度 0.85：可追踪性驱动的多agent框架，从需求生成仓库级代码，直接相关。
- [CODENS: Transforming Code Changes into Living, Accessible, and Queryable Documentation](https://arxiv.org/abs/2607.18356) — 相关度 0.70：将PR转化为知识图谱并支持agent引导的仓库级问答，可增强代码agent的检索与上下文理解。
- [Graph-Based Agentic AI with LangGraph: Workflow Pathways for Long-Running Stateful Business Processes](https://arxiv.org/abs/2607.19297) — 相关度 0.65：LangGraph图式工作流的状态、检查点、重试、中断等模式可迁移到代码agent的可靠性设计。
- [TrapHunter: Exposing Covert Pathways in Trap Token Contracts](https://arxiv.org/abs/2607.18753) — 相关度 0.62：智能合约trap token检测，结合LLM与动态验证，属程序分析范畴。
- [Skillware: A Software Ontology and Engineering Lifecycle for Persistent Behavioral Artifacts](https://arxiv.org/abs/2607.18970) — 相关度 0.60：为Agent Skills建立软件本体与生命周期，对agent工程化有参考。
