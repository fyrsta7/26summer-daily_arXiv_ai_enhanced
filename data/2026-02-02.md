...
Journal reference: Proceedings of ICPRAM 2026; ISBN 978-989-758-797-9; ISSN 2184-4313, SciTePress, pages 671-679

DOI: [10.5220/0014648500004067](https://doi.org/10.5220/0014648500004067)

Author affiliations: Shirin Reyhanian: Ruhr University Bochum; Laurenz Wiskott: Ruhr University Bochum
...
DOI: [10.1145/3774904.3793046](https://doi.org/10.1145/3774904.3793046)
...
Journal reference: Machine Learning and Applications: An International Journal (MLAIJ), Vol. 12, No. 4, pp. 1-9, 2025

DOI: [10.5121/mlaij.2025.12401](https://doi.org/10.5121/mlaij.2025.12401)

Author affiliations: Wataru Uemura: Ryukoku University; Takeru Nagashima: Ryukoku University
...
Journal reference: In Proceedings of the First Workshop on Language Models for Low-Resource Languages (LoResLM 2025), pages 373-386, Abu Dhabi, United Arab Emirates. Association for Computational Linguistics
...
Comments: This paper has been submitted to ISIT 2026
...
Comments: 24 pages, 6 tables. Version 2 improves the code construction and expands the set of realizable parameters. It also adds comprehensive tables comparing realizable parameters with those known to the authors from previous literature on multiple erasure correction as of July 2026
...
Journal reference: 2025 IEEE International Smart Cities Conference (ISC2), Patras, Greece, 2025, pp. 1-6

DOI: [10.1109/ISC266238.2025.11293327](https://doi.org/10.1109/ISC266238.2025.11293327)

Author affiliations: Julius Sechang Mboli: University of Hull; Omolara Aderonke Ogungbemi: University of Hull
...
DOI: [10.1145/3774904.3793059](https://doi.org/10.1145/3774904.3793059)
...
Author affiliations: Aldric Labarthe: CB, UNIGE; Roland Bouffanais: UNIGE; Julien Randon-Furling: CB
...
- [CVeDRL: An Efficient Code Verifier via Difficulty-aware Reinforcement Learning](https://arxiv.org/abs/2601.22803) — 相关度 0.90：难度感知强化学习训练高效代码验证器，显著提升 pass rate 和分支覆盖率，对代码生成验证环节有直接价值
- [TriCEGAR: A Trace-Driven Abstraction Mechanism for Agentic AI](https://arxiv.org/abs/2601.22997) — 相关度 0.80：提出轨迹驱动的状态抽象自动构建机制，为 agentic AI 的 runtime verification 与异常检测提供通用方法
