...
Comments: 9 pages, 6 figures, 3 tables. Project page: https://ndb796.github.io/LeanGuard ; code and models: https://github.com/ndb796/LeanGuard
...
### [13] [AgentX: Towards Agent-Driven Self-Iteration of Industrial Recommender Systems](http://arxiv.org/abs/2606.26859v2)
...
### [14] [Diagnosing Task Insensitivity in Language Agents](http://arxiv.org/abs/2606.26918v1)
...
### [15] [Where Do CoT Training Gains Land in LLM based Agents?](http://arxiv.org/abs/2606.26935v1)
...
### [16] [Look-Before-Move: Narrative-Grounded World Visual Attention in Dynamic 3D Story Worlds](http://arxiv.org/abs/2606.26964v2)
...
### [17] [Einstein World Models](http://arxiv.org/abs/2606.26969v1)
...
### [18] [Adaptive Utility driven Resource Orchestration for Resilient AI (AURORA-AI)](http://arxiv.org/abs/2606.27005v1)
...
### [19] [Semantic Early-Stopping for Iterative LLM Agent Loops](http://arxiv.org/abs/2606.27009v1)
*Sahil Shrivastava*
...
### [20] [Making Failure Safe: A Constrained, Verifiable Agent Framework for Open-Web Data Collection](http://arxiv.org/abs/2607.00035v1)
*Bo Chen*
...
### [21] [Joint Learning of Experiential Rules and Policies for Large Language Model Agents](http://arxiv.org/abs/2606.27136v1)
*Shicheng Ye,Chao Yu*
...
### [22] [OpenRCA 2.0: From Outcome Labels to Causal Process Supervision](http://arxiv.org/abs/2606.27154v2)
...
### [23] [A Process Harness for Uplifting Legacy Workflows to Agentic BPM: Design and Realization in CUGA FLO](http://arxiv.org/abs/2606.27188v1)
...
### [24] [Ask, Don't Judge: Binary Questions for Interpretable LLM Evaluation and Self-Improvement](http://arxiv.org/abs/2606.27226v1)
...
### [25] [Prompt Injection in Automated Résumé Screening with Large Language Models: Single and Multi-Injection Settings](http://arxiv.org/abs/2606.27287v1)
...
### [26] [When Does Combining Language Models Help? A Co-Failure Ceiling on Routing, Voting, and Mixture-of-Agents Across 67 Frontier Models](http://arxiv.org/abs/2606.27288v1)
*Josef Chen*
...
### [27] [When Does Personality Composition Matter for Multi-Agent LLM Teams?](http://arxiv.org/abs/2606.27443v2)
...
### [28] [Internalizing the Future: A Unified Agentic Training Paradigm for World Model Planning](http://arxiv.org/abs/2606.27483v1)
...
### [29] [Odyssey: Constructing Verifiable Local Truth-Preserving Foundation Models](http://arxiv.org/abs/2606.27593v1)
*Sridhar Mahadevan*
...
### [30] [An Empirical Study of LLM-Generated Specifications for VeriFast](http://arxiv.org/abs/2606.26490v1)
...
Selection reason: 系统评估LLM生成VeriFast分离逻辑规范，对代码agent的正确性验证与规范生成有直接参考。
...
### [31] [Evaluation-Strategy Gap in Fault Diagnosis of Deep Learning Programs](http://arxiv.org/abs/2606.26492v1)
*Sigma Jahan*
...
Selection reason: 揭示DL程序故障诊断评估策略的泛化差距，对调试技术评估方法的迁移有参考价值。
...
### [32] [ConcoLixir: Reactive LLM Discovery Oracles for Python Concolic Testing](http://arxiv.org/abs/2606.26545v1)
...
Selection reason: LLM作为发现预言机增强Python concolic测试覆盖率，直接结合LLM与测试生成，迁移价值高。
...
### [33] [Knowledge-Based Pull Requests: A Trusted Workflow for Agent-Mediated Knowledge Collaboration](http://arxiv.org/abs/2606.26721v1)
...
Selection reason: 提出基于知识包的PR工作流，区分知识与实现合并，对多agent协作与信任治理有明确借鉴。
...
### [34] [Towards Evaluation of Implicit Software World Models in Coding LLMs](http://arxiv.org/abs/2606.27406v1)
...
Selection reason: 扩展coding LLM评测到内存、时间等执行资源维度，直接补充软件世界模型与agent能力评估。
...
### [35] [A Deterministic Control Plane for LLM Coding Agents](http://arxiv.org/abs/2606.26924v1)
*Padmaraj Madatha*
...
Selection reason: 为LLM coding agent提出确定性控制平面，管理配置供应链、权限与审计，直接提升agent可靠性与安全性。
...
### [36] [Are LLMs Ready for Anti-Pattern Detection in Microservice Architectures?](http://arxiv.org/abs/2606.26927v1)
...
Selection reason: 评估LLM检测微服务架构反模式，可为代码分析型agent提供能力参考与补充静态分析。
...
### [37] [CLIR: Liveness-Driven and Structure-Aware Fuzzing for the Cranelift Compiler](http://arxiv.org/abs/2606.26977v1)
...
Selection reason: 面向Cranelift编译器的差分模糊测试框架，生成合法IR并有效检测缺陷，属于编译器测试通用方法。
...
### [38] [To Run or Not to Run: Analyzing the Cost-Effectiveness of Code Execution in LLM-Based Program Repair](http://arxiv.org/abs/2606.26978v1)
...
Selection reason: 实证分析LLM程序修复中代码执行的成本效益，直接指导agent执行策略的取舍与设计。
...
### [39] [How Much Static Structure Do Code Agents Need? A Study of Deterministic Anchoring](http://arxiv.org/abs/2606.26979v2)
...
Selection reason: 研究静态结构注释对代码agent定位与可复现性的影响，直接改进agent导航与稳定性。
...
### [40] [The Spec Growth Engine: Spec-Anchored, Code-Coupled, Drift-Enforced Architecture for AI-Assisted Software Development](http://arxiv.org/abs/2606.27045v1)
*Hartwig Grabowski*
...
Selection reason: 提出Spec Growth Engine管理规格图与上下文范围，解决agent上下文爆炸与spec-code漂移，对工作流有迁移价值。
...
### [41] [On the Reproducibility of Quantum Software Defect Datasets: A Case Study of Bugs4Q](http://arxiv.org/abs/2606.27124v1)
*Haruto Ohto,Yuta Ishimoto,Shinsuke Matsumoto,Shinji Kusumoto*

Main category: cs.SE

Comments: 10 pages plus 2 pages of references. Accepted to the Replication and Negative Results (RENE) Track of ICSME 2026

Selection reason: 量子缺陷数据集可复现性研究，对 benchmark 维护和评测可靠性有参考价值。
...
### [42] [Smaller Models, Unexpected Costs: Trade-offs in LLM Quantization for Automated Program Repair](http://arxiv.org/abs/2606.27205v2)
...
Selection reason: 系统评估 LLM 量化对自动程序修复的影响，涉及效率与效果权衡，对 coding agent 部署有用。
...
### [43] [Speculative Refinement: A Hybrid Autoregressive Diffusion Decoding Strategy and Its Behavior Across Benchmarks](http://arxiv.org/abs/2606.27474v1)
...
Selection reason: 混合解码策略在代码基准上的评估发现，对代码生成评测方法有参考价值。
...
### [44] [Test Case Selection for Deep Neural Networks: A Replication Study on LLMs for Code](http://arxiv.org/abs/2606.27601v1)
...
Selection reason: 在 LLM 代码模型上复现测试用例选择技术，对代码模型的测试和评测有贡献。
...
### [45] [Temporal Validity in Retrieval Memory: Eliminating Stale-Fact Errors for AI Agents over Evolving Knowledge](http://arxiv.org/abs/2606.26511v1)
*Neeraj Yadav*
...
### [46] [The Inattentional Gap: Task-Conditioned Language and Vision Models Omit the Safety-Critical Signals They Can Otherwise Report](http://arxiv.org/abs/2606.26529v2)
*Kwan Soo Shin,In Seok Kang,Yunkyung Min,Judy Yang,Munho Lee*

Main category: cs.CL

Comments: 21 pages, 8 figures. v2: author list expanded; statistical robustness additions (bootstrap CIs, Holm-Bonferroni, judge-sensitivity analysis). Reproducibility deposit: https://doi.org/10.5281/zenodo.20826824
...
### [47] [Auditing Framing-Sensitive Behavioral Instability in Large Language Models for Mental Health Interactions](http://arxiv.org/abs/2606.26982v1)
...
### [48] [Bridging Talk and Thought: Understanding Dialogue Dynamics Across Collaborative Problem-Solving Contexts](http://arxiv.org/abs/2606.27233v1)
...
### [49] [Empowering GUI Agents via Autonomous Experience Exploration and Hindsight Experience Utilization for Task Planning](http://arxiv.org/abs/2606.27330v1)
...
### [50] [Supersede: Diagnosing and Training the Memory-Update Gap in LLM Agents](http://arxiv.org/abs/2606.27472v1)
*Vedant Patel*
...
### [51] [Risk-Aware Selective Multimodal Driver Monitoring with Driver-State World Modeling](http://arxiv.org/abs/2606.26922v1)
...
### [52] [In-Context Model Predictive Generation: Open-Vocabulary Motion Synthesis from Language Models to Physics](http://arxiv.org/abs/2606.26981v1)
...
### [53] [Learning to Fold: prizewinning solution at LeHome Challenge 2026 (1st place online, 2nd offline)](http://arxiv.org/abs/2606.27163v1)
*Ilia Larchenko*
...
### [54] [Advancing Omnimodal Embodied Agents from Isolated Skills to Everyday Physical Autonomy](http://arxiv.org/abs/2606.27251v1)
...
### [55] [E-TTS: A New Embodied Test-Time Scaling Framework for Robotic Manipulation](http://arxiv.org/abs/2606.27268v1)
...
### [56] [Glite ARF: Verifier-Driven Research with Parallel LLM Coding Agents](http://arxiv.org/abs/2606.27416v1)
...
Selection reason: 并行 LLM coding agent 的验证驱动框架，强调可审计性和隔离，对 agent 工作流有直接借鉴。
...
### [57] [Adaptive Evaluation of Out-of-Band Defenses Against Prompt Injection in LLM Agents](http://arxiv.org/abs/2606.26479v1)
...
### [58] [MIRROR: Novelty-Constrained Memory-Guided MCTS Red-Teaming for Agentic RAG](http://arxiv.org/abs/2606.26793v1)
...
### [59] [Chai: Agentic Discovery of Cryptographic Misuse Vulnerabilities](http://arxiv.org/abs/2606.26933v1)
...
### [60] [ShareLock: A Stealthy Multi-Tool Threshold Poisoning Attack Against MCP](http://arxiv.org/abs/2606.27027v1)
...
### [61] [Tool Use Enables Undetectable Steganography in Multi-Agent LLM Systems](http://arxiv.org/abs/2606.28425v1)
...
### [62] [On the Inseparability of Instructions and Data in Shared-Embedding Sequence Models](http://arxiv.org/abs/2606.27567v1)
...
### [63] [HiLSVA: Design and Evaluation of a Human-in-the-Loop Agentic System for Scientific Visualization](http://arxiv.org/abs/2606.26614v1)
...
### [64] [Localizing RL-Induced Tool Use to a Single Crosscoder Feature](http://arxiv.org/abs/2606.26474v1)
...
### [65] [Retrieval-Warmed Energy-Based Reasoning: A Five-Arm Ablation Methodology for Diffusion-as-Inference on Structured Reasoning Tasks](http://arxiv.org/abs/2606.26476v1)
...
### [66] [On the Necessity of a Liquid Substrate for Mesh Intelligence](http://arxiv.org/abs/2606.28413v1)
*Hongwei Xu*
...
### [67] [State Representation Matters in Deep Reinforcement Learning: Application to Energy Trading](http://arxiv.org/abs/2606.27032v1)
...
### [68] [Automating Potential-based Reward Shaping with Vision Language Model Guidance](http://arxiv.org/abs/2606.27180v1)
...
### [69] [PEBS: Per-rater Empirical-Bayes Shrinkage for RLHF Reward-Model Calibration](http://arxiv.org/abs/2606.27578v1)
*Arnav Raj*
...
### [70] [Retroactive Advantage Correction: Closed-Form V-Trace Bias Correction for Delay-Aware RLHF](http://arxiv.org/abs/2606.27580v1)
*Arnav Raj*
...
### [71] [Perception, Verdict, and Evolution: Hindsight-Driven Self-Refining Forensics Agent for AI-Generated Image Detection](http://arxiv.org/abs/2606.26552v1)
...
### [72] [Confidence-Aware Tool Orchestration for Robust Video Understanding](http://arxiv.org/abs/2606.26904v1)
...
### [73] [DMV-Bench: Diagnosing Long-Horizon Multimodal Agents' Visual Memory with Incidental Cue Injection](http://arxiv.org/abs/2606.27499v1)
...
### [74] [Dismantling Pathological Shortcuts: A Causal Framework for Faithful LVLM Decoding](http://arxiv.org/abs/2606.27596v1)
...
### [75] [Mostly Automatic Translation of Language Interpreters from C to Safe Rust](http://arxiv.org/abs/2606.27122v1)
...
Selection reason: 多 agent 编排 C 到 Rust 解释器翻译，结合 feature reduction 和自动验证，对长程代码 agent 有直接迁移价值。
...
### [76] [Evidence-Driven LLM Agent for C-to-Synthesizable-C Conversion and Verification](http://arxiv.org/abs/2606.28409v1)
...
### [77] [NOVA: A Verification-Aware Agent Harness for Architecture Evolution in Industrial Recommender Systems](http://arxiv.org/abs/2606.27243v2)
...
Selection reason: 验证感知的 agent harness 用于架构演化，其验证级联和任务级控制可迁移到代码 agent。
