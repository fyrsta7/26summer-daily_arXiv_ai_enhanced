...
### [21] [Mining Workflow Graphs for Black-Box Boundary Testing of Conversational LLM Agents](http://arxiv.org/abs/2607.06873v1)
...
Selection reason: 黑盒挖掘会话工作流图并测试边界，为对话agent状态化测试提供可迁移方法。
...
### [22] [Progressive Crystallization: Turning Agent Exploration into Deterministic, Lower-Cost Workflows in Production](http://arxiv.org/abs/2607.07052v1)
*Arun Malik*
...
Selection reason: 提出将智能体探索渐进结晶为确定性工作流的生命周期与升降级机制，对降低代码智能体成本和提高可靠性有强迁移价值。
...
### [23] [PERFOPT-Bench: Evaluating Coding Agents on Software Performance Optimization](http://arxiv.org/abs/2607.07744v1)
...
Selection reason: 专门评测编码智能体在性能优化任务上的基准，涵盖profile、诊断、修改、验证完整回路，直接对应SemOpt研究。
...
### [24] [Finding and Understanding Miscompilation Bugs in the Solidity Compiler](http://arxiv.org/abs/2607.07217v1)
*Bhargava Shastry*
...
Selection reason: 对Solidity编译器误编译bug的差分模糊测试，属于编译器正确性验证，可迁移到代码测试与LLM工具反馈场景。
...
### [25] [The Poisoned Chalice of LLM Evaluation Report](http://arxiv.org/abs/2607.07481v1)
...
Selection reason: 组织LLM评估数据污染检测竞赛，针对基准泄露问题，对代码智能体评测的可信度有参考价值。
...
### [26] [What Makes a Good Bug Report for an AI Agent?](http://arxiv.org/abs/2607.07593v1)
...
Selection reason: 系统研究何种bug报告特征有助于LLM修复智能体，通过统计与消融实验给出具体可操作指南。
...
### [27] [Rethinking Code Performance Benchmarks for LLMs](http://arxiv.org/abs/2607.07619v1)
...
Selection reason: 重新评估LLM代码性能基准并设计多智能体生成性能测试，直接击中SemOpt评测瓶颈并给出改进框架。
...
### [28] [Functional and Secure Code Generation with Task Vectors](http://arxiv.org/abs/2607.07881v1)
...
Selection reason: 利用任务向量提升代码生成的功能性与安全性，无需解码修改，可迁移到编码LLM的安全增强。
...
### [29] [Bug Report Specification Refinement with Trajectory Guidance for Automated Program Repair](http://arxiv.org/abs/2607.07882v1)
...
Selection reason: 通过轨迹引导细化bug报告规格，显著提升多个APR智能体的修复率，对智能体输入优化有直接价值。
...
### [30] [DeepSWE: Measuring Frontier Coding Agents on Original, Long-Horizon Engineering Tasks](http://arxiv.org/abs/2607.07946v1)
...
Selection reason: 提出原创长周期软件工程任务基准并用手写验证器评测，避免预训练污染，对编码智能体评测有重要价值。
...
### [31] [3100 Opinions on Code Review in an AI World: Building Causal Theory from Practitioner Discourse](http://arxiv.org/abs/2607.07980v1)
...
Selection reason: 对 AI 生成 PR 的代码审查机制构建因果理论，可为代码 agent 的评审反馈与审查流程设计提供参考。
...
### [32] [Jet-Long: Efficient Long-Context Extension with Dynamic Bifocal RoPE](http://arxiv.org/abs/2607.07740v2)
...
### [33] [Entropy Pacing Policy Optimization for Multi-Task Agentic Reinforcement Learning](http://arxiv.org/abs/2607.07178v1)
...
### [34] [Predicting LLM Safety Before Release by Simulating Deployment](http://arxiv.org/abs/2607.07184v1)
...
### [35] [A Transdiagnostic Space of Disorder Like Phenotypes in Reinforcement Learning Agents](http://arxiv.org/abs/2607.07753v1)
*Hari Prasad*
...
### [36] [Multi-Agent AI Control: Distributed Attacks Hamper Per-Instance Monitors](http://arxiv.org/abs/2607.07368v1)
...
### [37] [RLVP: Penalize the Path, Reward the Outcome](http://arxiv.org/abs/2607.07435v1)
*Bojie Li,Noah Shi*
...
### [38] [Reward-Adaptive Iterative Discovery: A Case Study on Automated Game Testing for NHL26](http://arxiv.org/abs/2607.07498v1)
...
Comments: Reinforcement Learning Conference - Reinforcement Learning and Video Games Workshop 2026
...
### [39] [Single-Rollout Asynchronous Optimization for Agentic Reinforcement Learning](http://arxiv.org/abs/2607.07508v1)
...
### [40] [Agon: Competitive Cross-Model RL with Implicit Rival Grading of Reasoning](http://arxiv.org/abs/2607.07690v1)
*Vladislav Beliaev*
...
### [41] [Efficient Safety Alignment of Language Models via Latent Personality Traits](http://arxiv.org/abs/2607.07918v1)
...
### [42] [From Triggers to Emotions: A CPM-Grounded Appraisal Multi-Agent for Dynamic Emotional Evolution in Persona-Based Dialogue](http://arxiv.org/abs/2607.07824v1)
...
### [43] [Tree-of-Thoughts Reasoning for Text-to-Image In-Context Learning](http://arxiv.org/abs/2607.07117v1)
...
### [44] [Multi-agent Autoformalization of Tensor Network Theory](http://arxiv.org/abs/2607.07857v1)
...
### [45] [Future Confidence Distillation in Large Language Models](http://arxiv.org/abs/2607.07626v1)
*Sahil Kale*
...
### [46] [From Solvers to Research: Large Language Model-Driven Formal Mathematics at the Research Frontier](http://arxiv.org/abs/2607.07779v1)
...
### [47] [When Implausible Tokens Get Reinforced: Tail-Aware Credit Calibration for LLM Reinforcement Learning](http://arxiv.org/abs/2607.07976v1)
...
### [48] [A Reliability Assessment of LALM Audio Judges for Full-Duplex Voice Agents](http://arxiv.org/abs/2607.07985v1)
...
### [49] [Computing with Stochastic Oracles in AI-Augmented Computation](http://arxiv.org/abs/2607.06893v1)
*Jie Wang*
...
### [50] [Thinking More, Harnessing Better: State Machine Guided Harness Automatic Generation with Project Digestion and Workflow Decomposition](http://arxiv.org/abs/2607.07007v1)
...
Selection reason: 利用LLM和状态机分解自动生成fuzz harness，工作流分解和回滚机制对代码生成智能体有直接借鉴价值。
...
### [51] [Mitigating Taint-Style Vulnerabilities in MCP Servers via Security-Aware Tool Descriptions](http://arxiv.org/abs/2607.07461v1)
...
Selection reason: 针对MCP服务器的污点风格漏洞提出基于工具描述的防护，对LLM工具调用智能体的安全加固有可迁移方法。
...
### [52] [Beyond Attack-Success Rate: Action-Graded Severity Scale for Tool-Using AI Agents](http://arxiv.org/abs/2607.07474v1)
...
### [53] [Mechanistic Interpretability of LLM Jailbreaks via Internal Attribution Graphs](http://arxiv.org/abs/2607.07903v1)
...
### [54] [Who Broke the System? Failure Localization in LLM-Based Multi-Agent Systems](http://arxiv.org/abs/2607.07989v1)
...
### [55] [Breaking Database Lock-in: Agentic Regeneration of High Performance Storage Readers for Database Bypass](http://arxiv.org/abs/2607.07696v1)
...
### [56] [HELP: Human-Efficient Large-Scale Robot Post-Training with Rollout Segmentation](http://arxiv.org/abs/2607.09776v2)
...
### [57] [End-to-End LLM Flight Planning with RAG-based Memory and Multi-modal Coach Agent](http://arxiv.org/abs/2607.06964v1)
...
### [58] [WAM-TTT: Steering World-Action Models by Watching Human Play at Test Time](http://arxiv.org/abs/2607.06988v2)
...
### [59] [CARLA-GS: Decoupling Representation, Reasoning, and Physics Simulation for Autonomous Driving Corner-Case Synthesis](http://arxiv.org/abs/2607.07601v1)
