...
- [PERFOPT-Bench: Evaluating Coding Agents on Software Performance Optimization](http://arxiv.org/abs/2607.07744v1) — 相关度 0.97：专门评测编码智能体在性能优化任务上的基准，涵盖profile、诊断、修改、验证完整回路，直接对应SemOpt研究。
- [Rethinking Code Performance Benchmarks for LLMs](http://arxiv.org/abs/2607.07619v1) — 相关度 0.93：重新评估LLM代码性能基准并设计多智能体生成性能测试，直接击中SemOpt评测瓶颈并给出改进框架。
- [DeepSWE: Measuring Frontier Coding Agents on Original, Long-Horizon Engineering Tasks](http://arxiv.org/abs/2607.07946v1) — 相关度 0.91：提出原创长周期软件工程任务基准并用手写验证器评测，避免预训练污染，对编码智能体评测有重要价值。
- [Bug Report Specification Refinement with Trajectory Guidance for Automated Program Repair](http://arxiv.org/abs/2607.07882v1) — 相关度 0.87：通过轨迹引导细化bug报告规格，显著提升多个APR智能体的修复率，对智能体输入优化有直接价值。
- [What Makes a Good Bug Report for an AI Agent?](http://arxiv.org/abs/2607.07593v1) — 相关度 0.86：系统研究何种bug报告特征有助于LLM修复智能体，通过统计与消融实验给出具体可操作指南。
- [Progressive Crystallization: Turning Agent Exploration into Deterministic, Lower-Cost Workflows in Production](http://arxiv.org/abs/2607.07052v1) — 相关度 0.82：提出将智能体探索渐进结晶为确定性工作流的生命周期与升降级机制，对降低代码智能体成本和提高可靠性有强迁移价值。
- [Mining Workflow Graphs for Black-Box Boundary Testing of Conversational LLM Agents](http://arxiv.org/abs/2607.06873v1) — 相关度 0.80：黑盒挖掘会话工作流图并测试边界，为对话agent状态化测试提供可迁移方法。
- [Thinking More, Harnessing Better: State Machine Guided Harness Automatic Generation with Project Digestion and Workflow Decomposition](http://arxiv.org/abs/2607.07007v1) — 相关度 0.76：利用LLM和状态机分解自动生成fuzz harness，工作流分解和回滚机制对代码生成智能体有直接借鉴价值。
- [Mitigating Taint-Style Vulnerabilities in MCP Servers via Security-Aware Tool Descriptions](http://arxiv.org/abs/2607.07461v1) — 相关度 0.71：针对MCP服务器的污点风格漏洞提出基于工具描述的防护，对LLM工具调用智能体的安全加固有可迁移方法。
- [Functional and Secure Code Generation with Task Vectors](http://arxiv.org/abs/2607.07881v1) — 相关度 0.70：利用任务向量提升代码生成的功能性与安全性，无需解码修改，可迁移到编码LLM的安全增强。
- [The Poisoned Chalice of LLM Evaluation Report](http://arxiv.org/abs/2607.07481v1) — 相关度 0.68：组织LLM评估数据污染检测竞赛，针对基准泄露问题，对代码智能体评测的可信度有参考价值。
- [Finding and Understanding Miscompilation Bugs in the Solidity Compiler](http://arxiv.org/abs/2607.07217v1) — 相关度 0.62：对Solidity编译器误编译bug的差分模糊测试，属于编译器正确性验证，可迁移到代码测试与LLM工具反馈场景。
- [3100 Opinions on Code Review in an AI World: Building Causal Theory from Practitioner Discourse](http://arxiv.org/abs/2607.07980v1) — 相关度 0.55：对 AI 生成 PR 的代码审查机制构建因果理论，可为代码 agent 的评审反馈与审查流程设计提供参考。
