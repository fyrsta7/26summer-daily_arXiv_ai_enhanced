...
### [1] [SeePhys Pro: Diagnosing Modality Transfer and Blind-Training Effects in Multimodal RLVR for Physics Reasoning](http://arxiv.org/abs/2605.09266v2)
...
### [2] [Towards Conversational Medical AI with Eyes, Ears and a Voice](http://arxiv.org/abs/2605.09272v1)
...
### [3] [EquiMem: Calibrating Shared Memory in Multi-Agent Debate via Game-Theoretic Equilibrium](http://arxiv.org/abs/2605.09278v1)
...
### [4] [A Prompt-Aware Structuring Framework for Reliable Reuse of AI-Generated Content in the Agentic Web](http://arxiv.org/abs/2605.09283v1)
...
### [5] [PiCA: Pivot-Based Credit Assignment for Search Agentic Reinforcement Learning](http://arxiv.org/abs/2605.09287v2)
...
### [6] [Beyond Accuracy: Evaluating Strategy Diversity in LLM Mathematical Reasoning](http://arxiv.org/abs/2605.09292v1)
...
### [7] [How LLMs Are Persuaded: A Few Attention Heads, Rerouted](http://arxiv.org/abs/2605.09314v1)
...
### [8] [Do Self-Evolving Agents Forget? Capability Degradation and Preservation in Lifelong LLM Agent Adaptation](http://arxiv.org/abs/2605.09315v1)
...
### [9] [CHAINTRIX: A multi-pipeline LLM-augmented framework for automated smart-contract security auditing](http://arxiv.org/abs/2605.09350v1)
...
### [10] [Towards a Virtual Neuroscientist: Autonomous Neuroimaging Analysis via Multi-Agent Collaboration](http://arxiv.org/abs/2605.09366v3)
...
### [11] [NEXUS: Continual Learning of Symbolic Constraints for Safe and Robust Embodied Planning](http://arxiv.org/abs/2605.09387v1)
...
### [12] [Empowering VLMs for Few-Shot Multimodal Time Series Classification via Tailored Agentic Reasoning](http://arxiv.org/abs/2605.09395v2)
...
### [13] [From Passive Reuse to Active Reasoning: Grounding Large Language Models for Neuro-Symbolic Experience Replay](http://arxiv.org/abs/2605.09419v1)
...
### [14] [SimWorld Studio: Automatic Environment Generation with Evolving Coding Agent for Embodied Agent Learning](http://arxiv.org/abs/2605.09423v2)
...
### [15] [VulTriage: Triple-Path Context Augmentation for LLM-Based Vulnerability Detection](http://arxiv.org/abs/2605.09461v2)
...
### [16] [Don't Click That: Teaching Web Agents to Resist Deceptive Interfaces](http://arxiv.org/abs/2605.09497v1)
...
### [17] [A Game Theoretic Free Energy Analysis of Higher Order Synergy in Attention Heads of Large Language Models](http://arxiv.org/abs/2605.09515v1)
*Djamel Bouchaffra*
...
### [18] [LLM-Guided Monte Carlo Tree Search over Knowledge Graphs: Composing Mechanistic Explanations for Drug-Disease Pairs](http://arxiv.org/abs/2605.09542v1)
...
### [19] [TIDE-Bench: Task-Aware and Diagnostic Evaluation of Tool-Integrated Reasoning](http://arxiv.org/abs/2605.09544v1)
...
### [20] [PDEAgent-Bench: A Multi-Metric, Multi-Library Benchmark for PDE Solver Generation](http://arxiv.org/abs/2605.09636v1)
...
### [21] [Workspace Optimization: How to Train Your Agent](http://arxiv.org/abs/2605.09650v1)
...
### [22] [CodeClinic: Evaluating Automation of Coding Skills for Clinical Reasoning Agents](http://arxiv.org/abs/2605.09675v1)
...
### [23] [Absurd World: A Simple Yet Powerful Method to Absurdify the Real-world for Probing LLM Reasoning Capabilities](http://arxiv.org/abs/2605.09678v1)
...
### [24] [Causal state binding predicts action control in language agents](http://arxiv.org/abs/2605.09692v3)
*Xiao Jia*
...
### [25] [Ambig-DS: A Benchmark for Task-Framing Ambiguity in Data-Science Agents](http://arxiv.org/abs/2605.09698v1)
...
### [26] [Generating Complex Code Analyzers from Natural Language Questions](http://arxiv.org/abs/2605.09304v1)
...
Selection reason: 融合LLM与CodeQL生成代码分析器，具备RAG迭代与自测技术，直接可迁移到代码理解agent。
...
### [27] [An Execution-Verified Multi-Language Benchmark for Code Semantic Reasoning](http://arxiv.org/abs/2605.11006v1)
...
Selection reason: 提供执行验证的多语言代码语义推理基准，填补程序结构理解评估空白。
...
### [28] [MACAA: Belief-Revision Multi-Agent Reasoning for Code Authorship Verification](http://arxiv.org/abs/2605.09421v3)
...
Selection reason: 基于信念修正的多agent推理框架可用于代码溯源验证，其协作推理机制可迁移至代码agent。
...
### [29] [ConCovUp: Effective Agent-Based Test Driver Generation for Concurrency Testing](http://arxiv.org/abs/2605.09573v1)
...
Selection reason: 多agent与程序分析结合生成并发测试驱动，显著提升共享内存访问覆盖，对agent测试生成有直接价值。
...
### [30] [Trajectory Supervision for Continual Tool-Use Learning in LLMs](http://arxiv.org/abs/2605.09734v1)
...
Selection reason: 轨迹监督用于持续工具学习，探索中间过程的保留价值，对agent学习方法有参考，但规模有限。
...
### [31] [An Executable Benchmarking Suite for Tool-Using Agents](http://arxiv.org/abs/2605.11030v2)
...
Selection reason: 可执行的工具使用agent基准套件，明确证据采纳契约，为agent评测提供标准化框架。
...
### [32] [Evaluating Tool Cloning in Agentic-AI Ecosystems](http://arxiv.org/abs/2605.09817v2)
...
Selection reason: 针对 agent 工具生态的克隆检测与多样性评估，对代码 agent 工具数据集和 benchmark 构建有直接可迁移价值。
...
### [33] [Beyond Continuity: Challenges of Context Switching in Multi-Turn Dialogue with LLMs](http://arxiv.org/abs/2605.09268v1)
...
### [34] [Hidden Error Awareness in Chain-of-Thought Reasoning: The Signal Is Diagnostic, Not Causal](http://arxiv.org/abs/2605.09502v1)
...
### [35] [CLR-voyance: Reinforcing Open-Ended Reasoning for Inpatient Clinical Decision Support with Outcome-Aware Rubrics](http://arxiv.org/abs/2605.09584v1)
...
### [41] [MiroBench: Benchmarking Realism in Agentic Simulation of Real-world Discussions](http://arxiv.org/abs/2606.14715v1)
...
### [42] [SmartEval: A Benchmark for Evaluating LLM-Generated Smart Contracts from Natural Language Specifications](http://arxiv.org/abs/2605.09610v1)
...
Selection reason: 面向智能合约生成的多维度评测基准，提供可复现的评估流程与失败模式分析。
...
### [43] [CalBench: Evaluating Coordination-Privacy Trade-offs in Multi-Agent LLMs](http://arxiv.org/abs/2605.09823v3)
...
### [44] [Memorize Theorems, Not Instances: Probing SFT Generalization through Mathematical Reasoning](http://arxiv.org/abs/2605.09270v2)
...
### [45] [The Trap of Trajectory: Towards Understanding and Mitigating Spurious Correlations in Agentic Memory](http://arxiv.org/abs/2605.09330v1)
...
### [46] [Skill-R1: Agent Skill Evolution via Reinforcement Learning](http://arxiv.org/abs/2605.09359v1)
...
### [47] [Your Simulation Runs but Solves the Wrong Physics: PDE-Grounded Intent Verification for LLM-Generated Multiphysics Simulation Code](http://arxiv.org/abs/2605.09360v1)
...
Selection reason: 基于PDE意图验证纠正LLM生成的仿真代码，区分可执行性与语义正确性，对代码验证有启示。
...
### [48] [Efficient LLM Reasoning via Variational Posterior Guidance with Efficiency Awareness](http://arxiv.org/abs/2605.11019v1)
...
### [49] [Trust Region Inverse Reinforcement Learning: Explicit Dual Ascent using Local Policy Updates](http://arxiv.org/abs/2605.11020v2)
...
### [50] [Metal-Sci: A Scientific Compute Benchmark for Evolutionary LLM Kernel Search on Apple Silicon](http://arxiv.org/abs/2605.09708v2)
*Víctor Gallego*
...
### [51] [RubricRefine: Improving Tool-Use Agent Reliability with Training-Free Pre-Execution Refinement](http://arxiv.org/abs/2605.09730v3)
...
Selection reason: 通过执行前语义契约检查提升工具使用agent可靠性，零执行尝试且性能优越，直接适用于代码agent。
...
### [52] [LEAD: Length-Efficient Adaptive and Dynamic Reasoning for Large Language Models](http://arxiv.org/abs/2605.09806v1)
...
### [53] [The Authorization-Execution Gap Is a Major Safety and Security Problem in Open-World Agents](http://arxiv.org/abs/2605.11003v1)
...
### [54] [Position: AI Security Policy Should Target Systems, Not Models](http://arxiv.org/abs/2605.09504v1)
...
### [55] [Governing AI-Assisted Security Operations: A Design Science Framework for Operational Decision Support](http://arxiv.org/abs/2605.09534v1)
...
### [56] [DCVD: Dual-Channel Cross-Modal Fusion for Joint Vulnerability Detection and Localization](http://arxiv.org/abs/2605.11015v1)
...
### [57] [MonitoringBench: Semi-Automated Red-Teaming for Agent Monitoring](http://arxiv.org/abs/2605.09684v1)
...
### [58] [Security Risks in Tool-Enabled AI Agents: A Systematic Analysis of Privileged Execution Environments](http://arxiv.org/abs/2605.09721v1)
*Hardik Goel*
...
### [59] [Portable Agent Memory: A Protocol for Cryptographically-Verified Memory Transfer Across Heterogeneous AI Agents](http://arxiv.org/abs/2605.11032v1)
...
### [60] [Oracle Poisoning: Corrupting Knowledge Graphs to Weaponise AI Agent Reasoning](http://arxiv.org/abs/2605.09822v1)
...
### [61] [GeoSym127K: Scalable Symbolically-verifiable Synthesis for Multimodal Geometric Reasoning](http://arxiv.org/abs/2605.16371v1)
...
### [62] [DeepTumorVQA: A Hierarchical 3D CT Benchmark for Stage-Wise Evaluation of Medical VLMs and Tool-Augmented Agents](http://arxiv.org/abs/2605.09679v1)
...
### [63] [Do multimodal models imagine electric sheep?](http://arxiv.org/abs/2605.09693v1)
