...
- [LDP: An Identity-Aware Protocol for Multi-Agent LLM Systems](https://arxiv.org/abs/2603.08852) — 相关度 0.70：多 agent 通信协议加入身份、治理与溯源，可迁移至代码 agent 的协作与信任管理。
- [EsoLang-Bench: Evaluating Genuine Reasoning in Large Language Models via Esoteric Programming Languages](https://arxiv.org/abs/2603.09678) — 相关度 0.65：用深奥语言评估代码推理能力，提供抗数据污染的代码推理基准，对 code agent 能力评测有价值。
