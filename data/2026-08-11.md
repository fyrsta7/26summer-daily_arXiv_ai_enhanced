...
### [1] [ADIAS: Automated Design of Interactive Agentic Systems](https://arxiv.org/abs/2608.06410)
...
### [2] [KNOWPLAN: Knowledge-Driven AI Agents for Smart Degree Pathway Planning](https://arxiv.org/abs/2608.06530)
...
### [3] [NxN E-valuation: Hypothesis Certification via a Conformal CRT Null](https://arxiv.org/abs/2608.06621)
*Bin Wang,Yan Zhong*
...
### [4] [Shape Your Feed: An LLM-based Agentic System for Conversational Recommendation](https://arxiv.org/abs/2608.06632)
...
### [5] [Deal Me Maybe: The Role of Emotions in Multi-Agent Negotiation](https://arxiv.org/abs/2608.06922)
...
### [6] [Science Edge Evaluation: SEE the Missing Step Toward Real Scientific Discovery](https://arxiv.org/abs/2608.06931)
...
### [7] [Blind to the Pivotal Vote: Aggregate Independence Metrics Miss Where Verification Actually Helps](https://arxiv.org/abs/2608.06940)
*Yang Shu*
...
### [8] [Does Splitting a Triage Decision Across Agents Hide Bias or Help Catch It? A Multi-Agent Simulation Study of LLM-Based Resource Allocation Under Audit Capacity Constraints](https://arxiv.org/abs/2608.06949)
*Paul-Peter Arslan*
...
### [9] [CAi Copilot: Reducing Operational Workload in Molecular Design through Intent-Driven Agentic Workflows](https://arxiv.org/abs/2608.06961)
...
### [10] [Not All Problems Are Best Modeled as MILP: A DSL-Centric Framework for Flexible and Accurate Optimization Modeling](https://arxiv.org/abs/2608.07040)
...
### [11] [BONSAI: Evolvability-Guided Tree Search over Skills](https://arxiv.org/abs/2608.07056)
...
### [12] [DocMemo: Dynamic Evidence Discovery via Probabilistic Memory-Guided Retrieval for Multi-Modal Document Understanding](https://arxiv.org/abs/2608.07067)
...
### [13] [MemOPD: On-Policy Distillation through Memory State Alignment for Long-Horizon Agents](https://arxiv.org/abs/2608.07068)
...
### [14] [Transformers Struggle to Use Their Emergent World Models: Revisiting the Tower of Hanoi, and the Illusion of Thinking](https://arxiv.org/abs/2608.07077)
...
### [15] [MemWM: Memory-Augmented Text-Based World Model](https://arxiv.org/abs/2608.07107)
...
### [16] [How Much, Then Where: Credit-Conserving Action-to-Token Allocation for Multi-Turn Agent Reinforcement Learning](https://arxiv.org/abs/2608.07118)
...
### [18] [A MARL Centered Reference Architecture for Large Language Model Augmentation in Smart Manufacturing](https://arxiv.org/abs/2608.07148)
...
### [19] [NiyamAI - An Intent-Bound AI Agent with Cryptographically Verifiable Guardrails using Zero-Knowledge Proofs](https://arxiv.org/abs/2608.07167)
...
### [20] [Agent Memory Distillation: Empowering Small LLM Agents with Hierarchical Teacher Memory](https://arxiv.org/abs/2608.07169)
...
### [21] [EMAS: Stabilizing Multi-Agent System Evolution through Evidence-Guided Revision](https://arxiv.org/abs/2608.07196)
...
### [22] [Recipes for Creativity: Iterative Generation and Evaluation in Large Language Models](https://arxiv.org/abs/2608.07243)
...
### [23] [Winning by Peeking: Unenforced Budgets and Test-Set Selection Inflate Short-Budget AutoML Comparisons](https://arxiv.org/abs/2608.07303)
...
### [24] [$A^2E$ : An End-to-End Agent Auditing Engine](https://arxiv.org/abs/2608.07346)
...
### [25] [ResidencyRL: Reinforcement Learning in Simulated Clinical Environments](https://arxiv.org/abs/2608.07418)
...
### [26] [CoBa: Cost-Effective Test-Time Scaling via Compute-Balanced Routing](https://arxiv.org/abs/2608.07424)
...
### [27] [TEPA: Revoking Stale Memories for Conflict-Robust Language Agents](https://arxiv.org/abs/2608.07429)
*Yan Zhou,Yue Ouyang,Kaiyang Zheng,Suncheng Xiang*
...
### [28] [Fisher-R1: Training LLM Agents for Reliable Hypothesis Testing](https://arxiv.org/abs/2608.07437)
...
### [29] [PsychoAgent: An Affect-Sensitive Cognitive Architecture for Conflict-Aware Memory in LLM Agents](https://arxiv.org/abs/2608.07438)
...
### [30] [Blast Radius](https://arxiv.org/abs/2608.07440)
...
### [31] [SkillProx: Self-Evolving Agent Skills via Proximal Textual Gradient Descent](https://arxiv.org/abs/2608.07449)
...
### [32] [Characterizing the Quality Profile of AI-Generated C++ in Production](https://arxiv.org/abs/2608.06640)
...
Selection reason: 大规模实证分析 AI 生成 C++ 代码的性能与维护质量，并验证 taxonomy 反馈可降低静态告警和计算开销。
...
### [33] [Online Monitoring and Corrective Steering of Programming Agents](https://arxiv.org/abs/2608.06701)
...
Selection reason: LivePlan 用规则监控器加 LLM 顾问对编程 agent 在线纠偏，SWE-bench 平均提升 9.9% 且成本极低。
...
Selection reason: PMCoder 将分层规划与情景记忆双向耦合，提升 issue 修复率并减少重复失败动作，机制可迁移。
...
### [35] [Beyond Text Matching: Towards Reference-Free Evaluation for Human-Oriented Binary Reverse Engineering](https://arxiv.org/abs/2608.07038)
...
Selection reason: 提出 BinJudgeBench 和自适应 LLM-as-Judge 路由，为反编译可读性等代码评估提供可迁移的无参考评测方法。
...
### [36] [Towards Assurance Closure in AI-Native Large-Scale Agile Software Development](https://arxiv.org/abs/2608.07317)
*Ricardo Britto*
...
Selection reason: 面向 AI-native 软件开发的 assurance closure 架构，提出机器可操作的保证推理缺口，对 agent 可靠性设计有参考价值。
...
### [37] [PACE: Primitive-Aware Code Evolution for Automated Algorithm Design](https://arxiv.org/abs/2608.07395)
...
Selection reason: PACE 用可执行算法原语解耦局部逻辑与整体程序，实现跨程序代码级演化，直接适用于自动算法设计优化。
