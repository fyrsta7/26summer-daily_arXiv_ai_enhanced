...
### [1] [Generalization Bounds of Emergent Communications for Agentic AI Networking](http://arxiv.org/abs/2605.08613v1)
...
### [2] [MIND-Skill: Quality-Guaranteed Skill Generation via Multi-Agent Induction and Deduction](http://arxiv.org/abs/2605.08670v1)
...
### [3] [Iterative Critique-and-Routing Controller for Multi-Agent Systems with Heterogeneous LLMs](http://arxiv.org/abs/2605.08686v1)
...
### [4] [SkillMaster: Toward Autonomous Skill Mastery in LLM Agents](http://arxiv.org/abs/2605.08693v2)
...
### [5] [RewardHarness: Self-Evolving Agentic Post-Training](http://arxiv.org/abs/2605.08703v1)
...
### [6] [AgentPSO: Evolving Agent Reasoning Skill via Multi-agent Particle Swarm Optimization](http://arxiv.org/abs/2605.08704v2)
...
### [7] [Done, But Not Sure: Disentangling World Completion from Self-Termination in Embodied Agents](http://arxiv.org/abs/2605.08747v4)
...
### [8] [AHD Agent: Agentic Reinforcement Learning for Automatic Heuristic Design](http://arxiv.org/abs/2605.08756v1)
...
### [9] [EvoMAS: Learning Execution-Time Workflows for Multi-Agent Systems](http://arxiv.org/abs/2605.08769v1)
...
### [10] [Mirror, Mirror on the Wall: Can VLM Agents Tell Who They Are at All?](http://arxiv.org/abs/2605.08816v1)
...
### [11] [How You Begin is How You Reason: Driving Exploration in RLVR via Prefix-Tuned Priors](http://arxiv.org/abs/2605.08817v1)
...
### [12] [When Agents Overtrust Environmental Evidence: An Extensible Agentic Framework for Benchmarking Evidence-Grounding Defects in LLM Agents](http://arxiv.org/abs/2605.08828v2)
...
### [13] [Ace-Skill: Bootstrapping Multimodal Agents with Prioritized and Clustered Evolution](http://arxiv.org/abs/2605.08887v1)
...
### [14] [OPT-BENCH: Evaluating the Iterative Self-Optimization of LLM Agents in Large-Scale Search Spaces](http://arxiv.org/abs/2605.08904v1)
...
### [15] [Forge: Quality-Aware Reinforcement Learning for NP-Hard Optimization in LLMs](http://arxiv.org/abs/2605.08905v1)
...
### [16] [Internalizing Safety Understanding in Large Reasoning Models via Verification](http://arxiv.org/abs/2605.08930v1)
...
### [17] [PnP-Corrector: A Universal Correction Framework for Coupled Spatiotemporal Forecasting](http://arxiv.org/abs/2605.08935v3)
...
### [18] [Self-ReSET: Learning to Self-Recover from Unsafe Reasoning Trajectories](http://arxiv.org/abs/2605.08936v1)
...
### [19] [MDGYM: Benchmarking AI Agents on Molecular Simulations](http://arxiv.org/abs/2605.08941v1)
...
### [20] [Agentic AI Scientists Are Not Built For Autonomous Scientific Discovery](http://arxiv.org/abs/2605.08956v1)
...
### [21] [Learning to Explore: Scaling Agentic Reasoning via Exploration-Aware Policy Optimization](http://arxiv.org/abs/2605.08978v2)
...
### [22] [Re$^2$Math: Benchmarking Theorem Retrieval in Research-Level Mathematics](http://arxiv.org/abs/2605.09012v1)
...
### [23] [SearchSkill: Teaching LLMs to Use Search Tools with Evolving Skill Banks](http://arxiv.org/abs/2605.09038v3)
...
### [24] [Containment Verification: AI Safety Guarantees Independent of Alignment](http://arxiv.org/abs/2605.09045v2)
...
Selection reason: 对agentic框架进行形式化验证，为代码agent的安全性提供可迁移的验证方法论。
...
### [25] [CauSim: Scaling Causal Reasoning with Increasingly Complex Causal Simulators](http://arxiv.org/abs/2605.09079v1)
...
### [26] [Token Economics for LLM Agents: A Dual-View Study from Computing and Economics](http://arxiv.org/abs/2605.09104v1)
...
### [27] [MCP-Cosmos: World Model-Augmented Agents for Complex Task Execution in MCP Environments](http://arxiv.org/abs/2605.09131v1)
...
### [28] [Methods for Formal Verification of Agent Skills: Three Layers Toward a Mechanically Checkable Capability-Containment Proof](http://arxiv.org/abs/2605.23951v1)
*Alfredo Metere*
...
### [29] [BoostAPR: Boosting Automated Program Repair via Execution-Grounded Reinforcement Learning with Dual Reward Models](http://arxiv.org/abs/2605.09134v3)
...
Selection reason: 基于执行反馈的强化学习与行级信用分配，直接用于自动程序修复，与coding agent高度相关。
...
### [30] [FORTIS: Benchmarking Over-Privilege in Agent Skills](http://arxiv.org/abs/2605.09163v3)
...
### [31] [CIVeX: Causal Intervention Verification for Language Agents](http://arxiv.org/abs/2605.09168v1)
*Fabio Rovai*
...
### [32] [Open Ontologies: Tool-Augmented Ontology Engineering with Stable Matching Alignment](http://arxiv.org/abs/2605.09184v1)
*Fabio Rovai*
...
### [33] [Agentic MIP Research: Accelerated Constraint Handler Generation](http://arxiv.org/abs/2605.09186v1)
...
### [34] [Evidence Over Plans: Online Trajectory Verification for Skill Distillation](http://arxiv.org/abs/2605.09192v2)
...
### [35] [Learning the Preferences of a Learning Agent](http://arxiv.org/abs/2605.09217v1)
...
### [36] [EvidenT: An Evidence-Preserving Framework for Iterative System-Level Package Repair](http://arxiv.org/abs/2605.08621v1)
...
Selection reason: 证据保留的系统级包修复框架，闭循环验证，大幅提升agent修复成功率。
...
### [37] [Semantic Voting: Execution-Grounded Consensus for LLM Code Generation](http://arxiv.org/abs/2605.08680v1)
...
Selection reason: 执行指纹聚类的语义投票，改进无oracle条件下的代码生成选择方法。
...
### [38] [A Learning Method for Symbolic Systems Using Large Language Models](http://arxiv.org/abs/2605.08694v1)
...
Selection reason: LLM挖掘可复用证明策略并集成到符号证明器，可配合agent形式化验证。
...
### [39] [Debugging the Debuggers: Failure-Anchored Structured Recovery for Software Engineering Agents](http://arxiv.org/abs/2605.08717v2)
...
Selection reason: 失败锚定的结构化恢复框架，显著提升SE agent的诊断准确率与恢复率。
...
### [40] [Skill Drift Is Contract Violation: Proactive Maintenance for LLM Agent Skill Libraries](http://arxiv.org/abs/2605.10990v1)
...
Selection reason: 将技能漂移视为契约违反，实现精确的agent技能库维护与修复。
...
### [41] [Using Semantic Distance to Estimate Uncertainty in LLM-Based Code Generation](http://arxiv.org/abs/2605.09023v1)
...
Selection reason: 基于语义距离的不确定性估计直接提升LLM代码生成的正确性验证与可靠性。
...
### [42] [ParityFuzz: Finding Inconsistencies across Solidity Compilers via Fine-Grained Mutation and Differential Analysis](http://arxiv.org/abs/2605.09051v1)
...
Selection reason: 面向Solidity编译器的差分模糊测试与交叉编译器不一致检测，属于软件测试与程序分析方法。
...
### [43] [Evaluating LLM-Generated Code: A Benchmark and Developer Study](http://arxiv.org/abs/2605.09059v2)
...
Selection reason: 提出多层级代码生成评估方法与开发者调研，弥补正确性之外的代码质量评测空缺。
...
### [44] [Flame3D: Zero-shot Compositional Reasoning of 3D Scenes with Agentic Language Models](http://arxiv.org/abs/2605.09218v1)
...
### [45] [PrepBench: How Far Are We from Natural-Language-Driven Data Preparation?](http://arxiv.org/abs/2605.08687v1)
...
### [46] [Detect, Localize, and Explain: Interactive Hierarchical Log Anomaly Analytics with LLM Augmentation](http://arxiv.org/abs/2605.09222v1)
...
Selection reason: 层次化日志异常检测结合LLM解释，对agent调试与可观测性有参考价值。
...
Selection reason: 草图化归纳推理时扩展，以结构化方式提升小模型代码生成的性价比。
...
### [56] [Geometry Guided Self-Consistency for Physical AI](http://arxiv.org/abs/2605.08638v1)
...
### [57] [Octopus Protocol: One-Shot Hardware Discovery and Control for AI Agents via Infrastructure-as-Prompts](http://arxiv.org/abs/2605.09055v1)
...
### [58] [ARES-LSHADE: Autoresearch-Enhanced LSHADE with Memetic Polish for the GNBG Benchmark](http://arxiv.org/abs/2605.13877v2)
...
### [59] [Evolutionary Ensemble of Agents](http://arxiv.org/abs/2605.09018v3)
*Zongmin Yu,Liu Yang*
...
### [60] [AgentCollabBench: Diagnosing When Good Agents Make Bad Collaborators](http://arxiv.org/abs/2605.08647v1)
...
### [61] [AgentForesight: Online Auditing for Early Failure Prediction in Multi-Agent Systems](http://arxiv.org/abs/2605.08715v2)
...
### [62] [Generating Leakage-Free Benchmarks for Robust RAG Evaluation](http://arxiv.org/abs/2605.08838v1)
...
### [63] [GAMBIT: A Three-Mode Benchmark for Adversarial Robustness in Multi-Agent LLM Collectives](http://arxiv.org/abs/2605.09027v2)
...
### [64] [ShadowMerge: A Novel Poisoning Attack on Graph-Based Agent Memory via Relation-Channel Conflicts](http://arxiv.org/abs/2605.09033v3)
...
### [65] [The Art of the Jailbreak: Formulating Jailbreak Attacks for LLM Security Beyond Binary Scoring](http://arxiv.org/abs/2605.09225v1)
...
### [66] [Slipstream: Trajectory-Grounded Compaction Validation for Long-Horizon Agents](http://arxiv.org/abs/2605.08580v1)
...
### [67] [Robust Multi-Agent LLMs under Byzantine Faults](http://arxiv.org/abs/2605.09076v2)
...
### [68] [Internal vs. External: Comparing Deliberation and Evolution for Multi-Agent Constitutional Design](http://arxiv.org/abs/2605.09128v1)
