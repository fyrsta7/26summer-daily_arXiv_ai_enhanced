...
- [Imperative Interference: Social Register Shapes Instruction Topology in Large Language Models](https://arxiv.org/abs/2603.25015) — 相关度 0.60：揭示指令措辞和社会语域对LLM指令遵循的影响，可迁移到编码agent系统提示词设计。
- [Imperative Interference: Social Register Shapes Instruction Topology in Large Language Models](https://arxiv.org/abs/2603.25015) — 相关度 0.60：揭示指令措辞和社会语域对LLM指令遵循的影响，可迁移到编码agent系统提示词设计。
- [The Competence Shadow: Theory and Bounds of AI Assistance in Safety Engineering](https://arxiv.org/abs/2603.25197) — 相关度 0.50：形式化AI辅助安全工程中的能力阴影，对coding agent工作流设计有启发意义。
