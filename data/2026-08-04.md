...
Author affiliations: Roy Zhao: Paul G. Allen School of Computer Science & Engineering, University of Washington; Zhenyu Zhao: Independent Researcher
...
Comments: Accepted at ICGJ 2026 (International Conference on Game Jams, Hackathons and Game Creation Events)
...
Comments: 5 pages, 1 figure. Accepted at the 2026 IEEE International Conference on Software Maintenance and Evolution (ICSME), Tool Demonstration and Data Showcase Track

Author affiliations: Shazzad Hossain: University of Dhaka; Proma Chowdhury: University of Dhaka; Mridha Md. Nafis Fuad: University of Dhaka
...
DOI: [10.1145/3767308.3835852](https://doi.org/10.1145/3767308.3835852)

Author affiliations: Xinkui Zhao: Communication University of Zhejiang / Zhejiang University; Enbo Chen: Communication University of Zhejiang / Zhejiang University; Yifan Zhang: Communication University of Zhejiang / Zhejiang University; Chang Liu: Communication University of Zhejiang / Zhejiang University; Guanjie Cheng: Communication University of Zhejiang / Zhejiang University; Naibo Wang: Communication University of Zhejiang / Zhejiang University; Yueshen Xu: Xidian University
...
- [Preventing Premature Commitment in Coding Agents with an Evidence-Conditioned Execution Layer](https://arxiv.org/abs/2607.28815) — 相关度 0.95：通过执行层强制证据条件化，防止coding agent过早提交，SWE-bench提升明显且省token。
- [Reusing Past Repairs Through Hierarchical Trajectory Abstraction for Coding Agents](https://arxiv.org/abs/2607.29658) — 相关度 0.95：将历史修复轨迹分层抽象为可复用计划，显著提升多个代码修复代理在SWE-bench上的表现。
- [AuditCoder: Responsibility-Preserving Task Graphs for Auditable Code Generation and Bounded Repair](https://arxiv.org/abs/2607.29529) — 相关度 0.90：提出责任保持任务图与受限修复机制，直接关联代码生成代理的可审计性和修复流程。
- [Validation Evidence in LLM Repair Agents: How Much of What Passes Actually Tests the Bug?](https://arxiv.org/abs/2607.28871) — 相关度 0.90：系统分析修复agent验证证据的有效性，提出BSG-VA框架与反馈机制，直接改进agent修复可靠性。
- [AgenticRepair: Multi-Faceted Program Context Engineering for Agentic Vulnerability Repair](https://arxiv.org/abs/2607.29422) — 相关度 0.85：面向漏洞修复的多维度程序上下文工程，结合多agent协作，显著提升修复成功率。
- [Automated Testing and Repair for Verified Compilers Generated by a Coding Agent](https://arxiv.org/abs/2607.28928) — 相关度 0.85：面向agent生成的验证编译器，提出专门测试与修复方法，并检查reward hacking，对agent产出验证有参考。
- [Beyond Component Testing: Validating Agentic AI Systems](https://arxiv.org/abs/2607.29405) — 相关度 0.85：系统综述agentic AI系统的验证问题，提出轨迹级验证、运行时监控与审计证据结构，对代码代理可靠性研究有直接参考价值。
- [To Add Is Machine, To Delete Is Human: Measuring and Mitigating Deletion Avoidance in LLM Code Editing](https://arxiv.org/abs/2607.28887) — 相关度 0.85：刻画LLM编辑中的删除回避问题并提出CanItDelete基准与缓解方法，对代码编辑agent有直接价值。
- [Execution-First Synthetic Tool-Use Trace Generation for LLM Agents](https://arxiv.org/abs/2607.29175) — 相关度 0.80：提出执行优先的工具轨迹合成框架，生成可执行的监督数据，对工具型agent训练有直接帮助。
- [From Code Review to Code Critique: Intent, Drift, and Spotlight for AI-Generated Diffs at Scale](https://arxiv.org/abs/2607.29516) — 相关度 0.80：重构AI代码审查为意图预测、漂移检测与高亮排序，适用于大规模agent生成diff的审查。
- [DragonCrawl: A Generative, Intent-Based Framework for Scalable Mobile End-to-End Testing](https://arxiv.org/abs/2607.28750) — 相关度 0.75：基于LLM意图推理的移动端E2E测试系统，展示了生成式测试的工程化落地与CI/CD集成。
- [From C to Idiomatic Rust: A Ship-of-Theseus Agentic Translation](https://arxiv.org/abs/2607.28835) — 相关度 0.75：提出从C到Rust的agentic增量翻译方法，强调语义保持与分步验证，可迁移到代码迁移任务。
- [Repository-Aware Metamorphic Relation Generation for Augmented Reality Applications using Large Language Models](https://arxiv.org/abs/2607.28775) — 相关度 0.70：面向AR应用的仓库感知蜕变关系生成，结合agentic推理，可迁移到通用测试预言构造。
- [Metaphor-Induced Algorithmic Steering: Cross-Domain Procedural Transfer in LLM Code Generation](https://arxiv.org/abs/2607.28683) — 相关度 0.65：研究隐喻指令对LLM代码生成算法效率的隐性影响并提出检测框架，可迁移至代码agent的提示与效率分析。
- [Alteron: A Tool for Behavioral Regression Testing Across NLP Classifier Versions](https://arxiv.org/abs/2607.29557) — 相关度 0.60：用蜕变测试检测NLP模型版本间的行为回归，可迁移到代码代理版本评测与可靠性验证。
- [Building a Process-Modeling Tool using Agentic AI: An Experience Report on PM4Py-UCM](https://arxiv.org/abs/2607.28825) — 相关度 0.60：报告了用Claude Code构建工具的完整开发记录与验证策略，对agent辅助软件开发有实践指导。
- [Code Is the Body: Agent-Owned Software Bodies for Recursive Evolution and Descent](https://arxiv.org/abs/2607.28691) — 相关度 0.60：提出agent源码体、递归进化与治理架构，对代码agent的版本化与受控自演化有参考价值。
- [Metamorphic Testing of Transpilers via Mutation Consistency of Programs](https://arxiv.org/abs/2607.29247) — 相关度 0.60：针对transpiler的蜕变测试方法，利用源码级变化一致性，可迁移到编译器/转换器测试。
- [Reducing Data Movement in the Galerkin Product of Block Algebraic Multigrid on GPUs](https://arxiv.org/abs/2607.28891) — 相关度 0.60：针对GPU上稀疏矩阵乘积的访存优化与建模，提供算法空间映射和调度变体选择方法，可启发自动调优。
- [A Formalism-Aware Reward Loop for Handwritten UML-to-PlantUML Generation](https://arxiv.org/abs/2607.28987) — 相关度 0.55：用结构化模型奖励（XMI/CFG）优化UML生成，奖励设计思想可迁移到代码结构化验证。
