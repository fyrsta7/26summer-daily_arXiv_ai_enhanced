...
### [6] [An Ontology-Guided, Deduplication-Aware Extraction Layer for Knowledge Graph Construction from Heterogeneous Documents](https://arxiv.org/abs/2607.28662)
...
### [7] [How Hard Does It Think? Analyzing Step-Aware Reasoning Energy in LLM Chain-of-Thought Trajectories](https://arxiv.org/abs/2607.28674)
...
### [8] [ViSAGE: Constructing Self-Correcting Memories for Long-Form Video Understanding](https://arxiv.org/abs/2607.28678)
...
### [9] [Library Reachability in LSR-Synth: How Anti-Memorization Design Changes the Measurement of Symbolic Discovery](https://arxiv.org/abs/2607.28684)
...
### [10] [Safety, or Just Capability? A Validity Audit of Agent-Safety Benchmarks](https://arxiv.org/abs/2607.28685)
...
### [12] [Model or Harness? An Interaction-Centric Taxonomy for Localizing Agent Failures](https://arxiv.org/abs/2607.28802)
...
### [13] [Best Friends, Not Forever: Evaluating Long-Horizon Persona Collapse and Behavioral Drift in AI Companions](https://arxiv.org/abs/2607.28818)
...
### [14] [NeSyFS: A Neuro-symbolic Fast-Slow Thinking Framework for LLM Agent under Partial Observability](https://arxiv.org/abs/2607.28942)
...
### [15] [MerchantBench: Benchmarking LLM Agents for Long-Term Coherence in E-Commerce Operations](https://arxiv.org/abs/2607.28956)
...
### [16] [Scaling Scientific Discovery Environments for Turn-Level Agentic RL](https://arxiv.org/abs/2607.28990)
...
### [17] [Evidence-Grounded Constraint Checking in Construction Documents](https://arxiv.org/abs/2607.29058)
...
### [18] [Harnessing the Wisdom of LLM Crowds through Complementarity-Driven Iterative Collaboration](https://arxiv.org/abs/2607.29087)
...
### [19] [CAGE: Certified Authorization under Typed-Return Uncertainty for Tool-Using Agents](https://arxiv.org/abs/2607.29190)
...
### [20] [Beyond Component Testing: Validating Agentic AI Systems](https://arxiv.org/abs/2607.29405)
...
Selection reason: 系统综述agentic AI系统的验证问题，提出轨迹级验证、运行时监控与审计证据结构，对代码代理可靠性研究有直接参考价值。
...
### [21] [MirrorCraft: Paired Evaluation under Hidden Rule Changes in Minecraft](https://arxiv.org/abs/2607.29218)
...
### [22] [Don't Mix Rewards, Mix Policies: Policy Decomposition and Optimization for Multi-Reward RL](https://arxiv.org/abs/2607.29246)
...
### [23] [Tool Specifications Matter: Uncovering and Mitigating Safety Risks in AI Agents](https://arxiv.org/abs/2607.29254)
...
### [24] [MAGA: Multi-Platform Self-Fusion of GUI Agents via Structured Action Distillation](https://arxiv.org/abs/2607.29320)
...
### [25] [ModelEquivBench: Certifying Multi-Relational Evaluation of LLM-Generated Optimization Models](https://arxiv.org/abs/2607.29431)
...
### [26] [Beyond Retrieval: Analytic Memory for Multimodal Agents](https://arxiv.org/abs/2607.29440)
...
### [27] [Self-Play Meets Skill Evolution: Self-Evolving Search Agents that Pose, Solve, and Remember](https://arxiv.org/abs/2607.29468)
...
### [28] [AMTFV: Agentic Mathematical Tool-Flow Verification for LLM Self-Correction](https://arxiv.org/abs/2607.29549)
...
### [29] [LEMUR: Learning to Align with Multi-Objective Reinforcement Learning from Preference Feedback](https://arxiv.org/abs/2607.29559)
...
### [30] [DungeonBench: A Benchmark for Rules-Rich Tactical Reasoning in Dungeons & Dragons Combat](https://arxiv.org/abs/2607.29577)
...
### [31] [AgentHPOBench: A Benchmark For Evaluating LLM Agents as Sequential Hyperparameter Optimizers](https://arxiv.org/abs/2607.29626)
...
### [33] [Metaphor-Induced Algorithmic Steering: Cross-Domain Procedural Transfer in LLM Code Generation](https://arxiv.org/abs/2607.28683)
...
Selection reason: 研究隐喻指令对LLM代码生成算法效率的隐性影响并提出检测框架，可迁移至代码agent的提示与效率分析。
...
### [34] [Code Is the Body: Agent-Owned Software Bodies for Recursive Evolution and Descent](https://arxiv.org/abs/2607.28691)
...
Selection reason: 提出agent源码体、递归进化与治理架构，对代码agent的版本化与受控自演化有参考价值。
...
### [35] [DragonCrawl: A Generative, Intent-Based Framework for Scalable Mobile End-to-End Testing](https://arxiv.org/abs/2607.28750)
...
Selection reason: 基于LLM意图推理的移动端E2E测试系统，展示了生成式测试的工程化落地与CI/CD集成。
...
### [36] [Repository-Aware Metamorphic Relation Generation for Augmented Reality Applications using Large Language Models](https://arxiv.org/abs/2607.28775)
...
Selection reason: 面向AR应用的仓库感知蜕变关系生成，结合agentic推理，可迁移到通用测试预言构造。
...
### [37] [Preventing Premature Commitment in Coding Agents with an Evidence-Conditioned Execution Layer](https://arxiv.org/abs/2607.28815)
...
Selection reason: 通过执行层强制证据条件化，防止coding agent过早提交，SWE-bench提升明显且省token。
...
### [38] [Building a Process-Modeling Tool using Agentic AI: An Experience Report on PM4Py-UCM](https://arxiv.org/abs/2607.28825)
*Daniel Amyot*
...
Selection reason: 报告了用Claude Code构建工具的完整开发记录与验证策略，对agent辅助软件开发有实践指导。
...
### [39] [From C to Idiomatic Rust: A Ship-of-Theseus Agentic Translation](https://arxiv.org/abs/2607.28835)
*Vasily A. Sartakov*
...
Selection reason: 提出从C到Rust的agentic增量翻译方法，强调语义保持与分步验证，可迁移到代码迁移任务。
...
### [40] [Validation Evidence in LLM Repair Agents: How Much of What Passes Actually Tests the Bug?](https://arxiv.org/abs/2607.28871)
...
Selection reason: 系统分析修复agent验证证据的有效性，提出BSG-VA框架与反馈机制，直接改进agent修复可靠性。
...
### [41] [To Add Is Machine, To Delete Is Human: Measuring and Mitigating Deletion Avoidance in LLM Code Editing](https://arxiv.org/abs/2607.28887)
...
Selection reason: 刻画LLM编辑中的删除回避问题并提出CanItDelete基准与缓解方法，对代码编辑agent有直接价值。
...
### [42] [Reducing Data Movement in the Galerkin Product of Block Algebraic Multigrid on GPUs](https://arxiv.org/abs/2607.28891)
*Mark F. Adams*
...
Selection reason: 针对GPU上稀疏矩阵乘积的访存优化与建模，提供算法空间映射和调度变体选择方法，可启发自动调优。
...
### [43] [Automated Testing and Repair for Verified Compilers Generated by a Coding Agent](https://arxiv.org/abs/2607.28928)
*Martin Rinard*
...
Selection reason: 面向agent生成的验证编译器，提出专门测试与修复方法，并检查reward hacking，对agent产出验证有参考。
...
### [44] [A Formalism-Aware Reward Loop for Handwritten UML-to-PlantUML Generation](https://arxiv.org/abs/2607.28987)
...
Selection reason: 用结构化模型奖励（XMI/CFG）优化UML生成，奖励设计思想可迁移到代码结构化验证。
...
### [45] [Execution-First Synthetic Tool-Use Trace Generation for LLM Agents](https://arxiv.org/abs/2607.29175)
...
Selection reason: 提出执行优先的工具轨迹合成框架，生成可执行的监督数据，对工具型agent训练有直接帮助。
...
### [46] [Metamorphic Testing of Transpilers via Mutation Consistency of Programs](https://arxiv.org/abs/2607.29247)
...
Selection reason: 针对transpiler的蜕变测试方法，利用源码级变化一致性，可迁移到编译器/转换器测试。
...
### [47] [AgenticRepair: Multi-Faceted Program Context Engineering for Agentic Vulnerability Repair](https://arxiv.org/abs/2607.29422)
...
Selection reason: 面向漏洞修复的多维度程序上下文工程，结合多agent协作，显著提升修复成功率。
...
### [48] [From Code Review to Code Critique: Intent, Drift, and Spotlight for AI-Generated Diffs at Scale](https://arxiv.org/abs/2607.29516)
...
Selection reason: 重构AI代码审查为意图预测、漂移检测与高亮排序，适用于大规模agent生成diff的审查。
...
### [49] [AuditCoder: Responsibility-Preserving Task Graphs for Auditable Code Generation and Bounded Repair](https://arxiv.org/abs/2607.29529)
...
Selection reason: 提出责任保持任务图与受限修复机制，直接关联代码生成代理的可审计性和修复流程。
...
### [50] [Alteron: A Tool for Behavioral Regression Testing Across NLP Classifier Versions](https://arxiv.org/abs/2607.29557)
...
Selection reason: 用蜕变测试检测NLP模型版本间的行为回归，可迁移到代码代理版本评测与可靠性验证。
...
### [51] [Reusing Past Repairs Through Hierarchical Trajectory Abstraction for Coding Agents](https://arxiv.org/abs/2607.29658)
...
Selection reason: 将历史修复轨迹分层抽象为可复用计划，显著提升多个代码修复代理在SWE-bench上的表现。
