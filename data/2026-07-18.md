...
### [3] [MemoHarness: Agent Harnesses That Learn from Experience](https://arxiv.org/abs/2607.14159)
...
### [4] [When a Verified World Model Still Loses: Play-Adequacy vs Prediction-Accuracy in LLM-Synthesized Code World Models](https://arxiv.org/abs/2607.14169)
...
### [6] [Align AI to Dynamic Human-AI Workflows](https://arxiv.org/abs/2607.14240)
...
### [8] [AI Agents Do Not Fail Alone:The Context Fails First](https://arxiv.org/abs/2607.14275)
*Fouad Bousetouane*
...
### [9] [CIPHER: A Decoupled Exploration-Selection Framework for Test-Time Scaling of Data Science Agents](https://arxiv.org/abs/2607.14386)
...
### [10] [CatalogAgent: A Supervisor-mediated Self-Learning System Enabling Context Engineering for GenAI Models](https://arxiv.org/abs/2607.14396)
...
### [11] [Reward-Free Evolving Agents via Pairwise Validator](https://arxiv.org/abs/2607.14408)
...
### [12] [Alipay-PIBench: A Realistic Payment Integration Benchmark for Coding Agents](https://arxiv.org/abs/2607.14573)
...
Selection reason: 支付集成场景的coding agent benchmark，含结构化技能评估和确定性rubric，可迁移到其他仓库级任务。
...
### [13] [Tactile: Giving Computer-Using Agents Hands and Feet](https://arxiv.org/abs/2607.14443)
...
### [14] [MCPEvol-Bench: Benchmarking LLM Agent Performance Across Dynamic Evolutions of MCP Servers](https://arxiv.org/abs/2607.14642)
...
Selection reason: 针对MCP服务器动态演化的agent benchmark，提出11种变异算子，评测工具演化下的适应性，对代码agent有直接参考。
...
### [15] [Step-Level Preference Learning for Generative Agents in Social Simulations](https://arxiv.org/abs/2607.14485)
...
### [16] [Proof-or-Stop: Don't Trust the Agent, Trust the Evidence -- Loop Engineering for Verifiable Evidence-Gated Lifecycle Control](https://arxiv.org/abs/2607.14890)
...
Selection reason: 证据门控生命周期控制方法，防止agent虚假完成，机制可迁移到代码agent的可靠性与验证。
...
### [17] [SAGA: Schema-Aware Grounding for Agentic Text-to-SPARQL Generation](https://arxiv.org/abs/2607.14494)
...
### [18] [RetroAgent: Harnessing LLMs to Search Over Structured Memory for Agentic Retrosynthesis Planning](https://arxiv.org/abs/2607.14512)
...
### [19] [Are LLM-Generated GPU Kernels Production-Ready? A Trace-Driven Benchmark and Optimization Agent](https://arxiv.org/abs/2607.14541)
...
### [20] [Democratizing Agent Deployment Safety: A Structural Monitoring Approach](https://arxiv.org/abs/2607.14570)
...
### [21] [Collaborative Spatial Learning with Multi-LLM Agents in Networked Social Experiments](https://arxiv.org/abs/2607.14574)
...
### [22] [MathCoPilot: An Interactive System for Human-AI Symbiotic Paradigm of Mathematical Research](https://arxiv.org/abs/2607.14582)
...
### [23] [Analytic Abduction: Causal Decomposition and Governed Commitment for Human--AI Coordination](https://arxiv.org/abs/2607.14641)
*Remo Pareschi*
...
### [24] [TopoAgent: A Self-Evolving Topological Agent for Multimodal Scientific Reasoning](https://arxiv.org/abs/2607.14658)
...
### [25] [SmartRAG: Native Graph-Based RAG for Mobile Device](https://arxiv.org/abs/2607.14661)
...
### [26] [Project Kaleidoscope: Contextual, Human-Aligned Evaluation for Real-World AI Applications](https://arxiv.org/abs/2607.14673)
...
### [27] [Reachability-Aware Pretraining for Efficient Target-Oriented Path Exploration in Temporal Knowledge Graph Reasoning](https://arxiv.org/abs/2607.14886)
...
### [28] [SMC-ES: Automated synthesis of formally verified control policies](https://arxiv.org/abs/2607.15003)
...
### [29] [BrainPilot: Automating Brain Discovery with Agentic Research](https://arxiv.org/abs/2607.15079)
...
### [30] [Plover: Steering GUI Agents through Plan-Centric Interaction](https://arxiv.org/abs/2607.15193)
...
### [31] [Self-Evolving Human-Centered Framework for Explainable Depression Symptom Annotation](https://arxiv.org/abs/2607.15202)
...
### [32] [When Words Are Safe But Actions Kill: Probing Physical Danger Beyond Text Safety in Hidden-State Risk Space](https://arxiv.org/abs/2607.15218)
...
### [33] [AutoSynthesis: An agentic system for automated meta-analysis](https://arxiv.org/abs/2607.15247)
...
### [34] [SearchOS-V1: Towards Robust Open-Domain Information-Seeking Agent Collaboration](https://arxiv.org/abs/2607.15257)
...
### [35] [Beyond Object Validation: Relational Conformance in Multi-Artifact Agent Releases](https://arxiv.org/abs/2607.14155)
*Tengjiao Liu*
...
### [36] [Natural-Language to SysMLv2 Translation via Conformance-Driven Iterative Refinement](https://arxiv.org/abs/2607.14162)
...
### [37] [Stop Means Stop: Measuring and Repairing the Enforcement Gap in Agent-Framework Control Primitives](https://arxiv.org/abs/2607.14166)
*Sajjad Khan*
...
Selection reason: 系统测量并修复agent框架控制原语的安全漏洞，对agent可靠性、验证和工具设计至关重要。
...
### [38] [Structured Feedback Improves Repair in an LLM Agent Loop](https://arxiv.org/abs/2607.14167)
...
Selection reason: 验证结构化反馈对LLM agent修复循环的提升，直接作用于代码agent的验证-修复流程。
...
### [39] [Quantize with Confidence? An Empirical Study of Quantization for Code Generation](https://arxiv.org/abs/2607.14181)
...
Selection reason: 实证评估量化策略对代码生成模型的影响，为资源受限环境下部署代码agent提供参考。
...
### [40] [NexForge: Scaling Executable Agent Tasks via Requirement-First Synthesis](https://arxiv.org/abs/2607.14186)
...
Selection reason: 需求优先合成可执行agent任务数据，为代码agent训练与评测提供可扩展方法。
...
### [41] [ToolAlignBench: Investigating Alignment Conflicts in Tool-Calling Enabled LLMs](https://arxiv.org/abs/2607.14285)
...
Selection reason: 构建工具调用LLM安全对齐冲突基准，揭示agent遵循指令中的风险，对agent评测有迁移价值。
...
### [42] [Copy-on-Write Scoring: Application-Specific Agent Evaluations](https://arxiv.org/abs/2607.14336)
...
Selection reason: 提出应用内评估agent操作的新型框架（CoW Scoring），可低成本定位agent工具层问题。
...
### [43] [The Prover Is the Judge: Verified Security Software from AI Coding Agents in Ada/SPARK](https://arxiv.org/abs/2607.14340)
*Tobias Philipp*
...
Selection reason: 展示prover验证循环驱动AI coding agent生成可验证安全代码，强调反馈强度上限，对代码agent验证极具参考。
...
### [44] [Why Git Is the Memory Solution for the Agentic Development Lifecycle](https://arxiv.org/abs/2607.14390)
*Frank Guo*
...
Selection reason: 提出git绑定的agent开发记忆方案，解决agent长期记忆与溯源问题，机制可迁移。
...
### [45] [Beyond Generalist LLMs: Specialist Agentic Systems for Structured Code Workflow Execution](https://arxiv.org/abs/2607.14456)
...
Selection reason: 对比专用与通用agent在结构化代码工作流中的表现，展示专用化收益，对构建工程agent有参考。
...
### [46] [Rethinking Issue Resolution for AI/ML Systems](https://arxiv.org/abs/2607.14657)
*Ahmed Adnan,Mushfiqur Rahman,Antu Saha,Oscar Chaparro*

Main category: cs.SE

Comments: In proceedings at the 42nd IEEE International Conference on Software Maintenance and Evolution, ICSME 2026

Selection reason: 定性分析AI/ML系统问题解决工作流，为构建维护AI/ML代码库的agent提供需求洞察。
...
### [47] [Large Language Models for Code Generation from Multilingual Prompts: A Curated Benchmark and a Study on Code Quality](https://arxiv.org/abs/2607.14816)
...
Selection reason: 构建多语言代码生成benchmark并研究代码质量，为评估跨语言coding agent提供数据集与方法。
...
### [48] [StructureClaw: Traceable LLM Agents and an Executable Benchmark for Structural Engineering Workflows](https://arxiv.org/abs/2607.14896)
...
Selection reason: 提出artifact-centered workbench和可执行benchmark，评测结构工程agent的完整工作流，评测方法可迁移到代码agent。
...
### [49] [FirmPilot: Evidence-Guided Multi-Agent Environment Recovery for IoT Firmware Rehosting](https://arxiv.org/abs/2607.14903)
...
Selection reason: 证据引导的多agent框架用于环境恢复，协作和反馈机制可迁移到代码agent的自动修复与验证。
...
### [50] [Leaf: An Instrumentation-based Dynamic Analysis Framework for Rust](https://arxiv.org/abs/2607.15025)
...
Selection reason: Rust动态分析框架，提供事件驱动接口，可作为代码agent的测试和调试基础设施参考。
...
### [51] [MM-IssueLoc: A Controlled Benchmark for Evaluating Visual Evidence in Multimodal Repository-Level Issue Localization](https://arxiv.org/abs/2607.15205)
...
Selection reason: 多模态仓库级issue定位benchmark，评估视觉证据对agent的影响，直接相关代码agent评测。
...
### [52] [Falsifiable Release Gates for Self-Improving Systems](https://arxiv.org/abs/2607.13070)
*Deepak Soni*
