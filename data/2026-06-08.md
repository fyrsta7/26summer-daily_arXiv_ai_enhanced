...
### [1] [Order Matters: Unveiling the Hidden Impact of Macro Placement Sequences via Proxy-Guided LLM Evolution](http://arxiv.org/abs/2606.08904v1)
...
### [2] [Oversight Has a Capacity: Calibrating Agent Guards to a Subjective, Fatiguing Human](http://arxiv.org/abs/2606.08919v1)
*Emre Turan*
...
### [3] [AlloSpatial: Agentic Harness Framework for Spatial Reasoning in Foundation Models](http://arxiv.org/abs/2606.08952v1)
...
### [4] [RTL-BenchLS: A Large-Scale Benchmark for RTL Reasoning and Generation with Large Language Models](http://arxiv.org/abs/2606.08976v1)
...
### [5] [Baichuan-M4: A Clinical-Grade Medical Agent System for Continuous Care](http://arxiv.org/abs/2606.08982v2)
...
### [6] [The Token Not Taken: Sampling, State, and the Stochasticity of AI Agents](http://arxiv.org/abs/2606.08998v3)
...
### [7] [LATTEArena: An Evaluation Framework for LLM-powered Tabular Feature Engineering (Extended Version)](http://arxiv.org/abs/2606.09004v2)
...
### [8] [A Multi-Agent System for IPMSM Design Optimization via an FEA-AI Hybrid Approach](http://arxiv.org/abs/2606.09037v1)
...
### [9] [Agent Economics: An Entropy-Controlled Pluralistic Alignment Framework for Preventing Artificial Hivemind in Autonomous Agents](http://arxiv.org/abs/2606.09039v2)
*Cheonsu Jeong*
...
### [10] [REFLECT: Intervention-Supported Error Attribution for Silent Failures in LLM Agent Traces](http://arxiv.org/abs/2606.09071v1)
...
### [11] [ComplexConstraints and Beyond: Expert Rubrics for RLVR](http://arxiv.org/abs/2606.09118v3)
...
### [12] [MASS: Deep Research for Social Sciences with Memory-Augmented Social Simulation](http://arxiv.org/abs/2606.09198v1)
...
### [13] [FF-JEPA: Long-Horizon Planning in World Models with Latent Planners](http://arxiv.org/abs/2606.09311v1)
...
### [14] [Anything2Skill: Compiling External Knowledge into Reusable Skills for Agents](http://arxiv.org/abs/2606.09316v3)
...
### [15] [Experience Makes Skillful: Enabling Generalizable Medical Agent Reasoning via Self-Evolving Skill Memory](http://arxiv.org/abs/2606.09365v3)
...
### [16] [Capability-Aligned Hierarchical Learning for Tool-Augmented LLMs](http://arxiv.org/abs/2606.09371v1)
...
### [17] [RunAgent SuperBrowser: A Theory of Autonomous Web Navigation Grounded in Human Browsing Behaviour](http://arxiv.org/abs/2606.09399v1)
...
### [18] [Capacity, Not Format: Rethinking Structured Reasoning Failures](http://arxiv.org/abs/2606.09410v1)
*Hengxin Fan*
...
### [19] [WeaveBench: A Long-Horizon, Real-World Benchmark for Computer-Use Agents with Hybrid Interfaces](http://arxiv.org/abs/2606.09426v3)
...
### [20] [Bayesian Selective Latent Inference for Wastewater-First Influenza Monitoring](http://arxiv.org/abs/2606.09433v1)
...
### [21] [AliyunConsoleAgent: Training Web Agents in Real-World Cloud Environments via Distillation and Reinforcement Learning](http://arxiv.org/abs/2606.09447v1)
...
### [22] [Deterministic Integrity Gates for LLM-Assisted Clinical Manuscript Preparation: An Auditable Biomedical Informatics Architecture](http://arxiv.org/abs/2606.09500v4)
...
### [23] [AI Scientists Are Only as Good as Their Evidence: A Stratified Ablation of Proprietary Data and Reasoning Skills in Drug-Asset Valuation](http://arxiv.org/abs/2606.09556v1)
*Yinan Wang*
...
### [24] [PRISM: Recovering Instruction Sets from Language Model Activations](http://arxiv.org/abs/2606.09563v1)
...
### [25] [Self-Explainability in Self-Adaptive and Self-Organising Systems: Status and Research Directions](http://arxiv.org/abs/2606.09568v1)
...
### [26] [From 0-to-1 to 1-to-N: Reproducible Engineering Evidence for MetaAI Recursive Self-Design](http://arxiv.org/abs/2606.09663v1)
...
### [27] [SpatialWorld: Benchmarking Interactive Spatial Reasoning of Multimodal Agents in Real-World Tasks](http://arxiv.org/abs/2606.09669v2)
...
### [28] [(Auto)formalization is supposed to be easy: Trellis process semantics for spelling out rigorous proofs](http://arxiv.org/abs/2606.09674v1)
*Wesley Pegden*
...
### [29] [Proxy Reward Internalization and Mechanistic Exploitation: A Learned Precursor to Reward Hacking and Its Generalization](http://arxiv.org/abs/2606.09711v1)
...
### [30] [SearchSwarm: Towards Delegation Intelligence in Agentic LLMs for Long-Horizon Deep Research](http://arxiv.org/abs/2606.09730v1)
...
### [31] [Multi-Turn Evaluation of Deep Research Agents Under Process-Level Feedback](http://arxiv.org/abs/2606.09748v1)
...
### [32] [Collaborative Human-Agent Protocol (CHAP)](http://arxiv.org/abs/2606.09751v2)
...
### [33] [Auto-Configuring Scientific Simulators with Lightweight Coding-Agent Adapters](http://arxiv.org/abs/2606.09774v2)
...
### [34] [Deployment-Time Memorization in Foundation-Model Agents](http://arxiv.org/abs/2606.10062v2)
...
### [35] [Less Context, Better Agents: Efficient Context Engineering for Long-Horizon Tool-Using LLM Agents](http://arxiv.org/abs/2606.10209v1)
...
Selection reason: 针对工具使用型LLM Agent的上下文剪枝与摘要策略，显著提升长程任务可靠性与效率，可直接迁移到coding agent上下文管理。
...
### [36] [Regimes: An Auditable, Held-Out-Gated Improvement Loop Demonstrated on LongMemEval with ActiveGraph](http://arxiv.org/abs/2606.10241v1)
*Yohei Nakajima*
...
### [37] [Anomaly Detection and Root Cause Analysis for Microservice Systems](http://arxiv.org/abs/2606.09942v1)
*Luan Pham*
...
Selection reason: 面向微服务系统的异常检测与RCA方法与基准，可用于运维分析agent。
...
### [38] [ATTAIN: Automated Exploit Failure Analysis through Trace-Driven Diff Analysis](http://arxiv.org/abs/2606.09060v1)
...
Selection reason: 用LLM工具循环进行差分分析定位漏洞影响版本，展示了agent化程序分析的通用模式。
...
### [39] [Context Rot in AI-Assisted Software Development: Repurposing Documentation Consistency for AI Configuration Artifacts](http://arxiv.org/abs/2606.09090v1)
...
Selection reason: 研究AI配置文件（CLAUDE.md等）的上下文腐化检测，直接关系到持久化agent上下文的维护。
...
### [40] [Autonomous Incident Resolution at Hyperscale: An Agentic AI Architecture for Network Operations](http://arxiv.org/abs/2606.09122v1)
*Arun Malik*
...
Selection reason: 生产级多agent自主事件处理架构，包含分层分解、工具调用与闭环验证，可迁移到软件agent。
...
### [41] [Understanding How Enterprises Adopt the Model Context Protocol for LLM-Driven Software Engineering](http://arxiv.org/abs/2606.09182v1)
...
Selection reason: 对企业MCP采用情况的实证研究，揭示工具集成挑战，对agent工具生态有参考价值。
...
### [42] [Multi-task LLMs for Bug Classification: Efficient Inference with Auxiliary Decoding Heads](http://arxiv.org/abs/2606.09956v1)
*Nikolai Rozanov*
...
Selection reason: 通过多任务LLM与辅助解码头实现高效的行级缺陷定位，推理开销低，适用bug修复agent。
...
### [43] [Data-aware Static Analysis: Improving Detection of Semantic Faults in Machine Learning Code Using Data Characteristics](http://arxiv.org/abs/2606.09957v1)
...
Selection reason: 面向机器学习代码的数据感知静态分析，通过数据特征检测语义错误，可增强代码分析工具。
...
### [44] [Empirical Study for Structured Output Control in LLMs for Software Engineering](http://arxiv.org/abs/2606.09395v1)
...
Selection reason: 系统评估LLM在SE任务中的结构化输出控制，强调格式保真与语义正确性，对agent输出层有关键意义。
...
### [45] [Agentic Persona Generation with Critique-Refinement: An Industrial Evaluation](http://arxiv.org/abs/2606.09637v1)
...
Selection reason: 基于批判-改进循环的agentic人物生成方法，展示了多agent协作与迭代精化的工作流模式。
...
### [46] [FASE: Fast Adaptive Semantic Entropy for Code Quality](http://arxiv.org/abs/2606.09800v1)
...
Selection reason: 快速自适应语义熵用于多智能体代码生成的不确定性量化，低成本高效，可直接集成到agent工作流。
...
### [47] [What makes a harness a harness: necessary and sufficient conditions for an agent harness](http://arxiv.org/abs/2606.10106v1)
...
Selection reason: 对agent harness给出可操作定义与判定测试，有助于代码agent框架与评测的边界澄清，可迁移到agent工程实践。
...
### [48] [TestMap: Evidence Infrastructure for Foundation-Model-Assisted Test Generation](http://arxiv.org/abs/2606.10211v1)
...
Selection reason: 提供自动化、证据驱动的生成测试验证基础设施，记录测试候选全生命周期，对LLM辅助测试生成与评估有直接借鉴价值。
...
### [49] [From Statute to Control Flow: Span-Grounded Deontic Trees for Defeasible Scope Parsing](http://arxiv.org/abs/2606.08932v1)
...
### [50] [PACT: Learning Diverse Diagnostic Strategies via Privileged Synthesis and Branch Consensus](http://arxiv.org/abs/2606.08938v1)
...
### [51] [CARE: A Conformal Safety Layer for Medical Summarization](http://arxiv.org/abs/2606.08969v1)
...
### [52] [SafeRun: Enabling Determinism in LLM Planning for Running](http://arxiv.org/abs/2606.09027v1)
...
### [53] [Memory Beyond Recall: A Dual-Process Cognitive Memory System for Self-Evolving LLM Agents](http://arxiv.org/abs/2606.09483v1)
...
### [54] [Emergence of Context Characteristics Sensitivity in Large Language Models](http://arxiv.org/abs/2606.09525v1)
...
### [55] [Code Is More Than Text: Uncertainty Estimation for Code Generation](http://arxiv.org/abs/2606.09577v1)
...
Selection reason: 提出代码专属的三轴不确定性估计，显著提升代码生成可靠性与选择性预测，直接适用于代码agent。
...
### [56] [AGENTSERVESIM: A Hardware-aware Simulator for Multi-Turn LLM Agent Serving](http://arxiv.org/abs/2606.09613v2)
...
### [57] [End-to-End Context Compression at Scale](http://arxiv.org/abs/2606.09659v1)
...
### [58] [$τ$-Rec: A Verifiable Benchmark for Agentic Recommender Systems](http://arxiv.org/abs/2606.10156v2)
...
### [59] [ReasonRec: A Reasoning-Augmented Multimodal Agent for Unified Recommendation](http://arxiv.org/abs/2606.28357v1)
...
### [60] [ATM: Action-Consistency Transfer Matrix for Diagnosing and Improving Latent World Models](http://arxiv.org/abs/2606.09028v1)
*Jiaheng Chen*
...
### [61] [See More, Think Deeper: Query-Expanded Visual Evidence and Answer-Clue Guided Reflection for Long Video Understanding](http://arxiv.org/abs/2606.09064v1)
...
### [62] [OmniGameArena: A Unified UE5 Benchmark for VLM Game Agents with Improvement Dynamics](http://arxiv.org/abs/2606.09826v1)
...
### [63] [XMedFusion: A Knowledge-Guided Multimodal Perception and Reasoning Framework for Autonomous Medical Systems](http://arxiv.org/abs/2606.14766v1)
...
### [64] [Closing the Prior-Posterior Loop: Self-Reflective Molecular Design with Analysis-Driven LLM Iteration](http://arxiv.org/abs/2606.09520v2)
...
### [65] [Cheap Reward Hacking Detection](http://arxiv.org/abs/2606.08893v1)
...
### [66] [INFUSER: Influence-Guided Self-Evolution Improves Reasoning](http://arxiv.org/abs/2606.09052v3)
...
### [67] [Internalizing Geometric Law: Learning from Solver Residuals for Precision-Critical Generation](http://arxiv.org/abs/2606.09278v1)
...
### [68] [Reasoning Arena: Trace Tournaments When Verifiable Rewards Fall Short](http://arxiv.org/abs/2606.09380v1)
...
### [69] [LargeMonitor: Monitoring Online Task-Free Continual Learning via Large Pretrained Models](http://arxiv.org/abs/2606.09430v1)
...
### [70] [3SPO: State-Score-Supervised Policy Optimization for LLM Agents](http://arxiv.org/abs/2606.09961v1)
...
### [71] [Safe-RULE: Safe Reinforcement UnLEarning](http://arxiv.org/abs/2606.09559v1)
...
### [72] [Bittensor Agent Arenas as a Trajectory Primitive: Distilling a Shopping Agent from ShoppingBench Subnet Traces](http://arxiv.org/abs/2606.10064v1)
...
### [73] [Dropout-GRPO: Variational Stochasticity for Continuous Latent Reasoning](http://arxiv.org/abs/2606.10184v1)
*Wooil Jung*
...
### [74] [SHAPO: Sharpness-Aware Policy Optimization for Safe Exploration](http://arxiv.org/abs/2606.10228v1)
...
### [75] [SpaceVLN: A Zero-Shot Vision-and-Language Navigation Agent with Online Spatial Cognitive Memory and Reasoning](http://arxiv.org/abs/2606.08992v1)
...
### [76] [Harness Engineering for Physical AI: Robot Middleware Is the Harness Layer](http://arxiv.org/abs/2606.09416v1)
...
Selection reason: 将语言agent的harness概念扩展到物理AI，提出了投影、隔离、转移三类强制机制，可启发代码agent的边界控制。
...
### [77] [Targeting World Models to Compromise Robot Learning Pipelines](http://arxiv.org/abs/2606.09499v1)
...
### [78] [ReCoVLA: VLM-Guided Reward Compilation for Failure Recovery in Vision-Language-Action Policies](http://arxiv.org/abs/2606.09630v1)
...
### [79] [FMplex: Model Virtualization for Serving Extensible Foundation Models](http://arxiv.org/abs/2606.09643v1)
...
### [80] [Hardening Agent Benchmarks with Adversarial Hacker-Fixer Loops](http://arxiv.org/abs/2606.08960v1)
...
### [81] [Context-Fractured Decomposition Attacks on Tool-Using LLM Agents: Exploiting Artifact Provenance Gaps](http://arxiv.org/abs/2606.09084v1)
...
### [82] [SecureClaw: Clawing Back Control of LLM Agents](http://arxiv.org/abs/2606.09549v1)
...
### [83] [FuseFSS: Efficient Secure LLM Inference with Function Secret Sharing](http://arxiv.org/abs/2606.09551v1)
...
### [84] [Observability for Delegated Execution in Agentic AI Systems](http://arxiv.org/abs/2606.09692v1)
