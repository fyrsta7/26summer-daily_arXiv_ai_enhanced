...
### [25] [PerfAgent: Profiler-Guided Iterative Refinement for Repository-Level Code Optimization](https://arxiv.org/abs/2607.19653)
...
Selection reason: PerfAgent用profiler引导迭代优化仓库级代码，直接命中SemOpt主题并显著提升优化成功率。
...
### [26] [Context Matters: Improving the Practical Reliability of LLM-Based Unit Test Generation](https://arxiv.org/abs/2607.19682)
...
Selection reason: 上下文感知的LLM单元测试生成结合静态分析，提升编译稳定性，可直接用于代码agent测试环节。
...
### [27] [Bridging Behavior and Implementation: Automated Java Glue Code Generation for Behavior-Driven Development](https://arxiv.org/abs/2607.19703)
...
Selection reason: 分层多agent框架实现行为解释、上下文检索与代码生成，对代码生成agent有迁移价值。
...
### [28] [Towards Automated Formal Verification of zkEVMs Using LLM-Guided Constraint Synthesis](https://arxiv.org/abs/2607.19795)
...
Selection reason: LLM引导约束合成加SMT验证与自动修复，其检索与修复回路可迁移到代码验证类agent。
...
### [29] [Beyond Fail-to-Pass: Iterative Hardening of Co-Generated Bug Reproduction Tests and Fixes](https://arxiv.org/abs/2607.19843)
...
Selection reason: 对共生成的bug复现测试与修复进行迭代加固，直接改进APR agent的验证与修复能力。
...
### [30] [Towards Reliable C-to-Rust Translation with Rule-Guided Reasoning and Reinforcement Learning](https://arxiv.org/abs/2607.19966)
...
Selection reason: 规则引导推理加强化学习的C转Rust翻译，其推理路径构建方法可迁移到可靠代码转换agent。
...
### [31] [Multi-Source and Cross-Scenario Strategy-Guided Code Optimization](https://arxiv.org/abs/2607.20353)
...
Selection reason: 多源跨场景策略引导的LLM代码优化框架，直接对比并超越SemOpt，强相关。
