...
Selection reason: 面向coding agent的轨迹级评测基准，结合形式化验证与轨迹评审，直接相关。
...
### [32] [Articulating Assumptions in AI-Generated Scientific Analyses through Task Decomposition](http://arxiv.org/abs/2607.05762v1)
...
Selection reason: 多智能体任务分解框架用于分析AI生成的科学计算代码，可迁移到代码agent的验证与可解释性设计。
...
### [33] [Detecting Vulnerability-Inducing Commits via Multi-Stage Reasoning with LLM-Based Agents](http://arxiv.org/abs/2607.05772v1)
...
Selection reason: 基于LLM多智能体多阶段推理检测漏洞引入提交，属于软件安全分析且可迁移至代码审查agent。
...
### [34] [Can Large Language Models Generate Observability-Aware Code?](http://arxiv.org/abs/2607.05785v1)
...
Selection reason: 评估agent生成系统的可观测性，揭示仅关注功能正确性的评测盲区，对代码agent评测有启发。
...
### [35] [SCOPE: Leveraging Subgoal Critiques for Code Generation](http://arxiv.org/abs/2607.05810v1)
...
Selection reason: 提出子目标批评器改进代码生成，显著提升pass@1，直接贡献于代码agent的反馈与修正机制。
...
### [36] [Beyond Refusal: A Same-Lineage Study of Aligned and Abliterated LLMs for Vulnerability Analysis](http://arxiv.org/abs/2607.05842v1)
...
Selection reason: 对比同一族系对齐与消融模型的漏洞分析能力，为LLM安全agent的评测与选择提供参考。
...
### [37] [Mitigating Errors in LLM-Generated Web API Invocations via Retrieval-Augmented Generation and Constrained Decoding](http://arxiv.org/abs/2607.05936v1)
...
Selection reason: 通过检索增强生成和约束解码减少LLM生成Web API调用错误，直接提升代码生成可靠性。
...
### [38] [Pre-Training on Software Engineering Texts: Effects on Domain Adaptation and General-Language Understanding](http://arxiv.org/abs/2607.06613v1)
...
Selection reason: 研究软件工程文本的预训练策略，可为编码agent的领域适应提供基础指导。
...
### [39] [Large Language Models Have Unreliable Understanding of Software Engineering Terminology](http://arxiv.org/abs/2607.06004v1)
...
Selection reason: 系统评测LLM对SE术语的理解可靠性，影响编码agent理解需求与生成代码的正确性。
...
### [40] [SWE-Review: Closing the Loop on Issue Resolution with Agentic Code Review](http://arxiv.org/abs/2607.06065v1)
...
Selection reason: 提出agentic代码审查框架与基准，将一次PR生成闭环到审查-修订，直接提升issue解决能力。
...
### [41] [Prompt Coach: An Empirical Evaluation of an Agentic Tutor for Learning Prompt Engineering in Software Development](http://arxiv.org/abs/2607.06074v1)
...
Selection reason: agentic导师在IDE中教授提示工程，对编码agent的人机协作与可用性有参考价值。
...
### [42] [Collaborative Multi-Agent Testing for Emergent Failure Discovery in Autonomous Driving Systems](http://arxiv.org/abs/2607.06078v1)
...
Selection reason: 协作式多智能体测试框架发现自动驾驶系统故障，多agent协作方法可迁移到软件测试agent。
...
### [43] [Agents That Teach: Towards Designing Incidental Learning Back into AI-Assisted Software Development](http://arxiv.org/abs/2607.06101v1)
...
Selection reason: 提出在AI辅助开发中设计“会教学的agent”以维持程序员的附带学习，对编码agent人机协同设计有启示。
...
### [44] [Static Metrics Are Insufficient: Predicting Java Method Energy Usage with Execution Time](http://arxiv.org/abs/2607.06124v1)
*Muhammad Imran,Vincenzo Stoico,Ivano Malavolta*

Main category: cs.SE

Comments: Accepted for publication at the 19th International Conference on the Quality of Information and Communications Technology (QUATIC 2026)

Selection reason: 方法级执行时间与静态指标预测Java能耗，属于profiling/benchmark与性能优化可迁移方法。
...
### [45] [Evaluating Fine-Tuning and Metrics for Neural Decompilation of Dart AOT Binaries](http://arxiv.org/abs/2607.06125v1)
...
Selection reason: 神经反编译基准与pass@k为主指标的评估分析，对LLM代码生成评测有直接借鉴。
...
### [46] [What Resolve Rate Hides: Trajectory Structure Diagnostics for Coding Agents](http://arxiv.org/abs/2607.06184v1)
...
Selection reason: 编码agent轨迹结构诊断框架，揭示resolve rate隐藏的过程信号，直接相关。
...
### [47] [LogicHunter: Testing LLM Agent Frameworks with an Agentic Oracle](http://arxiv.org/abs/2607.06195v1)
...
Selection reason: 针对LLM agent框架的规格驱动模糊测试与agentic oracle，直接相关。
...
### [48] [AgentTether: Graph-Guided Diagnosis and Runtime Intervention for Reliable LLM Agent Operation](http://arxiv.org/abs/2607.06273v1)
...
Selection reason: 图引导的LLM agent运行时诊断与修复，提升可靠性，直接相关。
...
### [49] [UI2App: Benchmarking Visual Interaction Inference in Executable Web Application Generation](http://arxiv.org/abs/2607.06306v1)
...
Selection reason: 从截图生成可执行Web应用的基准，评估交互推断能力，对多模态代码生成agent有参考。
...
### [50] [Specification Grounding Drives Test Effectiveness for LLM Code](http://arxiv.org/abs/2607.06636v1)
...
Selection reason: 规格锚定显著提升LLM代码测试与修复效果，对coding agent测试/修复回路直接相关。
...
### [51] [RuBench: A Repository-Level Agentic Coding Benchmark with Natively Authored Russian Task Specifications](http://arxiv.org/abs/2607.06411v1)
*Evgeny Shilov*

Main category: cs.SE

Comments: 16 pages, 1 figure, 7 tables. Benchmark: 25 natively Russian repository-level agentic coding tasks; 4 product agent configurations, 3 runs each. Data, full trajectories and harness: https://github.com/eugeneshilow/rubench

Selection reason: 仓库级agentic coding基准，含污染检查与轨迹审计，直接相关。
...
### [52] [Reliable and Developer-Aligned Evaluation of Agents for Software Engineering](http://arxiv.org/abs/2607.06713v1)
...
Selection reason: 面向软件工程agent的可靠评测方法论，强调污染感知与轨迹感知指标。
...
### [53] [Deployment Risk Assessment Using Diff-Aware Features: A Case Study at Prime Video](http://arxiv.org/abs/2607.06766v2)
...
Selection reason: 基于diff特征与LLM特征提取的变更风险预测，可迁移到代码审查agent的风险评估。
...
### [54] [REFORGE: A Method for Benchmarking LLMs' Reverse Engineering Capabilities in Decompiled Binary Function Naming](http://arxiv.org/abs/2607.07738v1)
...
Selection reason: 反编译函数命名基准强调对齐不确定性，对代码理解agent评测有参考价值。
...
### [55] [FORGE: Towards Functional Tool-Use Generalization via Keypoint Trajectory Reasoning](http://arxiv.org/abs/2607.05780v1)
...
### [56] [The Balkanization of Execution-Security Research for AI Coding Agents: Isolation, Access Control, and Time-of-Check-to-Time-of-Use Vulnerabilities](http://arxiv.org/abs/2607.05743v1)
...
### [57] [Unicode TAG-Block Concealment of Tool-Metadata Payloads in the Model Context Protocol: An Approval-View Fidelity Gap Across Three Independent Server Implementations](http://arxiv.org/abs/2607.05744v1)
*Mohammadreza Rashidi*
...
Selection reason: 揭示MCP工具元数据中的Unicode隐藏载荷可绕过审批视图，直接影响编码agent的安全性与可靠性。
...
### [58] [Security and Privacy in Agentic AI: Grand Challenges and Future Directions](http://arxiv.org/abs/2607.06608v1)
...
### [59] [i-EXAM: Instructable and Explainable Attack Connectivity Graph Modeler](http://arxiv.org/abs/2607.05888v1)
...
### [60] [When Agents Go Rogue: Activation-Based Detection of Malicious Behaviors in Multi-Agent Systems](http://arxiv.org/abs/2607.06807v1)
...
### [61] [An Experimental Design Approach to Evaluating Agentic AI's Autonomous Model Discovery](http://arxiv.org/abs/2607.06413v1)
...
### [62] [Do You Remember? Toward Memory-Centric Multimodal AI](http://arxiv.org/abs/2607.11919v1)
...
### [63] [When Should LLMs Search? Counterfactual Supervision for Search Routing](http://arxiv.org/abs/2607.05752v1)
*Minho Kim*
...
### [64] [InfluMatch: Frontier-Quality KOL Search at 4B-Model Cost](http://arxiv.org/abs/2607.05968v1)
...
### [65] [From Blueprint to Reality: Modeling and Applying Putnam's Social Capital Theory with LLM-based Multi-agent Simulations](http://arxiv.org/abs/2607.06080v1)
...
### [66] [LLM Agents for Deliberative Collaboration: A Study on Joint Decision Making Under Partial Observability](http://arxiv.org/abs/2607.06157v1)
...
### [67] [Improving LLM-Generated Process Model Quality Through Reinforcement Learning: The Role of Reward Function Design](http://arxiv.org/abs/2607.06175v1)
...
### [68] [Spider 2.0-AIFunc: Extending Real-World Text-to-SQL to AI-Native SQL Workflows](http://arxiv.org/abs/2607.06229v1)
...
### [69] [From Voting to Agent Collaboration: Answer-Type-Aware LLM Pipelines for BioASQ 14b](http://arxiv.org/abs/2607.06452v1)
...
### [70] [What Predicts Correctness in Text-to-SQL? A Selective-Prediction Study](http://arxiv.org/abs/2607.06799v1)
*Robert Richardson*
...
### [71] [A Gold-Standard Study of What Makes a Lightweight Game-Playing Agent Strong](http://arxiv.org/abs/2607.06854v1)
...
### [72] [Harnessing Code Agents for Automatic Software Verification](http://arxiv.org/abs/2607.06341v1)
...
Selection reason: 用通用代码agent自动完成Coq证明，对agent驱动形式化验证有迁移价值。
...
### [73] [Think Before You Grid-Search: Floor-First Triage for LLM Serving](http://arxiv.org/abs/2607.05876v2)
*Yihua Liu*
...
### [74] [Agentic AI for IPoDWDM Network Lifecycle Automation: An MCP-Enabled Architecture](http://arxiv.org/abs/2607.05958v1)
...
### [75] [MCP-Enabled Agentic AI for Autonomous IPoDWDM Network Lifecycle Automation](http://arxiv.org/abs/2607.05975v1)
*Chunmin Xia,Jakub Harbaczewski,Nikhil Dsilva,Julie Raulin,Dominic Schneider,Achim Autenrieth*
...
### [76] [From Agentic to Autogenic Network Management for AI-Native 6G and Beyond: A Standards Perspective](http://arxiv.org/abs/2607.06786v1)
