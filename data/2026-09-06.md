...
### [1] [Caught in the Story: Narrative Captivity in Multi-turn LLMs Conversation](https://arxiv.org/abs/2609.03407)
...
### [2] [DuplexSpeechBench-IFEval: Evaluating Implicit Instruction Following in Full-Duplex Voice Agents](https://arxiv.org/abs/2609.03423)
...
### [3] [HalluPeer: A Taxonomy-driven Benchmark for Detecting Hallucinations in Scientific Peer Reviews](https://arxiv.org/abs/2609.03580)
...
### [5] [STAIR (STructure Aware Information Retriever): A novel dataset and LLM based retriever for document structure augmentation](https://arxiv.org/abs/2609.03874)
...
### [6] [Epistemic Warrant for LLM Recommendations: Characterizing the Basis for Reliance When Ground Truth Is Unavailable](https://arxiv.org/abs/2609.04127)
...
### [7] [From Deceptive Outputs to Deceptive Mechanisms: A Causal Framework for Language-Model Deception Research](https://arxiv.org/abs/2609.04166)
...
Selection reason: 实测现成LLM在软件工程质量判断中误报与漏检的非对称错误模式，对设计代码审查/验证类agent的可靠性有直接参考价值。
...
Selection reason: 验证LLM从源代码提交提取架构设计决策的能力，属代码理解与提交分析方向的通用探索，可迁移到agent的变更理解和规划。
...
### [10] [ATIBA: Grounded Integrity and Quality Checking for Research Papers](https://arxiv.org/abs/2609.04123)
...
Selection reason: 提出LLM“只判断不虚构证据”的grounded验证与幻觉防御工作流，该机制可迁移到代码agent的溯源验证与审查环节。
