...
### [1] [BioInsight: Multi-Agent Orchestration for Interactive Biomedical Knowledge Discovery](http://arxiv.org/abs/2606.20997v1)
...
### [2] [Building Agent Harnesses for Scientific Curation from Multimodal Sources](http://arxiv.org/abs/2606.21005v2)
...
### [3] [Agentic Time Machine as an Infrastructure for Future-Event Forecasting](http://arxiv.org/abs/2606.21013v1)
...
### [4] [Negative Knowledge as Failure-aware Shared Memory for AutoResearch](http://arxiv.org/abs/2606.21024v1)
*Hanchun Wang*
...
### [5] [Answer Engineering: Local Trajectory Editing for Protocol-Constrained Decision Making in Large Language Models](http://arxiv.org/abs/2606.21121v1)
...
### [6] [PulseCX: Breaking the Closed-World Assumption in Real-Time CX](http://arxiv.org/abs/2606.21124v1)
...
### [7] [Trip+: Benchmarking Agents in Personalized Interactive Travel Planning](http://arxiv.org/abs/2606.21169v1)
...
### [8] [ARCO: Adaptive Rubric with Co-Evolution for Multi-Step LLM-Based Agents](http://arxiv.org/abs/2606.21262v1)
...
### [9] [Social World Model for Lifelong Social Intelligence](http://arxiv.org/abs/2606.21315v1)
*Yu Luo*
...
### [10] [Calibration Is Not Control: Why LLM-Agent Oversight Needs Intervention](http://arxiv.org/abs/2606.21399v1)
...
### [11] [Don't Blindly Trust It: How Unreliable Feedback Breaks Tool-Using LLM Agents](http://arxiv.org/abs/2606.21409v1)
...
### [12] [AutoRAS: Learning Robust Agentic Systems with Primitive Representations](http://arxiv.org/abs/2606.21445v1)
...
### [13] [Composing Verifiable Conceptual Models via Building Blocks: Towards Design-Time Verification of Agentic AI Workflows](http://arxiv.org/abs/2606.21565v1)
...
### [14] [Counsel: A Meta-Evaluation Dataset for Agentic Tasks](http://arxiv.org/abs/2606.21627v1)
...
### [15] [ChainWorld: Composing Long-Horizon Desktop Workloads from Atomic OSWorld Tasks](http://arxiv.org/abs/2606.21654v1)
...
### [16] [Hallucination as Context Drift: Synchronization Protocols for Multi-Agent LLM Systems](http://arxiv.org/abs/2606.21666v1)
*Carson Rodrigues*
...
### [17] [Training the Orchestrator: A Supervised Approach to End-to-End PDDL Planning with LLM Agents](http://arxiv.org/abs/2606.21740v1)
...
### [18] [AgentMeter: Evaluating Model-CLI Matching for CLI-Based Local Task-Solving Agents](http://arxiv.org/abs/2606.21140v1)
...
Selection reason: 提出模型-CLI匹配评测基准与成本感知指标，强调本地任务agent应作为模型与CLI整体评测，直接服务agent评测。
...
### [19] [Context-Aware Generative AI for Automated Telecom Test Script Generation](http://arxiv.org/abs/2606.21151v1)
...
Selection reason: 基于知识图谱与MCP的上下文感知测试脚本生成agent，通过增量检测和RAG持续更新测试，方法可迁移到通用测试agent。
...
### [20] [An Exploratory Case Study of LLM-Assisted Refactoring and Gameplay Feature Generation in an Endless Runner Game](http://arxiv.org/abs/2606.21171v1)
...
Selection reason: 对GPT-4o在重构与游戏功能生成中的实证案例，揭示LLM在局部变换与跨系统集成的能力差异，对agent任务边界有参考价值。
...
### [21] [Change Impact Recommendation for JavaScript: Lessons from History and Runtime Analysis](http://arxiv.org/abs/2606.21187v1)
...
Selection reason: 结合历史共变与动态依赖的JavaScript变更影响推荐，分析两类信号互补性，可用于代码变更理解和回归测试agent。
...
### [22] [KBSpec: LLM-driven Formal Specification Generation with Evolving Domain Knowledge Base](http://arxiv.org/abs/2606.21339v1)
...
Selection reason: 利用官方文档与验证器反馈构建自演化知识库，增强LLM生成JML规范，形式化验证agent的有效方法。
...
### [23] [ATLAS: Agentic Taxonomy of Large-Scale Software Ecosystems](http://arxiv.org/abs/2606.21597v1)
...
Selection reason: 用Designer/Classifier双agent与自纠错循环自动构建软件仓库分层分类法，方法可迁移到代码检索与仓库理解agent。
...
### [24] [The Alignment Problem in Constrained Code Generation](http://arxiv.org/abs/2606.21619v1)
...
Selection reason: 系统分析约束解码与LLM/目标语言不对齐导致的正确性灾难，对带形式保证的代码生成agent设计有直接指导意义。
...
### [25] [Assessing Language Models for Salient Class Identification](http://arxiv.org/abs/2606.21629v1)
...
Selection reason: 构建ApacheJavaCM数据集并评估LM直接识别提交中显著类，轻量SLM即可胜任，可用于代码审查agent。
...
### [26] [ConcernBERT: Learning Responsibilities Using Class Membership](http://arxiv.org/abs/2606.21647v1)
...
Selection reason: 用三元组损失和类成员上下文训练代码实体嵌入，支持职责识别与重构下游任务，可迁移到代码检索与架构恢复。
...
### [27] [Is Agent Code Less Maintainable Than Human Code?](http://arxiv.org/abs/2606.21804v1)
...
Selection reason: 评估coding agent生成代码的可维护性，引入CodeThread控制实验框架，直接关系agent代码质量与评测。
...
### [28] [What Context Does a Coding Agent Actually Need to Act?](http://arxiv.org/abs/2607.09691v1)
*Brian Sam-Bodden*
...
### [29] [Task-Differentiated Atomic Skill Expansion and Routing for Continual Learning Across Highly Heterogeneous Tasks](http://arxiv.org/abs/2606.21307v1)
...
### [30] [DataClaw0: Agentic Tailoring Multimodal Data from Raw Streams](http://arxiv.org/abs/2606.21337v1)
...
### [31] [Depth-Entropy Guided Sampling for Training-Free LLM Reasoning](http://arxiv.org/abs/2607.09693v1)
...
### [32] [Decodable but Not Faithful: Coupling Natural-Language Rationales to Programmatic Verifiers](http://arxiv.org/abs/2606.21678v1)
...
### [33] [Beyond the Next Step: Variable-Length Latent World Models for Long-Horizon Planning](http://arxiv.org/abs/2606.21775v1)
...
### [34] [Local LLM Agents as Vulnerable Runtimes:A Source-Code Audit of the Agent Runtime Layer](http://arxiv.org/abs/2606.21071v1)
...
### [35] [Evaluating LLMs for Real-World Web Vulnerability Detection](http://arxiv.org/abs/2606.21397v1)
...
### [36] [Safe to Check, Unsafe to Use: Relinking at the Compression Boundary of LLM Agents](http://arxiv.org/abs/2606.21732v1)
...
### [37] [Scalable Hierarchical Attention Transformers for Multi-Turn Jailbreak Detection in Long Conversations](http://arxiv.org/abs/2606.21082v1)
...
### [38] [AdaMem: Learning What to Remember for Personalized Long-Horizon LLM Agents](http://arxiv.org/abs/2606.21144v1)
...
### [39] [PrivacyAlign: Contextual Privacy Alignment for LLM Agents](http://arxiv.org/abs/2606.21710v1)
...
### [40] [Denoising Iterative Self-Correction: Structured Verification Loops for Reliable LLM Reasoning](http://arxiv.org/abs/2606.21724v1)
...
### [41] [CalVerT: Augmenting Agents with Calibrated Verifier Telemetry Improves Action and Learning in Knowledge-Intensive Tasks](http://arxiv.org/abs/2606.21777v1)
...
### [42] [When Does Overlap Help? OSU-Mem and a Cell-Conditional Analysis of Trajectory Memory for LLM Agents](http://arxiv.org/abs/2606.28376v1)
...
### [43] [LEDGER: Scaling Agentic Document Editing with Dependency-aware Graph Retrieval](http://arxiv.org/abs/2606.28379v1)
...
### [44] [Multiscale Exit-Join Dynamics: Tactical Consensus and Strategic Coalition Formation](http://arxiv.org/abs/2606.26139v1)
*Quanyan Zhu*
...
### [45] [Decoupling the Declarative from the Procedural in Vision-Language-Action Models](http://arxiv.org/abs/2606.21496v1)
...
### [46] [Imitation from Heterogeneous Demonstrations using Grounded Latent-Action World Models](http://arxiv.org/abs/2606.21672v1)
...
### [47] [CORTIS: Text-Only Adaptation of Spoken Language Models for Task-Oriented Voice Agents](http://arxiv.org/abs/2606.21453v1)
...
### [48] [HPP: Hierarchical Programmatic Probing for Long Video Understanding by Decoupling Perception and Reasoning](http://arxiv.org/abs/2606.21734v1)
...
### [49] [SwarmX: Agentic Scheduling for Low-Latency Agentic Systems](http://arxiv.org/abs/2606.21401v2)
