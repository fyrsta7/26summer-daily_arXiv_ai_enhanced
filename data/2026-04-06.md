...
- [Evaluating the Formal Reasoning Capabilities of Large Language Models through Chomsky Hierarchy](https://arxiv.org/abs/2604.02709) — 相关度 0.60：基于乔姆斯基层次结构评测LLM形式推理能力，可迁移到代码Agent的推理能力评估。
- [Evaluating the Formal Reasoning Capabilities of Large Language Models through Chomsky Hierarchy](https://arxiv.org/abs/2604.02709) — 相关度 0.60：基于乔姆斯基层次结构评测LLM形式推理能力，可迁移到代码Agent的推理能力评估。
