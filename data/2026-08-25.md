...
Selection reason: 形式化规格驱动的agentic开发流程与量化治理指标，直接相关于agent化SDLC与验证
...
Selection reason: 终端agent的调查框架，统一架构、能力获取与评测，对coding agent设计有直接参考价值
...
### [9] [Evaluating Skills, Not Just Agents: Agentic Continuous Evaluation of Skills](https://arxiv.org/abs/2608.20614)
...
### [10] [Dual-Cache Latent Space Communication between Heterogeneous Language Models](https://arxiv.org/abs/2608.20617)
...
### [11] [Applying Anthropic Primitives at Large Enterprises: Harness Paradigm for Knowledge Work](https://arxiv.org/abs/2608.20622)
*George Juraj Salapa*
...
Selection reason: 讨论编码代理 harness 的企业级基础设施化，提出统一 harness 与凭证作用域等机制，对 coding agent 架构设计有迁移价值。
...
### [12] [Weighted Memory Tree: Remembering What Matters for Long-Horizon LLM Agents](https://arxiv.org/abs/2608.20631)
...
### [13] [DreamBench-SWE: A Multi-Session Memory-Hygiene Benchmark for Software Agents](https://arxiv.org/abs/2608.20664)
*Sarthak Singh*
...
Selection reason: 为软件代理的多会话记忆卫生提供可执行基准，评估不同外部记忆方法，对代理记忆机制研究直接相关。
...
### [14] [Large Language Models at the Intersection of Software Engineering and Software Security:An Evidence-Centered Structured Survey and Research Agenda](https://arxiv.org/abs/2608.21107)
...
Selection reason: 综述 LLM 在软件工程与安全中的评估设计，提出 assurance framework 和最低报告协议，对代理评测有参考价值。
...
### [15] [Why2Speak: Faithful Reasoning for Abstaining Action Policies](https://arxiv.org/abs/2608.20670)
...
### [16] [CDRL: Certification-Driven Reinforcement Learning for Neutrino Flavor Model Discovery](https://arxiv.org/abs/2608.20686)
...
### [18] [Calibrating Criterion Revision in LLM Agents: Failure Modes and a Trace-Anchored Protocol](https://arxiv.org/abs/2608.20729)
*Guodong Xu*
...
### [19] [CAS: Conformalized Agentic Search via Adaptive Retrieval and Policy Weighting](https://arxiv.org/abs/2608.20771)
...
### [20] [Structure for Reading, Prose for Writing: Asymmetric Structural Conditioning in Multi-Agent Document Authoring](https://arxiv.org/abs/2608.20786)
...
### [21] [Automated Trajectory Evaluation for Mobile Agents via Step-Level Consequence Reasoning and Aggregation](https://arxiv.org/abs/2608.20797)
...
### [22] [Dynamic Context Scheduling: Learning Beyond the Static Universe](https://arxiv.org/abs/2608.20799)
...
### [23] [Certified Multi-Turn Robustness for LLM Safety via Compositional Bounds and Safety Persistence](https://arxiv.org/abs/2608.20820)
...
### [24] [Prediction certification cannot replace explanation certification: a competence envelope for trustworthy AI under compound stress](https://arxiv.org/abs/2608.20825)
...
### [26] [No Judgment Without a Reason: Counterfactual Receipts for Versioned AI Evaluators](https://arxiv.org/abs/2608.20938)
...
### [27] [The Logic of Machine Self-Preservation](https://arxiv.org/abs/2608.20940)
*Cheng Siong Chin*
...
### [28] [Belief Without Behavior: Measuring the Translation of Theory of Mind into Coordinated Social Action in Vision-Language Models](https://arxiv.org/abs/2608.20975)
...
### [29] [Don't Solve, Just Compare: Tiny Advisors for Runtime Intervention in LLM Agents](https://arxiv.org/abs/2608.21027)
...
### [30] [When Trust Meets Truth: Trust-Truth Separability in LLM-as-Judge](https://arxiv.org/abs/2608.21097)
...
### [31] [ReFrame: Evidence-Guided Test-Time Safety Alignment in Multimodal Large Language Models](https://arxiv.org/abs/2608.21100)
...
### [32] [AUSO: Action-Level Unified Skill Optimization from Internalization to Utilization](https://arxiv.org/abs/2608.21292)
...
### [33] [Specification Portability Across LLM Development Agents: Cross-Agent Compatibility in Specification-Driven Software Migration](https://arxiv.org/abs/2608.21208)
...
Selection reason: 研究规格在多agent间的可移植性，为多agent软件工程与评测提供重要实证
...
### [34] [Beyond Fault Localization: A Trajectory-Level Study of LLM Agents for Microservice Root Cause Analysis](https://arxiv.org/abs/2608.21310)
...
Selection reason: 轨迹级评估微服务根因分析agent并设计DiagGuard，直接贡献于agent评测与可靠性
...
### [35] [AI-to-AI Code Reviews of GitHub Pull Requests](https://arxiv.org/abs/2608.21311)
...
Selection reason: 大规模AI-to-AI代码评审数据集与分析，对agent评审和多agent协作有参考价值
...
### [36] [Natural-Language Workflows Are Not Software Yet: Artifact-Driven Compilation for Reliable Agent Execution](https://arxiv.org/abs/2608.21341)
...
Selection reason: 基于工件驱动编译提升agent执行可靠性，直接适用于代码agent工作流可靠化
...
### [37] [AI with Authority, from Application to Silicon](https://arxiv.org/abs/2608.21356)
*Jason Hickey*
...
Selection reason: 证明内核验证下agent驱动硅片设计，展示可迁移到代码agent的验证与可靠性机制
...
### [38] [Testing and Evaluation of Agentic AI Systems In Military Command and Control](https://arxiv.org/abs/2608.20597)
...
Selection reason: 针对军事指挥控制的 agentic AI 测试与评估，提出 assurance case 框架，其评估方法论可迁移到软件代理的可靠性验证。
...
### [39] [Temporal Validity on Real Software Histories: Eliminating Stale-Fact Errors in Code-Assistant Memory over GitHub Fixes](https://arxiv.org/abs/2608.20685)
*Neeraj Yadav*
...
Selection reason: 利用确定性超期记忆消除代码助手 RAG 的陈旧事实错误，在真实 GitHub 修复上验证，对代码代理记忆机制有直接价值。
...
### [40] [BC-Bench: Evaluating Agentic Engineering in a Domain-Specific Language for ERP](https://arxiv.org/abs/2608.20851)
...
Selection reason: 提出面向 ERP 领域特定语言的代理工程基准 BC-Bench，评估 bug 修复与测试生成，对领域 agent 评测有参考价值。
...
### [41] [Trustworthy RAG: An Evaluation Agent for Detecting Misinformation and Knowledge Poisoning in Generative AI Systems](https://arxiv.org/abs/2608.21095)
...
Selection reason: 提出 RAG 评估代理检测知识投毒，并在安全编码助手场景验证，对代理安全与可靠性有参考价值。
