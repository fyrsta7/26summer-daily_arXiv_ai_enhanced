...
Selection reason: 提出生成模型的确定性封装原则，可参考用于构建可靠、可审计的agent系统。
...
### [21] [A Multi-Agent system for Multi-Objective constrained optimization](http://arxiv.org/abs/2606.20236v1)
*Federica Filippini*
...
### [22] [Navigating Unreliable Parametric and Contextual Knowledge: Explicit Knowledge Conflict Resolution for LLM Inference](http://arxiv.org/abs/2606.20245v1)
...
### [23] [SoftSkill: Behavioral Compression for Contextual Adaptation](http://arxiv.org/abs/2606.20333v1)
...
### [24] [Automating SKILL.md Generation for Computer-Using Agents via Interaction Trajectory Mining](http://arxiv.org/abs/2606.20363v1)
...
### [25] [What Do Safety-Aligned LLMs Learn From Mixed Compliance Demonstrations?](http://arxiv.org/abs/2606.20508v1)
...
### [26] [Multi-LCB: Extending LiveCodeBench to Multiple Programming Languages](http://arxiv.org/abs/2606.20517v1)
...
### [27] [LedgerAgent: Structured State for Policy-Adherent Tool-Calling Agents](http://arxiv.org/abs/2606.20529v1)
...
### [28] [Fara-1.5: Scalable Learning Environments for Computer Use Agents](http://arxiv.org/abs/2606.20785v1)
...
### [29] [Process-Reward Tactic Evolution for Long-Horizon Bioinformatics Workflows](http://arxiv.org/abs/2606.20839v1)
...
### [30] [When Do Intrinsic Rewards Work for Code Reasoning? A Comprehensive Study](http://arxiv.org/abs/2606.20881v1)
...
### [31] [Power Systems Agent Benchmark: Executable Evaluation of AI Agents in Electric Power Engineering](http://arxiv.org/abs/2606.20950v2)
*Sergei Trashchenkov*
...
### [32] [AutoACSL: Synthesizing ACSL Specifications by Integrating LLMs with CPG-Based Static Analysis](http://arxiv.org/abs/2606.20969v1)
...
Selection reason: 将LLM与代码属性图静态分析结合，通过Frama-C验证反馈循环自动合成ACSL规范，直接适用于形式化验证agent。
...
### [33] [How Should Agents Read Demonstrations? Hierarchical Structure Beats Flat Action Logs](http://arxiv.org/abs/2606.20978v1)
...
### [34] [Library-Aware Doubles and Iterative Repair for Large Language Model-Generated Unit Tests in OpenSIL Firmware](http://arxiv.org/abs/2606.19725v2)
...
Selection reason: LLM生成单元测试加迭代编译修复的流水线，直接匹配coding agent的测试生成与验证需求。
...
### [35] [Agentic Electronic Design Automation: A Handoff Perspective](http://arxiv.org/abs/2606.19795v1)
...
Selection reason: 以handoff有效性为原则综述agentic EDA，多阶段协调机制可迁移到SE agent工作流。
...
### [36] [The Hidden Environmental Cost of Poor Coding Practices in TensorFlow and Keras Applications: A Study on Resource Leaks and Carbon Emissions](http://arxiv.org/abs/2606.19799v1)
...
Selection reason: 量化ML代码资源泄漏对能耗和碳排放的影响，为代码优化目标提供实证参考。
...
### [37] [CoRaCommit: A VS Code Extension for Commit Message Generation with Exemplar Retrieval](http://arxiv.org/abs/2606.19814v1)
...
Selection reason: 检索增强的commit message生成工具，虽垂直但提供RAG+用户反馈的可迁移思路。
...
### [38] [JAMER: Project-Level Code Framework Dataset and Benchmark on Professional Game Engines](http://arxiv.org/abs/2606.19830v2)
...
Selection reason: 首个专业游戏引擎上的项目级代码数据集与基准，扩展代码生成与agent评测范畴。
...
### [39] [A Topology-Aware, Memory-Centric Architecture that Separates Root-Cause Derivation from Root-Cause Explanation](http://arxiv.org/abs/2606.20758v1)
*Momil Seedat*
...
Selection reason: 分离根因推导与解释的多agent运维架构，可迁移到agent的记忆、诊断与LLM集成设计。
...
### [40] [Repository-Level Solidity Code Generation with Large Language Models: From Prompting to Fine-Tuning](http://arxiv.org/abs/2606.19988v1)
...
Selection reason: 仓库级Solidity代码生成基准及多种调优策略对比，补充特定领域代码生成评测和方法。
...
### [41] [Beyond Static Endpoints: Tool Programs as an Interface for Flexible Agentic Web Services](http://arxiv.org/abs/2606.19992v1)
...
Selection reason: 以可执行tool program封装agent工具意图，降低长程工具调用延迟，可迁移到coding agent工具使用。
...
### [42] [When Lower Privileges Suffice: Investigating Over-Privileged Tool Selection in LLM Agents](http://arxiv.org/abs/2606.20023v2)
...
Selection reason: 研究LLM agent工具选择中的过度特权问题，提出评测集与权限感知后训练防御，可迁移到代码agent的工具反馈与安全评测。
...
### [43] [The Correctness Illusion in LLM-Generated GPU Kernels](http://arxiv.org/abs/2606.20128v1)
*Dipankar Sarkar*
...
Selection reason: 揭示LLM生成GPU kernel在固定shape allclose检查下的正确性幻觉，并用种子模糊+高精度参考验证，直接相关于代码生成正确性评估。
...
### [44] [N-Version Programming with Coding Agents](http://arxiv.org/abs/2606.20158v1)
...
Selection reason: 将N版本编程应用于编码agent，评估多样性投票降低共因失败，对agent可靠性策略有直接借鉴。
...
### [45] [Qiskit Code Migration with LLMs](http://arxiv.org/abs/2606.20173v1)
...
Selection reason: LLM+RAG的Qiskit代码迁移方法，虽然领域特定，但基于分类学的RAG结构化知识检索可迁移到一般代码迁移任务。
...
### [46] [Phoenix: Safe GitHub Issue Resolution via Multi-Agent LLMs](http://arxiv.org/abs/2606.20243v2)
...
Selection reason: 多agent LLM系统解决GitHub issue，包含安全控制与基线测试评估，直接相关于编码agent的工程化与评测。
...
### [47] [AutoPass: Evidence-Guided LLM Agents for Compiler Performance Tuning](http://arxiv.org/abs/2606.20373v1)
...
Selection reason: LLM agent利用编译器和运行时证据调优LLVM编译选项，是SemOpt核心应用，直接相关。
...
### [48] [Formally Verified Code Synthesis for Structured Data Translation in a Medical Internet of Things](http://arxiv.org/abs/2606.20776v1)
...
Selection reason: LLM代码合成结合形式化验证确保schema转换正确性，其验证集成方式可迁移到代码agent输出可靠性验证。
...
### [49] [A Unified Framework for Runtime Verification and Model-Based Diagnosis in LOLA](http://arxiv.org/abs/2606.23720v1)
...
Selection reason: 统一运行时验证与模型诊断的流式语言框架，其诊断机制可参考用于代码agent行为监控与故障定位。
...
### [50] [Probe-and-Refine Tuning of Repository Guidance for Coding Agents](http://arxiv.org/abs/2606.20512v2)
...
Selection reason: 提出探针-精炼调优方法迭代改进仓库指引文件，显著提升SWE-bench Verified修复率，直接相关于coding agent优化。
...
### [51] [The Substrate Collapse: AI Code Generation Invalidates Authorship-Based Knowledge Metrics](http://arxiv.org/abs/2606.20882v1)
*Brett Wheeler*
...
Selection reason: 讨论AI生成代码使作者归属知识度量失效，并提出基于理解的度量与可证伪预测，对评估代码agent产物的长期可维护性有启发。
...
### [52] [OxyMake: A Formally-Specified, Content-Addressable Workflow Engine](http://arxiv.org/abs/2606.20989v2)
*Emmanuel Sérié*
...
Selection reason: 内容寻址缓存工作流引擎，用BLAKE3键替代mtime并给出TLA+形式化协议，可迁移到代码agent的执行缓存与可复现运行。
...
### [53] [Optimal Order of Multi-Agent and General Many-Body Systems](http://arxiv.org/abs/2606.20485v1)
*Jake J. Xia*
...
### [54] [AI Economist Agent: An Agentic Framework for Model-Grounded Economic Analysis with RAG, Knowledge Graphs, and Large Language Models](http://arxiv.org/abs/2606.20041v1)
*Masahiro Kato*
...
### [55] [VOiLA: Vectorized Online Planning with Learned Diffusion Models for POMDP Agents](http://arxiv.org/abs/2606.19729v2)
...
### [56] [Tri-Info: Generalizable, Interpretable Failure Prediction for VLA Models via Information Theory](http://arxiv.org/abs/2606.19998v1)
...
### [57] [Dual-Agent Framework for Cross-Model Verified Translation of Natural-Language Protocols into Robotic Laboratory Platform](http://arxiv.org/abs/2606.20120v1)
...
### [58] [Vesta: A Generalist Embodied Reasoning Model](http://arxiv.org/abs/2606.20905v1)
...
### [59] [SafeSpec: Fast and Safe LLM via Dynamic Reflective Sampling](http://arxiv.org/abs/2606.19755v1)
...
### [60] [NRT-Bench: Benchmarking Multi-Turn Red-Teaming of LLM Operator Agents in Safety-Critical Control Rooms](http://arxiv.org/abs/2606.20408v3)
...
### [61] [Analyzing Defensive Misdirection Against Model-Guided Automated Attacks on Agentic AI Systems](http://arxiv.org/abs/2606.20470v2)
...
### [62] [Calibration Without Comprehension: Diagnosing the Limits of Fine-Tuning LLMs for Vulnerability Detection in Systems Software](http://arxiv.org/abs/2606.20502v1)
...
Selection reason: 构建漏洞检测LLM基准与诊断指标，揭示微调仅改变阈值而未改变决策策略，对代码安全agent评估有重要参考。
...
### [63] [Efficient and Sound Probabilistic Verification for AI Agents](http://arxiv.org/abs/2606.20510v1)
...
### [64] [Sovereign Execution Broker: Enforcing Certificate-Bound Authority in Agentic Control Planes](http://arxiv.org/abs/2606.20520v2)
*Jun He,Deying Yu*
...
### [65] [PromptMark: A Prompt-Guided Iterative-Feedback Framework for Source Code Watermarking](http://arxiv.org/abs/2606.20835v1)
...
Selection reason: 黑盒提示引导源码水印与统计检测，可作为AI生成代码溯源/评测的辅助技术。
...
### [66] [Whose Agent Are You? Multi-Layer Fingerprinting and Attribution of Autonomous Web Agents](http://arxiv.org/abs/2606.20910v1)
...
### [68] [DataMagic: Transforming Tabular Data into Data Insight Video](http://arxiv.org/abs/2606.20388v1)
...
### [69] [Efficiently Representing Algorithms With Chain-of-Thought Transformers](http://arxiv.org/abs/2606.19697v1)
...
### [70] [Connect the Dots: Training LLMs for Long-Lifecycle Agents with Cross-Domain Generalization Via Reinforcement Learning](http://arxiv.org/abs/2606.20002v1)
...
### [71] [Hierarchical Control in Multi-Agent Games: LLM-based Planning and RL Execution](http://arxiv.org/abs/2606.20014v3)
...
### [72] [Sensorimotor World Models: Perception for Action via Inverse Dynamics](http://arxiv.org/abs/2606.20104v1)
...
### [73] [UltraQuant: 4-bit KV Caching for Context-Heavy Agents](http://arxiv.org/abs/2606.20474v2)
...
### [74] [Contagion Networks: Evaluator Preference Propagation in Multi-Agent LLM Systems](http://arxiv.org/abs/2606.20493v2)
*Zewen Liu*
...
### [75] [Is Our Benchmark Enough? An Analysis of Continual Learning for MLLMs](http://arxiv.org/abs/2606.20961v1)
...
### [76] [Artificial collectives of specialists and generalists excel at different tasks](http://arxiv.org/abs/2606.20877v1)
...
### [77] [See-and-Reach: Precise Vision-Language Navigation for UAVs within the Field of View](http://arxiv.org/abs/2606.20045v1)
...
### [78] [GroundShot: Visually Consistent Multi-Shot Long Video Generation via Entity-Grounded Shot Scheduling](http://arxiv.org/abs/2606.20799v2)
...
### [79] [Large Language Models Do Not Always Need Readable Language](http://arxiv.org/abs/2606.19857v1)
...
### [80] [Latent Personal Memory: Represent personal memory as dynamic soft prompts](http://arxiv.org/abs/2606.20911v1)
...
### [81] [Learning What Not to Forget: Long-Horizon Agent Memory from a Few Kilobytes of Learning](http://arxiv.org/abs/2606.20954v1)
...
### [82] [AURA: Adaptive Uncertainty-aware Refinement for LLM-as-a-Judge Auditing](http://arxiv.org/abs/2606.19714v1)
...
### [83] [ScholarQuest: A Taxonomy-Guided Benchmark for Agentic Academic Paper Search in Open Literature Environments](http://arxiv.org/abs/2606.20235v1)
