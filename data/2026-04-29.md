...
### [3] [When to Vote, When to Rewrite: Disagreement-Guided Strategy Routing for Test-Time Scaling](http://arxiv.org/abs/2604.26644v1)
...
### [4] [SciHorizon-DataEVA: An Agentic System for AI-Readiness Evaluation of Heterogeneous Scientific Data](http://arxiv.org/abs/2604.26645v2)
...
### [5] [FutureWorld: A Live Reinforcement Learning Environment for Predictive Agents with Real-World Outcome Rewards](http://arxiv.org/abs/2604.26733v4)
...
### [6] [Bian Que: An Agentic Framework with Flexible Skill Arrangement for Online System Operations](http://arxiv.org/abs/2604.26805v2)
...
### [7] [A Dynamical Framework for Cognitive Processes Based on Transformations and Semantic Equivalence](http://arxiv.org/abs/2605.23942v1)
...
### [8] [When Your LLM Reaches End-of-Life: A Framework for Confident Model Migration in Production Systems](http://arxiv.org/abs/2604.27082v1)
...
Selection reason: 用贝叶斯校准自动指标评估 LLM 迁移，方法可迁移到代码 agent 的少标注评测场景
...
### [9] [End-to-end autonomous scientific discovery on a real optical platform](http://arxiv.org/abs/2604.27092v1)
...
### [10] [Think it, Run it: Autonomous ML pipeline generation via self-healing multi-agent AI](http://arxiv.org/abs/2604.27096v1)
...
### [11] [TRUST: A Framework for Decentralized AI Service v.0.1](http://arxiv.org/abs/2604.27132v1)
...
### [12] [Unpacking Vibe Coding: Help-Seeking Processes in Student-AI Interactions While Programming](http://arxiv.org/abs/2604.27134v1)
...
### [13] [Step-level Optimization for Efficient Computer-use Agents](http://arxiv.org/abs/2604.27151v1)
...
### [14] [Web2BigTable: A Bi-Level Multi-Agent LLM System for Internet-Scale Information Search and Extraction](http://arxiv.org/abs/2604.27221v1)
...
### [15] [When Roles Fail: Epistemic Constraints on Advocate Role Fidelity in LLM-Based Political Statement Analysis](http://arxiv.org/abs/2604.27228v1)
*Juergen Dietrich*
...
### [16] [Reinforced Agent: Inference-Time Feedback for Tool-Calling Agents](http://arxiv.org/abs/2604.27233v1)
...
### [17] [AutoSurfer -- Teaching Web Agents through Comprehensive Surfing, Learning, and Modeling](http://arxiv.org/abs/2604.27253v1)
...
### [18] [LLM-Assisted Empirical Software Engineering: Systematic Literature Review and Research Agenda](http://arxiv.org/abs/2604.26192v1)
...
Selection reason: 系统综述LLM辅助软件工程经验研究方法，虽非代码agent直接技术，但其任务分类和局限总结可为agent评测设计提供背景。
...
### [19] [Adaptive and AI-Augmented Security Testing: A Systematic Survey of Program Analysis, Feedback-Driven Testing, and Hybrid Learning-Based Approaches](http://arxiv.org/abs/2604.27000v1)
...
Selection reason: 系统综述自适应/AI增强安全测试，涵盖模糊测试、LLM测试生成与程序分析混合方法，对代码agent的测试与修复模块有直接参考价值。
...
### [20] [Agentic AI in the Software Development Lifecycle: Architecture, Empirical Evidence, and the Reshaping of Software Engineering](http://arxiv.org/abs/2604.26275v1)
*Happy Bhati*
...
Selection reason: 提出agentic软件工程的六层架构并总结SWE-bench等实证趋势，直接定义编码agent的设计与评估框架。
...
### [21] [Beyond Accuracy: LLM Variability in Evidence Screening for Software Engineering SLRs](http://arxiv.org/abs/2604.27006v1)
...
Selection reason: 量化LLM在筛选任务中的变异性与输入特征影响，对理解agent分类决策的可靠性和可复现性有参考价值。
...
### [22] [An Empirical Study of Speculative Decoding on Software Engineering Tasks](http://arxiv.org/abs/2604.26469v3)
...
Selection reason: 首个针对SE任务的投机解码系统实证，直接加速LLM代码生成/修复，与SemOpt高度相关。
...
### [23] [RepoDoc: A Knowledge Graph-Based Framework to Automatic Documentation Generation and Incremental Updates](http://arxiv.org/abs/2604.26523v1)
...
Selection reason: 基于知识图谱的仓库文档自动生成框架，其分模块生成和图传播更新机制可迁移到代码agent的仓库理解与增量维护。
...
### [24] [Identifying and Characterizing Semantic Clones of Solidity Functions](http://arxiv.org/abs/2604.26526v1)
...
Selection reason: 提出语义克隆检测方法并利用LLM生成注释辅助识别，对代码检索和agent理解代码语义有借鉴意义。
...
### [25] [PICKLES: a Natural Language Framework for Requirement Specification and Model-Based Testing](http://arxiv.org/abs/2604.26572v1)
...
Selection reason: 从自然语言需求自动生成正式模型和测试用例，为coding agent的测试生成提供基于BDD/MBT的灵活框架。
...
### [26] [Graph Construction and Matching for Imperative Programs using Neural and Structural Methods](http://arxiv.org/abs/2604.26578v3)
*Arshad Beg,Diarmuid O'Donoghue,Rosemary Monahan*

Main category: cs.SE

Comments: 14 Pages. Submitted to Sci-K 2026 -- 6th International Workshop on Scientific Knowledge: Representation, Discovery, and Assessment to be held on 25/26 October 2026 - Bari, Italy, co-located with The 25th International Semantic Web Conference, ISWC 2026

Selection reason: 结合语法树与嵌入的图构造方法支持跨语言程序分析和验证件复用，可直接用于代码agent的语义表示与匹配。
...
### [27] [Recommendations for Efficient and Responsible LLM Adoption within Industrial Software Development](http://arxiv.org/abs/2604.26590v1)
...
Selection reason: 多案例研究给出LLM在工业软件开发的实施建议，其中人工监督和工作流集成对部署coding agent有实际指导价值。
...
### [28] [TDD Governance for Multi-Agent Code Generation via Prompt Engineering](http://arxiv.org/abs/2604.26615v1)
...
Selection reason: 将TDD原则编码为多agent代码生成的流程治理机制，直接涉及agent工作流约束和验证门控，与代码agent可靠性高度相关。
...
### [29] [Will It Break in Production? Metric-Driven Prediction of Residual Defects in Python Systems](http://arxiv.org/abs/2604.26667v1)
...
Selection reason: 基于度量和代码嵌入的缺陷预测方法，对代码质量评估和agent修复优先级排序有参考价值。
...
### [30] [Which Types of Heterogeneity Matter for Root Cause Localization in Microservice Systems ?](http://arxiv.org/abs/2604.26670v1)
...
Selection reason: 面向微服务根因定位的异构建模与主动学习方法，可迁移到代码 agent 的故障诊断与调试环节
...
### [31] [What Makes Software Bugs Escape Testing? Evidence from a Large-Scale Empirical Study](http://arxiv.org/abs/2604.26672v1)
...
Selection reason: 大规模实证揭示逃逸缺陷集中于高变更成熟组件，可为测试生成与修复优先级提供参考
...
### [32] [Reproducible Automated Program Repair Is Hard -- Experiences With the Defects4J Dataset](http://arxiv.org/abs/2604.26674v1)
...
Selection reason: 针对 Defects4J 的可复现性缺陷提出更严格的 APR 评测框架，直接影响程序修复 agent 的评测可靠性
...
### [33] [LLM-Guided Runtime Parameter Optimization for Energy-Efficient Model Inference](http://arxiv.org/abs/2604.27032v1)
...
Selection reason: LLM 引导运行时参数优化，直接属于自动性能调优，且提出优于传统搜索的提示与反馈闭环
...
### [34] [What Is the Cost of Energy Monitoring? An Empirical Study on the Overhead of RAPL-Based Tools](http://arxiv.org/abs/2604.26815v1)
...
Selection reason: 系统评测 RAPL 能量监控工具开销并给出低开销实现，对 profiling 和能量优化工具有直接借鉴
...
### [35] [Hot Fixing in the Wild](http://arxiv.org/abs/2604.26892v1)
...
Selection reason: 基于大规模仓库分析热修复行为并对比人类与 AI agent 的修复模式，为紧急修复 agent 设计提供实证
...
### [36] [ClassEval-Pro: A Cross-Domain Benchmark for Class-Level Code Generation](http://arxiv.org/abs/2604.26923v1)
...
Selection reason: 提出跨领域类级代码生成 benchmark，带高覆盖测试与错误分析，直接用于评估代码生成 agent
...
### [37] [Where did we fail? -- Reproducing build failures in embedded open source software](http://arxiv.org/abs/2604.27075v1)
...
Selection reason: 提供 CI 构建失败日志的统一抽象与可复现数据集，增强 agent 的构建反馈与长程复现能力
...
### [38] [On the Effectiveness of Modular Testing in EvoSuite](http://arxiv.org/abs/2604.27112v2)
*Elizabeth Dinella*
...
Selection reason: 改进 EvoSuite 模块化测试，放宽非目标方法调用限制以提升分支覆盖，对测试生成 agent 有直接价值
...
### [39] [CI-Repair-Bench: A Repository-Aware Benchmark for Automated Patch Validation via CI Workflows](http://arxiv.org/abs/2604.27148v2)
...
Selection reason: 构建基于真实 CI 工作流的仓库级程序修复 benchmark，提供错误类型细粒度评估，推动 CI 原生修复 agent 研究
...
### [40] [Theory Under Construction: Orchestrating Language Models for Research Software Where the Specification Evolves](http://arxiv.org/abs/2604.27209v2)
...
Selection reason: 提出耦合代码/理论/论文的迭代提示自动机与半衰期任务延续机制，可迁移到长程科研代码 agent 的编排
...
### [41] [Self-Evolving Software Agents](http://arxiv.org/abs/2604.27264v1)
...
Selection reason: 提出 BDI-LLM 自进化软件 agent，支持目标/推理/代码自主演化，对自适应 agent 架构有借鉴价值
...
### [42] [Rule-based High-Level Coaching for Goal-Conditioned Reinforcement Learning in Search-and-Rescue UAV Missions Under Limited-Simulation Training](http://arxiv.org/abs/2604.26833v1)
...
### [43] [SiriusHelper: An LLM Agent-Based Operations Assistant for Big Data Platforms](http://arxiv.org/abs/2605.00043v1)
...
### [44] [Preserving Disagreement: Architectural Heterogeneity and Coherence Validation in Multi-Agent Policy Simulation](http://arxiv.org/abs/2604.26561v1)
*Ariel Sela*
...
### [45] [The Cost of Consensus: Isolated Self-Correction Prevails Over Unguided Homogeneous Multi-Agent Debate](http://arxiv.org/abs/2605.00914v1)
...
### [46] [MappingEvolve: LLM-Driven Code Evolution for Technology Mapping](http://arxiv.org/abs/2604.26591v1)
...
### [47] [When to Retrieve During Reasoning: Adaptive Retrieval for Large Reasoning Models](http://arxiv.org/abs/2604.26649v1)
...
### [48] [Bidirectional Semantic Complementary Tool Retrieval for Remote Sensing Agents](http://arxiv.org/abs/2606.07538v1)
...
### [49] [What Suppresses Nash Equilibrium Play in Large Language Models? Mechanistic Evidence and Causal Control](http://arxiv.org/abs/2604.27167v2)
...
### [50] [A self-evolving agent for explainable diagnosis of DFT-experiment band-gap mismatch](http://arxiv.org/abs/2604.26703v1)
*Yue Li,Bijun Tang*
...
### [51] [When Continual Learning Moves to Memory: A Study of Experience Reuse in LLM Agents](http://arxiv.org/abs/2604.27003v1)
...
### [52] [Uncertainty-Aware Reward Discounting for Mitigating Reward Hacking](http://arxiv.org/abs/2604.26360v2)
*Disha Singha*
...
### [53] [Lyapunov-Guided Self-Alignment: Test-Time Adaptation for Offline Safe Reinforcement Learning](http://arxiv.org/abs/2604.26516v1)
...
### [54] [Language Diffusion Models are Associative Memories Capable of Retrieving Unseen Data](http://arxiv.org/abs/2604.26841v1)
...
### [55] [Detecting Clinical Discrepancies in Health Coaching Agents: A Dual-Stream Memory and Reconciliation Architecture](http://arxiv.org/abs/2604.27045v1)
...
### [56] [Agent Name Service (ANS): A Proof-of-Concept Trust Layer for Secure AI Agent Discovery, Identity, and Governance in Kubernetes](http://arxiv.org/abs/2604.26997v1)
...
### [57] [LATTICE: Evaluating Decision Support Utility of Crypto Agents](http://arxiv.org/abs/2604.26235v1)
...
### [58] [An Empirical Security Evaluation of LLM-Generated Cryptographic Rust Code](http://arxiv.org/abs/2604.27001v1)
...
Selection reason: 实证评估LLM生成加密Rust代码的安全性，揭示模型系统性缺陷，对coding agent输出验证和漏洞防护有重要启示。
...
### [59] [Enforcing Benign Trajectories: A Behavioral Firewall for Structured-Workflow AI Agents](http://arxiv.org/abs/2604.26274v1)
*Hung Dang*
...
### [60] [SecMate: Multi-Agent Adaptive Cybersecurity Troubleshooting with Tri-Context Personalization](http://arxiv.org/abs/2604.26394v1)
...
### [61] [Autonomous LLM Agents & CTFs: A Second Look](http://arxiv.org/abs/2605.21497v1)
...
### [62] [Tatemae: Detecting Alignment Faking via Tool Selection in LLMs](http://arxiv.org/abs/2604.26511v1)
...
### [63] [Enhancing Linux Privilege Escalation Attack Capabilities of Local LLM Agents](http://arxiv.org/abs/2604.27143v1)
...
### [64] [Ambient Persuasion in a Deployed AI Agent: Unauthorized Escalation Following Routine Non-Adversarial Content Exposure](http://arxiv.org/abs/2605.00055v1)
...
### [65] [From Prompt to Physical Actuation: Holistic Threat Modeling of LLM-Enabled Robotic Systems](http://arxiv.org/abs/2604.27267v2)
...
### [66] [A Test Taxonomy and Continuous Integration Ecosystem for Dynamic Resource Management in HPC](http://arxiv.org/abs/2604.26824v1)
...
Selection reason: 提出 HPC 动态资源管理测试分类法与容器化 CI 生态，可迁移到 agent 的自动化验证与回归测试
...
### [67] [Option-Order Randomisation Reveals a Distributional Position Attractor in Prompted Sandbagging](http://arxiv.org/abs/2604.26206v1)
*Jon-Paul Cacioli*
...
### [68] [Breaking the Autoregressive Chain: Hyper-Parallel Decoding for Efficient LLM-Based Attribute Value Extraction](http://arxiv.org/abs/2604.26209v1)
...
### [69] [StratMem-Bench: Evaluating Strategic Memory Use in Virtual Character Conversation Beyond Factual Recall](http://arxiv.org/abs/2604.26243v1)
...
### [70] [ClawGym: A Scalable Framework for Building Effective Claw Agents](http://arxiv.org/abs/2604.26904v3)
...
### [71] [Turning the TIDE: Cross-Architecture Distillation for Diffusion Large Language Models](http://arxiv.org/abs/2604.26951v1)
