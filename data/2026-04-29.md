...
- [Agentic AI in the Software Development Lifecycle: Architecture, Empirical Evidence, and the Reshaping of Software Engineering](http://arxiv.org/abs/2604.26275v1) — 相关度 0.90：提出agentic软件工程的六层架构并总结SWE-bench等实证趋势，直接定义编码agent的设计与评估框架。
- [An Empirical Study of Speculative Decoding on Software Engineering Tasks](http://arxiv.org/abs/2604.26469v3) — 相关度 0.90：首个针对SE任务的投机解码系统实证，直接加速LLM代码生成/修复，与SemOpt高度相关。
- [CI-Repair-Bench: A Repository-Aware Benchmark for Automated Patch Validation via CI Workflows](http://arxiv.org/abs/2604.27148v2) — 相关度 0.90：构建基于真实 CI 工作流的仓库级程序修复 benchmark，提供错误类型细粒度评估，推动 CI 原生修复 agent 研究
- [ClassEval-Pro: A Cross-Domain Benchmark for Class-Level Code Generation](http://arxiv.org/abs/2604.26923v1) — 相关度 0.90：提出跨领域类级代码生成 benchmark，带高覆盖测试与错误分析，直接用于评估代码生成 agent
- [LLM-Guided Runtime Parameter Optimization for Energy-Efficient Model Inference](http://arxiv.org/abs/2604.27032v1) — 相关度 0.90：LLM 引导运行时参数优化，直接属于自动性能调优，且提出优于传统搜索的提示与反馈闭环
- [Reproducible Automated Program Repair Is Hard -- Experiences With the Defects4J Dataset](http://arxiv.org/abs/2604.26674v1) — 相关度 0.90：针对 Defects4J 的可复现性缺陷提出更严格的 APR 评测框架，直接影响程序修复 agent 的评测可靠性
- [TDD Governance for Multi-Agent Code Generation via Prompt Engineering](http://arxiv.org/abs/2604.26615v1) — 相关度 0.85：将TDD原则编码为多agent代码生成的流程治理机制，直接涉及agent工作流约束和验证门控，与代码agent可靠性高度相关。
- [An Empirical Security Evaluation of LLM-Generated Cryptographic Rust Code](http://arxiv.org/abs/2604.27001v1) — 相关度 0.80：实证评估LLM生成加密Rust代码的安全性，揭示模型系统性缺陷，对coding agent输出验证和漏洞防护有重要启示。
- [Theory Under Construction: Orchestrating Language Models for Research Software Where the Specification Evolves](http://arxiv.org/abs/2604.27209v2) — 相关度 0.80：提出耦合代码/理论/论文的迭代提示自动机与半衰期任务延续机制，可迁移到长程科研代码 agent 的编排
- [Hot Fixing in the Wild](http://arxiv.org/abs/2604.26892v1) — 相关度 0.75：基于大规模仓库分析热修复行为并对比人类与 AI agent 的修复模式，为紧急修复 agent 设计提供实证
- [On the Effectiveness of Modular Testing in EvoSuite](http://arxiv.org/abs/2604.27112v2) — 相关度 0.75：改进 EvoSuite 模块化测试，放宽非目标方法调用限制以提升分支覆盖，对测试生成 agent 有直接价值
- [Self-Evolving Software Agents](http://arxiv.org/abs/2604.27264v1) — 相关度 0.75：提出 BDI-LLM 自进化软件 agent，支持目标/推理/代码自主演化，对自适应 agent 架构有借鉴价值
- [Where did we fail? -- Reproducing build failures in embedded open source software](http://arxiv.org/abs/2604.27075v1) — 相关度 0.75：提供 CI 构建失败日志的统一抽象与可复现数据集，增强 agent 的构建反馈与长程复现能力
- [Adaptive and AI-Augmented Security Testing: A Systematic Survey of Program Analysis, Feedback-Driven Testing, and Hybrid Learning-Based Approaches](http://arxiv.org/abs/2604.27000v1) — 相关度 0.72：系统综述自适应/AI增强安全测试，涵盖模糊测试、LLM测试生成与程序分析混合方法，对代码agent的测试与修复模块有直接参考价值。
- [Graph Construction and Matching for Imperative Programs using Neural and Structural Methods](http://arxiv.org/abs/2604.26578v3) — 相关度 0.70：结合语法树与嵌入的图构造方法支持跨语言程序分析和验证件复用，可直接用于代码agent的语义表示与匹配。
- [RepoDoc: A Knowledge Graph-Based Framework to Automatic Documentation Generation and Incremental Updates](http://arxiv.org/abs/2604.26523v1) — 相关度 0.70：基于知识图谱的仓库文档自动生成框架，其分模块生成和图传播更新机制可迁移到代码agent的仓库理解与增量维护。
- [What Is the Cost of Energy Monitoring? An Empirical Study on the Overhead of RAPL-Based Tools](http://arxiv.org/abs/2604.26815v1) — 相关度 0.70：系统评测 RAPL 能量监控工具开销并给出低开销实现，对 profiling 和能量优化工具有直接借鉴
- [PICKLES: a Natural Language Framework for Requirement Specification and Model-Based Testing](http://arxiv.org/abs/2604.26572v1) — 相关度 0.65：从自然语言需求自动生成正式模型和测试用例，为coding agent的测试生成提供基于BDD/MBT的灵活框架。
- [Which Types of Heterogeneity Matter for Root Cause Localization in Microservice Systems ?](http://arxiv.org/abs/2604.26670v1) — 相关度 0.65：面向微服务根因定位的异构建模与主动学习方法，可迁移到代码 agent 的故障诊断与调试环节
- [Identifying and Characterizing Semantic Clones of Solidity Functions](http://arxiv.org/abs/2604.26526v1) — 相关度 0.60：提出语义克隆检测方法并利用LLM生成注释辅助识别，对代码检索和agent理解代码语义有借鉴意义。
- [When Your LLM Reaches End-of-Life: A Framework for Confident Model Migration in Production Systems](http://arxiv.org/abs/2604.27082v1) — 相关度 0.60：用贝叶斯校准自动指标评估 LLM 迁移，方法可迁移到代码 agent 的少标注评测场景
- [Will It Break in Production? Metric-Driven Prediction of Residual Defects in Python Systems](http://arxiv.org/abs/2604.26667v1) — 相关度 0.60：基于度量和代码嵌入的缺陷预测方法，对代码质量评估和agent修复优先级排序有参考价值。
- [A Test Taxonomy and Continuous Integration Ecosystem for Dynamic Resource Management in HPC](http://arxiv.org/abs/2604.26824v1) — 相关度 0.55：提出 HPC 动态资源管理测试分类法与容器化 CI 生态，可迁移到 agent 的自动化验证与回归测试
- [Beyond Accuracy: LLM Variability in Evidence Screening for Software Engineering SLRs](http://arxiv.org/abs/2604.27006v1) — 相关度 0.50：量化LLM在筛选任务中的变异性与输入特征影响，对理解agent分类决策的可靠性和可复现性有参考价值。
- [LLM-Assisted Empirical Software Engineering: Systematic Literature Review and Research Agenda](http://arxiv.org/abs/2604.26192v1) — 相关度 0.50：系统综述LLM辅助软件工程经验研究方法，虽非代码agent直接技术，但其任务分类和局限总结可为agent评测设计提供背景。
- [Recommendations for Efficient and Responsible LLM Adoption within Industrial Software Development](http://arxiv.org/abs/2604.26590v1) — 相关度 0.50：多案例研究给出LLM在工业软件开发的实施建议，其中人工监督和工作流集成对部署coding agent有实际指导价值。
- [What Makes Software Bugs Escape Testing? Evidence from a Large-Scale Empirical Study](http://arxiv.org/abs/2604.26672v1) — 相关度 0.50：大规模实证揭示逃逸缺陷集中于高变更成熟组件，可为测试生成与修复优先级提供参考
