...
### [3] [TRACE: Transition-Aware Residual Control for Multi-Objective Materials Discovery](https://arxiv.org/abs/2608.23631)
...
Selection reason: 提出函数级执行反馈的代码偏好优化框架，用单元测试标注中间步骤并改进 KTO/DPO，直接提升代码生成质量。
...
### [7] [Automata from Agent Traces: Failure and Next-Step Prediction](https://arxiv.org/abs/2608.23670)
...
### [9] [AgentRoom: Concurrent Multi-Agent Coding in a CRDT-Backed Shared Workspace](https://arxiv.org/abs/2608.23740)
...
Selection reason: AgentRoom用CRDT支撑并发多agent编码，直接研究代码agent的多agent协作与共享工作区机制
...
### [10] [Generating Biomedical Fact-Checking Reports with RL-Enhanced Agentic Search](https://arxiv.org/abs/2608.23811)
...
### [11] [Exploit More, Explore Smarter for Budget-Constrained Agentic Search](https://arxiv.org/abs/2608.23848)
...
### [12] [Semantic Overlays: Mitigating Prompt Injection with Annotations Beyond Tokens and Steering Vectors](https://arxiv.org/abs/2608.23873)
*Joshua Penman*
...
### [13] [AI Finds A Way](https://arxiv.org/abs/2608.23875)
...
### [14] [Quantifying System-Level Harms from AI Adoption in Complex Sociotechnical Systems](https://arxiv.org/abs/2608.23906)
...
### [15] [Retrieval-augmented generation vs. deterministic tax computation in multi-agent financial advisory: A 2x2 factorial experiment](https://arxiv.org/abs/2608.23908)
...
### [16] [PROOF-Gen: From Optimized Data to Better Distillation](https://arxiv.org/abs/2608.23911)
...
### [17] [MARS: Multi-Specialist LLM Relay System for Competitive Programming](https://arxiv.org/abs/2608.23918)
...
### [18] [More Rejective, Not More Discriminative: The Unit of Verification in Pre-Execution LLM Oversight](https://arxiv.org/abs/2608.23941)
...
### [19] [Recursive Agentic Reasoning](https://arxiv.org/abs/2608.23956)
...
### [20] [EMRB: A Multi-Level Benchmark for Evaluating LLM Reasoning over Raw Electromagnetic Signals](https://arxiv.org/abs/2608.24086)
...
Selection reason: EMRB评测LLM通过编写代码分析原始电磁信号，验证代码agent在科学计算任务中的能力，并提出带自验证的结构化方法。
...
### [21] [Robust Code RL via Faulty-Code-Driven Test case Synthesis and Dense Reward Shaping](https://arxiv.org/abs/2608.24135)
...
Selection reason: 提出基于错误代码的测试用例合成与密集奖励塑造的代码RL框架，直接提升代码生成模型训练质量。
...
### [22] [Memory Is Not Always Needed: Characterizing Conditional Memory in Scientific Reasoning](https://arxiv.org/abs/2608.23982)
...
### [23] [Paritok-4B: Intent-Conditioned Context Compression for Coding Agents](https://arxiv.org/abs/2608.24188)
...
Selection reason: 面向编码agent的抽取式意图条件上下文压缩器，显著降低token开销并保持求解率，直接针对agent上下文优化。
...
### [24] [Diverse by Reasoning: Harnessing the Wisdom of LLM Crowds for Future Prediction](https://arxiv.org/abs/2608.24001)
...
### [25] [SA-Bench: Evaluating Semantic Alignment in LLM-Based Paper Reproduction](https://arxiv.org/abs/2608.24252)
...
Selection reason: SA-Bench诊断LLM论文复现中的语义漂移，提供细粒度语义验证基准，可迁移到代码生成与验证agent。
...
### [26] [ReproAgent: Contract-Guided Paper-to-Code Reproduction](https://arxiv.org/abs/2608.24291)
...
Selection reason: ReproAgent用契约引导的Prepare-Plan-Generate-Repair流水线实现论文到代码复现，强化agent的分阶段验证与修复。
...
### [27] [Reflection with Action-Induced Visual Differences for Desktop GUI Agents](https://arxiv.org/abs/2608.24015)
...
### [28] [From State to Action: OODA-Tool for Reliable Multi-Turn Tool Use](https://arxiv.org/abs/2608.24368)
...
Selection reason: OODA-Tool将状态保持与动作生成解耦，提升多轮工具调用agent的可靠性，可推广到长程代码任务。
...
### [29] [Beyond Confidence: Test-Time Scaling for Multi-Turn Search Agents via Retrieval Grounding](https://arxiv.org/abs/2608.24024)
...
### [30] [PeakBench: Benchmarking Resource-Aware Tool Invocation in LLM Agents](https://arxiv.org/abs/2608.24509)
...
Selection reason: PeakBench评测agent在资源约束下的工具并行调度，区分逻辑规划与物理调度，对低延迟工具执行有参考价值。
...
### [31] [Joint Optimization of Tool Creation and Use for Large Language Model Agents](https://arxiv.org/abs/2608.24571)
...
Selection reason: SMITH用强化学习联合优化工具创建与使用，让同一策略内工具schema可调用，提升agent的工具库构建能力。
...
### [32] [StarHarness: Evolving Harnesses with Stratified Search for Enterprise Environments](https://arxiv.org/abs/2608.24804)
...
Selection reason: StarHarness通过分层搜索演化企业环境下的agent harness，包括提示、工具接口和子agent结构，迁移性明确。
...
### [33] [Poisoning Agentic Alpha: Adversarial Vulnerabilities Across Roles and Architectures in Multi-Agent Trading Systems](https://arxiv.org/abs/2608.24069)
...
### [34] [AgentWorld: Personality-Aware Reliability Evaluation for Agentic Information Retrieval](https://arxiv.org/abs/2608.24076)
...
### [35] [Are Android GUI Agents Robust Against Runtime Anomalies? AnTrap: Evaluating Agents in Dynamic Adversarial Environments](https://arxiv.org/abs/2608.24099)
...
### [36] [ACE: A Self-Correcting Agentic Canvas Editor for Multi-Slide Presentation Automation](https://arxiv.org/abs/2608.24103)
...
### [37] [AHEAD: Adaptive Hindsight with Environment-Augmented Distillation for Agentic RL](https://arxiv.org/abs/2608.24114)
...
### [38] [Task-Adaptive Rubrics for GUI Reward Modeling](https://arxiv.org/abs/2608.24174)
...
### [39] [MetaRAG: Belief-Action Aligned Policy Optimization for Agentic RAG](https://arxiv.org/abs/2608.24214)
...
### [40] [Constraint-Guided Enterprise Data Mapping with Large Language Models](https://arxiv.org/abs/2608.24218)
...
### [41] [Evaluating Multiple LLM Generations with Validated Task Coverage](https://arxiv.org/abs/2608.24228)
...
### [42] [TRACE: An Evidence-Grounded Benchmark for Safety Evaluation of Large Reasoning Models](https://arxiv.org/abs/2608.24232)
...
### [43] [STRIVE: Multi-Agent Structured Temporal Reasoning with Integrated Verification for Longitudinal Radiology Report Generation](https://arxiv.org/abs/2608.24237)
...
### [44] [RePolicy: Reinforcement Learning for Safety-Policy Invocation in Agent Safeguards](https://arxiv.org/abs/2608.24275)
...
### [45] [VideoHarness-RSI: Recursive Harness Self-Improvement for Long-Video Understanding with Frozen Vision-Language Models](https://arxiv.org/abs/2608.24302)
*Guoyang Xu,Hao Chen*
...
### [46] [OPDSearch+: On-Policy Distillation with RL Refinement for Search-Augmented Reasoning](https://arxiv.org/abs/2608.24310)
...
### [51] [Neurosymbolic Alignment for Physiologically-Safe Clinical Language Models](https://arxiv.org/abs/2608.24534)
...
### [52] [When "Must" Becomes "Maybe": Constraint Weakening in LLM Agent Workflows](https://arxiv.org/abs/2608.24569)
...
### [53] [EviDx: Evidence-Aware Active Diagnosis with Scaffolded LLM Agents](https://arxiv.org/abs/2608.24570)
...
### [54] [Parason: Revealing Subtask and Trial Parallelism in LLM Reasoning](https://arxiv.org/abs/2608.24658)
...
### [55] [Confident at the moment of action: belief miscalibration in LLM play under hidden information](https://arxiv.org/abs/2608.24691)
...
### [56] [Meta$^n$: Recursive Self-Improvement through Emergent Depth](https://arxiv.org/abs/2608.24735)
...
### [57] [Evidence Blindness in Direct Corpus Interaction: Persistent Navigation with AtlasNav](https://arxiv.org/abs/2608.24764)
...
### [58] [StepGuard: Learning Step-Level Guardrails with Scalable Supervision and Safety-Utility Balancing](https://arxiv.org/abs/2608.24777)
...
### [59] [Right Diagnoses, Decorative Reasoning:A Perturbation Audit of Medical Chain-of-Thought](https://arxiv.org/abs/2608.24790)
...
### [60] [CAFE: Self-Improving Search Agents Need Co-Evolving Feedback](https://arxiv.org/abs/2608.24794)
...
### [61] [Constrained Entity Selection under Partial Knowledge for LLM-Based Knowledge Graph QA](https://arxiv.org/abs/2608.24824)
*Emanuel Kitzelmann*
...
### [62] [SPO++: Stream-Aligned Policy Optimization for Asynchronous Agentic RL](https://arxiv.org/abs/2608.24870)
...
### [63] [Recursive Experiential-Working Memory Evolution for Long-Horizon Agent Harnesses](https://arxiv.org/abs/2608.24876)
...
### [64] [From Traceability to Justifiability: Accountability Structures in Agentic Software Engineering](https://arxiv.org/abs/2608.23610)
*Rashid Azarang*
...
Selection reason: 对 agentic 软件工程交付链的可追溯性与可辩护性进行度量，可用于评估编码 agent 部署的可信度。
...
### [65] [REFINE: A Multi-Agent LLM Approach for Evidence-Guided Code Refactoring](https://arxiv.org/abs/2608.23611)
...
Selection reason: 多 agent 证据感知的 Java 重构方法，结合静态分析、转换与保持性检查，直接面向代码重构 agent。
...
### [66] [Rebuild Dossier: Mechanically-Enforced Specs for Agentic App Rebuilds, and What Model-Tier Failures Reveal](https://arxiv.org/abs/2608.23616)
*Parker Fawcett*
...
Selection reason: 通过机械强制接口规格和自动化检查约束 agent 应用重建，提供多级验证与失败分析，直接面向 agentic 软件开发。
...
### [67] [Identifying Latent Declarative Representations of Code for Assisting Repository Migration](https://arxiv.org/abs/2608.23619)
...
Selection reason: 利用潜在声明式表示辅助仓库迁移，提出 ADFD-Migrate 与 f2x50 基准，直接涉及 LLM 代码迁移与评测。
...
### [68] [When May an Agent Stop? Evidence-Carrying Termination for Tool-Using LLMs](https://arxiv.org/abs/2608.23623)
*Jason Liu*
...
Selection reason: 提出证据携带终止机制，用类型化证书约束LLM agent停止决策，是agent可靠性与验证的通用方法，可迁移到代码agent
...
### [69] [Callability Is Not Operability: Controlled Interface Interventions for LLM Agents](https://arxiv.org/abs/2608.23628)
*Zihao Wang*
...
Selection reason: 区分工具可调用性与可操作性，提出Agent-First Tooling接口机制和AFT-Bench，对agent工具设计有直接迁移价值
...
### [70] [FPGAgent: An LLM-Assisted Framework for Autonomous HLS Code Generation and Verification in FPGA Environments](https://arxiv.org/abs/2608.23630)
...
Selection reason: 面向FPGA HLS代码生成的多智能体框架，含端到端可执行验证和新基准，属于代码生成+验证的典型工作
...
### [71] [ToolRobustBench: Stage-Wise Perturbation Evaluation and Failure Diagnosis for Tool-Calling Agents](https://arxiv.org/abs/2608.23635)
...
Selection reason: 提出工具调用agent的分阶段扰动诊断基准，可迁移到代码agent鲁棒性评测与失败归因
...
### [72] [Feedback That Backfires: Why Small Language Model Agents Repeat the Call They Just Watched Fail](https://arxiv.org/abs/2608.23651)
*Esmail Gumaan*
...
Selection reason: 发现失败反馈会导致小模型agent重复失败调用，揭示harness层面反馈机制问题，对agent工具反馈设计有重要参考
...
### [73] [Beyond Executable Models: The Pufibara Agent Harness and the Modelica Agent Workflow Benchmark for Physical System Modeling](https://arxiv.org/abs/2608.23653)
*Zizhe Wang*
...
Selection reason: 提出Pufibara agent harness和Modelica benchmark，持久状态与证据关联机制可迁移到代码agent，但偏向物理建模
...
### [74] [Automated Synthesis of Cloud Emulators](https://arxiv.org/abs/2608.23842)
...
Selection reason: CloudEmu用LLM神经符号合成云模拟器并以真实云为oracle自动测试修复，是LLM代码合成+验证的通用方法
...
### [75] [The Empire, Long Divided, Must Unite: Architectural Convergence in Three LLM Agent Harnesses](https://arxiv.org/abs/2608.23953)
*Dai Jiahong*
...
Selection reason: 对三个开源coding-agent harness的架构收敛研究，提炼共性元素与可验证性缺口，对agent设计具有直接指导价值
...
### [76] [Evaluating Language Models on Cross-Language Code Functional Equivalence](https://arxiv.org/abs/2608.23961)
...
Selection reason: 提出PolyHuman数据集评估LLM跨语言函数等价判断，属于代码语义理解评测，可迁移到代码agent
...
### [77] [DeepRepoQA: Code Repository Question Answering with Deep Agent Exploration](https://arxiv.org/abs/2608.24221)
...
Selection reason: DeepRepoQA用MCTS引导agent对代码仓库进行多跳问答探索，是代码检索与规划agent的直接方法
...
### [78] [Towards LLM-Enhanced Android Taint Analysis](https://arxiv.org/abs/2608.24269)
...
Selection reason: 用LLM agent迭代探索做Android污点分析并超越传统静态工具，是程序分析agent的直接应用
...
### [79] [Observability and Fault Injection for LLM-Based Multi-Agent Systems in Software Engineering](https://arxiv.org/abs/2608.24271)
...
Selection reason: 提供基于OpenTelemetry的多agent系统可观测性与故障注入工具，直接支持代码agent的调试与评测
...
### [80] [Ockhamareto: Pareto-Gated Segment-Level Credit Assignment for Concise Unit-Test Generation with Reinforcement Learning](https://arxiv.org/abs/2608.24473)
...
Selection reason: Ockhamareto用Pareto门控和token级信用分配RL优化单元测试生成，属于测试生成与优化方法
...
### [81] [Aging of Prompt Engineering Techniques Across LLM Versions](https://arxiv.org/abs/2608.24641)
...
Selection reason: 研究提示工程技术在不同LLM版本间的老化效应，用pass@k评估代码生成，直接指导编码agent的提示策略选择。
...
### [82] [A Literate Programming Environment for Human and Machine Agents](https://arxiv.org/abs/2608.24644)
*Adam T. Burke*
...
Selection reason: 面向人机协作的文字编程环境，提供符号感知的上下文与工具，有助于增强编码agent的结构化检索能力。
...
### [83] [From Natural Language Requirements to Graphical User Interfaces: Automated Prototyping and Verification with Pretrained Language Models](https://arxiv.org/abs/2608.24749)
*Kristian Kolthoff*
...
Selection reason: 利用LLM从自然语言需求生成GUI原型并验证，涉及自动化验证agent，可迁移到需求驱动的代码生成与测试。
