...
Comments: Accepted to ICSME 2026 in the Tool Demonstration and Data Showcase Track

Journal reference: 42nd International Conference on Software Maintenance and Evolution (ICSME) 2026
...
Comments: 7 pages . Companion paper to arXiv:2607.12943 [cs.SE] and SSRN Working Paper No. 7069378
...
- [Agentic Synthesis against Counterexample-Supplemented Sketches](https://arxiv.org/abs/2607.15854) — 相关度 0.85：反例补充草稿的agent合成方法，通过回归集和代码保留验证agent行为，直接相关代码agent可靠性。
- [DiffTestGen: Change-Directed LLM-Based Testing for Exposing Behavioral Differences](https://arxiv.org/abs/2607.16024) — 相关度 0.85：LLM差分测试生成，暴露代码变更行为差异，可迁移到agent测试与验证。
- [GapForge: Directed Compiler Fuzzing via Coverage-Gap Analysis](https://arxiv.org/abs/2607.15762) — 相关度 0.80：基于覆盖缺口分析的编译器模糊测试，方法可迁移到代码生成和测试优化，发现真实缺陷。
- [Understanding Agent-Reactive Bugs at the Model-Harness Boundary: An Empirical Study of LLM Agent Issue Reports](https://arxiv.org/abs/2607.15684) — 相关度 0.80：实证研究agent-reactive bug，揭示harness与LLM交互缺陷，对设计agent测试oracle和调试具价值。
- [Verified LLM-Driven Synthesis for Concept Design](https://arxiv.org/abs/2607.15718) — 相关度 0.75：LLM驱动的概念合成与形式化验证，CEGIS方式可迁移到代码agent的验证和设计生成。
- [Making Agent-Mediated Contributions Governable: A Project-Level Governance Manifest for Open-Source AI Collaboration](https://arxiv.org/abs/2607.15769) — 相关度 0.70：项目级治理清单增强AI贡献的可控性，治理和审核机制可用于代码agent的工作流管理。
- [TARS: A Theory-of-Mind Agent for Personalized In-IDE Code Comprehension](https://arxiv.org/abs/2607.15948) — 相关度 0.70：集成IDE的ToM agent，自适应解释深度，可迁移到代码理解agent的个性化交互。
- [READU: Inconsistency-Driven Just-in-Time Detection and Repair of README Bugs](https://arxiv.org/abs/2607.15780) — 相关度 0.50：README bug检测与修复，不一致驱动方法可参考但非直接agent研究。
