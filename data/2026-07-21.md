...
Journal reference: Findings of the Association for Computational Linguistics: ACL 2026, pages 21721-21736, 2026

DOI: [10.18653/v1/2026.findings-acl.1092](https://doi.org/10.18653/v1/2026.findings-acl.1092)
...
### [2] [Cura 1T: Specialized Model for Agentic Healthcare](https://arxiv.org/abs/2607.15314)
...
### [3] [AnovaX: A Local, Multi-Agent Voice Assistant with LLM Planning, Typed Executors, and Adaptive Recovery](https://arxiv.org/abs/2607.15367)
*Raunak B Sinha*
...
### [4] [Precise but Uncoupled: Reviewer Precision Does Not Guarantee Critique Uptake in Multi-Agent Math Reasoning](https://arxiv.org/abs/2607.15388)
...
### [5] [Do Coding Agents Need Executable World Models, Simplification, and Verification to Solve ARC-AGI-3?](https://arxiv.org/abs/2607.15439)
*Sergey Rodionov*
...
### [6] [SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction](https://arxiv.org/abs/2607.15550)
...
### [7] [ToolVerse: Unlocking Massive Environments and Long-Horizon Tasks for Agentic Reinforcement Learning](https://arxiv.org/abs/2607.15660)
...
### [8] [Behavioral Controllability of Agentic Models for Information Extraction: From Fixed Workflows to Reflective Agents](https://arxiv.org/abs/2607.15715)
...
### [9] [AgentFAIR: A Multi-Agent Collaborative Framework for FAIRness Evaluation of Geospatial Datasets](https://arxiv.org/abs/2607.15781)
...
### [10] [Knowledge-Centric Agents for Workflow Generation](https://arxiv.org/abs/2607.15845)
...
### [11] [DSWorld: A Data Science World Model for Efficient Autonomous Agents](https://arxiv.org/abs/2607.15901)
...
### [12] [SciForge: An AI-Native, Multimodal Workbench for Scientific Discovery](https://arxiv.org/abs/2607.16038)
...
### [13] [CRAFT: Clustering Rubrics to Diagnose Weak LLM Capabilities and Generate Targeted Fine-Tuning Data](https://arxiv.org/abs/2607.16122)
...
### [14] [Understanding Agent-Reactive Bugs at the Model-Harness Boundary: An Empirical Study of LLM Agent Issue Reports](https://arxiv.org/abs/2607.15684)
...
Selection reason: 实证研究agent-reactive bug，揭示harness与LLM交互缺陷，对设计agent测试oracle和调试具价值。
...
### [15] [Verified LLM-Driven Synthesis for Concept Design](https://arxiv.org/abs/2607.15718)
*Alcino Cunha*
...
Selection reason: LLM驱动的概念合成与形式化验证，CEGIS方式可迁移到代码agent的验证和设计生成。
...
### [16] [GapForge: Directed Compiler Fuzzing via Coverage-Gap Analysis](https://arxiv.org/abs/2607.15762)
...
Selection reason: 基于覆盖缺口分析的编译器模糊测试，方法可迁移到代码生成和测试优化，发现真实缺陷。
...
### [17] [Making Agent-Mediated Contributions Governable: A Project-Level Governance Manifest for Open-Source AI Collaboration](https://arxiv.org/abs/2607.15769)
...
Selection reason: 项目级治理清单增强AI贡献的可控性，治理和审核机制可用于代码agent的工作流管理。
...
### [18] [READU: Inconsistency-Driven Just-in-Time Detection and Repair of README Bugs](https://arxiv.org/abs/2607.15780)
...
Selection reason: README bug检测与修复，不一致驱动方法可参考但非直接agent研究。
...
### [19] [Agentic Synthesis against Counterexample-Supplemented Sketches](https://arxiv.org/abs/2607.15854)
...
Selection reason: 反例补充草稿的agent合成方法，通过回归集和代码保留验证agent行为，直接相关代码agent可靠性。
...
### [20] [TARS: A Theory-of-Mind Agent for Personalized In-IDE Code Comprehension](https://arxiv.org/abs/2607.15948)
...
Selection reason: 集成IDE的ToM agent，自适应解释深度，可迁移到代码理解agent的个性化交互。
...
### [21] [DiffTestGen: Change-Directed LLM-Based Testing for Exposing Behavioral Differences](https://arxiv.org/abs/2607.16024)
...
Selection reason: LLM差分测试生成，暴露代码变更行为差异，可迁移到agent测试与验证。
