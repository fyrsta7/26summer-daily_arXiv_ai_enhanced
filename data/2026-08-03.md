...
Selection reason: 为 agentic 执行提供运行时准入协议，检查前置条件与义务，增强 agent 安全可靠性，可迁移。
...
### [13] [World Action Planner: Generalizable Decision-Making with Action-Conditioned World Models](https://arxiv.org/abs/2607.27599)
...
### [14] [SCOPE: Synthetic Conditional Objectives for Policy Evolution in Black-Box Combinatorial Optimization](https://arxiv.org/abs/2607.27630)
...
### [15] [ReDiPPO: Reference-Guided Value Calibration and Discrepancy-Aware Token Reweighting for Mathematical Reasoning](https://arxiv.org/abs/2607.27631)
...
### [16] [Rehearse: Stepping Back from the Confidence Cliff in Self-Improving Autoresearch](https://arxiv.org/abs/2607.27687)
...
### [18] [SpatialCLI: Learning to Reason With Spatial Tools, Then Without Them](https://arxiv.org/abs/2607.27703)
...
### [19] [Albilich: Steerable Proof-State Orchestration for LLM-Based Mathematical Research with CAS Integration](https://arxiv.org/abs/2607.27705)
...
### [20] [MECA: A Mechanism-Centered Agent for Constructing Well-Specified and Valuable Mathematical Conjectures](https://arxiv.org/abs/2607.27709)
...
### [23] [MemTxn: A Transaction Boundary for Source-Supported Updates and Complete-State Recovery in Agent Memory](https://arxiv.org/abs/2607.27834)
...
### [34] [SemPIC: Learning Semantic Position-Independent KV Caches](https://arxiv.org/abs/2607.28069)
...
### [35] [Echoverse: Deep, Evolving Environments for Training Computer-Use Agents at Scale](https://arxiv.org/abs/2607.28074)
...
### [36] [Group-Reflective Self-Distillation for Agentic Reinforcement Learning](https://arxiv.org/abs/2607.28076)
...
### [37] [Distilling Answer Set Programming Theories from Large Language Models](https://arxiv.org/abs/2607.28086)
...
### [38] [SciDataSailor: Deep Scientific Data Exploring](https://arxiv.org/abs/2607.28098)
...
### [39] [MIND: Lightweight and Effective Memory Injection Defense for LLM Agents via Intent-Aware Information Bottleneck](https://arxiv.org/abs/2607.28103)
...
### [40] [BlueprintRepair: Typed Local Edits for Failed Lean Proof Blueprints](https://arxiv.org/abs/2607.28110)
*Ruslan Khrulev*
...
### [41] [ConMem: Contribution-Aware Memory for Long-Horizon Manufacturing Inspection Logs](https://arxiv.org/abs/2607.28126)
...
### [42] [AgenticASR: Refining Speech Recognition in Real-World Scenarios via an Agentic Approach](https://arxiv.org/abs/2607.28175)
...
### [43] [Qwen-UI-Agent Technical Report: Toward Next-Generation Real-World Centric Foundation GUI Agents](https://arxiv.org/abs/2607.28227)
...
### [44] [LLM-Guided Evolutionary Search for Constraint Model Reformulation to Improve Solver Efficiency](https://arxiv.org/abs/2607.28268)
...
### [45] [MemHarness: Memory Is Reconstructed, Not Replayed](https://arxiv.org/abs/2607.28272)
...
### [46] [Tycho: Active Abstraction with Programmatic World Models for ARC-AGI-3](https://arxiv.org/abs/2607.28287)
...
### [47] [One Human, $N$ Agents: Audit-Budget Allocation for LLM Agent Fleets under Miscalibrated, Correlated Confidence](https://arxiv.org/abs/2607.28317)
...
### [48] [Paying for Honesty Without Knowing the Truth: Reputation-Penalty Design for LLM Marketplace Agents](https://arxiv.org/abs/2607.28330)
...
### [49] [Correcting What You Cannot See: Credit Assignment for Perception Distillation in Multimodal Reasoners](https://arxiv.org/abs/2607.28336)
...
### [50] [How Benchmarks Mis-Score Computer-Use Agents](https://arxiv.org/abs/2607.28367)
...
### [51] [When Specifications Conflict: A Symmetry-Based Framework for Measuring LLM Preferences](https://arxiv.org/abs/2607.28384)
...
### [52] [GLM-RAG: Graph Language Models for Graph-Based Retrieval-Augmented Generation](https://arxiv.org/abs/2607.28397)
...
### [53] [SVR: Self-Verifying Refinement via Joint Verdict-Confidence Reinforcement Learning for Adaptive Test-Time Compute](https://arxiv.org/abs/2607.28457)
...
### [54] [SCOPE: Supply-Chain Operations through Coupled Policies for End-to-End Coordination](https://arxiv.org/abs/2607.28488)
...
### [55] [MANTA: Multi-Agent Network Topology Adaptation for Self-Evolving Multi-Agent Systems](https://arxiv.org/abs/2607.28527)
...
### [56] [Rethinking Inference-Time Scaling in Local Computer-Use Agents: Failure Modes and Compute Tradeoffs](https://arxiv.org/abs/2607.28573)
...
### [57] [OSReward: Instituting Standardized Evaluation for Cross-Platform Computer-Use Reward Models](https://arxiv.org/abs/2607.28609)
...
### [58] [OwlPath: Lossless Knowledge Compression for LLM Bug Repair](https://arxiv.org/abs/2607.27249)
...
Selection reason: 利用 OWL 本体压缩知识并检索结构依赖，提升 bug 修复 agent 的上下文效率与召回。
...
### [59] [Do Context Files Help Coding Agents? A Two-Agent Ablation Study on Real Repositories](https://arxiv.org/abs/2607.27250)
*Prakhar Khatri*
...
Selection reason: 对 Claude Code 和 Codex 的上下文文件策略进行受控消融，为 agent 设计提供实证依据。
...
### [60] [AgentS4D: Benchmarking Runtime Risks across the Execution Lifecycle of LLM-Based Workspace Agents](https://arxiv.org/abs/2607.27294)
...
Selection reason: 构建 LLM 工作区 agent 的全生命周期运行时安全基准，覆盖多 agent 配置与风险注入评估。
...
### [61] [SIGIL: Compiling Agent Skills into Typed Harnesses](https://arxiv.org/abs/2607.27309)
...
Selection reason: 将自然语言技能编译为可执行 harness，提升 agent 步骤执行率和 token 效率，机制可迁移。
...
Selection reason: 结合属性导向的回归搜索与语义伪造测试，能发现回归测试遗漏的缺陷，对测试生成有价值。
...
### [63] [SWE-NFI: Studying and Benchmarking Coding Agents for Non-Functional Improvements](https://arxiv.org/abs/2607.27409)
...
Selection reason: 面向 coding agent 非功能性改进的 benchmark 与规则化评估套件，直接相关。
...
### [64] [LimICE: Integrating LLM into ICE Framework for Efficient Loop Invariant Inference](https://arxiv.org/abs/2607.27606)
...
Selection reason: 将 LLM 与 ICE 框架结合进行循环不变式增量合成，属于 LLM 驱动的程序验证方法，可迁移到代码 agent 的正确性推理。
...
### [65] [Not as Sweet by Another Name: An Empirical Study of Format Robustness in LLM Document Workflows](https://arxiv.org/abs/2607.27648)
...
Selection reason: 提出格式感知的蜕变测试框架评估 LLM 文档工作流鲁棒性，对 agent 输入输出可靠性测试有借鉴价值。
...
### [66] [Can Large Language Models Resolve Real Java Merge Conflicts? An Evaluation with a Calibrated LLM-as-Judge](https://arxiv.org/abs/2607.27674)
*Bowen Shen*
...
Selection reason: 用校准的 LLM-as-judge 评估 LLM 解决 Java 合并冲突，涉及代码修复与评测方法，直接相关。
...
### [67] [Specification-Guided Synthesis of Deadlock-Free Communication Protocol Refinements with Large Language Models](https://arxiv.org/abs/2607.27964)
...
Selection reason: 基于 MPST 规范引导 LLM 合成无死锁协议细化，将形式化约束融入生成过程，可迁移到 agent 的代码合成验证。
...
### [68] [Agentic Method for Deterministic Validation of Legacy Code Migration](https://arxiv.org/abs/2607.28271)
...
Selection reason: 用 agentic 测试合成与确定性 oracle 验证遗留代码迁移，属于 agent 验证与测试生成。
...
### [69] [CoGate: Confidence-Gated Co-Decoding for Secure Code Generation](https://arxiv.org/abs/2607.28529)
...
Selection reason: 置信度门控的协同解码优化代码生成安全性，直接面向代码生成模型的解码时方法。
...
### [70] [PAIChecker: Uncovering and Checking PR-Issue Misalignment in SWE-Bench-Like Benchmarks](https://arxiv.org/abs/2607.28587)
...
Selection reason: 多 agent 系统自动检测 SWE-bench 类基准的 PR-Issue 错配，涉及基准质量与多 agent 协作。
...
### [71] [Change2Task: From Repository Changes to Executable Coding Agent Tasks and Environments](https://arxiv.org/abs/2607.28591)
...
Selection reason: 从仓库历史构造可执行 coding agent 任务与测试环境的系统，直接提供数据与验证。
