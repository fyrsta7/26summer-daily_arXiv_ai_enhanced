...
Selection reason: 面向NPU的硬件感知LLM内核生成，结合运行时反馈与知识蒸馏，直接用于性能优化。
...
Selection reason: 提出面向LLM集成应用的双层复杂度度量，可用于agent软件工程评估。
...
Selection reason: 用约束与工具实现 coding agent 的可扩展监督，显著提高后门检测率。
...
### [48] [A Single Patch Is Not Enough: Deterministic Fusion of Repair Candidates](http://arxiv.org/abs/2607.01597v1)
...
Selection reason: 确定性融合LLM修复候选补丁，提升coding agent的pass@1，直接解决评测与选择问题。
...
### [49] [AgentFlow: Building Agent Dependency Graphs for Static Analysis of Agent Programs](http://arxiv.org/abs/2607.01640v1)
...
Selection reason: 构建agent程序依赖图的静态分析方法，可迁移到代码agent的治理、安全与理解。
...
### [50] [When Agents Do Not Stop: Uncovering Infinite Agentic Loops in LLM Agents](http://arxiv.org/abs/2607.01641v1)
...
Selection reason: 静态分析检测LLM agent无限循环，提升agent可靠性的通用方法。
...
### [51] [Refploit: Facilitating Exploit Construction via Code-Agent Trajectory Repair](http://arxiv.org/abs/2607.01760v1)
...
Selection reason: 基于代码agent轨迹修复的漏洞利用生成，直接研究agent修复与验证机制。
...
### [52] [KRCA: An Efficient Root Cause Analysis System in Hyper-Scale Microservice Systems via Agentic AI](http://arxiv.org/abs/2607.01788v1)
...
Selection reason: 微服务RCA多agent系统，采用记忆增强与因果约束，可迁移到agent协作与可靠性。
...
### [53] [Archer: Towards Agentic Review for Compiler Optimizations](http://arxiv.org/abs/2607.01808v1)
*Yunbo Ni,Shaohua Li*
...
Selection reason: 面向编译器优化的agentic评审工具，结合义务引导和确定性验证，直接相关。
...
### [54] [Regression Accumulation in Multi-Turn LLM Programming Conversations](http://arxiv.org/abs/2607.01855v1)
...
Selection reason: 多轮编程对话回归累积研究，提出Verification Gate策略提升agent可靠性。
...
### [55] [AI Writes Faster Than Humans Can Review: A Longitudinal Study of an Enterprise 2x Mandate](http://arxiv.org/abs/2607.01904v1)
...
Selection reason: 纵向实证研究 AI 编码工具采纳与代码审查自动化，对评估 coding agent 的工程化影响有参考价值。
...
### [56] [Beyond Textual Repository Exploration: Dual-Modal Structural Reasoning for Agentic Issue Resolution](http://arxiv.org/abs/2607.01929v1)
...
Selection reason: 提出双模态结构图谱增强 issue-resolution agent 的仓库探索，并在 SWE-bench 上验证，直接相关。
...
### [57] [Underspecification does not imply Incoherence: The Risks of Semantic Collapse in Coding Models](http://arxiv.org/abs/2607.01953v1)
...
Selection reason: 发现 LLM 在提示欠指定时发生语义坍缩，影响代码生成评测与正确性估计，可迁移到 agent 可靠性。
...
### [58] [Epic-Organized vs. Requirement-Aligned Gherkin: An Empirical Evaluation of LLM-Based Acceptance Criteria Generation](http://arxiv.org/abs/2607.01980v1)
...
Selection reason: 比较 epic-organized 与 requirement-aligned 的 LLM 验收标准生成策略，对 agent 生成测试类工件有参考价值。
...
### [59] [Mitigating Package Hallucinations in Large Language Models via Model Editing](http://arxiv.org/abs/2607.02052v1)
...
Selection reason: 通过模型编辑抑制包幻觉，直接提升 LLM 代码生成与依赖配置的可靠性。
...
### [60] [Prompt Coverage Adequacy](http://arxiv.org/abs/2607.02057v1)
...
Selection reason: 提出 prompt 覆盖充分度作为 LLM 生成代码的测试准则，直接关联代码生成验证。
...
### [61] [Coding Agents Are Guessing: Measuring Action-Boundary Violations in Underspecified DevOps Instructions](http://arxiv.org/abs/2607.02294v1)
...
Selection reason: 提出 UnderSpecBench 测量 coding agent 在欠指定 DevOps 指令下的越界行为，直接相关安全性评估。
...
### [62] [Guiding Human Validation of LLM-Generated Code via Verifiable Literate Programming](http://arxiv.org/abs/2607.02333v1)
...
Selection reason: 可验证文生编程框架以 NL 文档为中间层，支持 LLM 代码的细粒度人工验证与修复。
...
### [63] [SkillFuzz: Fuzzing Skill Composition for Implicit Intents Discovery in Open Skill Marketplaces](http://arxiv.org/abs/2607.02345v1)
...
Selection reason: 将技能组合模糊测试用于发现 LLM agent 隐式意图，提供执行前安全测试方法。
...
### [64] [Understanding Agent-Based Patching of Compiler Missed Optimizations](http://arxiv.org/abs/2607.02370v2)
...
Selection reason: 系统研究 agent 修复编译器漏优化并引入历史知识增强，与 SemOpt 核心直接相关。
...
### [65] [Reasoning effort, not tool access, buys first-try reliability in agentic code generation: an observational study](http://arxiv.org/abs/2607.02436v1)
*Achint Mehta*
...
Selection reason: 观测研究表明推理努力而非工具访问决定 agentic 代码生成首次可靠性，对 agent 配置有直接指导。
...
### [66] [TestEvo-Bench: An Executable and Live Benchmark for Test and Code Co-Evolution](http://arxiv.org/abs/2607.02469v1)
...
Selection reason: 提出可执行、实时的测试与代码协同演化基准，直接评测测试自动化 agent 的生成与更新能力。
...
### [67] [Can Coding Agents Implement Missed Compiler Optimizations? Evaluating LLM Agents on LLVM Peephole Optimizations](http://arxiv.org/abs/2607.02684v1)
...
Selection reason: 提出 PeepholeBench，评测 LLM agent 补全 LLVM 缺失 peephole 优化，与程序优化和 coding agent 直接相关。
...
### [68] [LLMoxie: Exploring Agentic AI for Scientific Software Development](http://arxiv.org/abs/2607.02703v1)
...
Selection reason: 描述面向科学软件的 agentic AI 平台与插件技能体系，其工作流、可审计性和领域适配经验可迁移到代码 agent。
...
### [69] [A Preliminary Study on Explaining Risk of Code Changes using LLM-Based Prediction Models](http://arxiv.org/abs/2607.02782v1)
...
Selection reason: 利用 LLM 注意力突出 diff 中风险行，可为代码审查 agent 提供轻量风险引导。
...
### [70] [A Systematic Methodology for Evaluating Failure Independence in LLM-Generated Code](http://arxiv.org/abs/2607.02808v1)
...
Selection reason: 系统评估 LLM 生成代码的失效独立性，对多版本/多 agent 可靠性设计与验证有参考。
...
### [71] [DiPS: Dialogue Policy Selection for High-Stakes Persuasion Agents](http://arxiv.org/abs/2607.01557v2)
...
### [72] [Object Aligner: A Configurable JSON Schema Similarity Score for Graphs, Applied to LLM Prompt Optimization](http://arxiv.org/abs/2607.01972v1)
*Jan Drchal*
...
### [73] [Seduced by the Narrative: Assessing Rule Adherence in Semi-Open Textual Sandboxes](http://arxiv.org/abs/2607.02802v1)
...
### [74] [CausalSteward: An Agentic Divide-Conquer-Combine Copilot for Causal Discovery](http://arxiv.org/abs/2607.01936v1)
...
### [75] [SovereignNegotiation-Bench: Evaluating User-Owned Personal Agents In Delegated Bargaining Under Privacy, Consent, Evidence, And Institutional Pressure](http://arxiv.org/abs/2607.02814v1)
*Dylan Zongmin Liu*
...
### [76] [Guided Action Flow: Q-Guided Inference for Flow-Matching Vision-Language-Action Policies](http://arxiv.org/abs/2607.02092v2)
...
### [77] [ACID: Action Consistency via Inverse Dynamics for Planning with World Models](http://arxiv.org/abs/2607.02403v1)
...
### [78] [WorldSample: Closed-loop Real-robot RL with World Modelling](http://arxiv.org/abs/2607.02431v1)
...
### [79] [Learning to Move Before Learning to Do: Task-Agnostic pretraining for VLAs](http://arxiv.org/abs/2607.02466v1)
...
### [80] [Knowledge Over Parameters: Evolving Smart Contract Vulnerability Detection](http://arxiv.org/abs/2607.01742v1)
...
Selection reason: 知识演化驱动的智能合约漏洞检测，结合运行时与LLM推理，可迁移至代码分析agent。
...
### [81] [Has This Checkpoint Been Abliterated? A Two-Signal Audit and Its Failure Map](http://arxiv.org/abs/2607.01854v1)
*Gabriel Hurtado*
...
### [82] [Behind the Refusal: Determining Guardrail Activation via Behavioral Monitoring](http://arxiv.org/abs/2607.02121v1)
...
### [83] [Cloak and Detonate: Scanner Evasion and Dynamic Detection of Agent Skill Malware](http://arxiv.org/abs/2607.02357v2)
...
Selection reason: 针对 agent skill 恶意载荷的规避与动态检测，直接提升 coding agent 供应链安全。
...
### [84] [JavaVulBench: A Java Vulnerability Benchmark with Realistic Splits, a Unified Multi-Backend Harness, and a Leakage-Aware Evaluation Mode](http://arxiv.org/abs/2607.02825v1)
...
### [85] [AgenticDataBench: A Comprehensive Benchmark for Data Agents](http://arxiv.org/abs/2607.01647v1)
...
### [86] [Characterizing and Bridging the Diagnostic Gap in eBPF Verifier Rejections](http://arxiv.org/abs/2607.02748v1)
...
Selection reason: 重构 eBPF 验证器拒绝定位并评测 LLM 修复，对程序分析和 agent 修复任务有直接价值。
...
### [87] [MMBench-Live: A Continuously Evolving Benchmark for Multimodal Models](http://arxiv.org/abs/2607.01813v1)
...
### [88] [S-EMBER: A Large-Scale Benchmark for Streaming Egocentric Memory Retrieval](http://arxiv.org/abs/2607.02689v1)
...
### [89] [Evolutionary Feature Engineering for Structured Data](http://arxiv.org/abs/2607.01548v1)
...
### [90] [Decomposer: Learning to Decompile Symbolic Music to Programs](http://arxiv.org/abs/2607.01849v1)
...
### [91] [kNNGuard: Turning LLM Hidden Activations into a Training-Free Configurable Guardrail](http://arxiv.org/abs/2607.02072v2)
...
### [92] [Neuron-Aware Active Few-Shot Learning for LLMs](http://arxiv.org/abs/2607.02423v1)
...
### [93] [Neuron-Aware Data Selection for Annotation-Free LLM Self-Distillation](http://arxiv.org/abs/2607.02460v1)
...
### [94] [DemoPSD: Disagreement-Modulated Policy Self-Distillation](http://arxiv.org/abs/2607.02502v3)
...
### [95] [Out-of-Distribution Generalization of Risk Aversion in Language Models](http://arxiv.org/abs/2607.02755v1)
...
### [96] [Safe Inference-Time Alignment via Lagrangian Reward Augmentation](http://arxiv.org/abs/2607.02781v1)
...
### [97] [ADVENT: LLM-Driven Automatic Predicate Invention for ILP](http://arxiv.org/abs/2607.01585v1)
...
### [98] [What Types of Human-AI Teams Exist?](http://arxiv.org/abs/2607.02198v1)
...
### [99] [The Eticas AI Risk Taxonomy: Open Infrastructure for Operationalizing AI Audits](http://arxiv.org/abs/2607.02201v1)
