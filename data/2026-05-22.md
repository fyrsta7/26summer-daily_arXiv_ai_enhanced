...
### [1] [Inductive Deductive Synthesis: Enabling AI to Generate Formally Verified Systems](http://arxiv.org/abs/2605.23109v1)
...
### [2] [AutoResearch AI: Towards AI-Powered Research Automation for Scientific Discovery](http://arxiv.org/abs/2605.23204v1)
...
### [3] [Foundation Protocol: A Coordination Layer for Agentic Society](http://arxiv.org/abs/2605.23218v1)
...
### [4] [GENSTRAT: Toward a Science of Strategic Reasoning in Large Language Models](http://arxiv.org/abs/2605.23238v1)
...
### [5] [Design and Report Benchmarks for Knowledge Work](http://arxiv.org/abs/2605.23262v1)
...
### [6] [Parallel Context Compaction for Long-Horizon LLM Agent Serving](http://arxiv.org/abs/2605.23296v1)
...
### [7] [DART: Semantic Recoverability for Structured Tool Agents](http://arxiv.org/abs/2605.23311v1)
...
### [8] [Human-in-the-Loop Multi-Agent Ventilator Decision Support with Contextual Bandit Preference Learning](http://arxiv.org/abs/2605.23320v1)
...
### [9] [When Planning Fails Despite Correct Execution: On Epistemic Calibration for LLM-Based Multi-Agent Systems](http://arxiv.org/abs/2605.23414v1)
...
### [10] [Co-ReAct: Rubrics as Step-Level Collaborators for ReAct Agents](http://arxiv.org/abs/2605.23590v1)
...
### [11] [One Policy, Infinite NPCs: Persona-Traceable Shared RL Policies for Scalable Game Agents](http://arxiv.org/abs/2605.23652v1)
*Yoosung Hong*
...
### [12] [MemAudit: Post-hoc Auditing of Poisoned Agent Memory via Causal Attribution and Structural Anomaly Detection](http://arxiv.org/abs/2605.23723v1)
...
### [13] [Agentic Proving for Program Verification](http://arxiv.org/abs/2605.23772v1)
...
Selection reason: 将agentic proving用于Lean 4程序验证基准，评估Claude Code的规格生成与验证能力，对程序验证agent和评测体系有直接价值。
...
### [14] [From Raw Experience to Skill Consumption: A Systematic Study of Model-Generated Agent Skills](http://arxiv.org/abs/2605.23899v1)
...
### [15] [SkillOpt: Executive Strategy for Self-Evolving Agent Skills](http://arxiv.org/abs/2605.23904v2)
...
### [16] [EvoCode-Bench: Evaluating Coding Agents in Multi-Turn Iterative Interactions](http://arxiv.org/abs/2605.24110v1)
...
### [17] [SkillEvolBench: Benchmarking the Evolution from Episodic Experience to Procedural Skills](http://arxiv.org/abs/2605.24117v1)
...
### [18] [MAPLE: Multi-State Aggregated Policy Evaluation for AlphaZero in Imperfect-Information Games](http://arxiv.org/abs/2605.24139v1)
...
### [19] [HyperGuide: Hyperbolic Guidance for Efficient Multi-Step Reasoning in Large Language Models](http://arxiv.org/abs/2605.24140v2)
...
### [20] [Neuro-Inspired Inverse Learning for Planning and Control](http://arxiv.org/abs/2605.24152v2)
...
### [21] [Inference Time Context Sparsity: Illusion or Opportunity?](http://arxiv.org/abs/2605.24168v1)
...
### [22] [A Sober Look at Agentic Misalignment in Automated Workflows](http://arxiv.org/abs/2605.24197v2)
...
### [23] [When Does Multi-Agent RL Improve LLM Workflows? Workflow, Scale, and Policy-Sharing Tradeoffs](http://arxiv.org/abs/2605.24202v2)
...
### [24] [Identifying and Mitigating Systemic Measurement Bias in Production LLM Inference Benchmarks](http://arxiv.org/abs/2605.24217v2)
...
### [25] [Beyond Final Answers: Auditing Trajectory-Level Hallucinations in Multi-Agent Industrial Workflows](http://arxiv.org/abs/2605.24219v2)
...
### [26] [How Well Do Models Follow Their Constitutions?](http://arxiv.org/abs/2605.24229v1)
...
### [27] [The Impact of AI Coding Assistants on Software Engineering: A Longitudinal Study](http://arxiv.org/abs/2605.23135v1)
...
Selection reason: 纵向研究AI编码助手对任务焦点与开发者体验的影响，提出监督式工程工作等概念，对理解编码agent使用效应有参考价值。
...
### [28] [AI Assurance: A Comprehensive Testing Strategy for Enterprise AI Systems](http://arxiv.org/abs/2605.23459v1)
...
Selection reason: 面向企业LLM/agent系统的测试与保障策略，提供了AI测试的分类与评估驱动开发框架，可迁移到agent评测和可靠性设计。
...
### [29] [TRACER: A Semantic-Aware Framework for Fine-Grained Contamination Detection in Code LLMs](http://arxiv.org/abs/2605.24079v1)
...
Selection reason: 面向代码LLM的语义感知细粒度数据污染检测，提升benchmark可信度与评测可靠性，可迁移到代码agent评测场景。
...
### [30] [Empirical Analysis and Detection of Hallucinations in LLM-Generated Bug Report Summaries](http://arxiv.org/abs/2605.24137v1)
...
Selection reason: 针对LLM生成的bug报告摘要做分节感知幻觉检测，可提升代码维护类agent输出的可靠性，但主题细节相对聚焦。
...
### [31] [Understanding Conversational Patterns in Multi-agent Programming: A Case Study on Fibonacci Game Development](http://arxiv.org/abs/2605.24138v1)
...
Selection reason: 分析双agent编程协作中的角色对齐、收敛效率与错误传播，为多agent软件工程的工作流与控制机制提供实证与启发。
...
### [32] [VISTA: An End-to-End Benchmark for Visual Spec-to-Web-App Coding Agents](http://arxiv.org/abs/2605.26144v3)
...
Selection reason: 提出端到端视觉规格到Web应用生成的编码agent基准，包含多模态评测与交互组件标注，直接面向UI类coding agent评估。
...
### [33] [Towards Evaluation Engineering: An Empirical Study of ML Evaluation Harnesses in the Wild](http://arxiv.org/abs/2605.24213v1)
...
Selection reason: 对57个ML评估harness做实证研究并总结工作流阶段与根因，对构建和优化agent/harness有方法迁移价值。
...
### [34] [PoisonForge: Task-Level Targeted Poisoning Benchmark for Instruction-Tuned LLMs](http://arxiv.org/abs/2605.23168v1)
...
### [35] [Are Frontier LLMs Ready for Cybersecurity? Evidence for Vertical Foundation Models from Dual-Mode Vulnerability Benchmarks](http://arxiv.org/abs/2605.23243v5)
...
### [36] [When the Manual Lies: A Realistic Benchmark to Evaluate MCP Poisoning Attacks for LLM Agents](http://arxiv.org/abs/2605.24069v1)
...
### [37] [Attested Tool-Server Admission: A Security Extension to the Model Context Protocol](http://arxiv.org/abs/2605.24248v2)
*Alfredo Metere*
...
Selection reason: 为MCP提供带认证的工具服务器准入与按服务器工具白名单机制，提升coding agent工具链的安全可控性。
...
### [38] [An Empirical Evaluation of LLM-Generated Code Security Across Prompting Methods](http://arxiv.org/abs/2605.24298v1)
...
### [39] [Enhancing Reliability in LLM-Based Secure Code Generation](http://arxiv.org/abs/2605.24300v1)
...
### [40] [An Interactive Paradigm for Deep Research](http://arxiv.org/abs/2605.24266v1)
...
### [41] [ContextEcho: A Benchmark for Persona Drift in Long Agentic-Coding Sessions](http://arxiv.org/abs/2605.24279v1)
...
Selection reason: 构造ContextEcho基准与快照探测协议，刻画长时agentic编码会话中persona漂移，直接面向coding agent长期会话评测。
...
### [42] [MileStone: A Multi-Objective Compiler Phase Ordering Framework for Graph-based IR-Level Optimization](http://arxiv.org/abs/2605.23435v1)
...
Selection reason: 图表示与强化学习求解多目标编译器pass排序，直接属于自动程序性能优化方向，可迁移到编译优化与benchmark验证。
...
### [43] [JEDI: Java Evaluation of Declarative and Imperative Queries](http://arxiv.org/abs/2605.23543v1)
...
Selection reason: 提出Java Stream API性能基准套件JEDI，并通过SQL转换生成多种实现与并行策略对比，直接服务于程序性能优化与benchmark设计。
...
### [44] [Misleading Microbenchmarks on the Java Virtual Machines](http://arxiv.org/abs/2605.23570v1)
...
Selection reason: 系统分析JVM微基准测试在分层编译下的误导性问题并扩充实践指南，对benchmark可靠性与性能评估方法有直接迁移价值。
...
### [45] [CHRONOS: Temporally-Aware Multi-Agent Coordination for Evolving Data Marketplaces](http://arxiv.org/abs/2605.23887v1)
*Joydeep Chandra*
...
### [46] [The Time is Here for Just-in-Time Systems: Challenges and Opportunities](http://arxiv.org/abs/2605.24096v1)
...
Selection reason: 用Claude Code按规格即时合成定制键值存储系统，并通过测试套迭代优化性能，直接展现编码agent用于系统生成与性能优化的潜力。
...
### [47] [AvalancheBench: Evaluating Enterprise Data Agents Through Latent World Recovery](http://arxiv.org/abs/2605.24183v1)
...
### [49] [Symbolic Reasoning Frameworks Trigger Memory-Mediated Ecosystem Dynamics in Multi-Agent LLM Systems](http://arxiv.org/abs/2606.07552v2)
*Augustin Chan*
...
### [50] [ARMS: Automatic Reward Shaping for Sparse-Reward Multi-Agent Reinforcement Learning](http://arxiv.org/abs/2605.23562v1)
...
### [51] [Autonomous Frontier-Based Exploration with VLM Guidance](http://arxiv.org/abs/2605.23165v1)
...
### [52] [MGRetrieval: Memory-Guided Reflective Retrieval for Long-Term Dialogue Agents](http://arxiv.org/abs/2605.27437v1)
...
### [53] [Infra-Bayesian Reinforcement Learning Agents Outperform Classical RL For Worst-Case Robustness](http://arxiv.org/abs/2605.23146v2)
...
### [54] [FastKernels: Benchmarking GPU Kernel Generation in Production](http://arxiv.org/abs/2605.23215v1)
...
### [55] [CoSPlay: Cooperative Self-Play at Test-Time with Self-Generated Code and Unit Test](http://arxiv.org/abs/2605.23491v2)
...
### [56] [Not All Transitions Matter: Evidence from PPO](http://arxiv.org/abs/2605.24071v2)
*Ajhesh Basnet*
...
### [57] [Goal-Conditioned Agents that Learn Everything All at Once](http://arxiv.org/abs/2605.23551v1)
...
### [58] [Understanding Goal Generalisation in Sequential Reinforcement Learning](http://arxiv.org/abs/2605.23565v1)
...
### [59] [Push Your Agent: Measuring and Enforcing Quantitative Goal Persistence in Long-Horizon LLM Agents](http://arxiv.org/abs/2605.23574v1)
...
Selection reason: 提出量化目标坚持度基准PushBench，测度长程agent在验证器支持下的持久性与防重复提交，直接服务coding agent可靠性与评测。
...
### [60] [From Demonstrations to Rewards: Test-Time Prompt Optimization for VLM Reward Models](http://arxiv.org/abs/2606.00083v1)
...
### [61] [PromptAudit: Auditing Prompt Sensitivity in LLM-Based Vulnerability Detection](http://arxiv.org/abs/2605.24171v1)
...
### [62] [Agent-ToM: Learning to Monitor Autonomous LLM Agents via Theory-of-Mind Reasoning](http://arxiv.org/abs/2605.24216v1)
...
### [63] [ChainFlow-VLA: Causal Flow Planning with Vision-Language Models](http://arxiv.org/abs/2605.23270v1)
...
### [64] [EvalVerse: Pipeline-Aware and Expert-Calibrated Benchmarking for Professional Cinematic Video Generation](http://arxiv.org/abs/2605.23271v1)
...
### [65] [PathNavigate: A Training-Free Pathology Agent with Surprise-Guided Scan and Shared Slide Memory for Whole-Slide Image VQA](http://arxiv.org/abs/2605.23559v1)
...
### [66] [PhotoFlow: Agentic 3D Virtual Photography Missions](http://arxiv.org/abs/2605.23771v1)
...
### [67] [ETCHR: Editing To Clarify and Harness Reasoning](http://arxiv.org/abs/2605.23897v1)
