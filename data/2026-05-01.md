...
### [1] [AgentFloor: How Far Up the tool use Ladder Can Small Open-Weight Models Go?](http://arxiv.org/abs/2605.00334v1)
...
### [2] [AEM: Adaptive Entropy Modulation for Multi-Turn Agentic Reinforcement Learning](http://arxiv.org/abs/2605.00425v3)
...
### [3] [Thinking in Text and Images: Interleaved Vision--Language Reasoning Traces for Long-Horizon Robot Manipulation](http://arxiv.org/abs/2605.00438v1)
...
### [4] [Learn where to Click from Yourself: On-Policy Self-Distillation for GUI Grounding](http://arxiv.org/abs/2605.00642v3)
...
### [5] [To Call or Not to Call: A Framework to Assess and Optimize LLM Tool Calling](http://arxiv.org/abs/2605.00737v2)
...
### [6] [Position: agentic AI orchestration should be Bayes-consistent](http://arxiv.org/abs/2605.00742v2)
...
### [7] [Effect-Transparent Governance for AI Workflow Architectures: Semantic Preservation, Expressive Minimality, and Decidability Boundaries](http://arxiv.org/abs/2605.01030v3)
*Alan L. McCann*
...
### [8] [Algebraic Semantics of Governed Execution: Monoidal Categories, Effect Algebras, and Coterminous Boundaries](http://arxiv.org/abs/2605.01032v3)
*Alan L. McCann*
...
### [9] [Virtual Speech Therapist: A Clinician-in-the-Loop AI Speech Therapy Agent for Personalized and Supervised Therapy](http://arxiv.org/abs/2605.01101v2)
...
### [10] [Towards Multi-Agent Autonomous Reasoning in Hydrodynamics](http://arxiv.org/abs/2605.01102v1)
...
### [11] [New Bounds for Zarankiewicz Numbers via Reinforced LLM Evolutionary Search](http://arxiv.org/abs/2605.01120v2)
...
### [12] [A Low-Latency Fraud Detection Layer for Detecting Adversarial Interaction Patterns in LLM-Powered Agents](http://arxiv.org/abs/2605.01143v2)
...
### [13] [Position: Safety and Fairness in Agentic AI Depend on Interaction Topology, Not on Model Scale or Alignment](http://arxiv.org/abs/2605.01147v1)
...
### [14] [Code World Model Preparedness Report](http://arxiv.org/abs/2605.00932v2)
...
Selection reason: Meta代码世界模型准备度报告，面向代码生成与代码推理能力，对Coding Agent有直接参考价值。
...
### [15] [Social Bias in LLM-Generated Code: Benchmark and Mitigation](http://arxiv.org/abs/2605.00382v3)
...
Selection reason: 构建LLM生成代码社会偏见基准并提出公平性监控Agent，直接相关代码生成Agent评测与改进。
...
### [16] [ClozeMaster: Fuzzing Rust Compiler by Harnessing LLMs for Infilling Masked Real Programs](http://arxiv.org/abs/2605.00413v1)
...
Selection reason: 基于LLM掩码填充的Rust编译器模糊测试，发现27个真实bug，是有效的测试生成方法。
...
### [17] [Improving LLM Code Generation via Requirement-Aware Curriculum Reinforcement Learning](http://arxiv.org/abs/2605.00433v1)
...
Selection reason: 需求感知课程强化学习提升LLM代码生成，直接优化代码生成模型训练方法，有性能提升实证。
...
### [18] [PPO guided Agentic Pipeline for Adaptive Prompt Selection and Test Case Generation](http://arxiv.org/abs/2605.00942v1)
...
Selection reason: PPO驱动的Agentic流程自适应提示选择与测试用例生成，提升分支/行覆盖率，直接面向代码测试Agent。
...
### [19] [Think Harder and Don't Overlook Your Options: Revisiting Issue-Commit Linking with LLM-Assisted Retrieval](http://arxiv.org/abs/2605.00447v2)
...
Selection reason: 系统评估多种检索与重排序方法用于issue-commit链接恢复，包含LLM对比，对代码检索与追踪有参考价值。
...
### [20] [Q-ARE: An Evaluation Dataset for Query Based API Recommendation](http://arxiv.org/abs/2605.00472v1)
...
Selection reason: 构建基于API推荐评测数据集及两个新指标，系统性评估现有方法与LLM，推进语义理解与代码检索。
...
### [21] [EnCoDe: Energy Estimation of Source Code At Design-Time](http://arxiv.org/abs/2605.00504v1)
...
Selection reason: 面向设计期的细粒度能耗建模与预测，可作profiling/能耗调优的参考方法。
...
### [22] [Themis: Training Robust Multilingual Code Reward Models for Flexible Multi-Criteria Scoring](http://arxiv.org/abs/2605.00754v3)
...
Selection reason: 构建多语言多准则代码奖励模型评测与训练集，直接支撑代码agent的后训练与评测。
...
### [23] [GeoContra: From Fluent GIS Code to Verifiable Spatial Analysis with Geography-Grounded Repair](http://arxiv.org/abs/2605.00782v1)
...
Selection reason: 以可执行契约、静态/运行时验证和修复循环约束LLM代码生成，对agent可靠性验证有迁移价值。
...
### [24] [Can Coding Agents Reproduce Findings in Computational Materials Science?](http://arxiv.org/abs/2605.00803v1)
...
Selection reason: 提出AutoMat基准评测coding agent复现材料科学工作流，并分析失败模式，对agent评估有参考价值。
...
### [25] [RECAP: An End-to-End Platform for Capturing, Replaying, and Analyzing AI-Assisted Programming Interactions](http://arxiv.org/abs/2605.01104v1)
...
Selection reason: 提供捕获、回放与分析AI编程交互的平台，可直接支撑agent行为研究和评估。
...
### [26] [The Productivity-Reliability Paradox: Specification-Driven Governance for AI-Augmented Software Development](http://arxiv.org/abs/2605.01160v1)
*Sabry E. Farrag*
...
Selection reason: 提出AI辅助开发的效率-可靠性悖论与规格治理模型，对agent可靠性设计具有参考价值。
...
### [27] [Value Functions for Temporal Logic: Optimal Policies and Safety Filters](http://arxiv.org/abs/2605.01051v1)
...
### [28] [Governing What the EU AI Act Excludes: Accountability for Autonomous AI Agents in Smart City Critical Infrastructure](http://arxiv.org/abs/2605.01091v1)
...
### [29] [Odysseus: Scaling VLMs to 100+ Turn Decision-Making in Games via Reinforcement Learning](http://arxiv.org/abs/2605.00347v1)
...
### [30] [InvEvolve: Evolving White-Box Inventory Policies via Large Language Models with Performance Guarantees](http://arxiv.org/abs/2605.00369v4)
...
### [31] [From Static Analysis to Audience Dissemination: A Training-Free Multimodal Controversy Detection Multi-Agent Framework](http://arxiv.org/abs/2605.02939v1)
...
### [32] [PrismAgent: Illuminating Harm in Memes via a Zero-Shot Interpretable Multi-Agent Framework](http://arxiv.org/abs/2605.02940v1)
*Zihan Ding,Ziyuan Yang,Yi Zhang*
...
### [33] [Hierarchical Abstract Tree for Cross-Document Retrieval-Augmented Generation](http://arxiv.org/abs/2605.00529v1)
...
### [34] [Healthcare AI GYM for Medical Agents](http://arxiv.org/abs/2605.02943v1)
*Minbyul Jeong*
...
### [35] [Exploring Pass-Rate Reward in Reinforcement Learning for Code Generation](http://arxiv.org/abs/2605.02944v1)
...
Selection reason: 直接研究代码生成RL中pass-rate与二元奖励的效果差异，对agent训练奖励设计有重要价值。
...
### [36] [AgentStop: Terminating Local AI Agents Early to Save Energy in Consumer Devices](http://arxiv.org/abs/2605.15206v1)
...
### [37] [When Less is Enough: Efficient Inference via Collaborative Reasoning](http://arxiv.org/abs/2605.01111v1)
...
### [38] [BlenderRAG: High-Fidelity 3D Object Generation via Retrieval-Augmented Code Synthesis](http://arxiv.org/abs/2605.00632v1)
...
### [39] [AgenticAITA: A Proof-Of-Concept About Deliberative Multi-Agent Reasoning for Autonomous Trading Systems](http://arxiv.org/abs/2605.12532v1)
*Ivan Letteri*
...
### [40] [LLM-Oriented Information Retrieval: A Denoising-First Perspective](http://arxiv.org/abs/2605.00505v2)
...
### [41] ["I Don't Know" -- Towards Appropriate Trust with Certainty-Aware Retrieval Augmented Generation](http://arxiv.org/abs/2605.00957v1)
...
### [42] [Separation Assurance between Heterogeneous Fleets of Small Unmanned Aerial Systems via Multi-Agent Reinforcement Learning](http://arxiv.org/abs/2605.01041v3)
...
### [43] [Semia: Auditing Agent Skills via Constraint-Guided Representation Synthesis](http://arxiv.org/abs/2605.00314v1)
...
### [44] [Skills as Verifiable Artifacts: A Trust Schema and a Biconditional Correctness Criterion for Human-in-the-Loop Agent Runtimes](http://arxiv.org/abs/2605.00424v2)
*Alfredo Metere*
...
Selection reason: 提出技能作为可验证工件、信任模型与双条件正确性准则，增强Agent运行时的可靠性与HITL机制。
...
### [45] [E-MIA: Exam-Style Black-Box Membership Inference Attacks against RAG Systems](http://arxiv.org/abs/2605.00955v1)
...
### [46] [When RAG Chatbots Expose Their Backend: An Anonymized Case Study of Privacy and Security Risks in Patient-Facing Medical AI](http://arxiv.org/abs/2605.00796v1)
...
### [47] [Certified Purity for Cognitive Workflow Executors: From Static Analysis to Cryptographic Attestation](http://arxiv.org/abs/2605.01037v3)
*Alan L. McCann*
...
### [48] [LLM Ghostbusters: Surgical Hallucination Suppression via Adaptive Unlearning](http://arxiv.org/abs/2605.01047v1)
...
### [49] [A Sentence Relation-Based Approach to Sanitizing Malicious Instructions](http://arxiv.org/abs/2605.01078v1)
...
### [50] [LLM-assisted gNB Parameter Configuration for Radio Access Network](http://arxiv.org/abs/2606.20574v1)
...
### [51] [Human-AI Coordination Zones: A Framework for Designing Human-in-the-Loop Experiences with Agentic AI](http://arxiv.org/abs/2606.09848v1)
...
### [52] [SAGA: Workflow-Atomic Scheduling for AI Agent Inference on GPU Clusters](http://arxiv.org/abs/2605.00528v2)
...
### [53] [MemRouter: Memory-as-Embedding Routing for Long-Term Conversational Agents](http://arxiv.org/abs/2605.00356v1)
...
### [54] [Safeguarding LLM Agents from Misalignment through Provenance Analysis](http://arxiv.org/abs/2607.01236v1)
...
### [55] [Context Recycling for Long-Horizon LLM Inference](http://arxiv.org/abs/2606.26105v1)
*Derek Thomas*
...
### [56] [Agent Capsules: Quality-Gated Granularity Control for Multi-Agent LLM Pipelines](http://arxiv.org/abs/2605.00410v1)
*Aninda Ray*
...
Selection reason: 多Agent LLM管线的质量门控粒度控制运行时，显著降低token消耗且保质量，可迁移至代码Agent工作流优化。
...
### [57] [Impact of Task Phrasing on Presumptions in Large Language Models](http://arxiv.org/abs/2605.00436v1)
*Kenneth J. K. Ong*
...
### [58] [A11y-Compressor: A Framework for Enhancing the Efficiency of GUI Agent Observations through Visual Context Reconstruction and Redundancy Reduction](http://arxiv.org/abs/2605.00551v1)
...
### [59] [Structure Liberates: How Constrained Sensemaking Produces More Novel Research Output](http://arxiv.org/abs/2605.00557v1)
...
### [60] [Just Keep Prompting: Evaluating Repetitive Socratic Prompting in VLMs](http://arxiv.org/abs/2607.14099v1)
