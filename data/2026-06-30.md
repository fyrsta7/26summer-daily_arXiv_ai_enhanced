...
Comments: 37 pages, 4 figures; source code available at https://github.com/beetree/ARC-AGI
...
### [44] [SWE-Router: Routing in Multi-turn Agentic Software Engineering Tasks](http://arxiv.org/abs/2607.00053v1)
...
Selection reason: 提出基于轨迹的价值路由SWE-Router，让便宜模型先探索再由部分轨迹决定是否升级，显著提升多轮SWE agent成本效率并给出最优性保证。
...
### [45] [An Empirical Study of Security Calibration in Large Language Models for Code](http://arxiv.org/abs/2606.31159v1)
...
Selection reason: 首次大规模研究代码生成LLM的安全校准并检验校准引导修复，对代码agent的可信评估与安全修复有直接参考。
...
### [46] [FeatX: Editing Software by Editing Features for Repository-Level Code Evolution](http://arxiv.org/abs/2606.31206v1)
...
Selection reason: 提出面向feature的仓库级代码编辑工具FeatX，用层次化feature结构与三阶段Evolution Agent生成补丁，显著降低认知负荷并提升定位效果。
...
### [47] [A Multi-Dimensional, Per-Pass Empirical Study of the LLVM Optimization Pipeline](http://arxiv.org/abs/2606.31238v1)
...
Selection reason: 对LLVM -O3管线做逐pass的8.4万次系统测量，揭示非单调性、帕累托支配与能量收益，为编译器自动调优与phase ordering提供关键实证。
...
### [48] [MOA: A Profiling-Guided LLM Framework for Memory-Optimization Automation at Codebase Scale](http://arxiv.org/abs/2606.31368v1)
...
Selection reason: MOA用三个LLM agent自动检测并修复大规模C/C++内存低效，profiling指导加静态分析器生成与补丁生成，堆和二进制体积显著下降且专家接受率高。
...
### [49] [AlgoBench: Benchmarking Algorithmic Adaptation in Code Generation](http://arxiv.org/abs/2607.00062v1)
...
Selection reason: AlgoBench通过约束变换自动生成新算法问题并引入复杂度感知指标，评估代码LLM的算法改编能力，为代码生成benchmark提供新方法。
...
### [50] [Falsification, Not Exposure: An Internally Preregistered Placebo-Controlled Decomposition of Self-Repair Feedback in Frozen Small Code Models](http://arxiv.org/abs/2606.31511v1)
*Mehmet Iscan*
...
Selection reason: 通过安慰剂对照分解自修复反馈，研究代码模型重试机制中的可执行反例价值，对代码 agent 反馈设计与评测有直接迁移价值。
...
### [51] [ScratchWorld: Evaluating If World Models Compute Executable Consequences](http://arxiv.org/abs/2606.31689v1)
...
Selection reason: 将 Scratch 程序作为可执行世界评测模型对状态变化和因果后果的预测，对程序执行理解与 agent 状态追踪评测有参考价值。
...
### [52] [AdaTrans: Automated C to Rust Transformation via Error-Adaptive Repair](http://arxiv.org/abs/2606.31706v1)
...
Selection reason: 提出基于错误自适应修复的 C 到 Rust 自动转换框架，结合 RAG 与多阶段验证，直接面向代码变换与修复 agent。
...
### [53] [Do Machines Struggle Where Humans Do? LLM and Human Comprehension of Obfuscated Code](http://arxiv.org/abs/2606.31725v1)
...
Selection reason: 比较 LLM 与人类在混淆代码理解上的失败模式，对代码理解模型评估与可解释性有参考价值。
...
### [54] [JETO-Bench: A Reproducible Benchmark for Execution Time Improvement Patches in Java](http://arxiv.org/abs/2606.31767v1)
...
Selection reason: 构建可扩展的执行时间改进补丁基准并评测 OpenHands 编码 agent，直接属于自动程序性能优化与 agent 评测。
...
### [55] [CoCoMUT: A Tool for Code-Context Mining and Automated Dataset Generation](http://arxiv.org/abs/2606.31971v1)
*Alessandro Botta,Shiven Garisa,Jaya Vardhini Akurathi,Ahsanul Ameen Sabit,Trey Woodlief,Soneya Binta Hossain*

Main category: cs.SE

Comments: 5 pages, 1 figure. Submitted to ISSTA 2026 Tool Track

Selection reason: 提供 Java 方法级代码上下文挖掘与数据集生成工具，可支持代码检索、测试、修复等 SE agent 的数据准备。
...
### [56] [The Illusion of Safety: Multi-Tier Verification of AI vs. Human C++ Code](http://arxiv.org/abs/2607.00107v2)
...
Selection reason: 构建多层级验证基准比较 AI 与人类 C++ 代码安全性，对 AI 生成代码的正确性与安全验证有重要价值。
...
### [57] [Benchmarking the Benchmarks: A Validity Audit of Tool-Calling Evaluation](http://arxiv.org/abs/2607.02577v1)
...
Selection reason: 系统审计工具调用基准的评估器有效性，提出归因分解指标与可配置基准，对 agent 评测机制有直接改进价值。
...
### [58] [When Not to Write Memory: Governing False Promotion from Correlated Agent Traces](http://arxiv.org/abs/2607.02579v1)
...
Selection reason: 研究 agent 记忆写入路径中的错误提升治理，提出依赖感知的支持度评估策略，可迁移到代码 agent 的记忆与可靠性设计。
...
### [59] [MIRTH: Mutual-Information Reasoning with Temporal Hubs for Vision-Language-Action Agents](http://arxiv.org/abs/2606.31167v1)
...
### [60] [3D HAMSTER: Bridging Planning and Control in Hierarchical Vision Language Action Models through 3D Trajectory Guidance](http://arxiv.org/abs/2606.31329v2)
...
### [61] [Stage-Transition Dense Reward Modeling for Reinforcement Learning](http://arxiv.org/abs/2606.31377v1)
...
### [62] [Z-1: Efficient Reinforcement Learning for Vision-Language-Action Models](http://arxiv.org/abs/2606.31846v1)
...
### [63] [MVP-Nav: Multi-layer Value Map Planner Navigator](http://arxiv.org/abs/2606.31919v1)
...
### [64] [Freeform Preference Learning for Robotic Manipulation](http://arxiv.org/abs/2606.32027v2)
...
### [65] [ASPIRE: Agentic /Skills Discovery for Robotics](http://arxiv.org/abs/2607.00272v1)
...
### [66] [Automating Cause-Effect Specification with Knowledge Graphs and Large Language Models](http://arxiv.org/abs/2606.31614v1)
...
### [67] [A Tutorial on Autonomous Fault-Tolerant Control Using Knowledge-Grounded LLM Agents](http://arxiv.org/abs/2606.31635v1)
...
### [68] [Learning from Failure: Inference-Time Self-Improvement for Computer-Use Agents](http://arxiv.org/abs/2606.31270v1)
...
### [69] [WorldRoamBench: An Open-World Benchmark for Long-Horizon Stability of Interactive World Models](http://arxiv.org/abs/2606.31672v3)
...
### [70] [EgoSafetyBench: A Diagnostic Egocentric Video Benchmark for Evaluating Embodied VLMs as Runtime Safety Guards](http://arxiv.org/abs/2607.00218v1)
...
### [71] [FinPersona-Bench: A Benchmark for Longitudinal Psychometric Stability of Autonomous Financial Agents](http://arxiv.org/abs/2606.31522v2)
...
### [72] [Seeing Is Not Sharing: Some Vision-Language Models Overestimate Common Ground in Asymmetric Dialogue](http://arxiv.org/abs/2606.31719v1)
...
### [73] [DigitalCoach: Communication and Grounding Gaps in Human and Agentic Computer Use Coaching](http://arxiv.org/abs/2606.31980v1)
...
### [74] [Reinforcement Learning with Metacognitive Feedback Elicits Faithful Uncertainty Expression in LLMs](http://arxiv.org/abs/2606.32032v1)
...
### [75] [A Lifecycle and Application-Stack Survey of Large Language Model Vulnerabilities: Attacks, Risks, Defenses, and Open Problems](http://arxiv.org/abs/2606.31639v1)
...
### [76] [Active Sensing for RIS-Aided Tracking and Power Control: A Hybrid Neuroevolution and Supervised Learning Approach](http://arxiv.org/abs/2607.00056v2)
...
### [77] [Governance Gaps in Agent Interoperability Protocols: What MCP, A2A, and ACP Cannot Express](http://arxiv.org/abs/2606.31498v1)
...
Selection reason: 系统分析MCP/A2A/ACP等agent互操作协议在治理需求上的能力缺口，为构建可治理的多agent代码协作系统提供设计依据。
...
### [78] [MECoBench: A Systematic Study of Multimodal Agent Collaboration in Embodied Environments](http://arxiv.org/abs/2606.31966v1)
...
### [79] [PPT-Eval: A Benchmark for Computer-Use Agents on PowerPoint Tasks](http://arxiv.org/abs/2606.31154v1)
...
### [80] [Calibrating the Evaluator: Does Probability Calibration Mitigate Preference Coupling in LLM Agent Feedback Loops?](http://arxiv.org/abs/2606.31371v1)
*Zewen Liu*
...
### [81] [Evil Spectra: How Optimisers can Amplify or Suppress Emergent Misalignment](http://arxiv.org/abs/2606.31591v1)
...
### [82] [ECHO: Prune To Act, Trace To Learn With Selective Turn Memory In Agentic RL](http://arxiv.org/abs/2606.31650v3)
...
### [83] [TRIAGE: Role-Typed Credit Assignment for Agentic Reinforcement Learning](http://arxiv.org/abs/2606.32017v2)
...
### [84] [AdaJEPA: An Adaptive Latent World Model](http://arxiv.org/abs/2606.32026v1)
...
### [85] [QVal: Cheaply Evaluating Dense Supervision Signals for Long-Horizon LLM Agents](http://arxiv.org/abs/2606.32034v1)
...
### [86] [DA-Studio: An Agentic System for End-to-End Data Analysis](http://arxiv.org/abs/2606.31423v1)
...
### [87] [ShopX: A Foundation Model for Intent-to-Item Fulfillment in Agentic Shopping](http://arxiv.org/abs/2606.31693v2)
...
### [88] [GR2 Technical Report](http://arxiv.org/abs/2606.31984v3)
