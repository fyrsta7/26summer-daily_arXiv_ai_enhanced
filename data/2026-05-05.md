...
Comments: Accepted at ICAPS 2026
...
Selection reason: 上下文注入对多agent设计探索的影响，指导条件化上下文设计。
...
### [30] [POSTCONDBENCH: Benchmarking Correctness and Completeness in Formal Postcondition Inference](http://arxiv.org/abs/2605.03356v1)
...
Selection reason: 提出多语言后置条件生成基准POSTCONDBENCH，用于评测LLM的代码分析与生成能力，直接相关。
...
### [31] [LATS-RCA: Language Agent Tree Search for Root Cause Analysis in Microservices](http://arxiv.org/abs/2605.03505v2)
...
Selection reason: 将语言agent树搜索用于微服务根因分析，反射引导的多agent诊断机制对代码agent的调试与长程推理有直接迁移价值。
...
### [32] [ProgramBench: Can Language Models Rebuild Programs From Scratch?](http://arxiv.org/abs/2605.03546v1)
...
Selection reason: 提出程序重建基准ProgramBench，全面评测软件工程agent的架构设计与端到端实现能力，高度相关。
...
### [33] [Deep Graph-Language Fusion for Structure-Aware Code Generation](http://arxiv.org/abs/2605.03689v1)
*Mert Tiftikci,Amir Molzam Sharifloo,Mira Mezini*

Main category: cs.SE

Comments: Accepted in Forge 2026

Selection reason: 提出图-语言深度融合框架CGFuse用于代码生成，图特征注入PLM内部的方法对结构感知代码生成有直接帮助。
...
### [34] [KVerus: Scalable and Resilient Formal Verification Proof Generation for Rust Code](http://arxiv.org/abs/2605.03822v1)
...
Selection reason: KVerus利用RAG和自适应性验证自动生成与修复Rust形式化证明，跨文件依赖处理对coding agent的长程代码验证极具价值。
...
### [35] [Beyond Rules: LLM-Powered Linting for Quantum Programs](http://arxiv.org/abs/2605.03943v1)
...
Selection reason: 将LLM与CoT/RAG结合用于量子程序静态分析linting，展示了LLM作为linter的通用范式，可迁移至代码分析agent。
...
### [36] [Randomized and Diverse Input State Generation for Quantum Program Testing](http://arxiv.org/abs/2605.03957v1)
...
Selection reason: 提出量子程序测试输入生成器与多样性评分，覆盖量子态空间的测试方法对测试agent设计有参考价值。
...
### [37] [Mitigating False Positives in Static Memory Safety Analysis of Rust Programs via Reinforcement Learning](http://arxiv.org/abs/2605.04000v2)
...
Selection reason: RL抑制静态分析误报，可迁移到代码agent的反馈验证机制。
...
### [38] [A Multi-Agent Consensus Protocol for Stable Software Remodularization](http://arxiv.org/abs/2605.04188v1)
*Ahmed F. Ibrahim*
...
Selection reason: 多agent协商协议用于软件重构，可迁移到分布式agent协作。
...
### [39] [Reproduction Test Generation for Java SWE Issues](http://arxiv.org/abs/2605.04320v2)
...
Selection reason: Java复现测试生成benchmark和工具，为agent提供执行反馈。
...
### [40] [A Skill-Based AI Agentic Pipeline for Library of Congress Subject Indexing](http://arxiv.org/abs/2605.03537v1)
*Eric H. C. Chow*
...
### [41] [Physics-Grounded Multi-Agent Architecture for Traceable, Risk-Aware Human-AI Decision Support in Manufacturing](http://arxiv.org/abs/2605.04003v1)
...
### [42] [ARMATA: Auto-Regressive Multi-Agent Task Assignment](http://arxiv.org/abs/2605.04225v1)
...
### [43] [RAG over Thinking Traces Can Improve Reasoning Tasks](http://arxiv.org/abs/2605.03344v2)
...
### [44] [Decision-aware User Simulation Agent for Evaluating Conversational Recommender Systems](http://arxiv.org/abs/2605.05250v1)
...
### [45] [FINER-SQL: Boosting Small Language Models for Text-to-SQL](http://arxiv.org/abs/2605.03465v1)
...
### [46] [Governed Metaprogramming for Intelligent Systems: Reclassifying Eval as a Governed Effect](http://arxiv.org/abs/2605.05248v4)
*Alan L. McCann*
...
### [47] [An Ethical eValuation Agent (EeVA): Results of a Proof-of-Concept Test on a Prototype Agentic-like Workflow to Assist Ethical Deliberations](http://arxiv.org/abs/2606.11218v1)
...
### [48] [Measuring and Mitigating Bias in Code Generated by Large Language Models](http://arxiv.org/abs/2606.00049v1)
...
### [49] [Frontier Lag: A Bibliometric Audit of Capability Misrepresentation in Academic AI Evaluation](http://arxiv.org/abs/2605.04135v2)
...
### [50] [DGPO: Distribution Guided Policy Optimization for Fine Grained Credit Assignment](http://arxiv.org/abs/2605.03327v2)
...
### [51] [LLM-ADAM: A Generalizable LLM Agent Framework for Pre-Print Anomaly Detection in Additive Manufacturing](http://arxiv.org/abs/2605.03328v1)
...
### [52] [Discovering Reinforcement Learning Interfaces with Large Language Models](http://arxiv.org/abs/2605.03408v1)
...
### [53] [Learning to Theorize the World from Observation](http://arxiv.org/abs/2605.03413v2)
...
### [54] [LLMs Uncertainty Quantification via Adaptive Conformal Semantic Entropy](http://arxiv.org/abs/2605.04295v2)
...
### [55] [Memory as a Markov Matrix: Sample Efficient Knowledge Expansion via Token-to-Dictionary Mapping](http://arxiv.org/abs/2605.04308v1)
...
### [56] [SkCC: Portable and Secure Skill Compilation for Cross-Framework LLM Agents](http://arxiv.org/abs/2605.03353v4)
...
### [57] [ARGUS: Defending LLM Agents Against Context-Aware Prompt Injection](http://arxiv.org/abs/2605.03378v2)
...
Selection reason: 针对LLM agent的上下文感知提示注入防御，因果溯源审计机制可迁移至coding agent的可靠性与安全防护。
...
### [58] [MEMSAD: Gradient-Coupled Anomaly Detection for Memory Poisoning in Retrieval-Augmented Agents](http://arxiv.org/abs/2605.03482v2)
*Ishrith Gowda*
...
### [59] [From TinyGo to gc Compiler: Extending Zorya's Concolic Framework to Real-World Go Binaries](http://arxiv.org/abs/2605.03492v2)
...
Selection reason: 扩展concolic执行框架至真实Go二进制漏洞检测，属于程序分析通用方法，对agent辅助漏洞挖掘有参考价值。
...
### [60] [Tailored Prompts, Targeted Protection: Vulnerability-Specific LLM Analysis for Smart Contracts](http://arxiv.org/abs/2605.03697v1)
...
### [61] [MOSAIC-Bench: Measuring Compositional Vulnerability Induction in Coding Agents](http://arxiv.org/abs/2605.03952v1)
...
Selection reason: 提出MOSAIC-Bench评估coding agent在分解任务中的漏洞诱导风险，为agent安全评测与防御提供重要基准。
...
### [62] [Generating Proof-of-Vulnerability Tests to Help Enhance the Security of Complex Software](http://arxiv.org/abs/2605.03956v1)
...
Selection reason: 结合调用路径分析、执行反馈与LLM生成可利用性PoV测试，方法可迁移至面向安全测试的coding agent。
...
### [63] [Identifier-Free Code Embedding Models for Scalable Search](http://arxiv.org/abs/2605.05251v1)
...
Selection reason: 代码嵌入模型双向关联源码头与反编译代码，直接增强代码检索。
...
### [64] [Root-Cause-Driven Automated Vulnerability Repair](http://arxiv.org/abs/2605.04251v1)
...
Selection reason: 根因驱动漏洞修复+两阶段质量评估，与agent修复和评测直接相关。
...
### [65] [Lightweight Vulnerability Detection from Code Metrics and Token Features](http://arxiv.org/abs/2605.04260v1)
*Chun Yin Chiu*
...
Selection reason: 轻量级漏洞检测基线，可作agent快速triage或反馈信号。
...
### [66] [TRACE: A Metrologically-Grounded Engineering Framework for Trustworthy Agentic AI Systems in Operationally Critical Domains](http://arxiv.org/abs/2605.03838v1)
*Serhii Zabolotnii*
...
### [67] [MCJudgeBench: A Benchmark for Constraint-Level Judge Evaluation in Multi-Constraint Instruction Following](http://arxiv.org/abs/2605.03858v1)
...
### [68] [Safety and accuracy follow different scaling laws in clinical large language models](http://arxiv.org/abs/2605.04039v1)
...
### [69] [NoisyCausal: A Benchmark for Evaluating Causal Reasoning Under Structured Noise](http://arxiv.org/abs/2605.04313v1)
*Zhi Xu,Yun Fu*
...
### [70] [Enhancing Self-Supervised Talking Head Forgery Detection via a Training-Free Dual-System Framework](http://arxiv.org/abs/2605.03390v1)
...
### [71] [iWorld-Bench: A Benchmark for Interactive World Models with a Unified Action Generation Framework](http://arxiv.org/abs/2605.03941v2)
