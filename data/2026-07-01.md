...
Selection reason: 基于状态重写的可审计验证架构，可迁移到 agent 生成结果的验证与审计。
...
### [25] [Better Together, in the Right Order: Classical-then-LLM Optimization for SE](http://arxiv.org/abs/2607.02583v1)
...
Selection reason: 提出经典优化器先导、LLM 后置的 SNAP2 组合方法，在 SE 配置任务上效果与成本皆优，对 SemOpt 有明确迁移价值。
...
### [26] [Registry-Governed Agent Lifecycle:Completing EDDOps with Evaluation-DrivenRegistration, Promotion, and Retirement on AWS AgentCore](http://arxiv.org/abs/2607.00345v1)
...
Selection reason: 提出评估驱动的 agent 生命周期治理框架并映射到 AWS AgentCore，对 coding agent 的评测与部署治理有参考价值。
...
### [27] [BT-APE: A Computationally Light Backtracking Approach to Automatic Prompt Engineering for Requirements Classification](http://arxiv.org/abs/2607.00427v1)
...
Selection reason: 轻量级回溯式自动提示工程方法可迁移到代码 agent 的 prompt 优化，但应用场景为需求分类，相关度中等。
...
### [28] [The Moving Target: A Longitudinal Audit of Trustworthiness Drift Across Twelve Checkpoints of Open-Source Chat LLMs](http://arxiv.org/abs/2607.02587v1)
*Zhichao Fan,Yanhang Li,Zexin Zhuang,Xian Sun,Yingshuo Wang*

Main category: cs.SE

Comments: 22 pages, 2 figures; accepted as a poster at the ICML 2026 TAIGA Workshop

Selection reason: 纵向审计开源模型检查点间的信任分数漂移，强调评测结果需注明日期，对 agent 模型评测的可复现性有借鉴意义。
...
### [29] [Large Language Models for Multi-Lingual Equivalent Mutant Detection: An Extended Empirical Study](http://arxiv.org/abs/2607.00511v1)
...
Selection reason: 系统研究 LLM 在多语言等价变异体检测上的效果与泛化能力，对软件测试和质量保障 agent 有直接应用价值。
...
### [30] [Auditing Empirical Comparisons in Quantum Software](http://arxiv.org/abs/2607.00516v1)
...
Selection reason: 提出审计经验比较声明的方法，可迁移到性能benchmark与正确性证据验证。
...
### [31] [Rise From The Ashes: LLM-based Static Analysis for Deep Learning Framework Bugs](http://arxiv.org/abs/2607.00555v1)
...
Selection reason: LLM多agent静态分析框架，以跨语言张量流SBIR检测DL框架bug，与代码agent直接相关。
...
### [32] [Towards Better Linux Kernel Fault Localization: Leveraging Contrastive Reasoning and Hierarchical Context Analysis](http://arxiv.org/abs/2607.00562v1)
...
Selection reason: 面向Linux内核的LLM故障定位，对比推理+层次上下文分析，显著提升定位精度。
...
### [33] [Attributing Structured-Output Gains in Function Calling: Interface Alignment versus Procedural Transfer](http://arxiv.org/abs/2607.02595v1)
...
Selection reason: 提出函数调用结构化增益归因协议，给出严格评测基线，可迁移至agent技能注入评估。
...
### [34] [SchedCheck: Schedule-Robustness Analysis for Event-Driven Block Programs](http://arxiv.org/abs/2607.00623v1)
*Yuan Si,Jialu Zhang*
...
Selection reason: 对事件驱动块程序做调度鲁棒性验证，为生成代码的并发正确性提供可自动化校验工具。
...
### [35] [Checked Program Recovery from Execution Video: A Sound Oracle for Untrusted Generators](http://arxiv.org/abs/2607.00635v1)
*Yuan Si,Jialu Zhang*
...
Selection reason: 从执行视频恢复程序并用sound oracle验证，为不可信生成器提供了可信任的正确性认证方案。
...
### [36] [LLVM-Bench: Benchmarking and Advancing Large Language Models for LLVM Compiler Issue Resolution](http://arxiv.org/abs/2607.00700v1)
...
Selection reason: 首个LLM解决LLVM编译器问题的benchmark与自动化验证平台，直接服务编译优化与修复。
...
### [37] [ClarifyCodeBench: Evaluating LLMs on Clarifying Ambiguous Requirements for Code Generation](http://arxiv.org/abs/2607.00711v1)
...
Selection reason: 评估LLM澄清不明确需求能力的交互式基准，对代码生成agent的交互迭代评测有直接价值。
...
### [38] [AgentLTL: A Trace-Verification Framework for Measuring, Enforcing, and Training Procedural Compliance in Tool-Using LLM Agents](http://arxiv.org/abs/2607.02599v1)
...
Selection reason: 用FO-LTL对工具使用agent轨迹做程序性合规验证、拦截与指标化训练，可直接用于agent正确性保障。
...
### [39] [Knowledge-Enhanced Agentic Vulnerability Repair](http://arxiv.org/abs/2607.00820v1)
...
Selection reason: 知识增强的agentic漏洞修复，结合工具ReAct推理与闭环验证，显著提升C/C++漏洞修复率。
...
### [40] [Petrify: Petri-net Based Analysis of Concurrency Properties in Java Bytecode](http://arxiv.org/abs/2607.00830v1)
...
Selection reason: Petri网编码Java字节码分析并发属性，可迁移为agent生成代码的并发验证后端。
...
### [41] [From Registry to Repository: How AI Agent Skills Are Written, Adapted, and Maintained](http://arxiv.org/abs/2607.00911v2)
...
Selection reason: 首次实证研究AI agent技能的编写、复用与维护模式，为技能库与工具链设计提供依据。
...
### [42] [A Survey of LLM-Driven Penetration Testing: Taxonomy, Co-Evolution, and Open Challenges](http://arxiv.org/abs/2607.02605v1)
...
Selection reason: 系统综述LLM渗透测试agent的架构演进与RLVR训练范式，分类法和挑战可迁移至安全代码agent。
...
### [43] [ChainSWE: Benchmarking Coding Agents on Multi-Bug Software Maintenance](http://arxiv.org/abs/2607.02606v1)
...
Selection reason: 首个面向连续、依赖bug修复的coding agent基准，揭示长链维护中的性能衰减。
...
### [44] [Delta Debugging in the Absence of Test Oracles Through Metamorphic Testing](http://arxiv.org/abs/2607.00929v1)
*Mingyue Jiang,Yongqiang Tian,Tsong Yueh Chen*

Main category: cs.SE

Comments: Under review. This is the authors' version

Selection reason: 利用蜕变测试替代oracle的delta debugging，为无oracle场景下的输入最小化提供可迁移方案。
...
### [45] [Leveraging LLM-Based Agentic Systems to Generate Quantum Applications for Test Optimization](http://arxiv.org/abs/2607.00939v1)
...
Selection reason: 多智能体协作生成量子应用用于测试优化，方法可迁移到代码 agent 的生成与验证流程，但领域特定。
...
### [46] [SWE-Doctor: Guiding Software Engineering Agents with Runtime Diagnosis from Multi-Faceted Bug Reproduction Tests](http://arxiv.org/abs/2607.00990v1)
...
Selection reason: 面向软件工程 agent 的运行时诊断引导补丁生成，在 SWE-bench 上显著提升，直接相关。
...
### [47] [AutoRestTest at the SBFT 2026 Tool Competition](http://arxiv.org/abs/2607.01063v1)
...
Selection reason: 结合 LLM 与多智能体强化学习的 REST API 测试工具，对 agent 驱动的测试生成有参考价值。
...
### [48] [Cheap Code, Costly Judgment: A Case Study on Governable Agentic Software Engineering](http://arxiv.org/abs/2607.01087v2)
...
Selection reason: 对 agentic 软件工程的治理机制进行案例研究，提出可迁移的 governance conversion 模型。
...
### [49] [SAGE: Structured Agentic Graph Editing for Software Diagrams](http://arxiv.org/abs/2607.01102v1)
...
Selection reason: 用 LLM 做结构化图表编辑，验证修复流程可迁移到 agent 的结构化输出编辑。
...
### [50] [Skills Are Not Islands: Measuring Dependency and Risk in Agent Skill Supply Chains](http://arxiv.org/abs/2607.01136v1)
...
Selection reason: 引入 agent skill 供应链和依赖分析，对 agent 生态的可靠性和风险治理有迁移价值。
...
### [51] [Are Performance-Optimization Benchmarks Reliably Measuring Coding Agents?](http://arxiv.org/abs/2607.01211v2)
...
Selection reason: 审计性能优化 benchmark 的可靠性，直接针对 SemOpt 核心评测问题。
...
### [52] [RepoRescue: An Empirical Study of LLM Agents on Whole-Repository Compatibility Rescue](http://arxiv.org/abs/2607.01213v1)
...
Selection reason: 评测 LLM agents 修复仓库级兼容性问题，提出源-only 审计和运行时强制等评估方法。
...
### [53] [Benchmarking Code Improvement with Progressive, Adaptive, and Interactive Feedback](http://arxiv.org/abs/2607.01360v1)
...
Selection reason: 提出渐进式自适应反馈的代码改进评测 benchmark，测量模型迭代改进能力。
...
### [54] [Adoption and Impact of Command-Line AI Coding Agents: A Study of Microsoft's Early 2026 Rollout of Claude Code and GitHub Copilot CLI](http://arxiv.org/abs/2607.01418v1)
...
Selection reason: 对编码 agent 在大规模组织的采用与影响进行实证研究，对 agent 部署评测有参考价值。
...
### [55] [Risk Architecture for AI-Native Engineering Teams: An Organizational Framework for Agentic System Governance](http://arxiv.org/abs/2607.01421v1)
...
Selection reason: 提出 AI-native 团队的风险架构框架，对 agent 系统治理和可靠性设计有迁移价值。
...
### [56] [From Anatomy to Smells: An Empirical Study of SKILL.md in Agent Skills](http://arxiv.org/abs/2607.01456v2)
...
Selection reason: 实证分析 SKILL.md 中的 skill smells，为 agent skill 质量改进提供检测方法。
...
### [57] [Dependencies that Bundle Code and Execution](http://arxiv.org/abs/2607.02618v1)
...
Selection reason: 通过可分发执行缓存优化应用启动性能，属于运行时优化并有speedup验证。
...
### [58] [Kani: A Model Checker for Rust](http://arxiv.org/abs/2607.01504v1)
...
Selection reason: Rust模型检验器提供正确性验证能力，可作为代码agent的验证后端或正确性检查工具。
...
### [59] [DART-VLN: Test-Time Memory Decay and Anti-Loop Regularization for Discrete Vision-Language Navigation](http://arxiv.org/abs/2607.01043v1)
...
### [60] [FAR: Failure-Aware Retry for Test-Time Recovery and Continual Policy Improvement](http://arxiv.org/abs/2607.01111v1)
...
### [61] [CHARLIE: An On-Premise Multi-Agent Retrieval-Augmented Generation System for Evidential Reasoning in Forensic Science](http://arxiv.org/abs/2607.05428v1)
...
### [62] [Mapping the Evaluation Frontier: An Empirical Survey of the Bias-Reliability Tradeoff Across Eleven Evaluator-Agent Conditions](http://arxiv.org/abs/2607.00304v1)
*Zewen Liu*
...
### [63] [Auditing the Audit: Five Failure Modes in Benchmark-Validity Audits](http://arxiv.org/abs/2607.02586v1)
...
Selection reason: 归纳基准有效性审计的五大失败模式并提出尽职调查门控，对 agent 评测的可靠性与元审计有参考价值。
...
### [64] [Active-GRPO: Adaptive Imitation and Self-Improving Reasoning for Molecular Optimization](http://arxiv.org/abs/2607.00531v1)
...
### [65] [LLM-Guided ODE Discovery and Parameter Inference from Small-Cohort Aggregate Data](http://arxiv.org/abs/2607.00733v1)
...
### [66] [Staleness-Learning Rate Scaling Laws for Asynchronous RLHF](http://arxiv.org/abs/2607.01083v2)
...
### [67] [Sequentially-Controlled Interactive Multi-Particle Flow-Maps for Online Feedback-Driven Search](http://arxiv.org/abs/2607.01144v1)
...
### [68] [Right in the Right Way: LM Training with Verifiable Rewards and Human Demonstrations](http://arxiv.org/abs/2607.01181v1)
...
### [69] [Language-Critique Imitation Learning from Suboptimal Demonstrations](http://arxiv.org/abs/2607.01225v1)
...
### [70] [Multi-Head Recurrent Memory Agents](http://arxiv.org/abs/2607.01523v1)
...
### [71] [Exploring the Semantic Gap in Agentic Data Systems: A Formative Study of Operationalization Failures in Analytical Workflows](http://arxiv.org/abs/2607.00828v1)
...
### [72] [From Personas to Plot: Character-Grounded Multi-Agent Story Generation for Long-Form Narratives](http://arxiv.org/abs/2607.00918v1)
...
### [73] [IsoSci: A Benchmark of Isomorphic Cross-Domain Science Problems for Evaluating Reasoning versus Knowledge Retrieval in LLMs](http://arxiv.org/abs/2607.01431v1)
...
### [74] [VideoSearch-R1: Iterative Video Retrieval and Reasoning via Soft Query Refinement](http://arxiv.org/abs/2607.00446v1)
...
### [75] [Homer: Understanding Long-form Videos with Hierarchical Memory and Agentic Reasoning](http://arxiv.org/abs/2607.02588v1)
...
### [76] [Autonomous Scientific Discovery via Iterative Meta-Reflection](http://arxiv.org/abs/2607.01131v1)
...
### [77] [NeuroCogMap Reveals Cognitive Organization of Large Language Models](http://arxiv.org/abs/2607.00397v1)
...
### [78] [MemSyco-Bench: Benchmarking Sycophancy in Agent Memory](http://arxiv.org/abs/2607.01071v2)
...
### [79] [Beyond the Prompt: Jailbreaking Function-Calling LLMs via Simulated Moderation Traces](http://arxiv.org/abs/2607.00481v1)
...
### [80] [TAG: A Lightweight Framework for Test-Driven Agentic Artifact Generation](http://arxiv.org/abs/2607.02615v2)
...
Selection reason: 测试驱动生成框架，结合确定性/LLM 测试和专家评判，可直接迁移到代码工件生成验证。
