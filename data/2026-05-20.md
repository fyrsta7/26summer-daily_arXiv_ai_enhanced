...
### [1] [From Automated to Autonomous: Hierarchical Agent-native Network Architecture (HANA)](http://arxiv.org/abs/2605.20608v1)
...
### [2] [COAgents: Multi-Agent Framework to Learn and Navigate Routing Problems Search Space](http://arxiv.org/abs/2605.20618v1)
...
### [3] [Evaluating Temporal Semantic Caching and Workflow Optimization in Agentic Plan-Execute Pipelines](http://arxiv.org/abs/2605.20630v1)
...
### [4] [Declarative Data Services: Structured Agentic Discovery for Composing Data Systems](http://arxiv.org/abs/2605.20690v2)
*Shanshan Ye,Duo Lu*
...
### [5] [RMA: an Agentic System for Research-Level Mathematical Problems](http://arxiv.org/abs/2605.22875v1)
...
### [6] [EvoSci: A Bio-Inspired Multi-Agent Framework for the Evolution of Scientific Discovery](http://arxiv.org/abs/2605.24018v1)
...
### [7] [Interaction Locality in Hierarchical Recursive Reasoning](http://arxiv.org/abs/2605.20784v1)
...
### [8] [Conditional Equivalence of DPO and RLHF: Implicit Assumption, Failure Modes, and Provable Alignment](http://arxiv.org/abs/2605.20834v1)
...
### [9] [PlanningBench: Generating Scalable and Verifiable Planning Data for Evaluating and Training Large Language Models](http://arxiv.org/abs/2605.20873v2)
...
### [10] [Governance by Construction for Generalist Agents](http://arxiv.org/abs/2605.20874v1)
...
Selection reason: 策略即代码的agent治理架构，包含意图拦截、HITL和工具边界控制，可迁移至coding agent的可靠性约束
...
### [11] [Playing Devil's Advocate: Off-the-Shelf Persona Vectors Rival Targeted Steering for Sycophancy](http://arxiv.org/abs/2605.21006v2)
...
### [12] [AutoRPA: Efficient GUI Automation through LLM-Driven Code Synthesis from Interactions](http://arxiv.org/abs/2605.21082v1)
...
### [13] [ScenePilot: Controllable Boundary-Driven Critical Scenario Generation for Autonomous Driving](http://arxiv.org/abs/2605.21168v3)
...
### [14] [SciAtlas: A Large-Scale Knowledge Graph for Automated Scientific Research](http://arxiv.org/abs/2605.22878v1)
...
### [15] [Insights Generator: Systematic Corpus-Level Trace Diagnostics for LLM Agents](http://arxiv.org/abs/2605.21347v3)
...
Selection reason: 提出语料级轨迹诊断的多agent系统，自动生成带证据的洞察，直接支持coding agent调试与改进
...
### [16] [Towards Resilient and Autonomous Networks: A BlueSky Vision on AI-Native 6G](http://arxiv.org/abs/2605.21395v1)
...
### [17] [Teaching AI Through Benchmark Construction: QuestBench as a Course-Based Practice for Accountable Knowledge Work](http://arxiv.org/abs/2605.21413v2)
...
### [18] [Mind the Sim-to-Real Gap & Think Like a Scientist](http://arxiv.org/abs/2605.21458v1)
...
### [19] [DeepWeb-Bench: A Deep Research Benchmark Demanding Massive Cross-Source Evidence and Long-Horizon Derivation](http://arxiv.org/abs/2605.21482v1)
...
### [20] [Benchmarking and Improving Monitors for Out-Of-Distribution Alignment Failure in LLMs](http://arxiv.org/abs/2605.21602v2)
...
Selection reason: 提出OOD对齐失败检测基准MOOD及guard model+OOD detector组合方法，可迁移到coding agent的可靠性监控。
...
### [21] [TO-Agents: A Multi-Agent AI Pipeline for Preference-Guided Topology Optimization](http://arxiv.org/abs/2605.21622v1)
...
### [22] [MindLoom: Composing Thought Modes for Frontier-Level Reasoning Data Synthesis](http://arxiv.org/abs/2605.21630v1)
...
### [23] [SMDD-Bench: Can LLMs Solve Real-World Small Molecule Drug Design Tasks?](http://arxiv.org/abs/2605.21740v2)
...
### [24] [Energy per Successful Goal: Goal-Level Energy Accounting for Agentic AI Systems](http://arxiv.org/abs/2605.22883v1)
...
### [25] [Trace2Skill: Verifier-Guided Skill Evolution for Long-Context EDA Agents](http://arxiv.org/abs/2605.21810v1)
...
### [26] [Implicit Safety Alignment from Crowd Preferences](http://arxiv.org/abs/2605.21822v1)
...
### [27] [Toward AI VIS Co-Scientists: A General and End-to-End Agent Harness for Solving Complex Data Visualization Tasks](http://arxiv.org/abs/2605.21825v1)
...
### [28] [An Event-Driven Tool for Context-Aware Code Smell Detection Using SmellDSL](http://arxiv.org/abs/2605.20675v1)
...
Selection reason: 基于SmellDSL的上下文感知代码异味检测和分析方法，对代码质量工具与agent可参考
...
### [29] [Articulate but Wrong: Self-Review Failures in LLM-Based Code Modernization](http://arxiv.org/abs/2605.21537v1)
...
Selection reason: 实证揭示LLM代码现代化中自审查不可靠，对coding agent的正确性验证与安全网设计有直接价值
...
### [30] [BioDefect: The First Dataset for Defect Detection in Bioinformatics Software](http://arxiv.org/abs/2605.20788v1)
...
Selection reason: 首个生物信息学软件缺陷检测数据集，提供带完整上下文的缺陷样本，可用于缺陷检测模型评测
...
### [31] [RSE of a Quantum Transport Code and its Effects](http://arxiv.org/abs/2605.21334v1)
...
Selection reason: 连续集成、自动化测试与持续基准实践，暴露缺陷并检测性能回归，对科学软件质量保证有参考价值
...
### [32] [SpecBench: Measuring Reward Hacking in Long-Horizon Coding Agents](http://arxiv.org/abs/2605.21384v1)
...
Selection reason: SpecBench量化长程coding agent的奖励黑客行为，分解可见/保留测试来衡量真实目标达成，评测价值极高
...
### [33] [Stdlib or Third-Party? Empirical Performance and Correctness of LLM-Assisted Zero-Dependency Python Libraries](http://arxiv.org/abs/2605.21405v1)
...
Selection reason: 对LLM生成的零依赖stdlib重实现进行性能与正确性实证，显示多数场景性能持平并存在5-115x加速，对代码生成与性能评测有直接参考。
...
### [34] [Agentic Model Checking](http://arxiv.org/abs/2605.21434v1)
...
Selection reason: 提出agentic model checking范式，将LLM agent与有界模型检查结合用于验证LLM生成代码，直接相关于代码agent的可靠性与验证。
...
### [35] [Quality and Security Signals in AI-Generated Python Refactoring Pull Requests](http://arxiv.org/abs/2605.21453v1)
...
Selection reason: 实证研究AI生成Python重构PR的质量与安全信号，识别24种变更操作及lint/security影响，可用于agent重构效果评测。
...
### [36] [A Dataset of Reproducible Flaky-Test Failures](http://arxiv.org/abs/2605.21677v1)
...
Selection reason: 提供1115个可复现flaky test的数据集，含复现脚本、修复脚本及失败日志，直接用于测试/调试agent的评测与训练。
...
### [37] [Scalable Reinforcement Learning via Adaptive Batch Scaling](http://arxiv.org/abs/2605.21557v2)
*Jongchan Park*
...
### [38] [Frontier: Towards Comprehensive and Accurate LLM Inference Simulation](http://arxiv.org/abs/2605.21312v2)
...
### [39] [Causal Past Logic for Runtime Verification of Distributed LLM Agent Workflows](http://arxiv.org/abs/2605.20923v1)
*Benedikt Bollig*
...
### [40] [Trusted Weights, Treacherous Optimizations? Optimization-Triggered Backdoor Attacks on LLMs](http://arxiv.org/abs/2605.20641v1)
...
### [41] [Heartbeat-Bound Hierarchical Credentials: Cryptographic Revocation for AI Agent Swarms](http://arxiv.org/abs/2605.20704v1)
*Saurabh Deochake*
...
### [42] [An Application-Layer Multi-Modal Covert-Channel Reference Monitor for LLM Agent Egress](http://arxiv.org/abs/2605.20734v1)
*Alfredo Metere*
...
### [43] [GenAI-Driven Threat Detection with Microsoft Security Copilot](http://arxiv.org/abs/2605.20896v2)
...
### [44] [ASSEMBLAGE-DEEPHISTORY: A Cross-Build Binary Dataset with Temporal Coverage](http://arxiv.org/abs/2605.21615v1)
...
Selection reason: 构建含时间覆盖的跨构建二进制数据集，并用LLM基准评估二进制漏洞推理，为程序分析/安全agent提供评测语料。
...
### [45] [PocketAgents: A Manifest-Driven Library of Autonomous Defense Agents](http://arxiv.org/abs/2605.21694v1)
...
### [46] [FuzzingBrain V2: A Multi-Agent LLM System for Automated Vulnerability Discovery and Reproduction](http://arxiv.org/abs/2605.21779v1)
...
Selection reason: 多智能体LLM系统FuzzingBrain V2实现自动化漏洞发现与复现，基于OSS-Fuzz验证并发现29个零日漏洞，对安全测试agent有直接价值。
...
### [47] [Quality-Assured Fuzz Harness Generation via the Four Principles Framework](http://arxiv.org/abs/2605.21824v1)
...
Selection reason: 基于四原则框架的LLM fuzz harness自动生成与质量保证，内置正确性检查拦截58个假阳性崩溃，提升agent生成harness可靠性。
...
### [48] [Machine Intelligence that Understands Visual and Linguistic Information and Interacts with Humans and Environments](http://arxiv.org/abs/2605.24020v1)
*Van Quang Nguyen*
...
### [49] [ArchSIBench: Benchmarking the Architectural Spatial Intelligence of Vision-Language Models](http://arxiv.org/abs/2605.20837v1)
...
### [50] [Open-source LLMs administer maximum electric shocks in a Milgram-like obedience experiment](http://arxiv.org/abs/2605.21401v2)
...
### [51] [DISC: Decoupling Instruction from State-Conditioned Control via Policy Generation](http://arxiv.org/abs/2605.20856v1)
...
### [52] [Lost in Fog: Sensor Perturbations Expose Reasoning Fragility in Driving VLAs](http://arxiv.org/abs/2605.21446v2)
...
### [53] [MedExpMem: Adapting Experience Memory for Differential Diagnosis](http://arxiv.org/abs/2605.22872v1)
...
### [54] [AVSD: Adaptive-View Self-Distillation by Balancing Consensus and Teacher-Specific Privileged Signals](http://arxiv.org/abs/2605.20643v1)
...
### [55] [When Do LLMs Reason? A Dynamical Systems View via Entropy Phase Transitions](http://arxiv.org/abs/2605.22873v2)
...
### [56] [REFLECTOR: Internalizing Step-wise Reflection against Indirect Jailbreak](http://arxiv.org/abs/2605.20654v2)
...
### [57] [Hack-Verifiable Environments: Towards Evaluating Reward Hacking at Scale](http://arxiv.org/abs/2605.20744v1)
...
### [58] [The Hidden Signal of Verifier Strictness: Controlling and Improving Step-Wise Verification via Selective Latent Steering](http://arxiv.org/abs/2605.20745v1)
...
### [59] [The Constraint Tax: Measuring Validity-Correctness Tradeoffs in Structured Outputs for Small Language Models](http://arxiv.org/abs/2605.26128v1)
*Jaideep Ray*
...
Selection reason: 测量结构化输出约束对SLM准确性的影响，工具调用schema约束分析可直接迁移到代码agent
...
### [60] [Multi-Step Likelihood-Ratio Correction for Reinforcement Learning with Verifiable Rewards](http://arxiv.org/abs/2605.20865v1)
...
### [61] [Domain-Adaptable Reinforcement Learning for Code Generation with Dense Rewards](http://arxiv.org/abs/2605.21180v1)
...
Selection reason: 用域自适应RL与密集奖励微调代码生成LLM，涵盖语法、正确性和可执行性，对代码生成优化有直接价值
...
### [62] [APEX: Autonomous Policy Exploration for Self-Evolving LLM Agents](http://arxiv.org/abs/2605.21240v1)
...
### [63] [FedCritic: Serverless Federated Critic Learning-based Resource Allocation for Multi-Cell OFDMA in 6G](http://arxiv.org/abs/2605.21418v1)
...
### [64] [Agent JIT Compilation for Latency-Optimizing Web Agent Planning and Scheduling](http://arxiv.org/abs/2605.21470v2)
...
### [65] [When Are Teacher Tokens Reliable? Position-Weighted On-Policy Self-Distillation for Reasoning](http://arxiv.org/abs/2605.21606v1)
...
### [66] [Value-Gradient Hypothesis of RL for LLMs](http://arxiv.org/abs/2605.21654v1)
...
### [67] [Decoupling Communication from Policy: Robust MARL under Bandwidth Constraints](http://arxiv.org/abs/2605.21085v1)
...
### [68] [Can Multi-Agent LLMs Identify Their Peers? Stylometric Fingerprinting in Role-Constrained Political Analysis](http://arxiv.org/abs/2606.09854v1)
*Juergen Dietrich*
...
### [69] [Terminal-World: Scaling Terminal-Agent Environments via Agent Skills](http://arxiv.org/abs/2605.20876v1)
...
### [70] [Strategy-Induct: Task-Level Strategy Induction for Instruction Generation](http://arxiv.org/abs/2605.20924v1)
...
### [71] [Towards Context-Invariant Safety Alignment for Large Language Models](http://arxiv.org/abs/2605.20994v1)
...
### [72] [Beyond Text-to-SQL: An Agentic LLM System for Governed Enterprise Analytics APIs](http://arxiv.org/abs/2605.21027v2)
...
### [73] [Fine-grained Claim-level RAG Benchmark for Law](http://arxiv.org/abs/2605.21071v3)
...
### [74] [TextReg: Mitigating Prompt Distributional Overfitting via Regularized Text-Space Optimization](http://arxiv.org/abs/2605.21318v1)
...
### [75] [Mem-$π$: Adaptive Memory through Learning When and What to Generate](http://arxiv.org/abs/2605.21463v1)
...
### [76] [Residual Skill Optimization for Text-to-SQL Ensembles](http://arxiv.org/abs/2605.21792v1)
