...
Selection reason: 面向 LLM agent 的技能假设验证与渐进式技能沉淀机制，可迁移到 coding agent 的可靠技能库与反思验证流程。
...
Selection reason: 从自然语言生成 DSL 代码并系统验证结构化上下文的作用，与代码生成 agent 的上下文设计评估相关。
...
Selection reason: 用机制可解释性子空间干预多步 coding agent 的安全行为，提供安全检测与干预方法。
...
### [19] [Reinforcement learning to improve large language model-based automated code compliance systems](http://arxiv.org/abs/2606.22402v1)
...
Selection reason: 用 SFT+GRPO 优化 LLM 生成代码的结构与语义准确性，方法可迁移至代码生成正确性优化。
...
### [20] [Formal-Method-Guided Vibe Coding: Closing the Verification Loop on AI-Generated Safety-Critical Software Through Model-Driven Engineering](http://arxiv.org/abs/2606.22413v2)
...
Selection reason: 用形式化验证+MDE 闭环迭代修正 LLM 生成代码，直接面向生成代码的验证与可靠性提升。
...
### [21] [All Green, Still Broken: Real-Flow Verification Lessons from an LLM-Integrated, Multi-Market Web Application](http://arxiv.org/abs/2606.22475v1)
...
Selection reason: 真实 LLM 集成 Web 应用的四类测试边界缺陷分析，为 agent 端到端测试与验证提供经验。
...
### [22] [WebCQ: Cooperative Multi-Agent Deep Reinforcement Learning for Scalable Web GUI Testing](http://arxiv.org/abs/2606.22502v1)
...
Selection reason: 多智能体强化学习做 Web GUI 测试，是可扩展的 agent 驱动 GUI 测试方法。
...
### [23] [RigorBench: Benchmarking Engineering Process Discipline in Autonomous AI Coding Agents](http://arxiv.org/abs/2606.22678v2)
...
Selection reason: 首个衡量 coding agent 工程过程纪律的 benchmark，覆盖规划、验证、恢复等维度，直接用于 agent 评估。
...
### [24] [Beyond Simpson's Paradox: A Cascade of Confounders in AI Agent Pull-Request Co-Authorship](http://arxiv.org/abs/2606.22711v1)
...
Selection reason: 对 AI coding agent PR 协作者的混杂因素分析，提醒评测统计需分层，迁移到 agent 效果评估。
...
### [25] [Habituation at the Gate: Rising Approval and Declining Scrutiny in Human Review of AI Agent Code](http://arxiv.org/abs/2606.22721v1)
...
Selection reason: 纵向分析人类对 AI agent 代码审查的惰化，对 agent 代码审查流程设计有参考。
...
### [26] [BabelJudge: Measuring LLM-as-a-Judge Reliability Across Languages and Agent Trajectories](http://arxiv.org/abs/2606.22329v1)
*Shreyas KC*
...
### [27] [Not All Claims Are Equally Risky: FACTOR for Adaptive Verification in Factual Long-Form Generation](http://arxiv.org/abs/2606.22474v1)
...
### [28] [Context-Aware Distillation and Ablation for Text2DSL](http://arxiv.org/abs/2606.22578v1)
*Alexander V. Kozachok,Alexander M. Nazimov,Shamil G. Magomedov*
...
### [29] [Only Ask What You Don't Know: Grounded Delta Planning for Efficient Multi-step RAG](http://arxiv.org/abs/2606.22681v1)
...
### [30] [Curriculum Reinforcement Learning Can Incentivize Reasoning Capacity in LLMs Beyond the Base Model](http://arxiv.org/abs/2606.22317v1)
...
### [31] [Select-to-Act: Hierarchical Reinforcement Learning via Adaptive Language Guidance](http://arxiv.org/abs/2606.22350v1)
...
### [32] [Libretto: Giving LLM Agents a Sense of Musical Structure](http://arxiv.org/abs/2606.22708v1)
*Yichen Xu*
...
### [34] [An LLM-Orchestrated Agent for Directional-Coupler Design with Self-Consistent Eigenmode and FDTD Validation](http://arxiv.org/abs/2606.22493v1)
...
### [35] [Lingering Authority: Revocable Resource-and-Effect Capabilities for Coding Agents](http://arxiv.org/abs/2606.22504v1)
*Igor Santos-Grueiro*
...
Selection reason: 为 coding agent 设计可撤销能力与资源权限的 reference monitor，直接提升 agent 工具调用安全与任务契约。
...
### [36] [RAVEN: Agentic RAG for Automated Vulnerability Repair](http://arxiv.org/abs/2606.22647v1)
...
Selection reason: 基于 agentic RAG 的自动化漏洞修复框架，跨 CWE 和语言泛化，直接相关。
...
### [37] [VeriPort: Automated and Verified Patch Backporting at Scale](http://arxiv.org/abs/2606.22704v1)
...
Selection reason: 端到端代理系统自动生成并验证补丁 backport，提供证据链与大规模实证，直接相关。
...
### [38] [Emergent Culture in Minimal LLM Systems](http://arxiv.org/abs/2606.30668v1)
...
### [39] [Sol Video Inference Engine: Agent-Native Full-Stack Acceleration Framework for Efficient Video Generation](http://arxiv.org/abs/2606.23743v2)
...
### [40] [Benchmarking Robot Memory Under Interference](http://arxiv.org/abs/2606.22338v1)
*Soumil Rathi*
