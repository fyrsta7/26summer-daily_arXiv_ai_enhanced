...
- [ADK Arena: Evaluating Agent Development Kits via LLM-as-a-Developer](http://arxiv.org/abs/2606.05548v1) — 相关度 0.95：提出LLM-as-a-Developer方法并系统评估51个Agent开发框架，与代码智能体研究和基准测试高度相关。
- [Asuka-Bench: Benchmarking Code Agents on Underspecified User Intent and Multi-Round Refinement](http://arxiv.org/abs/2606.05920v1) — 相关度 0.95：提出结合未明确意图和多轮细化的代码智能体基准，紧密贴合真实开发流程。
- [Enhancing Software Engineering Through Closed-Loop Memory Optimization](http://arxiv.org/abs/2606.05646v1) — 相关度 0.95：提出闭环记忆优化框架，以验证过的下游影响作为记忆效用度量，直接提升SE智能体性能。
- [From Failed Trajectories to Reliable LLM Agents: Diagnosing and Repairing Harness Flaws](http://arxiv.org/abs/2606.06324v2) — 相关度 0.92：面向 agent harness 的轨迹诊断与修复框架，显著提升 agent 可靠性，直接用于长程执行场景。
- [Can LLMs Write Correct TLA+ Specifications? Evaluating Natural-Language-to-TLA+ Generation](http://arxiv.org/abs/2606.05792v1) — 相关度 0.90：首次系统评估LLM生成TLA+规范的正确性，使用模型检查器验证，对形式化代码生成与智能体评测有直接贡献。
- [SmellBench: Towards Fine-Grained Evaluation of Code Agents on Refactoring Tasks](http://arxiv.org/abs/2606.05574v1) — 相关度 0.90：面向代码智能体重构任务的新基准，弥补了功能正确性之外的维护性评估缺口。
- [Tensor Algebraic Property Skeletons: Amplifying Property-Based Testing for AI Compilers](http://arxiv.org/abs/2606.06747v2) — 相关度 0.88：基于张量代数属性骨架的 agentic 属性测试框架，为 AI 编译器生成 PBT 并发现语义错误，迁移价值高。
- [Microskill Architecture: A Modular Skill-Driven Framework for AI-Native Code Generation](http://arxiv.org/abs/2606.05720v1) — 相关度 0.85：微技能架构将知识封装为原子技能胶囊并动态路由，显著降低token消耗，可迁移至代码生成上下文优化。
- [Systematic LLM Translation of Legacy Scientific Code to Differentiable Frameworks: Application to a Land Surface Model](http://arxiv.org/abs/2606.07681v1) — 相关度 0.82：agentic 流水线将 Fortran 旧代码翻译为 JAX，含编译-修复循环与数值一致性验证，可迁移到科学代码现代化。
- [Queen-Bee Agents: A BeeSpec-Centered Architecture for Governed Enterprise MCP Orchestration](http://arxiv.org/abs/2606.06545v1) — 相关度 0.80：面向企业MCP编排的受治理多智能体架构，涉及作用域执行与治理，可借鉴于代码智能体的工程化。
- [TLA-Prover: Verifiable TLA+ Specification Synthesis via Preference-Optimized Low-Rank Adaptation](http://arxiv.org/abs/2606.06133v3) — 相关度 0.78：基于 TLC 验证反馈的 TLA+ 规格生成与修复式 RL，方法可迁移到代码/规格生成中的验证驱动训练。
- [Code2LoRA: Hypernetwork-Generated Adapters for Code Language Models under Software Evolution](http://arxiv.org/abs/2606.06492v1) — 相关度 0.75：用超网络生成仓库级 LoRA 注入仓库知识，零推理 token 开销，对 repo 级 coding agent 上下文高效化有价值。
- [NTILC: Neural Tool Invocation via Learned Compression](http://arxiv.org/abs/2606.06566v1) — 相关度 0.72：通过潜在检索与学习压缩降低工具调用上下文开销，可直接迁移到 coding agent 的工具选择。
- [Pomona: Continuous Code Quality Improvement via Small, Automated Changes at Bloomberg](http://arxiv.org/abs/2606.06752v1) — 相关度 0.72：轻量 agentic 工具持续发现并修复代码质量问题，小型 PR 工业部署，对 agent 代码维护工作流有借鉴。
- [AI-Driven Test Case Generation from Natural Language Requirements: A Survey of Techniques and Research Gaps](http://arxiv.org/abs/2606.06563v2) — 相关度 0.68：系统梳理自然语言需求到测试用例生成的 AI 方法与评测缺口，对测试 agent 和评测设计有参考。
- [Scaffold, Not Vocabulary? A Controlled, Two-Tier, Pre-Registered Study of a Popperian Code-Generation Skill](http://arxiv.org/abs/2606.06454v1) — 相关度 0.66：受控消融实验证明代码生成 prompt 技能增益主要来自脚手架结构，对 agent prompt 设计有严谨方法论借鉴。
- [Human Oversight and Overload: Two Hidden and Costly Burdens of AI-Assisted Software Engineering](http://arxiv.org/abs/2606.05770v1) — 相关度 0.65：讨论AI辅助软件开发中的人类监督与认知过载问题，对智能体工作流设计有参考意义。
- [Towards the Readability of LLM-Generated Codes through Multitask Representation Engineering](http://arxiv.org/abs/2606.06214v1) — 相关度 0.62：面向 LLM 生成代码可读性的多任务表示工程，提供生成代码质量的定向控制方法。
- [More than a Judge: An Empirical Study of Agent-Human Interaction in Crowdsourced Testing Assessment](http://arxiv.org/abs/2606.06301v1) — 相关度 0.60：LLM-as-judge 评估代理在众包测试报告中的反馈作用，对 agent 评估与反馈机制有参考价值。
- [AutoPipelineAI: Context-Aware CI/CD Pipeline Generation from Natural Language](http://arxiv.org/abs/2606.06662v1) — 相关度 0.55：NL 驱动、仓库感知的 CI/CD 配置生成与反馈验证，可作为软件工程 agent 的一种垂直应用参考。
- [Agentic Software: How AI Agents Are Restructuring the Software Paradigm](http://arxiv.org/abs/2606.05608v2) — 相关度 0.50：概念性讨论Agent式软件范式，提供背景框架和路线图，但缺乏具体可迁移方法。
