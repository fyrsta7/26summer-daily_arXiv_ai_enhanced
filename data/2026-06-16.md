...
### [1] [Treatment Response Optimized Clinical Decision Support AI System via Digital Twin Simulation](http://arxiv.org/abs/2606.17405v1)
...
### [2] [Incumbent Advantage: Brand Bias and Cognitive Manipulation Dynamics in LLM Recommendation Systems](http://arxiv.org/abs/2606.17443v1)
*Xi Chu,Yupeng Hou*
...
### [3] [MapSatisfyBench: Benchmarking Satisfaction-Aware Map Agents through Behavior-Grounded Implicit Decision Factors](http://arxiv.org/abs/2606.17453v2)
...
### [4] [Dissecting model behavior through agent trajectories](http://arxiv.org/abs/2606.17454v2)
...
### [5] [Can LLMs Be CEOs? Benchmarking Strategic Resource Reallocation with Multi-Role Agent Simulation](http://arxiv.org/abs/2606.17459v1)
...
### [6] [Simulated Customers Never Walk Away: Decision Fidelity of LLM User Simulators Measured Against Real Purchase Outcomes](http://arxiv.org/abs/2606.20708v1)
*Liang Chen*
...
### [7] [SEAGym: An Evaluation Environment for Self-Evolving LLM Agents](http://arxiv.org/abs/2606.17546v1)
...
### [8] [Closing the Feedback Loop: From Experience Extraction to Insight Governance in Verbal Reinforcement Learning](http://arxiv.org/abs/2606.17591v1)
...
### [9] [FinAcumen: Financial Multimodal Reasoning via Self-Evolving Experience Memory Harness](http://arxiv.org/abs/2606.17642v2)
...
### [10] [Beyond Domains: Reusing Web Skills via Transferable Interaction Patterns](http://arxiv.org/abs/2606.17645v1)
...
### [11] [From Brewing to Resolution: Tracing the Internal Lifecycle of Code Reasoning in LLMs](http://arxiv.org/abs/2606.17648v1)
...
### [12] [EComAgentBench: Benchmarking Shopping Agents on Long-Horizon Tasks with Distributed Hidden Intent](http://arxiv.org/abs/2606.17698v2)
...
### [13] [LongWebBench: Evaluating Structural and Functional Webpage Generation in Long-Horizon Settings](http://arxiv.org/abs/2606.17727v1)
...
### [14] [Shattering the Autoregressive Curse: Dynamic Epistemic Entropy Orchestrated Erasable Reinforcement Learning for LLMs](http://arxiv.org/abs/2606.17735v1)
...
### [15] [DecoSearch: Complexity-Aware Routing and Plan-Level Repair for Text-to-SQL](http://arxiv.org/abs/2606.17821v1)
...
### [16] [A homotopy-type-theoretic generalization of neurosymbolic inference](http://arxiv.org/abs/2606.17851v1)
...
### [17] [FlowRAG: Synergizing Explicit Reasoning via Frequency-Aware Multi-Granularity Graph Flow](http://arxiv.org/abs/2606.17856v1)
...
### [18] [StepGuard: Guarding Web Navigation via Single-Step Calibration](http://arxiv.org/abs/2606.17871v1)
...
### [19] [FairTutor: Equity-Aware Pedagogical LLM Routing for Budget-Constrained AI Tutoring](http://arxiv.org/abs/2606.20713v1)
*Qingyang Xu*
...
### [20] [DiagFlowBench: Evaluating How Language Models Handle Off-Procedure Inputs in Grounded Diagnostic Dialogue](http://arxiv.org/abs/2606.17904v1)
...
### [21] [PreAct: Computer-Using Agents that Get Faster on Repeated Tasks](http://arxiv.org/abs/2606.17929v1)
*Bojie Li*
...
### [22] [How Inference Compute Shapes Frontier LLM Evaluation](http://arxiv.org/abs/2606.17930v3)
...
### [23] [LLM Consumer Behavior Theory: Foundations of a Novel Research Field](http://arxiv.org/abs/2606.18005v1)
...
### [24] [LegalHalluLens: Typed Hallucination Auditing and Calibrated Multi-Agent Debate for Trustworthy Legal AI](http://arxiv.org/abs/2606.18021v1)
...
### [25] [ProvenanceGuard: Source-Aware Factuality Verification for MCP-Based LLM Agents](http://arxiv.org/abs/2606.18037v1)
...
### [26] [PseudoBench: Measuring How Agentic Auto-Research Fuels Pseudoscience](http://arxiv.org/abs/2606.18060v1)
...
### [27] [Escape from Delusional Echo Trap: Symmetry Breaking, Stochastic Dynamics and Mathematical Mitigation Strategies for Algorithmic Sycophancy](http://arxiv.org/abs/2606.20718v1)
...
### [28] [Agentic AI-based Framework for Mitigating Premature Diagnostic Handoff and Silent Hallucination in Healthcare Applications](http://arxiv.org/abs/2606.18068v1)
...
### [29] [A Unified Framework for Context-Aware and Relation-Aware Graph Retrieval-Augmented Generation](http://arxiv.org/abs/2606.18075v1)
...
### [31] [Knowledge Reutilization in Meta-Reinforcement Learning](http://arxiv.org/abs/2606.18132v1)
...
### [32] [Your AI Travel Agent Would Book You a Bullfight: An Agentic Benchmark for Implicit Animal Welfare in Frontier AI Models](http://arxiv.org/abs/2606.18142v4)
...
### [33] [WEQA: Wearable hEalth Question Answering with Query-Adaptive Agentic Reasoning](http://arxiv.org/abs/2606.18147v1)
...
### [34] [Learning Cardiac Electrophysiology Digital Twins Through Agentic Discovery of Hybrid Structure](http://arxiv.org/abs/2606.18154v1)
...
### [35] [DRFLOW: A Deep Research Benchmark for Personalized Workflow Prediction](http://arxiv.org/abs/2606.18191v2)
...
### [36] [EvolveNav: Proactive Preflection and Self-Evolving Memory for Zero-Shot Object Goal Navigation](http://arxiv.org/abs/2606.18235v1)
...
### [37] [CaVe-VLM-CoT: An Interpretable Vision-Language Model Framework](http://arxiv.org/abs/2606.18385v1)
...
### [38] [Searching for Synergy in Shared Workspace Human-AI Collaboration](http://arxiv.org/abs/2606.18413v3)
...
### [39] [When Web Agents Finish but Still Fail: Reproducible Triggers and Trace Diagnostics for Parallel Web Exploration](http://arxiv.org/abs/2606.20724v2)
...
### [40] [CEO-Bench: Can Agents Play the Long Game?](http://arxiv.org/abs/2606.18543v1)
...
Selection reason: CEO-Bench 模拟 500 天长程运营任务，评价 agent 的长期规划与适应能力，可迁移到长程 coding agent 评测。
...
### [41] [Interpretable and Verifiable Hardware Generation with LLM-Driven Stepwise Refinement](http://arxiv.org/abs/2606.19387v2)
...
Selection reason: LLM驱动逐步精化生成可验证硬件，方法论可迁移到代码生成与形式化验证结合的场景。
...
### [42] [Beyond the GUI Paradigm: Do Mobile Agents Need the Phone Screen?](http://arxiv.org/abs/2606.19388v1)
...
Selection reason: 评估编码agent在移动CLI任务上的表现并引入基准套件，直接涉及coding agent评测。
...
### [43] [Unlocking LLM Code Correction with Iterative Feedback Loops](http://arxiv.org/abs/2606.17514v1)
...
Selection reason: 系统研究LLM通过执行反馈迭代修正代码的能力，直接关注coding agent的反馈循环与评测。
...
### [44] [PracRepair: LLM-Empowered Automated Program Repair Inspired by Human-Like Debugging Practices](http://arxiv.org/abs/2606.17612v1)
...
Selection reason: 提出LLM启发的人类式调试APR框架，在Defects4J等基准上显著提升修复效果，直接相关。
...
### [45] [Position: Coding Benchmarks Are Misaligned with Agentic Software Engineering](http://arxiv.org/abs/2606.17799v1)
...
Selection reason: 立场论文指出编码基准与agentic SE错位，对agent评测设计有重要启示。
...
### [46] [A Framework for Evaluating Agentic Skills at Scale](http://arxiv.org/abs/2606.17819v1)
...
Selection reason: 提出大规模评估agent skill的框架与数据集，直接适用于coding agent的技能评估。
...
### [47] [Planning to Hammer: Difficulty-Aware Decomposition for Automating Rocq Proofs](http://arxiv.org/abs/2606.17981v1)
...
Selection reason: 将LLM规划与CoqHammer结合实现自动化定理证明，对代码正确性验证的agent化有参考价值。
...
### [48] [All Smoke, No Alarm: Oracle Signals in Agent-Authored Test Code](http://arxiv.org/abs/2606.18168v1)
...
Selection reason: 研究 agent 生成测试代码中的 oracle 信号质量，对评估 coding agent 测试能力的评测方法有直接迁移价值。
...
### [49] [Exploring Statistical Change Point Detection Techniques for Performance Anomaly Detection at Mozilla](http://arxiv.org/abs/2606.18377v1)
...
Selection reason: 系统评估 25 种变化点检测方法用于性能异常检测，并构建标注基准，直接服务性能回归检测与 benchmark。
...
### [50] [Finding Compiler-Platform Interaction Bugs in Deep Learning Pipelines via Cross-Layer Constraints](http://arxiv.org/abs/2606.18421v1)
...
Selection reason: 面向深度学习编译器的跨层约束测试框架，可迁移到编译器/运行时缺陷检测与验证。
...
### [51] [From Specification to Execution: AI Assisted Scientific Workflow Management](http://arxiv.org/abs/2606.18425v1)
...
Selection reason: 用 LLM 生成科学工作流并引入调试 agent 与 MCP 集成，对长程 agent 工作流设计有参考价值。
...
### [52] [SoK: AI-Augmented Binary Reversing](http://arxiv.org/abs/2606.17398v1)
...
Selection reason: 系统化综述AI增强的二进制逆向，涵盖LLM和agentic AI，对程序分析类agent的评测与方法有参考价值。
...
### [53] [Structural Role Injection in Handlebars-Templated LLM Prompts: Triple-Brace Interpolation, Delimiter Family, and the Limits of HTML Auto-Escaping](http://arxiv.org/abs/2606.18120v1)
...
### [54] [Agentra: A Supervisable Multi-Agent Framework for Enterprise Intrusion Response](http://arxiv.org/abs/2606.18325v2)
...
### [55] [A Red-Team Study of Anthropic Fable 5 & Opus 4.8 Models](http://arxiv.org/abs/2606.18193v1)
*Nicola Franco*
...
### [56] [Learning Red Agent Policy from Observations for Neurosymbolic Autonomous Cyber Agents](http://arxiv.org/abs/2606.18223v2)
...
### [57] [SafeClawBench: Separating Semantic, Audit-Evidence, and Sandbox Harm in Tool-Using LLM Agents](http://arxiv.org/abs/2606.18356v1)
...
### [58] [Ghost Vectors: Soft-Deleted Embeddings Remain Reconstructible in HNSW Vector Databases](http://arxiv.org/abs/2606.18497v1)
...
### [59] [MagicSim: A Unified Infrastructure for Executable Embodied Interaction](http://arxiv.org/abs/2606.17511v1)
...
### [60] [ED3R: Energy-Aware Distributed Disaster Detection Enabled by Cooperative Robotic Agents](http://arxiv.org/abs/2606.17739v1)
...
### [62] [Visual Verification Enables Inference-time Steering and Autonomous Policy Improvement](http://arxiv.org/abs/2606.18247v1)
...
### [63] [Guava: An Effective and Universal Harness for Embodied Manipulation](http://arxiv.org/abs/2606.18363v1)
...
### [64] [As You Wish: Mission Planning with Formal Verification using LLMs in Precision Agriculture](http://arxiv.org/abs/2606.18519v1)
...
### [65] [Querying an astronomical database using large language models: the ALeRCE text-to-SQL system](http://arxiv.org/abs/2606.18108v1)
...
### [66] [A T-API-Compliant ReAct Agentic Loop for Optical Networks: Generic vs. Domain-Specific Tool Abstractions](http://arxiv.org/abs/2606.18000v1)
...
### [67] [Trustworthy Self-Composable Big-Data-as-a-Service: An LLM-Orchestrated Multi-Agent Framework for Automated Data Engineering, AutoML, MLOps Deployment, and Drift-Aware Lifecycle Optimization](http://arxiv.org/abs/2606.17915v1)
...
Selection reason: LLM编排多agent的BDaaS生命周期框架，其编排、治理与人工介入机制可迁移到工程化agent。
...
### [68] [A Neuro-Symbolic Approach to Strategy Synthesis for Strategic Logics](http://arxiv.org/abs/2606.17962v1)
...
### [69] [A Variational Framework for LLM Generator-Regulator Games](http://arxiv.org/abs/2606.18424v1)
*Quanyan Zhu*
...
### [71] [Scaling Enterprise Agent Routing: Degradation, Diagnosis, and Recovery](http://arxiv.org/abs/2606.17519v1)
...
### [72] [SuCo: Sufficiency-guided Continuous Adaptive Reasoning](http://arxiv.org/abs/2606.17687v1)
...
### [73] [RubricsTree: Scalable and Evolving Open-Ended Evaluation of Personal Health Agents across Health Memory and Medical Skills](http://arxiv.org/abs/2606.18203v1)
...
### [74] [ReproRepo: Scaling Reproducibility Audits with GitHub Repository Issues](http://arxiv.org/abs/2606.18237v1)
...
### [77] [AUTOGATE: Automated Clock Gating via Toggling-Aware LLM-based RTL Rewriting](http://arxiv.org/abs/2606.17461v1)
...
### [78] [Model Validation of Agentic AI Systems: A POMDP-Based Framework for Belief-State, Forecast, and Policy Validation](http://arxiv.org/abs/2606.17383v1)
...
### [79] [TerraTransfer: Learning End-to-End Driving Policies Without Expert Demonstrations](http://arxiv.org/abs/2606.17386v2)
...
### [80] [Visuals Lie, Consistency Speaks: Disentangling Spatial Attention from Reliability in Vision-Language Models](http://arxiv.org/abs/2606.17389v1)
...
### [81] [OmniDrive: An LLM-Choreographed Multi-Agent World Model with Unified Latent Co-Compression for Multi-View Driving Video Generation](http://arxiv.org/abs/2606.17536v1)
...
### [82] [Divide, Deliberate, Decide: A Multi-Agent Framework for Fine-Grained Egocentric Action Recognition](http://arxiv.org/abs/2606.17627v1)
...
### [83] [LiveStarPro: Proactive Streaming Video Understanding with Hierarchical Memory for Long-Horizon Streams](http://arxiv.org/abs/2606.17798v1)
...
### [84] [Video2Code: Generating Interactive Webpages from UI Videos via Action-Aware Revisit](http://arxiv.org/abs/2606.20711v1)
...
### [85] [MIRAGE: Stealthy Visual Prompt Injection for Vulnerability Detection in Web Agents](http://arxiv.org/abs/2606.20717v1)
...
### [86] [When the Next Step Is Not One Step: Distribution-Aware Execution Modeling for Concurrent Go Programs](http://arxiv.org/abs/2606.17508v1)
*Kaviru Hapuarachchi*
...
Selection reason: 针对并发Go程序建模不确定性执行，以分布训练提升预测并发布数据集，对程序分析与调试有迁移价值。
...
### [87] [Offline Preference-Based Trajectory Evaluation](http://arxiv.org/abs/2606.17541v1)
*Fernando Diaz*
...
### [88] [LoopCoder-v2: Only Loop Once for Efficient Test-Time Computation Scaling](http://arxiv.org/abs/2606.18023v1)
...
### [89] [SAE Interventions are Unreliable: Post-Intervention Recovery of Suppressed Behavior](http://arxiv.org/abs/2606.18322v1)
...
### [90] [LLMZero: Discovering Adaptive Training Strategies for RL Post-Training via LLM Agents](http://arxiv.org/abs/2606.18388v1)
...
### [91] [SFT Overtraining Predicts Rank Inversion via Entropy Collapse Under RLVR](http://arxiv.org/abs/2606.18487v2)
