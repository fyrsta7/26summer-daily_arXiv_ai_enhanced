...
### [1] [AdMem: Advanced Memory for Task-solving Agents](http://arxiv.org/abs/2606.06787v1)
...
### [2] [Workflow-to-Skill: Skill Creation via Routing-Workflow-Semantics-Attachments Decomposition](http://arxiv.org/abs/2606.06893v1)
...
### [3] [Declarative Skills for AI Agents in Knowledge-Grounded Tool-Use Workflows](http://arxiv.org/abs/2606.06923v1)
...
Selection reason: 对比声明式与命令式 agent 编排，声明式技能文件对工具调用 agent 的设计有直接借鉴意义。
...
### [4] [Quantum-Inspired Trace-Augmented Evidence Selection for Reasoning over Structured Hypothesis Spaces](http://arxiv.org/abs/2606.06941v1)
...
### [5] [NAVI-Orbital: First In-Orbit Demonstration of a Zero-Shot Vision-Language Model for Autonomous Earth Observation](http://arxiv.org/abs/2606.18271v1)
...
### [6] [Exploring Agentic Tool-Calling Decisions via Uncertainty-Aligned Reinforcement Learning](http://arxiv.org/abs/2606.06976v1)
...
### [7] [The Sim-to-Real Gap of Foundation Model Agents: A Unified MDP Perspective](http://arxiv.org/abs/2606.07017v1)
...
### [8] [StainFlow: Entity-Stain Tracking and Evidence Linking for Process Rewards in GUI Agents](http://arxiv.org/abs/2606.07027v2)
...
### [9] [DyCon: Dynamic Reasoning Control via Evolving Difficulty Modeling](http://arxiv.org/abs/2606.07108v2)
...
### [10] [Think Fast: Estimating No-CoT Task-Completion Time Horizons of Frontier AI Models](http://arxiv.org/abs/2606.07157v3)
...
### [11] [DuMate-DeepResearch: An Auditable Multi-Agent System with Recursive Search and Rubric-Grounded Reasoning](http://arxiv.org/abs/2606.07299v1)
...
### [12] [Online Pandora's Box for Contextual LLM Cascading](http://arxiv.org/abs/2606.07392v1)
...
### [13] [A case study of evaluating AI agents on a neuroscience data-to-discovery pipeline](http://arxiv.org/abs/2606.07718v1)
...
### [14] [Act As a Real Researcher: A Suite of Benchmarks Evaluating Frontier LLMs and Agentic Harnesses in Research Lifecycle](http://arxiv.org/abs/2606.07462v1)
...
### [15] [Position: Hippocampal Explicit Memory Is the Cornerstone for AGI](http://arxiv.org/abs/2606.11245v1)
*Sangjun Park*
...
### [16] [How AI Agents Reshape Knowledge Work: Autonomy, Efficiency, and Scope](http://arxiv.org/abs/2606.07489v2)
...
### [17] [Beyond Goodhart's Law: A Dynamic Benchmark for Evaluating Compliance in Multi-Agent Systems](http://arxiv.org/abs/2606.07805v1)
...
### [18] [Where Instruction Hierarchy Breaks: Diagnosing and Repairing Failures in Reasoning Language Models](http://arxiv.org/abs/2606.07808v1)
...
### [19] [Scaling Participation in Modular AI Systems](http://arxiv.org/abs/2606.07812v1)
...
### [20] [SPARC: A Multi-Agent System for Electrical Circuit Question Answering](http://arxiv.org/abs/2606.20643v1)
...
### [21] [Safety is Contextual, LLM-Judges Are Not: Navigating the Rigid Priors of Evaluators](http://arxiv.org/abs/2606.07874v1)
...
### [22] [The AI Epistemic Deference Index: A Continuous Measure of Sycophancy](http://arxiv.org/abs/2606.07897v1)
...
### [23] [Contract2Tool: Learning Preconditions and Effects for Reliable Tool-Augmented LLM Agents](http://arxiv.org/abs/2606.07904v1)
...
Selection reason: 从元数据/文档/轨迹学习工具契约并做因果工具过滤，直接提升tool-augmented agent的可靠性与效率。
...
### [24] [SWE-Marathon: Can Agents Autonomously Complete Ultra-Long-Horizon Software Work?](http://arxiv.org/abs/2606.07682v1)
...
Selection reason: 超长时程软件任务基准，揭示 agent 自我验证与提前终止问题，对 coding agent 评测极具价值。
...
### [25] [Review the Code, Not the Story: A Vision and Protocol for Code-First Peer Review](http://arxiv.org/abs/2606.07683v1)
*Jienan Chen*
...
Selection reason: 面向可执行证据的 code-first 评审协议，AI 构建环境并审计代码路径，对 agent 评测与代码审查有参考。
...
### [26] [Chiseling Out Efficiency: Structured Skeleton Supervision for Efficient Code Generation](http://arxiv.org/abs/2606.06821v1)
...
Selection reason: 显式提取效率骨架并以多任务学习提升 LLM 生成代码的运行效率，直接对应程序性能优化。
...
### [27] [SkelDPO: A Skeleton-Guided Direct Preference Optimization Framework for Efficient Code Generation](http://arxiv.org/abs/2606.06826v1)
*Yu Yu,Chen Lyu*
...
Selection reason: 骨架引导的直接偏好优化提升代码执行效率，与传统 correctness/efficiency 对齐形成互补。
...
### [28] [LLM Agent-Assisted Reverse Engineering with Quantitative Readability Metrics](http://arxiv.org/abs/2606.06838v1)
...
Selection reason: LLM agent 辅助反编译代码可读性改进，结合定量指标与正确性验证，可迁移到 agent 驱动的代码重构。
...
### [29] [Empirical Study on the Characteristics and Evolution of AI-usage in GitHub Repositories: Evidence from Code Comments](http://arxiv.org/abs/2606.06843v1)
...
Selection reason: 实证分析 3.5 万条引用 AI 的代码注释，揭示开发者真实使用模式与代码演化，对理解 coding agent 落地有参考价值。
...
### [30] [From Custom Logic to APIs: Understanding and Recommending API Replacement Refactorings](http://arxiv.org/abs/2606.06912v1)
...
Selection reason: 提出混合静态模式匹配与语义推理的 API 替换重构推荐框架，可迁移至代码 agent 的自动化重构能力。
...
### [31] [Porting Declarative UI to HarmonyOS: A Heuristic-guided LLM Approach](http://arxiv.org/abs/2606.07085v1)
...
Selection reason: 用启发式骨架引导 LLM 翻译加规则修复，在 UI 迁移任务上大幅提升可编译率，此受限生成策略可迁移到代码 agent。
...
### [32] [Are We Lost in the Woods? Detecting Silent Semantic Faults for Random Forest Classifiers with Data-informed Static Analysis](http://arxiv.org/abs/2606.07709v1)
...
Selection reason: 用数据感知静态分析检测 ML 脚本中的静默语义错误，可辅助验证 agent 生成的 ML 代码质量。
...
### [33] [SWE-Explore: Benchmarking How Coding Agents Explore Repositories](http://arxiv.org/abs/2606.07297v1)
...
Selection reason: SWE-Explore 基准专门评测 coding agent 的仓库探索能力，行级覆盖与排序指标直接关联下游修复，核心相关。
...
### [34] [QBugLM: An Agentic Benchmarking Framework for LLM-based Quantum Software Debugging](http://arxiv.org/abs/2606.07314v1)
...
Selection reason: 面向量子程序调试的 agentic 框架与基准，迭代反馈显著提升修复成功率，对调试类代码 agent 有参考价值。
...
### [35] [Socratic-SWE: Self-Evolving Coding Agents via Trace-Derived Agent Skills](http://arxiv.org/abs/2606.07412v1)
...
Selection reason: Socratic-SWE 从历史轨迹提炼技能并自进化生成新任务，闭环训练显著提升 SWE-bench 性能，强迁移价值。
...
### [36] [Agentic Very Much! Adoption of Coding Agent in New GitHub Projects](http://arxiv.org/abs/2606.07448v1)
...
Selection reason: 实证显示新 GitHub 项目中 coding agent 采用率翻倍且强度更高，为 agent 影响力评估提供数据。
...
### [37] [The Windows IOCTL Census: A Corpus-Scale, Multi-Architecture Database of the Driver Control-Code Surface](http://arxiv.org/abs/2606.07732v1)
*Michael J. Bommarito*
...
Selection reason: 大规模 Windows 驱动 IOCTL 数据库，作为程序分析/安全 agent 测试语料有参考价值。
...
### [38] [Jas: AI-Paired Engineering as a Revival of N-Version Programming](http://arxiv.org/abs/2606.07828v1)
*Jason Hickey*
...
Selection reason: 用精确规范与差分测试支撑 AI 多语言移植，验证了 AI-paired engineering 的可靠性工作流，对代码生成 agent 有启发。
...
### [39] [Cherry-pick Override: Unsafe Directional Commitment in LLM Judges under Mixed Evidence](http://arxiv.org/abs/2606.07834v1)
*Haoran Xu*
...
Selection reason: 研究LLM裁判在混合证据下的定向承诺风险并设计外部承诺控制层，可迁移到代码agent的验证与评测可靠性。
...
### [40] [DD-GEPA: Prompt Optimization for Dialogue Disentanglement Focusing on Task Instruction and Utterance Representation](http://arxiv.org/abs/2606.07894v1)
...
Selection reason: 用GEPA自动优化prompt解决对话解缠任务，优化方法通用但应用为NLP任务，迁移价值有限。
...
### [41] [Progress-SQL: Improving Reinforcement Learning for Text-to-SQL via Progressive Rewards](http://arxiv.org/abs/2606.06825v1)
...
### [42] [Characterize Then Distill: Mechanistic Reasoning in Large Output Spaces](http://arxiv.org/abs/2606.06840v1)
...
### [43] [ThinkBooster: A Unified Framework for Seamless Test-Time Scaling of LLM Reasoning](http://arxiv.org/abs/2606.06915v2)
...
### [44] [OpenHalDet: A Unified Benchmark for Hallucination Detection across Diverse Generation Scenarios](http://arxiv.org/abs/2606.06959v1)
...
### [45] [TRACE: Trajectory Reasoning through Adaptive Cross-Step Evidence Aggregation for LLM Agents](http://arxiv.org/abs/2606.07054v1)
...
### [46] [Less Context, More Accuracy: A Bi-Temporal Memory Engine for LLM Agents Where a Lean Retrieved Context Beats the Full History](http://arxiv.org/abs/2606.09900v1)
*Liuyin Wang*
...
### [47] [When Large Language Models Fail in Healthcare: Evaluating Sensitivity to Prompt Variations](http://arxiv.org/abs/2606.07237v1)
*Mahdi Alkaeed*
...
### [48] [SLMJury: Can Small Language Models Judge as Well as Large Ones?](http://arxiv.org/abs/2606.07810v1)
...
### [49] [The ACUTE Protocol: Operationalizing Language Model Activations for Better Calibration, Utility, and Trust](http://arxiv.org/abs/2606.07822v2)
...
### [50] [MemDreamer: Decoupling Perception and Reasoning for Long Video Understanding via Hierarchical Graph Memory and Agentic Retrieval Mechanism](http://arxiv.org/abs/2606.07512v2)
...
### [51] [Think Like a Pilot: Fine-Grained Long-Horizon UAV Navigation](http://arxiv.org/abs/2606.06836v1)
...
### [52] [Neuro-Symbolic Learning for Long-Horizon Task Planning Under Complex Logical Constraints](http://arxiv.org/abs/2606.06877v1)
...
### [53] [An Abstract Architecture for Explainable Autonomy in Hazardous Environments](http://arxiv.org/abs/2606.07211v1)
...
### [54] [Beyond Waypoints: A Trajectory-Centric Waypointing Paradigm for Vision-Language Navigation](http://arxiv.org/abs/2606.07244v1)
...
### [55] [Mitigating Anchoring Bias in LLM-Based Agents for Energy-Efficient 6G Autonomous Networks](http://arxiv.org/abs/2606.18272v2)
...
### [56] [Does Persona Make LLMs K-pop Fans? A Pilot Study of LLM-Based Online Concert Audience Agents](http://arxiv.org/abs/2606.07837v1)
...
### [57] [Cost-Aware Speculative Execution for LLM-Agent Workflows: An Integrated Five-Dimension Method](http://arxiv.org/abs/2606.07846v1)
*Faisal Fareed*
...
### [58] [What Your Posts Reveal: A Benchmark and Agentic Framework for User-Level Privacy Leakage on Social Media](http://arxiv.org/abs/2606.06784v1)
...
### [59] [MLingualFC: Evaluating Jailbreak Vulnerabilities in Multilingual Vision-Language Models](http://arxiv.org/abs/2606.07706v1)
...
### [60] [MalSkillBench: A Runtime-Verified Benchmark of Malicious Agent Skills](http://arxiv.org/abs/2606.07131v3)
...
Selection reason: 首个运行时验证的恶意 skill 基准，覆盖提示注入与代码注入，对 coding agent 供应链安全评测有直接价值。
...
### [61] [From Privacy to Workflow Integrity: Communication-Graph Metadata in Autonomous Agent Interoperability](http://arxiv.org/abs/2606.07150v3)
*Bijaya Dangol*
...
### [62] [On the Shoulders of Giants: Empowering Automated Smart Contract Auditing via the GiAnt Corpus](http://arxiv.org/abs/2606.07363v1)
...
Selection reason: 大规模智能合约审计数据集，涵盖漏洞检测与 gas 优化任务，可用于评测安全与性能 agent。
...
### [63] [MOLOT System Card: Malicious Operational Logic Observation Transformer](http://arxiv.org/abs/2606.07792v1)
...
Selection reason: 静态行为序列建模检测恶意包并发布基准，可迁移到代码安全 agent 的检测与评测。
...
### [64] [Beyond Pass/Fail: Using Process Mining to Understand How LLMs Resist (and Fail) Red Team Attacks](http://arxiv.org/abs/2606.07833v1)
*Zvi Topol*
...
### [65] [The Three-Ring Architecture: Governing Agents in the Era of On-Platform Organisations](http://arxiv.org/abs/2606.07119v1)
...
### [66] [Hierarchical Certified Semantic Commitment for Byzantine-Resilient LLM-Agent Collaboration](http://arxiv.org/abs/2606.07316v1)
...
### [67] [TianJi-Environ: An Autonomous AI Scientist for Atmospheric Environmental Research](http://arxiv.org/abs/2606.07697v1)
...
### [68] [SCALE: Scalable Cross-Attention Learning with Extrapolation for Agentic Workflow Scheduling](http://arxiv.org/abs/2606.06820v1)
...
### [69] [PandaAI: A Practical Agent CQ2 for Neuro-symbolic Data Analysis And Integrated Decision-Making in Quantitative Finance](http://arxiv.org/abs/2606.06823v1)
...
### [70] [HARP: Efficient Data Selection for Finetuning Large Language Models](http://arxiv.org/abs/2606.07690v1)
...
### [71] [SlimSearcher: Training Efficiency-Aware Web Agents via Adaptive Reward Gating](http://arxiv.org/abs/2606.07074v1)
...
### [72] [FunctionEvolve: Structure-Guided Symbolic Regression with LLMs](http://arxiv.org/abs/2606.07704v1)
...
### [73] [SAW: Stage-Aware Dynamic Weighting for Multi-Objective Reinforcement Learning in Large Language Models](http://arxiv.org/abs/2606.07705v1)
...
### [74] [WhiFlash: Accelerating Speculative Decoding with Token-Level Cross-Paradigm Routing](http://arxiv.org/abs/2606.07710v1)
...
### [75] [Rosetta Memory: Adaptive Memory for Cross-LLM Agents](http://arxiv.org/abs/2606.07711v1)
...
### [76] [Do Coding Agents Deceive Us? Detecting and Preventing Cheating via Capped Evaluation with Randomized Tests](http://arxiv.org/abs/2606.07379v2)
...
### [77] [Sparse Subspace-to-Expert Sharing for Task-Agnostic Continual Learning](http://arxiv.org/abs/2606.07500v1)
...
### [78] [Strained Coherence: A Pre-Failure Signal in Coding Agent Execution Trajectories](http://arxiv.org/abs/2606.07889v1)
...
### [79] [Agentic multi-fidelity learning of quasiparticle and excitonic properties](http://arxiv.org/abs/2606.07836v1)
