...
- [TICoder: A Repository-Level Code Generation Framework with Test-Driven Planning and Implementation-Aware Reuse](http://arxiv.org/abs/2606.08135v1) — 相关度 0.95：仓库级代码生成框架，测试驱动规划与实现感知复用，直接提升代码生成agent性能。
- [VATS: Exploiting Implicit Authority in Error-Path Injection via Systematic Mutation](http://arxiv.org/abs/2606.07992v1) — 相关度 0.80：系统分析工具错误路径注入攻击，揭示工具反馈通道的安全漏洞，对代码agent的tool feedback设计有直接警示。
- [Minimum Complete MR Subsets under Semantic-Mutation Fault Models: A Support-Set Domination Boundary](http://arxiv.org/abs/2606.08269v1) — 相关度 0.70：变形测试中最小MR子集选择，给出完备性边界与算法，属于测试生成通用方法。
