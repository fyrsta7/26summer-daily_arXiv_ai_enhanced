...
### [1] [MemToolAgent: Leveraging Memory for Tool Using Agents Based on Environment and User Feedback](http://arxiv.org/abs/2606.07909v2)
...
### [2] [VATS: Exploiting Implicit Authority in Error-Path Injection via Systematic Mutation](http://arxiv.org/abs/2606.07992v1)
...
Selection reason: 系统分析工具错误路径注入攻击，揭示工具反馈通道的安全漏洞，对代码agent的tool feedback设计有直接警示。
...
### [3] [Efficient Skill Grounding via Code Refactoring with Small Language Models](http://arxiv.org/abs/2606.07999v1)
...
### [4] [SKILL.nb: Selective Formalization and Gated Execution for Durable Agent Workflows](http://arxiv.org/abs/2606.08049v1)
...
### [5] [PACE: Anytime-Valid Acceptance Tests for Self-Evolving Agents](http://arxiv.org/abs/2606.08106v1)
*Zayx Shawn*
...
### [6] [Decision-Aware Memory Cards: Counterfactual-Inspired Context Selection and Compression for Tool-Using LLM Agents](http://arxiv.org/abs/2606.08151v2)
...
### [7] [Online Agent-as-a-Judge: Situation-Generating Evaluation for Interactive Agents](http://arxiv.org/abs/2606.08200v1)
...
### [8] [SciTrace: Trajectory-Aware Safety Reasoning for Scientific Discovery Agents](http://arxiv.org/abs/2606.08234v1)
...
### [9] [Traxia: A Framework for Verifiable, Agent-Native Scientific Publishing](http://arxiv.org/abs/2606.08256v1)
*Wisdom Dogah*
...
### [10] [Beyond Agent Architecture: Execution Assumptions and Reproducibility in LLM-Based Trading Systems](http://arxiv.org/abs/2606.08285v1)
...
### [11] [Revisiting the shutdown problem](http://arxiv.org/abs/2606.08296v1)
*David Thorstad*
...
### [12] [To Nuke or Not to Nuke: LLMs' (Missing) Ethical Reasoning and Actions in a High-Stakes Decision-Making Simulation](http://arxiv.org/abs/2606.08310v1)
...
### [13] [Neuro-Symbolic Injection of LTLf Constraints in Autoregressive Reinforcement Learning Policies](http://arxiv.org/abs/2606.08312v1)
...
### [14] [Benchmarking Open-Ended Multi-Agent Coordination in Language Agents](http://arxiv.org/abs/2606.08340v1)
...
### [15] [TICoder: A Repository-Level Code Generation Framework with Test-Driven Planning and Implementation-Aware Reuse](http://arxiv.org/abs/2606.08135v1)
...
Selection reason: 仓库级代码生成框架，测试驱动规划与实现感知复用，直接提升代码生成agent性能。
...
### [16] [Minimum Complete MR Subsets under Semantic-Mutation Fault Models: A Support-Set Domination Boundary](http://arxiv.org/abs/2606.08269v1)
...
Selection reason: 变形测试中最小MR子集选择，给出完备性边界与算法，属于测试生成通用方法。
...
### [17] [Voting Protocols as Coordination Mechanisms for Role-Constrained Multi-Agent Tutoring Systems](http://arxiv.org/abs/2606.08030v1)
...
### [18] [Emergence World: A Platform for Evaluating Long-Horizon Multi-Agent Autonomy](http://arxiv.org/abs/2606.08367v1)
...
### [19] [Aligned but Not Partner-Specific: Distinguishing How Multimodal LLM Agents Succeed in Reference Games Without Human-Like Conventions](http://arxiv.org/abs/2606.08081v1)
...
### [20] [Decoupling Semantics and Logic: A Training-Free Coarse-to-Fine Pipeline for Video Retrieval-Augmented Generation](http://arxiv.org/abs/2606.07924v1)
...
### [21] [IEA: Amateur-Friendly Conversational Image Editing Agent via Three Stages of Multitask Alignment](http://arxiv.org/abs/2606.08016v1)
...
### [22] [Semantic Quorum Assurance: Collective Certification for Non-Deterministic AI Infrastructure](http://arxiv.org/abs/2606.08021v1)
*Jun He,Deying Yu*
...
### [23] [IntentKV: Cross-Turn Intent-Aware KV Cache Pruning for Agent Inference](http://arxiv.org/abs/2606.09916v1)
...
### [24] [Causal Agent Replay: Counterfactual Attribution for LLM-Agent Failures](http://arxiv.org/abs/2606.08275v1)
*Jaineet Shah*
...
### [25] [Generative Frontier Planning for Adaptive Peer-Referral Recruitment under Covariate-Dependent Arrivals](http://arxiv.org/abs/2606.08360v1)
...
### [26] [An Information-Theoretic Definition for Open-Ended Learning](http://arxiv.org/abs/2606.08369v1)
...
### [27] ["So There's a Catch-22 Here": How Early Adopters Who Build Multi-Agent LLM Systems Conceptualize Transparency](http://arxiv.org/abs/2606.08323v1)
...
### [28] [PRISM: PRior-guided Imagination Sampling in world Models](http://arxiv.org/abs/2606.07974v1)
...
### [29] [Continual Quadruped Robots Coordination via Semantic Skill Discovery](http://arxiv.org/abs/2606.08102v2)
...
### [30] [POISE: Position-Aware Undetectable Skill Injection on LLM Agents](http://arxiv.org/abs/2606.07943v1)
...
### [31] [RecurGuard: Runtime Monitoring for Reasoning-Token Consumption Attacks](http://arxiv.org/abs/2606.07968v1)
...
### [32] [Closing the Sim-to-Real Gap: An Evaluation Framework for Autonomous Cyber Defense Configuration of Commercial EDR](http://arxiv.org/abs/2606.08168v1)
