...
### [1] [OSGuard: A Benchmark for Safety in Computer-Use Agents](http://arxiv.org/abs/2606.15034v1)
...
### [2] [Risk-Aware LLM Agents for Geospatial Data Retrieval: Design and Preliminary Adversarial Evaluation](http://arxiv.org/abs/2606.15077v1)
...
### [3] [VGPT-RSI for RH-Adjacent Formal Progress: Boundary Certificates, Verified Finite Lagarias Inequalities, and Explicit Failure Localization](http://arxiv.org/abs/2606.15096v1)
...
### [4] [Towards Verifiable Agentic Data Science: Solving Irregular TSQA Via Tool-Grounded Reasoning](http://arxiv.org/abs/2606.15107v1)
...
### [5] [Visual-Seeker: Towards Visual-Native Multimodal Agentic Search via Active Visual Reasoning](http://arxiv.org/abs/2606.15231v1)
...
### [6] [CODA-BENCH: Can Code Agents Handle Data-Intensive Tasks?](http://arxiv.org/abs/2606.15300v1)
...
### [7] [APEX: Adaptive Principle EXtraction A Three-Layer Self-Evolution Framework for Production AI Agents](http://arxiv.org/abs/2606.15363v1)
...
### [8] [S1-DeepResearch: Beyond Search, Toward Real-World Long-Horizon Research Agents](http://arxiv.org/abs/2606.15367v1)
...
### [9] [Reward Hacking in Language Model Agents: Revisiting AI Safety Gridworlds](http://arxiv.org/abs/2606.15385v1)
...
### [10] [ToolMenuBench: Benchmarking Tool-Menu Filtering Strategies for Reliable and Efficient LLM Agents](http://arxiv.org/abs/2606.15508v1)
...
### [11] [Specifications for Humans, Agents, and Tooling](http://arxiv.org/abs/2606.15084v1)
*Mark Marron*
...
Selection reason: 面向人/agent/工具的多语言规范生态，强调验证、测试生成与沙箱，对agentic软件工程的规范与验证有迁移价值。
...
### [12] [The Hitchhiker's Guide to Program Analysis, Part III: Mostly Harmless LLMs](http://arxiv.org/abs/2606.15122v1)
...
Selection reason: LLM仅负责构造分析harness，行为推理交给形式后端，这种分离LLM与形式验证的架构可迁移到代码agent的告警验证。
...
### [13] [AI-driven Software Development: A Pragmatic Path to Agentic Development Processes](http://arxiv.org/abs/2606.15283v1)
...
Selection reason: 提出从辅助AI到受控agentic开发流程的框架，强调harness、验证与治理机制，对代码agent工程化有参考价值。
...
### [14] [LogCopilot: Automating Log Aggregation Analysis through Large Language Models](http://arxiv.org/abs/2606.17094v1)
...
Selection reason: 用LLM检索知识并生成/执行LogQL查询来自动化日志聚合分析，其工具调用与知识库方法可迁移到agent的日志诊断。
...
### [15] [ClayBuddy: A Framework, Evaluation, & Mitigation of Coding Agent Failures](http://arxiv.org/abs/2606.19380v3)
...
Selection reason: 系统研究coding agent三类失败机制并提出可修改harness的缓解方案，直接针对代码agent可靠性与评测。
...
### [16] [CoAgent: Concurrency Control for Multi-Agent Systems](http://arxiv.org/abs/2606.15376v1)
...
### [17] [AutoDojo: Adaptive Black-Box Attacks Reveal the Limits of IPI Defenses and Task-Specification Effects in LLM Agents](http://arxiv.org/abs/2606.15057v2)
...
### [18] [Benign in Isolation, Harmful in Composition: Security Risks in Agent Skill Ecosystems](http://arxiv.org/abs/2606.15242v1)
...
### [19] [Defending against Adaptive Prompt Injection Attacks via Reasoning-enabled Task Alignment](http://arxiv.org/abs/2606.15441v1)
...
### [20] [LLM4RTL: Tool-Assisted LLM for RTL Generation](http://arxiv.org/abs/2606.15500v1)
...
### [21] [MemoryVAM: Integrating Memory into Video Action Model for Robot Manipulation](http://arxiv.org/abs/2606.20679v1)
...
### [22] [Ling and Ring 2.6 Technical Report: Efficient and Instant Agentic Intelligence at Trillion-Parameter Scale](http://arxiv.org/abs/2606.15079v1)
...
### [23] [Privacy-Preserving Text Sanitization for Distributed Agents Collaboration via Disentangled Representations](http://arxiv.org/abs/2606.15335v1)
...
### [24] [Not All Skills Help: Measuring and Repairing Agent Knowledge](http://arxiv.org/abs/2606.15390v1)
...
### [25] [CHILLGuard: Towards Fine-Grained Chinese LLM Safety Guardrail with Scalable Data Construction and Model-aware Preference Alignment](http://arxiv.org/abs/2606.15396v1)
...
### [26] [T-Mem: Memory That Anticipates, Not Archives](http://arxiv.org/abs/2606.15405v1)
...
### [27] [Let LLMs Judge Each Other: Multi-Agent Peer-Reviewed Reasoning for Medical Question Answering](http://arxiv.org/abs/2606.15419v1)
...
### [28] [Cognitive Trajectory Modeling: Quantifying Human-AI Co-Creation through Cognitively Grounded Interaction Trajectories](http://arxiv.org/abs/2606.15358v2)
*Nicholas Davis*
...
### [29] [StarOR: Synergizing Tree Search and Test-Time Reinforcement Learning for Optimization Modeling](http://arxiv.org/abs/2606.15197v2)
...
### [30] [Edu-Theater: A Data-Efficient Agent Framework for Scalable Learner Behavior Simulation through Staging Roll-Call](http://arxiv.org/abs/2606.15225v1)
...
### [31] [LatentGym: A Testbed For Cross-Task Experiential Learning With Controllable Latent Structure](http://arxiv.org/abs/2606.15306v1)
...
### [32] [Constitutional Value Potentials: reading and steering internal priority margins in language models](http://arxiv.org/abs/2606.15420v1)
*Tong Che,Rui Wu*
...
### [33] [EChO-Agent: Evidence Chain Orchestration Agent for Audio Reasoning](http://arxiv.org/abs/2606.15141v1)
