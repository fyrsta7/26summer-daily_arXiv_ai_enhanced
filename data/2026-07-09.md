...
### [1] [Concretized Proposition Prompting Resolves Composition-Knowledge Dichotomy in Large Language Models](http://arxiv.org/abs/2607.08018v1)
...
### [2] [From Prompts to Contracts: Harness Engineering for Auditable Enterprise LLM Agents](http://arxiv.org/abs/2607.08028v1)
...
Selection reason: 用 harness、契约、校验构件将 LLM agent 审计化，对工程化 agent 的可靠落地与模型替换有强参考价值。
...
### [3] [A safety-oriented hypothetico-deductive framework for AI-assisted differential diagnosis](http://arxiv.org/abs/2607.08038v1)
...
### [4] [When LLMs Agree, Are They Right? Auditing Self-Consistency and Cross-Model Agreement as Confidence Signals](http://arxiv.org/abs/2607.08065v1)
*Kaihua Ding*
...
### [5] [Persuasion Attacks Can Decrease Effectiveness of CoT Monitoring](http://arxiv.org/abs/2607.08066v1)
...
### [6] [CausalDS: Benchmarking Causal Reasoning in Data-Science Agents](http://arxiv.org/abs/2607.08093v1)
...
### [7] [Agentic Context Learning with Self-Discovered Specification](http://arxiv.org/abs/2607.09794v1)
...
### [8] [ASMR: Agentic Schema Generation for Ship Maintenance Report Writing](http://arxiv.org/abs/2607.08177v1)
...
### [9] [Playing ZendoWorld: Challenging AI Agents on Active Visual Concept Induction](http://arxiv.org/abs/2607.08233v1)
...
### [10] [AutoPersonas: A Multi-Timescale Loop Engine for Open-Ended Persona Evolution](http://arxiv.org/abs/2607.08252v1)
*Mengchen Li*
...
### [11] [Compete Then Collaborate: Frontier AI Teachers Build a Verifiable Curriculum to Improve a Coding Student Beyond Imitation](http://arxiv.org/abs/2607.08255v1)
*Miseong Shawn Kim*
...
### [12] [PolyUQuest: Verifiable Structure-Aware Web RAG over Heterogeneous Graphs](http://arxiv.org/abs/2607.08269v1)
...
### [13] [Understanding Axes of Difficulty For Long Context Tasks Via PredicateLongBench](http://arxiv.org/abs/2607.08284v1)
...
### [14] [Blind-Spots-Bench: Evaluating Blind Spots in Multimodal Models](http://arxiv.org/abs/2607.08317v1)
...
### [15] [Game Theory Driven Multi-Agent Framework Mitigates Language Model Hallucination](http://arxiv.org/abs/2607.08403v1)
...
### [17] [SolarChain-Eval: A Physics-Constrained Benchmark for Trustworthy Economic Agents in Decentralized Energy Markets](http://arxiv.org/abs/2607.08681v1)
...
### [18] [Remember When It Matters: Proactive Memory Agent for Long-Horizon Agents](http://arxiv.org/abs/2607.08716v1)
...
### [19] [Workflow as Knowledge: Semantic Persistence for LLM-Mediated Workflows](http://arxiv.org/abs/2607.08740v1)
...
Selection reason: 将工作流建模为可检查、可恢复的知识对象，为代码 agent 工作流持久化与审计提供概念框架。
...
### [20] [GATS: Graph-Augmented Tree Search with Layered World Models for Efficient Agent Planning](http://arxiv.org/abs/2607.08894v1)
...
### [21] [Long-Horizon-Terminal-Bench: Testing the Limits of Agents on Long-Horizon Terminal Tasks with Dense Reward-Based Grading](http://arxiv.org/abs/2607.08964v2)
...
### [22] [A Formalization of the Mean-Field Derivation of the Vlasov Equation: AI-Assisted Lean Formalization as a Strategy Game](http://arxiv.org/abs/2607.08986v1)
*Joseph K. Miller*
...
### [23] [Aleena: Alignment Agent for Research Software Engineering Collaborations](http://arxiv.org/abs/2607.08043v1)
...
Selection reason: 面向研究软件工程协作的生命周期对齐 agent，其项目状态追踪与决策连续性机制可迁移到多 agent 协作场景。
...
### [24] [TTHE: Test-Time Harness Evolution](http://arxiv.org/abs/2607.08124v1)
...
Selection reason: 将 harness 视为测试时可进化程序，用执行轨迹无监督优化 agent 流程，直接面向代码 agent 的自适应改进。
...
### [25] [ProjAgent: Procedural Similarity Retrieval for Repository-Level Code Generation](http://arxiv.org/abs/2607.08691v1)
...
Selection reason: 提出过程相似性检索与静态分析反馈修复，用于仓库级代码生成，直接提升 agent 代码生成能力。
...
### [26] [Programmers Are Poor and Overconfident Judges of LLM-Generated Assertions](http://arxiv.org/abs/2607.08885v1)
...
Selection reason: 实验揭示程序员难以判断 LLM 生成断言的正确性，对构建可靠验证与代码审查 agent 有警示价值。
...
### [27] [Better Harnesses, Smaller Models: Building 90% Cheaper Agents via Automated Harness Adaptation](http://arxiv.org/abs/2607.08938v1)
...
Selection reason: 元 agent 自动适配 harness，使小模型达到大模型性能且成本降 90%，直接指导低成本 agent 部署。
...
### [28] [Toward Inferring Accurate Context-free Grammars for Big Languages in a Black-box Setting](http://arxiv.org/abs/2607.08959v4)
...
Selection reason: 黑盒上下文无关文法推断改进 fuzzing 与程序分析，可为代码 agent 的输入生成和漏洞发现提供底层能力。
...
### [29] [The Patchwork Problem in LLM-Generated Code](http://arxiv.org/abs/2607.08981v1)
...
Selection reason: 系统化定义 LLM 生成代码的结构一致性不变量和失败分类，并提供验证框架，直接针对代码 agent 产物缺陷。
...
### [30] [SCATE: Learning to Supervise Coding Agents for Cost-Effective Test Generation](http://arxiv.org/abs/2607.08983v1)
...
Selection reason: 将 coding agent 监督建模为上下文 bandit，自适应选择测试动作，显著提升覆盖率与成本效率。
...
### [31] [Loop-Based Slicing and Input-Driven Concretization: An Empirical Study of Termination and Non-Termination Analysis](http://arxiv.org/abs/2607.08988v1)
...
Selection reason: 循环切片与输入具体化预处理可增强终止性验证，作为程序分析 agent 的预处理策略有迁移价值。
...
### [32] [From Generic to Personalized: Exploring Persona-Aware Code Review Explanations](http://arxiv.org/abs/2607.08990v1)
...
Selection reason: 探索个性化代码审查解释，对构建适配开发者风格的 AI 审查 agent 有参考价值。
...
### [33] [GitLake: Git-for-data for the agentic lakehouse](http://arxiv.org/abs/2607.08319v1)
...
### [34] [Provably Optimal Learning Algorithms for Assistance Games](http://arxiv.org/abs/2607.08012v1)
...
### [35] [Who Analyses the Analyser? Self-Validating LLM Hazard Analysis with Constitutional Meta-STPA](http://arxiv.org/abs/2607.08054v1)
...
### [36] [When Thinking Hurts: Epistemic Signals in the Reasoning Chains of Visual Language Models](http://arxiv.org/abs/2607.08059v1)
*Mayank Singal*
...
### [37] [Open-ended Multi-agent Autocurricula via Visual Inspection of Policies with Multi-modal LLMs](http://arxiv.org/abs/2607.08193v1)
...
### [38] [Self-Adaptive Anomaly Detection with Reinforcement Learning and Human Feedback in Connected Vehicles](http://arxiv.org/abs/2607.08373v1)
...
### [39] [Multi-Modal, Multi-Environment Machine Teaching for Robust Reward Learning](http://arxiv.org/abs/2607.08647v1)
...
### [40] [Prompt-Driven Exploration](http://arxiv.org/abs/2607.08837v1)
...
### [41] [Eluna: An Agentic LLM System for Automating Warehouse Operations with Reasoning and Task Execution](http://arxiv.org/abs/2607.08960v1)
...
### [42] [AlphaZero in Sparsely Rewarded Games: Limits and Auxiliary Supervision](http://arxiv.org/abs/2607.08984v1)
...
### [43] [A Comprehensive Survey and Systematic Real-World Evaluation of Embodied Vision-and-Language Navigation](http://arxiv.org/abs/2607.09792v1)
...
### [44] [CLAP: Direct VLM-to-VLA Adaptation via Language-Action Grounding](http://arxiv.org/abs/2607.08974v1)
...
### [45] [ADORN: Adaptive Drift handling for Open RAN using Reinforcement Learning](http://arxiv.org/abs/2607.08443v1)
...
### [46] [APIVOT: Adaptive Planning with Interleaved Vision-Language Thoughts](http://arxiv.org/abs/2607.08024v1)
...
### [47] [WCog-VLA: A Dual-Level World-Cognitive Vision-Language-Action Model for End-to-End Autonomous Driving](http://arxiv.org/abs/2607.08375v1)
...
### [48] [Cognitive-structured Multimodal Agent for Multimodal Understanding, Generation, and Editing](http://arxiv.org/abs/2607.08497v1)
...
### [49] [MultiView-Bench: A Diagnostic Benchmark for World-Centric Multi-View Integration in VLMs](http://arxiv.org/abs/2607.08970v1)
...
### [50] [SMetric: Rethink LLM Scheduling for Serving Agents with Balanced Session-centric Scheduling](http://arxiv.org/abs/2607.08565v1)
...
### [51] [Tool-Making and Self-Evolving LLM Agents in Low-Latency Systems](http://arxiv.org/abs/2607.08010v1)
...
Selection reason: agentic tool-making 将重复 SOP 步骤编译为工具，显著降低延迟与错误率，可直接迁移到低延迟代码 agent 设计。
...
### [52] [Can We Trust LLM's Logic? Quantifying Uncertainty, Coherence, and Robustness via a Graph-Based Framework](http://arxiv.org/abs/2607.08017v1)
...
### [53] [What LLM Forecasters Know but Don't Say: Probing Internal Representations for Calibration and Faithfulness](http://arxiv.org/abs/2607.08046v1)
...
### [54] [When Synthetic Speech Is All You Have: Better Call GRPO](http://arxiv.org/abs/2607.08409v1)
...
### [55] [Two Axes of LLM Abstention: Answer Correctness and Question Answerability](http://arxiv.org/abs/2607.08456v1)
*Benedikt J. Wagner*
...
### [56] [WebSwarm: Recursive Multi-Agent Orchestration for Deep-and-Wide Web Search](http://arxiv.org/abs/2607.08662v1)
...
### [57] [Beware What You Autocomplete: Forensic Attribution of Backdoored Code Completions](http://arxiv.org/abs/2607.08011v1)
...
### [58] [Prismata: Confining Cross-Site Prompt Injection in Web Agents](http://arxiv.org/abs/2607.08147v1)
...
### [59] [Out of Sight: Compression-Aware Content Protection against Agentic Crawlers](http://arxiv.org/abs/2607.08180v1)
*Xuefei Wang*
...
### [60] [Multi-Agent Firewall Architecture for Privacy Protection of Sensitive Data in Interactions with Language Models](http://arxiv.org/abs/2607.08282v1)
...
### [61] [From Legacy Documentation to OSCAL: An MCP-Based Agent Pipeline for Threat-Informed Continuous Compliance in Critical Infrastructure](http://arxiv.org/abs/2607.08288v1)
...
### [62] [TRACE: A Two-Channel Robust Attribution Watermark via Complementary Embeddings for LLM-Agent Trajectories](http://arxiv.org/abs/2607.08400v1)
...
### [63] [SeedSmith: LLM-Driven Seed Synthesis for Directed Fuzzing](http://arxiv.org/abs/2607.08949v2)
...
Selection reason: LLM agentic 流水线为定向 fuzzing 合成种子，大幅加速崩溃发现，与代码测试和 agent 验证直接相关。
