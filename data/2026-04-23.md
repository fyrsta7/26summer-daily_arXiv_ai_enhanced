...
### [1] [ReCAPA: Hierarchical Predictive Correction to Mitigate Cascading Failures](http://arxiv.org/abs/2604.21232v2)
...
### [2] [Robustness Analysis of POMDP Policies to Observation Perturbations](http://arxiv.org/abs/2604.21256v1)
...
### [3] [Spatial Metaphors for LLM Memory: A Critical Analysis of the MemPalace Architecture](http://arxiv.org/abs/2604.21284v1)
...
### [4] [SemanticAgent: A Semantics-Aware Framework for Text-to-SQL Data Synthesis](http://arxiv.org/abs/2604.21414v1)
...
### [5] [FairQE: Multi-Agent Framework for Mitigating Gender Bias in Translation Quality Estimation](http://arxiv.org/abs/2604.21420v1)
...
### [6] [HiCrew: Hierarchical Reasoning for Long-Form Video Understanding via Question-Aware Multi-Agent Collaboration](http://arxiv.org/abs/2604.21444v1)
...
### [7] [AI-Gram: When Visual Agents Interact in a Social Network](http://arxiv.org/abs/2604.21446v2)
*Andrew Shin*
...
### [8] [Efficient Agent Evaluation via Diversity-Guided User Simulation](http://arxiv.org/abs/2604.21480v1)
...
### [9] [GeoMind: An Agentic Workflow for Lithology Classification with Reasoned Tool Invocation](http://arxiv.org/abs/2604.21501v2)
...
### [10] [When Correct Beliefs Collapse: Epistemic Resilience of LLMs under Clinical Pressure](http://arxiv.org/abs/2605.23932v1)
...
### [11] [CoFEE: Reasoning Control for LLM-Based Feature Discovery](http://arxiv.org/abs/2604.21584v1)
...
### [12] [Thinking with Reasoning Skills: Fewer Tokens, More Accuracy](http://arxiv.org/abs/2604.21764v2)
...
### [13] [Learning to Communicate: Toward End-to-End Optimization of Multi-Agent Language Systems](http://arxiv.org/abs/2604.21794v1)
...
### [14] [Tool Attention Is All You Need: Dynamic Tool Gating and Lazy Schema Loading for Eliminating the MCP/Tools Tax in Scalable Agentic Workflows](http://arxiv.org/abs/2604.21816v1)
...
### [15] [Alignment has a Fantasia Problem](http://arxiv.org/abs/2604.21827v1)
...
### [16] [Nemobot Games: Crafting Strategic AI Gaming Agents for Interactive Learning with Large Language Models](http://arxiv.org/abs/2604.21896v1)
...
### [17] [From Research Question to Scientific Workflow: Leveraging Agentic AI for Science Automation](http://arxiv.org/abs/2604.21910v1)
...
### [18] [Read the Paper, Write the Code: Agentic Reproduction of Social-Science Results](http://arxiv.org/abs/2604.21965v1)
...
### [19] [Sound Agentic Science Requires Adversarial Experiments](http://arxiv.org/abs/2604.22080v2)
...
### [20] [Memanto: Typed Semantic Memory with Information-Theoretic Retrieval for Long-Horizon Agents](http://arxiv.org/abs/2604.22085v1)
...
### [21] [Emergent Strategic Reasoning Risks in AI: A Taxonomy-Driven Evaluation Framework](http://arxiv.org/abs/2604.22119v2)
...
### [22] [Feedback Over Form: Why Execution Feedback Matters More Than Pipeline Topology in 1-3B Code Generation](http://arxiv.org/abs/2604.21950v1)
...
Selection reason: 在小模型代码生成中证明执行反馈比流水线拓扑更关键，并对自演化搜索、早停等有实证结论，直接指导 code agent 设计。
...
### [23] [Hidden Dependencies and Component Variants in SBOM-Based Software Composition Analysis](http://arxiv.org/abs/2604.21278v1)
...
Selection reason: 揭示 SBOM 中隐藏依赖与组件变体导致的漏洞报告不一致，为依赖安全分析/供应链 agent 提供实证依据。
...
### [24] [Conjecture and Inquiry: Quantifying Software Performance Requirements via Interactive Retrieval-Augmented Preference Elicitation](http://arxiv.org/abs/2604.21380v2)
...
Selection reason: 通过交互式检索增强偏好学习量化性能需求，可迁移至agent在需求理解与交互澄清中的应用。
...
### [25] [Assessing the Impact of Requirement Ambiguity on LLM-based Function-Level Code Generation](http://arxiv.org/abs/2604.21505v1)
...
Selection reason: 首个面向需求歧义的代码生成benchmark，系统评估歧义对LLM代码生成的影响，具有评测方法价值。
...
### [26] [SpecSyn: LLM-based Synthesis and Refinement of Formal Specifications for Real-world Program Verification](http://arxiv.org/abs/2604.21570v1)
...
Selection reason: 基于LLM的正式规格生成与精化，用于程序验证，包含变异判别机制，可迁移到代码验证agent。
...
### [27] [A Metamorphic Testing Approach to Diagnosing Memorization in LLM-Based Program Repair](http://arxiv.org/abs/2604.21579v1)
...
Selection reason: 结合蜕变测试与NLL诊断LLM程序修复中的记忆泄漏，提供了评测可靠性的方法。
...
### [28] [You Don't Need Public Tests to Generate Correct Code](http://arxiv.org/abs/2604.21598v2)
...
Selection reason: 提出无需公共测试用例的自生成输入与模拟执行框架，直接改进代码生成agent的自校正能力。
...
### [29] [Can Large Language Models Assist the Comprehension of ROS2 Software Architectures?](http://arxiv.org/abs/2604.21699v1)
...
Selection reason: 评估LLM理解ROS2软件架构的能力，为软件架构理解agent提供实证参考。
...
### [30] [Agentic AI-assisted coding offers a unique opportunity to instill epistemic grounding during software development](http://arxiv.org/abs/2604.21744v1)
...
Selection reason: 提出领域约束的epistemic grounding文档来约束agentic coding，增强代码agent的可靠性与领域正确性。
...
### [31] [Less Is More: Measuring How LLM Involvement affects Chatbot Accuracy in Static Analysis](http://arxiv.org/abs/2604.21746v1)
*Krishna Narasimhan*
...
Selection reason: 比较直接生成、结构化中间表示和agentic工具调用的静态分析查询生成，发现结构化约束效果更优，可迁移到代码分析agent设计。
...
### [32] [Generalizing Test Cases for Comprehensive Test Scenario Coverage](http://arxiv.org/abs/2604.21771v2)
...
Selection reason: 提出从初始测试泛化测试场景的框架，提升场景覆盖，对自动化测试生成agent有直接贡献。
...
### [33] [FlyCatcher: Neural Inference of Runtime Checkers from Tests](http://arxiv.org/abs/2604.22028v1)
...
Selection reason: 结合LLM、静态分析与动态验证从测试推断运行时检查器，方法可迁移到代码agent的验证与错误检测。
...
### [34] [Call-Chain-Aware LLM-Based Test Generation for Java Projects](http://arxiv.org/abs/2604.22046v1)
...
Selection reason: 调用链感知的LLM测试生成方法，显式建模依赖上下文，对代码agent的测试生成有直接迁移价值。
...
### [35] [Ethics Testing: Proactive Identification of Generative AI System Harms](http://arxiv.org/abs/2604.22089v1)
...
Selection reason: 提出伦理测试概念以识别生成式AI系统危害，对GAI代码生成风险评估有参考价值。
...
### [36] [EngramaBench: Evaluating Long-Term Conversational Memory with Structured Graph Retrieval](http://arxiv.org/abs/2604.21229v1)
*Julian Acuna*
...
### [37] [Planning Beyond Text: Graph-based Reasoning for Complex Narrative Generation](http://arxiv.org/abs/2604.21253v1)
...
### [38] [VLAA-GUI: Knowing When to Stop, Recover, and Search, A Modular Framework for GUI Automation](http://arxiv.org/abs/2604.21375v2)
...
Selection reason: 模块化GUI自动化框架包含停止、恢复、搜索机制，可迁移到代码agent的长程执行与容错设计。
...
### [39] [Process Supervision via Verbal Critique Improves Reasoning in Large Language Models](http://arxiv.org/abs/2604.21611v1)
*Hao-Yuan Chen*
...
### [40] [From If-Statements to ML Pipelines: Revisiting Bias in Code-Generation](http://arxiv.org/abs/2604.21716v1)
...
Selection reason: 指出条件语句评测低估代码生成偏差，提出基于ML pipeline的偏差评测，对代码生成评估有参考价值。
...
### [41] [AEL: Agent Evolving Learning for Open-Ended Environments](http://arxiv.org/abs/2604.21725v1)
...
### [42] [StructMem: Structured Memory for Long-Horizon Behavior in LLMs](http://arxiv.org/abs/2604.21748v1)
...
### [43] [How Consistent Are LLM Agents? Measuring Behavioral Reproducibility in Multi-Step Tool-Calling Pipelines](http://arxiv.org/abs/2605.28840v1)
*Abel Yagubyan*
...
Selection reason: 系统测量多步工具调用agent的行为一致性，提出可靠性评估维度，直接适用于代码agent的鲁棒性研究。
...
### [44] [MathDuels: Evaluating LLMs as Problem Posers and Solvers](http://arxiv.org/abs/2604.21916v2)
...
Selection reason: 提出自博弈双角色LLM评测机制，可迁移到代码agent的能力评估与动态benchmark设计。
...
### [45] [The Coin Flip Judge? Reliability and Bias in LLM-as-a-Judge Evaluation](http://arxiv.org/abs/2606.13685v1)
*Abel Yagubyan*
...
### [46] [When Prompts Override Vision: Prompt-Induced Hallucinations in LVLMs](http://arxiv.org/abs/2604.21911v1)
...
### [47] [Replay-buffer engineering for noise-robust quantum circuit optimization](http://arxiv.org/abs/2604.21863v1)
...
### [48] [Strategic Heterogeneous Multi-Agent Architecture for Cost-Effective Code Vulnerability Detection](http://arxiv.org/abs/2604.21282v1)
...
Selection reason: 提出异构多agent架构用于漏洞检测，结合云LLM专家与本地验证器，可迁移到代码agent的协作与验证机制。
...
### [49] [TraceScope: Interactive URL Triage via Decoupled Checklist Adjudication](http://arxiv.org/abs/2604.21840v1)
...
### [50] [Transient Turn Injection: Exposing Stateless Multi-Turn Vulnerabilities in Large Language Models](http://arxiv.org/abs/2604.21860v1)
...
### [51] [CrossCommitVuln-Bench: A Dataset of Multi-Commit Python Vulnerabilities Invisible to Per-Commit Static Analysis](http://arxiv.org/abs/2604.21917v1)
*Arunabh Majumdar*
...
Selection reason: 提出多提交漏洞数据集，揭示逐个提交静态分析的盲区，可用于构建代码安全分析与agent验证基准。
...
### [52] [AutoRISE: Agent-Driven Strategy Evolution for Red-Teaming Large Language Models](http://arxiv.org/abs/2604.22871v1)
...
### [53] [Measure Twice, Click Once: Co-evolving Proposer and Visual Critic via Reinforcement Learning for GUI Grounding](http://arxiv.org/abs/2604.21268v1)
...
### [54] [Understanding and Mitigating Spurious Signal Amplification in Test-Time Reinforcement Learning for Math Reasoning](http://arxiv.org/abs/2604.21327v1)
...
### [55] [mcdok at SemEval-2026 Task 13: Finetuning LLMs for Detection of Machine-Generated Code](http://arxiv.org/abs/2604.21365v1)
...
Selection reason: 针对机器生成代码检测的微调方法，涉及代码理解和归因，对代码agent生成内容识别有参考价值。
...
### [56] [PrismaDV: Automated Task-Aware Data Unit Test Generation](http://arxiv.org/abs/2604.21765v1)
...
Selection reason: 复合AI系统自动生成任务感知的数据单元测试，结合提示优化，对agent化测试生成有借鉴意义。
...
### [57] [Removing Sandbagging in LLMs by Training with Weak Supervision](http://arxiv.org/abs/2604.22082v2)
...
### [58] [CorridorVLA: Explicit Spatial Constraints for Generative Action Heads via Sparse Anchors](http://arxiv.org/abs/2604.21241v2)
...
### [59] [IntrAgent: An LLM Agent for Content-Grounded Information Retrieval through Literature Review](http://arxiv.org/abs/2604.22861v1)
