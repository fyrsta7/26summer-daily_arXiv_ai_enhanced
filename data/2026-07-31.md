...
### [1] [Even More Deception: Objective Misalignment in Mixed-Motive LLM Multi-Agent Systems](https://arxiv.org/abs/2607.26120)
...
### [2] [ClinLens: Towards Long-Horizon Coding Agents for Longitudinal Multimodal Clinical Data Science](https://arxiv.org/abs/2607.26155)
...
### [3] [When benchmark inferences do not compose: Projectibility in AI evaluation](https://arxiv.org/abs/2607.26159)
*Brett Reynolds*
...
Selection reason: 提出评测分数应带形式性、作用域与有效期元数据，并采用最弱链聚合，适用于代码agent基准结果的可信度评估。
...
Selection reason: 提出可审计、可解释的代码生成追踪机制，对代码 agent 的调试、验证和可信度有迁移价值。
...
### [8] [Exploring Structures in Physics Problems: Can AI Agents Discover Statistical Mechanical Mappings?](https://arxiv.org/abs/2607.26367)
...
### [10] [CG-World: A Large-Scale World-State Dataset and Protocol for World Models](https://arxiv.org/abs/2607.26452)
...
### [11] [EvoPINN: Agentic Discovery of Executable Algorithms for Physics-Informed Neural Networks](https://arxiv.org/abs/2607.26490)
...
### [12] [Evidence-Ledger Adjudication for Claim-Evidence Traceability](https://arxiv.org/abs/2607.26512)
...
### [13] [Eco3S: Complex Socio-Economic System Simulation via Agent-Based Models](https://arxiv.org/abs/2607.26588)
...
### [14] [Fewer Clarifications, Better Code: Benchmarking Cross-Session Personalized Ambiguity Adaptation in Coding Assistants](https://arxiv.org/abs/2607.26611)
...
### [18] [UrbanDS: A Graph-Guided LLM Multi-Agent System for Data-Intensive Urban Tasks](https://arxiv.org/abs/2607.26724)
...
### [19] [Do Latent Channels Actually Communicate? A Causal Audit of Latent Multi-Agent LLM](https://arxiv.org/abs/2607.26773)
...
### [20] [What Does It Take to Detect an AI Agent? Minimal Feature Sets for Behavioral Detection under Browser Automation](https://arxiv.org/abs/2607.26935)
...
### [21] [Belief-Guided Decision Making with Uncertainty Gating in the Game of Go](https://arxiv.org/abs/2607.26946)
...
### [22] [Setoka: A Benchmark for Hierarchical User Understanding in Personalized Agents over Heterogeneous Data](https://arxiv.org/abs/2607.27056)
...
### [23] [AgentMap: Joint Equivalence and Subsumption Discovery for Ontology Matching](https://arxiv.org/abs/2607.27130)
...
### [24] [OmegaUse-OfficeVal: Benchmarking LLM Agents on Long-Horizon Office-Suite Tasks with Economic Grounding](https://arxiv.org/abs/2607.27155)
...
### [25] [Partner Capability Estimation for Task-Agnostic Adaptation in Ad-Hoc Teamwork](https://arxiv.org/abs/2607.27177)
...
### [26] [Can AI agents conduct open-ended AI research? Early evidence from two case studies](https://arxiv.org/abs/2607.27191)
...
### [27] [Cross-Model Cross-Language AI Coding Agent Performance: Accuracy and Speed of Parallel CLRS Algorithms](https://arxiv.org/abs/2607.26083)
...
Selection reason: 跨模型跨语言评测coding agent生成并行算法的正确性与speedup，强调运行时性能作为主要指标，直接支撑SemOpt相关评估。
...
### [28] [Validating ETCS Data with the B Mathematical Language: An Industrial Pipeline and a Blueprint for LLM Integration](https://arxiv.org/abs/2607.26111)
...
Selection reason: LLM生成+形式化裁决+人工确认的安全攸关数据验证流水线，其验证闭环模式可迁移至代码agent的安全关键场景。
...
### [29] [Try Again, Don't Look Back: Blind Resampling Outperforms Self-Repair in Small Code Models](https://arxiv.org/abs/2607.26117)
*Yuvraj Verma*
...
Selection reason: 对照实验揭示小代码模型自修复的锚定效应，盲重采样在同等预算下更优，直接影响agent重试与反馈策略设计。
...
### [30] [Multi-Agent Debate Strategies: Survey, Taxonomy, and Challenges](https://arxiv.org/abs/2607.26212)
...
Selection reason: 系统综述多agent辩论策略并提出三维分类，为代码agent多智能体协作、交互与评测提供可迁移框架。
...
### [31] [Model-Driven Requirements Configuration with Three-Valued Uncertainty Scoring](https://arxiv.org/abs/2607.26220)
*Ahmed Ibrahim*
...
Selection reason: 提出神经符号多agent架构，用确定性符号校验与三值不确定性评分约束LLM生成，验证机制可迁移到代码生成的结构正确性保障。
...
### [32] [Do Code Language Models Use Tests? A Behavioral and Representational Study of Test-Driven Code Generation](https://arxiv.org/abs/2607.26244)
...
Selection reason: 实证研究测试对代码模型生成的作用，发现表征偏移与正确性提升脱节，对测试驱动代码agent评估与设计有直接参考价值。
...
### [33] [SARC-DQ: Runtime Data-Quality Gating for Agentic AI: Silent Evidence Defects, the Incompetence Shield, and Downstream-Only Remediation](https://arxiv.org/abs/2607.26313)
*Gaston Besanson*
...
Selection reason: 提出运行时数据质量门控机制，解决agent证据缺陷导致的错误动作，可迁移到代码agent的工具结果校验与数据新鲜度检查。
...
### [34] [Impossible to hide secret ...: Uncovering Security and Privacy Issues in LLM-native IDEs](https://arxiv.org/abs/2607.26390)
...
Selection reason: 系统梳理LLM原生IDE的安全隐私问题与开发者不信任来源，为代码agent安全设计与沙箱机制提供实证依据。
...
### [35] [ExplainBench: Evaluating Code Explanations from Agents](https://arxiv.org/abs/2607.26451)
...
Selection reason: 首个自动评估代码agent解释可信度的基准，揭示解释质量与修复能力解耦，并验证审计agent可提升解释可靠性。
...
### [36] [MultiFixer: A Coordinator-Proposer Based Multi-Agent Framework For Fixing Multi-Hunk Bugs](https://arxiv.org/abs/2607.26591)
...
Selection reason: 面向多 hunk 缺陷修复的多智能体框架，直接解决 coding agent 的协调与长程修复问题。
...
### [37] [Tangling Pull Requests: Curating a Commit Untangling Dataset from Merged PRs](https://arxiv.org/abs/2607.26730)
...
Selection reason: 提供了从 PR 构建 commit 拆解数据集的通用方法，可作为代码理解和 agent 训练的数据支撑。
...
### [38] [CodeSpec: Dual Executable Specifications for Agentic Long-Horizon Feature Development](https://arxiv.org/abs/2607.26777)
...
Selection reason: 为长程代码 agent 提供可执行双规格方法，提升功能开发的设计-实现一致性，直接相关。
...
### [39] [MRCoder: An Efficient Context Selecting Approach for Repository-Level Code Generation](https://arxiv.org/abs/2607.26805)
...
Selection reason: 针对仓库级代码生成的高效上下文选择方法，大幅减少 token 消耗并提升生成质量。
...
### [40] [A First Look at Coding Agents' Compliance with AI Contribution Rules in Open-Source Communities](https://arxiv.org/abs/2607.26819)
...
Selection reason: 实证研究代码 agent 对开源贡献规则的遵守情况，涉及验证、披露、拒绝等可迁移机制。
...
### [41] [When Knowledge Changes: Metamorphic Testing of RAG Systems with Mutations](https://arxiv.org/abs/2607.26843)
...
Selection reason: 提出 RAG 系统在语料演化下的蜕变测试框架，可迁移到代码 agent 中 RAG 的鲁棒性验证。
...
### [42] [VITAL-RAG: Invariance Race for Context Allocation in Coding Agents](https://arxiv.org/abs/2607.26937)
...
Selection reason: 针对编码 agent 的 RAG 上下文分配方法，显著提升检索质量并节省 token，直接相关。
...
### [43] [How Developers Experience Debugging Unfamiliar Codebases with Code Tours Generated and Evaluated by Local LLMs](https://arxiv.org/abs/2607.26987)
...
Selection reason: 研究 LLM 生成代码导览对调试体验与信任校准的影响，对 agent 解释与交互设计有参考价值。
...
### [44] [MindForge: Teaching Small Language Models Whole-Life-Cycle Software Engineering via Source-Free Program Synthesis](https://arxiv.org/abs/2607.27146)
...
Selection reason: 构建全生命周期软件工程训练环境与合成轨迹，显著提升小模型在多种代码任务上的能力。
...
### [45] [SpecFirst: Behavioral Specification Elicitation as a First-Class Step in Agent-Based Program Synthesis from Scratch](https://arxiv.org/abs/2607.27167)
...
Selection reason: 将行为规格提取作为代码合成前的显式阶段，提升从零程序构建的 agent 成功率。
