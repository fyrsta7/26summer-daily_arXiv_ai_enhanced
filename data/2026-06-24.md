...
### [1] [iFLYTEK-Embodied-Omni Technical Report](http://arxiv.org/abs/2607.02542v1)
...
### [2] [Agentic Knowledge Tracing: A Multi-Agent LLM Architecture for Stealth Assessment of Financial Literacy in Serious Games](http://arxiv.org/abs/2606.25358v1)
...
### [3] [Offline Multi-agent Continual Cooperation via Skill Partition and Reuse](http://arxiv.org/abs/2606.25389v1)
...
### [4] [BrainAgent: A Large Language Model-Driven Multi-Agent Framework for Autonomous Brain Signal Understanding](http://arxiv.org/abs/2606.25400v1)
...
### [5] [Agentic evolution of physically constrained foundation models](http://arxiv.org/abs/2606.25532v1)
...
### [6] [AlgoEvolve: LLM-driven Meta-evolution of Algorithmic Trading Programs](http://arxiv.org/abs/2606.26173v1)
...
### [7] [GUI agent: Guided Exploration of User-Sensitive Screens](http://arxiv.org/abs/2606.25705v1)
...
### [8] [Closed-Loop Control with Rule-Aligned Small Language Models and Multi-Agent Self-Correction](http://arxiv.org/abs/2607.09713v1)
...
### [9] [AI Snitches Get Glitches: Towards Evading Agentic Surveillance](http://arxiv.org/abs/2606.25836v2)
...
### [10] [Feedback-Coupled Memory Systems in Continuous Time](http://arxiv.org/abs/2607.09714v1)
*Stefano Grassi*
...
### [11] [Agentic System as Compressor: Quantifying System Intelligence in Bits](http://arxiv.org/abs/2606.25960v1)
...
### [12] [WinDOM: Self-Family Distillation for Small-Model GUI Grounding](http://arxiv.org/abs/2606.25964v1)
...
### [13] [Autodata: An agentic data scientist to create high quality synthetic data](http://arxiv.org/abs/2606.25996v3)
...
### [14] [The Unfireable Safety Kernel: Execution-Time AI Alignment for AI Agents and Other Escapable AI Systems](http://arxiv.org/abs/2606.26057v1)
...
### [15] [Governing Actions, Not Agents: Institutional Attestation as a Governance Model for Autonomous AI Systems](http://arxiv.org/abs/2606.26298v1)
...
### [16] [The Verification Horizon: No Silver Bullet for Coding Agent Rewards](http://arxiv.org/abs/2606.26300v2)
...
### [17] [How Do Tool-Augmented LLM Agents Perform on Real-World Energy Analytics Tasks?](http://arxiv.org/abs/2606.26346v1)
...
### [18] [OpenFinGym: A Verifiable Multi-Task Gym Environment for Evaluating Quant Agents](http://arxiv.org/abs/2606.26350v1)
...
### [19] [Instruction Bleed: Cross-Module Interference in Prompt-Composed Agentic Systems](http://arxiv.org/abs/2606.26356v1)
...
### [20] [How Do Developers Maintain and Evolve Their Agents' Instructions? An Empirical Study](http://arxiv.org/abs/2606.25257v1)
...
Selection reason: 对编码 Agent 指令文件（ACF）的演化与维护进行实证研究，直接关系 Agent 指令的工程化设计与治理。
...
### [21] [Semantic Code Clone Detection: Are We There Yet?](http://arxiv.org/abs/2606.25272v1)
...
Selection reason: 提出克隆算子框架与分布偏移评测，检验语义克隆检测的真实泛化性，对代码分析与评测有参考价值。
...
### [22] [LibEvoBench: Probing Temporal Knowledge Stratification in Code Generation Models](http://arxiv.org/abs/2606.25402v1)
...
Selection reason: 新基准 LibEvoBench 评估代码生成模型对多版本 API 的时序知识，为代码 Agent 评测增加新维度。
...
### [23] [Project-wise Comparison of Software Birthmarks Using Weighted Partial Similarity](http://arxiv.org/abs/2606.25418v2)
*Nikolay Fedorov,Akito Monden,Hiroki Inayoshi,Haruaki Tamada,Masateru Tsunoda*

Main category: cs.SE

Comments: 19 pages, 7 figures. This work has been submitted to the IEEE for possible publication

Selection reason: 项目级软件胎记比较与部分相似度方法，对代码复用/抄袭检测有参考价值，但与 Agent 关联较弱。
...
### [24] [Unlocking Model Potentials Through Adaptive Multi-Agent Scaffolding for Efficient Issue Resolution](http://arxiv.org/abs/2606.25514v1)
...
Selection reason: 提出去中心化多 Agent 架构 icat-agent，在 SWE-bench 上显著提升 issue 解决率，是直接可迁移的 Coding Agent 方法。
...
### [25] [Evaluating LLMs on Real-World Software Performance Optimization](http://arxiv.org/abs/2606.25530v1)
...
Selection reason: SWE-Pro 是面向真实仓库性能优化的 benchmark，覆盖时间/内存权衡与噪声感知测量，与 SemOpt 直接相关。
...
### [26] [On the Viability of Requirements Generation From Code: An Experience Report](http://arxiv.org/abs/2606.25550v1)
...
Selection reason: 经验报告 LLM/RAG Agent 从代码生成需求时的失败模式与人工监督必要性，对 Agent 流程验证有参考价值。
...
### [27] [IntentTester: Intent-Driven Multi-agent Framework for Cross-Library Test Migration](http://arxiv.org/abs/2606.25588v1)
...
Selection reason: IntentTester 用多 Agent 与测试描述语言实现跨库/跨语言测试迁移，是测试生成 Agent 的可迁移方法。
...
### [28] [CodeChat-Eval: Evaluating Large Language Models in Multi-Turn Code Refinement Dialogues](http://arxiv.org/abs/2606.25747v2)
...
Selection reason: CodeChat-Eval 评估多轮代码精修对话中的功能保持，弥补代码生成评测的多轮场景空缺。
...
### [29] [Reinforcement Learning for Software Vulnerability Analysis: A Systematic Review with Emphasis on C/C++ Source Code and Static Analysis](http://arxiv.org/abs/2606.28403v1)
...
Selection reason: 系统综述强化学习在 C/C++ 漏洞分析与静态分析中的应用，为漏洞检测 Agent 的设计提供视角。
...
### [30] [Recall Before Rerank: Benchmarking Deep Learning Models for Large-Scale Code-to-Code Retrieval](http://arxiv.org/abs/2606.27401v1)
...
Selection reason: 大规模 code-to-code 检索召回基准与查询改写方案，对 Agent 的代码检索和上下文获取有参考价值。
...
### [31] [Automated Detection of Configuration-Specific Security Vulnerabilities via Patch Analysis](http://arxiv.org/abs/2606.25863v1)
...
Selection reason: PatchLens 通过补丁分析推导漏洞影响条件，可用于配置感知的漏洞评估与测试选择。
...
### [32] [Helpful or Harmful? Evaluating LLM-Assisted Vulnerability Patching via a Human Study](http://arxiv.org/abs/2606.25973v1)
...
Selection reason: 通过人类研究评估LLM辅助漏洞修复，Ghost Tests验证补丁完整性，对代码修复agent评估有直接参考。
...
### [33] [CLOSER-VLN: Closed-Loop Self-Verified Retrieval-Augmented Reasoning for Aerial Vision-Language Navigation](http://arxiv.org/abs/2606.28397v1)
...
### [34] [AI-Assisted Computational Reproducibility on the FABRIC Testbed](http://arxiv.org/abs/2606.25879v1)
...
### [35] [Explainable Control Framework (XCF) based on Fuzzy Model-Agnostic Explanation and LLM Agent-Supported Interface](http://arxiv.org/abs/2606.25941v1)
...
### [36] [AI Coaching for Accelerating Human Skill Development with Reinforcement Learning](http://arxiv.org/abs/2606.25337v1)
...
### [37] [Reliability-Asymmetric Spacecraft Autonomy: Co-Designing a Capable Learned GNC Stack with a Verified, Adaptation-Aware Runtime Shield](http://arxiv.org/abs/2606.25366v1)
*Alireza Shojaei*
...
### [38] [LiMoDE: Rethinking Lifelong Robot Manipulation from a Mixture-of-Dynamic-Experts Perspective](http://arxiv.org/abs/2606.26183v1)
*Zhihao Gu,Lin Wang*
...
### [39] [SidConArena: An Environment Evaluating Agents in Open-Ended,Positive-Sum Bargaining Game](http://arxiv.org/abs/2606.27397v1)
...
### [40] [Multi-Agent Goal Recognition with Team- and Goal-Conditioned Reinforcement Learning and Factorized Branch-and-Bound](http://arxiv.org/abs/2606.25978v1)
...
### [41] [UC-Search: Risk-Aware Test-Time Search for Delayed Constrained Time-Series Control](http://arxiv.org/abs/2606.25274v2)
*Xibai Wang*
...
### [42] [FactorLibrary: From Polynomials to Circuits via Recursive Subgoals](http://arxiv.org/abs/2606.25394v1)
...
### [43] [Uncertainty Quantification for Computer-Use Agents: A Benchmark across Vision-Language Models and GUI Grounding Datasets](http://arxiv.org/abs/2606.25760v1)
...
### [44] [Semantic Consistency Policy Optimization for Reinforcement Learning of LLM Agents](http://arxiv.org/abs/2606.25852v1)
...
### [45] [Model Forensics: Investigating Whether Concerning Behavior Reflects Misalignment](http://arxiv.org/abs/2606.26071v2)
...
### [46] [Neglected Free Lunch from Post-training: Progress Advantage for LLM Agents](http://arxiv.org/abs/2606.26080v1)
...
### [47] [The Red Queen Gödel Machine: Co-Evolving Agents and Their Evaluators](http://arxiv.org/abs/2606.26294v2)
...
### [48] [EVOM: Agentic Meta-Evolution of Actor-Critic Architectures for Reinforcement Learning](http://arxiv.org/abs/2606.26327v1)
...
### [49] [SOLAR: AI-Powered Speed-of-Light Performance Analysis](http://arxiv.org/abs/2606.26383v1)
...
### [50] [Decoupling Reconnaissance and Exploitation: Measuring the Capability Boundaries of LLM-Based Web Penetration Testing](http://arxiv.org/abs/2606.25332v1)
...
### [51] [Representation Matters: An Empirical Study of Program Representations for LLM Vulnerability Reasoning](http://arxiv.org/abs/2606.25356v1)
...
Selection reason: 系统比较 AST/CFG/PDG 等程序表示对 LLM 漏洞推理的影响，可迁移到代码 Agent 的上下文表示设计。
...
### [52] [Probabilistic Agents in Deterministic Audits: Evaluating Multi-Agent Systems for Automated Audits Based on the German IT-Grundschutz](http://arxiv.org/abs/2606.25622v1)
...
### [53] [Can Trustless Agents Be Trusted? An Empirical Study of the ERC-8004 Decentralized AI Agent Ecosystem](http://arxiv.org/abs/2606.26028v2)
...
### [54] [CyberChainBench: Can AI Agents Secure Smart Contracts Against Real-World On-Chain Vulnerabilities?](http://arxiv.org/abs/2606.26216v1)
...
### [55] [Closing the Loop to Discover Psychological Theories with an Automated Cognitive Scientist](http://arxiv.org/abs/2606.26448v1)
...
### [57] [Reclaim Evaluation: A Lossy Memory Is Worse Than an Empty One](http://arxiv.org/abs/2606.25449v3)
*Alex Kwon*

Main category: cs.CL

Comments: 33 pages, 4 figures, 21 tables. v3: adds a recoverability principle unifying the results, a capability inverted-U (named result + figure), a write-time recompute certificate, and an agentic-task (Battleship) demonstration; strengthens the prevalence audit (judge-free floor + human inter-rater agreement); core claims unchanged
...
### [59] [Staying In Character: Perspective-Bounded Memory For Book-Based Role-Playing Agents](http://arxiv.org/abs/2606.25632v1)
...
### [60] [Is GraphRAG Needed? From Basic RAG to Graph-/Agentic Solutions with Context Optimization](http://arxiv.org/abs/2606.25656v1)
...
### [61] [Beyond Function Calling: Benchmarking Tool-Using Agents under Tool-Environment Unreliability](http://arxiv.org/abs/2606.25819v2)
...
Selection reason: ToolBench-X 在工具不可靠场景下评测 Tool-Using Agent，对 Agent 鲁棒性与故障恢复有直接迁移价值。
...
### [62] [Weave of Formal Thought](http://arxiv.org/abs/2606.25987v1)
*Alexandre Bouayad*
