...
### [1] [Not all uncertainty is alike: volatility, stochasticity, and exploration](http://arxiv.org/abs/2605.19215v1)
*Payam Piray*
...
### [2] [SimGym: A Framework for A/B Test Simulation in E-Commerce with Traffic-Grounded VLM Agents](http://arxiv.org/abs/2605.19219v1)
...
### [3] [Causal Evidence for Attention Head Imbalance in Modality Conflict Hallucination](http://arxiv.org/abs/2605.19250v1)
...
### [4] [AQuaUI: Visual Token Reduction for GUI Agents with Adaptive Quadtrees](http://arxiv.org/abs/2605.19260v1)
...
### [5] [MOCHA: Multi-Objective Chebyshev Annealing for Agent Skill Optimization](http://arxiv.org/abs/2605.19330v1)
...
Selection reason: 多目标Chebyshev退火优化agent skill，可迁移到coding agent的技能调优与Pareto探索。
...
### [6] [Agentic Trading: When LLM Agents Meet Financial Markets](http://arxiv.org/abs/2605.19337v1)
...
### [7] [Generative Recursive Reasoning](http://arxiv.org/abs/2605.19376v2)
...
### [8] [PRISM: A Benchmark for Programmatic Spatial-Temporal Reasoning](http://arxiv.org/abs/2605.19382v1)
...
### [9] [Conflict-Resilient Multi-Agent Reasoning via Signed Graph Modeling](http://arxiv.org/abs/2605.19418v1)
...
### [10] [Reason--Imagine--Act: Closed-Loop LLM Decision Making with World Models for Autonomous Driving](http://arxiv.org/abs/2605.24004v1)
...
### [11] [What and When to Distill: Selective Hindsight Distillation for Multi-Turn Agents](http://arxiv.org/abs/2605.19447v1)
...
### [12] [Generative Auto-Bidding with Unified Modeling and Exploration](http://arxiv.org/abs/2605.19457v1)
...
### [13] [Beyond Mode Collapse: Distribution Matching for Diverse Reasoning](http://arxiv.org/abs/2605.19461v1)
...
### [14] [LC-ERD: Mining Latent Logic for Self-Evolving Reasoning via Consistency-Regulated Reward Decomposition](http://arxiv.org/abs/2605.24005v2)
...
### [15] [Beyond Fixed Budgets: Characterizing the Inelasticity and Limitations of Tree-of-Thought Reasoning Strategies](http://arxiv.org/abs/2606.20599v1)
...
### [16] [Library Drift: Diagnosing and Fixing a Silent Failure Mode in Self-Evolving LLM Skill Libraries](http://arxiv.org/abs/2605.19576v2)
*Xing Zhang,Yanwei Cui,Guanghui Wang,Ziyuan Li,Wei Qiu,Bing Zhu,Peiyang He*

Main category: cs.AI

Comments: Accepted to the ICML 2026 Workshop on Failure Modes in Agentic AI (FAGEN@ICML 2026), Seoul, South Korea

Selection reason: 诊断并修复自进化skill库的漂移问题，给出治理方案，直接适用于自进化coding agent。
...
### [17] [SceneCode: Executable World Programs for Editable Indoor Scenes with Articulated Objects](http://arxiv.org/abs/2605.19587v1)
...
### [18] [Formal Skill: Programmable Runtime Skills for Efficient and Accurate LLM Agents](http://arxiv.org/abs/2605.19604v1)
...
### [19] [Pseudocode-Guided Structured Reasoning for Automating Reliable Inference in Vision-Language Models](http://arxiv.org/abs/2605.19663v1)
...
### [20] [EngiAI: A Multi-Agent Framework and Benchmark Suite for LLM-Driven Engineering Design](http://arxiv.org/abs/2605.19743v2)
...
### [21] [Memory-Augmented Reinforcement Learning Agent for CAD Generation](http://arxiv.org/abs/2605.19748v1)
...
### [22] [OpenComputer: Verifiable Software Worlds for Computer-Use Agents](http://arxiv.org/abs/2605.19769v1)
...
Selection reason: 面向computer-use agent的可验证软件世界框架，含状态验证器与部分奖励机制，可迁移到agent评测。
...
### [23] [Distribution-Free Uncertainty Quantification for Continuous AI Agent Evaluation](http://arxiv.org/abs/2605.19779v1)
...
### [24] [Prior Knowledge or Search? A Study of LLM Agents in Hardware-Aware Code Optimization](http://arxiv.org/abs/2605.19782v1)
...
Selection reason: 通过受控实验分析LLM agent在硬件感知代码优化中依赖先验而非反馈，直接关系SemOpt核心。
...
### [25] [From Prompts to Pavement Through Time: Temporal Grounding in Agentic Scene-to-Plan Reasoning](http://arxiv.org/abs/2605.19824v1)
...
### [26] [Streamlined Constraint Reasoning via CNN Pattern Recognition on Enumerated Solutions](http://arxiv.org/abs/2605.19895v1)
*Patrick Spracklen*
...
### [27] [PEEK: Context Map as an Orientation Cache for Long-Context LLM Agents](http://arxiv.org/abs/2605.19932v1)
...
### [28] [Robotics-Inspired Guardrails for Foundation Models in Socially Sensitive Domains](http://arxiv.org/abs/2605.19940v1)
...
### [29] [Probabilistic Tiny Recursive Model](http://arxiv.org/abs/2605.19943v1)
...
### [31] [When Skills Don't Help: A Negative Result on Procedural Knowledge for Tool-Grounded Agents in Offensive Cybersecurity](http://arxiv.org/abs/2605.20023v2)
...
### [32] [AutoResearchClaw: Self-Reinforcing Autonomous Research with Human-AI Collaboration](http://arxiv.org/abs/2605.20025v2)
...
### [33] [Probing Embodied LLMs: When Higher Observation Fidelity Hurts Problem Solving](http://arxiv.org/abs/2605.20072v1)
...
### [34] [Neurosymbolic Learning for Inference-Time Argumentation](http://arxiv.org/abs/2605.20098v2)
...
### [35] [Using Aristotle API for AI-Assisted Theorem Proving in Lean 4: A Formalisation Case Study of the Grasshopper Problem](http://arxiv.org/abs/2605.20120v1)
...
### [36] [Not Every Rubric Teaches Equally: Policy-Aware Rubric Rewards for RLVR](http://arxiv.org/abs/2605.20164v1)
...
### [37] [A Methodology for Selecting and Composing Runtime Architecture Patterns for Production LLM Agents](http://arxiv.org/abs/2605.20173v1)
*Vasundra Srinivasan*
...
Selection reason: 提出生产级LLM agent运行时架构模式选择方法，聚焦随机-确定边界与可靠性，可迁移至coding agent工作流。
...
### [38] [OSCToM: RL-Guided Adversarial Generation for High-Order Theory of Mind](http://arxiv.org/abs/2605.20423v1)
...
### [39] [AgentCo-op: Retrieval-Based Synthesis of Interoperable Multi-Agent Workflows](http://arxiv.org/abs/2605.20425v1)
...
### [40] [BOHM: Zero-Cost Hierarchical Attribution for Compound AI Systems](http://arxiv.org/abs/2605.22866v1)
*Joss Armstrong*
...
### [41] [Open-World Evaluations for Measuring Frontier AI Capabilities](http://arxiv.org/abs/2605.20520v1)
...
### [42] [AgentAtlas: Beyond Outcome Leaderboards for LLM Agents](http://arxiv.org/abs/2605.20530v2)
...
Selection reason: 提出agent评估的诊断词汇表和轨迹失败分类，可迁移至coding agent的评测与失败归因
...
### [43] [MuMuTestUp: Mutation-based Multi-Agent Test Case Update](http://arxiv.org/abs/2605.19265v1)
...
Selection reason: 变异引导的多agent测试更新框架，针对断言充分性与语义检索，直接改进测试agent。
...
### [44] [On-the-Fly Input Adaptation for Reliable Code Intelligence](http://arxiv.org/abs/2605.19365v1)
...
Selection reason: 通过输入验证与适配减少代码模型误预测，无需重训，适合提升coding agent可靠性。
...
### [45] [When to Answer and When to Defer: A Decision Framework for Reliable Code Predictions](http://arxiv.org/abs/2605.19369v1)
*Ravishka Rathnasuriya,Wei Yang*
...
Selection reason: 将不确定性估计、校准与工具调用结合的选择性预测框架，增强代码agent的风险感知与安全放弃。
...
### [46] [DRReduce: Enhancing Syntax-Guided Program Reduction with Dependency Reconstruction](http://arxiv.org/abs/2605.19412v1)
...
Selection reason: 通过依赖重建增强语法引导的程序化简，服务于调试与最小化测试用例，属程序分析通用方法。
...
### [47] [Characterizing Real-World Bugs in Tile Programs for Automated Bug Detection](http://arxiv.org/abs/2605.19652v1)
...
Selection reason: 系统研究tile程序代码生成bug，为编译器测试与自动化bug检测提供基础性洞见。
...
### [48] [CriterAlign: Criterion-Centric Rationale Alignment for Code Preference Judging](http://arxiv.org/abs/2605.19665v2)
...
Selection reason: 提出面向代码偏好评估的criterion-centric pairwise评判框架，改进LLM judge的评估准确率。
...
### [49] [Can LLMs Produce Better Object-Oriented Designs than Human-Involved Development?](http://arxiv.org/abs/2605.19901v1)
...
Selection reason: 比较LLM与人类参与项目的面向对象设计质量，为代码生成质量评估提供参考。
...
### [50] [A Case for Agentic Tuning: From Documentation to Action in PostgreSQL](http://arxiv.org/abs/2605.19988v1)
...
Selection reason: 将专家调优方法转化为可执行技能，赋予LLM agent进行PostgreSQL配置优化，直接属于自动性能调优。
...
### [51] [Does Code Cleanliness Affect Coding Agents? A Controlled Minimal-Pair Study](http://arxiv.org/abs/2605.20049v1)
...
Selection reason: 用最小对研究代码整洁度对coding agent行为的影响，为agent评测与代码维护提供可迁移方法。
...
### [52] [Towards LLM-Assisted Architecture Recovery for Real-World ROS~2 Systems: An Agent-Based Multi-Level Approach to Hierarchical Structural Architecture Reconstruction](http://arxiv.org/abs/2605.20055v1)
...
Selection reason: 基于LLM agent的RO S2系统分层架构恢复方法，对软件架构逆向agent有参考价值。
...
### [53] [Combined Program Analysis Techniques: A Systematic Mapping Study](http://arxiv.org/abs/2605.20310v1)
...
Selection reason: 系统梳理程序分析技术组合的协同分类，为构建分析工具链提供结构化指导。
...
### [54] [Agentic Agile-V: From Vibe Coding to Verified Engineering in Software and Hardware Development](http://arxiv.org/abs/2605.20456v1)
*Christopher Koch*
...
Selection reason: 提出Agentic Agile-V流程框架，将agent代码生成约束为结构化工件与验收证据，对工程化agent有直接参考。
...
### [55] [Code Generation by Differential Test Time Scaling](http://arxiv.org/abs/2605.20473v1)
...
Selection reason: 提出基于差分分析和覆盖引导fuzzing的测试时扩展方法，无需额外LLM调用即可选择最优代码候选。
...
### [56] [A Multi-Layer Testing Framework for Automated Data Quality Assurance in Cloud-Native ELT Pipelines](http://arxiv.org/abs/2605.20500v1)
...
Selection reason: 结合LLM生成语义测试的多层数据管道测试框架，对自动化测试生成和验证编排有一定参考价值。
...
### [57] [High-Dimensional Concentration and Retrieval Instability in Embedding Spaces: Implications for Retrieval-Augmented Generation](http://arxiv.org/abs/2606.28330v1)
*Ernesto Lopez Fune*
...
### [58] [Beyond Text and Tables: Vision-Language Model Integration in ComProScanner for Extracting Materials Data from Scientific Figures with High Accuracy](http://arxiv.org/abs/2606.00065v1)
...
### [59] [Contract Based Verification of Non-functional Requirements for Embedded Automotive C Code](http://arxiv.org/abs/2605.21532v1)
...
Selection reason: 提出面向C模块的接口契约与Frama-C插件，可迁移至代码agent的合约验证与不可信代码检查
...
### [60] [STAR-PólyaMath: Multi-Agent Reasoning under Persistent Meta-Strategic Supervision](http://arxiv.org/abs/2605.19338v1)
...
### [61] [PAVE: A Cognitive Architecture for Legitimate Violation in Generative Agent Societies](http://arxiv.org/abs/2605.19351v1)
...
### [62] [Multi-agent Collaboration with State Management](http://arxiv.org/abs/2605.20563v1)
...
Selection reason: 面向多agent共享代码库的状态管理，能在写入时检测解决冲突，直接适用于coding agent协作
...
### [63] [What Do Evolutionary Coding Agents Evolve?](http://arxiv.org/abs/2605.20086v1)
...
### [64] [ContextFlow: Hierarchical Task-State Alignment for Long-Horizon Embodied Agents](http://arxiv.org/abs/2605.19314v1)
...
### [65] [SCARA: A Semantics-Constrained Autonomous Remediation Agent for Opaque Industrial Software Vulnerabilities](http://arxiv.org/abs/2605.19668v1)
...
Selection reason: 面向无源码工业软件漏洞的自主修复agent，结合语义约束与验证流程，对代码修复agent有迁移价值。
...
### [66] [Measuring Safety Alignment Effects in Autonomous Security Agents](http://arxiv.org/abs/2605.19722v1)
...
### [67] [PhyWorld: Physics-Faithful World Model for Video Generation](http://arxiv.org/abs/2605.19242v1)
...
### [68] [JUDO: A Juxtaposed Domain-Oriented Multimodal Reasoner for Industrial Anomaly QA](http://arxiv.org/abs/2605.20284v1)
...
### [69] [CutVerse: A Compositional GUI Agents Benchmark for Media Post-Production Editing](http://arxiv.org/abs/2605.19484v1)
...
### [70] [CaptchaMind: Training CAPTCHA Solvers via Reinforcement Learning with Explicit Reasoning Supervision](http://arxiv.org/abs/2605.19538v1)
...
### [71] [A novel YOLO26-MoE optimized by an LLM agent for insulator fault detection considering UAV images](http://arxiv.org/abs/2605.19595v1)
...
### [72] [P2DNav: Panorama-to-Downview Reasoning for Zero-shot Vision-and-Language Navigation](http://arxiv.org/abs/2605.19634v1)
...
### [73] [Passive Construction Site Safety Monitoring via Persona-Scaffolded Adversarial Chain-of-Thought VLM Verification](http://arxiv.org/abs/2605.19869v1)
...
### [74] [Toward User Comprehension Supports for LLM Agent Skill Specifications](http://arxiv.org/abs/2605.19362v2)
*Zikai Alex Wen*
...
### [75] [Using Biometrics to Understand AI-Assisted Coding Performance and its Perception](http://arxiv.org/abs/2606.20598v1)
...
### [76] [Modeling Emotional Dynamics in Agent-to-Agent Interactions on Moltbook](http://arxiv.org/abs/2605.20442v1)
...
### [77] [PrefBench: Evaluating Zero-Shot LLM Agents in Hidden-Preference Personalized Pricing Negotiations](http://arxiv.org/abs/2605.22855v1)
*Yingjie Lei*
...
### [78] [Smaller Abstract State Spaces Enable Cross-Scale Generalization in Reinforcement Learning](http://arxiv.org/abs/2605.20272v1)
...
### [79] [EviTrack: Selection over Sampling for Delayed Disambiguation](http://arxiv.org/abs/2605.19283v1)
*Omer Haq*
...
### [80] [The Evaluation Game: Beyond Static LLM Benchmarking](http://arxiv.org/abs/2605.19377v1)
...
### [81] [Introspective X Training: Feedback Conditioning Improves Scaling Across all LLM Training Stages](http://arxiv.org/abs/2605.20285v1)
...
### [82] [When to Stop Reusing: Dynamic Gradient Gating for Sample-Efficient RLVR](http://arxiv.org/abs/2605.19425v1)
...
### [83] [Sampling-Based Safe Reinforcement Learning](http://arxiv.org/abs/2605.19469v1)
...
### [84] [Learning with Foresight: Enhancing Neural Routing Policy via Multi-Node Lookahead Prediction](http://arxiv.org/abs/2605.19975v1)
...
### [85] [Training Language Agents to Learn from Experience](http://arxiv.org/abs/2605.20477v1)
...
### [86] [Diagnosing Multi-step Reasoning Failures in Black-box LLMs via Stepwise Confidence Attribution](http://arxiv.org/abs/2605.19228v2)
...
### [87] [HalluWorld: A Controlled Benchmark for Hallucination via Reference World Models](http://arxiv.org/abs/2605.19341v1)
...
### [88] [optimize_anything: A Universal API for Optimizing any Text Parameter](http://arxiv.org/abs/2605.19633v1)
...
Selection reason: 通用LLM文本优化API可优化agent架构与CUDA内核等代码，与SemOpt高度契合。
...
### [89] [Synthesis and Evaluation of Long-term History-aware Medical Dialogue](http://arxiv.org/abs/2605.19766v1)
...
### [90] [Chunking German Legal Code](http://arxiv.org/abs/2605.19806v2)
...
### [91] [CopT: Contrastive On-Policy Thinking with Continuous Spaces for General and Agentic Reasoning](http://arxiv.org/abs/2605.20075v1)
...
### [92] [Less Back-and-Forth: A Comparative Study of Structured Prompting](http://arxiv.org/abs/2605.20149v1)
...
### [93] [Do as I Say, Not as I Do: Instruction-Induction Conflict in LLMs](http://arxiv.org/abs/2605.20382v2)
...
### [94] [Protein Thoughts: Interpretable Reasoning with Tree of Thoughts and Embedding-Space Flow Matching for Protein-Protein Interaction Discovery](http://arxiv.org/abs/2605.21522v1)
