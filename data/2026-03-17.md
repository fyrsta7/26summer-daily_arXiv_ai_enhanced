...
- [Knowledge Activation: AI Skills as the Institutional Knowledge Primitive for Agentic Software Development](https://arxiv.org/abs/2603.14805) — 相关度 0.60：提出面向agent化软件开发的机构知识激活框架，可迁移到编码agent的知识组织与上下文构建。
