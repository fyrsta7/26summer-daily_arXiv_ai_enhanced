...
### [1] [Relational Intervention During Functional Collapse in Large Language Models: A Lexical-Statistical Ablation and a Structure x Register Factorial](http://arxiv.org/abs/2606.00935v1)
...
### [2] [Can AI Review Improve Paper Drafting? An Empirical Study on 20 Computer Architecture Submissions](http://arxiv.org/abs/2606.01013v2)
*Di Wu*
...
### [3] [Tackling the Root of Misinformation by Teaching Laypeople about Logical Fallacies via Socratic Questioning and Critical Argumentation](http://arxiv.org/abs/2606.01020v1)
...
### [4] [TravelEval: A Comprehensive Benchmarking Framework for Evaluating LLM-Powered Travel Planning Agents](http://arxiv.org/abs/2606.01046v1)
...
### [5] [MindClaw: Closed-Loop Embodied Mental-State Reasoning for Precision Intervention](http://arxiv.org/abs/2606.01063v2)
...
### [6] [Before the Model Learns the Bug:Fuzzing RLVR Verifiers](http://arxiv.org/abs/2606.01066v1)
*Jaideep Ray*
...
### [7] [SkillRevise: Improving LLM-Authored Agent Skills via Trace-Conditioned Skill Revision](http://arxiv.org/abs/2606.01139v3)
...
### [8] ["Skill Issues'': Data-Centric Optimization of Lakehouse Agents](http://arxiv.org/abs/2606.01185v2)
...
### [9] [Can LLM Agents Sustain Long-Horizon Organizational Dynamics?](http://arxiv.org/abs/2606.01199v1)
...
### [10] [HomeFlow: A Data Flywheel for Smart Home Agent Training with Verifiable Simulation](http://arxiv.org/abs/2606.01230v1)
...
### [11] [SIRIUS-SQL: Anchoring Multi-Candidate Text-to-SQL in Execution Feedback](http://arxiv.org/abs/2606.01246v1)
...
### [12] [ANDES: Agent Native Data Evolving Synthesis Tool for Autonomous Instruction Alignment](http://arxiv.org/abs/2606.01279v1)
...
### [13] [SkillSmith: Co-Evolving Skills and Tools for Self-Improving Agent Systems](http://arxiv.org/abs/2606.01314v1)
...
### [14] [Science Earth: Towards A Planet-Scale Operating System for AI-Native Scientific Discovery](http://arxiv.org/abs/2606.01316v2)
...
### [15] [Recognize Your Orchestrator: An Entropy Dynamics Perspective for LLM Multi-Agent Systems](http://arxiv.org/abs/2606.01351v1)
...
### [16] [Early Diagnosis of Wasted Computation in Multi-Agent LLM Systems via Failure-Aware Observability](http://arxiv.org/abs/2606.01365v2)
...
### [17] [Self-Healing Agentic Orchestrators for Reliable Tool-Augmented Large Language Model Systems](http://arxiv.org/abs/2606.01416v1)
...
### [18] [Don't Ask the LLM to Track Freshness: A Deterministic Recipe for Memory Conflict Resolution](http://arxiv.org/abs/2606.01435v1)
...
### [19] [Dive into Ambiguity: A*-Inspired Multi-Agents Commonsense Obfuscation Attack on LLM Prompts](http://arxiv.org/abs/2606.01441v1)
...
### [20] [Self-Revising Discovery Systems for Science: A Categorical Framework for Agentic Artificial Intelligence](http://arxiv.org/abs/2606.01444v1)
...
### [21] [Transferring Information Across Interventions in Causal Bayesian Optimization](http://arxiv.org/abs/2606.01457v1)
...
### [22] [An Enigma of Artificial Reason: Investigating the Production-Evaluation Gap in Large Reasoning Models](http://arxiv.org/abs/2606.01462v1)
...
### [23] [FVSpec: Real-World Property-Based Tests as Lean Challenges](http://arxiv.org/abs/2606.01008v1)
...
Selection reason: 构建真实属性测试转Lean规范的多agent流水线及基准，直接服务AI辅助形式化验证研究。
...
### [24] [BenchEvolver: Frontier Task Synthesis via Solution-Centric Evolution](http://arxiv.org/abs/2606.01286v1)
...
Selection reason: 通过解演化自动合成更难且可验证的编程任务，破解benchmark饱和，同时提供训练信号，对代码agent评测和训练有直接价值。
...
### [25] [SABER: Benchmarking Operational Safety of LLM Coding Agents in Stateful Project Workspaces](http://arxiv.org/abs/2606.01317v1)
...
Selection reason: 评测coding agent在有状态项目工作区中的操作安全基准，直接覆盖代码agent安全评估需求。
...
### [26] [Reducing Token Usage of State-in-Context Agents using Minification](http://arxiv.org/abs/2606.01326v1)
...
Selection reason: 针对state-in-context agent的源码minification降token方法，直接优化代码agent的输入效率，并公开实现。
...
### [27] [Bridging Requirements and Architecture: Multi-Agent Orchestration with External Knowledge and Hierarchical Memory](http://arxiv.org/abs/2606.01385v1)
...
Selection reason: 多智能体架构设计框架引入RAG和分层记忆机制，其工作流可迁移到软件架构agent的迭代式设计。
...
### [28] [LLM Consortium for Software Design Refinement: A Controlled Experiment on Multi-Agent Collaboration Topologies](http://arxiv.org/abs/2606.01490v1)
...
Selection reason: 系统比较12种多智能体协作拓扑的受控实验，为代码agent的多agent工作流设计提供实证依据。
...
### [29] [The Ringelmann Effect in Multi-Agent LLM Systems: A Scaling Law for Effective Team Size](http://arxiv.org/abs/2606.02646v1)
...
### [30] [3DCodeBench: Benchmarking Agentic Procedural 3D Modeling Via Code](http://arxiv.org/abs/2606.01057v1)
...
### [31] [CA-BED: Conversation-Aware Bayesian Experimental Design](http://arxiv.org/abs/2606.01182v1)
...
### [32] [DiscourseFlip: An Oblique Discourse-Level Opinion Manipulation Attack against Black-box Retrieval-Augmented Generation](http://arxiv.org/abs/2606.01212v2)
...
### [33] [Connecting the Dots: Benchmarking Reflective Memory in Long-Horizon Dialogue](http://arxiv.org/abs/2606.01223v1)
...
### [34] [SkillAdaptor: Self-Adapting Skills for LLM Agents from Trajectories](http://arxiv.org/abs/2606.01311v1)
...
### [35] [TimeSage-MT: A Multi-Turn Benchmark for Evaluating Agentic Time Series Reasoning](http://arxiv.org/abs/2606.01498v1)
...
### [36] [Multi-Agent DRL for QoS and Energy Optimization in RIS-Enabled Open-RAN Industrial 6G TN/NTN Networks](http://arxiv.org/abs/2606.28339v1)
...
### [37] [Leyline: KV Cache Directives for Agentic Inference](http://arxiv.org/abs/2606.01065v1)
...
### [38] [Hierarchical Online Prompt Mutation with Dual-Loop Feedback for Guardrailed Evidence Document Generation: A Production-Evaluation Case Study](http://arxiv.org/abs/2606.01472v1)
...
### [39] [Plausibility Is Not Prediction: Contrastive Evidence for LLM-Based Cellular Perturbation Reasoning](http://arxiv.org/abs/2606.01042v1)
...
### [40] [RLVR without Ineffective Samples: Group Prioritized Off-Policy Optimization for LLM Reasoning](http://arxiv.org/abs/2606.01281v1)
...
### [41] [pcbGPT: Automatic PCB Schematic Synthesis from Natural Language Requirements](http://arxiv.org/abs/2606.01188v1)
...
### [42] [PSG-Nav: Probabilistic Scene Graph Navigation via Multiverse Decision Making](http://arxiv.org/abs/2606.01313v1)
...
### [44] [From Rocq to Metal: A Pipeline for Formally Verified Microcontroller Firmware](http://arxiv.org/abs/2606.02651v1)
...
Selection reason: 建立形式化验证固件管线并融合LLM辅助tactic合成，对AI生成代码的正确性验证和形式化方法有迁移价值。
...
### [45] [SS-ZKR: Spatial-Semantic Zero-Knowledge Routing for Privacy-Preserving Multi-Agent Collaboration](http://arxiv.org/abs/2606.00962v1)
*Hassan Touheed*
...
### [46] [D-Judge: Disrupting Multi-Turn Jailbreaks using Semantics-Preserving Output Rewriting](http://arxiv.org/abs/2606.02640v1)
...
### [47] [memorywire: A Vendor-Neutral Wire Format for Agent Memory Operations](http://arxiv.org/abs/2606.01138v3)
*Thamilvendhan Munirathinam*

Main category: cs.CR

Comments: 18 pages, 1 figure, 6 tables. v3 adds a memory-poison recovery evaluation (PurgeBench) and a recover capability; provenance-based forget is the strongest recovery lever, the entangled class remains open. Code: github.com/mthamil107/memorywire. Companion to arXiv:2604.18248 (Prompt Injection Detection)
...
### [48] [Inference Cost Attacks for Retrieval-Augmented Large Language Models](http://arxiv.org/abs/2606.02643v1)
...
### [49] [A New Framework for Cybersecurity Refusals in AI Agents](http://arxiv.org/abs/2606.02644v1)
...
### [50] [Needles at Scale: LLM-Assisted Target Selection for Windows Vulnerability Research](http://arxiv.org/abs/2606.01364v1)
*Michael J. Bommarito*
...
Selection reason: 面向大规模二进制漏洞研究的LLM目标选择流水线，符号化-富化-采样方法可迁移至代码分析agent的优先级排序。
...
### [51] [ClawHub Security Signals: When VirusTotal, Static Analysis, and SkillSpector Disagree](http://arxiv.org/abs/2606.01494v1)
...
Selection reason: 发布agent技能安全数据集并分析多扫描器分歧，支撑代码agent技能生态的安全评估与治理。
