...
### [1] [MER-R1: Multimodal Emotion Reasoning via Slow-Fast Thinking Synergy](http://arxiv.org/abs/2606.27652v1)
...
### [2] [ToE: A Hierarchical and Explainable Claim Verification Framework with Dynamic Multi-source Evidence Retrieval and Aggregation](http://arxiv.org/abs/2606.27736v1)
...
### [3] [Towards Reliable and Robust LLM Planning: Symbolic Feedback-Driven Iterative Self-Refinement Framework](http://arxiv.org/abs/2606.27757v1)
...
### [4] [Understanding Rollout Error in Graph World Models](http://arxiv.org/abs/2606.27780v2)
...
### [5] [Agent vs. Parametric World Models: Hybrid Planning for Reliable Language Agents](http://arxiv.org/abs/2606.27806v3)
*Xinyuan Song,Zekun Cai*
...
### [6] [ATOD: Annealed Turn-aware On-policy Distillation for Multi-turn Autonomous Agents](http://arxiv.org/abs/2606.27814v1)
...
### [7] [Data and Evaluation Closed-Loop for Model Capability Enhancement](http://arxiv.org/abs/2606.28471v1)
...
### [8] [Tandem Reinforcement Learning with Verifiable Rewards](http://arxiv.org/abs/2606.28166v1)
...
### [9] [Agent-Native Immune System: Architecture, Taxonomy, and Engineering](http://arxiv.org/abs/2606.28270v1)
...
### [10] [GPTNT: Benchmarking Real-Time Collaboration Between Multimodal Agents on Keep Talking And Nobody Explodes](http://arxiv.org/abs/2606.28514v1)
...
### [11] [Search for Truth from Reasoning: A Dynamic Representation Editing Framework for Steering LLM Trajectories](http://arxiv.org/abs/2606.28589v2)
...
### [12] [Building to the Test: Coding Agents Deliver What You Check, Not What You Requested](http://arxiv.org/abs/2606.28430v1)
...
Selection reason: 揭示 coding agent 的验证自感知问题，对 agent 评测机制研究有重要价值。
...
### [13] [SWE-MeM: Learning Adaptive Memory Management for Long-Horizon Coding Agents](http://arxiv.org/abs/2606.28434v1)
...
Selection reason: 面向长程 coding agent 的自适应记忆管理，直接提升 agent 效率与性能。
...
### [14] [BashCoder-R1: Towards Robust and Explainable Bash Code Generation with Robustness-Aware Group Relative Policy Optimization](http://arxiv.org/abs/2606.27733v1)
...
Selection reason: Bash 代码生成结合鲁棒性 RL 和新基准，对代码生成与评测有直接价值。
...
### [15] [UNICS: Multilingual Code Search via Unified Pseudocode and Contrastive Transfer Learning](http://arxiv.org/abs/2606.27747v1)
...
Selection reason: 多语言代码搜索的通用方法，属于代码检索相关研究。
...
### [16] [Dockerless: Environment-Free Program Verifier for Coding Agents](http://arxiv.org/abs/2606.28436v1)
...
Selection reason: 环境无关的程序验证器用于 coding agent 训练，显著降低验证成本，直接相关。
...
### [17] [When AI Reviews Its Own Code: Recursive Self-Training Collapse in Code LLMs](http://arxiv.org/abs/2606.28438v1)
...
Selection reason: 研究代码 LLM 递归自训练退化与自审查失效，对 agent 可靠性和训练稳定性有迁移价值。
...
### [18] [Evolution-Aware Regression Test Prioritization of ML-Enabled Systems Using Gradient-Based Behavior Vectors](http://arxiv.org/abs/2606.28037v1)
...
Selection reason: 面向 ML 系统演化的回归测试优先级方法，对测试领域的通用方法有参考。
...
### [19] [SBridge: Identifying Source-to-Binary Function Similarity via Cross-Domain Control Block Matching](http://arxiv.org/abs/2606.28058v1)
...
Selection reason: 源到二进制函数相似性匹配，对程序分析和漏洞检测有通用方法价值。
...
### [20] [How Humans, Bots, and Agents Communicate About Vulnerabilities in Pull Requests](http://arxiv.org/abs/2606.28125v1)
...
Selection reason: 研究PR中人类/机器人/agent如何沟通漏洞，对agent安全沟通与评审有参考价值。
...
### [21] [CrossLangFuzzer: Differential Testing of Cross-Language JVM Compilers](http://arxiv.org/abs/2606.28132v1)
...
Selection reason: 跨语言JVM编译器差分测试，直接相关于编译器正确性与自动测试。
...
### [22] [Humanizing Automatically Generated Unit Test Suites with LLM-Based Refactoring](http://arxiv.org/abs/2606.28229v2)
...
Selection reason: 用LLM重构SBST测试套件提升可读性，是测试生成与LLM协作的通用方法。
...
### [23] [Govern the Repository, Not the Agent: Measuring Ecosystem-Level Risk in AI-Native Software](http://arxiv.org/abs/2606.28235v1)
*Daniel Russo*
...
Selection reason: 大规模实证分析agent PR的集成摩擦，提出生态级治理与评测视角，可迁移至agent评测。
...
### [24] [TUA-Bench: A Benchmark for General-Purpose Terminal-Use Agents](http://arxiv.org/abs/2606.28480v1)
...
Selection reason: 通用终端agent基准，覆盖编码与日常任务，对coding agent评估有直接价值。
...
### [25] [Evaluating LLMs on Java Code Snippet Adaptation Using a Mutation-Injection Framework](http://arxiv.org/abs/2606.28618v1)
...
Selection reason: 用变异注入研究LLM代码片段适配能力，提供代码适配评测方法，虽为计划性研究。
...
### [26] [Reflect-R1: Evidence-Driven Reflection for Self-Correction in Long Video Understanding](http://arxiv.org/abs/2606.27922v3)
...
### [27] [ProMSA:Progressive Multimodal Search Agents for Knowledge-Based Visual Question Answering](http://arxiv.org/abs/2606.27974v1)
...
### [28] [PhysisForcing: Physics Reinforced World Simulator for Robotic Manipulation](http://arxiv.org/abs/2606.28128v1)
...
### [29] [Digitizing Coaching Intelligence: An Agentic Framework for Holistic Athlete Profiling using VLM and RAG](http://arxiv.org/abs/2606.28570v1)
...
### [30] [Animation2Code: Evaluating Temporal Visual Reasoning in Video-to-Code Generation](http://arxiv.org/abs/2606.28593v1)
...
### [31] [Database Context Compression for Text-to-SQL on Real-World Large Databases](http://arxiv.org/abs/2606.28601v1)
...
### [32] [Bifocal Diffusion Language Models: Asymmetric Bidirectional Context for Parallel Generation](http://arxiv.org/abs/2606.27732v1)
...
### [33] [From Signals to Transfer: A Factorised Study of Probe-Based Uncertainty Estimation in Large Language Models](http://arxiv.org/abs/2606.27679v1)
...
### [35] [Low-Agreeableness Persona Conditioning for Safe LLM Fine-Tuning](http://arxiv.org/abs/2606.27709v1)
...
### [36] [Enhancing Numerical Prediction in LLMs via Smooth MMD Alignment](http://arxiv.org/abs/2606.27731v1)
...
### [37] [Triadic Werewolf: A Jester Role for Multi-Hop Theory of Mind in LLMs](http://arxiv.org/abs/2606.27909v1)
*Avni Mittal*
...
### [38] [Is Lying an Emergent Behaviour in LLMs? Evidence from Gaslighting AI agents in a Sustainability Game](http://arxiv.org/abs/2606.28456v1)
...
### [39] [It Lied to a Doctor to Buy Poison Ingredients: Quantifying Real-World Misuse of Phone-use Agents](http://arxiv.org/abs/2606.27944v1)
...
### [40] [Which Nash Equilibrium? Solver-Dependent Selection on Zero-Sum Nash Polytopes](http://arxiv.org/abs/2606.28308v1)
*Luis Leal*
...
### [41] [CBD: API-Only LLM Black-Box Unlearning through Controlled Behavioral Divergence](http://arxiv.org/abs/2606.27683v1)
...
### [42] [Deployment-Side Adaptiveness in Multi-Horizon Volatility Forecasting](http://arxiv.org/abs/2606.27688v1)
...
### [43] [RS-Diffuser: Risk-Sensitive Diffusion Planning with Distributional Value Guidance](http://arxiv.org/abs/2606.27766v1)
*Shiqiang Gong*
...
### [44] [An Agentic AI Pipeline for Appliance-Level Energy Anomaly Detection and LLM-Driven Recommendations](http://arxiv.org/abs/2606.28467v1)
...
### [45] [CPAgents: Agentic Composite Phenotype Generation for Cardiac Disease Association](http://arxiv.org/abs/2606.28179v1)
...
### [46] [LLawCo: Learning Laws of Cooperation for Modeling Embodied Multi-Agent Behavior](http://arxiv.org/abs/2606.28182v1)
...
### [47] [Towards Value-Constrained Credit Assignment in Fully Delegated AI Cooperatives](http://arxiv.org/abs/2606.28217v1)
...
### [48] [Towards Automating Scientific Review with Google's Paper Assistant Tool](http://arxiv.org/abs/2606.28277v1)
...
### [49] [What LLMs explain is not what they believe: Evaluating explanation sufficiency under models' own input beliefs](http://arxiv.org/abs/2606.28615v1)
...
### [51] [LLM agents security duality: a comprehensive survey of self-security and empowered cybersecurity](http://arxiv.org/abs/2606.28450v1)
...
### [52] [Agentic AI-Powered Re-Identification: An Emerging, Scalable Threat to Mobility Microdata Privacy](http://arxiv.org/abs/2606.27936v1)
...
### [53] [ToolPrivacyBench: Benchmarking Purpose-Bound Privacy in Tool-Using LLM Agents](http://arxiv.org/abs/2606.28061v1)
