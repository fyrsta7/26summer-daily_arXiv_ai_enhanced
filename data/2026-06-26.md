...
- [CrossLangFuzzer: Differential Testing of Cross-Language JVM Compilers](http://arxiv.org/abs/2606.28132v1) — 相关度 0.90：跨语言JVM编译器差分测试，直接相关于编译器正确性与自动测试。
- [Dockerless: Environment-Free Program Verifier for Coding Agents](http://arxiv.org/abs/2606.28436v1) — 相关度 0.90：环境无关的程序验证器用于 coding agent 训练，显著降低验证成本，直接相关。
- [Humanizing Automatically Generated Unit Test Suites with LLM-Based Refactoring](http://arxiv.org/abs/2606.28229v2) — 相关度 0.90：用LLM重构SBST测试套件提升可读性，是测试生成与LLM协作的通用方法。
- [SWE-MeM: Learning Adaptive Memory Management for Long-Horizon Coding Agents](http://arxiv.org/abs/2606.28434v1) — 相关度 0.90：面向长程 coding agent 的自适应记忆管理，直接提升 agent 效率与性能。
- [Building to the Test: Coding Agents Deliver What You Check, Not What You Requested](http://arxiv.org/abs/2606.28430v1) — 相关度 0.85：揭示 coding agent 的验证自感知问题，对 agent 评测机制研究有重要价值。
- [TUA-Bench: A Benchmark for General-Purpose Terminal-Use Agents](http://arxiv.org/abs/2606.28480v1) — 相关度 0.85：通用终端agent基准，覆盖编码与日常任务，对coding agent评估有直接价值。
- [When AI Reviews Its Own Code: Recursive Self-Training Collapse in Code LLMs](http://arxiv.org/abs/2606.28438v1) — 相关度 0.80：研究代码 LLM 递归自训练退化与自审查失效，对 agent 可靠性和训练稳定性有迁移价值。
- [BashCoder-R1: Towards Robust and Explainable Bash Code Generation with Robustness-Aware Group Relative Policy Optimization](http://arxiv.org/abs/2606.27733v1) — 相关度 0.75：Bash 代码生成结合鲁棒性 RL 和新基准，对代码生成与评测有直接价值。
- [UNICS: Multilingual Code Search via Unified Pseudocode and Contrastive Transfer Learning](http://arxiv.org/abs/2606.27747v1) — 相关度 0.70：多语言代码搜索的通用方法，属于代码检索相关研究。
- [Govern the Repository, Not the Agent: Measuring Ecosystem-Level Risk in AI-Native Software](http://arxiv.org/abs/2606.28235v1) — 相关度 0.65：大规模实证分析agent PR的集成摩擦，提出生态级治理与评测视角，可迁移至agent评测。
- [Evaluating LLMs on Java Code Snippet Adaptation Using a Mutation-Injection Framework](http://arxiv.org/abs/2606.28618v1) — 相关度 0.60：用变异注入研究LLM代码片段适配能力，提供代码适配评测方法，虽为计划性研究。
- [SBridge: Identifying Source-to-Binary Function Similarity via Cross-Domain Control Block Matching](http://arxiv.org/abs/2606.28058v1) — 相关度 0.60：源到二进制函数相似性匹配，对程序分析和漏洞检测有通用方法价值。
- [Evolution-Aware Regression Test Prioritization of ML-Enabled Systems Using Gradient-Based Behavior Vectors](http://arxiv.org/abs/2606.28037v1) — 相关度 0.55：面向 ML 系统演化的回归测试优先级方法，对测试领域的通用方法有参考。
- [How Humans, Bots, and Agents Communicate About Vulnerabilities in Pull Requests](http://arxiv.org/abs/2606.28125v1) — 相关度 0.55：研究PR中人类/机器人/agent如何沟通漏洞，对agent安全沟通与评审有参考价值。
