...
### [1] [CP-SynC: Multi-Agent Zero-Shot Constraint Modeling in MiniZinc with Synthesized Checkers](http://arxiv.org/abs/2605.01675v1)
...
### [2] [Latent State Design for World Models under Sufficiency Constraints](http://arxiv.org/abs/2605.01694v1)
*Keon Woo Kim*
...
### [3] [Catching the Infection Before It Spreads: Foresight-Guided Defense in Multi-Agent Systems](http://arxiv.org/abs/2605.01758v3)
...
### [4] [DataEvolver: Let Your Data Build and Improve Itself via Goal-Driven Loop Agents](http://arxiv.org/abs/2605.01789v1)
...
### [5] [NeuroState-Bench: A Human-Calibrated Benchmark for Commitment Integrity in LLM Agent Profiles](http://arxiv.org/abs/2605.01847v3)
*Xiao Jia*
...
### [6] [Sheaf-Theoretic Planning: A Categorical Foundation for Resilient Multi-Agent Autonomous Systems](http://arxiv.org/abs/2605.01879v1)
...
### [7] [A Language for Describing Agentic LLM Contexts](http://arxiv.org/abs/2605.01920v1)
*Noga Peleg Pelc,Gal A. Kaminka,Yoav Goldberg*

Main category: cs.AI

Comments: 18 pages, 12 figures. Accepted at CAIS '26. Project page: www.acdlang.org

Selection reason: 提出Agentic上下文描述语言，可标准化和可视化代码Agent的提示结构与动态。
...
### [8] [Moira: Language-driven Hierarchical Reinforcement Learning for Pair Trading](http://arxiv.org/abs/2605.01954v1)
...
### [9] [12 Angry AI Agents: Evaluating Multi-Agent LLM Decision-Making Through Cinematic Jury Deliberation](http://arxiv.org/abs/2605.01986v1)
...
### [10] [Model Spec Midtraining: Improving How Alignment Training Generalizes](http://arxiv.org/abs/2605.02087v2)
...
### [11] [NORA: A Harness-Engineered Autonomous Research Agent for End-to-End Spatial Data Science](http://arxiv.org/abs/2605.02092v1)
...
### [12] [Conventional Commit Classification using Large Language Models and Prompt Engineering](http://arxiv.org/abs/2605.02033v1)
...
Selection reason: 利用LLM提示工程进行Commit分类，提示策略对软件工程Agent有参考价值。
...
### [13] [How Compliant Are GitHub Actions Workflows? A Checklist-Based Study with LLM-Assisted Auditing](http://arxiv.org/abs/2605.02091v1)
...
Selection reason: 用LLM审计CI工作流合规性并提出多层级仲裁框架，可迁移到Agent质量评估。
...
### [14] [Foundation Models as Oracles for Refactoring Correctness Detection](http://arxiv.org/abs/2605.02096v2)
...
Selection reason: 用基础模型检测重构正确性，为代码Agent提供轻量级验证与筛查机制。
...
### [15] [Beyond Semantic Similarity: Rethinking Retrieval for Agentic Search via Direct Corpus Interaction](http://arxiv.org/abs/2605.05242v1)
...
Comments: 27 pages, Technical AI Safety Conference
...
### [18] [GRAVITY: Architecture-Agnostic Structured Anchoring for Long-Horizon Conversational Memory](http://arxiv.org/abs/2605.01688v1)
...
### [19] [BIM Information Extraction Through LLM-based Adaptive Exploration](http://arxiv.org/abs/2605.01698v1)
*Sylvain Hellin,Suhyung Jang,Stefan Fuchs,Stavros Nousias,André Borrmann*

Main category: cs.CL

Comments: Submitted to Automation in Construction
...
### [20] [The Reasoning Trap: An Information-Theoretic Bound on Closed-System Multi-Step LLM Reasoning](http://arxiv.org/abs/2605.01704v2)
*Kwan Soo Shin*
...
### [21] [The Compliance Gap: Why AI Systems Promise to Follow Process Instructions but Don't](http://arxiv.org/abs/2605.01771v1)
*Kwan Soo Shin*
...
### [22] [FixItFlow: Automated Troubleshooting Guide Generation from Cloud Incidents](http://arxiv.org/abs/2607.13035v1)
...
Selection reason: 用LLM自动生成云故障排查指南并严格验证，对代码Agent的验证机制有迁移价值。
...
### [23] [Prompt Framing Distorts Count-Based Evaluation of LLM Error Detection: Evidence from Numeric Anchoring](http://arxiv.org/abs/2607.01240v1)
*Dekun Yang*
...
### [24] [Spatiotemporal Hidden-State Dynamics as a Signature of Internal Reasoning in Large Language Models](http://arxiv.org/abs/2605.01853v1)
...
### [25] [Enhancing Judgment Document Generation via Agentic Legal Information Collection and Rubric-Guided Optimization](http://arxiv.org/abs/2605.02011v1)
...
### [26] [What Single-Prompt Accuracy Misses: A Multi-Variant Reliability Audit of Language Models](http://arxiv.org/abs/2605.02038v1)
...
### [27] [EditPropBench: Measuring Factual Edit Propagation in Scientific Manuscripts](http://arxiv.org/abs/2605.02083v2)
*Garvin Kruthof*
...
### [28] [Talk is Cheap, Communication is Hard: Dynamic Grounding Failures and Repair in Multi-Agent Negotiation](http://arxiv.org/abs/2605.01750v2)
...
### [29] [Quality-Aware Exploration Budget Allocation for Cooperative Multi-Agent Reinforcement Learning](http://arxiv.org/abs/2605.01865v1)
...
### [30] [Coopetition-Gym v1: A Formally Grounded Platform for Mixed-Motive Multi-Agent Reinforcement Learning under Strategic Coopetition](http://arxiv.org/abs/2605.02063v1)
*Vik Pant,Eric Yu*

Main category: cs.MA

Comments: 82 pages, 14 figures, 9 tables, 51 references. AI-track technical report companion to the four-paper foundational series; should be read with arXiv:2510.18802, arXiv:2510.24909, arXiv:2601.16237, and arXiv:2604.01240. Reproducibility package and source code: https://github.com/vikpant/strategic-coopetition. Datasets released under CC-BY-4.0 at https://huggingface.co/vikpant
...
### [31] [Architectural Obsolescence of Unhardened Agentic-AI Runtimes](http://arxiv.org/abs/2605.01740v1)
*Alfredo Metere*
...
### [32] [VulKey: Automated Vulnerability Repair Guided by Domain-Specific Repair Patterns](http://arxiv.org/abs/2605.01769v3)
...
Selection reason: 基于分层修复模式的LLM漏洞自动修复框架，直接面向代码修复任务。
...
### [33] [QASecClaw: A Multi-Agent LLM Approach for False Positive Reduction in Static Application Security Testing](http://arxiv.org/abs/2605.01885v1)
...
Selection reason: 多Agent LLM降低SAST误报，是代码安全审查Agent的直接实践。
...
### [34] [Trojan Hippo: Weaponizing Agent Memory for Data Exfiltration](http://arxiv.org/abs/2605.01970v3)
...
### [35] [Discover Fast Power Allocation Solution for Multi-Target Tracking via AlphaEvolve Evolution](http://arxiv.org/abs/2605.01794v1)
...
### [36] [Reward Hacking Benchmark: Measuring Exploits in LLM Agents with Tool Use](http://arxiv.org/abs/2605.02964v1)
*Kunvar Thaman*

Main category: cs.LG

Comments: 16 pages, 2 figures. Accepted to ICML 2026
...
### [37] [AutoRAGTuner: A Declarative Framework for Automatic Optimization of RAG Pipelines](http://arxiv.org/abs/2605.02967v1)
...
Selection reason: RAG流水线自动优化框架，其声明式配置和贝叶斯调优可迁移到代码Agent调优。
