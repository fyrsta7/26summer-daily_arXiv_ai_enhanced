...
- [QASecClaw: A Multi-Agent LLM Approach for False Positive Reduction in Static Application Security Testing](http://arxiv.org/abs/2605.01885v1) — 相关度 0.85：多Agent LLM降低SAST误报，是代码安全审查Agent的直接实践。
- [VulKey: Automated Vulnerability Repair Guided by Domain-Specific Repair Patterns](http://arxiv.org/abs/2605.01769v3) — 相关度 0.85：基于分层修复模式的LLM漏洞自动修复框架，直接面向代码修复任务。
- [Foundation Models as Oracles for Refactoring Correctness Detection](http://arxiv.org/abs/2605.02096v2) — 相关度 0.80：用基础模型检测重构正确性，为代码Agent提供轻量级验证与筛查机制。
- [A Language for Describing Agentic LLM Contexts](http://arxiv.org/abs/2605.01920v1) — 相关度 0.75：提出Agentic上下文描述语言，可标准化和可视化代码Agent的提示结构与动态。
- [AutoRAGTuner: A Declarative Framework for Automatic Optimization of RAG Pipelines](http://arxiv.org/abs/2605.02967v1) — 相关度 0.70：RAG流水线自动优化框架，其声明式配置和贝叶斯调优可迁移到代码Agent调优。
- [FixItFlow: Automated Troubleshooting Guide Generation from Cloud Incidents](http://arxiv.org/abs/2607.13035v1) — 相关度 0.65：用LLM自动生成云故障排查指南并严格验证，对代码Agent的验证机制有迁移价值。
- [How Compliant Are GitHub Actions Workflows? A Checklist-Based Study with LLM-Assisted Auditing](http://arxiv.org/abs/2605.02091v1) — 相关度 0.65：用LLM审计CI工作流合规性并提出多层级仲裁框架，可迁移到Agent质量评估。
- [Conventional Commit Classification using Large Language Models and Prompt Engineering](http://arxiv.org/abs/2605.02033v1) — 相关度 0.55：利用LLM提示工程进行Commit分类，提示策略对软件工程Agent有参考价值。
