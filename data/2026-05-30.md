...
### [1] [Doing What They Say, Not What They Reason: Locating the Faithfulness Gap in LLM Agents](http://arxiv.org/abs/2606.00476v2)
*Yufeng Wang*
...
### [2] [KACE: Knowledge-Adaptive Context Engineering for Mathematical Reasoning](http://arxiv.org/abs/2606.00532v1)
...
### [3] [Probe Before You Edit: Probing-Guided Molecular Optimization for LLM Agents in Structure-Based Drug Design](http://arxiv.org/abs/2606.00555v2)
...
### [4] [TRACE: Trajectory Risk-Aware Compression for Long-Horizon Agent Safety](http://arxiv.org/abs/2606.00611v1)
...
### [5] [Efficient Test-time Inference for Generative Planning Models with OCL Search](http://arxiv.org/abs/2606.00618v2)
...
### [6] [DEMM-Bench: A Cross-Regime Benchmark for Agent-Runtime Governance-Evidence Sufficiency](http://arxiv.org/abs/2606.20634v1)
*Oleg Solozobov*
...
### [7] [Hidden Thoughts Are Not Secret: Reasoning Trace Exposure in LLMs](http://arxiv.org/abs/2606.00642v1)
...
### [8] [ForeSci: Evaluating LLM Agents for Forward-Looking AI Research Judgment](http://arxiv.org/abs/2606.00644v2)
...
### [9] [AXIOM: A Trust-First Neuro-Symbolic Execution Architecture for Verifiable Mathematical Reasoning](http://arxiv.org/abs/2606.00671v1)
*Alessio Bruno*
...
### [10] [MOSAIC: Modular Orchestration for Structured Agentic Intelligence and Composition](http://arxiv.org/abs/2606.00708v1)
...
### [11] [LLM-Driven Co-Evolutionary Automated Heuristic Design for Bi-Component Coupled Combinatorial Optimization](http://arxiv.org/abs/2606.00718v1)
...
### [12] [Latent Reward Steering: An Adaptive Inference-Time Framework that Implicitly Promotes Cognitive Behaviors in Reasoning LLMs](http://arxiv.org/abs/2606.00726v2)
...
### [13] [SHARP: Sleep-based Hierarchical Accelerated Replay for Long Range Non-Stationary Temporal Pattern Recognition](http://arxiv.org/abs/2606.00732v4)
...
### [14] [CoMIC: Collaborative Memory and Insights Circulation for Long-Horizon LLM Agents in Cloud-Edge Systems](http://arxiv.org/abs/2606.00756v1)
...
### [15] [FALAT: Tracing Failures in LLM Agent Trajectories via Dependency-Guided Search](http://arxiv.org/abs/2606.00765v1)
...
### [16] [Decoupled Behavioral Cloning for Scalable Inductive Generalization in RL from Specifications](http://arxiv.org/abs/2606.00838v1)
...
### [17] [Certificate-Guided Evaluation of Reinforcement Learning Generalization](http://arxiv.org/abs/2606.00840v1)
...
### [18] [Adversarial Feeds Steer LLM Agent Decisions Against Their Defaults](http://arxiv.org/abs/2606.00914v1)
*Rana Muhammad Usman*
...
### [19] [GitHub Copilot and Developer Productivity: An Observational Dose-Response Analysis](http://arxiv.org/abs/2606.00438v1)
...
Selection reason: 提供观测性工具效率度量的剂量-反应分析框架，可迁移到coding agent生产率的真实场景评估。
...
### [20] [When Safe Skills Collide: Measuring Compositional Risk in Agent Skill Ecosystems](http://arxiv.org/abs/2606.00448v1)
...
Selection reason: 系统测量agent技能组合的构成性安全风险，其静态组合基准与可执行性验证对代码agent工具链安全评测有直接借鉴价值。
...
### [21] [Sakura: An Approach for Generating Complex Tests from Natural Language Test Descriptions](http://arxiv.org/abs/2606.00530v1)
*Tyler Stennett,Rangeet Pan,Bridget McGinn,Alessandro Orso,Saurabh Sinha*

Main category: cs.SE

Comments: 22 pages, 11 figures. Accepted to ISSTA 2026

Selection reason: 首个基于多智能体的自然语言描述复杂测试生成框架，直接聚焦代码测试生成与agent执行反馈。
...
### [22] [Scaling Behavior of Single LLM-Driven Multi-Agent Systems](http://arxiv.org/abs/2606.00655v1)
...
### [23] [Dynamic Coordination Strategy Selection for Enterprise Multi-Agent Systems](http://arxiv.org/abs/2606.00804v2)
*Thanh Luong Tuan*
...
### [24] [On the Limits of LLM Adaptability: Impact of Model-Internalized Priors on Annotation Task Performance](http://arxiv.org/abs/2606.00467v1)
...
### [25] [Skill or Skip? Learning Selective Skill Invocation in Agentic Tasks via Dual-Granularity Preference Learning](http://arxiv.org/abs/2606.00510v1)
...
### [26] [Post-Training Recipe, More Than Model Family, Shapes Multi-Agent LLM Conversational Behavior](http://arxiv.org/abs/2606.20632v2)
...
### [27] [SPADER: Step-wise Peer Advantage with Diversity-Aware Exploration Rewards for Multi-Answer Question Answering](http://arxiv.org/abs/2606.00593v2)
...
### [28] [MemPro: Agentic Memory Systems as Evolvable Programs](http://arxiv.org/abs/2606.00619v1)
...
### [29] [PaCo-VLA: Passivity-Shielded Compliance Prior for Contact-Rich Vision-Language-Action Manipulation](http://arxiv.org/abs/2606.00515v1)
...
### [30] [Too Much of a Good Thing: When sim2real Efforts Impede Policy Learning (And What to Do About It)](http://arxiv.org/abs/2606.02636v2)
...
### [31] [CodeCytos: AI-assisted spatial molecular imaging analysis via code-augmented agent action space](http://arxiv.org/abs/2606.00472v1)
...
### [32] [CV-Arena: An Open Benchmark for Instructional Computer Vision Problem Solving with Human-AI Collaborative Preferences](http://arxiv.org/abs/2606.00931v1)
...
### [33] [MultiTurnPSB: Evaluating Multi-Turn Jailbreak Attacks an dClassifier-Based Defenses for Medical AI Safety](http://arxiv.org/abs/2606.02630v1)
...
### [34] [Benchmarking Security Risk Detection and Verification in Open Agentic Skill Ecosystems](http://arxiv.org/abs/2606.00925v1)
...
### [35] [The Paradox of Outcome Optimization: A Causal Information-Theoretic Bound on Reasoning Shortcuts in LLMs](http://arxiv.org/abs/2606.00674v1)
...
### [36] [COPF: An Online Framework for Deployment-Stable Counterfactual Fairness in Evolving Graphs](http://arxiv.org/abs/2606.00700v1)
...
### [37] [Task diversity produces systematic transfer but inhibits continual reinforcement learning](http://arxiv.org/abs/2606.00880v1)
...
### [38] [Accuracy, Stability, and Repeated-Run Reliability of Large Language Models on Deterministic Programming Tasks](http://arxiv.org/abs/2606.00920v1)
...
Selection reason: 提出重复运行稳定性评估协议和指标，对LLM代码生成benchmark的可靠性评测有显著参考价值。
