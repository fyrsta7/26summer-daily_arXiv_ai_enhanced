...
### [19] [CodeCytos: AI-assisted spatial molecular imaging analysis via code-augmented agent action space](http://arxiv.org/abs/2606.00472v1)
...
### [20] [CV-Arena: An Open Benchmark for Instructional Computer Vision Problem Solving with Human-AI Collaborative Preferences](http://arxiv.org/abs/2606.00931v1)
...
### [21] [Scaling Behavior of Single LLM-Driven Multi-Agent Systems](http://arxiv.org/abs/2606.00655v1)
...
### [22] [Dynamic Coordination Strategy Selection for Enterprise Multi-Agent Systems](http://arxiv.org/abs/2606.00804v2)
*Thanh Luong Tuan*
...
### [23] [MultiTurnPSB: Evaluating Multi-Turn Jailbreak Attacks an dClassifier-Based Defenses for Medical AI Safety](http://arxiv.org/abs/2606.02630v1)
...
### [24] [Benchmarking Security Risk Detection and Verification in Open Agentic Skill Ecosystems](http://arxiv.org/abs/2606.00925v1)
...
### [25] [The Paradox of Outcome Optimization: A Causal Information-Theoretic Bound on Reasoning Shortcuts in LLMs](http://arxiv.org/abs/2606.00674v1)
...
### [26] [COPF: An Online Framework for Deployment-Stable Counterfactual Fairness in Evolving Graphs](http://arxiv.org/abs/2606.00700v1)
...
### [27] [Task diversity produces systematic transfer but inhibits continual reinforcement learning](http://arxiv.org/abs/2606.00880v1)
...
### [28] [Accuracy, Stability, and Repeated-Run Reliability of Large Language Models on Deterministic Programming Tasks](http://arxiv.org/abs/2606.00920v1)
...
### [31] [On the Limits of LLM Adaptability: Impact of Model-Internalized Priors on Annotation Task Performance](http://arxiv.org/abs/2606.00467v1)
...
### [32] [Skill or Skip? Learning Selective Skill Invocation in Agentic Tasks via Dual-Granularity Preference Learning](http://arxiv.org/abs/2606.00510v1)
...
### [33] [Post-Training Recipe, More Than Model Family, Shapes Multi-Agent LLM Conversational Behavior](http://arxiv.org/abs/2606.20632v2)
...
### [34] [SPADER: Step-wise Peer Advantage with Diversity-Aware Exploration Rewards for Multi-Answer Question Answering](http://arxiv.org/abs/2606.00593v2)
...
### [35] [MemPro: Agentic Memory Systems as Evolvable Programs](http://arxiv.org/abs/2606.00619v1)
...
### [36] [Critic-R: Improving Agentic Search using Instruction-tuned Retrievers with Natural Language Introspective Feedback](http://arxiv.org/abs/2606.00590v1)
...
### [37] [MemGraphRAG: Memory-based Multi-Agent System for Graph Retrieval-Augmented Generation](http://arxiv.org/abs/2606.00610v1)
...
### [38] [SkillPager: Query-Adaptive Intra-Skill Navigation via Semantic Node Retrieval](http://arxiv.org/abs/2606.00822v1)
