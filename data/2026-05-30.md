...
- [Sakura: An Approach for Generating Complex Tests from Natural Language Test Descriptions](http://arxiv.org/abs/2606.00530v1) — 相关度 0.95：首个基于多智能体的自然语言描述复杂测试生成框架，直接聚焦代码测试生成与agent执行反馈。
- [Accuracy, Stability, and Repeated-Run Reliability of Large Language Models on Deterministic Programming Tasks](http://arxiv.org/abs/2606.00920v1) — 相关度 0.80：提出重复运行稳定性评估协议和指标，对LLM代码生成benchmark的可靠性评测有显著参考价值。
- [When Safe Skills Collide: Measuring Compositional Risk in Agent Skill Ecosystems](http://arxiv.org/abs/2606.00448v1) — 相关度 0.80：系统测量agent技能组合的构成性安全风险，其静态组合基准与可执行性验证对代码agent工具链安全评测有直接借鉴价值。
- [GitHub Copilot and Developer Productivity: An Observational Dose-Response Analysis](http://arxiv.org/abs/2606.00438v1) — 相关度 0.60：提供观测性工具效率度量的剂量-反应分析框架，可迁移到coding agent生产率的真实场景评估。
