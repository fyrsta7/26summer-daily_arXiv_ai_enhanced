...
### [1] [RecourseBench: A Modular Framework for Reproducible Algorithmic Recourse Evaluation](http://arxiv.org/abs/2606.16113v1)
...
### [2] [LiteOdyssey: A Lightweight Reasoning AI Agent for Interpretable Rare-Disease Diagnosis](http://arxiv.org/abs/2606.16149v2)
*Minh-Ha Nguyen,Erica Gray,Bryce A. Schuler,Chih-Ting Yang,Rizwan Hamid,Lingyao Li,Siyuan Ma,Thomas A. Cassini,Cathy Shyr*

Main category: cs.AI

Comments: 27 pages,5 main figures, working version 2
...
### [3] [Latent Thought Flow: Efficient Latent Reasoning in Large Language Models](http://arxiv.org/abs/2606.16222v1)
...
### [4] [State-Grounded Multi-Agent Synthetic Data Generation for Tool-Augmented LLMs](http://arxiv.org/abs/2606.16307v1)
...
### [5] [AdaSTORM: Scaling LLM Reasoning on Dynamic Graphs via Adaptive Spatio-Temporal Multi-Agent Collaboration](http://arxiv.org/abs/2606.16328v1)
...
### [6] [Phase-Aware Guidance Injection for Recurrent MAPPO in Assembly-Line Disruption Recovery](http://arxiv.org/abs/2606.16330v1)
...
### [7] [Looking Is Not Picking: An Attention-Segment Account of Tool-Selection Failures in LLM Agents](http://arxiv.org/abs/2606.16364v2)
*Shiyang Chen*
...
Selection reason: 揭示LLM代理工具选择中注意力与决策分离机制，提出注意力引导的无训练选择器，可迁移至编码代理的工具选择。
...
### [8] [Posterior Twins: Distributional Behavioral Simulation for Enterprise Decisions](http://arxiv.org/abs/2606.16415v1)
*Ankit Das*
...
### [9] [When Agent Automation Becomes Profitable: Quantifying and Insuring Autonomous AI Risk through Trace-Economic Underwriting](http://arxiv.org/abs/2606.16465v1)
...
### [10] [Tensor-Coord: Algebraic Decomposition of Joint Plan Tensors for Conflict-Free Multi-Agent LLM Planning](http://arxiv.org/abs/2606.16478v1)
*Mudit Rastogi*
...
### [11] [Steering Emotional Dynamics for Art Therapy: Controllable Narrative Script Generation through Hierarchically Guided LLM Agents](http://arxiv.org/abs/2606.16481v1)
...
### [12] [CoffeeBench: Benchmarking Long-Horizon LLM Agents in Heterogeneous Multi-Agent Economies](http://arxiv.org/abs/2606.16613v1)
...
### [13] [The Integrator Advantage: Controlled Agentic AI for Small and Medium-Sized Companies](http://arxiv.org/abs/2606.16649v1)
...
### [14] [User as Code: Executable Memory for Personalized Agents](http://arxiv.org/abs/2606.16707v1)
*Bojie Li*
...
### [15] [AgentFairBench: Do LLM Agents Discriminate When They Act?](http://arxiv.org/abs/2606.16723v1)
...
### [16] [A First-Principles Derivation of LLM Policy Optimization: From Expected Reward to GRPO and Its Structural Extensions](http://arxiv.org/abs/2606.16733v1)
...
### [17] [Skill-to-LoRA: From Using Skills to Learning Behaviors for Token-Efficient LLM Agents](http://arxiv.org/abs/2606.16769v1)
...
### [18] [OpenClaw-Skill: Collective Skill Tree Search for Agentic Large Language Models](http://arxiv.org/abs/2606.16774v1)
...
### [19] [LabOSBench: Benchmarking Computer Use Agents for Scientific Instrument Control](http://arxiv.org/abs/2606.16802v1)
...
### [20] [Adaptive and Explicit safe: Triggering Latent Safety Awareness in Large Reasoning Models](http://arxiv.org/abs/2606.16808v1)
...
### [21] [GIST-CMTF: Goal-State Inference for Causal Minimal Tool Filtering in LLM Agents](http://arxiv.org/abs/2606.16813v1)
...
### [23] [Consensus-based Agentic Large Language Model Framework for Harmonized Tariff Schedule Code Classification](http://arxiv.org/abs/2606.16987v1)
...
### [24] [When in Doubt, Plan It Out: Committed Small Language Model Deliberation for Reactive Reinforcement Learning](http://arxiv.org/abs/2606.16995v1)
...
### [25] [Beyond Parallel Sampling: Diverse Query Initialization for Agentic Search](http://arxiv.org/abs/2606.17209v1)
...
### [26] [When Rules Learn: A Self-Evolving Agent for Legal Case Retrieval](http://arxiv.org/abs/2606.17220v1)
...
### [27] [Quantifying Consistency in LLM Logical Reasoning via Structural Uncertainty](http://arxiv.org/abs/2606.17312v1)
...
### [28] [MemTrace: Probing What Final Accuracy Misses in Long-Term Memory](http://arxiv.org/abs/2606.17328v1)
...
### [29] [Distributed General-Purpose Agent Networks: Architecture, Key Mechanisms, and Prototypes](http://arxiv.org/abs/2606.17368v1)
...
### [30] [Binary Decompilation LLM with Feedback-Driven Multi-Turn Refinement](http://arxiv.org/abs/2606.16162v1)
...
Selection reason: 将二进制反编译建模为多轮RL，利用编译/执行/I/O反馈修正生成，其反馈驱动范式可迁移到代码生成agent。
...
### [31] [Understanding Automated Web GUI Testing: An Empirical Study Across Exploration Strategies and State Abstractions](http://arxiv.org/abs/2606.16650v1)
...
Selection reason: 系统比较多种探索策略与状态抽象对Web GUI测试的影响，方法论对代码代理测试策略设计有参考价值。
...
### [32] [No Resource, No Benchmarks, No Problem? Evaluating and Improving LLMs for Code Generation in No-Resource Languages](http://arxiv.org/abs/2606.16827v1)
...
Selection reason: 构建无资源语言代码生成基准并比较预训练/微调策略，为代码代理在低资源语言上的部署提供实用路径。
...
### [33] [Towards LLM Accelerated Rapid Reviews for Software Tool Discovery -- Case for Log Anomaly Detection](http://arxiv.org/abs/2606.16839v1)
...
Selection reason: 提出LLM筛选和编码代理运行工具的流水线，自动化软件工具发现与执行，可迁移到代理评价。
...
### [34] [Toward Self-Evolution-Ready Workflow Harnesses: A Reversible Migration Path and Convertibility Taxonomy for Expert LLM Pipelines](http://arxiv.org/abs/2606.24598v1)
...
Selection reason: 提出专家LLM管道迁移为自适应工作流的路径与可转换性分类，对代理工作流设计有借鉴意义。
...
### [35] [Neuro-Symbolic Software Verification: Hyper-charging Local Language Models with Symbolic Reasoning at Scale](http://arxiv.org/abs/2606.16886v1)
...
Selection reason: 结合本地LLM与符号推理进行循环不变式合成，利用验证器反馈迭代，直接关乎代码验证与工具反馈。
...
### [36] [Agent trajectories as programs: fingerprinting and programming coding-agent behavior](http://arxiv.org/abs/2606.16988v1)
*Hamidah Oderinwale*
...
Selection reason: 提出编码代理行为指纹识别与程序化表示，在SWE-Bench上分析代理结构，普适性强。
...
### [37] [Selection Without Signal, Recovery Through Expression: A Measurement Study of Post-Hoc Falsification Operators for Frozen Small Code Models](http://arxiv.org/abs/2606.16999v1)
*Mehmet Iscan*
...
Selection reason: 系统评测冻结代码模型的后处理操作符，提出无损提取恢复与自适应早停，直接指导代码代理采样策略。
...
### [38] [Cluster-Aware Dual-Level Test Specification Generation for Large-Scale Automotive Software Requirements](http://arxiv.org/abs/2606.17197v1)
...
Selection reason: 提出聚类感知的双层测试规格生成管线，解决大规模需求下集成测试覆盖，可迁移到代理测试生成。
...
### [39] [Trust-Aware Multi-Agent Traceability: Confidence-Calibrated Knowledge Graphs for Consistent Software Artifact Management](http://arxiv.org/abs/2606.17203v1)
...
Selection reason: 提出置信度校准的共享知识图谱协调多代理，减少错误传播，适用于软件工程代理的可靠协作。
...
### [40] [Vibe Coding Ate My Homework: An evaluation of AI approaches to greenfield software engineering and programming](http://arxiv.org/abs/2606.18293v2)
*Callum Barbour*
...
Selection reason: 评估自然语言编程在绿地任务上的能力并分析现有基准，对代码代理能力边界有直接参考。
...
### [41] [Bistable by Construction: Wall-Clock-Calibrated State Monitors Have No Moment-Detection Regime at Agent Cadence](http://arxiv.org/abs/2606.19386v1)
*Manvendra Modgil*
...
Selection reason: 研究agent流上的运行时监控器校准机制，指出wall-clock vs sample-time的陷阱，对代码agent的可靠监控有迁移价值。
...
### [42] [Gaming-Resistant Insurance Contracts for Autonomous AI Agents: Strategy-Proof Toll Mechanism Design](http://arxiv.org/abs/2606.16326v2)
*Hao-Hsuan Chen*
...
### [43] [How Much Coordination Gain Is Real? A Paired Noise-Floor Protocol for Multi-Agent LLM Benchmarks](http://arxiv.org/abs/2606.20695v1)
...
### [44] [SPARK: Security Knowledge Priming and Representation-Guided Knowledge Activation for LLM-based Secure Code Generation](http://arxiv.org/abs/2606.16244v1)
...
### [45] [The Proxy Knows Too Much: Sealing LLM API Routers with Attested TEEs](http://arxiv.org/abs/2606.16358v1)
...
### [46] [An Evaluation of Data Leakage Risks in Tool-Using LLM Agents in Realistic Scenarios](http://arxiv.org/abs/2606.17114v1)
...
### [47] [Tool-IQA: Augmenting Image Quality Assessment with Simple Tools](http://arxiv.org/abs/2606.16082v1)
...
### [48] [Semantic Flip: Synthetic OOD Generation for Robust Refusal in Embodied Question Answering and Spatial Localization](http://arxiv.org/abs/2606.16898v1)
...
### [49] [DriveJudge: Rethinking Autonomous Driving Evaluation with Vision-Language Models](http://arxiv.org/abs/2606.17362v1)
...
### [50] [PACT: Privileged Trace Co-Training for Multi-Turn Tool-Use Agents](http://arxiv.org/abs/2606.16215v1)
...
### [51] [Tyler: Typed Latent Reasoning for Language Models -- When to Think, What to Compute, and How Much to Allocate](http://arxiv.org/abs/2606.16360v1)
...
### [52] [LectūraAgents: A Multi-Agent Framework for Adaptive Personalized AI-Assisted Learning and Embodied Teaching](http://arxiv.org/abs/2606.16428v3)
...
### [53] [ACCORD: Action-Conditioned Contextual Grounding for Language Agents](http://arxiv.org/abs/2606.16432v1)
...
### [54] [VeriGraph: Towards Verifiable Data-Analytic Agents](http://arxiv.org/abs/2606.16603v1)
...
### [55] [Compositional Reasoning Depth Predicts Clinical AI Failure: Empirical Evidence Consistent with Transformer Compositionality Limits in Electronic Health Record Question Answering](http://arxiv.org/abs/2606.16890v1)
*Sanjay Basu*
...
### [56] [TokenPilot: Cache-Efficient Context Management for LLM Agents](http://arxiv.org/abs/2606.17016v1)
...
### [57] [PromptMN: Pseudo Prompting Language](http://arxiv.org/abs/2606.17164v1)
*Enkhzol Dovdon*
...
Selection reason: 提出结构化伪提示语言减少指令歧义，可提升代码代理的上下文解析与可审查性。
...
### [58] [InvDesMobility: a reliability-gated first-principles feedback framework for closed-loop materials discovery](http://arxiv.org/abs/2606.16133v1)
...
### [59] [Embedded Arena: Iterative Optimization via Hardware Feedback](http://arxiv.org/abs/2606.16190v1)
...
### [60] [From Tokens to Regions: CUDA-Sensitive Instruction Tuning for GPU Kernel Generation](http://arxiv.org/abs/2606.16231v1)
...
### [61] [FlowMPC: Improving Flow Matching policies with World Models](http://arxiv.org/abs/2606.16286v1)
*Chandon Hamel*
...
### [62] [daVinci-kernel: Co-Evolving Skill Selection, Summarization, and Utilization via RL for GPU Kernel Optimization](http://arxiv.org/abs/2606.16497v2)
...
### [63] [A Unified Causal-Origin Taxonomy of Distributional Shifts in Reinforcement Learning](http://arxiv.org/abs/2606.16933v2)
...
### [64] [Is Your Trajectory Displacement Safe in Long-tail?](http://arxiv.org/abs/2606.16313v1)
...
### [65] [Binary Tracking for Spatial QA and Navigation with Open Vision-Language Models](http://arxiv.org/abs/2606.16902v1)
...
### [66] [The Right Call for Software Benchmarking: Consistent Decisions in Stateful Environments](http://arxiv.org/abs/2606.17261v1)
*Gábor Melis*
...
Selection reason: 针对有状态环境提出一致决策的基准实验设计，直接改进软件性能比较的方法论。
...
### [67] [Agentic Publication Protocol: An Attempt to Modernize Scientific Publication](http://arxiv.org/abs/2606.27386v1)
