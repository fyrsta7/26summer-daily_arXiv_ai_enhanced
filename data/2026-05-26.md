...
- [EviACT: An Evidence-to-Action Framework for Agentic Program Repair](http://arxiv.org/abs/2605.27238v1) — 相关度 0.95：证据驱动的代理式程序修复框架，高度相关。
- [Agentic Separation Logic Specification Synthesis](http://arxiv.org/abs/2605.27531v1) — 相关度 0.90：代理式分离逻辑规范综合，验证代理相关。
- [Automating Formal Verification with Agent-Guided Tree Search](http://arxiv.org/abs/2605.27485v1) — 相关度 0.90：代理引导树搜索自动化形式验证，直接相关。
- [Benchmarks are Not Enough: RAMP for Runtime Assessing of Agentic Models in Production Systems](http://arxiv.org/abs/2605.27492v1) — 相关度 0.90：生产环境运行时评估代理模型，评测机制直接相关。
- [TrajAudit: Automated Failure Diagnosis for Agentic Coding Systems](http://arxiv.org/abs/2605.26563v2) — 相关度 0.90：自动故障诊断框架，面向仓库级编码代理，含基准和定位方法，直接相关。
- [Verus-SpecGym: An Agentic Environment for Evaluating Specification Autoformalization](http://arxiv.org/abs/2605.26457v1) — 相关度 0.86：提出规范自动形式化基准与agent环境，用官方测试和对抗样例评估，对验证型代码agent价值高。
- [ConVer: Using Contracts and Loop Invariant Synthesis for Scalable Formal Software Verification](http://arxiv.org/abs/2605.27051v1) — 相关度 0.85：LLM合成契约与循环不变量用于C程序形式验证，验证代理相关。
- [LLM-based Mockless Unit Test Generation for Java](http://arxiv.org/abs/2605.26851v1) — 相关度 0.85：无mock的Java单元测试生成，上下文增强与约束修复，适合编码代理。
- [Laguna M.1/XS.2 Technical Report](http://arxiv.org/abs/2605.27605v1) — 相关度 0.85：面向长程代理编码的MoE模型，含基准结果，直接相关。
- [LogDx-CI: Benchmarking Log Reduction Tools for LLM Root-Cause Diagnosis](http://arxiv.org/abs/2605.28876v1) — 相关度 0.85：针对CI失败日志缩减工具的基准，评估对LLM根因诊断的支持，直接相关。
- [Testing Agentic Workflows with Structural Coverage Criteria](http://arxiv.org/abs/2605.26521v1) — 相关度 0.82：提出多agent工作流的结构化覆盖测试方法，生成可执行测试验证工具与委托路径，直接相关agent测试。
- [AndroidDaily: A Verifiable Benchmark for Mobile GUI Agents on Real-World Closed-Source Applications](http://arxiv.org/abs/2605.27761v1) — 相关度 0.78：面向真实闭源 App 的 GUI agent 可验证 benchmark 与过程感知评估器，评测机制可迁移到长程代码/软件 agent。
- [LLM Based Web Accessibility Repair: An Empirical Study of Detection, Remediation, and Cost](http://arxiv.org/abs/2605.27716v1) — 相关度 0.72：LLM agent 做可访问性缺陷检测与自动修复，并分析迭代修复成本，对编码/修复 agent 有直接参考价值。
- [OptiLoop: Coordination-in-the-Loop Verification and Repair for LLM-Generated Optimization Agents](http://arxiv.org/abs/2605.27630v1) — 相关度 0.70：协同回路验证与修复LLM生成优化代理，代理可靠性相关。
- [ProDebug: An Automated Debugging System for Prolog](http://arxiv.org/abs/2605.27124v1) — 相关度 0.70：结合LLM与谱/变异分析的Prolog自动调试，调试代理相关。
- [HTMLCure: Turning Browser Experience into State Guided Repair for Interactive HTML](http://arxiv.org/abs/2605.26807v1) — 相关度 0.65：浏览器交互状态引导的HTML修复框架，可迁移至代理式修复和SFT数据生成。
- [Strategies for Guiding LLMs to Use Software Design Patterns: A Case of Singleton](http://arxiv.org/abs/2605.26898v1) — 相关度 0.60：引导LLM应用设计模式的提示策略，可迁移至代码生成中的架构约束。
- [Neuro-Symbolic Verification of LLM Outputs for Data-Sensitive Domains (extended preprint)](http://arxiv.org/abs/2605.26942v2) — 相关度 0.55：神经符号验证LLM输出，可靠性机制可迁移至代码代理输出验证。
- [Governed Evolution of Agent Runtimes through Executable Operational Cognition](http://arxiv.org/abs/2605.27328v1) — 相关度 0.50：代理运行时演进治理框架，可迁移至代理工作流可靠性。
