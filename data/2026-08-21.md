...
Selection reason: 提出结构化分歧的对抗式代码审查协议，直接提升代码智能体的审查质量并在SWE-bench验证。
...
Selection reason: 为LLM错误纠正提供系统化的运维纪律与错误循环，对智能体可靠性和持续改进有参考价值。
...
Selection reason: 提出以精度而非能力作为LLM系统的评测指标，可迁移到代码智能体的稳定性评估。
...
Selection reason: 基于CoderForge大规模轨迹数据预测issue解决难度，直接有助于代码智能体的基准构造与任务分层。
...
Selection reason: 形式化智能体行动前的多重门控组合与补偿机制，可迁移到代码智能体的动作安全与工作流设计。
...
### [34] [SkillForge: Self-Distilling Agents for Project-Specific Issue Resolution](https://arxiv.org/abs/2608.18933)
...
Selection reason: SkillForge通过自蒸馏获取项目特定知识以解决issue，直接增强代码智能体的仓库级问题解决能力。
