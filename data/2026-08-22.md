...
- [Accelerated Genetic Programming Hyper-Heuristics for Simulation-Based Scheduling via Agentic AI](https://arxiv.org/abs/2608.19487) — 相关度 0.95：使用Claude智能体对模拟调度Python代码进行性能优化并节省大量算力，直接属于自动程序性能优化。
- [Auditing and Decomposing Feedback-Driven Evolution in LLM Test Generation under the Oracle Problem](https://arxiv.org/abs/2608.19626) — 相关度 0.90：系统审计反馈驱动的LLM测试生成中的oracle问题并设计审计协议，直接关系测试生成智能体的评估可靠性。
- [PRAXIS: Graph-Grounded Tacit Knowledge for Domain Code Generation](https://arxiv.org/abs/2608.19784) — 相关度 0.90：从代码依赖图提取隐性知识用于领域代码生成，直接提升coding agent的代码生成能力
- [Repo0: Design-Driven Zero-to-All Code Generation](https://arxiv.org/abs/2608.19854) — 相关度 0.90：Repo0通过双DAG架构驱动零到全代码生成，核心方法直接适用于仓库级coding agent
- [BreakGuard: Towards Detecting Dependency Breaking Changes with LLM-Generated Tests](https://arxiv.org/abs/2608.20167) — 相关度 0.85：用LLM生成测试检测依赖破坏性变更，直接贡献于agent自动化测试与验证
- [Hype Meets Reality: Large Language Models as Mutators in Search-based Automated Program Repair of Simulink-Stateflow Models](https://arxiv.org/abs/2608.19347) — 相关度 0.85：在搜索式APR中集成LLM突变算子并系统评估其影响，直接相关于自动程序修复与智能体引导。
- [Loreley: Repository-Scale Program Evolution with Quality-Diversity Search](https://arxiv.org/abs/2608.19703) — 相关度 0.85：仓库级程序演化结合质量-多样性搜索，直接面向自动代码优化与agent搜索策略的可迁移方法
- [Outcome Monitors: Recovery Affordances for Silent Tool Failures](https://arxiv.org/abs/2608.19303) — 相关度 0.85：提出Outcome Monitors检测工具静默失败并提供恢复机制，直接增强智能体工具使用的鲁棒性。
- [From Agent Behaviour to Agent-Friendly Documentation: An Empirical Study of How Coding Agents Discover, Read, and Write Technical Documentation](https://arxiv.org/abs/2608.20195) — 相关度 0.75：行为驱动的coding agent文档交互实证研究，为agent工作流与文档设计提供可迁移洞见
- [Measuring What a Specification Determines: A Formal Semantic-Block Model and an Execution-Judged Benchmark](https://arxiv.org/abs/2608.19475) — 相关度 0.60：形式化规格确定性的语义块模型与执行判定基准，可迁移到规格驱动的代码生成评测。
- [Stable Within, Unidentified Across: Semantic Identification of Benchmark Effects and Rankings](https://arxiv.org/abs/2608.19269) — 相关度 0.55：分析评估基准的语义多重性与排序不稳定，对构建稳健的代码智能体评测有方法论参考。
