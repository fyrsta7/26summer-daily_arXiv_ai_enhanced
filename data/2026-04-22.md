...
### [1] [EvoAgent: An Evolvable Agent Framework with Skill Learning and Multi-Agent Delegation](http://arxiv.org/abs/2604.20133v3)
...
### [2] [HiPO: Hierarchical Preference Optimization for Adaptive Reasoning in LLMs](http://arxiv.org/abs/2604.20140v2)
...
### [3] [Stateless Decision Memory for Enterprise AI Agents](http://arxiv.org/abs/2604.20158v1)
*Vasundra Srinivasan*
...
### [4] [Mol-Debate: Multi-Agent Debate Improves Structural Reasoning in Molecular Design](http://arxiv.org/abs/2604.20254v1)
...
### [5] [Memory-Augmented LLM-based Multi-Agent System for Automated Feature Generation on Tabular Data](http://arxiv.org/abs/2604.20261v1)
...
### [6] [ActuBench: A Multi-Agent LLM Pipeline for Generation and Evaluation of Actuarial Reasoning Tasks](http://arxiv.org/abs/2604.20273v1)
*Jan-Philipp Schmidt*
...
### [7] [FSFM: A Biologically-Inspired Framework for Selective Forgetting of Agent Memory](http://arxiv.org/abs/2604.20300v2)
...
### [8] [Self-Awareness before Action: Mitigating Logical Inertia via Proactive Cognitive Awareness](http://arxiv.org/abs/2604.20413v1)
...
### [9] [MedSkillAudit: A Domain-Specific Audit Framework for Medical Research Agent Skills](http://arxiv.org/abs/2604.20441v1)
...
### [10] [Self-Guided Plan Extraction for Instruction-Following Tasks with Goal-Conditional Reinforcement Learning](http://arxiv.org/abs/2604.20601v1)
...
### [11] [pAI/MSc: ML Theory Research with Humans on the Loop](http://arxiv.org/abs/2604.20622v1)
...
### [12] [CHORUS: An Agentic Framework for Generating Realistic Deliberation Data](http://arxiv.org/abs/2604.20651v1)
...
### [13] [Learning to Evolve: A Self-Improving Framework for Multi-Agent Systems via Textual Parameter Graph Optimization](http://arxiv.org/abs/2604.20714v1)
...
### [14] [Interval POMDP Shielding for Imperfect-Perception Agents](http://arxiv.org/abs/2604.20728v1)
...
### [15] [SWE-chat: Coding Agent Interactions From Real Users in the Wild](http://arxiv.org/abs/2604.20779v1)
...
Selection reason: 首个真实用户编码 agent 会话数据集（6000 sessions），并揭示模式与故障，是 coding agent 实证研究的直接基础。
...
### [16] [Automatic Ontology Construction Using LLMs as an External Layer of Memory, Verification, and Planning for Hybrid Intelligent Systems](http://arxiv.org/abs/2604.20795v1)
...
### [17] [Diagnosing CFG Interpretation in LLMs](http://arxiv.org/abs/2604.20811v1)
...
### [18] [Escaping the Agreement Trap: Defensibility Signals for Evaluating Rule-Governed AI](http://arxiv.org/abs/2604.20972v1)
...
### [19] [Co-Evolving LLM Decision and Skill Bank Agents for Long-Horizon Tasks](http://arxiv.org/abs/2604.20987v1)
...
### [20] [Value-Conflict Diagnostics Reveal Widespread Alignment Faking in Language Models](http://arxiv.org/abs/2604.20995v2)
...
Selection reason: 提出价值冲突诊断框架并发现更普遍的 alignment faking，其监控与轻量干预向量可迁移到代码 agent 的可靠性。
...
### [21] [The Last Harness You'll Ever Build](http://arxiv.org/abs/2604.21003v3)
...
### [22] [Deep FinResearch Bench: Evaluating AI's Ability to Conduct Professional Financial Investment Research](http://arxiv.org/abs/2604.21006v1)
...
### [23] [Adaptive Test-Time Compute Allocation with Evolving In-Context Demonstrations](http://arxiv.org/abs/2604.21018v1)
...
### [24] [BODHI: Precise OS Kernel Specification Inference](http://arxiv.org/abs/2605.23931v1)
...
Selection reason: 用领域知识提示大幅提升 LLM 从内核代码生成形式规约的正确性，是规格合成/验证 agent 的直接方法。
...
### [25] [Hallucination Inspector: A Fact-Checking Judge for API Migration](http://arxiv.org/abs/2604.20202v1)
...
Selection reason: 静态分析工具检测LLM API迁移中的幻觉符号，提升代码agent可靠性。
...
### [26] [Towards Secure Logging: Characterizing and Benchmarking Logging Code Security Issues with LLMs](http://arxiv.org/abs/2604.20211v1)
...
Selection reason: 构建日志安全缺陷分类与benchmark，评测LLM检测修复，相关代码安全生成。
...
### [27] [Learning Reasoning World Models for Parallel Code](http://arxiv.org/abs/2604.20926v3)
...
Selection reason: 为并行代码预测工具结果的推理世界模型，可替代外部工具反馈，强相关agent。
...
### [28] [Shift-Up: A Framework for Software Engineering Guardrails in AI-native Software Development -- Initial Findings](http://arxiv.org/abs/2604.20436v1)
...
Selection reason: 用BDD/C4/ADR作为守护机制稳定agent行为，减少漂移，相关SE agent工作流。
...
### [29] [On the Informativeness of Security Commit Messages: A Large-scale Replication Study](http://arxiv.org/abs/2604.20461v1)
...
Selection reason: 安全提交信息充分性实证，可为agent生成提交信息提供参考。
...
### [30] [Deja Vu at Scale: Paraphrase-Robust Detection of Duplicate Gherkin Steps in Behaviour-Driven Software Testing with Sentence-Transformer Embeddings and a 1.1M-Step Open Benchmark](http://arxiv.org/abs/2604.20462v3)
...
Selection reason: BDD 步骤去重检测方法与 1.1M 步开放基准，可迁移到测试代码去重和 agent 生成测试的质量评估。
...
### [31] [Early-Stage Product Line Validation Using LLMs: A Study on Semi-Formal Blueprint Analysis](http://arxiv.org/abs/2604.20523v1)
...
Selection reason: 系统评估 12 个 LLM 在特性模型分析操作上的准确率与成本，为 LLM 做 SE 分析的 agent 提供评测与选型依据。
...
### [32] [DeepParse: Hybrid Log Parsing with LLM-Synthesized Regex Masks](http://arxiv.org/abs/2604.20553v1)
...
Selection reason: LLM 合成正则模板后交给 Drain 确定性执行，分离推理与执行，为 agent 工具设计提供低成本高可靠的范式。
...
### [33] [Evaluating Assurance Cases as Text-Attributed Graphs for Structure and Provenance Analysis](http://arxiv.org/abs/2604.20577v2)
...
Selection reason: 用 GNN 对 assurance case 做链接预测与人类/LLM 来源判别，方法可迁移到 agent 产出物的结构与溯源测评。
...
### [34] [QuanForge: A Mutation Testing Framework for Quantum Neural Networks](http://arxiv.org/abs/2604.20706v1)
...
Selection reason: 提出面向 QNN 的变异测试框架与统计变异击杀准则，随机性场景下的测试思想可借鉴到 agent 输出验证。
...
### [35] [Evaluating Software Defect Prediction Models via the Area Under the ROC Curve Can Be Misleading](http://arxiv.org/abs/2604.20742v1)
...
Selection reason: 指出用 AUC 评估缺陷预测模型可能误导，提出阈值相关可视化度量，对 agent/模型的性能评测方法有直接参考。
...
### [36] [Residual Risk Analysis in Benign Code: How Far Are We? A Multi-Model Semantic and Structural Similarity Approach](http://arxiv.org/abs/2604.21051v1)
...
Selection reason: 结合语义和 AST 结构相似性估计补丁后残余风险，可迁移到 agent 的漏洞修复后验证与优先级排序。
...
### [37] [Structural Quality Gaps in Practitioner AI Governance Prompts: An Empirical Study Using a Five-Principle Evaluation Framework](http://arxiv.org/abs/2604.21090v1)
*Christo Zietsman*
...
Selection reason: 对 AGENTS.md 治理提示做结构完整性评估，发现常见缺口，直接关系到 coding agent 行为约束与工程化。
...
### [38] [A Ground-Truth-Based Evaluation of Vulnerability Detection Across Multiple Ecosystems](http://arxiv.org/abs/2604.21111v1)
...
Selection reason: 基于 OSV 构建跨生态漏洞检测 ground-truth 并开源复现工具，为漏洞检测/修复 agent 提供评测基准。
...
### [39] [Meta-Tool: Efficient Few-Shot Tool Adaptation for Small Language Models](http://arxiv.org/abs/2604.20148v1)
*Sachin Kumar*
...
### [40] [WebGen-R1: Incentivizing Large Language Models to Generate Functional and Aesthetic Websites with Reinforcement Learning](http://arxiv.org/abs/2604.20398v1)
...
Selection reason: 端到端RL生成多页面网站代码，级联多模态奖励设计可迁移至代码生成。
...
### [41] [DialToM: A Theory of Mind Benchmark for Forecasting State-Driven Dialogue Trajectories](http://arxiv.org/abs/2604.20443v2)
...
### [43] [Exploiting LLM-as-a-Judge Disposition on Free Text Legal QA via Prompt Optimization](http://arxiv.org/abs/2604.20726v2)
...
### [44] [Using Machine Mental Imagery for Representing Common Ground in Situated Dialogue](http://arxiv.org/abs/2604.21144v1)
...
### [45] [Auditing and Controlling AI Agent Actions in Spreadsheets](http://arxiv.org/abs/2604.20070v1)
...
### [46] [IMPACT-CYCLE: A Contract-Based Multi-Agent System for Claim-Level Supervisory Correction of Long-Video Semantic Memory](http://arxiv.org/abs/2604.20136v1)
...
Selection reason: 提出程序执行双重推理benchmark，评测LLM动态代码理解，相关代码智能。
...
### [52] [Omission Constraints Decay While Commission Constraints Persist in Long-Context LLM Agents](http://arxiv.org/abs/2604.20911v1)
*Yeran Gamage*
...
### [53] [AgentSOC: A Multi-Layer Agentic AI Framework for Security Operations Automation](http://arxiv.org/abs/2604.20134v1)
...
### [54] [Taint-Style Vulnerability Detection and Confirmation for Node.js Packages Using LLM Agent Reasoning](http://arxiv.org/abs/2604.20179v1)
...
Selection reason: 多阶段LLM agent pipeline检测并生成PoC验证Node.js漏洞，直接相关安全代码agent。
...
### [55] [SafeRedirect: Defeating Internal Safety Collapse via Task-Completion Redirection in Frontier LLMs](http://arxiv.org/abs/2604.20930v1)
...
### [56] [Adaptive Defense Orchestration for RAG: A Sentinel-Strategist Architecture against Multi-Vector Attacks](http://arxiv.org/abs/2604.20932v1)
...
### [57] [AVISE: Framework for Evaluating the Security of AI Systems](http://arxiv.org/abs/2604.20833v2)
...
### [58] [Breaking MCP with Function Hijacking Attacks: Novel Threats for Function Calling and Agentic Models](http://arxiv.org/abs/2604.20994v1)
...
### [59] [Behavioral Consistency and Transparency Analysis on Large Language Model API Gateways](http://arxiv.org/abs/2604.21083v1)
...
Selection reason: 黑盒测量 LLM API 网关的模型替换、计费等不一致行为，为依赖网关的 coding agent 提供部署可靠性审计手段。
...
### [60] [Cross-Session Threats in AI Agents: Benchmark, Evaluation, and Algorithms](http://arxiv.org/abs/2604.21131v1)
*Ari Azarafrooz*
...
### [61] [Adaptive Instruction Composition for Automated LLM Red-Teaming](http://arxiv.org/abs/2604.21159v1)
...
### [62] [Trust, Lies, and Long Memories: Emergent Social Dynamics and Reputation in Multi-Round Avalon with LLM Agents](http://arxiv.org/abs/2604.20582v1)
*Suveen Ellawela*
...
### [63] [Anchor-and-Resume Concession Under Dynamic Pricing for LLM-Augmented Freight Negotiation](http://arxiv.org/abs/2604.20732v1)
...
### [64] [Cortex 2.0: Grounding World Models in Real-World Industrial Deployment](http://arxiv.org/abs/2604.20246v1)
...
### [65] [Bimanual Robot Manipulation via Multi-Agent In-Context Learning](http://arxiv.org/abs/2604.20348v2)
...
### [66] [MOMO: A framework for seamless physical, verbal, and graphical robot skill learning and adaptation](http://arxiv.org/abs/2604.20468v2)
...
### [67] [LLM-guided phase diagram construction through high-throughput experimentation](http://arxiv.org/abs/2604.20304v1)
...
### [68] [Coverage, Not Averages: Semantic Stratification for Trustworthy Retrieval Evaluation](http://arxiv.org/abs/2604.20763v1)
