...
### [1] [AgentCAT: Simulating Computerized Adaptive Testing via Multi-Agent Large Language Models](http://arxiv.org/abs/2606.21832v1)
...
### [2] [Measuring What Persists: Conditioning Mechanisms and a Geometric Framework for AI Agent Identity](http://arxiv.org/abs/2606.21843v1)
*Andrew Tanner*
...
### [3] [AgentRiskBOM: A Risk-Scoping Security Bill of Materials for Agentic AI Systems](http://arxiv.org/abs/2606.21877v1)
...
Selection reason: 提出agent系统安全BOM，用结构化权限与风险评估增强agent透明性，部分机制可迁移到agent可靠性工程。
...
### [4] [Learning the ARTS of Search for Automated Discovery](http://arxiv.org/abs/2606.21891v1)
...
### [5] [Holmes: Multimodal Agentic Diagnosis for Mixed-Language Mobile Crashes at Industrial Scale](http://arxiv.org/abs/2606.21963v1)
...
Selection reason: 工业级多agent系统用多模态运行信号做移动崩溃根因分析，检索-探索-推理架构可迁移到代码诊断。
...
### [6] [REBA: A Revealed Belief Automaton Framework for Online Planning in Continuous POMDPs](http://arxiv.org/abs/2606.21971v1)
...
### [7] [Human vs Machine Mathematical Difficulty on Project Euler: An Experimental Analysis](http://arxiv.org/abs/2606.21972v1)
...
### [8] [IRumAI: Reinforcement Learning for Indian Rummy](http://arxiv.org/abs/2606.21975v1)
*Vignesh Mohan*
...
### [9] [CFAgentBench: A Reproducible Environment and Benchmark for Autonomous Construction-Finance Agents](http://arxiv.org/abs/2606.22000v1)
*Rishi Srivastava*
...
Selection reason: 面向领域agent的可复现环境与benchmark，含功能正确性评估和风险护栏设计，评测方法论可迁移。
...
### [10] [When Does Belief-Based Agent Memory Help? Reliability-Conditional Updating and Provenance-Capped Poisoning Defense](http://arxiv.org/abs/2606.22030v2)
*Pranav Singh*
...
### [11] [When Does a Video-Language Model Stop Watching? Reward Strength Controls the Formation and Reversal of Visual Shortcuts in Multimodal RLVR](http://arxiv.org/abs/2606.22043v1)
*Zekun Xu*
...
### [12] [Can Reasoning Models Detect Changes to their Chains of Thought?](http://arxiv.org/abs/2606.22085v1)
...
### [13] [Interpreting Latent CoT Reasoning as Dynamical Systems](http://arxiv.org/abs/2607.09698v1)
...
### [14] [GitReq: A Gold Standard Dataset for Software Quality Requirements](http://arxiv.org/abs/2606.21810v1)
...
Selection reason: 构建软件质量需求（性能、安全等）标注数据集，为代码质量分析与需求分类提供可用benchmark。
...
### [15] [Steer, Don't Solve: Training Small Critic Models for Large Code Agents](http://arxiv.org/abs/2606.21811v1)
...
Selection reason: 训练小规模critic模型在轨迹内引导代码agent，显著提升SWE-bench性能并降低成本，直接可迁移。
...
### [16] [A11YRepair: Bridging Web Accessibility Barriers via Knowledge-Enhanced Divide-and-Conquer Repair](http://arxiv.org/abs/2606.21926v1)
...
Selection reason: LLM驱动的Web可访问性缺陷自动修复，用分治工作流和领域知识，对程序修复和多缺陷协调有迁移价值。
...
### [17] [CodeTeam: An LLM-Powered Multi-Agent Framework for Repository-Level Code Generation](http://arxiv.org/abs/2606.22082v1)
...
Selection reason: 面向仓库级代码生成的多agent框架，规划/决策/实现分离并有依赖调度与QA迭代，直接相关。
...
### [18] [TraceView: Interactive Visualization of Agentic Program Repair Trajectories](http://arxiv.org/abs/2606.22110v1)
...
Selection reason: 提供APR agent轨迹的可视化标注与诊断工具，帮助理解agent行为，对调试和分析agent有价值。
...
### [19] [Natural Language-Focused Software Engineering via Code-Documentation Equivalence](http://arxiv.org/abs/2606.22247v1)
...
Selection reason: 提出代码-文档等价性并自动生成等价文档，实验表明能提升LLM代码理解与编辑效果，可增强agent上下文。
...
### [20] [AgentDSE: Reasoning-Augmented Architectural Design Space Exploration](http://arxiv.org/abs/2606.21836v1)
...
### [21] [Harness-MU: A Safe, Governed, and Effective Harness for Multi-User LLM Agents](http://arxiv.org/abs/2606.21856v1)
...
### [22] [$π$-RAG: Oblivious Retrieval via Semantic Quantization and Transcendental Addressing for Large Language Models](http://arxiv.org/abs/2606.22153v1)
...
### [23] [Revelio: Cost-Efficient Agentic Memory Safety Vulnerability Detection For Repository-Scale Codebases](http://arxiv.org/abs/2606.22263v1)
...
Selection reason: agentic框架用可执行PoV和sanitizer验证内存安全漏洞，低成本高可信，直接面向代码安全agent。
...
### [24] [A Verifiable Search Is Not a Learnable Chain-of-Thought](http://arxiv.org/abs/2606.21884v1)
*Harsh Patel*
...
### [25] [Modularized Reinforcement Learning on LLMs: From MDP Creation to Exploration and Learning](http://arxiv.org/abs/2606.21943v1)
...
### [26] [Cluster-Specific Localized Drift Detection for Efficient Batch Model Adaptation under Controlled Distribution Shift](http://arxiv.org/abs/2606.22026v1)
...
### [27] [Gradient-Descent Steps to Success over Mean Accuracy: A Paradigm Shift for ML](http://arxiv.org/abs/2606.22053v1)
...
### [28] [Evolutional Math: Cross-Validated Island-Model Genetic Programming for Interpretable Symbolic Regression on Small, Wide Datasets](http://arxiv.org/abs/2606.28381v1)
*Artem Andrianov*

Main category: cs.NE

Comments: 12 pages, 3 figures. Reference implementation available at https://gitlab.com/cyntegrity/evomath
...
### [29] [RARM: Confidence-Gated Progress Reward Modeling for RL in Manipulation](http://arxiv.org/abs/2606.22027v2)
...
### [30] [NL2Scratch: An Executable Benchmark and Evaluation for Block-Based Programming](http://arxiv.org/abs/2606.22061v1)
...
### [31] [When Is Emergent Consensus Real? A Measured Coupling Gain and a Validity Diagnostic for LLM Agent Societies](http://arxiv.org/abs/2606.22203v1)
*Dongxu Yang*
...
### [32] [CNnotator: LLM-Guided Memory Safety Annotation Synthesis](http://arxiv.org/abs/2606.21822v1)
...
Selection reason: 用LLM自动生成并验证内存安全CN规约，结合测试/验证工具，对程序分析和agent验证有参考价值。
