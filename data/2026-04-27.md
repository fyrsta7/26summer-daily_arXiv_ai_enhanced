...
### [1] [Failure-Centered Runtime Evaluation for Deployed Trilingual Public-Space Agents](http://arxiv.org/abs/2604.23990v1)
*M. Meng*
...
### [2] [QED: An Open-Source Multi-Agent System for Generating Mathematical Proofs on Open Problems](http://arxiv.org/abs/2604.24021v4)
...
### [3] [AgentPulse: A Continuous Multi-Signal Framework for Evaluating AI Agents in Deployment](http://arxiv.org/abs/2604.24038v1)
...
Selection reason: 多信号持续评估agent部署表现，方法论对agent评测有迁移价值。
...
### [4] [A2DEPT: Large Language Model-Driven Automated Algorithm Design via Evolutionary Program Trees](http://arxiv.org/abs/2604.24043v1)
...
### [5] [Explanation Quality Assessment as Ranking with Listwise Rewards](http://arxiv.org/abs/2604.24176v1)
...
### [6] [Adaptive ToR: Complexity-Aware Tree-Based Retrieval for Pareto-Optimal Multi-Intent NLU](http://arxiv.org/abs/2604.24219v1)
...
### [7] [PhysNote: Self-Knowledge Notes for Evolvable Physical Reasoning in Vision-Language Model](http://arxiv.org/abs/2604.24443v1)
...
### [8] [Agentic clinical reasoning over longitudinal myeloma records: a retrospective evaluation against expert consensus](http://arxiv.org/abs/2604.24473v1)
...
### [9] [Beyond the Attention Stability Boundary: Agentic Self-Synthesizing Reasoning Protocols](http://arxiv.org/abs/2604.24512v1)
...
### [10] [Interoceptive machine framework: Toward interoception-inspired regulatory architectures in artificial intelligence](http://arxiv.org/abs/2604.24527v1)
*Diego Candia-Rivera*
...
### [11] [STELLAR-E: a Synthetic, Tailored, End-to-end LLM Application Rigorous Evaluator](http://arxiv.org/abs/2604.24544v1)
...
### [12] [Hierarchical Behaviour Spaces](http://arxiv.org/abs/2604.24558v1)
...
### [13] [FastOMOP: A Foundational Architecture for Reliable Agentic Real-World Evidence Generation on OMOP CDM data](http://arxiv.org/abs/2604.24572v1)
...
### [14] [Evaluating whether AI models would sabotage AI safety research](http://arxiv.org/abs/2604.24618v1)
...
### [15] [XGRAG: A Graph-Native Framework for Explaining KG-based Retrieval-Augmented Generation](http://arxiv.org/abs/2604.24623v1)
...
### [16] [The Price of Agreement: Measuring LLM Sycophancy in Agentic Financial Applications](http://arxiv.org/abs/2604.24668v3)
...
### [17] [Governing What You Cannot Observe: Adaptive Runtime Governance for Autonomous AI Agents](http://arxiv.org/abs/2604.24686v1)
...
### [18] [Can Current Agents Close the Discovery-to-Application Gap? A Case Study in Minecraft](http://arxiv.org/abs/2604.24697v2)
...
### [19] [Co-Director: Agentic Generative Video Storytelling](http://arxiv.org/abs/2604.24842v1)
...
### [20] [Latent Agents: A Post-Training Procedure for Internalized Multi-Agent Debate](http://arxiv.org/abs/2604.24881v1)
...
### [21] [Sparse Personalized Text Generation with Multi-Trajectory Reasoning](http://arxiv.org/abs/2604.24996v1)
...
### [22] [Toward a Science of Intent: Closure Gaps and Delegation Envelopes for Open-World AI Agents](http://arxiv.org/abs/2604.25000v2)
...
Selection reason: 提出闭包差距与委托包络概念，为开放世界agent的验证与部署提供理论框架，可启发代码agent的规划。
...
### [23] [Leverage Laws: A Per-Task Framework for Human-Agent Collaboration](http://arxiv.org/abs/2604.25040v1)
*Stan Loosmore*
...
### [24] [Constraint-Guided Multi-Agent Decompilation for Executable Binary Recovery](http://arxiv.org/abs/2604.23940v2)
...
Selection reason: 多agent反编译，使用约束引导验证，对代码生成和验证有直接价值。
...
### [25] [Vulnerability Identification by Harnessing Inter-connected Multi-Source Information](http://arxiv.org/abs/2604.24028v2)
...
Selection reason: 利用多源信息识别漏洞，对程序分析和漏洞检测有参考价值。
...
### [26] [Empowering Autonomous Debugging Agents with Efficient Dynamic Analysis](http://arxiv.org/abs/2604.24212v1)
...
Selection reason: 为调试agent设计基于函数级执行轨迹的高效动态分析接口，在SWE-bench上显著提升修复率并降低成本，直接相关。
...
### [27] [RefEvo: Agentic Design with Co-Evolutionary Verification for Agile Reference Model Generation](http://arxiv.org/abs/2604.24218v1)
...
Selection reason: 多agent动态规划与协同进化验证的LLM代码生成框架，验证与上下文压缩机制可迁移到硬件或软件代码生成agent。
...
### [28] [Learning from Execution: Self-Evolving Memory for Private-Library Code Generation](http://arxiv.org/abs/2604.24222v3)
...
Selection reason: 针对私有库代码生成的自演化记忆框架，将执行反馈组织为多层级使用指南，直接增强RAG代码生成。
...
### [29] [SWE-QA: A Dataset and Benchmark for Complex Code Understanding](http://arxiv.org/abs/2604.24814v1)
...
Selection reason: 构建多跳代码理解数据集与评测基准，直接面向复杂代码理解与模型评测，可用于代码agent推理与检索能力评估。
...
### [30] [On the Footprints of Reviewer Bots Feedback on Agentic Pull Requests in OSS GitHub Repositories](http://arxiv.org/abs/2604.24450v1)
...
Selection reason: 实证分析reviewer bot对agentic PR结果的影响，为coding agent工作流中的评审反馈策略提供参考依据。
...
### [31] [Understanding the Limits of Automated Evaluation for Code Review Bots in Practice](http://arxiv.org/abs/2604.24525v1)
...
Selection reason: 工业环境下自动化代码评审bot的评估局限研究，对LLM代码评审agent的评测方法与标签设计有直接参考价值。
...
### [32] [Mono2Sls: Automated Monolith-to-Serverless Migration via Multi-Stage Pipeline with Static Analysis](http://arxiv.org/abs/2604.24550v1)
...
Selection reason: 多阶段静态分析加多LLM agent的自动迁移管线，agent协作、中间产物与验证机制可直接借鉴。
...
### [33] [Measuring the Unmeasurable: Markov Chain Reliability for LLM Agents](http://arxiv.org/abs/2604.24579v1)
...
Selection reason: 用马尔可夫链统一agent执行轨迹可靠性指标并给出拟合与不确定性检验，可迁移到代码agent评测。
...
### [34] [Evaluation of LLM-Based Software Engineering Tools: Practices, Challenges, and Future Directions](http://arxiv.org/abs/2604.24621v1)
...
Selection reason: 系统讨论LLM软件工程工具评测的挑战与方向，对code agent benchmark设计与评估有指导价值。
...
### [35] [Leveraging LLMs for Multi-File DSL Code Generation: An Industrial Case Study](http://arxiv.org/abs/2604.24678v1)
...
Selection reason: 工业DSL多文件代码生成的LLM适配与评测案例，涉及结构化表示、微调与执行验证，对代码生成agent有迁移价值。
...
### [36] [Defective Task Descriptions in LLM-Based Code Generation: Detection and Analysis](http://arxiv.org/abs/2604.24703v1)
...
Selection reason: 检测任务描述缺陷的轻量分类器并分析缺陷对LLM代码生成的影响，可直接提升代码生成agent的输入鲁棒性。
...
### [37] [When Prompt Under-Specification Improves Code Correctness: An Exploratory Study of Prompt Wording and Structure Effects on LLM-Based Code Generation](http://arxiv.org/abs/2604.24712v1)
*Amal AKLI,Mike PAPADAKIS,Maxime CORDY,Yves Le TRAON*
...
Selection reason: 研究提示词欠规格对LLM代码生成正确性的影响，提供写鲁棒prompt的实践经验，对代码生成agent有参考价值。
...
### [38] [FGDM: Reasoning Aware Multi-Agentic Framework for Software Bug Detection using Chain of Thought and Tree of Thought Prompting](http://arxiv.org/abs/2604.24831v1)
...
Selection reason: 提出基于CoT/ToT的多智能体框架用于软件bug检测与修复，直接涉及代码agent的推理与修复机制。
...
### [39] [From Heuristics to Transformers: A Comprehensive Survey of Type Inference from Stripped Binaries](http://arxiv.org/abs/2606.23692v1)
...
Selection reason: 二进制类型推断综述，虽偏逆向工程，但其中神经符号方法可启发代码理解与agent的语义分析。
...
### [40] [Large Language Models for Multilingual Code Intelligence: A Survey](http://arxiv.org/abs/2604.25960v1)
...
Selection reason: 综述多语言代码生成与翻译，涉及跨语言泛化，对多语言代码agent有直接参考价值。
...
### [41] [Context-Augmented Code Generation: How Product Context Improves AI Coding Agent Decision Compliance by 49%](http://arxiv.org/abs/2605.08112v1)
...
Selection reason: 研究产品上下文检索对AI coding agent决策合规性的提升，直接涉及代码agent的上下文增强与测评。
...
### [42] [MultiHedge: Adaptive Coordination via Retrieval-Augmented Control](http://arxiv.org/abs/2604.24905v1)
...
### [43] [Frontier Coding Agents Can Now Implement an AlphaZero Self-Play Machine Learning Pipeline For Connect Four That Performs Comparably to an External Solver](http://arxiv.org/abs/2604.25067v2)
...
### [44] [Update Opacity: Epistemic Accessibility and Governance Under AI System Change](http://arxiv.org/abs/2606.00037v1)
...
### [45] [GLM-5 Serving Parameter Tuning for OpenClaw: Single-Deployment MaaS Inference Optimization for Long-Context Agent Workloads](http://arxiv.org/abs/2607.02518v1)
*Minjie Hua,Ning Wang,Peijun Yang,Kai Wang,Shiguo Lian*

Main category: cs.DC

Comments: 10 pages, 3 figures, 2 tables; technical report
...
### [46] [From Skill Text to Skill Structure: The Scheduling-Structural-Logical Representation for Agent Skills](http://arxiv.org/abs/2604.24026v4)
...
### [47] [Thoughts-as-Planning: Latent World Models for Chain-of-Thoughts Optimization via Reinforcement Planning](http://arxiv.org/abs/2605.28842v1)
...
### [48] [AdapTime: Enabling Adaptive Temporal Reasoning in Large Language Models](http://arxiv.org/abs/2604.24175v1)
...
### [49] [MultiDx: A Multi-Source Knowledge Integration Framework towards Diagnostic Reasoning](http://arxiv.org/abs/2604.24186v1)
...
### [50] [Rewarding the Scientific Process: Process-Level Reward Modeling for Agentic Data Analysis](http://arxiv.org/abs/2604.24198v2)
...
### [51] [SeaEvo: Advancing Algorithm Discovery with Strategy Space Evolution](http://arxiv.org/abs/2604.24372v2)
...
### [52] [Aligned Multi-View Scripts for Universal Chart-to-Code Generation](http://arxiv.org/abs/2604.24559v1)
...
### [53] [Skill Retrieval Augmentation for Agentic AI](http://arxiv.org/abs/2604.24594v3)
...
### [54] [Less is More: Lightweight Prompt Compression for Question Answering Applications on Edge Devices](http://arxiv.org/abs/2606.20571v1)
...
### [55] [Green Shielding: A User-Centric Approach Towards Trustworthy AI](http://arxiv.org/abs/2604.24700v1)
...
### [56] [Large Language Models Explore by Latent Distilling](http://arxiv.org/abs/2604.24927v1)
...
### [57] [GAIA-v2-LILT: Multilingual Adaptation of Agent Benchmark beyond Translation](http://arxiv.org/abs/2604.24929v1)
...
### [58] [BenchGuard: Who Guards the Benchmarks? Automated Auditing of LLM Agent Benchmarks](http://arxiv.org/abs/2604.24955v1)
...
Selection reason: 提出BenchGuard自动化审计LLM agent benchmark，直接针对agent评估基础设施，对构建可靠benchmark有重要价值。
...
### [59] [Dont Stop Early: Scalable Enterprise Deep Research with Controlled Information Flow and Evidence-Aware Termination](http://arxiv.org/abs/2604.24978v1)
...
Selection reason: 提出企业深度研究agent架构，包含信息流控制和证据感知终止，这些工作流机制可迁移到长程代码agent。
...
### [60] [Faithful Autoformalization via Roundtrip Verification and Repair](http://arxiv.org/abs/2604.25031v2)
...
### [61] [Dual-Track CoT: Budget-Aware Stepwise Guidance for Small LMs](http://arxiv.org/abs/2604.25039v1)
...
### [62] [Strategic Bidding in 6G Spectrum Auctions with Large Language Models](http://arxiv.org/abs/2604.24156v1)
...
### [63] [Fix Initial Programs and Iteratively Refine Repair Instructions Toward Non-Elimination Multi-Turn Program Correction](http://arxiv.org/abs/2604.23989v2)
...
### [64] [TCOD: Exploring Temporal Curriculum in On-Policy Distillation for Multi-turn Autonomous Agents](http://arxiv.org/abs/2604.24005v3)
...
### [65] [AgenticCache: Cache-Driven Asynchronous Planning for Embodied AI Agents](http://arxiv.org/abs/2604.24039v1)
...
### [66] [Meta-Aligner: Bidirectional Preference-Policy Optimization for Multi-Objective LLMs Alignment](http://arxiv.org/abs/2604.24178v1)
...
### [67] [GradMAP: Gradient-Based Multi-Agent Proximal Learning for Grid-Edge Flexibility](http://arxiv.org/abs/2604.24549v1)
...
### [68] [Cortex-Inspired Continual Learning: Unsupervised Instantiation and Recovery of Functional Task Networks](http://arxiv.org/abs/2604.24637v2)
...
### [69] [Learning to Think from Multiple Thinkers](http://arxiv.org/abs/2604.24737v1)
...
### [70] [Nemotron 3 Nano Omni: Efficient and Open Multimodal Intelligence](http://arxiv.org/abs/2604.24954v2)
...
### [71] [Compute Aligned Training: Optimizing for Test Time Inference](http://arxiv.org/abs/2604.24957v2)
...
### [72] [Poster: ClawdGo: Endogenous Security Awareness Training for Autonomous AI Agents](http://arxiv.org/abs/2604.24020v1)
...
### [73] [Evaluating Cryptographic API Misuse Detectors for Go](http://arxiv.org/abs/2604.24085v1)
*Vivi Andersson,Martin Monperrus*

Main category: cs.CR

Comments: 8 pages. Accepted at SVM '26 (ICSE workshop)

Selection reason: Go加密API误用检测器评估，提供分类法和实证，对测试工具开发有参考价值。
...
### [75] [MAS-SZZ: Multi-Agentic SZZ Algorithm for Vulnerability-Inducing Commit Identification](http://arxiv.org/abs/2604.24398v1)
...
Selection reason: 多agent协作的漏洞引入提交定位算法，将agent用于代码历史与变更分析，对安全分析agent有迁移价值。
...
### [76] [GAMMAF: A Common Framework for Graph-Based Anomaly Monitoring Benchmarking in LLM Multi-Agent Systems](http://arxiv.org/abs/2604.24477v1)
...
### [77] [A Comparative Evaluation of AI Agent Security Guardrails](http://arxiv.org/abs/2604.24826v1)
...
### [78] [AgentWard: A Lifecycle Security Architecture for Autonomous AI Agents](http://arxiv.org/abs/2604.24657v1)
...
### [79] [SUDP: Secret-Use Delegation Protocol for Agentic Systems](http://arxiv.org/abs/2604.24920v3)
