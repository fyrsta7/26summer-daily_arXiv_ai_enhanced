...
### [1] [The Containment Gap: How Deployed Agentic AI Frameworks Fail Public-Facing Safety Requirements](http://arxiv.org/abs/2606.12797v1)
...
### [2] [GUITrans2Act: Understanding User Operational Behaviors from Mobile GUI Interactions with Vision-Language Models](http://arxiv.org/abs/2606.12817v2)
...
### [3] [GeoNatureAgent Benchmark: Benchmarking LLM Agents for Environmental Geospatial Analysis Across Frontier and Open-Weight Foundation Models](http://arxiv.org/abs/2606.12821v1)
...
### [4] [Fantastic Scientific Agents and How to Build Them: AgentBuild for Rietveld Refinement](http://arxiv.org/abs/2606.12834v1)
...
### [5] [(Human) Attention Is (Still) All You Need: Human oversight makes AI-assisted social science reliable](http://arxiv.org/abs/2606.12848v1)
...
### [6] [WISE: A Long-Horizon Agent in Minecraft with Why-Which Reasoning](http://arxiv.org/abs/2606.12852v1)
...
### [7] [DailyReport: An Open-ended Benchmark for Evaluating Search Agents on Daily Search Tasks](http://arxiv.org/abs/2606.12871v1)
...
### [8] [HarnessBridge: Learnable Bidirectional Controller for LLM Agent Harness](http://arxiv.org/abs/2606.12882v1)
...
### [9] [MDForge: Agentic Molecular Dynamics Pipeline Design under Sparse Simulator Feedback](http://arxiv.org/abs/2606.12916v1)
...
### [10] [Iterating Toward Better Search: A Two-Agent Simulation Framework for Evaluating Agentic Search Architectures in E-Commerce](http://arxiv.org/abs/2606.12924v1)
...
### [11] [Learning What to Remember: A Cognitively Grounded Multi-Factor Value Model for Agentic Memory](http://arxiv.org/abs/2606.12945v2)
...
### [12] [Structured Testbench Generation for LLM-Driven HDL Design and Verification-Oriented Data Curation](http://arxiv.org/abs/2606.12983v1)
...
### [13] [The Illusion of Multi-Agent Advantage](http://arxiv.org/abs/2606.13003v2)
...
### [14] [Nous: An Attempt to Extract and Inject the Cognition Behind Prediction-Market Behavior](http://arxiv.org/abs/2606.13038v1)
*Haowei Qian*
...
### [15] [YeasierAgent: Agentic Social Sandbox as a Canvas for Intent-Driven Creation of Platform-Agnostic Symbiotic Agent-Native Applications](http://arxiv.org/abs/2606.13722v1)
*Jory He*
...
### [16] [Rethinking RAG in Long Videos: What to Retrieve and How to Use It?](http://arxiv.org/abs/2606.13141v1)
...
### [17] [TerraBench: Can Agents Reason Over Heterogeneous Earth-System Data?](http://arxiv.org/abs/2606.13148v2)
...
### [18] [ARMOR-MAD: Adaptive Routing for Heterogeneous Multi-Agent Debate in Large Language Model Reasoning](http://arxiv.org/abs/2606.13197v1)
...
### [19] [LLM-as-an-Investigator: Evidence-First Reasoning for Robust Interactive Problem Diagnosis](http://arxiv.org/abs/2606.13220v1)
...
### [20] [TwinBI: An Agentic Digital Twin for Efficient Augmented Interactions with Business Intelligence Dashboards](http://arxiv.org/abs/2606.13731v1)
...
### [21] [From Verdict to Process: Agentic Reinforcement Learning for Multi-Stage Fact Verification](http://arxiv.org/abs/2606.13262v1)
...
### [22] [ReSum: Synergizing LLM Reasoning and Summarization with Reinforcement Learning](http://arxiv.org/abs/2606.13316v1)
...
### [23] [IterCAD: An Iterative Multimodal Agent for Visually-Grounded CAD Generation and Editing](http://arxiv.org/abs/2606.13368v2)
...
### [24] [Neuro-Symbolic Agents for Regulated Process Automation: Challenges and Research Agenda](http://arxiv.org/abs/2606.13405v2)
...
### [25] [Uncertainty-Aware Hybrid Retrieval for Long-Document RAG](http://arxiv.org/abs/2606.13550v1)
...
### [26] [A Three-Layer Framework for AI in Scientific Discovery](http://arxiv.org/abs/2606.13566v2)
*Guojun Liao*
...
### [27] [Multiagent Protocols with Aggregated Confidence Signals](http://arxiv.org/abs/2606.13591v1)
...
### [28] [Reward Modeling for Multi-Agent Orchestration](http://arxiv.org/abs/2606.13598v1)
...
### [29] [EpiBench: Verifiable Evaluation of AI Agents on Epigenomics Analysis](http://arxiv.org/abs/2606.13602v1)
...
### [30] [AgentBeats: Agentifying Agent Assessment for Openness, Standardization, and Reproducibility](http://arxiv.org/abs/2606.13608v2)
...
### [31] [EurekAgent: Agent Environment Engineering is All You Need For Autonomous Scientific Discovery](http://arxiv.org/abs/2606.13662v2)
...
### [32] [Agents-K1: Towards Agent-native Knowledge Orchestration](http://arxiv.org/abs/2606.13669v3)
...
### [33] [Poker Arena: Multi-Axis Profiling of Strategic Reasoning and Memory in LLMs](http://arxiv.org/abs/2606.13815v1)
...
### [34] [Capability Minimization as a Safety Primitive: Risk-Aware Causal Gating for Least-Privilege LLM Agents](http://arxiv.org/abs/2606.13884v1)
...
### [35] [A Multi-Agent AI System for Automated High School Transcript Processing: Collaborative Document Analysis at Scale](http://arxiv.org/abs/2606.13916v1)
...
### [36] [Sorries Are Not the Hard Part: An Expert-Review Case Study of a Semi-Autonomous Formalization](http://arxiv.org/abs/2606.13925v1)
...
### [37] [Minim: Privacy-Aware Minimal View for Agents via Trusted Local Sanitization](http://arxiv.org/abs/2606.13949v1)
...
### [38] [Beyond Problem Solving: UOJ-Bench for Evaluating Code Generation, Hacking, and Repair in Competitive Programming](http://arxiv.org/abs/2606.12864v1)
...
Selection reason: 包含代码生成、破解与修复三任务的竞赛编程基准，直接评测 LLM 的编程与调试能力。
...
### [39] [ComAct: Reframing Professional Software Manipulation via COM-as-Action Paradigm](http://arxiv.org/abs/2606.13239v2)
...
Selection reason: 提出 COM-as-Action 范式，以确定性程序合成替代 GUI 控制，为 agent 操作软件提供新思路。
...
### [40] [Mining Architectural Quality Under Agentic AI Adoption: A Causal Study of Java Repositories](http://arxiv.org/abs/2606.13298v1)
...
Selection reason: 对 agentic AI 采用前后架构质量进行因果分析，揭示密度指标的误导性，对智能体影响评估有参考。
...
### [41] [Faster Code, Deeper Debt? A Multivocal Literature Review on Technical Debt and Its Early Signs in LLM-Assisted Software Development](http://arxiv.org/abs/2606.14796v1)
...
Selection reason: 综述 LLM 辅助开发引入的技术债务及早期迹象，总结了策略与工具，对构建可靠 agent 工作流有参考。
...
### [42] [Toward Instructions-as-Code: Understanding the Impact of Instruction Files on Agentic Pull Requests](http://arxiv.org/abs/2606.13449v1)
...
Selection reason: 分析指令文件对 agentic PR 成功率的影响，发现长且结构化指令更有效，直接指导 rules 设计。
...
### [43] [Understanding the Rejection of Fixes Generated by Agentic Pull Requests -- Insights from the AIDev Dataset](http://arxiv.org/abs/2606.13468v1)
...
Selection reason: 定性分析 agentic PR 修复被拒绝的 14 种原因，为改进 agent 修复能力提供实证依据。
...
### [44] [Do programming languages still matter to your AI coding agent teammate? Evidence at scale from chess engines](http://arxiv.org/abs/2606.13763v1)
...
Selection reason: 大规模研究 coding agent 跨 17 种语言生成国际象棋引擎的能力与成本，揭示语言选择对性能的影响。
...
### [45] [An Empirical Study of Gemini 3 for Detecting Natural Language Test Smells in Manual Test Cases](http://arxiv.org/abs/2606.13804v1)
...
Selection reason: 使用大模型检测自然语言测试用例中的测试坏味道，相比小模型效果更优，可迁移到测试分析 agent。
...
### [46] [Bayesian-Calibrated Detection of Hallucinated Package Imports in AI-Assisted Code](http://arxiv.org/abs/2606.13918v1)
...
Selection reason: 为 LLM 生成代码中的幻觉包导入检测增加贝叶斯校准层，可提升代码 agent 的依赖可靠性。
...
### [47] [Knowledge-Based Zero-Replay Debugging of Multi-Agent LLM Traces](http://arxiv.org/abs/2606.14805v1)
...
Selection reason: 提出零重放预测多 agent 轨迹中关键事件的方法，显著提升调试定位效率，对 agent 运维有直接价值。
...
### [48] [Agentic MPC for Semantic Control System Resynthesis](http://arxiv.org/abs/2606.12774v1)
...
### [49] [An LLM System for Autonomous Variational Quantum Circuit Design](http://arxiv.org/abs/2606.13380v1)
...
### [50] [Adaptive Turn-Taking for Real-time Multi-Party Voice Agents](http://arxiv.org/abs/2606.13544v3)
...
### [51] [Perceive, Interact, Reason: Building Tool-Augmented Visual Agents for Spatial Reasoning](http://arxiv.org/abs/2606.12830v1)
...
### [52] [Efficient Reinforcement for Visual-Textual Thinking with Discrete Diffusion Model](http://arxiv.org/abs/2606.14792v1)
...
### [53] [Iterative Visual Thinking and the Self-Correction Mirage in VLM Grounding](http://arxiv.org/abs/2606.13156v2)
...
### [54] [SpatialClaw: Rethinking Action Interface for Agentic Spatial Reasoning](http://arxiv.org/abs/2606.13673v1)
...
### [55] [Carolina Guide: A Multi-Agent RAG System with Institutional Guardrails for Academic Policy Assistance](http://arxiv.org/abs/2606.28360v1)
...
### [56] [STREAM: Multi-Tier LLM Inference Middleware with Dual-Channel HPC Token Streaming](http://arxiv.org/abs/2606.13968v1)
...
### [57] [VHDLSuite: Unified Pipeline for LLM VHDL Generation with Data Synthesis and Evaluation](http://arxiv.org/abs/2606.13735v1)
...
### [58] [The Price of Anarchy in Disaggregated Inference](http://arxiv.org/abs/2606.17081v1)
*Athos Georgiou*
...
### [59] [SpheriCity: Designing Trustworthy Conversational AI for Sustainability Decision Support](http://arxiv.org/abs/2606.13854v1)
...
### [60] [The Silent Cost of Artificial Intelligence Assistance: A Theory of Autonomy Surrender, the Recovery Mechanism, and the Restoration of Human Agency](http://arxiv.org/abs/2606.13962v1)
...
### [61] [G-Long: Graph-Enhanced Memory Management for Efficient Long-Term Dialogue Agents](http://arxiv.org/abs/2606.13115v1)
...
### [62] [MemRefine: LLM-Guided Compression for Long-Term Agent Memory](http://arxiv.org/abs/2606.13177v1)
...
### [63] [Ontology Memory-Augmented ASR Correction for Long Text-Speech Interleaved Conversations](http://arxiv.org/abs/2606.13464v2)
...
### [64] [ArogyaSutra: A Multi-Agent Framework for Multimodal Medical Reasoning in Indic Languages](http://arxiv.org/abs/2606.13572v2)
...
### [65] [LabVLA: Grounding Vision-Language-Action Models in Scientific Laboratories](http://arxiv.org/abs/2606.13578v2)
...
### [66] [Learning to Reason by Analogy via Retrieval-Augmented Reinforcement Fine-Tuning](http://arxiv.org/abs/2606.13680v1)
...
### [67] [SANA: What Matters for QA Agents over Massive Data Lakes?](http://arxiv.org/abs/2606.13904v1)
...
### [68] [The Internet of Agentic AI: Communication, Coordination, and Collective Intelligence at Scale](http://arxiv.org/abs/2606.12835v1)
*Quanyan Zhu*
...
### [69] [Safety-Contract Graph Multi-Agent Reinforcement Learning for Autonomous Network Security Response](http://arxiv.org/abs/2606.13832v1)
...
### [70] [MAStrike: Shapley-Guided Collusive Red-Teaming on Multi-Agent Systems](http://arxiv.org/abs/2606.12918v2)
...
### [71] [DIG: Oracle-Guided Directed Input Generation for One-Day Vulnerabilities](http://arxiv.org/abs/2606.13037v1)
...
Selection reason: 利用 LLM 和 oracle 引导生成漏洞利用输入，显著加速 PoC 构造，对安全分析与 agent 验证有借鉴。
...
### [72] [The Emergence of Autonomous Penetration Capabilities in Large Language Model-Powered AI Systems](http://arxiv.org/abs/2606.13079v2)
...
### [73] [FreoStream:Enhancing Stream Guardrails via Future-Aware Reasoning and Safety-Aligned Optimization](http://arxiv.org/abs/2606.13737v1)
...
### [74] [Who Pays the Price? Stakeholder-Centric Prompt Injection Benchmarking for Real-world Web Agents](http://arxiv.org/abs/2606.13385v1)
...
### [75] [SEVRA-BENCH: Social Engineering of Vulnerabilities in Review Agents](http://arxiv.org/abs/2606.13757v2)
...
### [76] [Select and Improve: Understanding the Mechanics of Post-Training for Reasoning](http://arxiv.org/abs/2606.13125v1)
...
### [77] [MaxProof: Scaling Mathematical Proof with Generative-Verifier RL and Population-Level Test-Time Scaling](http://arxiv.org/abs/2606.13473v1)
...
### [78] [Beyond the Commitment Boundary: Probing Epiphenomenal Chain-of-Thought in Large Reasoning Models](http://arxiv.org/abs/2606.13603v1)
...
### [79] [Human-like autonomy emerges from self-play and a pinch of human data](http://arxiv.org/abs/2606.19370v1)
...
### [80] [cAPM: Continual AI-Assisted Pace-Mapping with Active Learning](http://arxiv.org/abs/2606.19373v1)
...
### [83] [XFlow: An Executable Protocol Programming System for Reliable Multi-Agent Workflows](http://arxiv.org/abs/2606.14790v1)
...
### [84] [Functional Cache Grafting: Robust and Rapid Code-Policy Synthesis for Embodied Agents](http://arxiv.org/abs/2606.13097v1)
...
### [85] [AgentRivet: an automated system for producing Rivet routines from journal publications](http://arxiv.org/abs/2606.13535v3)
