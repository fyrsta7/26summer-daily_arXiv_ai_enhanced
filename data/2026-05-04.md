...
### [1] [Planner Matters! An Efficient and Unbalanced Multi-agent Collaboration Framework for Long-horizon Planning](http://arxiv.org/abs/2605.02168v1)
...
### [2] [Retrieval and Multi-Hop Reasoning in 1M-Token Context Windows: Evaluating LLMs on Classical Chinese Text](http://arxiv.org/abs/2605.02173v1)
*Eric H. C. Chow*
...
### [3] [T$^2$PO: Uncertainty-Guided Exploration Control for Stable Multi-Turn Agentic Reinforcement Learning](http://arxiv.org/abs/2605.02178v1)
...
### [4] [MEMAUDIT: An Exact Package-Oracle Evaluation Protocol for Budgeted Long-Term LLM Memory Writing](http://arxiv.org/abs/2605.02199v1)
...
### [5] [Submodular Benchmark Selection](http://arxiv.org/abs/2605.02209v1)
*Alexander Smola*
...
### [6] [Perturbation Dose Responses in Recursive LLM Loops: Raw Switching, Stochastic Floors, and Persistent Escape under Append, Replace, and Dialog Updates](http://arxiv.org/abs/2605.02236v2)
*Pawel Kaplanski*

Main category: cs.AI

Comments: 93 pages, 32 figures. Code, configurations, trajectories, and aggregated reports: https://github.com/kaplan196883/llmattr
...
### [7] [ANNEAL: Adapting LLM Agents via Governed Symbolic Patch Learning](http://arxiv.org/abs/2605.16309v2)
...
### [8] [PhysicianBench: Evaluating LLM Agents in Real-World EHR Environments](http://arxiv.org/abs/2605.02240v1)
...
### [9] [Zero-Shot Confidence Estimation for Small LLMs: When Supervised Baselines Aren't Worth Training](http://arxiv.org/abs/2605.02241v3)
*Luong N. Nguyen*
...
### [10] [A Study of Belief Revision Postulates in Multi-Agent Systems (Extended Version)](http://arxiv.org/abs/2605.02249v2)
...
### [11] [Towards Understanding Specification Gaming in Reasoning Models](http://arxiv.org/abs/2605.02269v1)
...
### [12] [EngiAgent: Fully Connected Coordination of LLM Agents for Solving Open-ended Engineering Problems with Feasible Solutions](http://arxiv.org/abs/2605.02289v1)
...
### [13] [A Compound AI Agent for Conversational Grant Discovery](http://arxiv.org/abs/2605.02366v1)
*Zhisheng Tang,Mayank Kejriwal*

Main category: cs.AI

Comments: accepted as demo submission to ACM CAIS
...
### [14] [Verifiable Counterfactual Supervision for Process Reward Models](http://arxiv.org/abs/2605.02395v3)
...
### [15] [HeavySkill: Heavy Thinking as the Inner Skill in Agentic Harness](http://arxiv.org/abs/2605.02396v1)
...
### [16] [FitText: Evolving Agent Tool Ecologies via Memetic Retrieval](http://arxiv.org/abs/2605.02411v2)
...
### [17] [The Model Knows, the Decoder Finds: Future Value Guided Particle Power Sampling](http://arxiv.org/abs/2605.02427v3)
...
### [18] [Measuring AI Reasoning: A Guide for Researchers](http://arxiv.org/abs/2605.02442v1)
...
### [19] [Position: How can Graphs Help Large Language Models?](http://arxiv.org/abs/2605.02452v1)
*Xiyuan Wang,Yi Hu,Yanbo Wang,Chuan Shi,Muhan Zhang*

Main category: cs.AI

Comments: The article has been accepted by Frontiers of Computer Science (FCS), with the DOI: {10.1007/s11704-026-51651-6}
...
### [20] [GRAIL: A Deep-Granularity Hybrid Resonance Framework for Real-Time Agent Discovery via SLM-Enhanced Indexing](http://arxiv.org/abs/2605.02489v2)
*Jinliang Xu*
...
### [21] [DataClawBench: An Agent Benchmark for Exploratory Real-World Financial Data Analysis](http://arxiv.org/abs/2605.02503v3)
...
### [22] [Strategy-Aware Optimization Modeling with Reasoning LLMs](http://arxiv.org/abs/2605.02545v1)
...
### [23] [On Training Large Language Models for Long-Horizon Tasks: An Empirical Study of Horizon Length](http://arxiv.org/abs/2605.02572v1)
...
### [24] [Foundation-Model-Based Agents in Industrial Automation: Purposes, Capabilities, and Open Challenges](http://arxiv.org/abs/2605.02592v1)
...
### [25] [Counterfactual Reasoning in Automated Planning](http://arxiv.org/abs/2605.02603v1)
...
### [26] [AcademiClaw: When Students Set Challenges for AI Agents](http://arxiv.org/abs/2605.02661v1)
...
### [27] [Hybrid Inspection and Task-Based Access Control in Zero-Trust Agentic AI](http://arxiv.org/abs/2605.02682v1)
*Majed El Helou,Benjamin Ryder,Chiara Troiani,Jean Diaconu,Hervé Muyal,Marcelo Yannuzzi*

Main category: cs.AI

Comments: Paper page at https://outshift-open.github.io/tbac-research-datasets
...
### [29] [Mitigating Misalignment Contagion by Steering with Implicit Traits](http://arxiv.org/abs/2605.02751v2)
...
### [30] [U-Define: Designing User Workflows for Hard and Soft Constraints in LLM-Based Planning](http://arxiv.org/abs/2605.02765v1)
...
### [31] [SCPRM: A Schema-aware Cumulative Process Reward Model for Knowledge Graph Question Answering](http://arxiv.org/abs/2605.02819v1)
...
### [32] [Hidden Coalitions in Multi-Agent AI: A Spectral Diagnostic from Internal Representations](http://arxiv.org/abs/2605.06696v1)
...
### [33] [Standing on the Shoulders of Giants: Stabilized Knowledge Distillation for Cross--Language Code Clone Detection](http://arxiv.org/abs/2605.02860v1)
...
Selection reason: 用于跨语言克隆检测的知识蒸馏与响应稳定化方法，可迁移至代码agent的输出可靠性。
...
### [34] [Stable Agentic Control: Tool-Mediated LLM Architecture for Autonomous Cyber Defense](http://arxiv.org/abs/2605.03034v1)
*Kerri Prinos,Lilianne Brush,Cameron Denton,Zhanqi Wang,Joshua Knox,Snehal Antani,Anton Foltz,Amy Villaseñor*

Main category: cs.AI

Comments: 23 pages total (9 main paper + 16 appendices/references), 2 figures
...
### [35] [Programmatic Context Augmentation for LLM-based Symbolic Regression](http://arxiv.org/abs/2605.03101v1)
...
### [36] [Learning Correct Behavior from Examples: Validating Sequential Execution in Autonomous Agents](http://arxiv.org/abs/2605.03159v1)
...
Selection reason: 从少量轨迹学习正确行为的agent验证算法，适用于UI、代码生成等序列执行验证。
...
### [37] [Terminus-4B: Can a Smaller Model Replace Frontier LLMs at Agentic Execution Tasks?](http://arxiv.org/abs/2605.03195v2)
...
Selection reason: 微调小模型作为终端执行子agent，减少主agent token消耗且性能不降，直接相关agent架构。
...
### [38] [ADAPTS: Agentic Decomposition for Automated Protocol-agnostic Tracking of Symptoms](http://arxiv.org/abs/2605.03212v2)
...
### [39] [Evaluating Prompting and Execution-Based Methods for Deterministic Computation in LLMs](http://arxiv.org/abs/2605.03227v2)
*Hongkun Yu*
...
### [40] [cotomi Act: Learning to Automate Work by Watching You](http://arxiv.org/abs/2605.03231v1)
...
Comments: 7 pages, 4 figures. ACM CAIS 2026 (System Demonstrations)
...
### [41] [DocSync: Agentic Documentation Maintenance via Critic-Guided Reflexion](http://arxiv.org/abs/2605.02163v1)
...
Selection reason: 结合AST与RAG的Agentic文档维护，并采用Critic-guided反思循环，方法可直接迁移到代码Agent。
...
### [42] [Beyond Translation Accuracy: Addressing False Failures in LLM-Based Code Translation](http://arxiv.org/abs/2605.02195v3)
...
Selection reason: 系统分析LLM代码翻译中的评估假失败，为翻译任务评测标准提供重要参考。
...
### [43] [HEJ-Robust: A Robustness Benchmark for LLM-Based Automated Program Repair](http://arxiv.org/abs/2605.02215v3)
...
Selection reason: 构建程序修复鲁棒性基准，揭示LLM修复模型对语法变体的脆弱性，直接指导评测。
...
### [44] [The Conversations Beneath the Code: Triadic Data for Long-Horizon Software Engineering Agents](http://arxiv.org/abs/2605.02244v1)
*Yelin Kim*
...
Selection reason: 提出长程软件工程Agent训练数据的三方数据框架，对Agent数据构建有启发。
...
### [45] [CommitSuite: A Comprehensive Benchmark for Commit Classification and Message Generation](http://arxiv.org/abs/2605.02256v1)
...
Selection reason: 提供大规模Commit分类与消息生成基准，附带语义标注和免参考评估，可直接用于SE任务评测。
...
### [46] [These Aren't the Reviews You're Looking For How Humans Review AI-Generated Pull Requests](http://arxiv.org/abs/2605.02273v1)
...
Selection reason: 分析AI生成PR的人类评审行为，对理解Agent工作流中人工监督机制有参考价值。
...
### [47] [AOCI: Symbolic-Semantic Indexing for Practical Repository-Scale Code Understanding with LLMs](http://arxiv.org/abs/2605.02421v1)
...
Selection reason: 提出仓库级符号-语义索引，为LLM提供结构化蓝图，直接提升代码理解与agent任务效果。
...
### [48] [ARIADNE: Agentic Reward-Informed Adaptive Decision Exploration via Blackboard-Driven MCTS for Competitive Program Generation](http://arxiv.org/abs/2605.02431v1)
...
Selection reason: 基于黑板MCTS的竞争程序生成框架，融合执行反馈与代码修复，直接可迁移至coding agent。
...
### [49] [Causal Software Engineering: A Vision and Roadmap](http://arxiv.org/abs/2605.02454v1)
...
Selection reason: 提出因果软件工程愿景，因果推理可启发代码agent的规划与反事实调试，但为概念性贡献。
...
### [50] [LLM-Assisted Repository-Level Generation with Structured Spec-Driven Engineering](http://arxiv.org/abs/2605.02455v1)
*Shuzhao Feng,Boqi Chen,Brett H Meyer,Gunter Mussbacher*

Main category: cs.SE

Comments: Accepted to the 34th ACM Joint European Software Engineering Conference and Symposium on the Foundations of Software Engineering (FSE Companion '26)

Selection reason: 结构化规格驱动工程范式，通过可验证的规格引导仓库级代码生成，对agent可靠性有迁移价值。
...
### [51] [TSCG: Deterministic Tool-Schema Compilation for Agentic LLM Deployments](http://arxiv.org/abs/2605.04107v1)
*Furkan Sakizli*

Main category: cs.SE

Comments: 19 pages, 6 figures, 23 tables. Code, benchmark suite, and evaluation logs: https://github.com/SKZL-AI/tscg

Selection reason: 确定性工具模式编译显著提升小型模型工具调用成功率，对agent的工具反馈与部署有直接价值。
...
### [52] [AI-Generated Smells: An Analysis of Code and Architecture in LLM and Agent-Driven Development](http://arxiv.org/abs/2605.02741v1)
...
Selection reason: 系统审计AI生成代码的技术债与架构衰减，揭示体积-质量逆律，可指导代码agent的生成质量控制。
...
### [53] [ARIS: Autonomous Research via Adversarial Multi-Agent Collaboration](http://arxiv.org/abs/2605.03042v1)
*Ruofeng Yang,Yongcan Li,Shuai Li*

Main category: cs.SE

Comments: Technical report. Code at https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep

Selection reason: 自主研究的多agent对抗协作与证据审计框架，对代码agent的验证与多agent协作有借鉴。
...
### [54] [ARISE: A Repository-level Graph Representation and Toolset for Agentic Program Repair and Fault Localization](http://arxiv.org/abs/2605.03117v2)
...
Selection reason: 仓库级数据流图与切片工具用于agent化程序修复，提升定位精度，直接适用于SWE任务。
...
### [55] [Kerncap: Automated Kernel Extraction and Isolation for AMD GPUs](http://arxiv.org/abs/2605.03208v2)
...
Selection reason: 自动提取并隔离GPU内核，加速调优循环，为autotuning agent提供基础工具。
...
### [56] [A Semantic Autonomy Framework for VLM-Integrated Indoor Mobile Robots: Hybrid Deterministic Reasoning and Cross-Robot Adaptive Memory](http://arxiv.org/abs/2605.02525v1)
...
### [57] [CoRAL: Contact-Rich Adaptive LLM-based Control for Robotic Manipulation](http://arxiv.org/abs/2605.02600v2)
...
### [58] [Refining Compositional Diffusion for Reliable Long-Horizon Planning](http://arxiv.org/abs/2605.03075v1)
...
### [59] [LLM-enabled Social Agents](http://arxiv.org/abs/2605.02335v1)
*Önder Gürcan,Moharram Challenger*

Main category: cs.MA

Comments: 11 pages, 1 figure, Hybrid Human Artificial Intelligence (HHAI) 2026
...
### [60] [When Stress Becomes Signal: Detecting Antifragility-Compatible Regimes in Multi-Agent LLM Systems](http://arxiv.org/abs/2605.02463v2)
...
### [61] [When Correct Isn't Usable: Improving Structured Output Reliability in Small Language Models](http://arxiv.org/abs/2605.02363v1)
...
### [62] [Is It Novel and Why? Fine-Grained Patent Novelty Prediction Based on Passage Retrieval](http://arxiv.org/abs/2605.02392v1)
*Valentin Knappich,Anna Hätty,Simon Razniewski,Annemarie Friedrich*

Main category: cs.CL

Comments: Accepted to SIGIR 2026 https://doi.org/10.1145/3805712.3809576
...
Comments: 15 pages, 4 figures, 2 tables. Code and data: https://github.com/deviprasadbal/RAGHealthcareRetrievalStrategies Also archived at Zenodo: https://doi.org/10.5281/zenodo.19774692
...
### [64] [Pact: A Choreographic Language for Agentic Ecosystems](http://arxiv.org/abs/2605.03143v1)
*Kiran Gopinathan,Jack Feser,Michelangelo Naim,Zenna Tavares,Eli Bingham*

Main category: cs.PL

Comments: To be presented at the 2nd International Workshop on Choreographic Programming (CP 2026)
...
### [65] [Towards Dependable Retrieval-Augmented Generation Using Factual Confidence Prediction](http://arxiv.org/abs/2605.05244v1)
...
### [66] [When Actions Disappear: Adversarial Action Removal in Self-Play Reinforcement Learning](http://arxiv.org/abs/2605.16312v1)
*Arahan Kujur*
...
### [67] [A Structural Threshold in Decision Capacity Governs Collapse in Self-Play Reinforcement Learning](http://arxiv.org/abs/2605.16315v1)
*Arahan Kujur*
...
### [68] [SCRIBE: Practical Static Binary Patching via Binary-Aware Recompilation of Decompiled Code](http://arxiv.org/abs/2605.02121v1)
*Han Dai,Soumyakant Priyadarshan,Abdullah Imran,Ruoyu Wang,Antonio Bianchi*

Main category: cs.CR

Comments: Accepted at the 11th IEEE European Symposium on Security and Privacy (EuroS&P 2026)

Selection reason: 通过二进制感知重编译实现静态补丁，LLM可全自动补丁成功率100%，对自动修复有直接价值。
...
### [69] [When Alignment Isn't Enough: Response-Path Attacks on LLM Agents](http://arxiv.org/abs/2605.02187v1)
...
### [70] [APIOT: Autonomous Vulnerability Management Across Bare-Metal Industrial OT Networks](http://arxiv.org/abs/2605.02346v1)
...
### [71] [EvoPoC: Automated Exploit Synthesis for DeFi Smart Contracts via Hierarchical Knowledge Graphs](http://arxiv.org/abs/2605.02868v1)
...
Selection reason: 利用层次知识图谱与SMT验证的智能合约漏洞利用合成agent，结构化推理机制可迁移。
...
### [72] [A Validated Prompt Bank for Malicious Code Generation: Separating Executable Weapons from Security Knowledge in 1,554 Consensus-Labeled Prompts](http://arxiv.org/abs/2605.03179v1)
...
Selection reason: 恶意代码提示词库与武器-知识分类轴，为代码生成安全评测提供可靠性基准。
...
### [73] [When Agents Handle Secrets: A Survey of Confidential Computing for Agentic AI](http://arxiv.org/abs/2605.03213v2)
...
### [74] [MAGE: Safeguarding LLM Agents against Long-Horizon Threats via Shadow Memory](http://arxiv.org/abs/2605.03228v1)
...
### [75] [AutoResearch: An Execution-Grounded Multi-Agent Framework for Reliable Research Workflow Automation](http://arxiv.org/abs/2607.02520v1)
...
Selection reason: 执行接地多Agent研究自动化框架，集成代码执行、修复、引用验证和决策控制，可迁移到代码Agent。
...
### [76] [From Experimental Limits to Physical Insight: A Retrieval-Augmented Multi-Agent Framework for Interpreting Searches Beyond the Standard Model](http://arxiv.org/abs/2605.02491v1)
...
### [77] [Beyond State Machines: Executing Network Procedures with Agentic Tool-Calling Sequences](http://arxiv.org/abs/2605.02584v1)
