...
### [7] [The RAIL Principles for Neurosymbolic AI: Reasoning, Assurances, Interfacing and Learning](https://arxiv.org/abs/2608.04285)
...
### [9] [Improving Auto-Design of Neural PDE Solvers with a Domain-Specific Language](https://arxiv.org/abs/2608.04384)
...
### [10] [What Is a Skill Worth? Structure-Aware Shapley Valuation of Agent Skills](https://arxiv.org/abs/2608.04562)
...
### [11] [Agreement Before Diversity: Verification-First Complementarity for Heterogeneous Language-Model Coordination](https://arxiv.org/abs/2608.04618)
...
### [12] [A/B Agent: A Self-Evolving Agent for Strategy Iteration in Industrial A/B Testing](https://arxiv.org/abs/2608.04625)
...
### [13] [CoPlan: A Trustworthy Co-Intelligence Interface for Care Planning through Role-Based Contestable Argument Graphs](https://arxiv.org/abs/2608.05107)
...
Selection reason: 提出基于角色可争辩参数图的多agent协作与人类可质疑机制，对代码agent的规划/评审工作流有迁移价值。
...
### [14] [OctoLong: Mid-Training On Cross-Repository Code Contexts Enhances Long-Context Modeling](https://arxiv.org/abs/2608.05141)
...
Selection reason: 用AST和语言服务构造跨仓库长上下文训练数据，显著提升长程检索与仓库级agent任务能力。
...
### [15] [Traceable LLM-Generated Hazard Scenarios for Operational Safety Analysis of Aviation Systems Using ASRS Reports](https://arxiv.org/abs/2608.04697)
...
### [16] [Diagnosing Tool-Selection Reasoning in LLM Agents with Canary Tools](https://arxiv.org/abs/2608.04719)
...
### [17] [Chain-of-Thought Monitoring Can Be Unreliable in Implicit-Influence Settings](https://arxiv.org/abs/2608.04735)
...
### [18] [EviGraph: Evidence-Guided Autonomous Research Agents](https://arxiv.org/abs/2608.04738)
...
### [19] [ContextWeave: A Real-World Workflow Benchmark](https://arxiv.org/abs/2608.04830)
...
### [20] [Hierarchical Graph Memory for LLM Agents with Path-level Localization and Rewrite](https://arxiv.org/abs/2608.05095)
...
### [21] [ABSeeker: Training Long-Horizon Search Agents via Answer-Backtracked Credit Assignment](https://arxiv.org/abs/2608.05102)
...
### [22] [Argus: A General-Purpose Agentic Runtime for Long-Horizon Reasoning](https://arxiv.org/abs/2608.05144)
...
### [23] [An Approach for Embedding-Guided Function Reuse Detection in Embedded C Software](https://arxiv.org/abs/2608.04137)
...
Selection reason: 使用RAG与硬件兼容性验证器检测嵌入式C函数复用，可作为代码检索/复用方法参考，但领域较专
...
### [24] [MergeSE: Post-Hoc Model Merging for Software Engineering Tasks Without Retraining](https://arxiv.org/abs/2608.04181)
...
Selection reason: 提出训练无关的模型合并工具，支持SE任务，对代码模型优化与合并方法有直接参考价值
...
### [25] [SONAR: Task-Aware Code Summary Evaluation for LLM Consumers Without References](https://arxiv.org/abs/2608.04195)
...
Selection reason: 提出无参考的代码摘要评估框架，以代码再生为信号，可迁移到agent对摘要质量的判断
...
### [26] [A Unified Model for Cross-Domain Clone Detection via Model Merging](https://arxiv.org/abs/2608.04215)
*Palash R. Roy,Banani Roy,Kevin A. Schneider,Chanchal K. Roy*
...
Selection reason: 系统研究模型合并构建跨域克隆检测器，为SE模型优化和OOD鲁棒性提供实证与方法
...
### [27] [Neuro-Symbolic Proof-of-Vulnerability Generation with Open-Weight Models](https://arxiv.org/abs/2608.04217)
*Yu Nong,Haipeng Cai*
...
Selection reason: 神经符号的PoV生成框架结合LLM和SMT，对漏洞验证与agent安全分析有参考价值
...
### [28] [CURATE: Leveraging LLM Agents to Compose, Catalog, and Deploy Reproducible Workflows](https://arxiv.org/abs/2608.04270)
...
Selection reason: 多agent系统管理可复现工作流生命周期，包含目录复用和人在环路，可迁移到agent工作流设计
...
Selection reason: 为编码agent提供artifact-anchored验证记忆，处理上游漂移时声明有效性，直接相关
...
### [30] [COMPAS: Difficulty-Aware Joint Search for Optimizing Code Generation](https://arxiv.org/abs/2608.04336)
...
Selection reason: 难度感知联合搜索模型/提示/解码配置并路由，优化代码生成质量与成本，直接相关
...
### [31] [ExeCRE: Execution-Consistency Guided Reliability Estimation for Self-Correcting Code Generation](https://arxiv.org/abs/2608.04439)
...
Selection reason: 基于执行一致性估计代码可靠性，减少自纠正中的误导反馈，直接提升agent正确性
...
### [32] [AdaptAgent: A Multi-agent, Domain-Guided Reasoning Framework for Code Adaptation](https://arxiv.org/abs/2608.04459)
...
Selection reason: 多agent分解代码适配任务，通过策略与编译器验证迭代，直接符合coding agent研究方向
...
### [33] [The Order Is the Guarantee: Verifier-Budgeted Code Deletion with Static-First Learned Proposals](https://arxiv.org/abs/2608.04611)
...
Selection reason: 在有限验证预算下用排序和静态优先策略删除代码，覆盖agent代码维护与验证
...
### [34] [An Exploratory Study of Agent Plans for Agentic AI Coding Tools in Open-Source Software](https://arxiv.org/abs/2608.04661)
...
Selection reason: 对开源仓库Agent Plans的实证分析，揭示agent任务规划与执行指导，有参考价值
...
### [35] [Active-SWE: Benchmarking Coding Agents for Proactive Bug Fixing without Issue Reports](https://arxiv.org/abs/2608.04682)
...
Selection reason: 新benchmark评估agent主动发现并修复多bug，扩展SWE评测范畴，直接相关
...
### [36] [What We Observe as LLM Behavior Can Be a Side-effect of Inference Backend](https://arxiv.org/abs/2608.04714)
...
Selection reason: 揭示推理后端对LLM benchmark结果的影响，提示agent评测需披露后端配置，有方法性贡献
...
### [37] [RepoProbe: Benchmarking Architecture-Aware Repository Comprehension with Checklists](https://arxiv.org/abs/2608.04783)
...
Selection reason: 提出仓库理解benchmark和checklist验证协议，改善agent评测可靠性，直接相关
...
### [38] [Scrouting: Cost-Aware Routing of Coding Agents by Scouting the Repository First](https://arxiv.org/abs/2608.04804)
...
Selection reason: 通过先侦察仓库再路由低成本/高解决率的编码agent，直接属于agent成本优化
...
### [39] [SciCode-Verified: How Benchmark Defects Underestimated the Scientific-Coding Ability of Language Models](https://arxiv.org/abs/2608.04975)
...
Selection reason: 审计并修正SciCode基准缺陷后模型能力评估大幅回升，是面向科学代码生成的评测质量方法贡献。
...
### [40] [RepairFormer: Automated Repair of Structured Inputs Using Transformers](https://arxiv.org/abs/2608.05060)
...
Selection reason: 用Transformer将结构化输入修复建模为带格式标签和边界定位的序列生成，可迁移到代码与配置文件的自动修复。
