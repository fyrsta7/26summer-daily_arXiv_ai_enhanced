...
### [1] [Flow Reasoning Models: Scaling Reasoning Through Iterative Self-Refinement](http://arxiv.org/abs/2606.29150v1)
...
### [2] [Pooled Leaderboards Hide System-Specific Winners: A Reporting-Protocol Audit of Offline Root-Cause Analysis Benchmarks](http://arxiv.org/abs/2606.29159v1)
...
### [3] [Selective Memory Retention for Long-Horizon LLM Agents](http://arxiv.org/abs/2606.29178v1)
*Pranath Reddy*
...
### [4] [Evidence-Informed LLM Beliefs for Continual Scientific Discovery](http://arxiv.org/abs/2606.29182v1)
...
### [5] [AI Trading's Alpha Singularity: Emergent Market Reasoning through Agent-to-Agent Self-Evolution](http://arxiv.org/abs/2606.29194v1)
...
### [6] [PolicyGuard: A Dialogue-Grounded Sub-Agent Verifier for Policy Adherence in LLM Agents](http://arxiv.org/abs/2606.29225v1)
...
### [7] [When Summaries Distort Decisions: Information Fidelity in LLM-Compressed Financial Analysis](http://arxiv.org/abs/2606.29251v2)
...
### [8] [The Complexity Ceiling Benchmark: A Multi-Domain Evaluation of Sequential Reasoning Under Depth Scaling](http://arxiv.org/abs/2606.29278v1)
...
### [9] [Hierarchical Experimentalist Agents](http://arxiv.org/abs/2606.29315v1)
...
### [10] [When LLMs Develop Languages: Symbolic Communication for Efficient Multi-Agent Reasoning](http://arxiv.org/abs/2606.29354v1)
...
### [11] [Diagnosing and Repairing Factual Errors in RAG under Budget Constraints](http://arxiv.org/abs/2606.29377v1)
...
### [12] [LLM-Guided Planning for Multi-hop Reasoning over Multimodal Nuclear Regulatory Documents](http://arxiv.org/abs/2606.29399v1)
...
### [13] [Mixture of Debaters: Learn to Debate at Architectural Level in Multi-Agent Reasoning](http://arxiv.org/abs/2606.29425v1)
...
### [14] [Agent-Computer Observation Interfaces Enable Dynamic Computer Use](http://arxiv.org/abs/2606.29472v1)
*Bojie Li,Noah Shi*
...
### [15] [UCOB: Learning to Utilize and Evolve Agentic Skills via Credit-Aware On-Policy Bidirectional Self-Distillation](http://arxiv.org/abs/2606.29502v1)
...
### [16] [OSWorld 2.0: Benchmarking Computer Use Agents on Long-Horizon Real-World Tasks](http://arxiv.org/abs/2606.29537v2)
...
### [17] [Learned Coordination Conventions in Cooperative MARL: Measuring the Translation Gap Between Theory-Informed Roles and Learned Routing](http://arxiv.org/abs/2606.29541v1)
*Yoosung Hong*
...
### [18] [SCARCE: Scalable Cascade Analysis for Rare-event Characterisation via Embeddings](http://arxiv.org/abs/2606.29623v1)
...
### [19] [Budgeted Act-or-Defer Multi-Agent LLM Deliberation with Local Reliability Bounds](http://arxiv.org/abs/2606.29654v1)
...
### [20] [Safety from Honesty in a Disinterested AI Predictor](http://arxiv.org/abs/2606.29657v2)
...
### [21] [OASIF: An Efficient Obfuscation-Aware Self-Improving Framework for LLM-Based Assembly Code Instruction Following and Comprehension](http://arxiv.org/abs/2606.29155v1)
...
Selection reason: 混淆汇编代码理解的LLM自进化框架，涉及指令遵循与RL，对二进制分析agent有直接价值。
...
### [22] [A Multi-Dataset Benchmark for Evaluating LLM Agents in Microservice Failure Diagnosis](http://arxiv.org/abs/2606.29193v1)
...
Selection reason: 面向微服务故障诊断的LLM agent基准，提供推理过程评估，对运维与调试agent有直接价值。
...
### [23] [SAKE: Software Architectural Knowledge Evaluation Benchmark for Large Language Models](http://arxiv.org/abs/2606.29520v1)
...
Selection reason: 软件架构知识评估基准，提供LLM架构推理评测，对代码agent的规划与审查能力评估有参考。
...
### [24] [RESOURCE2SKILL: Distilling Executable Agent Skills from Human-Created Multimodal Resources](http://arxiv.org/abs/2606.29538v3)
...
Selection reason: 将多模态人类资源蒸馏为可执行技能库并支持检索组合，直接增强软件代理的技能复用与在线获取。
...
### [25] [Deforking the World of Code: A Project-Provenance Map that Recovers Cross-Forge Fork Families that Platform Graphs Cannot See](http://arxiv.org/abs/2606.29550v3)
*Audris Mockus*
...
Selection reason: 提供跨平台 fork 去重映射与数据集，可改善代码库度量与智能体评测中的数据膨胀和重复污染问题。
...
### [26] [Stop Hand-Holding Your Coding Agent: Engineering the Loops that Replace Step-by-Step Prompting](http://arxiv.org/abs/2607.00038v1)
*Sandeco Macedo*
...
Selection reason: 系统定义 coding agent 的 loop specification（触发、目标、验证、停止、记忆），与 agent 自动化工作流高度直接相关。
...
### [27] [Citation Discipline in Spec-Driven Development: A Cross-Model Empirical Study of Output Determinism and Automated Hallucination Detection in LLM-Generated Code](http://arxiv.org/abs/2606.30689v1)
*Subham Panda*
...
Selection reason: 实验度量 spec-driven 代码生成的可复现性与幻觉检测，为智能体输出验证提供可迁移方法。
...
### [28] [Connecting the Models: A Global Mega-model of MDE Projects on GitHub](http://arxiv.org/abs/2606.29606v1)
...
Selection reason: 构建 MDE 工程数据集与全局 mega-model，可作为代码仓库和模型工件分析的参考资源。
...
### [29] [Proteus: Automated Adversarial Robustness Testing for Audio Deepfake Detectors](http://arxiv.org/abs/2606.29544v1)
...
### [30] [Invariant Reasoning Directions in Latent Trajectories of Language Models](http://arxiv.org/abs/2606.29164v1)
...
### [31] [Deterministic Decisions for High-Stakes AI. A Zero-Egress Pipeline with the Deployability of RAG and the Accuracy of Machine Learning](http://arxiv.org/abs/2606.29280v1)
*Craig Atkinson*
...
### [32] [Interpretable Inverse Design of Metal-Organic Frameworks with Large Language Model Agents](http://arxiv.org/abs/2606.29459v1)
...
### [33] [CRAFT: Counterfactual Credit Assignment from Free Sibling Rollouts for Self-Distilled Agentic Reinforcement Learning](http://arxiv.org/abs/2606.29476v1)
...
### [34] [Mechanistically Eliciting Latent Behaviors in Language Models](http://arxiv.org/abs/2606.29604v1)
...
### [35] [Fuzzing Large Language Models to Elicit Hidden Behaviours](http://arxiv.org/abs/2606.29646v1)
...
### [36] [Position: Vision-Language-Action Models Cannot Be Verified to Perform Physical Reasoning](http://arxiv.org/abs/2606.30686v1)
...
### [37] [SemJoin: Semantic Join Optimization](http://arxiv.org/abs/2606.29532v1)
...
### [38] [Manufactured Confidence: How Memory Consolidation Turns Hearsay into Confident Facts](http://arxiv.org/abs/2606.29279v1)
*Alex Kwon*
...
### [39] [Closing the Activation-Cone Blind Spot: Response-Time Probing and Unified Defense](http://arxiv.org/abs/2606.29441v1)
*Subhadip Mitra*
...
### [40] [Two-Stage Prompt Optimization for Few-Shot Relation Extraction: From Reasoning-Guided Search to Gradient-Guided Refinement](http://arxiv.org/abs/2606.29639v1)
...
### [41] [Hybrid Retriever Evolution for Multimodal Document Reasoning Agents](http://arxiv.org/abs/2606.29648v1)
...
### [42] [Covering the Unseen: Information Demand Coverage Optimization for Retrieval-Augmented Generation](http://arxiv.org/abs/2606.29328v1)
...
### [43] [Solver-Verified Formulation Generation and Selection for Multi-Warehouse Inventory Allocation Using Large Language Models](http://arxiv.org/abs/2606.29366v1)
...
### [44] [Bridging VideoQA and Video-Guided Agentic Tasks via Generalized Keyframe Extraction](http://arxiv.org/abs/2606.29445v1)
...
### [45] [LLMography: Transforming Human-AI Conversations into Traceability, Oversight, and Auditability Indicators](http://arxiv.org/abs/2606.29437v1)
*Mohammed Bousmah*
...
### [46] [Agent Security Meets Regulatory Reality -- A Practitioner Systematization of Autonomous-Agent Threats and Controls in Regulated Financial Systems](http://arxiv.org/abs/2606.29142v1)
...
Selection reason: 系统化自主agent威胁与控制，虽面向金融合规，但可迁移到代码agent的安全与可靠性设计。
...
### [47] [Langshaw: Declarative Interaction Protocols Based on Sayso and Conflict](http://arxiv.org/abs/2606.29601v1)
*Munindar P. Singh,Samuel H. Christie,Amit K. Chopra*

Main category: cs.PL

Comments: Appeared in IJCAI 2024
