...
Comments: Some major error are found in this version such that the revised version need to change the title
...
Journal reference: 2026 IEEE Conference on Artificial Intelligence (CAI), 2026, pp. 1134-1139

DOI: [10.1109/CAI68641.2026.11536149](https://doi.org/10.1109/CAI68641.2026.11536149)

Author affiliations: Andrea Filiberto Lucas: University of Malta; Dylan Seychell: University of Malta
...
Journal reference: Medical Imaging Meets NeurIPS Workshop, 33rd Conference on Neural Information Processing Systems (NeurIPS 2019), Vancouver, Canada
...
Journal reference: Pattern Recognition vol.157 p.110930 2025

DOI: [10.1016/j.patcog.2024.110930](https://doi.org/10.1016/j.patcog.2024.110930)

Author affiliations: Michail S. Alexiou: Kennesaw State University; Nikolaos Bourbakis: Wright State University
...
DOI: [10.1016/j.eswa.2026.131439](https://doi.org/10.1016/j.eswa.2026.131439)
...
DOI: [10.1145/3748522.3779800](https://doi.org/10.1145/3748522.3779800)

Author affiliations: Thomas H. Schmitt: Georg Simon Ohm University of Applied Sciences Nuremberg; Maximilian Bundscherer: Georg Simon Ohm University of Applied Sciences Nuremberg; Tobias Bocklet: Nuremberg Hospital / Georg Simon Ohm University of Applied Sciences Nuremberg
...
Journal reference: International Conference on 3D Vision (3DV) 2026
...
Journal reference: Proceedings of the 2024 Conference on Empirical Methods in Natural Language Processing: Industry Track, pages 65-72

DOI: [10.18653/v1/2024.emnlp-industry.6](https://doi.org/10.18653/v1/2024.emnlp-industry.6)
...
Comments: Accepted at AfricaNLP 2026 (oral, spotlight)

Journal reference: Proceedings of the 7th Workshop on African Natural Language Processing (AfricaNLP 2026), pages 281-292, Rabat, Morocco

DOI: [10.18653/v1/2026.africanlp-main.30](https://doi.org/10.18653/v1/2026.africanlp-main.30)
...
Journal reference: Proceedings of the BioCreative IX Challenge and Workshop (BC9): Large Language Models for Clinical and Biomedical NLP at the International Joint Conference on Artificial Intelligence (IJCAI 2025)

DOI: [10.5281/zenodo.16876618](https://doi.org/10.5281/zenodo.16876618)
...
Author affiliations: Nalin Srun: UL, CNRS, LORIA; Parisa Rastin: UL, CNRS, LORIA; Guénaël Cabanes: UL, CNRS, LORIA; Lydia Boudjeloud Assala: UL, CNRS, LORIA
...
DOI: [10.1016/j.eswa.2026.133279](https://doi.org/10.1016/j.eswa.2026.133279)

Author affiliations: Manon Reusens: University of Antwerp; Sofie Goethals: University of Antwerp; Toon Calders: University of Antwerp / ZNA Middelheim Hospital; David Martens: University of Antwerp
...
Comments: If the claim of this paper were correct, the same logic could be applied to equations of the form of Euler's conjecture, implying that no non-trivial solutions exist. However, because counterexamples to Euler's conjecture are known to exist, the main claim of this paper is flawed, and I am therefore withdrawing this manuscript
...
- [BiasScope: Towards Automated Detection of Bias in LLM-as-a-Judge Evaluation](https://arxiv.org/abs/2602.09383) — 相关度 0.65：提出自动化发现LLM-as-judge评估偏差的框架，可迁移到代码agent评测的可靠性与偏差缓解。
- [BiasScope: Towards Automated Detection of Bias in LLM-as-a-Judge Evaluation](https://arxiv.org/abs/2602.09383) — 相关度 0.65：提出自动化发现LLM-as-judge评估偏差的框架，可迁移到代码agent评测的可靠性与偏差缓解。
