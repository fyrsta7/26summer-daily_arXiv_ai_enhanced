...
### [1] [An AI agent for treatment reasoning over a biomedical tool universe](http://arxiv.org/abs/2606.28692v1)
...
### [2] [BV-Blend: Uncertainty-Weighted Historical Baselines for Stable Critic-Free RL with Verifiable Rewards](http://arxiv.org/abs/2606.28707v1)
...
### [3] [Agentic Abstention: Do Agents Know When to Stop Instead of Act?](http://arxiv.org/abs/2606.28733v1)
...
### [4] [Agent Safety Is Action Alignment](http://arxiv.org/abs/2606.28739v1)
*Shawn Li,Yue Zhao*
...
### [5] [Self-Supervised Theorem Discovery in a Formal Axiomatic System](http://arxiv.org/abs/2606.28747v1)
...
### [6] [HyphaeDB: A Living Knowledge Topology for Agent-First Memory](http://arxiv.org/abs/2606.28781v1)
*Krishna Halaharvi*
...
### [7] [MedEvoEval: Evaluating Continual Evolution of Doctor Agents through Simulated Clinical Episodes](http://arxiv.org/abs/2606.28900v1)
*Hui Zhang*
...
### [8] [Preventing Error Propagation in Multi-Agent AI through Runtime Monitoring](http://arxiv.org/abs/2606.29026v1)
...
### [9] [Memory as an Attack Surface in LLM Agents: A Study on Multiple-Choice Question Answering](http://arxiv.org/abs/2606.29030v1)
*Shahnewaz Karim Sakib,Anindya Bijoy Das*
...
### [10] [Characterizing Large Language Model Agentic Workflows: A Study on N8n Ecosystem](http://arxiv.org/abs/2606.29116v2)
...
### [11] [Reward-Free Code Alignment from Pretrained or Fine-Tuned LLM: Unpacking the Trade-offs for Code Generation](http://arxiv.org/abs/2606.28998v2)
...
Selection reason: 研究代码LLM的无奖励对齐路径，为代码生成模型的训练与部署提供实证洞察。
...
### [12] [Diff-Based Code Corruption using LLMs for Large-Scale Bugfix Benchmarking](http://arxiv.org/abs/2606.29088v3)
...
Selection reason: 大规模bugfixing基准MegaBugFix，使用LLM diff注入bug，直接用于评估代码修复模型。
...
### [13] [When More Sampling Hurts: The Modal Ceiling and Correlation Ceiling of Test-Time Scaling](http://arxiv.org/abs/2606.28661v1)
...
### [14] [Uncertainty-Aware Sequential Decision Rules for Event-Triggered LLM Invocation in Streaming Systems](http://arxiv.org/abs/2607.13048v1)
*Zhaohui Wang*
...
### [15] [Multi-Agent Routing as Set-Valued Prediction: A WildChat Benchmark and Cost-Aware Evaluation](http://arxiv.org/abs/2606.28925v2)
...
### [16] [Why Trust Your Agent? Empirical Security Gains from TRiSM-Guided Agentic Workflows in Healthcare](http://arxiv.org/abs/2606.28666v1)
*Liam Kearns*
...
### [17] [Capability Gates Are Not Authorization: Confused-Deputy Failures in LLM Agent Frameworks](http://arxiv.org/abs/2606.28679v1)
*David Mellafe Zuvic*
...
### [18] [Understanding Binary Code Similarity for Real-World Vulnerability Detection: A Large-Scale Empirical Study](http://arxiv.org/abs/2606.28870v1)
...
Selection reason: 大规模二进制代码相似性实证研究，提出build-aware查询策略，对漏洞检测与程序分析有借鉴。
...
### [19] [From Tool Connection to Execution Control: Benchmarking Security Invariants in MCP-Style Agent Runtimes](http://arxiv.org/abs/2606.29073v1)
*Ting Liu*
...
### [20] [Symbolon: Symbolic Execution by Learning Code Transformation](http://arxiv.org/abs/2606.29108v1)
...
Selection reason: 用agent学习代码变换提升符号执行，结合程序分析与LLM agent，高度相关且效果显著。
...
### [21] [A Task-Driven and Quality-Assured Agent Framework for SAR Data Generation](http://arxiv.org/abs/2606.28896v1)
...
### [22] [Exit-and-Join Dynamics and Equilibrium in Continuum Cooperative Games](http://arxiv.org/abs/2606.28824v1)
*Quanyan Zhu*
...
### [23] [LAMP: Lean-based Agentic framework with MCP and Proof Repair](http://arxiv.org/abs/2606.28841v1)
...
### [24] [Metric Aggregation Divergence: A Hidden Validity Threat in Agent-Based Policy Optimization and a Contractual Remedy](http://arxiv.org/abs/2606.29038v1)
...
### [25] [SEATauBench: Adapting Tool-Agent-User Evaluation Into Low-Resource Southeast Asian Languages](http://arxiv.org/abs/2606.28715v1)
...
### [26] [5ting at SemEval-2026 Task 8: Strong End-to-End Multi-Turn RAG via LLM-Based Reranking and Faithfulness Control](http://arxiv.org/abs/2606.28737v1)
...
### [27] [AB-RAG: Adaptive Budgeted Retrieval-Augmented Generation for Reliable Question Answering](http://arxiv.org/abs/2606.29090v1)
*Ansh Kamthan*
