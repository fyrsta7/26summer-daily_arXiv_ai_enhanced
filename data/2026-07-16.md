...
Selection reason: 研究agent在工具可靠性变化下的适应能力，提供可迁移的评估框架，对coding agent可靠性评测有价值。
...
Selection reason: 提出统一、可扩展的agent评测基础设施，解耦Benchmark/Harness/Environment，直接可用于代码agent评测。
...
### [17] [Explaining Reinforcement Learning Agents via Inductive Logic Programming](https://arxiv.org/abs/2607.13655)
...
### [18] [CAVA: Canonical Action Verification and Attestation for Runtime Governance of Agentic AI Systems](https://arxiv.org/abs/2607.13716)
*Zexun Wang*
...
### [19] [Experience Memory Graph: One-Shot Error Correction for Agents](https://arxiv.org/abs/2607.13884)
...
### [20] [A Self-Evolving Agent for Longitudinal Personal Health Management](https://arxiv.org/abs/2607.13940)
...
### [21] [Do Agent Optimizers Compound? A Continual-Learning Evaluation on Terminal-Bench 2.0](https://arxiv.org/abs/2607.14004)
...
### [22] [Deep Interaction: An Efficient Human-AI Interaction Method for Large Reasoning Models](https://arxiv.org/abs/2607.14049)
...
### [23] [Falsifiable Release Gates for Self-Improving Systems](https://arxiv.org/abs/2607.13070)
*Deepak Soni*
...
### [24] [Compaction as Epistemic Failure: How Agentic LLM Tools Fabricate Confirmed Results from Killed Processes](https://arxiv.org/abs/2607.13071)
*Hiroki Tamba*
...
### [25] [Inference Economics of Enterprise Coding Agents: A Case Study of Cloud vs. On-Premise LLMs](https://arxiv.org/abs/2607.13080)
...
### [26] [Self-Improving AI Coding Agents Through Accumulated Behavioral Rules: A Closed-Loop Framework](https://arxiv.org/abs/2607.13091)
...
### [27] [SemaDiff: Identifying Semantic-Changing Commits with Generated Code and Tests](https://arxiv.org/abs/2607.13111)
...
### [28] [Design-System-Aware Development with AI: Evaluating Productivity and Design Consistency](https://arxiv.org/abs/2607.13156)
...
### [29] [From Human-Centric to Agentic Code Review: The Impact of Different Generations of Generative AI Technology on Review Quality](https://arxiv.org/abs/2607.13196)
...
### [30] [Can LLMs Learn and Apply Multi-Level Modelling Semantics? A First Empirical Study](https://arxiv.org/abs/2607.13257)
...
### [31] [Faithful Autoformalization of Natural Language Assertions](https://arxiv.org/abs/2607.13303)
...
### [32] [A Telemetry-Driven Model for Quantifying Upgrade Risk in Durable Workflow Execution](https://arxiv.org/abs/2607.13617)
...
Selection reason: 为 durable workflow 升级风险提供概率模型与 migrate/pin 策略，适用于长程 agent 的可靠执行。
...
### [33] [The Replication Assessment Problem in Software Engineering](https://arxiv.org/abs/2607.13815)
*Giuseppe Destefanis,Martin Shepperd,Leila Yousefi*

Main category: cs.SE

Comments: In International Conference on Evaluation and Assessment in Software Engineering (EASE 2026), June 09--12, 2026, Glasgow, United Kingdom. ACM, New York, NY, USA, 6 pages

DOI: [10.1145/3816483.3816559](https://doi.org/10.1145/3816483.3816559)

Selection reason: 系统化复制研究评估框架，可迁移到 coding agent benchmark 的可复现性与一致性评估。
...
### [34] [PROBE: Benchmarking Code Generation in Large Language Models](https://arxiv.org/abs/2607.13820)
...
Selection reason: 面向多语言、多维度的代码生成基准与评测流程，直接服务 LLM coding agent 评估。
...
### [35] [ProfMalPlus: Agent-Coordinated Detection of Malicious NPM Packages via Static-Dynamic Analysis Synergy](https://arxiv.org/abs/2607.13965)
...
Selection reason: 结合对象敏感行为图与 LLM 多智能体协作的恶意包检测，静态-动态分析裁决工作流可迁移到代码安全 agent。
...
### [36] [Early Adoption of Agentic Coding Tools by GitHub Projects](https://arxiv.org/abs/2607.14037)
...
Selection reason: 对 2361 个 GitHub 项目 agentic PR 的早期实证，揭示采用模式、生产力与人工监督模型，支撑 agent 工具设计。
...
### [37] [VisualRepair: Dynamic Tool Calling and Region Focusing for Visual Software Issue Repair](https://arxiv.org/abs/2607.14075)
...
Selection reason: 面向视觉软件缺陷的 MLLM 修复框架，类型感知工具调用与区域聚焦直接提升多模态 APR。
