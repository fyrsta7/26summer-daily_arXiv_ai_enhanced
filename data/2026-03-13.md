...
- [DIVE: Scaling Diversity in Agentic Task Synthesis for Generalizable Tool Use](https://arxiv.org/abs/2603.11076) — 相关度 0.70：通过工具轨迹反推任务来扩展多样性，对 coding agent 后训练数据合成与工具泛化有借鉴。
