...
Comments: aligned with workshop version
...
### [18] [Benchmarking API Drift in LLM-Generated Quantum Code Across Successive SDK Versions](http://arxiv.org/abs/2607.04072v1)
...
Selection reason: 基准测试 LLM 生成量子代码的 API 版本一致性，可迁移到通用代码生成评测。
...
### [19] [SEDCoT: Enhancing LLM-Based COBOL Code Translation via Symbolic Execution and Delta Debugging](http://arxiv.org/abs/2607.04092v1)
...
Selection reason: 结合符号执行与三角洲调试修复 LLM 代码翻译，提升语义正确性。
...
### [20] [An Evaluation of Role-Based Multi-Agent Code Generation on Repository-Scale Problems](http://arxiv.org/abs/2607.04212v1)
...
Selection reason: 评测角色型多智能体在仓库级代码生成中的表现，对多智能体协作研究有参考。
...
### [21] [Teaching Code LLMs to Reason with Intermediate Formal Specifications](http://arxiv.org/abs/2607.04232v1)
...
Selection reason: 验证引导的代码 LLM 训练框架，生成中间形式化规范，直接提升代码推理与修复。
...
### [22] [Using OAI Overlay to Enhance REST API Fuzzing](http://arxiv.org/abs/2607.04325v1)
...
Selection reason: 利用 OAI Overlay 标准增强 REST API 模糊测试，具有自动化测试迁移价值。
...
### [23] [Correct but Slow: An Empirical Study of the GPU Kernel Evaluation Gap in Modern Domain-Specific Languages](http://arxiv.org/abs/2607.04454v3)
*Tingxi Li,Ravishka Rathnasuriya,Wei Yang*

Main category: cs.SE

Comments: 17 pages, 2 figures --- Jul. 6th EDIT: update artifact link in the paper --- Jul. 13th EDIT: correct errors in reference, add new reference

Selection reason: 实证研究 GPU DSL 内核的正确性性能鸿沟，为性能验证提供轻量筛选方法。
...
### [24] [Obey, Diverge, Collapse: Blind Obedience to Incorrect Instructions Drives Code LLMs to Irrecoverable Code Semantic Collapse](http://arxiv.org/abs/2607.04537v1)
...
Selection reason: 揭示代码 LLM 对错误指令的盲目服从导致不可恢复崩溃，对智能体可靠性至关重要。
...
### [25] [!Imperio, smolVLA: The Implications of Data Poisoning on Open Source Robotics](http://arxiv.org/abs/2607.04146v1)
...
### [26] [HALO-WA: Hybrid-Attention Latent-Guided Online Reinforcement Learning for World-Action Models](http://arxiv.org/abs/2607.04265v1)
...
### [27] [Agentic-V2X: Small Language Model Agents for Deadline-Aware V2X Scheduling in 5G/6G Networks](http://arxiv.org/abs/2607.04290v1)
...
Selection reason: 提出将智能体行为编译为可验证程序与原子的 AGI 编译器，直接优化执行成本与确定性。
...
### [31] [SOV-CAD: Stepwise Orthographic Views Guided CAD Modeling Sequence Reconstruction](http://arxiv.org/abs/2607.04119v1)
...
### [32] [CritiqueDriveVLM: From Verifier-Guided Reinforcement Learning to Latent Thought Distillation for Autonomous Driving](http://arxiv.org/abs/2607.04179v1)
...
### [33] [Self-Reference in Large Language Models: The Introspection Threshold for Recursive Self-Improvement](http://arxiv.org/abs/2607.04277v1)
...
### [34] [Detecting Hallucinations in Retrieval-Augmented Generation through Grounding-Aware Sensitivity by Perturbation (GASP)](http://arxiv.org/abs/2607.04223v1)
*Mohamed Aly Bouke*
...
### [35] [CausalGame: Benchmarking Causal Thinking of LLM Agents in Games](http://arxiv.org/abs/2607.04293v1)
...
### [36] [UI-MOPD: Multi-Platform On-Policy Distillation for Continual GUI Agent Learning](http://arxiv.org/abs/2607.04425v1)
...
### [37] [Transplanting, inverting, and preventing a misalignment persona: method-conditional emergent misalignment in Qwen2.5](http://arxiv.org/abs/2607.04510v1)
