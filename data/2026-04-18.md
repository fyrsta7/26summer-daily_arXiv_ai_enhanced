...
- [Bias in the Loop: Auditing LLM-as-a-Judge for Software Engineering](http://arxiv.org/abs/2604.16790v1) — 相关度 0.85：审计LLM评判者用于代码评估的偏差，为代码agent的验证与评测提供关键的可靠性方法。
- [HELO-APR: Enhancing Low-Resource Program Repair through Cross-Lingual Knowledge Transfer](http://arxiv.org/abs/2604.17016v2) — 相关度 0.80：跨语言知识迁移的程序修复框架，课程学习策略可帮助低资源语言下的代码修复agent。
- [Beyond Task Success: An Evidence-Synthesis Framework for Evaluating, Governing, and Orchestrating Agentic AI](http://arxiv.org/abs/2604.19818v1) — 相关度 0.75：提出评估、治理、编排与保证的四层框架及ODTA测试，为agentic AI系统提供可借鉴的评测与治理机制。
- [MEMRES: A Memory-Augmented Resolver with Confidence Cascade for Agentic Python Dependency Resolution](http://arxiv.org/abs/2604.16941v1) — 相关度 0.75：面向Python依赖解析的agent系统，结合自进化记忆与置信级联，其记忆与决策机制可迁移到代码agent。
- [Mitigating Prompt-Induced Cognitive Biases in General-Purpose AI for Software Engineering](http://arxiv.org/abs/2604.16756v2) — 相关度 0.75：系统化评估并缓解提示诱导偏置以提升GPAI在SE决策中的可靠性，可直接用于代码Agent。
- [Treating Run-time Execution History as a First-Class Citizen: Co-Versioning Run-time Behavior alongside Code](http://arxiv.org/abs/2604.16933v1) — 相关度 0.75：将运行时行为与代码共同版本化，为agent提供行为感知的回归定位与语义diff，可迁移到agent的验证反馈机制。
- [AI Observability for Developer Productivity Tools: Bridging Cost Awareness and Code Quality](http://arxiv.org/abs/2604.17092v1) — 相关度 0.60：面向开发者工具的AI可观测性，统一成本追踪与质量验证模式可迁移到代码agent运行监控。
- [Gleaner: A Semantically-Rich and Efficient Online Sampler for Microservice Diagnostics](http://arxiv.org/abs/2604.16810v1) — 相关度 0.60：微服务诊断的在线trace采样框架，其新颖的采样与多样性保持策略可迁移到代码agent调试数据筛选。
- [Workstream: A Local-First Developer Command Center for the AI-Augmented Engineering Workflow](http://arxiv.org/abs/2604.17055v1) — 相关度 0.60：聚合PR、CI、AI审查与agent可观测性的开发者中枢，AI就绪度评分与审查智能对代码agent评测有参考价值。
