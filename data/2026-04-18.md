...
### [17] [LFRAG: Layout-oriented Fine-grained Retrieval-Augmented Generation on Multimodal Document Understanding](http://arxiv.org/abs/2605.22829v1)
...
### [18] [RLM-on-KG: Heuristics First, LLMs When Needed: Adaptive Retrieval Control over Mention Graphs for Scattered Evidence](http://arxiv.org/abs/2604.17056v1)
...
### [19] [CapSeal: Capability-Sealed Secret Mediation for Secure Agent Execution](http://arxiv.org/abs/2604.16762v1)
...
### [20] [SafeDream: Safety World Model for Proactive Early Jailbreak Detection](http://arxiv.org/abs/2604.16824v1)
...
### [21] [enclawed: A Configurable, Sector-Neutral Hardening Framework for Single-User AI Assistant Gateways](http://arxiv.org/abs/2604.16838v2)
*Alfredo Metere*
...
### [22] [Governed MCP: Kernel-Level Tool Governance for AI Agents via Logit-Based Safety Primitives](http://arxiv.org/abs/2604.16870v2)
*Daeyeon Son*
...
### [23] [Visual Inception: Compromising Long-term Planning in Agentic Recommenders via Multimodal Memory Poisoning](http://arxiv.org/abs/2604.16966v1)
*Jiachen Qian*
...
### [24] [CASCADE: A Cascaded Hybrid Defense Architecture for Prompt Injection Detection in MCP-Based Systems](http://arxiv.org/abs/2604.17125v1)
...
### [25] [Systematic Capability Benchmarking of Frontier Large Language Models for Offensive Cyber Tasks](http://arxiv.org/abs/2604.17159v1)
...
### [26] [Configuration Over Selection: Hyperparameter Sensitivity Exceeds Model Differences in Open-Source LLMs for RTL Generation](http://arxiv.org/abs/2604.17102v1)
...
### [27] [DO-Bench: An Attributable Benchmark for Diagnosing Object Hallucination in Vision-Language Models](http://arxiv.org/abs/2604.22822v1)
...
### [28] [Federation over Text: Insight Sharing for Multi-Agent Reasoning](http://arxiv.org/abs/2604.16778v2)
...
### [29] [AutoOR: Scalably Post-training LLMs to Autoformalize Operations Research Problems](http://arxiv.org/abs/2604.16804v2)
...
### [30] [HealthCraft: A Reinforcement Learning Safety Environment for Emergency Medicine](http://arxiv.org/abs/2605.21496v1)
*Brandon Dent*
...
### [31] [The Topological Trouble With Transformers](http://arxiv.org/abs/2604.17121v3)
...
### [32] [TimeRFT: Stimulating Generalizable Time Series Forecasting for TSFMs via Reinforcement Finetuning](http://arxiv.org/abs/2605.00015v1)
...
### [33] [ProtoCycle: Reflective Tool-Augmented Planning for Text-Guided Protein Design](http://arxiv.org/abs/2604.16896v1)
...
### [34] [Incentivizing Parametric Knowledge via Reinforcement Learning with Verifiable Rewards for Cross-Cultural Entity Translation](http://arxiv.org/abs/2604.16881v1)
...
### [35] [Bolzano: Case Studies in LLM-Assisted Mathematical Research](http://arxiv.org/abs/2604.16989v2)
...
### [36] [Improving LLM Code Reasoning via Semantic Equivalence Self-Play with Formal Verification](http://arxiv.org/abs/2604.17010v2)
...
### [37] [Abstain-R1: Calibrated Abstention and Post-Refusal Clarification via Verifiable RL](http://arxiv.org/abs/2604.17073v1)
...
### [38] [The Consensus Trap: Rescuing Multi-Agent LLMs from Adversarial Majorities via Token-Level Collaboration](http://arxiv.org/abs/2604.17139v1)
...
### [39] [HiveMind: OS-Inspired Scheduling for Concurrent LLM Agent Workloads](http://arxiv.org/abs/2604.17111v1)
