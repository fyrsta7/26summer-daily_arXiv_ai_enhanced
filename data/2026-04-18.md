...
### [1] [Introspection Adapters: Training LLMs to Report Their Learned Behaviors](http://arxiv.org/abs/2604.16812v2)
...
### [2] [PersonalHomeBench: Evaluating Agents in Personalized Smart Homes](http://arxiv.org/abs/2604.16813v3)
...
### [3] [GRAIL: Autonomous Concept Grounding for Neuro-Symbolic Reinforcement Learning](http://arxiv.org/abs/2604.16871v1)
...
### [4] [Step-GRPO: Internalizing Dynamic Early Exit for Efficient Reasoning](http://arxiv.org/abs/2604.16890v1)
...
### [5] [Beyond Text-Dominance: Understanding Modality Preference of Omni-modal Large Language Models](http://arxiv.org/abs/2604.16902v3)
...
### [6] [Skilldex: A Package Manager and Registry for Agent Skill Packages with Hierarchical Scope-Based Distribution](http://arxiv.org/abs/2604.16911v1)
...
### [7] [The Cognitive Penalty: Ablating System 1 and System 2 Reasoning in Edge-Native SLMs for Decentralized Consensus](http://arxiv.org/abs/2604.16913v1)
...
### [8] [ClimAgent: LLM as Agents for Autonomous Open-ended Climate Science Analysis](http://arxiv.org/abs/2604.16922v3)
...
### [9] [Playing Psychic: Using Thought Trees to Predict Reasoning Models Accuracy on Coding Tasks](http://arxiv.org/abs/2604.16931v1)
...
### [10] [AutoPKG: An Automated Framework for Dynamic E-commerce Product-Attribute Knowledge Graph Construction](http://arxiv.org/abs/2604.16950v1)
...
### [11] [Small Model as Master Orchestrator: Learning Unified Agent-Tool Orchestration with Parallel Subtask Decomposition](http://arxiv.org/abs/2604.17009v1)
...
### [12] [Harness as an Asset: Enforcing Determinism via the Convergent AI Agent Framework (CAAF)](http://arxiv.org/abs/2604.17025v3)
*Tianbao Zhang*

Main category: cs.AI

Comments: 47 pages, 13 figures. Code: https://github.com/TianbaoZhang001/OpenCAAF (Apache-2.0)
...
### [13] [Complementing Self-Consistency with Cross-Model Disagreement for Uncertainty Quantification](http://arxiv.org/abs/2604.17112v1)
...
### [14] [If Only My CGM Could Speak: A Privacy-Preserving Agent for Question Answering over Continuous Glucose Data](http://arxiv.org/abs/2604.17133v1)
...
### [15] [Graph-of-Agents: A Graph-based Framework for Multi-Agent LLM Collaboration](http://arxiv.org/abs/2604.17148v1)
...
### [16] [GraphDC: A Divide-and-Conquer Multi-Agent System for Scalable Graph Algorithm Reasoning](http://arxiv.org/abs/2605.06671v1)
...
### [17] [Mitigating Prompt-Induced Cognitive Biases in General-Purpose AI for Software Engineering](http://arxiv.org/abs/2604.16756v2)
...
Selection reason: 系统化评估并缓解提示诱导偏置以提升GPAI在SE决策中的可靠性，可直接用于代码Agent。
...
### [18] [Bias in the Loop: Auditing LLM-as-a-Judge for Software Engineering](http://arxiv.org/abs/2604.16790v1)
...
Selection reason: 审计LLM评判者用于代码评估的偏差，为代码agent的验证与评测提供关键的可靠性方法。
...
### [19] [Gleaner: A Semantically-Rich and Efficient Online Sampler for Microservice Diagnostics](http://arxiv.org/abs/2604.16810v1)
...
Selection reason: 微服务诊断的在线trace采样框架，其新颖的采样与多样性保持策略可迁移到代码agent调试数据筛选。
...
### [20] [Treating Run-time Execution History as a First-Class Citizen: Co-Versioning Run-time Behavior alongside Code](http://arxiv.org/abs/2604.16933v1)
*Marcus Kessel*

Main category: cs.SE

Comments: 4 pages, accepted at the 34th ACM International Conference on the Foundations of Software Engineering (FSE'2026 Ideas, Visions and Reflections)

Selection reason: 将运行时行为与代码共同版本化，为agent提供行为感知的回归定位与语义diff，可迁移到agent的验证反馈机制。
...
### [21] [MEMRES: A Memory-Augmented Resolver with Confidence Cascade for Agentic Python Dependency Resolution](http://arxiv.org/abs/2604.16941v1)
...
Selection reason: 面向Python依赖解析的agent系统，结合自进化记忆与置信级联，其记忆与决策机制可迁移到代码agent。
...
### [22] [HELO-APR: Enhancing Low-Resource Program Repair through Cross-Lingual Knowledge Transfer](http://arxiv.org/abs/2604.17016v2)
...
Selection reason: 跨语言知识迁移的程序修复框架，课程学习策略可帮助低资源语言下的代码修复agent。
...
### [23] [Workstream: A Local-First Developer Command Center for the AI-Augmented Engineering Workflow](http://arxiv.org/abs/2604.17055v1)
*Happy Bhati*
...
Selection reason: 聚合PR、CI、AI审查与agent可观测性的开发者中枢，AI就绪度评分与审查智能对代码agent评测有参考价值。
...
### [24] [AI Observability for Developer Productivity Tools: Bridging Cost Awareness and Code Quality](http://arxiv.org/abs/2604.17092v1)
...
Selection reason: 面向开发者工具的AI可观测性，统一成本追踪与质量验证模式可迁移到代码agent运行监控。
...
### [25] [Beyond Task Success: An Evidence-Synthesis Framework for Evaluating, Governing, and Orchestrating Agentic AI](http://arxiv.org/abs/2604.19818v1)
...
Selection reason: 提出评估、治理、编排与保证的四层框架及ODTA测试，为agentic AI系统提供可借鉴的评测与治理机制。
...
### [26] [Federation over Text: Insight Sharing for Multi-Agent Reasoning](http://arxiv.org/abs/2604.16778v2)
...
### [27] [AutoOR: Scalably Post-training LLMs to Autoformalize Operations Research Problems](http://arxiv.org/abs/2604.16804v2)
...
### [28] [HealthCraft: A Reinforcement Learning Safety Environment for Emergency Medicine](http://arxiv.org/abs/2605.21496v1)
*Brandon Dent*
...
### [29] [The Topological Trouble With Transformers](http://arxiv.org/abs/2604.17121v3)
...
### [30] [CapSeal: Capability-Sealed Secret Mediation for Secure Agent Execution](http://arxiv.org/abs/2604.16762v1)
...
### [31] [SafeDream: Safety World Model for Proactive Early Jailbreak Detection](http://arxiv.org/abs/2604.16824v1)
...
### [32] [enclawed: A Configurable, Sector-Neutral Hardening Framework for Single-User AI Assistant Gateways](http://arxiv.org/abs/2604.16838v2)
*Alfredo Metere*
...
### [33] [Governed MCP: Kernel-Level Tool Governance for AI Agents via Logit-Based Safety Primitives](http://arxiv.org/abs/2604.16870v2)
*Daeyeon Son*
...
### [34] [Visual Inception: Compromising Long-term Planning in Agentic Recommenders via Multimodal Memory Poisoning](http://arxiv.org/abs/2604.16966v1)
*Jiachen Qian*
...
### [35] [CASCADE: A Cascaded Hybrid Defense Architecture for Prompt Injection Detection in MCP-Based Systems](http://arxiv.org/abs/2604.17125v1)
...
### [36] [Systematic Capability Benchmarking of Frontier Large Language Models for Offensive Cyber Tasks](http://arxiv.org/abs/2604.17159v1)
...
### [37] [LFRAG: Layout-oriented Fine-grained Retrieval-Augmented Generation on Multimodal Document Understanding](http://arxiv.org/abs/2605.22829v1)
...
### [38] [RLM-on-KG: Heuristics First, LLMs When Needed: Adaptive Retrieval Control over Mention Graphs for Scattered Evidence](http://arxiv.org/abs/2604.17056v1)
...
### [39] [Configuration Over Selection: Hyperparameter Sensitivity Exceeds Model Differences in Open-Source LLMs for RTL Generation](http://arxiv.org/abs/2604.17102v1)
...
### [40] [TimeRFT: Stimulating Generalizable Time Series Forecasting for TSFMs via Reinforcement Finetuning](http://arxiv.org/abs/2605.00015v1)
...
### [41] [HiveMind: OS-Inspired Scheduling for Concurrent LLM Agent Workloads](http://arxiv.org/abs/2604.17111v1)
...
### [42] [DO-Bench: An Attributable Benchmark for Diagnosing Object Hallucination in Vision-Language Models](http://arxiv.org/abs/2604.22822v1)
