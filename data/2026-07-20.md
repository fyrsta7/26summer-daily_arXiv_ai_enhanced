...
- [NexForge: Scaling Agent Capabilities through Requirement-Driven Task Synthesis for LLMs](https://arxiv.org/abs/2607.14186) — 相关度 0.80：需求优先合成可执行agent任务数据，为代码agent训练与评测提供可扩展方法。
