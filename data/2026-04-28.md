...
### [1] [Agentic Architect: An Agentic AI Framework for Architecture Design Exploration and Optimization](http://arxiv.org/abs/2604.25083v1)
...
### [2] [Cooperate to Compete: Strategic Coordination in Multi-Agent Conquest](http://arxiv.org/abs/2604.25088v1)
...
### [3] [DATAREEL: Automated Data-Driven Video Story Generation with Animations](http://arxiv.org/abs/2604.25220v1)
...
### [4] [Authority Inversion in LLM-Mediated Ubiquitous Systems: When Models Trust Users Over Sensors](http://arxiv.org/abs/2605.23938v1)
...
### [5] [AutoResearchBench: Benchmarking AI Agents on Complex Scientific Literature Discovery](http://arxiv.org/abs/2604.25256v1)
...
### [6] [Plausible but Wrong: A case study on Agentic Failures in Astrophysical Workflows](http://arxiv.org/abs/2604.25345v2)
...
### [7] [DRIVE: Modeling Skills at the Reasoning and Interaction Levels for Web Agents under Continual Learning](http://arxiv.org/abs/2605.23939v1)
...
### [8] [Automated Adversarial Collaboration for Advancing Theory Building in the Cognitive Sciences](http://arxiv.org/abs/2604.25521v1)
...
### [9] [OxyGent: Making Multi-Agent Systems Modular, Observable, and Evolvable via Oxy Abstraction](http://arxiv.org/abs/2604.25602v2)
...
### [10] [Think Before You Act -- A Neurocognitive Governance Model for Autonomous AI Agents](http://arxiv.org/abs/2604.25684v1)
...
### [11] [Toward Scalable Terminal Task Synthesis via Skill Graphs](http://arxiv.org/abs/2604.25727v1)
...
### [12] [Does Theory of Mind Improvement Really Benefit Human-AI Interactions? Empirical Findings from Interactive Evaluations](http://arxiv.org/abs/2605.15205v1)
...
### [13] [StratFormer: Adaptive Opponent Modeling and Exploitation in Imperfect-Information Games](http://arxiv.org/abs/2604.25796v1)
...
### [14] [TrialCalibre: A Fully Automated Causal Engine for RCT Benchmarking and Observational Trial Calibration](http://arxiv.org/abs/2604.25832v1)
...
### [15] [ADEMA: A Knowledge-State Orchestration Architecture for Long-Horizon Knowledge Synthesis with LLMAgents](http://arxiv.org/abs/2604.25849v1)
...
### [16] [Recursive Multi-Agent Systems](http://arxiv.org/abs/2604.25917v2)
...
### [17] [Residual Drift Dominates Contradiction in Multi-Turn Constraint Reasoning](http://arxiv.org/abs/2605.23940v1)
*Sebastien Kawada*
...
### [18] [Operating-Layer Controls for Onchain Language-Model Agents Under Real Capital](http://arxiv.org/abs/2604.26091v1)
...
### [19] [Distill-Belief: Closed-Loop Inverse Source Localization and Characterization in Physical Fields](http://arxiv.org/abs/2604.26095v1)
...
### [20] [Evaluating Strategic Reasoning in Forecasting Agents](http://arxiv.org/abs/2604.26106v1)
...
### [21] [Hierarchical Multi-Persona Induction from User Behavioral Logs: Learning Evidence-Grounded and Truthful Personas](http://arxiv.org/abs/2604.26120v1)
...
### [22] [R$^3$-SQL: Ranking Reward and Resampling for Text-to-SQL](http://arxiv.org/abs/2604.25325v1)
...
Selection reason: 提出Text-to-SQL的ranking与agentic resampling方法，可迁移到代码生成中的候选排序与自我校验。
...
### [23] [Commit-Aware Learning-Based Test Case Prioritization for Continuous Integration](http://arxiv.org/abs/2604.25363v2)
...
Selection reason: 基于commit结构的测试用例优先级排序，为CI回归测试提供学习型方法，可辅助agent的测试优化。
...
### [24] [CoRE: A Fine-Grained Code Reasoning Benchmark Beyond Output Prediction](http://arxiv.org/abs/2604.25399v1)
...
Selection reason: 提出代码推理benchmark CoRE，评估LLM对实现不变性和中间状态的推理，是代码智能评测的重要补充。
...
### [25] [PLMGH: What Matters in PLM-GNN Hybrids for Code Classification and Vulnerability Detection](http://arxiv.org/abs/2604.25599v1)
...
Selection reason: 受控实证揭示 PLM-GNN 混合模型在代码分类/漏洞检测中的设计要点，可指导代码分析 agent。
...
### [26] [Using Large Language Models for Black-Box Testing of FMU-Based Simulations](http://arxiv.org/abs/2604.25650v1)
...
Selection reason: 用 LLM 生成结构化测试场景并自动执行验证，人机循环机制可迁移到测试 agent。
...
### [27] [Bug-Report-Driven Fault Localization: Industrial Benchmarking and Lesson Learned at ABB Robotics](http://arxiv.org/abs/2604.25700v2)
...
Selection reason: 仅凭 bug 报告文本做故障定位的工业评估，对 issue 驱动 agent 有借鉴。
...
### [28] [Learning Generalizable Multimodal Representations for Software Vulnerability Detection](http://arxiv.org/abs/2604.25711v2)
...
Selection reason: 多模态对比学习提升漏洞检测泛化性，表征对齐方法可迁移至代码理解 agent。
...
### [29] [SAFEdit: Does Multi-Agent Decomposition Resolve the Reliability Challenges of Instructed Code Editing?](http://arxiv.org/abs/2604.25737v1)
...
Selection reason: 多 agent 分解+可执行验证+失败抽象层的代码编辑框架，直接提升指令编辑可靠性。
...
### [30] [Scenario-based System Testing for Distributed Robotics Applications](http://arxiv.org/abs/2604.25772v1)
...
Selection reason: 提出场景规范语言与在线测试机制，支持动态配置，对分布式系统测试 agent 有参考价值。
...
### [31] [Can Code Evaluation Metrics Detect Code Plagiarism?](http://arxiv.org/abs/2604.25778v1)
...
Selection reason: 系统比较代码评估指标与查重工具，揭示指标在检测修改代码中的能力边界，对代码评测有用。
...
### [32] [RESTestBench: A Benchmark for Evaluating the Effectiveness of LLM-Generated REST API Test Cases from NL Requirements](http://arxiv.org/abs/2604.25862v1)
...
Selection reason: 提供 RESTful 测试生成基准与需求级突变测试指标，可评估 agent 测试有效性。
...
### [33] [From Threads to Trajectories: A Multi-LLM Pipeline for Community Knowledge Extraction from GitHub Issue Discussions](http://arxiv.org/abs/2604.25880v1)
...
Selection reason: 多 LLM 管线从 issue 讨论提取结构化轨迹，可用于训练和引导 agent 推理。
...
### [34] [Carbon-Taxed Transformers: A Green Compression Pipeline for Overgrown Language Models](http://arxiv.org/abs/2604.25903v1)
...
Selection reason: 压缩 pipeline 在 SE 任务上大幅降耗而保留精度，对部署代码 agent 有成本优化价值。
...
### [35] [SWE-Edit: Rethinking Code Editing for Efficient SWE-Agent](http://arxiv.org/abs/2604.26102v2)
...
Selection reason: 将代码编辑接口分解为 Viewer/Editor，降低上下文耦合并提升 SWE-agent 效率，直接相关。
...
### [36] [LLM-Guided Issue Generation from Uncovered Code Segments](http://arxiv.org/abs/2604.26118v2)
...
Selection reason: 结合覆盖率与 LLM 生成可复现 issue 报告，并验证有效性，可用于自动 bug 发现 agent。
...
### [37] [UCSC-NLP at SemEval-2026 Task 13: Multi-View Generalization and Diagnostic Analysis of Machine-Generated Code Detection](http://arxiv.org/abs/2604.26990v1)
...
Selection reason: 面向机器生成代码检测的多视图训练与类不平衡诊断，可用于 agent 输出鉴别与评测。
...
### [38] [ImproBR: Bug Report Improver Using LLMs](http://arxiv.org/abs/2604.26142v1)
...
Selection reason: 使用LLM自动检测并改进bug报告结构，其混合检测器和RAG方法可迁移到coding agent对issue的理解与预处理。
...
### [39] [AI Observability for Large Language Model Systems: A Multi-Layer Analysis of Monitoring Approaches from Confidence Calibration to Infrastructure Tracing](http://arxiv.org/abs/2604.26152v1)
*Twinkll Sisodia*
...
Selection reason: 提出LLM系统多层可观测性分类，对构建可靠agent的监控与追踪有参考价值。
...
### [40] [Cutscene Agent: An LLM Agent Framework for Automated 3D Cutscene Generation](http://arxiv.org/abs/2604.25318v1)
...
### [41] [reward-lens: A Mechanistic Interpretability Library for Reward Models](http://arxiv.org/abs/2604.26130v1)
...
### [42] [Entropy Centroids as Intrinsic Rewards for Test-Time Scaling](http://arxiv.org/abs/2604.26173v2)
...
### [43] [Ceci n'est pas une explication: Evaluating Explanation Failures as Explainability Pitfalls in Language Learning Systems](http://arxiv.org/abs/2604.26145v2)
...
### [44] [BARRED: Synthetic Training of Custom Policy Guardrails via Asymmetric Debate](http://arxiv.org/abs/2604.25203v1)
...
### [45] [The Structured Output Benchmark: A Multi-Source Benchmark for Evaluating Structured Output Quality in Large Language Models](http://arxiv.org/abs/2604.25359v1)
...
### [46] [CORAL: Adaptive Retrieval Loop for Culturally-Aligned Multilingual RAG](http://arxiv.org/abs/2604.25676v1)
...
### [47] [Agentic Harness Engineering: Observability-Driven Automatic Evolution of Coding-Agent Harnesses](http://arxiv.org/abs/2604.25850v4)
...
Selection reason: 观测驱动自动演进 coding-agent harness，闭环提升成功率，直接相关。
...
### [48] [Training Computer Use Agents to Assess the Usability of Graphical User Interfaces](http://arxiv.org/abs/2604.26020v1)
...
### [49] [Where Did It Go Wrong? Capability-Oriented Failure Attribution for Vision-and-Language Navigation Agents](http://arxiv.org/abs/2604.25161v1)
...
### [50] [From Soliloquy to Agora: Memory-Enhanced LLM Agents with Decentralized Debate for Optimization Modeling](http://arxiv.org/abs/2604.25847v1)
...
### [51] [Symbolic Execution Meets Multi-LLM Orchestration: Detecting Memory Vulnerabilities in Incomplete Rust CVE Snippets](http://arxiv.org/abs/2605.00034v1)
...
Selection reason: 结合符号执行与多LLM智能体检测Rust不安全代码漏洞，解决不完整代码问题，是程序分析与agent协作的直接应用。
...
### [52] [Structured Security Auditing and Robustness Enhancement for Untrusted Agent Skills](http://arxiv.org/abs/2604.25109v1)
...
### [53] [MARD: A Multi-Agent Framework for Robust Android Malware Detection](http://arxiv.org/abs/2604.25264v1)
...
Selection reason: 提出多智能体Android恶意软件检测框架，利用LLM编排静态分析工具，多agent协作模式可迁移到代码分析agent。
...
### [54] [From CRUD to Autonomous Agents: Formal Validation and Zero-Trust Security for Semantic Gateways in AI-Native Enterprise Systems](http://arxiv.org/abs/2604.25555v1)
*Ignacio Peyrano*
...
### [55] [SnapGuard: Lightweight Prompt Injection Detection for Screenshot-Based Web Agents](http://arxiv.org/abs/2604.25562v1)
...
### [56] [Towards Agentic Investigation of Security Alerts](http://arxiv.org/abs/2604.25846v1)
...
### [57] [GenDetect: Generalizing Reactive Detection for Resilience Against Imitative DeFi Attack Cascade](http://arxiv.org/abs/2604.26094v1)
...
Selection reason: 从已知攻击自动抽象检测规则，思路可迁移至智能合约漏洞检测 agent。
...
### [58] [M$^3$-VQA: A Benchmark for Multimodal, Multi-Entity, Multi-Hop Visual Question Answering](http://arxiv.org/abs/2604.25122v1)
