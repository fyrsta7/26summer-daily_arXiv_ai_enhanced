...
### [1] [Rethinking the Evaluation of Harness Evolution for Agents](http://arxiv.org/abs/2607.12227v1)
...
### [2] [On-Device Deep Research at 4B: Exposure Bounds Faithfulness, Retrieval Bounds Coverage](http://arxiv.org/abs/2607.12257v1)
...
### [3] [How Many Tasks Are Enough for Agent Benchmark Decisions? A Replay Analysis of Public LLM Agent Benchmarks](http://arxiv.org/abs/2607.12338v1)
*Wei-Jung Huang*
...
### [4] [PM-Bench: Evaluating Prospective Memory in LLM Agents](http://arxiv.org/abs/2607.12385v1)
...
### [5] [ToolAnchor: Anchoring Counterfactual Context to Boost Agentic Tool-use Capability](http://arxiv.org/abs/2607.14145v1)
...
### [6] [Critic Experience Bank: Self-Evolving Step-Level Confidence Estimation for LLM Agents](http://arxiv.org/abs/2607.12397v1)
...
### [7] [Isolation as a First-Class Principle for LLM-Agent System Safety: Concepts, Taxonomy, Challenges and Future Directions](http://arxiv.org/abs/2607.12406v1)
...
### [8] [EVOQUANT: Self-Evolving Verifier-Guided Strategy Optimization for Robust Quantitative Trading](http://arxiv.org/abs/2607.12455v1)
...
### [9] [Function-Aware Fill-in-the-Middle as Mid-Training for Coding Agent Foundation Models](http://arxiv.org/abs/2607.12463v2)
...
### [10] [From Observation to Insight: Mechanistic World Models and the Quest for Autonomous Discovery](http://arxiv.org/abs/2607.12474v2)
...
### [11] [TRACE: An Operational Reasoning Schema for Auditable Agentic Commitments](http://arxiv.org/abs/2607.12480v1)
...
### [12] [Self-Improvements in Modern Agentic Systems: A Survey](http://arxiv.org/abs/2607.13104v1)
...
### [13] [Agentic Service-Oriented Computing: A Manifesto for the Next Frontier of Service-Oriented Computing](http://arxiv.org/abs/2607.12619v1)
...
DOI: [10.1109/ICWS72778.2026.00163](https://doi.org/10.1109/ICWS72778.2026.00163)
...
### [14] [A Learning-Rate-Gated Failure of GRPO in a Small Language and Vision-Language Model Web Agent: A Controlled Null and Its Mechanism](http://arxiv.org/abs/2607.12640v1)
...
### [15] [Internet of Agentic Things: Networked AI Agents for Closed-Loop IoT Orchestration](http://arxiv.org/abs/2607.12662v1)
*Quanyan Zhu*
...
### [16] [MaxSAT-Based Feedback for Guiding Vision-Language Models in Sudoku](http://arxiv.org/abs/2607.12711v1)
...
### [17] [LLMs Can See the Smoke but not the Fire: Evaluating Abductive Reasoning with Elenchos](http://arxiv.org/abs/2607.12733v1)
...
### [18] [Enhancing Small Language Models Reasoning through Knowledge Graph Grounding](http://arxiv.org/abs/2607.14149v1)
...
### [19] [Improving Molecular Property Prediction in Small Language Models Using Graph-based Tools](http://arxiv.org/abs/2607.13115v1)
...
### [20] [Tracing Agentic Failure from the Flow of Success](http://arxiv.org/abs/2607.12747v1)
...
### [21] [Who Grades the Grader? Co-Evolving Evaluation Metrics and Skills for Self-Improving LLM Agents](http://arxiv.org/abs/2607.12790v1)
...
### [22] [A Multi-Agent System for Autonomous, Fine-Tuning-Free Clinical Symptom Detection: Development and Validation Study](http://arxiv.org/abs/2607.12886v1)
...
### [23] [MemOps: Benchmarking Lifecycle Memory Operations in Long-Horizon Conversations](http://arxiv.org/abs/2607.12893v1)
...
### [24] [Knowledge- and Gradient-Guided Reinforcement Learning for Parametrized Action Markov Decision Processes](http://arxiv.org/abs/2607.12924v2)
...
### [25] [FormalAnalyticGeo: A Neural-Symbolic Based Framework for Multimodal Analytic Geometry Problem Generation](http://arxiv.org/abs/2607.12982v1)
...
### [26] [Resist and Update: Counterfactual Report Coordinates for Incentive-Compatible LLMs](http://arxiv.org/abs/2607.12985v1)
...
### [27] [Win by Silence: Deletion Non-Monotonicity, Autonomous Exploitation, and Typed-State Gating in LLM Plan Evaluation](http://arxiv.org/abs/2607.12986v1)
*Aleh Manchuliantsau*
...
Selection reason: 揭示 LLM 计划评估中的删除非单调漏洞并设计门控机制，可迁移到 agent 评测与可靠性保障。
...
### [28] [Dynamic Resource Allocation for Ensemble Determinization MCTS](http://arxiv.org/abs/2607.13007v1)
...
Selection reason: 提出任务感知执行范围估计与 ACRR，并给出低成本高成功率 agent 策略和基准，直接相关。
...
### [30] [Oracle Agent Memory as an Enterprise Memory Substrate for Long-Horizon AI Agents](http://arxiv.org/abs/2607.13157v1)
...
### [31] [Learning Safe Agent Behaviour from Human Preferences and Justifications via World Models](http://arxiv.org/abs/2607.13172v1)
...
### [32] [Networked Intelligence: Active Shared Context Graphs for Human-AI Team Science](http://arxiv.org/abs/2607.13220v2)
...
### [33] [MemoHarness: Agent Harnesses That Learn from Experience](http://arxiv.org/abs/2607.14159v1)
...
### [34] [Harness Handbook: Making Evolving Agent Harnesses Readable,Navigable, and Editable](http://arxiv.org/abs/2607.13285v1)
...
Selection reason: 为 agent harness 提供行为定位与渐进式披露机制，直接改善 coding agent 的编辑规划与代码定位。
...
### [35] [Code-MUE: Measuring Code LLMs' Uncertainty through Execution-based Semantic Interaction Graphs](http://arxiv.org/abs/2607.12273v1)
...
Selection reason: 基于执行语义交互图的代码LLM不确定性估计，黑盒可用，对agent选择性预测有直接价值。
...
### [36] [XScientist: A Git-Like Research Protocol for Long-Running Autonomous Scientific Discovery](http://arxiv.org/abs/2607.12301v1)
*Jixiang Luo*
...
Selection reason: 提出git式长时运行自主研究协议，包含审计、门控与复现，可迁移到长程代码agent工作流。
...
### [37] [Skills That Don't Exist: A Large-Scale Study of Hallucinated Skill Recommendation in LLM Agents](http://arxiv.org/abs/2607.12340v1)
...
Selection reason: 测量LLM agent技能名称幻觉并验证供应链攻击风险，提出检索缓解与结构性防御，对agent工具生态安全重要。
...
### [38] [Detecting Rendering Bugs in Imperative Data Visualization Libraries via Equivalent Mutations](http://arxiv.org/abs/2607.12363v3)
...
Selection reason: 用等价突变检测渲染库bug，方法有通用性，但领域偏向可视化，对agent测试设计有参考。
...
### [39] [Understanding before Naming! Enhancing LLM-based Method Name Prediction with Code Summarization](http://arxiv.org/abs/2607.12467v1)
...
Selection reason: 面向 LLM 的方法名预测，提出摘要+精炼策略和评估方法，可用于代码理解与生成 agent。
...
### [40] [Agent-Safety Evaluations as Load-Bearing Evidence: A Vendor-Neutral, Cross-Harness Reconstructability Metric](http://arxiv.org/abs/2607.12469v1)
*Oleg Solozobov*
...
Selection reason: 提出 agent 安全评测的可重建性度量，可迁移到 coding agent 评测体系。
...
### [41] [Taming the Drift: Context-aware Repair of Dockerfile Drift during Software Evolution](http://arxiv.org/abs/2607.12541v1)
...
Selection reason: 上下文感知的 Dockerfile drift 修复框架，结合图分析和 LLM 补丁生成，可直接用于代码修复 agent。
...
### [42] [Hierarchical Fault Localization for Autonomous Driving Systems with Hypothesis Validation and Intent Analysis](http://arxiv.org/abs/2607.12598v1)
...
Selection reason: 面向 ADS 的分层故障定位框架，其假设验证和意图分析可迁移到代码级缺陷定位 agent。
...
### [43] [Multi-Perspective Agentic Program Repair via Code Property Graphs and Temporal Execution Graphs](http://arxiv.org/abs/2607.12605v1)
...
Selection reason: 基于 CPG/TEG 的多视角 agentic 程序修复，直接相关且评测于 Defects4J。
...
### [44] [SemaDiff: Identifying Semantic-Changing Commits with Generated Code and Tests](http://arxiv.org/abs/2607.13111v1)
...
Selection reason: 通过生成测试和对比执行识别语义变更提交，对 agent 驱动的测试与变更分析有直接价值。
...
### [45] [Line-Anchored Feedback Cuts Token Costs and Improves Correctness in AI Code Editing](http://arxiv.org/abs/2607.12713v1)
*William Franz Lamberti*

Main category: cs.SE

Comments: 13 pages, 10 figures, 12 tables. Code, task bank, and raw model outputs: https://github.com/billyl320/filemark_usage

Selection reason: 研究反馈格式对 AI 代码编辑的正确性和 token 成本影响，可直接转化为 agent 输入优化。
...
### [46] [Deep4ge: DNN Training Trajectories for Fault Detection and Diagnosis](http://arxiv.org/abs/2607.12868v1)
*Sigma Jahan*

Main category: cs.SE

Comments: Accepted at ICSME Data & Tool Track, 2026

Selection reason: 提供 DNN 训练故障检测数据集与方法，可支撑 ML 系统测试 agent 的研究。
...
### [47] [Form, Not Content? A Preregistered, Placebo-Controlled Evaluation of Learned Error-Conditioned Self-Repair Through Prompts and Weights in Frozen Small Code Models](http://arxiv.org/abs/2607.12962v1)
*Mehmet Iscan*
...
Selection reason: 用安慰剂对照评估代码模型自修复中的错误条件反馈，方法论严谨，对修复 agent 有直接参考。
...
### [48] [Software Supply Chains are Dead: Use-Case-Oriented Regeneration](http://arxiv.org/abs/2607.13021v1)
...
Selection reason: 用 agentic 合成替代外部依赖并验证局部代码生成可行性，对代码 agent 的按需生成与供应链安全有直接价值。
...
### [49] [Design-System-Aware Development with AI: Evaluating Productivity and Design Consistency](http://arxiv.org/abs/2607.13156v1)
...
Selection reason: DS-aware AI 前端开发生产力实验，对前端代码 agent 效果评测有参考价值。
...
### [50] [From Human-Centric to Agentic Code Review: The Impact of Different Generations of Generative AI Technology on Review Quality](http://arxiv.org/abs/2607.13196v1)
...
Selection reason: 百万级 PR 研究人类/LLM/agent 评审协作模式，为 agentic code review 提供重要实证。
...
### [51] [Beyond Object Validation: Relational Conformance in Multi-Artifact Agent Releases](http://arxiv.org/abs/2607.14155v1)
*Tengjiao Liu*
...
Selection reason: 面向多工件 agent 发布的关系一致性校验，以发布图为 agent 输出验证提供可迁移机制。
...
### [52] [Can LLMs Learn and Apply Multi-Level Modelling Semantics? A First Empirical Study](http://arxiv.org/abs/2607.13257v1)
...
Selection reason: LLM 生成多级建模语义的实证与提示策略对比，对生成结构化工件的 agent 有参考价值。
...
### [53] [Faithful Autoformalization of Natural Language Assertions](http://arxiv.org/abs/2607.13303v1)
*Hongyi Liu,Madhusudan Parthasarathy,Adithya Murali*

Main category: cs.SE

Comments: Code, data, and resources are publicly available for research purposes: https://github.com/Lhtie/llms-for-assertions

Selection reason: 基于一致性分数和测试验证的断言自动形式化，提升 LLM 生成可执行规格的可靠性，可直接用于测试 agent。
...
### [54] [Natural-Language to SysMLv2 Translation via Conformance-Driven Iterative Refinement](http://arxiv.org/abs/2607.14162v1)
...
Selection reason: 用生产级 conformance checker 驱动 generate-check-repair 循环，机制可迁移到代码生成 agent 的验证与修复。
...
### [55] [MetaInfer: A Knowledge Only LLM Inference Engine Generator SKILL Toolbox](http://arxiv.org/abs/2607.12875v1)
...
Selection reason: 用 LLM 多 agent 自动生成定制推理引擎，涉及编译器/运行时优化和代码生成，有参考价值。
...
### [56] [Mind the Gap: Promises and Pitfalls of Hierarchical Planning in LeWorldModel](http://arxiv.org/abs/2607.12547v2)
...
### [57] [Jetson-PI: Towards Onboard Real-Time Robot Control via Foresight-Aligned Asynchronous Inference](http://arxiv.org/abs/2607.12659v1)
...
### [58] [Microflow: Microarchitectural Causal Observability for Deep Cross-Layer Analysis and Optimization](http://arxiv.org/abs/2607.13184v1)
...
Selection reason: 将微架构因果可观测性引入性能分析，支撑跨层根因定位与优化，符合 profiling 主题。
...
### [59] [LakeQuest: A Three-Domain Benchmark for Grounded Question Answering across Data Lakes](http://arxiv.org/abs/2607.12310v1)
...
### [60] [Breaking Refusal in the First Half: A Mechanistic Study of the Prefill Jailbreak](http://arxiv.org/abs/2607.14147v1)
*Alex Kwon*
...
### [61] [Can Induced Emotion Bias LLM Behaviors in Sequential Decision Making?](http://arxiv.org/abs/2607.12631v1)
...
### [62] [PalmClaw: A Native On-Device Agent Framework for Mobile Phones](http://arxiv.org/abs/2607.13027v1)
...
### [63] [What Models Express, Suppress, and Resist: Auditing Open-Weight LLMs with Persona Vectors](http://arxiv.org/abs/2607.13162v2)
...
### [64] [RAGthoven at SemEval-2026 Task 1: A Multi-Stage Pipeline Walks Into a Benchmark and Barely Clears the Bar](http://arxiv.org/abs/2607.13189v1)
...
### [65] [Track, Rank, Crack: Epistemic Working Memory Scales Multi-Hop Reasoning in Language Agents](http://arxiv.org/abs/2607.12267v1)
*Ning Liu*
...
### [66] [The Computational Basis of Confidence in Large Language Models](http://arxiv.org/abs/2607.12447v1)
...
### [67] [OOD-RL-Bench: A Benchmark Framework for Out-of-Distribution Detection in Reinforcement Learning](http://arxiv.org/abs/2607.12523v1)
...
### [68] [Evidence-Grounded Verified Agentic Reasoning: A Path Toward Eliminating LLM Hallucination in Empirical Inference via Tool-Attested Kernel Proofs](http://arxiv.org/abs/2607.12650v1)
*Junyu Ren*
...
Selection reason: 基于 Lean 内核验证的 agent 推理可靠性机制，可迁移到需要可审计证据的代码 agent。
...
### [69] [ShortOPD: Recovering Pruned LLMs with Short-to-Long On-Policy Distillation](http://arxiv.org/abs/2607.13124v1)
...
### [70] [TerraZero: Procedural Driving Simulation for Zero-Demonstration Self-Play at Scale](http://arxiv.org/abs/2607.13028v1)
...
### [71] [SteinGate: Tail-Sensitive Safe Reinforcement Learning via Stein Discrepancy](http://arxiv.org/abs/2607.13175v1)
...
### [72] [Deconstructing Actor-Critic: A Large-scale Empirical Study of Design Components for Practitioners](http://arxiv.org/abs/2607.13274v1)
...
### [73] [Open-Source Intelligence for Code Provenance and the Security Patterns that Separate Human and Large-Language-Model Implementations of Common Programming Tasks](http://arxiv.org/abs/2607.12524v1)
...
Selection reason: 利用 OSINT 和分类器区分人机代码来源并分析安全模式，对代码安全分析与 agent 有参考价值。
...
### [74] [Bulkhead: Automated Semantic Detection and Remediation of Container Escape Vulnerabilities](http://arxiv.org/abs/2607.12723v1)
...
Selection reason: 集成多 agent 与形式方法的容器逃逸漏洞检测修复框架，对安全代码 agent 有迁移价值。
...
### [75] [Why Not Fix It Once and for All? An Empirical Study of Multiple Patches for Vulnerability Fixes in Open-Source Software](http://arxiv.org/abs/2607.13206v1)
...
Selection reason: 多补丁漏洞修复的根因分类与完整修复验证方法，对 agent 修复可靠性与验证有参考。
...
### [76] [Foundational Constraint Solving for Expressive Refinement Typing](http://arxiv.org/abs/2607.12226v1)
...
Selection reason: 提供可证明的CHC求解后端，可增强agent或验证器的正确性保证，但应用面较窄。
...
### [77] [Mystra: Declarative Dynamic Taint Analysis via Shadow Virtual Machine](http://arxiv.org/abs/2607.12308v2)
...
Selection reason: 声明式动态污点分析，支持语言模型友好规则合成，可移植到agent驱动的污点追踪与安全验证。
