...
- [AI-PROPELLER: Warehouse-Scale Interprocedural Code Layout Optimization with AlphaEvolve](http://arxiv.org/abs/2606.00131v1) — 相关度 0.95：基于进化式智能体工作流自动优化链接后代码布局，属于自动程序性能优化，且有硬件实测验证性能提升。
- [Improving Small Language Models for Code Generation with Reinforcement Learning from Verification Feedback](http://arxiv.org/abs/2605.30478v1) — 相关度 0.95：直接研究 RLVR 在代码生成上的应用，系统比较多种奖励设计与优化方法，对代码智能体训练有直接参考价值。
- [Automating Low-Risk Code Review at Meta: RADAR, Risk Calibration, and Review Efficiency](http://arxiv.org/abs/2605.30208v2) — 相关度 0.90：Meta大规模部署风险分层自动代码审查系统，展示AI代码审查的效率收益与安全权衡，工程实践价值极高。
- [EvoRepair: Enhancing Vulnerability Repair Agents Through Experience-Based Self-Evolution](http://arxiv.org/abs/2605.30105v1) — 相关度 0.90：经验驱动的自进化漏洞修复智能体框架，通过经验累积与复用显著提升修复性能，对修复类智能体有直接价值。
- [How Coding Agents Fail Their Users: A Large-Scale Analysis of Developer-Agent Misalignment in 20,574 Real-World Sessions](http://arxiv.org/abs/2605.29442v1) — 相关度 0.90：对2万+真实编码智能体会话失败模式的大规模分析，直接为智能体训练、评测与界面设计提供实证依据。
- [Agora: Toward Autonomous Bug Detection in Production-Level Consensus Protocols with LLM Agents](http://arxiv.org/abs/2605.29910v1) — 相关度 0.85：多智能体协作结合假设驱动测试发现协议级深层缺陷，为复杂系统的智能体验证提供有效框架。
- [Inferring Code Correctness from Specification](http://arxiv.org/abs/2605.29822v1) — 相关度 0.85：基于规约和输入输出对验证LLM生成代码正确性，为代码智能体提供轻量、稳定的正确性校验方法。
- [Minimal Prompt Perturbations Lead to Code Vulnerabilities: Prompt Fragility and Hidden-State Signals in Coding LLMs](http://arxiv.org/abs/2605.29737v1) — 相关度 0.80：揭示提示扰动对生成代码安全性的影响并提出隐藏状态预警信号，对代码智能体安全评测有直接价值。
- [Projectional Decoding: Towards Semantic-Aware LLM Generation](http://arxiv.org/abs/2605.30054v1) — 相关度 0.80：提出投影式解码框架，在生成中维护语义图模型并增量验证，可提升LLM生成软件工件的语义正确性。
- [Code-QA-Bench: Separating Code Reasoning from Documentation Memorization in Repository-Level QA](http://arxiv.org/abs/2605.29277v1) — 相关度 0.76：仓库级代码理解 benchmark，用闭卷/仅代码/全文档三条件分离推理与记忆，评测设计可服务代码 agent。
- [GUITestScape: Towards Open-set Evaluation on Exploratory GUI Testing](http://arxiv.org/abs/2605.29532v1) — 相关度 0.75：面向探索式GUI测试的开放集评测基准与过程感知评估器，其轨迹分解和验证器增强思路可用于智能体测试评测。
- [REPOT: Recoverable Program-of-Thought via Checkpoint Repair](http://arxiv.org/abs/2605.30052v1) — 相关度 0.75：通过验证前缀断点修复恢复程序式思维轨迹，为智能体执行中的可靠恢复和一次调用容错提供通用机制。
- [CODEFUSE-DEBENCH: An Empirical Study on Readability, Recompilability, and Functionality](http://arxiv.org/abs/2605.29490v1) — 相关度 0.70：提出多维反编译评测框架，含LLM评判、编译修复循环和动态追踪，评测与修复方法可迁移到代码智能体验证。
- [CodeGolf Bench: A Multi-Language Benchmark for Evaluating Concise Code Generation Capabilities of Large Language Models](http://arxiv.org/abs/2605.30394v1) — 相关度 0.70：跨语言简洁代码生成基准，提供动态问题集和人类表现基线，可评测代码模型的效率优化能力。
- [Physics Is All You Need? A Case Study in Physicist-Supervised AI Development of Scientific Software](http://arxiv.org/abs/2605.30353v1) — 相关度 0.70：物理学家监督AI编码智能体开发科学软件的案例，提炼出超越oracle测试的监督实践，对智能体可靠部署有借鉴意义。
- [Syll: Open-Source Personal Automation with Cross-Surface Execution](http://arxiv.org/abs/2606.07594v1) — 相关度 0.65：统一MCP/API、CLI与GUI的跨表面智能体框架，包含演示教学、记忆外部化等机制，可迁移到编码智能体的多环境执行。
- [On the Road to Personalized Code Intelligence: Portraiting and Assisting Developers Based on Their In-IDE Behaviors](http://arxiv.org/abs/2605.29372v1) — 相关度 0.62：基于 IDE 行为构建开发者画像并个性化代码问答，对个性化 coding agent 有参考价值，但偏向用户建模。
- [ParaTool: Shifting Tool Representations from Context to Parameters](http://arxiv.org/abs/2605.29561v1) — 相关度 0.60：将工具定义参数化以降低上下文开销并提升调用可靠性，对编码智能体的工具集成有借鉴价值。
- [Offloading Score: Measuring AI Reliance Through Counterfactual Workflows](http://arxiv.org/abs/2605.29392v1) — 相关度 0.55：提出可迁移的AI依赖度量方法，用于评估用户在编程任务中对智能体输出的过度依赖。
- [Claim against Measurement: Statistical Artefacts in Quantum Error Mitigation Benchmarks](http://arxiv.org/abs/2605.29872v1) — 相关度 0.50：系统批判基准实验中的统计假象并提出报告规范，评测严谨性方法论可迁移到代码智能体基准设计。
