...
### [1] [PANDO: Efficient Multimodal AI Agents via Online Skill Distillation](http://arxiv.org/abs/2605.24785v2)
...
### [2] [CoRe-Code: Collaborative Reinforcement Learning for Code Generation](http://arxiv.org/abs/2605.24812v1)
...
### [3] [Agent Manufacturing: Foundation-Model Agents as First-Class Industrial Entities](http://arxiv.org/abs/2605.24823v1)
*Yilei Zhang*
...
### [4] [Test-Time Deep Thinking to Explore Implicit Rules](http://arxiv.org/abs/2605.24828v2)
...
### [5] [Specifying AI-SDLC Processes: A Protocol Language for Human-Agent Boundaries](http://arxiv.org/abs/2606.20615v2)
*Ylli Prifti*

Main category: cs.AI

Comments: Position paper with formal specification, failure rate analysis, and feasibility demonstration. Companion empirical paper and open-source implementation forthcoming

Selection reason: 为AI-SDLC流程设计协议语言以定义人机边界与审批门，可迁移至多agent软件工程流程的规范与校验。
...
### [6] [Inverting the Shield: Systematically Generating Safety Tests from Policy Specifications](http://arxiv.org/abs/2605.24883v1)
...
Selection reason: 基于规范生成LLM安全测试，通过FOL形式化和策略图实现可覆盖测试，适用于agent的安全性评测与测试生成。
...
### [7] [ProActor: Timing-Aware Reinforcement Learning for Proactive Task Scheduling Agents](http://arxiv.org/abs/2605.24900v1)
...
### [8] [Energy Shields for Fairness](http://arxiv.org/abs/2605.24926v1)
...
### [9] [Towards Multi-Turn Dialog Systems for Industrial Asset Operations and Maintenance](http://arxiv.org/abs/2605.24953v1)
...
### [10] [AION: Next-Generation Tasks and Practical Harness for Time Series](http://arxiv.org/abs/2605.25045v1)
...
### [11] [Evolutionary Enhanced Multi-Agent Reinforcement Learning for Cooperative Air Combat](http://arxiv.org/abs/2605.25091v1)
...
### [12] [Trust but Verify: Prover-Verifier Deliberation for Selective LLM Prediction](http://arxiv.org/abs/2605.25133v1)
...
### [13] [ScaleWoB: Guiding GUI Agents with Coding Agents via Large-Scale Environmental Synthesis](http://arxiv.org/abs/2605.25160v2)
...
### [14] [SpecAlign: A Semantic Alignment Framework for SystemVerilog Assertion Generation](http://arxiv.org/abs/2605.25181v1)
...
### [15] [DarkForest: Less Talk, Higher Accuracy for Multi-Agent LLMs](http://arxiv.org/abs/2605.25188v1)
...
### [16] [Boosting Inference with Guided Reasoning: Stochastic Exploration for Recursive Models](http://arxiv.org/abs/2605.25230v2)
...
### [17] [Meta-Agent: From Task Descriptions to Verified Multi-Agent Systems](http://arxiv.org/abs/2605.25233v1)
*Andy Xu,Yu-Wing Tai*
...
### [18] [FrontierOR: Benchmarking LLMs' Capacity for Efficient Algorithm Design in Large-Scale Optimization](http://arxiv.org/abs/2605.25246v3)
...
### [19] [LipoAgent: Coordinating Fine-Tuned LLM Agents for Safer Lipid Design](http://arxiv.org/abs/2605.25250v1)
...
### [20] [Multi-Agent Specification-based Metamorphic Testing of FMU-Based Simulations](http://arxiv.org/abs/2605.25101v1)
...
Selection reason: LLM多agent工作流从规范提取蜕变关系并生成测试，对基于规范的自动化测试生成有清晰可迁移性。
...
### [21] [Specification-Based Code-Text-Code Reengineering for LLM-Mediated Software Evolution](http://arxiv.org/abs/2605.25232v1)
...
Selection reason: 提出Code2Text2Code的规范式重工程框架，结合中间表示与验证，对LLM驱动的代码演化有直接参考价值。
...
### [22] [Tool-Schema Compression Enables Agentic RAG Under Constrained Context Budgets](http://arxiv.org/abs/2605.26165v1)
*Furkan Sakizli*
...
Selection reason: 研究工具schema压缩以解决agentic RAG上下文预算冲突，对受限上下文下代码agent的工具调用效率提升非常相关。
...
### [23] [PR-Aware Automated Unit Test Generation: Challenges and Opportunities](http://arxiv.org/abs/2605.25285v1)
...
Selection reason: 系统评估PR感知的测试生成（EvoSuite vs GPT-4o）并定义F2P指标，为agent测试生成提供实证基础。
...
### [24] [Divide-and-Conquer Inference for Large-Scale Visual Recognition with Multimodal Large Language Models](http://arxiv.org/abs/2605.24799v1)
...
### [25] [Interpretation, Learning, and Empathy as One Constraint: A Residual-Adequacy Architecture with Accountable Abstention](http://arxiv.org/abs/2605.24999v1)
...
### [26] [JudgmentBench: Comparing Rubric and Preference Evaluation for Quality Assessment](http://arxiv.org/abs/2605.25240v3)
...
### [27] [Eureka: Intelligent Feature Engineering for Enterprise AI Cloud Resource Demand Prediction](http://arxiv.org/abs/2605.25297v2)
...
### [28] [Scaling up Energy-Aware Multi-Agent Reinforcement Learning for Mission-Oriented Drone Networks with Individual Reward](http://arxiv.org/abs/2605.24992v1)
...
### [29] [Selective Test-Time Compute Scaling for Click-Through Rate Prediction via Uncertainty-Triggered Feature Path Exploration](http://arxiv.org/abs/2605.24989v1)
...
### [30] [Grow-Prune-Freeze Networks: Adaptive & Continual Learning Technique for Olfactory Navigation](http://arxiv.org/abs/2605.25170v2)
...
### [31] [Hide to Guide: Learning via Semantic Masking](http://arxiv.org/abs/2605.25198v1)
...
### [32] [Latent Q-Barrier Shielding for Safe In-Context Reinforcement Learning](http://arxiv.org/abs/2605.25267v1)
...
### [33] [When Does Adaptive Guidance Help? Belief-Aware Privileged Distillation for Autonomous Driving Under Partial Observability](http://arxiv.org/abs/2605.26155v1)
*Mehmet Haklidir*
...
### [34] [Reflect-Guard: Enhancing LLM Safeguards against Adversarial Prompts via Logical Self-Reflection](http://arxiv.org/abs/2605.24834v1)
...
### [35] [MemMorph: Tool Hijacking in LLM Agents via Memory Poisoning](http://arxiv.org/abs/2605.26154v1)
...
### [36] [APT-Agent: Automated Penetration Testing using Large Language Models](http://arxiv.org/abs/2605.24949v1)
