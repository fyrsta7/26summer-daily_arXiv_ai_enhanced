...
Selection reason: 联合优化工具提示与模式描述的反思式框架，直接提升语言agent工具调用可靠性。
...
Selection reason: 研究模块化课程学习提升Text-to-SQL代码生成，训练策略可迁移到代码LLM的agent能力构建。
...
### [37] [SelfHeal: Empirical Fix Pattern Analysis and Bug Repair in LLM Agents](http://arxiv.org/abs/2604.17699v1)
...
Selection reason: 首个LLM agent错误修复模式研究与SelfHeal多agent修复系统，高度直接相关。
...
### [38] [Program Structure-aware Language Models: Targeted Software Testing beyond Textual Semantics](http://arxiv.org/abs/2604.17715v1)
...
Selection reason: 结合代码属性图与LLM进行分支目标测试生成，提升测试覆盖和漏洞发现，可迁移到测试agent。
...
### [39] [Revisiting Code Debloating with Ground Truth-based Evaluation](http://arxiv.org/abs/2604.17717v2)
...
Selection reason: 基于ground-truth的程序精简评估，为自动程序变换与优化提供基准方法。
...
### [40] [Raven: Rethinking Automated Assessment for Scratch Programs via Video-Grounded Evaluation](http://arxiv.org/abs/2604.17820v1)
...
Selection reason: 视频验证的自动化程序评估框架，其无显式测试的验证思路对agent验证有参考价值。
...
### [41] [Scaling Human-AI Coding Collaboration Requires a Governable Consensus Layer](http://arxiv.org/abs/2604.17883v1)
...
Selection reason: 提出属性图共识层作为AI编码协作的主工件，为agent工作流治理提供新范式。
...
### [42] [Cache-Related Smells in GitLab CI/CD: Comprehensive Catalog, Automated Detection, and Empirical Evidence](http://arxiv.org/abs/2604.17890v1)
*Francesco Urdih,Theodoros Theodoropoulos,Uwe Zdun*

Main category: cs.SE

Comments: 12 pages, Evaluation and Assessment in Software Engineering (EASE) 2026

Selection reason: CI/CD缓存坏气味目录与自动检测工具，可用于构建性能优化agent。
...
### [43] [MASFuzzer: Fuzz Driver Generation and Adaptive Scheduling via Multidimensional API Sequences](http://arxiv.org/abs/2604.17977v1)
...
Selection reason: LLM生成fuzz driver并结合自适应调度，直接贡献于自动化测试和漏洞发现。
...
### [44] [Statistical Software Engineering with Tuned Variables](http://arxiv.org/abs/2604.19822v1)
*Nimrod Busany*
...
Selection reason: 提出调优变量与统计发布门控概念，对AI系统调优和治理有参考价值。
...
### [45] [CodePivot: Bootstrapping Multilingual Transpilation in LLMs via Reinforcement Learning without Parallel Corpora](http://arxiv.org/abs/2604.18027v1)
...
Selection reason: 利用Python中间表示和强化学习实现多语言代码转换，可迁移到代码生成agent。
...
### [46] [Stateful Embedded Fuzzing with Peripheral-Accurate SystemC Virtual Prototypes](http://arxiv.org/abs/2604.19824v1)
...
Selection reason: 提出结合SystemC虚拟原型的嵌入式模糊测试框架，属于程序测试方法，对代码agent的测试反馈机制有参考价值。
...
### [47] [SolidCoder: Bridging the Mental-Reality Gap in LLM Code Generation through Concrete Execution](http://arxiv.org/abs/2604.19825v1)
...
Selection reason: 直接针对LLM代码生成中心智模拟与真实执行的差距，通过执行落地提升pass@1，对coding agent的验证机制高度相关。
...
### [48] [WebCompass: Towards Multimodal Web Coding Evaluation for Code Language Models](http://arxiv.org/abs/2604.18224v1)
...
Selection reason: 提出面向网页编码的多模态评测基准与Agent-as-a-Judge机制，是agent评测方法的重要补充。
...
### [49] [Towards an Agentic LLM-based Approach to Requirement Formalization from Unstructured Specifications](http://arxiv.org/abs/2604.18228v1)
...
Selection reason: 用agentic LLM流水线从非结构化需求提取形式化属性，可迁移到需求工程类agent的规划与验证。
...
### [50] [From Program Slices to Causal Clarity: Evaluating Faithful, Actionable LLM-Generated Failure Explanations via Context Partitioning and LLM-as-a-Judge](http://arxiv.org/abs/2604.18309v2)
...
Selection reason: 系统评估上下文配置对LLM生成失败解释质量的影响，为调试agent的输入设计与因果解释评测提供方法。
...
### [51] [Reliability of AI Bots Footprints in GitHub Actions CI/CD Workflows](http://arxiv.org/abs/2604.18334v1)
...
Selection reason: 研究GitHub Actions中AI bot的CI/CD可靠性并定义失败分类，对agent在真实工作流中的可靠性评估有迁移价值。
...
### [52] [Co-Located Tests, Better AI Code: How Test Syntax Structure Affects Foundation Model Code Generation](http://arxiv.org/abs/2604.19826v1)
*Éric Jacopin*
...
Selection reason: 实证研究测试语法结构对AI代码生成质量的影响，为代码agent的测试与代码协同生成提供可操作结论。
...
### [53] [More Is Different: Toward a Theory of Emergence in AI-Native Software Ecosystems](http://arxiv.org/abs/2604.19827v1)
*Daniel Russo*
...
Selection reason: 从复杂自适应系统理论刻画多agent软件生态的涌现与失效，为agent协作可靠性和治理提供概念框架。
...
### [54] [OpenGame: Open Agentic Coding for Games](http://arxiv.org/abs/2604.18394v1)
...
Selection reason: 提出端到端agentic游戏生成框架与执行接地RL、VLM评测，直接面向agent长程代码生成与验证。
...
### [55] [TypeScript Repository Indexing for Code Agent Retrieval](http://arxiv.org/abs/2604.18413v2)
...
Selection reason: 面向TypeScript仓库的图索引优化，直接改进代码agent的代码库检索与上下文获取效率。
...
### [56] [Towards Better Static Code Analysis Reports: Sentence Transformer-based Filtering of Non-Actionable Alerts](http://arxiv.org/abs/2604.18525v1)
...
Selection reason: 利用sentence transformer过滤静态分析不可操作告警，可迁移到agent代码审查和告警优先级排序。
...
### [57] [Structural Verification for Reliable EDA Code Generation without Tool-in-the-Loop Debugging](http://arxiv.org/abs/2604.18834v1)
...
Selection reason: 通过结构依赖图和预执行验证消除EDA代码生成中的tool-in-loop调试，直接提升长程代码生成的可靠性与效率。
...
### [58] [CollabSkill: Evaluating Human-Agent Collaboration On Real-World Tasks](http://arxiv.org/abs/2606.09833v1)
...
### [59] [Do LLMs Need to See Everything? A Benchmark and Study of Failures in LLM-driven Smartphone Automation using Screentext vs. Screenshots](http://arxiv.org/abs/2604.17817v1)
...
### [60] [The Collaboration Gap in Human-AI Work](http://arxiv.org/abs/2604.18096v1)
...
### [61] [The Triadic Loop: A Framework for Negotiating Alignment in AI Co-hosted Livestreaming](http://arxiv.org/abs/2604.18850v1)
...
### [62] [Choose Your Own Adventure: Non-Linear AI-Assisted Programming with EvoGraph](http://arxiv.org/abs/2604.18883v1)
...
Selection reason: 以开发图为交互模型回溯AI辅助编程历史，可用于设计agent的非线性探索与变更管理界面。
...
### [63] [COSAC: Counterfactual Credit Assignment in Sequential Cooperative Teams](http://arxiv.org/abs/2604.17693v2)
...
### [64] [LEPO: Latent Reasoning Policy Optimization for Large Language Models](http://arxiv.org/abs/2604.17892v4)
...
### [65] [Can Explicit Physical Feasibility Benefit VLA Learning? An Empirical Study](http://arxiv.org/abs/2604.17896v2)
...
### [66] [Learning to Correct: Calibrated Reinforcement Learning for Multi-Attempt Chain-of-Thought](http://arxiv.org/abs/2604.17912v1)
...
### [67] [RASP-Tuner: Retrieval-Augmented Soft Prompts for Context-Aware Black-Box Optimization in Non-Stationary Environments](http://arxiv.org/abs/2604.18026v1)
*Enze Pan*
...
### [68] [Scalable Neighborhood-Based Multi-Agent Actor-Critic](http://arxiv.org/abs/2604.18190v1)
...
### [69] [Towards Disentangled Preference Optimization Dynamics: Suppress the Loser, Preserve the Winner](http://arxiv.org/abs/2604.18239v3)
...
### [70] [Reducing Credit Assignment Variance via Counterfactual Reasoning Paths](http://arxiv.org/abs/2605.16302v2)
...
### [71] [Latent Phase-Shift Rollback: Inference-Time Error Correction via Residual Stream Monitoring and KV-Cache Steering](http://arxiv.org/abs/2604.18567v1)
...
### [72] [When Can LLMs Learn to Reason with Weak Supervision?](http://arxiv.org/abs/2604.18574v1)
...
### [73] [HELM: Harness-Enhanced Long-horizon Memory for Vision-Language-Action Manipulation](http://arxiv.org/abs/2604.18791v1)
...
### [74] [One Step Forward and K Steps Back: Better Reasoning with Denoising Recursion Models](http://arxiv.org/abs/2604.18839v1)
...
### [75] [Gradient-Based Program Synthesis with Neurally Interpreted Languages](http://arxiv.org/abs/2604.18907v1)
...
### [76] [Bayesian Active Learning with Gaussian Processes Guided by LLM Relevance Scoring for Dense Passage Retrieval](http://arxiv.org/abs/2604.17906v1)
...
### [77] [Evaluating Multi-Hop Reasoning in RAG Systems: A Comparison of LLM-Based Retriever Evaluation Strategies](http://arxiv.org/abs/2604.18234v1)
...
### [78] [First, Do No Harm (With LLMs): Mitigating Racial Bias via Agentic Workflows](http://arxiv.org/abs/2604.18038v1)
...
### [79] [From Craft to Kernel: A Governance-First Execution Architecture and Semantic ISA for Agentic Computers](http://arxiv.org/abs/2604.18652v2)
...
### [80] [RAVEN: Retrieval-Augmented Vulnerability Exploration Network for Memory Corruption Analysis in User Code and Binary Programs](http://arxiv.org/abs/2604.17948v2)
...
### [81] [Owner-Harm: A Missing Threat Model for AI Agent Safety](http://arxiv.org/abs/2604.18658v1)
...
### [82] [Evaluating Answer Leakage Robustness of LLM Tutors against Adversarial Student Attacks](http://arxiv.org/abs/2604.18660v1)
...
### [83] [Towards Optimal Agentic Architectures for Offensive Security Tasks](http://arxiv.org/abs/2604.18718v1)
...
### [84] [Temporal UI State Inconsistency in Desktop GUI Agents: Formalizing and Defending Against TOCTOU Attacks on Computer-Use Agents](http://arxiv.org/abs/2604.18860v1)
*Wenpeng Xu*
...
### [85] [Before You Interpret the Profile: Validity Scaling for LLM Metacognitive Self-Report](http://arxiv.org/abs/2604.17707v1)
*Jon-Paul Cacioli*
...
### [86] [Screen Before You Interpret: A Portable Validity Protocol for Benchmark-Based LLM Confidence Signals](http://arxiv.org/abs/2604.17714v1)
*Jon-Paul Cacioli*
...
### [87] [Concurrent Criterion Validation of a Validity Screen for LLM Confidence Signals via Selective Prediction](http://arxiv.org/abs/2604.17716v1)
*Jon-Paul Cacioli*
...
### [88] [PoQ-Judge: A Multi-Architecture Evaluation Framework for Cost-Aware Proof-of-Quality in Decentralized LLM Inference](http://arxiv.org/abs/2606.11196v1)
...
### [89] [MHSafeEval: Role-Aware Interaction-Level Evaluation of Mental Health Safety in Large Language Models](http://arxiv.org/abs/2604.17730v1)
...
### [90] [PDDL-Mind: Large Language Models are Capable on Belief Reasoning with Reliable State Tracking](http://arxiv.org/abs/2604.17819v1)
...
### [91] [Latent Abstraction for Retrieval-Augmented Generation](http://arxiv.org/abs/2604.17866v2)
...
### [92] [Latent Preference Modeling for Cross-Session Personalized Tool Calling](http://arxiv.org/abs/2604.17886v1)
...
### [93] [STaD: Scaffolded Task Design for Identifying Compositional Skill Gaps in LLMs](http://arxiv.org/abs/2604.18177v2)
...
### [94] [Negative Advantages Is a Double-Edged Sword: Calibrating advantages in GRPO for Search Agents](http://arxiv.org/abs/2604.18235v2)
...
### [95] [Characterizing AlphaEarth Embedding Geometry for Agentic Environmental Reasoning](http://arxiv.org/abs/2604.18715v1)
...
### [96] [Mango: Multi-Agent Web Navigation via Global-View Optimization](http://arxiv.org/abs/2604.18779v1)
...
### [97] [EVE: Verifiable Self-Evolution of MLLMs via Executable Visual Transformations](http://arxiv.org/abs/2604.18320v1)
...
### [98] [Progressive Online Video Understanding with Evidence-Aligned Timing and Transparent Decisions](http://arxiv.org/abs/2604.18459v1)
...
### [99] [Diversity Collapse in Multi-Agent LLM Systems: Structural Coupling and Collective Failure in Open-Ended Idea Generation](http://arxiv.org/abs/2604.18005v2)
...
### [100] [Aether: Network Validation Using Agentic AI and Digital Twin](http://arxiv.org/abs/2604.18233v1)
...
### [101] [Poster: EdgeCitadel -- Hybrid NATS-MQTT Orchestration for Edge Multi-Agent Systems](http://arxiv.org/abs/2606.14710v1)
...
### [102] [AI-Native Network Controller: A Modular Framework for Safe Agentic Control of Multi-Domain Network Infrastructure](http://arxiv.org/abs/2606.20565v1)
*Merim Dzaferagic*
