...
### [1] [MasterControl Seventeen Every Time](https://arxiv.org/abs/2609.03209)
...
### [4] [Dude: A Dual-Detection Multi-Agent System for Paper-Code Discrepancy Detection](https://arxiv.org/abs/2609.03416)
...
### [5] [Do GUI Agents Know When Not to Act? Enabling Conflict-Aware Termination for Multimodal GUI Agents](https://arxiv.org/abs/2609.03438)
...
### [6] [AutoGraphForge: Towards Automated Graph Theory Discovery](https://arxiv.org/abs/2609.03478)
*Ján Pastorek*
...
### [7] [DRACO: Fine-Grained Credit Assignment with Dynamic Rubrics for Long-Horizon Agent Training](https://arxiv.org/abs/2609.04094)
...
Selection reason: 提出基于动态rubric的细粒度信用分配DRACO，用于无验证信号的长程agent训练，可迁移到coding agent的复杂任务RL训练。
...
### [8] [Making Every Tool Call Count: Necessary Tool-Evidence Path Rewards for Agentic Vision-Language Models](https://arxiv.org/abs/2609.03493)
...
### [9] [Dalek: A Constructive Agent Machine](https://arxiv.org/abs/2609.03546)
*Wanpeng Xie*
...
### [10] [GPS-Bench: A Governance Policy Benchmark for Automating Policy Analysis](https://arxiv.org/abs/2609.03553)
...
### [11] [KC-Bench: A Dynamic Interactive Benchmark for Evaluating Knowledge Conflicts in LLM Agents](https://arxiv.org/abs/2609.03588)
...
### [12] [A computable representation of the physical laboratory enables verifiable workflows](https://arxiv.org/abs/2609.03621)
...
### [13] [Proactive Service Agents: A Unified Decision Framework, Methods, and Evaluation](https://arxiv.org/abs/2609.03727)
...
### [14] [SimSkill: A Lifelong Learning AI Agent for Autonomous Mastery of Traffic Simulation](https://arxiv.org/abs/2609.03753)
...
### [15] [Rethinking World Models for Safety-Critical Embodied Systems](https://arxiv.org/abs/2609.03774)
...
### [16] [DNative-Twin: Decision Graphs and Digital Twins for Reconstructable Agentic Decisions](https://arxiv.org/abs/2609.03787)
...
### [17] [Transfiver: Human-AI Co-Inference through a Shared Editable State](https://arxiv.org/abs/2609.03797)
...
### [18] [Adapting to Evolving Requirements: Agentic AI for Retail Supply Chain Operations](https://arxiv.org/abs/2609.03860)
...
### [19] [Bioinfoysis Technical Report](https://arxiv.org/abs/2609.03871)
...
### [23] [FiMI Banking: A Sovereign Model for Indian Retail Banking](https://arxiv.org/abs/2609.03960)
...
### [24] [Interface-Induced Trajectory Censoring](https://arxiv.org/abs/2609.03966)
*Wenbo Wang*
...
### [25] [FLY-EVAL++: An Evidence-Driven Evaluation Protocol for Safety-Constrained Flight Prediction with Large Language Models](https://arxiv.org/abs/2609.04021)
...
### [26] [Instruction Duplication as an Inference-Time Control Primitive](https://arxiv.org/abs/2609.04024)
*Victor Lavrenko*
...
### [27] [Spurious Advantage Hidden in GRPO](https://arxiv.org/abs/2609.04063)
...
### [28] [Environment Evolution for Terminal Agents](https://arxiv.org/abs/2609.04128)
...
### [29] [The Natural Language Interaction Protocol and Standard for AI Agents](https://arxiv.org/abs/2609.04135)
...
### [30] [Efficient Test-Time Adaptation through Human-AI Interaction](https://arxiv.org/abs/2609.04141)
...
### [31] [Terminal-Universe: Turning Agent Trajectories into Scalable Terminal Environments](https://arxiv.org/abs/2609.04148)
...
### [32] [A Case Study on Emergent Cheating and Whistleblowing in Autonomous Research Swarms](https://arxiv.org/abs/2609.04170)
...
### [33] [Clean Engineering, Unstable Measurement: A Preregistered Reliability Failure of Black-Box LLM Observers on Shared Endpoints](https://arxiv.org/abs/2609.04198)
...
### [34] [Requirements After the First Edit: Mining Late Requirement Emergence and Rework in Real-World Coding-Agent Sessions](https://arxiv.org/abs/2609.03028)
...
Selection reason: 基于真实编码agent会话分析需求迟到到达导致的代码重写/invalidation，对agent可靠性评估有直接迁移价值。
...
### [35] [Large Language Models and Language Server Protocol: a match made in context](https://arxiv.org/abs/2609.03086)
...
Selection reason: 展示LLM+静态验证器结合修复bug与重试机制，虽然针对Eiffel语言，但方法可迁移至其他验证场景。
...
### [36] [Compound Prompt Constraints in LLM Code Generation: A Factorial Study of Format, Persona, and Urgency](https://arxiv.org/abs/2609.03156)
...
Selection reason: 对提示复合约束进行因子化实验，揭示格式/人设/紧迫感对代码生成可靠性的联合影响，直接关系到agent代码生成管道设计。
...
Selection reason: 提出代码幻觉分类法、对抗性benchmark与拒绝行为评测，对提高coding agent的生成可靠性高度相关。
...
Selection reason: 通过RL训练测试时指令proposer，在采样前生成辅助tips来降低代码生成失败，为agent指令空间探索提供可迁移方法。
...
### [39] [Code Transformation Rule Synthesis using LLMs: Potential and Limits](https://arxiv.org/abs/2609.03592)
...
Selection reason: 系统评估LLM合成代码转换规则（Comby/GritQL/Ast-Grep），对自动程序修复与迁移等代码agent任务有参考价值。
...
### [40] [LabelMate: An LLM-Driven Framework for Refined Issue Report Labeling](https://arxiv.org/abs/2609.04055)
...
Selection reason: 面向issue报告分类的LLM框架，虽非核心代码任务，但其无标注自动生成/适配标签的流程可轻微迁移到agent工作流。
...
### [41] [When Models Edit Too Much: On the Fidelity of Minimal Code Edits](https://arxiv.org/abs/2609.04061)
...
Selection reason: 聚焦代码修复中的过度编辑与最小编辑保真度，提供评测框架并比较SFT与RL，对agent修复质量评估与训练具直接价值。
...
### [42] [SWE-Gate: Passing Functional Tests Is Not Enough for Software Engineering Agents](https://arxiv.org/abs/2609.04167)
...
Selection reason: 提出SWE-Gate benchmark，显式评估review约束合规性与函数测试，揭示纯功能测试高估agent能力的现象，直接服务agent评测。
