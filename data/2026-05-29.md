...
### [1] [Healthcare Mechanisms from Policy-as-Code Search under Strategic Provider Response](http://arxiv.org/abs/2605.30680v1)
...
### [2] [MAVEN: Improving Generalization in Agentic Tool Calling](http://arxiv.org/abs/2605.30738v1)
...
### [3] [Harnessing Agent Skills: Architectural Patterns and a Reference Architecture for Skill-Mediated LLM Agents](http://arxiv.org/abs/2606.20631v1)
...
### [4] [Learning Agent-Compatible Context Management for Long-Horizon Tasks](http://arxiv.org/abs/2605.30785v1)
...
### [5] [PReMISE: Policy Rubrics as Measurement Specifications for LLM Judges](http://arxiv.org/abs/2605.30803v1)
...
### [6] [Planner-Centric Reinforcement Learning for Deep Research with Structure-Aware Reward](http://arxiv.org/abs/2605.30824v1)
...
### [7] [SLAT: Segment-Level Adaptive Trimming for Efficient CoT Reasoning](http://arxiv.org/abs/2605.30832v1)
...
### [8] [COMPASS: Cognitive MCTS-Guided Process Alignment for Safe Search Agents](http://arxiv.org/abs/2605.30838v1)
...
### [9] [Distilling LLM Feedback for Lean Theorem Proving](http://arxiv.org/abs/2605.30861v1)
...
### [10] [UniScale: Adaptive Unified Inference Scaling via Online Joint Optimization of Model Routing and Test-Time Scaling](http://arxiv.org/abs/2605.30898v1)
...
### [11] [HADT: A Heterogeneous Multi-Agent Differential Transformer for Autonomous Earth Observation Satellite Cluster](http://arxiv.org/abs/2605.31023v1)
...
### [12] [COLLEAGUE.SKILL: Automated AI Skill Generation via Expert Knowledge Distillation](http://arxiv.org/abs/2605.31264v1)
...
### [13] [Industrializing Prediction-Powered Inference: The GLIDE Library for Reliable GenAI and Agentic Systems Evaluation](http://arxiv.org/abs/2605.31278v2)
...
### [14] [CAST: Non-Privileged Clipped Asymmetric Self-Teaching with Advantage Flipping for GRPO](http://arxiv.org/abs/2606.00172v1)
...
### [15] [TraceGraph: Shared Decision Landscapes for Diagnosing and Improving Agent Trajectories](http://arxiv.org/abs/2605.31308v1)
...
### [16] [Diagnosing Failure Modes of Shared-State Collaboration in Resource-Constrained Visual Agents](http://arxiv.org/abs/2605.31354v1)
*Yunpeng Zhou*
...
### [17] [Learning to Adapt: Self-Improving Web Agent via Cognitive-Aware Exploration](http://arxiv.org/abs/2605.31365v1)
...
### [18] [HypoAgent: An Agentic Framework for Interactive Abductive Hypothesis Generation over Knowledge Graphs](http://arxiv.org/abs/2605.31370v1)
...
### [20] [LinTree: Improving LLM Reasoning with Explicitly Structured Search Histories](http://arxiv.org/abs/2605.31492v1)
...
### [21] [TIGER: Traceable Inference with Graph-Based Evidence Routing for Mitigating Hallucinations in Multimodal Generation](http://arxiv.org/abs/2606.00232v1)
...
### [22] [MindZero: Learning Online Mental Reasoning With Zero Annotations](http://arxiv.org/abs/2606.00240v1)
...
### [23] [Capability Self-Assessment: Teaching LLMs to Know Their Limits](http://arxiv.org/abs/2606.00251v1)
...
### [24] [Closed-Loop Neural Activation Control in Vision-Language-Action Models](http://arxiv.org/abs/2606.00269v1)
...
### [25] [Robust Shielding for Safe Reinforcement Learning](http://arxiv.org/abs/2606.00270v1)
...
### [26] [Model-Native Computing Architecture: Envisioning Future System Architecture Through the Lens of Computer Architecture](http://arxiv.org/abs/2606.00288v3)
...
### [27] [The Deterministic Horizon: When Extended Reasoning Fails and Tool Delegation Becomes Necessary](http://arxiv.org/abs/2606.00376v1)
...
### [28] [VESTA: Visual Exploration with Statistical Tool Agents](http://arxiv.org/abs/2606.00384v2)
...
### [29] [Weak Critics Make Strong Learners: On-Policy Critique Distillation for Scalable Oversight](http://arxiv.org/abs/2606.00424v1)
...
### [30] [What Breaks When LLMs Code? Characterizing Operational Safety Failures of Agentic Code Assistants](http://arxiv.org/abs/2605.30777v1)
...
Selection reason: 系统研究编码智能体的运行安全失败模式并构建分类学，对智能体越狱防护与基准设计有直接贡献。
...
### [31] [Benchmarking Multimodal LLMs on Code Generation for Complex Interactive Webpages](http://arxiv.org/abs/2606.00154v1)
...
Selection reason: 新增多模态代码生成基准 WebIGBench，覆盖交互式网页代码生成，弥补现有静态基准的不足。
...
### [32] [BlueFin: Benchmarking LLM Agents on Financial Spreadsheets](http://arxiv.org/abs/2605.30907v1)
...
Selection reason: 面向电子表格智能体的基准与评估框架，其 rubric 和 LM judge 方法可迁移到代码智能体评测。
...
### [33] [Specification-Driven Development Benchmark: Security Knowledge Transition](http://arxiv.org/abs/2606.00167v1)
...
Selection reason: 面向规格驱动的 AI 辅助开发提出安全知识建模与迁移方法，并用测试套件验证安全增强效果。
...
### [34] [Ladder Logic Translation using Large Language Models in Industrial Automation](http://arxiv.org/abs/2605.31458v1)
...
Selection reason: 使用 LLM 将 PLC 梯形逻辑跨平台翻译，提出结构化管道，虽垂直但对代码转换类任务有一定参考。
...
### [35] [Knowledge Boundary Probing and Demand-Guided Intervention for LLM-Based Power System Code Generation](http://arxiv.org/abs/2605.31478v1)
...
Selection reason: 针对电力系统代码生成提出 API 知识边界探测与需求引导干预，可迁移到其他领域 LLM 代码生成可靠性改进。
...
### [36] [Separating Secrets from Placeholders: A Hybrid CNN-CodeBERT Framework for Three-Class Credential Leakage Detection](http://arxiv.org/abs/2605.31520v1)
...
Selection reason: 提出三分类凭据泄漏检测框架，融合 CodeBERT 与字符级模式识别，可辅助代码智能体避免泄露敏感信息。
...
### [37] [How Generation Architecture Shapes Code Complexity in Multi-Agent LLM Systems: A Paired Study on HumanEval](http://arxiv.org/abs/2606.00308v1)
*Nazmus Ashrafi*
...
Selection reason: 实证比较多智能体代码生成架构对代码复杂度的影响，对智能体架构设计与评测有直接指导意义。
...
### [38] [When are LLMs Sufficient Policy Optimizers for Sequential RL Tasks?](http://arxiv.org/abs/2605.30719v2)
...
### [39] [Emergence of Exploration in Policy Gradient Reinforcement Learning via Retrying](http://arxiv.org/abs/2606.00151v1)
...
### [40] [DARTS: Distribution-Aware Active Rollout Trajectory Shaping for Accelerating LLM Reinforcement Learning](http://arxiv.org/abs/2605.30859v1)
...
### [41] [Automating Formal Verification with Reinforcement Learning and Recursive Inference](http://arxiv.org/abs/2605.30914v1)
*Max Tan*
...
Selection reason: 用 RLVR 与验证器引导推理自动化形式化验证和程序生成，核心方法直接适用于代码智能体。
...
### [42] [Learning to Solve and Optimize by Evolving Code](http://arxiv.org/abs/2605.31049v1)
...
### [43] [MetaEvo: A Meta-Optimization Framework for Experience-Driven Agent Evolution](http://arxiv.org/abs/2606.07603v1)
...
### [44] [EchoRL: Reinforcement Learning via Rollout Echoing](http://arxiv.org/abs/2605.31228v1)
...
### [45] [Why Linear Recurrent Memory Works in Partially Observable Reinforcement Learning](http://arxiv.org/abs/2605.31261v1)
...
### [46] [The Terminal Representation in Reinforcement Learning](http://arxiv.org/abs/2605.31289v2)
...
### [47] [Agentic Transformers Provably Learn to Search via Reinforcement Learning](http://arxiv.org/abs/2606.00183v1)
...
### [48] [LEAF: Growing Trees Without Branching for Speech-Aware Large Language Model Post-Training](http://arxiv.org/abs/2606.07610v1)
...
### [49] [PithTrain: A Compact and Agent-Native MoE Training System](http://arxiv.org/abs/2605.31463v1)
...
### [50] [GPU Forecasters: Language Models as Selective Surrogates for Kernel Runtime Optimization](http://arxiv.org/abs/2605.31464v1)
...
### [51] [Learning to Construct Practical Agentic Systems](http://arxiv.org/abs/2606.00189v1)
...
### [52] [Skill Reuse as Compression in Agentic RL](http://arxiv.org/abs/2605.31509v1)
...
### [53] [BAGEN: Are LLM Agents Budget-Aware?](http://arxiv.org/abs/2606.00198v1)
...
### [54] [ROGUE: Misaligned Agent Behavior Arising from Ordinary Computer Use](http://arxiv.org/abs/2606.00341v1)
...
### [55] [Reinforcement Learning with Pairwise Preferences in Long-Term Decision Problems](http://arxiv.org/abs/2606.00367v1)
...
### [56] [TadA-Bench: A Million-Variant Benchmark for Future-Round Discovery Toward Agentic Protein Engineering](http://arxiv.org/abs/2606.02624v1)
...
### [57] [Design and Evaluation of Multi-Agent AI Oracle Systems for Prediction Market Resolution](http://arxiv.org/abs/2605.30802v1)
*Tarun Kota*
...
### [58] [Safe Equilibrium Policy Optimization for Strategic Agent Policies](http://arxiv.org/abs/2605.30854v1)
...
### [59] [Dreaming Of Others: Latent Teammate Modeling In World Models For Multi-Agent Reinforcement Learning](http://arxiv.org/abs/2605.31361v1)
*Tomas Leroy-Stone*
...
### [60] [Used Car Salesbots? Honesty and Credulity of LLMs as Bargaining Agents under Partial Information](http://arxiv.org/abs/2605.31445v1)
...
### [61] [Personalized to Persuade: The Effects of Contextualization and Warmth on Trust and Reliance in Conversational AI](http://arxiv.org/abs/2605.31275v1)
...
### [62] [Agentic Authoring of Interactive Multiview Visualizations in Genomics](http://arxiv.org/abs/2606.00370v1)
...
### [63] [Fighting Numerical Hallucinations via Data-centric Compilation for Online Financial QA](http://arxiv.org/abs/2605.31064v1)
...
### [64] [DynaTree: Dynamic Agentic Retrieval Tree for Time-Sensitive News Retrieval](http://arxiv.org/abs/2605.31377v1)
...
### [65] [A Systems-Level Analysis of Sensitivity, Robustness, and Stability in Retrieval-Augmented Generation](http://arxiv.org/abs/2606.28337v1)
...
### [66] [SAGE: A Novelty Gate for Efficient Memory Evolution in Agentic LLMs](http://arxiv.org/abs/2605.30711v2)
...
### [67] [Your Teacher Can't Help You Here: Combating Supervision Fidelity Decay in On-Policy Distillation](http://arxiv.org/abs/2605.30833v1)
...
### [68] [PatchWorld: Gradient-Free Optimization of Executable World Models](http://arxiv.org/abs/2605.30880v3)
...
### [69] [Combinatorial Synthesis: Scaling Code RLVR via Atomic Decomposition and Recombination](http://arxiv.org/abs/2605.31058v1)
...
Selection reason: 提出原子分解与重组框架合成可验证代码任务，解决代码 RLVR 训练数据稀缺问题，直接相关。
...
### [70] [Emergent Languages in Populations of Language Model Agents: From Token Efficiency to Oversight Evasion](http://arxiv.org/abs/2605.31170v1)
...
### [71] [Steering LLMs? Actually, Sparse Autoencoders can outperform simple baselines](http://arxiv.org/abs/2605.31183v1)
...
### [72] [Skill Availability and Presentation Granularity in Large-Language-Model Agents: A Controlled SkillsBench Study](http://arxiv.org/abs/2605.31408v1)
...
### [73] [LongTraceRL: Learning Long-Context Reasoning from Search Agent Trajectories with Rubric Rewards](http://arxiv.org/abs/2605.31584v1)
...
### [74] [Bridging Reasoning Trajectories in On-Policy Distillation via Near-Future Guidance](http://arxiv.org/abs/2606.00305v2)
...
### [75] [Masking Stale Observations Helps Search Agents -- Until It Doesn't: A Regime Map and Its Mechanism](http://arxiv.org/abs/2606.00408v1)
...
### [76] [Seeing Before Agreeing: Aligning Multi-Agent Consensus with Visual Evidence](http://arxiv.org/abs/2605.30698v1)
...
### [77] [VisualLeakBench: Reproducible Action-Boundary Propagation Failures in Vision-Language Agents](http://arxiv.org/abs/2606.07595v1)
...
### [78] [SpatialAct: Probing Spatial Reasoning-to-Action Capabilities of VLM Agents in 3D Scenes](http://arxiv.org/abs/2605.31148v1)
...
### [79] [ERGeoBench:A Comprehensive Benchmark for Embodied Reasoning and Geo-localization in Multimodal Large Language Models](http://arxiv.org/abs/2605.31251v1)
...
### [80] [StressDream: Steering Video World Models for Robust Policy Evaluation and Improvement](http://arxiv.org/abs/2606.00267v1)
...
### [81] [Neither Replacement nor Panacea: Comparing LLM-Based Conversational and Graphical Decision Support in Industrial Tasks](http://arxiv.org/abs/2605.31287v1)
...
### [82] [Investigating Detection and Obfuscation of Prompt Injection Attacks Against Software Reverse Engineering AI Agents](http://arxiv.org/abs/2605.30677v1)
...
Selection reason: 研究逆向工程智能体的提示注入攻击防护，对代码智能体的安全性与鲁棒性有迁移价值。
...
### [83] [Depth-Dependent Indirect Prompt Injection in Tool-Calling ReAct Agents: Injection Depth, Payload Framing, and Turn-Budget Sensitivity](http://arxiv.org/abs/2605.30686v1)
...
### [84] [PrivacyPeek: Auditing What LLM-Based Agents Acquire, Not Just What They Say](http://arxiv.org/abs/2606.00152v1)
...
### [85] [From Prompt Injection to Persistent Control: Defending Agentic Harness Against Trojan Backdoors](http://arxiv.org/abs/2605.31042v1)
...
### [86] [R+R: Reassessing Java Security API Misuse in Current LLMs: A Replication on JCA and JSSE APIs with External Security Knowledge](http://arxiv.org/abs/2605.31135v1)
...
Selection reason: 复现并扩展 LLM 生成 Java 安全 API 代码的误用研究，评估外部安全知识影响，对安全代码生成有参考价值。
...
### [87] [How to Compare the Security of Code Written by Humans to LLM-generated Code](http://arxiv.org/abs/2606.00186v2)
...
Selection reason: 提出人类与 LLM 生成代码安全对比的自动化框架，为安全评估提供可复用的实验方法学。
...
### [88] [Stateful Online Monitoring Catches Distributed Agent Attacks](http://arxiv.org/abs/2605.31593v1)
...
### [89] [GSAM: A Generalizable and Safe Robotic Framework for Articulated Object Manipulation](http://arxiv.org/abs/2605.30740v1)
...
### [90] [Completion at the Boundary (CaB): Deployable Switching with Completion-Aware Control under Limited Calibration](http://arxiv.org/abs/2606.00145v1)
...
### [91] [Hide-and-Seek in Trajectories: Discovering Failure Signals for VLA Runtime Monitoring](http://arxiv.org/abs/2605.30834v1)
...
### [92] [TARIC: Memory-Augmented Traversability-Aware Outdoor VLN under Interrupted Semantic Cues](http://arxiv.org/abs/2605.31121v1)
...
### [93] [Continuous Reasoning for Vision-Language-Action](http://arxiv.org/abs/2606.00229v2)
...
### [94] [Physical Atari: A Robust and Accessible Platform for Real-time Reinforcement Learning on Robots](http://arxiv.org/abs/2606.19357v1)
...
### [95] [Sophrosyne: Agentic Exploration of Relational Data Systems Needs Moderation](http://arxiv.org/abs/2605.30862v1)
...
### [96] [SpecDB: LLM-Generated Customized Databases via Feature-Oriented Decomposition](http://arxiv.org/abs/2605.31097v1)
...
### [97] [SEMBridge: Tagless-Final Program Semantics with Weakest-Precondition and Bounded-Checking Interpretations](http://arxiv.org/abs/2606.00220v1)
*Eric Liang*
