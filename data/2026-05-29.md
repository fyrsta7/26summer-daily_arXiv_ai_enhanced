...
- [Combinatorial Synthesis: Scaling Code RLVR via Atomic Decomposition and Recombination](http://arxiv.org/abs/2605.31058v1) — 相关度 0.95：提出原子分解与重组框架合成可验证代码任务，解决代码 RLVR 训练数据稀缺问题，直接相关。
- [What Breaks When LLMs Code? Characterizing Operational Safety Failures of Agentic Code Assistants](http://arxiv.org/abs/2605.30777v1) — 相关度 0.95：系统研究编码智能体的运行安全失败模式并构建分类学，对智能体越狱防护与基准设计有直接贡献。
- [Automating Formal Verification with Reinforcement Learning and Recursive Inference](http://arxiv.org/abs/2605.30914v1) — 相关度 0.90：用 RLVR 与验证器引导推理自动化形式化验证和程序生成，核心方法直接适用于代码智能体。
- [How Generation Architecture Shapes Code Complexity in Multi-Agent LLM Systems: A Paired Study on HumanEval](http://arxiv.org/abs/2606.00308v1) — 相关度 0.90：实证比较多智能体代码生成架构对代码复杂度的影响，对智能体架构设计与评测有直接指导意义。
- [Knowledge Boundary Probing and Demand-Guided Intervention for LLM-Based Power System Code Generation](http://arxiv.org/abs/2605.31478v1) — 相关度 0.85：针对电力系统代码生成提出 API 知识边界探测与需求引导干预，可迁移到其他领域 LLM 代码生成可靠性改进。
- [Benchmarking Multimodal LLMs on Code Generation for Complex Interactive Webpages](http://arxiv.org/abs/2606.00154v1) — 相关度 0.80：新增多模态代码生成基准 WebIGBench，覆盖交互式网页代码生成，弥补现有静态基准的不足。
- [R+R: Reassessing Java Security API Misuse in Current LLMs: A Replication on JCA and JSSE APIs with External Security Knowledge](http://arxiv.org/abs/2605.31135v1) — 相关度 0.80：复现并扩展 LLM 生成 Java 安全 API 代码的误用研究，评估外部安全知识影响，对安全代码生成有参考价值。
- [Investigating Detection and Obfuscation of Prompt Injection Attacks Against Software Reverse Engineering AI Agents](http://arxiv.org/abs/2605.30677v1) — 相关度 0.75：研究逆向工程智能体的提示注入攻击防护，对代码智能体的安全性与鲁棒性有迁移价值。
- [Specification-Driven Development Benchmark: Security Knowledge Transition](http://arxiv.org/abs/2606.00167v1) — 相关度 0.75：面向规格驱动的 AI 辅助开发提出安全知识建模与迁移方法，并用测试套件验证安全增强效果。
- [BlueFin: Benchmarking LLM Agents on Financial Spreadsheets](http://arxiv.org/abs/2605.30907v1) — 相关度 0.70：面向电子表格智能体的基准与评估框架，其 rubric 和 LM judge 方法可迁移到代码智能体评测。
- [How to Compare the Security of Code Written by Humans to LLM-generated Code](http://arxiv.org/abs/2606.00186v2) — 相关度 0.70：提出人类与 LLM 生成代码安全对比的自动化框架，为安全评估提供可复用的实验方法学。
- [Separating Secrets from Placeholders: A Hybrid CNN-CodeBERT Framework for Three-Class Credential Leakage Detection](http://arxiv.org/abs/2605.31520v1) — 相关度 0.70：提出三分类凭据泄漏检测框架，融合 CodeBERT 与字符级模式识别，可辅助代码智能体避免泄露敏感信息。
- [Ladder Logic Translation using Large Language Models in Industrial Automation](http://arxiv.org/abs/2605.31458v1) — 相关度 0.60：使用 LLM 将 PLC 梯形逻辑跨平台翻译，提出结构化管道，虽垂直但对代码转换类任务有一定参考。
