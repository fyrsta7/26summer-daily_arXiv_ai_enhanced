...
- [From Fragments to Paths: Task-Level Context Recovery for Large Industrial Codebases](http://arxiv.org/abs/2606.22906v1) — 相关度 0.90：任务级仓库上下文恢复方法显著提升编码agent在SWE-bench等任务上的性能，直接相关。
- [EnterpriseClawBench: Benchmarking Agents from Real Workplace Sessions](http://arxiv.org/abs/2606.23654v1) — 相关度 0.85：构建企业agent基准的协议和真实会话数据集，对agent评测具有直接迁移价值。
- [GroundEval: A Deterministic Replacement for LLM-as-Judge in Stateful Agent Evaluation](http://arxiv.org/abs/2606.22737v2) — 相关度 0.85：用确定性证据轨迹替代 LLM-as-judge 评估有状态 agent，直接改进 agent 评测可靠性。
- [Source-Free Detection and Impact Analysis of Compiler Optimization Problems in Mobile Applications](http://arxiv.org/abs/2606.23512v1) — 相关度 0.85：直接从二进制检测编译优化级别并量化性能影响，是典型的程序性能优化场景，高度相关。
- [Managing Procedural Memory in LLM Agents: Control, Adaptation, and Evaluation](http://arxiv.org/abs/2606.23127v1) — 相关度 0.80：提出程序性记忆基准AFTER，评估agent技能跨任务/角色/模型迁移，对agent记忆与评测有参考价值。
- [VeriPilot: An LLM-Powered Verilog Debugging Framework](http://arxiv.org/abs/2606.23759v1) — 相关度 0.80：基于LLM的Verilog调试框架，结合golden模型和CDFG定位修复，可迁移到代码修复场景。
- [ESAA-Conversational: An Event-Sourced Memory Layer for Continuity, Handoff, and Curation Across Heterogeneous LLM Coding Agents](http://arxiv.org/abs/2606.23752v1) — 相关度 0.75：为异构 LLM coding agent 提供事件溯源共享记忆层，解决跨会话与跨工具上下文延续。
- [JupOtter: Cell-Level Bug Detection in Jupyter Notebooks](http://arxiv.org/abs/2606.23877v1) — 相关度 0.75：提出单元格级 bug 检测方法及 2.1 万 notebook 标注数据集，可直接用于代码缺陷检测 agent 训练与评测。
- [Understanding the (In)Security of Vibe-Coded Applications](http://arxiv.org/abs/2606.23130v2) — 相关度 0.75：系统研究vibe-coding应用的安全性，揭示LLM开发常见漏洞模式，对代码agent安全性有借鉴意义。
- [ESBMC-PLC+: A Unified IEC 61131-3 Formal Verification Framework as a PLCverif Successor](http://arxiv.org/abs/2606.23870v2) — 相关度 0.70：提出统一的 IEC 61131-3 形式化验证框架并支持 k-induction，对程序验证与正确性检查方法有迁移价值。
